...
def reveal_distribution(shap_values, feature_values, feature_name):
    sf = np.array([shap_values, feature_values])
    corr = np.corrcoef(sf)
    coef = corr[0,1]
    return coef
...
def summary_legacy(shap_values, features=None, feature_names=None, max_display=None, plot_type=None,
    ...
    shap_feature_values = {'importance' : [], 'correlation' : []}
    ...
    if plot_type == "dot":
        ...
        if features is not None:
            ...
            for pos, i in enumerate(feature_order):
                ...
                most_important_features = shap_feature_values['importance']
                ...
                most_correlated_features = shap_feature_values['correlation']
                if coef >=0.3:
    ...
    #TODO: Generation of the natural language.
