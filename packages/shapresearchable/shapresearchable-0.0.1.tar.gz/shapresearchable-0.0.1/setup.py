...
def run_setup(with_binary, test_xgboost, test_lightgbm, test_catboost, test_spark, test_pyod,
    ...
    setup(
        ...
        url='https://github.com/GeneralZYQ/researchableShap',
        download_url = 'https://github.com/GeneralZYQ/researchableShap/archive/0.0.1.tar.gz',
        author='Zhang Yuanqing',
        author_email='y.zhang@researchable.nl',
        license='MIT',
        packages=[
            ...
            'shap.actions', 'shap.models', 'shap.report_generator', 'shap.models_uploaders'
        ],
