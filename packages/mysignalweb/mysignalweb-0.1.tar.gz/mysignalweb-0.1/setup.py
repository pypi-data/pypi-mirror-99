...
setup(
  name = 'mysignalweb',         # How you named your package folder (MyLib)
  packages = ['mysignalweb'],   # Chose the same as "name"
  ...
  url = 'https://github.com/Yaseen549/mysignalweb',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Yaseen549/mysignalweb/archive/refs/tags/v0.1.tar.gz',    # I explain this later on
  keywords = ['PY', 'ISMY', 'ONLYWEB'],   # Keywords that define your package best
