...
.. code-block:: bash
   ...
   $ git clone https://github.com/jupyterhub/naasauthenticator.git
   $ pip install -e .
...
You can then run JupyterHub using the config file and the NaasAuthenticator will be running the system:
