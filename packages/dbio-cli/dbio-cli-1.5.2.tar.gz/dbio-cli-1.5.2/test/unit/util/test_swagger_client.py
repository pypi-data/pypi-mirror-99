...
class TestSwaggerClient(unittest.TestCase):
    ...
    def test_swagger_client_refresh(self):
        ...
        dss = TestTokenDSSClient(swagger_url='https://dss.dev.ucsc-cgp-redwood.org/v1/swagger.json')
    ...
    def test_swagger_client_no_refresh(self):
        ...
        """
        dss = DSSClient(swagger_url='https://dss.dev.ucsc-cgp-redwood.org/v1/swagger.json')
        assert dss._authenticated_session is None
