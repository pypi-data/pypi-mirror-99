...
class AwsCustomResource(
    ...
    def get_response_field_reference(
        ...
        :param data_path: the path to the data.
        '''
        return typing.cast(aws_cdk.core.Reference, jsii.invoke(self, "getResponseFieldReference", [data_path]))
...
class AwsCustomResourcePolicy(
    ...
    def statements(self) -> typing.List[aws_cdk.aws_iam.PolicyStatement]:
        ...
        return typing.cast(typing.List[aws_cdk.aws_iam.PolicyStatement], jsii.get(self, "statements"))
...
class PhysicalResourceIdReference(
    ...
    def resolve(self, _: aws_cdk.core.IResolveContext) -> typing.Any:
...
class Provider(
    ...
    def bind(
        ...
        '''
        return typing.cast(aws_cdk.aws_cloudformation.CustomResourceProviderConfig, jsii.invoke(self, "bind", [_scope]))
    ...
    def on_event_handler(self) -> aws_cdk.aws_lambda.IFunction:
        ...
        return typing.cast(aws_cdk.aws_lambda.IFunction, jsii.get(self, "onEventHandler"))
    ...
    def is_complete_handler(self) -> typing.Optional[aws_cdk.aws_lambda.IFunction]:
        ...
        return typing.cast(typing.Optional[aws_cdk.aws_lambda.IFunction], jsii.get(self, "isCompleteHandler"))
