...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_labels=None, name=None, pulp_created=None, base_path=None, repository=None, content_guard=None, pulp_href=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
