...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_href=None, repository=None, pulp_labels=None, repository_version=None, name=None, pulp_created=None, base_path=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
