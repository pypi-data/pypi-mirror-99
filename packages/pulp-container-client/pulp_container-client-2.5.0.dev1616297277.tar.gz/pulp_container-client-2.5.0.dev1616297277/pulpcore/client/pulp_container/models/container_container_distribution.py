...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, repository=None, pulp_labels=None, repository_version=None, name=None, base_path=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
