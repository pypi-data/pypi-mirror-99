...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, repository_version=None, name=None, pulp_href=None, pulp_created=None, repository=None, pulp_labels=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
