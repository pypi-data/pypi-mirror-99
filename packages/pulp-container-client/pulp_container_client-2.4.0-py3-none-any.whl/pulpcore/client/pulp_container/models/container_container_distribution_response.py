...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_labels=None, base_path=None, repository_version=None, name=None, repository=None, content_guard=None, pulp_created=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
