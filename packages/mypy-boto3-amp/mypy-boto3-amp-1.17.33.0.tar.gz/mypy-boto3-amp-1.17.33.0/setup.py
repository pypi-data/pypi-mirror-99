...
setup(
    ...
    description="Type annotations for boto3.PrometheusService 1.17.33 service, generated by mypy-boto3-buider 4.4.0",
    classifiers=[
    ...
    keywords="boto3 amp type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
