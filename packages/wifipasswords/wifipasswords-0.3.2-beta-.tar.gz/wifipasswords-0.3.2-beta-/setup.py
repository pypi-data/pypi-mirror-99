...
setuptools.setup(
    ...
    version=ver,
    author="Joe Campbell",
    description="Retreive and save all WiFi networks and passwords on the device. Cross platform windows, linux, macOS",
    ...
    entry_points={
        'console_scripts': [
            'wifipasswords = wifipasswords.__main__:cli'
        ]
    },
)
