...
def sync(
    *,
    ...
    - If the user is basic, they can only delete versions in folders they have write rights on.
    - If the user is orgadmin, they can delete versions in all of their organization's folders."""
