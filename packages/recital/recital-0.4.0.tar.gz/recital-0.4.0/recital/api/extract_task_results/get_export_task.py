...
def _get_kwargs(
    *,
    ...
    task_id: int,
    nb_chunks: Union[Unset, int] = 1,
) -> Dict[str, Any]:
    url = "{}/api/v1/extract/results/export/".format(client.base_url)
...
def sync(
    *,
    ...
    """Runs the export of extract results.task_id

    The export is generated asynchronously, the user receives a notification when the
    export is ready to be downloaded.

    Only complete tasks can be exported.

    Only orgadmins can export results."""
