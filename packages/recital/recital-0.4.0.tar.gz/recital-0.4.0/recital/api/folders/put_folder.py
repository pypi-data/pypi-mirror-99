...
def sync(
    *,
    ...
    - If the user is basic, they can only update folders they have write rights on.
    - If the user is orgadmin, they can update all of their own organization's folders.

    The constraints of folder update are:

    - Root folders cannot be updated.
