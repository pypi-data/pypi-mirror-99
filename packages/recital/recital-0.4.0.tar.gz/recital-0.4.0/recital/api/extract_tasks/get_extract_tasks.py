...
from ...models.extract_with_config_out import ExtractWithConfigOut
...
) -> Optional[Union[List[ExtractWithConfigOut], None, None, HTTPValidationError]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ExtractWithConfigOut.from_dict(response_200_item_data)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[List[ExtractWithConfigOut], None, None, HTTPValidationError]]:
    return Response(
