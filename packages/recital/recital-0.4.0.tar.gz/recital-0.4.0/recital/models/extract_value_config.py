...
class ExtractValueConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        keywords_operator = self.keywords_operator

        keywords_scope = self.keywords_scope

        start_page = self.start_page
        end_page = self.end_page
        words_direction = self.words_direction
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keywords_operator = d.pop("keywords_operator", UNSET)

        keywords_scope = d.pop("keywords_scope", UNSET)

        start_page = d.pop("start_page", UNSET)

        end_page = d.pop("end_page", UNSET)

        words_direction = d.pop("words_direction", UNSET)
