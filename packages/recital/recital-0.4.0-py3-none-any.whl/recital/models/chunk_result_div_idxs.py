...
T = TypeVar("T", bound="ChunkResultDivIdxs")


@attr.s(auto_attribs=True)
class ChunkResultDivIdxs:
    """  """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        chunk_result_div_idxs.additional_properties = additional_properties
        return chunk_result_div_idxs
