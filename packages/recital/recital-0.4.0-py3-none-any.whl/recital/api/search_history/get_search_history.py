...
) -> Optional[Union[List[SearchQueryOut], None, None, HTTPValidationError]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[List[SearchQueryOut], None, None, HTTPValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    """ List the user's search history. """
