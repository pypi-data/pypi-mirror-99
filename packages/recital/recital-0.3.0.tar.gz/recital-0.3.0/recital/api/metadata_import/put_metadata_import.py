...
from ...models.metadata_import_update import MetadataImportUpdate
...
def _get_kwargs(
    *,
    ...
    json_body: MetadataImportUpdate,
) -> Dict[str, Any]:
...
def sync(
    *,
    ...
    """Update a pending or executing metadata import tasks.

    This is performed when the check file task is finished.

    Only services can update metadata import tasks."""
