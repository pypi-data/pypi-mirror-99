...
def sync(
    *,
    ...
    """Deletes a folder.
    - If the user is basic, they can only delete folders they has write rights on.
    - If the user is orgadmin, they can delete any of their own organization's folders."""
