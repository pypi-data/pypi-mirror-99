...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/extract/tasks/{task_id}/latestseeds/".format(client.base_url, task_id=task_id)
...
def sync(
    *,
    ...
    """Get the latest seeds that can be used to fit the model.

    Only services are allowed to access the latest seeds."""
