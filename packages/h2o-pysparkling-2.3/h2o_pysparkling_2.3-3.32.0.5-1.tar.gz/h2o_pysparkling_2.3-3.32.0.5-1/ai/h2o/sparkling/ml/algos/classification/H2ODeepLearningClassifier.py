...
class H2ODeepLearningClassifier(H2ODeepLearning):
    ...
    def __init__(self,
        ...
        self._java_obj = self._new_java_obj("ai.h2o.sparkling.ml.algos.classification.H2ODeepLearningClassifier", self.uid)
