...
`;!function(e,t,r,i){var n=s();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var a=t((function(e){n.initializeInstanceElements(e,f.elements)}),r),f=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(p(o.descriptor)||p(n.descriptor)){if(d(o)||d(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(d(o)){if(d(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}c(o,n)}else t.push(o)}return t}(a.d.map(l)),e);n.initializeClassElements(a.F,f.elements),n.runClassFinishers(a.F,f.finishers)}([(0,o.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"method",key:"scrollToPos",value:function(e,t){this.contentElement.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading">
      ${h(y(r.prototype),"renderHeading",this).call(this)}
      ...
      <ha-dialog open @closed=${this.closeDialog} hideActions heading=${!0}>
        <ha-header-bar slot="heading">
          ...
          <span slot="title">
            ${this.hass.localize("ui.panel.config.logs.details","level",n.dy`<span class="${e.level.toLowerCase()}">${e.level}</span>`)}
          </span>
        ...
        <div class="contents">
          <p>
            ...
            ${t?n.dy`
                  <br />
                  Integration: ${(0,s.Lh)(this.hass.localize,t)}
                  ${this._manifest&&this._manifest.documentation?n.dy`
                        (<a
                          href=${this._manifest.documentation}
                          target="_blank"
                          rel="noreferrer"
                          >documentation</a
                        >${this._manifest.is_built_in||this._manifest.issue_tracker?n.dy`,
                              <a
                                href=${(0,s.H0)(t,this._manifest)}
                                target="_blank"
                                rel="noreferrer"
                                >issues</a
                              >`:""})
            ...
            ${e.count>0?n.dy`
                  First occurred:
                  ${(0,p.Q)(e.first_occurred,this.hass.language)}
                  (${e.count} occurrences) <br />
                `:""}
            Last logged:
            ${(0,p.Q)(e.timestamp,this.hass.language)}
          </p>
          ${e.message.length>1?n.dy`
                <ul>
                  ${e.message.map((e=>n.dy` <li>${e}</li> `))}
                </ul>
              `:e.message[0]}
          ${e.exception?n.dy` <pre>${e.exception}</pre> `:n.dy``}
        </div>
      </ha-dialog>
    `}},{kind:"method",key:"_fetchManifest",value:async function(e){try{this._manifest=await(0,s.t4)(this.hass,e)}catch(e){}}},{kind:"method",key:"_copyLog",value:async function(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".contents");await(0,a.v)(t.innerText),(0,d.C)(this,{message:this.hass.localize("ui.common.copied_clipboard")})}},{kind:"get",static:!0,key:"styles",value:function(){return[c.yu,n.iv`
        a {
      ...
      `]}}]}}),n.oi);customElements.define("dialog-system-log-detail",E)}}]);
//# sourceMappingURL=chunk.01f82b2baff397141b91.js.map