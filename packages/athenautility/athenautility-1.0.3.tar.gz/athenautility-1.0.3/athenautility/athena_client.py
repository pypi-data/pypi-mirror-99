...
class AthenaClient:
    ...
    def databases(self):
        ...
        try:
            pay_load = {"user_name": self._user_name, "password": self._password}
            r = requests.post(SERVICE_URL + API_GET_ATHENA_DATABASES, data=pay_load)
            response = r.json()
            return response
    ...
    def tables(self, schema_name):
        ...
        try:
            ...
            r = requests.post(SERVICE_URL + API_GET_ATHENA_TABLES, data=pay_load)
            response = r.json()
            return response
        except requests.exceptions.HTTPError as err_h:
            print(err_h)
    ...
    def top(self, schema_name, table_name, limit=None):
        ...
        try:
            ...
            r = requests.post(SERVICE_URL + API_QUERY_ATHENA_TABLE, data=pay_load)
            response = r.json()
            return response
        except requests.exceptions.HTTPError as err_h:
            print(err_h)
    ...
    def run_query(self, query_string, result_as_df=True):
        ...
        try:
            ...
            r = requests.post(SERVICE_URL + API_RUN_QUERY_ON_ATHENA, data=pay_load)
            response = r.json()
            if result_as_df:
