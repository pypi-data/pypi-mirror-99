...
* point value in round-to-nearest-even mode.
* \param[in] i - unsigned long long int
* 
* \return half
* \retval \p i converted to half. 
*/
...
* warpSize. 
* \param[in] mask - unsigned int
* \param[in] var - half2
* \param[in] delta - int
* \param[in] width - int
* 
* \return Returns the 4-byte word referenced by var from the source thread ID as half2. 
...
* \param[in] width - int
* 
* \return Returns the 2-byte word referenced by var from the source thread ID as half. 
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
