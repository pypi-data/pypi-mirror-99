...
class Snapshot(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'zip_name': (str, none_type,),  # noqa: E501
            'container_image': (str,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The unique id of the snapshot.. [optional]  # noqa: E501
            number (int): The number of the snapshot within the project.. [optional]  # noqa: E501
            created (datetime): The time the snapshot was created.. [optional]  # noqa: E501
            path (str, none_type): The path of the snapshot's directory within the snapshot storage volume.. [optional]  # noqa: E501
            zip_name (str, none_type): The name of snapshot's Zip file (within the snapshot directory).. [optional]  # noqa: E501
            container_image (str): The container image to use as the execution environment for this snapshot.. [optional]  # noqa: E501
            creator (int): The user who created the snapshot.. [optional]  # noqa: E501
            job (int): The job that created the snapshot. [optional]  # noqa: E501
        """
