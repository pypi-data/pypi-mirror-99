...
class TokensCreateResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, id, token, username, first_name, last_name, *args, **kwargs):  # noqa: E501
        """TokensCreateResponse - a model defined in OpenAPI
