...
class JobCreate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'began': (datetime,),  # noqa: E501
            'ended': (datetime,),  # noqa: E501
            ...
            'log': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'runtime': (float,),  # noqa: E501
    ...
    def __init__(self, method, *args, **kwargs):  # noqa: E501
        """JobCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            began (datetime): The time the job began.. [optional]  # noqa: E501
            ended (datetime): The time the job ended.. [optional]  # noqa: E501
            status (str): The current status of the job.. [optional]  # noqa: E501
            is_active (bool): Is the job active?. [optional]  # noqa: E501
            result ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The result of the job; a JSON value.. [optional]  # noqa: E501
            ...
            log ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The job log; a JSON array of log objects, including any errors.. [optional]  # noqa: E501
            runtime (float): The running time of the job.. [optional]  # noqa: E501
            worker (str): The identifier of the worker that ran the job.. [optional]  # noqa: E501
            retries (int): The number of retries to fulfil the job.. [optional]  # noqa: E501
