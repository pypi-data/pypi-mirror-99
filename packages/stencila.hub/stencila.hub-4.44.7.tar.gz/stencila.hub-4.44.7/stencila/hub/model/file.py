...
class File(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mimetype': (str, none_type,),  # noqa: E501
    ...
    def __init__(self, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            current (bool): Is the file currently in the project? Used to retain a history for file paths within a project.. [optional]  # noqa: E501
            created (datetime): The time the file info was created.. [optional]  # noqa: E501
            updated (datetime, none_type): The time the file info was updated. This field will have the last time this row was altered (i.e. changed from current, to not).. [optional]  # noqa: E501
            modified (datetime, none_type): The file modification time.. [optional]  # noqa: E501
            size (int, none_type): The size of the file in bytes. [optional]  # noqa: E501
            mimetype (str, none_type): The mimetype of the file.. [optional]  # noqa: E501
            encoding (str, none_type): The encoding of the file e.g. gzip. [optional]  # noqa: E501
            fingerprint (str, none_type): The fingerprint of the file. [optional]  # noqa: E501
            job (int, none_type): The job that created the file e.g. a source pull or file conversion.. [optional]  # noqa: E501
            source (int, none_type): The source from which the file came (if any). If the source is removed from the project, so will this file.. [optional]  # noqa: E501
            snapshot (str, none_type): The snapshot that the file belongs. If the snapshot is deleted so will the files.. [optional]  # noqa: E501
            upstreams ([int]): The files that this file was derived from (if any).. [optional]  # noqa: E501
        """
