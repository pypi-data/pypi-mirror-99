...
class Source(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            address (str): The address of the source. e.g. github://org/repo/subpath. [optional]  # noqa: E501
            path (str, none_type): The file or folder name, or path, that the source is mapped to.. [optional]  # noqa: E501
            order (int, none_type): The order that the source should be pulled into the project (allows explicit overwriting of one source by another).. [optional]  # noqa: E501
            created (datetime): The time the source was created.. [optional]  # noqa: E501
            updated (datetime): The time the source was last changed.. [optional]  # noqa: E501
        """
