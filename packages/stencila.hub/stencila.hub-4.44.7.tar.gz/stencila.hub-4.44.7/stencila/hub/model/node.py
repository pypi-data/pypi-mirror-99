...
class Node(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'node': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'creator': (int, none_type,),  # noqa: E501
            'created': (datetime,),  # noqa: E501
            'app': (str, none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, node, *args, **kwargs):  # noqa: E501
        """Node - a model defined in OpenAPI

        Args:
            project (int, none_type): The project this node is associated with.
            node ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The node itself.
        ...
        Keyword Args:
            ...
            creator (int, none_type): User who created the project.. [optional]  # noqa: E501
            created (datetime): When the project was created.. [optional]  # noqa: E501
            app (str, none_type): An identifier for the app that created the node.. [optional]  # noqa: E501
            host (str, none_type): URL of the host document within which the node was created.. [optional]  # noqa: E501
            key (str): A unique, and very difficult to guess, key to access this node if it is not public.. [optional] if omitted the server will use the default value of "5T83pcN594ycYCrL6pSsmVyjpHuddNyi"  # noqa: E501
