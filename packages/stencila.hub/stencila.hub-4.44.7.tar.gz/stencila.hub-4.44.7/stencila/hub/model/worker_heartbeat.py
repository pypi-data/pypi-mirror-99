...
class WorkerHeartbeat(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'processed': (int,),  # noqa: E501
            'load': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, clock, active, processed, load, *args, **kwargs):  # noqa: E501
        """WorkerHeartbeat - a model defined in OpenAPI
        ...
        Args:
            ...
            load ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): An array of the system load over the last 1, 5 and 15 minutes. From os.getloadavg().
