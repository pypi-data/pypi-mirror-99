...
class Email(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, sender, recipient, subject, text, html, spf, *args, **kwargs):  # noqa: E501
        """Email - a model defined in OpenAPI

        Args:
            sender (str): Email sender, as taken from the message headers.
            recipient (str): Email recipient field, as taken from the message headers.
            subject (str): Email subject.
            text (str): Email body in plaintext formatting.
            html (str): HTML body of email. If not set, email did not have an HTML body.
            spf (str): The results of the Sender Policy Framework verification of the message sender and receiving IP address.
