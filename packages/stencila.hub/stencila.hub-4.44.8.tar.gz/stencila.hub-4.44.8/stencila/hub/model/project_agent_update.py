...
class ProjectAgentUpdate(ModelNormal):
    ...
    def __init__(self, role, *args, **kwargs):  # noqa: E501
        """ProjectAgentUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            project (int): Project to which the user or team is being given access to.. [optional]  # noqa: E501
            user (int): A user given access to the project.. [optional]  # noqa: E501
            team (int): A team given access to the project.. [optional]  # noqa: E501
        """
