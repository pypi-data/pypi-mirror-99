...
class GithubRepo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'permissions': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'updated': (datetime,),  # noqa: E501
            'refreshed': (datetime,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, full_name, image_url, permissions, updated, *args, **kwargs):  # noqa: E501
        """GithubRepo - a model defined in OpenAPI

        Args:
            full_name (str): The full name of the repository ie. owner/name
            image_url (str): The URL for an image associated with the repository.
            permissions ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): A JSON object with permissions that the user has for the repo.
            updated (datetime): The date-time that the repository was last updated.
        ...
        Keyword Args:
            ...
            refreshed (datetime): The date-time that this information was last refreshed from GitHub.. [optional]  # noqa: E501
        """
