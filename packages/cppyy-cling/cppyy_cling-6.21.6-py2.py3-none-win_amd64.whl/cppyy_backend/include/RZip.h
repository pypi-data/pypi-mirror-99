...
extern "C" void R__zipMultipleAlgorithm(int cxlevel, int *srcsize, char *src, int *tgtsize, char *tgt, int *irep, CppyyLegacy::RCompressionSetting::EAlgorithm::EValues);
