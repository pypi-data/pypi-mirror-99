...
project = "regapp-tools"
copyright = "2020-present, Marcus Hardt"
author = "Marcus Hardt"
...
modindex_common_prefix = ['regapp-tools']
...
html_theme_options = {
    ...
    'show_related': False,
    'note_bg': '#FFF59C',
    'description': 'Commandline tools to work with the bwIDM regApp (aka LDAP Facade)',
}
