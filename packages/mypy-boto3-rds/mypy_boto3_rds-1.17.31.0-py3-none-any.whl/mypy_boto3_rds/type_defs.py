...
DBProxyEndpointTypeDef = TypedDict(
    "DBProxyEndpointTypeDef",
    {
        ...
        "TargetRole": Literal["READ_WRITE", "READ_ONLY"],
        "IsDefault": bool,
    },
    total=False,
)
...
DBProxyTargetTypeDef = TypedDict(
    "DBProxyTargetTypeDef",
    {
        ...
        "Role": Literal["READ_WRITE", "READ_ONLY", "UNKNOWN"],
...
FailoverStateTypeDef = TypedDict(
    "FailoverStateTypeDef",
    {
        "Status": Literal["pending", "failing-over", "cancelling"],
...
DescribeDBProxyEndpointsResponseTypeDef = TypedDict(
    "DescribeDBProxyEndpointsResponseTypeDef",
    {"DBProxyEndpoints": List["DBProxyEndpointTypeDef"], "Marker": str},
    total=False,
)
...
FailoverGlobalClusterResultTypeDef = TypedDict(
    "FailoverGlobalClusterResultTypeDef", {"GlobalCluster": "GlobalClusterTypeDef"}, total=False
)
