...
from . import helpers, renders, widgets
...
class SiteView(BaseView):
    ...
    def as_string(cls, **initkwargs):
        ...
        if "render_type" not in initkwargs:
...
class CMSView(BaseView):
    ...
    def customized_return_url(self, default_url):
        ...
        if redirect_url:
            ...
            if len(base) > 1 and redirect_url.startswith(f"/{base[1]}"):
                return redirect_url
    ...
    def get_render_data(self, **kwargs):
        ...
        * **back_bundle** - The back_back bundle is bundle that is linked to \
        ...
        if "back_bundle" not in data:
            data["back_bundle"] = self.get_back_bundle()

        return super().get_render_data(**data)
    ...
    def get_url_kwargs(self, request_kwargs=None, **kwargs):
        ...
        for k in self.bundle.url_params:
            if k in request_kwargs and k not in kwargs:
        ...
        * post__pk = 2
        ...
        if self.parent_field:
            ...
            try:
                ...
                # Handle Singleton models without PK in url
                main_arg = 1
...
class ModelCMSView(CMSView):
    ...
    def get_url_kwargs(self, request_kwargs=None, **kwargs):
        ...
        kwargs = super().get_url_kwargs(request_kwargs, **kwargs)
    ...
    def get_render_data(self, **kwargs):
        ...
        return super().get_render_data(**kwargs)
