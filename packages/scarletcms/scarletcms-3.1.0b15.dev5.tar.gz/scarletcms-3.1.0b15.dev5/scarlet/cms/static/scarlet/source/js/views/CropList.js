...
const CropList = View.extend({
  ...
  handleCropFormSubmit() {
    if ($('form[data-form-id=edit]')[0].checkValidity() === true) {
    ...
    return {
      item: (item, escape) => {
        ...
        var fieldName = document.querySelector("input[name=name]"),
          fieldX = document.querySelector("input[name=x]"),
          fieldY = document.querySelector("input[name=y]"),
          fieldX2 = document.querySelector("input[name=x2]"),
          fieldY2 = document.querySelector("input[name=y2]");
        if (fieldName) {
          fieldName.value = item.name;
        }
        fieldX.value = item.x;
        fieldY.value = item.y;
        fieldX2.value = item.x2;
        fieldY2.value = item.y2;
