...
const Formset = View.extend({
  ...
  add(formsetType) {
    ...
    let carousel_button = $('<a />');
    carousel_button.attr('href','test');
    carousel_button.text('Add item');
    carousel_button.addClass('button button--primary add_crousel_item');

    clone.html(html);
    clone.append(carousel_button);
