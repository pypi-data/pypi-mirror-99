...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'pt', 'kn', 'vi', 'sr', 'th', 'chr', 'hi', 'ro', 'no', 'id', 'et',
        'ml', 'cs', 'my', 'uz', 'li', 'or', 'te', 'eo', 'fa', 'ar', 'gl', 'jv',
        'oc', 'az', 'eu', 'uk', 'br', 'da', 'lo', 'ast', 'simple', 'is', 'hr',
        'la', 'fj', 'tg', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'skr',
        'vo', 'he', 'af', 'zh-min-nan', 'shn', 'scn', 'sl', 'tl', 'pa', 'sw',
        'fy', 'bn', 'nn', 'lv', 'ka', 'sq', 'co', 'mn', 'pnb', 'min', 'lb',
        'nds', 'bs', 'nah', 'ms', 'yue', 'sa', 'kk', 'km', 'om', 'diq', 'vec',
        'tk', 'mk', 'be', 'sm', 'hsb', 'shy', 'gd', 'ga', 'an', 'wo', 'mni',
        'gom', 'mr', 'ang', 'ia', 'tt', 'fo', 'mt', 'sd', 'nia', 'gn', 'ie',
