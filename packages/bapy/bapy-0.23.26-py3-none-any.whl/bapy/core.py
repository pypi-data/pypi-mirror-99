...
def _(keep: int = Argument(Bump.PATCH, help='Tags to keep.')):
    """
    Delete git tags.
...
def _(bump: Bump = Option(GIT_VERSIONS, autocompletion=Git.bump_values, case_sensitive=False,
