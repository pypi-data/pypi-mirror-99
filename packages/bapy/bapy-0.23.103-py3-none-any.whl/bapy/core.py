...
class Git(git.Repo, BaseData):
    ...
    def bump(self, bump: Bump = Bump.PATCH, delete: bool = GIT_VERSIONS_DELETE, message: str = None,
             stdout: bool = True) -> Optional[VersionInfo]:
        if self.git_dir:
            self.path.c()
    ...
    def commit(self, bump: Bump = Bump.PATCH, message: str = None, stdout: bool = True) -> Optional[git.Commit]:
        if self.git_dir:
    ...
    def commit_cmd(self, bump: Bump = Bump.PATCH, message: str = None, stdout: bool = True) -> Optional[str]:
        if self.git_dir:
    ...
    def fetch(self, stdout: bool = True, **kwargs) -> Optional[IterableList]:
        if self.origin:
    ...
    def version_delete(self, keep: int = GIT_VERSIONS, stdout: bool = True) -> Optional[int]:
        if self.git_dir:
