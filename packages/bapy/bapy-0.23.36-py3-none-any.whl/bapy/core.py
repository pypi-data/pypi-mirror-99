...
class Git(git.Repo, BaseData):
    ...
    def bump(self, value: Bump = Bump.PATCH, msg: str = str()):
        ...
        Line.echo(data={'repo': Line.BWHITE, self.name: Line.GREEN, 'version': Line.BWHITE,
                        self._version: Line.GREEN, 'previous': Line.BWHITE, self.previous: Line.GREEN})
    ...
    def version_delete(self, keep: int = GIT_VERSIONS):
        ...
        Line.echo(data={
            'repo': Line.BWHITE, self.name: Line.GREEN, 'deleted': Line.BWHITE,
            delete if delete > 0 else int(): Line.GREEN
        })
...
class Path(pathlib.Path, pathlib.PurePosixPath):
    ...
    def setuptools(self) -> dict:
        ...
        Line.echo(data={'repo': Line.BWHITE, self.repo: color, 'path': Line.BWHITE, self.project: color})
        self.git = None
