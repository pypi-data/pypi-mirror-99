...
Функция ФайлыСходятся(ПервыйФайл, ВторойФайл, ЗаписываемРезультатВФайл = Ложь)
	...
	ПервыйВременныйФайл = ИмяФайлаДляСравнения(ПервыйФайл, УдалитьПервыйФайл);
	ВторойВременныйФайл = ИмяФайлаДляСравнения(ВторойФайл, УдалитьВторойФайл);
...
Функция ИмяФайлаДляСравнения(Файл, ВременныйФайл)
