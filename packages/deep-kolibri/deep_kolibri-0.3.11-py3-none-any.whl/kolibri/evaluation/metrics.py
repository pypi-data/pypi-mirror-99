...
from kolibri.evaluation import util
from kolibri.evaluation import validate
from kolibri.evaluation.preprocessing import binarize
...
def classification_report(y_true, y_pred, target_names, normalize=False):
    ...
    cr = sk_classification_report(y_true, y_pred, labels=target_names, output_dict=True)
