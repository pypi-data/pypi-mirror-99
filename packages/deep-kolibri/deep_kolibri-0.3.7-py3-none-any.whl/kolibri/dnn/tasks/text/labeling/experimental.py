...
from tf.keras_self_attention import SeqSelfAttention

import kolibri.dnn
from kolibri.dnn.tasks.text.labeling import BaseLabelingModel
...
kolibri.dnn.custom_objects['SeqSelfAttention'] = SeqSelfAttention
