...
from kolibri.dnn.tensorflow.layers import L, AttentionWeightedAverageLayer, KMaxPoolingLayer, MultiHeadSelfAttention
...
def get_model(model_type, embedding=None, hyper_parameters=None):
    ...
    if model_type == 'avrnn':
        ...
        return FastText(embedding=embedding, hyper_parameters=hyper_parameters)
