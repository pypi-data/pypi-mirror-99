...
import sys
import logging
from ...model.doc_classifier import DocClassifyModelSettings, DocClassifyCoachSettings, DeviceSettings
...
def main():
    ...
    model_settings = DocClassifyModelSettings(
        ...
        sent_transformer_encode_layer_size=args.sent_transformer_encode_layer_size
    )
