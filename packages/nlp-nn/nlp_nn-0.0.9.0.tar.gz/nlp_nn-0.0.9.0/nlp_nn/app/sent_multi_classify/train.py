...
import sys
import logging
from ...model.sent_multi_classifier import SentMultiClassifyModelSettings, SentMultiClassifyCoachSettings
from ...model.sent_multi_classifier import SentMultiClassify, DeviceSettings
...
def main():
    ...
    args = Utils.create_cmd_params(
        [SentMultiClassifyCoachSettings(), SentMultiClassifyModelSettings(), DeviceSettings()]
    )
    device_settings = DeviceSettings(gpu_idx=args.gpu_idx)
    coach_settings = SentMultiClassifyCoachSettings(
        ...
        tag_label_dic=args.class_label,
        valid_interval=args.valid_interval
    )
    model_settings = SentMultiClassifyModelSettings(
