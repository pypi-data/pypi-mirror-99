...
import sys
import logging
from ...model.sent_similarity_cross import SentSimilarityModelSettings, SentSimilarityCoachSettings, DeviceSettings
...
def main():
    ...
    args = Utils.create_cmd_params([SentSimilarityCoachSettings(), SentSimilarityModelSettings(), DeviceSettings()])
    device_settings = DeviceSettings(gpu_idx=args.gpu_idx)
    coach_settings = SentSimilarityCoachSettings(
    ...
    model_settings = SentSimilarityModelSettings(
