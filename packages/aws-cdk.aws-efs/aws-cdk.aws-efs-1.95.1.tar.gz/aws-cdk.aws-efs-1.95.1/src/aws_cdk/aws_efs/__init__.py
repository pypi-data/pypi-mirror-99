...
class CfnAccessPoint(
    ...
    def __init__(
        ...
        *,
        ...
        access_point_tags: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnAccessPoint.AccessPointTagProperty", aws_cdk.core.IResolvable]]]] = None,
...
class IAccessPoint(aws_cdk.core.IResource, typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_IAccessPointProxy"]:
