# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/05-constraints.ipynb (unless otherwise specified).

__all__ = ['check_for_nulls', 'construct_charge_state_s', 'check_capacity_constraints',
           'doesnt_exceed_charge_state_min', 'doesnt_exceed_charge_state_max', 'check_full_utilisation',
           'check_all_values_equal', 'charge_state_always_drops_to_0MWh', 'charge_state_always_gets_to_6MWh',
           'check_rate_constraints', 'doesnt_exceed_charge_rate_min', 'doesnt_exceed_charge_rate_max',
           'check_charging_patterns', 'charge_is_0_at_midnight', 'all_charge_periods_charge',
           'all_discharge_periods_discharge', 'all_inactive_periods_do_nothing', 'schedule_is_legal']
