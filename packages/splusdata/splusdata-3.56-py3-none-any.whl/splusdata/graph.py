...
class Graph:
    ...
    def autoplot(self):
        ...
        mag_auto_err = [np.nan if x <= -5 else x for x in mag_auto_err]
        return_plot(wl, mag_auto, mag_auto_err, title)
    ...
    def petroplot(self):
        ...
        mag_petro_err = [np.nan if x <= -5 else x for x in mag_petro_err]
        return_plot(wl, mag_petro, mag_petro_err, title)
    ...
    def aperplot(self):
        ...
        return_plot(wl, mag_aper, mag_aper_err, title)
    ...
    def totalplot(self):
        ...
        mag_total_err = [np.nan if x <= -5 else x for x in mag_total_err]
        return_plot(wl, mag_total, mag_total_err, title)

def return_plot(wl, mag, mag_err, title):
