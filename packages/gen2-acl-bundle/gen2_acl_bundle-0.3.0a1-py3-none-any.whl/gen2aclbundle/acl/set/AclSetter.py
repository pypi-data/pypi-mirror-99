...
class AclSetter:
    ...
    def set(self, storage_filesystem, export_path):
        info_dict = {"storage_account": self.__storage_name, "storage_filesystem": storage_filesystem, "export_path": export_path}
                ...
                for index, row in df_default.iterrows():
                    ...
                    if acl_default != "---":  # only create ACL for users that have some ACL Default defined
                        ...
                        if acl_aad_oid_item == "OWNER":
                            ...
                            acl_string = (
                                acl_string + f"{acl_type}:{acl_aad_oid_item}:{acl_access},"
    ...
    def __set_acl_for_dir_real(self, folder_name: str, folder_config: dict, root_path_current_folder: str):
        self.__logger.debug("-------------------------------")
        full_path_folder, filesystem, full_path_folder_to_set_acl = self.__acl_path_resolver.get_filesystem_and_path_from_root(
        ...
        self.__set_acl_for_subfolders_and_files(filesystem, full_path_folder[len(filesystem) + 1 :], acl_string)  # noqa: 5203
    ...
    def __set_acl(self, storage_filesystem, storage_path, acl_string):
        ...
        try:
            ...
            path_to_file, filename = self.__acl_path_resolver.get_path_and_filename(storage_path)
