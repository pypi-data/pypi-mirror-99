...
"""
Module that contains Fk Arm rig implementation for metarig in Maya
"""
...
class FkArmRig(module.RigModule, mixin.JointMixin):
    def __init__(self, *args, **kwargs):
        super(FkArmRig, self).__init__(*args, **kwargs)
    ...
    def create(self, *args, **kwargs):
        super(FkArmRig, self).create(*args, **kwargs)

        fk_rig = fkchain.FkChainComponent(name='armFkChain')
