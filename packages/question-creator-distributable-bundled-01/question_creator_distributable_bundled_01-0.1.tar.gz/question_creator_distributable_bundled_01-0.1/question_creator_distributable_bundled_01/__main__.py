...
from data_process import createHtmlString
from flask_sqlalchemy import SQLAlchemy
import json
import copy
from aws_operations.load_file_from_s3 import load_data_from_s3
from aws_operations.write_file_to_s3 import write_file_to_s3
import gzip
...
def upload_question_bank():
    with open('User.sqlite3', 'rb') as f:
