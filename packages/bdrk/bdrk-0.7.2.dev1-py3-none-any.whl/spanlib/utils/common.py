...
uniform_collection = [
    t.__origin__ for t in [Set, FrozenSet, AbstractSet, MutableSet, List, Deque]  # type: ignore
]
...
dictionary = [t.__origin__ for t in [Dict, Mapping, MutableMapping]]  # type: ignore
