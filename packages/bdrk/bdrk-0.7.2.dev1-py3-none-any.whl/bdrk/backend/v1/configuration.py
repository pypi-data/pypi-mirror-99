...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="http://localhost:8000",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("bdrk.backend.v1")
            ...
            'AccessTokenAuth':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-Bedrock-Access-Token',
                    'value': self.get_api_key_with_prefix('X-Bedrock-Access-Token')
                },
            'BearerAuth':
                {
                    'type': 'bearer',
            ...
            'InternalTokenAuth':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-Bedrock-Api-Token',
                    'value': self.get_api_key_with_prefix('X-Bedrock-Api-Token')
                },
        }
