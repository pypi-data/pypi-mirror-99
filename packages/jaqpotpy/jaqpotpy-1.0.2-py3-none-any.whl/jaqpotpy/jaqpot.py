...
class Jaqpot:
    ...
    def deploy_sklearn(self, model, X, y, title, description, model_meta=True, doa=None):
        """
    ...
    def deploy_sklearn_unsupervised(self, model, X, title, description, doa=None):
        """
        Deploys sklearn model or pipeline to Jaqpot.
    ...
    def get_bodel_by_id(self,model):
        """
