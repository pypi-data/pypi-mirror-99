...
from pyspace.nlp.toolkit.spacy import SpacyPostTokenizer, SpacyTokenizer, SpacyRegexReplaceNormalizer
...
class SpacyTokenizer(Tokenizer, SparseFeaturizer, EntityExtractor):
    ...
    defaults = {
        ...
        "post_tokenizer_merge_bool": False,
                ...
                if message.get(attribute) is not None:
                    if attribute == INTENT:
                        ...
                        if attribute == TEXT:
                            ...
                            if entities:
                                replace_patterns = dict(self.nlp.pipeline)['SpacyRegexReplaceNormalizer'].replace_patterns
