...
class QTL2525 (PowerModule):
    ...
    class QTL2525_12V_HighCurrentCalibration (QTL2525Calibration):
        ...
        def setCoefficients(self):
            ...
            #result = self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V12_LEAKAGE_MULTIPLIER_ADDR + " " + self.powerModule.calibrations["12V"]["Leakage"].multiplier.hexString(4))
