...
from src.enums.lg_webos_button import LGWebOSButton
...
class LGWebOSRemote():
    ...
    """
	Sends a literal string of text to the device. Only relevant if you are interacting with a LG webOS virtual keyboard.
