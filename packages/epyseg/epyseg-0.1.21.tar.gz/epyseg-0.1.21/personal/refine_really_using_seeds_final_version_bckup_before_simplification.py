...
class RefineMaskUsingSeeds():
    ...
    def __init__(self, img_orig, restore_safe_cells=True, _DEBUG=False,_VISUAL_DEBUG=False, **kwargs):
        ...
        if img_orig.has_c():
            ...
            whsed_no_dilat_black = raw_wshedlike_segmentation.copy()
            whsed_no_dilat_black[whsed_no_dilat_black > 0.5] = 255
            whsed_no_dilat_black[whsed_no_dilat_black <= 0.5] = 0
            ...
            # binarise seeds
            whsed_seeds_black = img_orig[..., 5]
            whsed_seeds_black[whsed_seeds_black>0.5]=255
            whsed_seeds_black[whsed_seeds_black <= 0.5] = 0
            # maybe deblob it or keep it like that

            # white seeds
            whsed_seeds_white =  Img.invert(img_orig[..., 6])
            whsed_seeds_white[whsed_seeds_white > 0.15] = 255
            whsed_seeds_white[whsed_seeds_white <= 0.15] = 0
...
if __name__ == '__main__':
    ...
    # img = Img('/home/aigouy/Bureau/tests_dual_resolution/predict/100708_png06.tif')
