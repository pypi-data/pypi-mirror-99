...
path = '/home/aigouy/Bureau/AVG_5_bis.tif'
img_orig = Img(path)
...
img_saturated[img_saturated > 0.6] = 255
img_saturated[img_saturated <= 0.6] = 0
...
for run in range(10):
    ...
    for region in props:
        ...
        if list_of_cells_to_dilate.count(region.label) < 2: # faudrait un check plus malin je pense --> style la longueur du bond depuis le vertex...
            continue
        # if id == 0:
        #     continue
        # print(id)
