...
_RequiredCustomerProfilesDestinationPropertiesTypeDef = TypedDict(
    "_RequiredCustomerProfilesDestinationPropertiesTypeDef", {"domainName": str}
)
_OptionalCustomerProfilesDestinationPropertiesTypeDef = TypedDict(
    "_OptionalCustomerProfilesDestinationPropertiesTypeDef", {"objectTypeName": str}, total=False
)
...
HoneycodeMetadataTypeDef = TypedDict(
    "HoneycodeMetadataTypeDef", {"oAuthScopes": List[str]}, total=False
)
