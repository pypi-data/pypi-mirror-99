...
from mkrunner.models import TStep, FunctionsMapping
from mkrunner.parser import parse_variables_mapping
...
def ensure_upload_ready():
    ...
    or you can install mkrunner with optional upload dependencies:
    $ pip install "mkrunner[upload]"
    """
    logger.error(msg)
    sys.exit(1)
...
def multipart_encoder(**kwargs):
    ...
    for key, value in kwargs.items():
        ...
        if os.path.isabs(value):
            ...
            from mkrunner.loader import load_project_meta
