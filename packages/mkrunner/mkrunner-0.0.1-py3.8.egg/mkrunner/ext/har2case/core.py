...
from mkrunner.compat import ensure_path_sep
from loguru import logger
from sentry_sdk import capture_exception

from mkrunner.ext.har2case import utils
from mkrunner.make import make_testcase, format_pytest_with_black
    ...
    def __make_request_url(self, teststep_dict, entry_json):
        ...
        Args:
            entry_json (dict):
                {
                    "request": {
                        "url": "https://mkrunner.top/home?v=1&w=2",
                        "queryString": [
                            {"name": "v", "value": "1"},
                            {"name": "w", "value": "2"}
                        ],
            ...
            entry_json (dict):
                {
                    "request": {
                        "method": "POST",
                        "url": "https://mkrunner.top/api/v1/Account/Login",
                        "headers": [],
                        "queryString": [],
                        "postData": {},
                    },
