...
from mkrunner.models import VariablesMapping, Validators, FunctionsMapping
from mkrunner.parser import parse_data, parse_string_value, get_mapping_function
    ...
    def validate(
        ...
        for v in validators:
            ...
            if "$" in check_item:
                ...
                # 如果是断言项是变量或函数，不做正则获取，直接作为值
                check_value = check_item
            elif check_item and isinstance(check_item, Text):
