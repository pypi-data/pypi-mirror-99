...
2. ...::
    ...
    -- Publish
    (pyLDAvis) $ tar tzf dist/pyLDAvis-3.3.0.tar.gz
    (pyLDAvis) $ twine upload --repository-url https://upload.pypi.org/legacy/ dist/*

Big Sur is both 10.16 and 11.0 – it’s official (https://eclecticlight.co/2020/07/21/big-sur-is-both-10-16-and-11-0-its-official/)
    numpy>=1.20.1
