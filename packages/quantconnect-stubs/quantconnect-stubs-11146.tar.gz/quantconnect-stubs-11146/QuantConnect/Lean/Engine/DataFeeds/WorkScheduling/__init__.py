...
del sys.modules["QuantConnect.Lean.Engine.DataFeeds.WorkScheduling"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.DataFeeds.WorkScheduling")
from QuantConnect.Lean.Engine.DataFeeds.WorkScheduling import *
