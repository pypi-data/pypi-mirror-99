...
del sys.modules["QuantConnect.Lean.Engine.DataFeeds.Queues"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.DataFeeds.Queues")
from QuantConnect.Lean.Engine.DataFeeds.Queues import *
