...
del sys.modules["QuantConnect.Lean.Engine.DataFeeds.Transport"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.DataFeeds.Transport")
from QuantConnect.Lean.Engine.DataFeeds.Transport import *
