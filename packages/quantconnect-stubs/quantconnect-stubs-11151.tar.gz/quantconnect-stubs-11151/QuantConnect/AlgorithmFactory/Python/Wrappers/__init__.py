...
del sys.modules["QuantConnect.AlgorithmFactory.Python.Wrappers"]
from clr import AddReference
AddReference("QuantConnect.AlgorithmFactory.Python.Wrappers")
from QuantConnect.AlgorithmFactory.Python.Wrappers import *
