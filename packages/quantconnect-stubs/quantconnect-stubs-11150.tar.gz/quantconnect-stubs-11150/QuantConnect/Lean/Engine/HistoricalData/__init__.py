...
del sys.modules["QuantConnect.Lean.Engine.HistoricalData"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.HistoricalData")
from QuantConnect.Lean.Engine.HistoricalData import *
