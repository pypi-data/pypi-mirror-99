...
del sys.modules["QuantConnect.Brokerages.Binance.Messages"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.Binance.Messages")
from QuantConnect.Brokerages.Binance.Messages import *
