...
del sys.modules["QuantConnect.Brokerages.GDAX.Messages"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.GDAX.Messages")
from QuantConnect.Brokerages.GDAX.Messages import *
