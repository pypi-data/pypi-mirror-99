...
del sys.modules["QuantConnect.Brokerages.Bitfinex.Messages"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.Bitfinex.Messages")
from QuantConnect.Brokerages.Bitfinex.Messages import *
