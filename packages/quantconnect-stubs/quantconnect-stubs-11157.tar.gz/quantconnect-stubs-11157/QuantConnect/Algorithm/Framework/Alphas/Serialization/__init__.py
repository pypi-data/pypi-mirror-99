...
del sys.modules["QuantConnect.Algorithm.Framework.Alphas.Serialization"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.Framework.Alphas.Serialization")
from QuantConnect.Algorithm.Framework.Alphas.Serialization import *
