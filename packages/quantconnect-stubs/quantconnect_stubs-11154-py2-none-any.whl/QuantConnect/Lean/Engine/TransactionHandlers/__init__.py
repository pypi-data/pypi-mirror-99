...
del sys.modules["QuantConnect.Lean.Engine.TransactionHandlers"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.TransactionHandlers")
from QuantConnect.Lean.Engine.TransactionHandlers import *
