...
del sys.modules["QuantConnect.Lean.Engine.DataFeeds.Enumerators"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.DataFeeds.Enumerators")
from QuantConnect.Lean.Engine.DataFeeds.Enumerators import *
