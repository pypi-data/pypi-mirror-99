...
del sys.modules["QuantConnect.Brokerages.InteractiveBrokers"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.InteractiveBrokers")
from QuantConnect.Brokerages.InteractiveBrokers import *
