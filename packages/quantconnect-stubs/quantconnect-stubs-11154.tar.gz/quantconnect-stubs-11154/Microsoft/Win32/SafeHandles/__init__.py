...
while os.path.basename(current_path) != "Microsoft":
...
del sys.modules["Microsoft.Win32.SafeHandles"]
from clr import AddReference
AddReference("Microsoft.Win32.SafeHandles")
from Microsoft.Win32.SafeHandles import *
