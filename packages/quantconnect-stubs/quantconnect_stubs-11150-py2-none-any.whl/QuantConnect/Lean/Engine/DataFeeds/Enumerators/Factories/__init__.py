...
del sys.modules["QuantConnect.Lean.Engine.DataFeeds.Enumerators.Factories"]
from clr import AddReference
AddReference("QuantConnect.Lean.Engine.DataFeeds.Enumerators.Factories")
from QuantConnect.Lean.Engine.DataFeeds.Enumerators.Factories import *
