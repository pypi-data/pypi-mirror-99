...
del sys.modules["QuantConnect.Securities.FutureOption.Api"]
from clr import AddReference
AddReference("QuantConnect.Securities.FutureOption.Api")
from QuantConnect.Securities.FutureOption.Api import *
