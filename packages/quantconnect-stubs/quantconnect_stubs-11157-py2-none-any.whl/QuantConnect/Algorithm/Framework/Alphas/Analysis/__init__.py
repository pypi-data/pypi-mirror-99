...
del sys.modules["QuantConnect.Algorithm.Framework.Alphas.Analysis"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.Framework.Alphas.Analysis")
from QuantConnect.Algorithm.Framework.Alphas.Analysis import *
