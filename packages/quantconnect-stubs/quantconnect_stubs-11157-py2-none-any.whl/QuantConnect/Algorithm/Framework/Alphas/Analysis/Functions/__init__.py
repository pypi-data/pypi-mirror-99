...
del sys.modules["QuantConnect.Algorithm.Framework.Alphas.Analysis.Functions"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.Framework.Alphas.Analysis.Functions")
from QuantConnect.Algorithm.Framework.Alphas.Analysis.Functions import *
