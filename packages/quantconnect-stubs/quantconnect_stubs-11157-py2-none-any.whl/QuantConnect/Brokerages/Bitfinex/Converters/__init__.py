...
del sys.modules["QuantConnect.Brokerages.Bitfinex.Converters"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.Bitfinex.Converters")
from QuantConnect.Brokerages.Bitfinex.Converters import *
