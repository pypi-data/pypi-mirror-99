...
del sys.modules["QuantConnect.Algorithm.Framework.Alphas.Analysis.Providers"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.Framework.Alphas.Analysis.Providers")
from QuantConnect.Algorithm.Framework.Alphas.Analysis.Providers import *
