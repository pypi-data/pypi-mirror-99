...
del sys.modules["QuantConnect.Brokerages.InteractiveBrokers.FinancialAdvisor"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.InteractiveBrokers.FinancialAdvisor")
from QuantConnect.Brokerages.InteractiveBrokers.FinancialAdvisor import *
