...
del sys.modules["QuantConnect.Brokerages.InteractiveBrokers.Client"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.InteractiveBrokers.Client")
from QuantConnect.Brokerages.InteractiveBrokers.Client import *
