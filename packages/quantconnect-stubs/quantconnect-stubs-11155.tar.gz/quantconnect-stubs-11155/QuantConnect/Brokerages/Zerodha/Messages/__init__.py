...
del sys.modules["QuantConnect.Brokerages.Zerodha.Messages"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.Zerodha.Messages")
from QuantConnect.Brokerages.Zerodha.Messages import *
