...
from ibvpy.view.plot3d.mayavi_util.pipelines \
...
#
#        if self.position == 'nodes':
#            subcell_offsets, subcell_lengths, subcells, subcell_types = self.old_dots.vtk_node_cell_data
#        elif self.position == 'int_pnts':
...
# vtk_cell_types.flatten()
    ...
    def _get_vtk_cell_data(self):
        ...
        #        cell_array, cell_offsets, cell_types = self.old_dots.get_vtk_cell_data(self.position)
