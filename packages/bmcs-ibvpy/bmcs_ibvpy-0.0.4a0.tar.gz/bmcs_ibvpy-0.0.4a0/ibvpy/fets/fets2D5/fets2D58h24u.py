...
#-----------------------------------------------------------------------------------
# FETS2D58H24U -  degenerated subparametric 3D volume element using a 2D material model
#                 rs-direction: cubic (serendipity)
#                 t-direction: linear
#-----------------------------------------------------------------------------------


class FETS2D58H24U(FETS3D8H24U):
    ...
    def get_eps_eng(self, sctx, u):
        ...
        eps_eng3D = super(FETS2D58H24U, self).get_eps_eng(sctx, u)
