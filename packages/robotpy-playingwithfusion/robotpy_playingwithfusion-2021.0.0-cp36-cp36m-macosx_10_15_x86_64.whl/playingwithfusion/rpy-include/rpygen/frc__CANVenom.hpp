...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__CANVenom : PyBasefrc__CANVenom<PyTrampolineBase, CxxBase> {
    using PyBasefrc__CANVenom<PyTrampolineBase, CxxBase>::PyBasefrc__CANVenom;
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "set", Set,command);    }
#endif
