...
class UserUttered(Event):
    ...
    def __init__(
        ...
        recordingId=None,
        missed_intent=None,
        text_redacted: Optional[Text] = None,
        entities_redacted= None
    ):
        self.text = text
        self.text_redacted = text_redacted if text_redacted else text
        ...
        if parse_data:
            ...
            self.parse_data['metadata'] = self.metadata
        else:
            self.parse_data = {
                "intent": self.intent,
        ...
        self.entities_redacted = entities_redacted if entities_redacted else self.entities
    ...
    def redact_msg(message):
        ...
        if message:
            ...
            phrase_arr = re.sub('\d', '{REDACTED}', text_numeric).split()
            res = ' '.join(list(map(normalize_redaction, phrase_arr)))
            return res
        else:
            return message
...
class BotUttered(Event):
    ...
    def __init__(self, text=None, data=None, metadata=None, timestamp=None, message_id=None):
        self.text = text
        self.data = data or {}
