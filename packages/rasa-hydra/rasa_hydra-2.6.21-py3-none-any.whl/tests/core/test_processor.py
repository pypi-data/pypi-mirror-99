...
async def test_redaction(default_processor: MessageProcessor):
    message_1 = UserUttered.redact_msg("hello")
    message_2 = UserUttered.redact_msg("7/12/1996")
    message_3 = UserUttered.redact_msg("five dollars")
    message_4 = UserUttered.redact_msg("5 dollars")
    message_5 = UserUttered.redact_msg("5.50")
    message_6 = UserUttered.redact_msg("1a2a3")
    message_7 = UserUttered.redact_msg("one hundred")
    message_8 = UserUttered.redact_msg("5 and eight")
    message_9 = UserUttered.redact_msg("one thousand six hundred sixty six" )
    message_10 = UserUttered.redact_msg("one thousand and six hundred and sixty six")
    assert message_1 == "hello"
    assert message_2 == "****"
    assert message_3 == "**** dollars"
    assert message_4 == "**** dollars"
    assert message_5 == "****"
    assert message_6 == "****"
    assert message_7 == "****"
    assert message_8 == "**** and ****"
    assert message_9 == "****"
    assert message_10 == "****"
