...
class EndpointConfig:
    ...
    def session(self):
        ...
        async def on_request_end(session, trace_config_ctx, params):
            if trace_config_ctx.trace_request_ctx:
                ...
                logger.info("[{}] - Request ({}) took {}s".format(
                    trace_config_ctx.trace_request_ctx.get("sender_id", "NA"),
                    trace_config_ctx.trace_request_ctx.get("url", "NA"),
                    elapsed)
                )
    ...
    async def request(
        ...
        **kwargs: Any,
        ...
        trace_request_ctx = {"sender_id": headers.get("Conversation-Id"), "url": url}
