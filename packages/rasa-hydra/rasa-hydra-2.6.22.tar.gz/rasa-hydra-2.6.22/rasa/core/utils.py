...
class AvailableEndpoints:
    ...
    def read_endpoints(cls, endpoint_file):
        ...
        duckling = read_endpoint_config(endpoint_file, endpoint_type="duckling")
        idp = read_endpoint_config(endpoint_file, endpoint_type="idp")
        upm = read_endpoint_config(endpoint_file, endpoint_type="upm")

        return cls(nlg, nlu, action, model, tracker_store, lock_store, event_broker, duckling,  idp, upm)
