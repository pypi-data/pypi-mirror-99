...
class ScheduleRequest(ActionServerRequest):
    def __init__(self,
                 schedule_request: ActionServerRequest,
                 time: datetime,
                 immediate_request: ActionServerRequest = Tell("")
                 ):
        super().__init__(
            immediate_request.request,
            immediate_request.variables,
            immediate_request.user_request,
            {
                "time": time.strftime("%Y/%m/%d, %H:%M:%S"),
                "request": schedule_request.publish()
            }
        )
