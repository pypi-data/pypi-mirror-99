...
from .wheel import Wheel, DEFAULT_UNLOCKED, DEFAULT_UNLOCK_TIME
...
def main():
    ...
    p.add_argument(
        '--sec', '-s', type=int, default=DEFAULT_UNLOCK_TIME,
        help='number of seconds until wheel is relocked, default: %(default)d',
    )
    ...
    if args.cmd == 'lock':
        ...
        wheel.unlock_wheel(pw, unlock_time=args.sec)
    elif args.cmd == 'dump':
        pw = None
