...
- n_keydowns (number; default 0): A counter, which is incremented on each key down event, similar to n_clicks for buttons."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, eventProps=Component.UNDEFINED, captureKeys=Component.UNDEFINED, keydown=Component.UNDEFINED, n_keydowns=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'eventProps', 'captureKeys', 'keydown', 'n_keydowns']
        self._type = 'Keyboard'
        self._namespace = 'dash_extensions'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'eventProps', 'captureKeys', 'keydown', 'n_keydowns']
