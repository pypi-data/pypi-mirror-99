...
_RequiredEncryptionTypeDef = TypedDict("_RequiredEncryptionTypeDef", {"RoleArn": str})
_OptionalEncryptionTypeDef = TypedDict(
    "_OptionalEncryptionTypeDef",
    {
        ...
        "DeviceId": str,
        "KeyType": Literal["speke", "static-key", "srt-password"],
        "Region": str,
        "ResourceId": str,
        "SecretArn": str,
        "Url": str,
...
_RequiredTransportTypeDef = TypedDict(
    ...
    {"Protocol": Literal["zixi-push", "rtp-fec", "rtp", "zixi-pull", "rist", "srt-listener"]},
)
