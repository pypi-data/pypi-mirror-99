...
fastcall_func bytesio_read_orig;
fastcall_func bytesio_readline_orig;
fastcall_func bytesio_readlines_orig;
fastcall_func bytesio_read1_orig;


HOOK_STREAM_FASTCALL(bytesio_read, "read");
HOOK_STREAM_FASTCALL(bytesio_readline, "readline");
HOOK_STREAM_FASTCALL(bytesio_readlines, "readlines");
HOOK_STREAM_FASTCALL(bytesio_read1, "read1");
