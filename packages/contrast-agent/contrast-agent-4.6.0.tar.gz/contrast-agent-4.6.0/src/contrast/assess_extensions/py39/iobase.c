...
fastcall_func iobase_readline_orig;
fastcall_func iobase_readlines_orig;


HOOK_STREAM_FASTCALL(iobase_readline, "readline");
HOOK_STREAM_FASTCALL(iobase_readlines, "readlines");
