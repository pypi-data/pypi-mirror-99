...
HOOK_BINARYFUNC(bytearray_removeprefix, "removeprefix");
HOOK_BINARYFUNC(bytearray_removesuffix, "removesuffix");
...
int apply_bytearray_patches(funchook_t *funchook) {
    ...
    ADD_METHOD_HOOK(PyByteArray_Type, bytearray_removeprefix, BYTEARRAY_REMOVEPREFIX_OFFSET);
    ADD_METHOD_HOOK(PyByteArray_Type, bytearray_removesuffix, BYTEARRAY_REMOVESUFFIX_OFFSET);
