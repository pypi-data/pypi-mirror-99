...
HOOK_TERNARYFUNC(bytes_encode, "encode");
HOOK_TERNARYFUNC(bytes_decode, "decode");
HOOK_BINARYFUNC(bytes_replace, "replace");
HOOK_BINARYFUNC(bytes_split, "split");
HOOK_BINARYFUNC(bytes_rsplit, "rsplit");
...
HOOK_BINARYFUNC(bytes_expandtabs, "expandtabs");
...
HOOK_BINARYFUNC(bytes_splitlines, "splitlines");
...
int apply_bytes_patches(funchook_t *funchook) {
    ...
    ADD_METHOD_HOOK(PyBytes_Type, bytes_encode, BYTES_ENCODE_OFFSET);
