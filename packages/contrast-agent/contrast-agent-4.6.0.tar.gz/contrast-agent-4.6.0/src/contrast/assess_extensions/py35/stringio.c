...
binaryfunc stringio_read_orig;
binaryfunc stringio_readline_orig;


HOOK_STREAM_BINARYFUNC(stringio_read, "read");
HOOK_STREAM_BINARYFUNC(stringio_readline, "readline");
