...
#define UNICODE_ZFILL_OFFSET 40
#define UNICODE_FORMATMAP_OFFSET 42


ternaryfunc unicode_encode_orig;
binaryfunc unicode_replace_orig;
ternaryfunc unicode_split_orig;
ternaryfunc unicode_rsplit_orig;
...
ternaryfunc unicode_expandtabs_orig;
...
ternaryfunc unicode_splitlines_orig;
...
HOOK_TERNARYFUNC(unicode_split, "split");
HOOK_TERNARYFUNC(unicode_rsplit, "rsplit");
...
HOOK_TERNARYFUNC(unicode_expandtabs, "expandtabs");
...
HOOK_TERNARYFUNC(unicode_splitlines, "splitlines");
