...
from contrast.extern.ruamel.yaml.compat import PY2, string_types, MutableSliceableSequence
from contrast.extern.ruamel.yaml.scalarstring import ScalarString
from contrast.extern.ruamel.yaml.anchor import Anchor
...
class CommentedBase(object):
    ...
    def yaml_set_comment_before_after_key(
        ...
        """
        from contrast.extern.ruamel.yaml.error import CommentMark
        from contrast.extern.ruamel.yaml.tokens import CommentToken
