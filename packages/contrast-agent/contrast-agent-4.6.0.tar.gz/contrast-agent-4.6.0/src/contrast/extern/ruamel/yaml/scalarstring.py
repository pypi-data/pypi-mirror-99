...
from contrast.extern.ruamel.yaml.compat import text_type
...
def walk_tree(base, map=None):
    ...
    """
    from contrast.extern.ruamel.yaml.compat import string_types
    from contrast.extern.ruamel.yaml.compat import MutableMapping, MutableSequence  # type: ignore
