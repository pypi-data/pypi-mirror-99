...
# fmt: off
from contrast.extern.ruamel.yaml.error import (MarkedYAMLError, MarkedYAMLFutureWarning,
                               MantissaNoDotYAML1_1Warning)
from contrast.extern.ruamel.yaml.nodes import *                               # NOQA
from contrast.extern.ruamel.yaml.nodes import (SequenceNode, MappingNode, ScalarNode)
from contrast.extern.ruamel.yaml.compat import (utf8, builtins_module, to_str, PY2, PY3,  # NOQA
                                text_type, nprint, nprintf, version_tnf)
from contrast.extern.ruamel.yaml.compat import ordereddict, Hashable, MutableSequence  # type: ignore
from contrast.extern.ruamel.yaml.compat import MutableMapping  # type: ignore

from contrast.extern.ruamel.yaml.comments import *                               # NOQA
from contrast.extern.ruamel.yaml.comments import (CommentedMap, CommentedOrderedMap, CommentedSet,
                                  CommentedKeySeq, CommentedSeq, TaggedScalar,
                                  CommentedKeyMap)
from contrast.extern.ruamel.yaml.scalarstring import (SingleQuotedScalarString, DoubleQuotedScalarString,
                                      LiteralScalarString, FoldedScalarString,
                                      PlainScalarString, ScalarString,)
from contrast.extern.ruamel.yaml.scalarint import ScalarInt, BinaryInt, OctalInt, HexInt, HexCapsInt
from contrast.extern.ruamel.yaml.scalarfloat import ScalarFloat
from contrast.extern.ruamel.yaml.scalarbool import ScalarBoolean
from contrast.extern.ruamel.yaml.timestamp import TimeStamp
from contrast.extern.ruamel.yaml.util import RegExp
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node, seqtyp, deep=False):
        ...
        if node.anchor:
            from contrast.extern.ruamel.yaml.serializer import templated_id
