...
from contrast.extern.ruamel.yaml.emitter import Emitter
from contrast.extern.ruamel.yaml.serializer import Serializer
...
from contrast.extern.ruamel.yaml.resolver import Resolver, BaseResolver, VersionedResolver

if False:  # MYPY
    from typing import Any, Dict, List, Union, Optional  # NOQA
    from contrast.extern.ruamel.yaml.compat import StreamType, VersionType  # NOQA
