...
from contrast.extern.ruamel.yaml.error import YAMLError, FileMark, StringMark, YAMLStreamError
from contrast.extern.ruamel.yaml.compat import text_type, binary_type, PY3, UNICODE_SIZE
...
#    from contrast.extern.ruamel.yaml.compat import StreamTextType  # NOQA
