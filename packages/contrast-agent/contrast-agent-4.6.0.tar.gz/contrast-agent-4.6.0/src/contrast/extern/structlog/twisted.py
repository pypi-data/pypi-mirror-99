...
from contrast.extern.six import PY2, string_types
...
class LoggerFactory(object):
    ...
    >>> from contrast.extern.structlog import configure
    >>> from contrast.extern.structlog.twisted import LoggerFactory
