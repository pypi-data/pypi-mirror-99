...
from contrast.extern.webob.acceptparse import (
...
from contrast.extern.webob.cachecontrol import (
    CacheControl,
...
from contrast.extern.webob.cookies import RequestCookies
...
from contrast.extern.webob.etag import (
    IfRange,
    AnyETag,
    NoETag,
    etag_property,
...
from contrast.extern.webob.headers import EnvironHeaders

from contrast.extern.webob.multidict import (
    NestedMultiDict,
    MultiDict,
    NoVars,
    GetDict,
...
class BaseRequest(object):
    ...
    def make_default_send_app(self):
        ...
        try:
            ...
            from contrast.extern.webob import client
            _client = client
