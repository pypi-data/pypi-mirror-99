GRAMMAR_DICT = {'sources': {'publications': {'fields': {'relative_citation_ratio': {'type': 'float',
    ...
    'funder_countries': {'type': 'countries',
     'description': 'The country of the GRID organisation funding this publication.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'research_org_country_names': {'type': 'string',
     'description': 'Country name of the GRID organisations authors are affiliated to, as a string.',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    'research_org_countries': {'type': 'countries',
     'description': 'Country of the GRID organisations authors are affiliated to, identified using GeoNames codes (note: this field supports :ref:`filter-functions`: ``count``).',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'reference_ids': {'type': 'identifier',
     'description': 'Dimensions publication ID for publications in the references list, i.e. outgoing citations (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'supporting_grant_ids': {'type': 'identifier',
     'description': 'Grants supporting a publication, returned as a list of dimensions grants IDs  (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'research_org_state_names': {'type': 'string',
     'description': 'State name of the GRID organisations authors are affiliated to, as a string.',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    'researchers': {'type': 'researchers',
     'description': "Researcher IDs matched to the publication's authors list. (note: this returns only the disambiguated authors of a publication; in order to get the full authors list, the field `author_affiliations` should be used). This field supports :ref:`filter-functions`: ``count``.",
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'research_org_cities': {'type': 'cities',
     'description': 'City of the GRID organisations authors are affiliated to, expressed as GeoNames ID and name.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'research_org_state_codes': {'type': 'states',
     'description': 'State of the GRID organisations authors are affiliated to, expressed as GeoNames codes (ISO\u200c-3166-2).',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'FOR_first': {'type': 'categories',
     'description': '`ANZSRC Fields of Research classification <https://app.dimensions.ai/browse/publication/for>`_ , first level or 2 digit codes.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'pmcid': {'type': 'identifier',
     ...
     'is_facet': False},
    'FOR': {'type': 'categories',
     'description': '`ANZSRC Fields of Research classification <https://app.dimensions.ai/browse/publication/for>`_ , second level or 4 digit codes.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
   ...
   'metrics': {'count': {'name': 'count', 'description': 'Total count'},
    ...
    'fcr_gavg': {'name': 'fcr_gavg',
     'description': 'Geometric mean of `field_citation_ratio` field.'}},
   'search_fields': ['title_only',
    'title_abstract_only',
    'authors',
    'concepts',
    'full_data']},
  'grants': {'fields': {'funding_org_name': {'type': 'label',
    ...
    'research_org_name': {'type': 'label',
     'description': 'Name of the research organisations receiving the grant.',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': True},
    ...
    'research_org_cities': {'type': 'cities',
     ...
     'is_facet': True},
    'research_org_state_codes': {'type': 'states',
     'description': 'State of the GRID organisations receiving the grant, expressed as GeoNames codes (ISO\u200c-3166-2).',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'end_date': {'type': 'timestamp',
     ...
     'is_filter': True,
     'is_facet': False},
    'investigator_details': {'type': 'json',
   ...
   'search_fields': ['title_only',
    ...
    'concepts',
    'full_data']},
  'patents': {'fields': {'assignee_names': {'type': 'string',
    ...
    'publication_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the publications related to this patent (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'current_assignees': {'type': 'orgs',
     'description': 'GRID organisations currenlty owning the patent.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'associated_grant_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the grants associated to the patent (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    'assignee_cities': {'type': 'cities',
     'description': 'City of the GRID assignees of the patent, expressed as GeoNames ID and name.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'year': {'type': 'integer',
     ...
     'is_facet': True},
    'reference_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the patents which are cited by this patent (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'original_assignees': {'type': 'orgs',
     'description': 'GRID organisations that first owned the patent.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'current_assignee_names': {'type': 'string',
     'description': 'Names of the GRID organisations currently holding the patent.',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'funder_groups': {'type': 'org_groups',
     'description': 'Organisation group the GRID patent funder belongs to.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'cited_by_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the patents that cite this patent (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'original_assignee_names': {'type': 'string',
     'description': 'Name of the GRID organisation that first owned the patent.',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    'ipcr': {'type': 'identifier',
    ...
    'assignee_state_codes': {'type': 'states',
     'description': 'State of the GRID assignee, expressed using GeoNames (ISO\u200c-3166-2) codes.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    ...
    'assignee_countries': {'type': 'countries',
     'description': 'Country of the GRID assignees of the patent, expressed as GeoNames code and name.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'id': {'type': 'identifier',
     ...
     'is_facet': False},
    'assignees': {'type': 'orgs',
     'description': 'GRID organisations who own or have owned the rights of a patent (note: this is a combination of `current_assignees` and `original_assigness` fields).',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
  ...
  'clinical_trials': {'fields': {'funder_countries': {'type': 'countries',
     'description': 'The country group the GRID funding organisations.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'gender': {'type': 'string',
     ...
     'is_facet': False},
    'publication_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the publications related to this clinical trial (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'phase': {'type': 'string',
     ...
     'is_facet': False},
    'associated_grant_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the grants associated to the clinical trial (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'HRCS_HC': {'type': 'categories',
     ...
     'is_facet': True},
    'funder_groups': {'type': 'org_groups',
     'description': 'The organisation group the GRID funding organisations.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
   ...
   'search_fields': ['title_only',
    ...
    'investigators',
    'full_data']},
  'policy_documents': {'fields': {'health_research_areas': {'type': 'categories',
     'description': '`Health Research Areas categorization <https://app.dimensions.ai/browse/publication/health_research_areas>`_ .',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'publication_ids': {'type': 'identifier',
     'description': 'Dimensions IDs of the publications related to this policy document (see also: :ref:`data-model` section).',
     'long_description': None,
     'is_entity': False,
     'is_filter': True,
     'is_facet': False},
    ...
    'year': {'type': 'integer',
     ...
     'is_filter': True,
     'is_facet': True},
    'publisher_org_city': {'type': 'cities',
     'description': 'City of the GRID organization publishing the policy document.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'HRCS_HC': {'type': 'categories',
     ...
     'is_filter': True,
     'is_facet': True},
    'publisher_org_state': {'type': 'states',
     'description': 'State of the GRID organization publishing the policy document.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'publisher_org_country': {'type': 'countries',
     'description': 'Country of the GRID organization publishing the policy document.',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
    'publisher_org': {'type': 'orgs',
    ...
    'broad_research_areas': {'type': 'categories',
     'description': '`Broad Research Areas categorization <https://app.dimensions.ai/browse/publication/broad_research_areas>`_  .',
     'long_description': None,
     'is_entity': True,
     'is_filter': True,
     'is_facet': True},
  ...
  'researchers': {'fields': {'id': {'type': 'identifier',
