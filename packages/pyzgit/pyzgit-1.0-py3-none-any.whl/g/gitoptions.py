...
from g.shared import echo, Color, Style, run_shell
...
GIT_OPTIONS = {
    ...
    'cs': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command': 'git show --pretty=format:"${_git_log_fuller_format}" ',
    ...
    'Cl': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command': '$(_lists_unmerge_file) ',
        'help-msg': 'lists unmerged files.',
    },
    'Ca': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command': 'git add $(_lists_unmerge_file) ',
        'help-msg': 'adds unmerged file contents to the index.',
    },
    'Ce': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command': 'git mergetool $(_lists_unmerge_file) ',
    ...
    'CO': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command': 'git checkout --ours -- $(_lists_unmerge_file) ',
    ...
    'CT': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command': 'git checkout --theirs -- $(_lists_unmerge_file) ',
    ...
    'ld': {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command':
            'git log --topo-order --stat --patch --pretty=format:"${_git_log_fuller_format}" ',
        'help-msg':
    ...
    "pc": {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command':
            'git push --set-upstream origin "$(_git_current_branch 2> /dev/null)" ',
        'help-msg':
    ...
    "pp": {
        'state': 0 | GitOptionState.STRING | GitOptionState.MULTI,
        'command':
            'git pull origin "$(_git_current_branch 2> /dev/null)" && git push origin "$(_git_current_branch 2> /dev/null)" ',
        'help-msg':
