...
class ArealDataExtractor(object):
    def __init__(self, rm, period=None):
        self.rm = rm
        stack_names = {'PTSTKModel': 'ptstk', 'PTHSKModel': 'pthsk', 'PTGSKModel': 'ptgsk', 'PTSSKModel': 'ptssk',
                       'PTSTKOptModel': 'ptstk', 'PTHSKOptModel': 'pthsk', 'PTGSKOptModel': 'ptgsk',
                       'PTSSKOptModel': 'ptssk'}
        ...
        self.outputs = {'ptstk':
                            ...
                            'snow_tiles_response': {'sout': 'outflow', 'glacier_melt': 'glacier_melt'},
                            'kirchner_state': {'q_inst': 'discharge'},
                            'snow_tiles_state': {'sca': 'sca', 'swe': 'swe'}},
                        'ptgsk':
                            {'priestley_taylor_response': {'pet': 'output'},
                            'actual_evaptranspiration_response': {'aet': 'output'},
