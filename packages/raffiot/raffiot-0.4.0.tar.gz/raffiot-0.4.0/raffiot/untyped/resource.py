...
from raffiot.untyped import _runtime
from raffiot.untyped import io
from raffiot.untyped._internal import IOTag
...
def defer_resource(deferred, *args, **kwargs):
    """
...
def defer_read(deferred, *args, **kwargs):
    """
...
def defer_read_resource(deferred, *args, **kwargs):
    """
...
def sleep_until(epoch_in_seconds):
    """
...
reentrant_lock = io.defer(_runtime.Lock).map(
