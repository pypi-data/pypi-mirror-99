...
class BasicTrainer(Trainer):
    ...
    def __init__(
        self, 
        # logger
        tracking_uri=None, experiment_name='Default', run_name=None, user=None, data_dir=None, results_dir='results',
        ...
        # when local db is selected
        if tracking_uri is None:
            # parse tracking_uri and artifact_root (weights_save_path)
            tracking_uri, artifact_root = migrate_experiments(root='.', subdir=results_dir)
            _logger_params = {
                'tracking_uri': tracking_uri,
                'artifact_root': artifact_root,
            }
        # when remote db is selected
        else:
            _logger_params = {
                'tracking_uri': tracking_uri,
            }
