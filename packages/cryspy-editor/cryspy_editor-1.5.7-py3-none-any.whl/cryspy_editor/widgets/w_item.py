from .FUNCTIONS import make_qtablewidget_for_item_constr, show_info, get_layout_method_help, \
    get_layout_internal_attribute, get_layout_rciftab_obj, make_qtablewidget_for_item

from PyQt5 import QtWidgets, QtGui, QtCore


def w_for_item(obj, layout_11, layout_12, layout_13, layout_2, layout_3, w_output, thread):
    layout_11.addWidget(QtWidgets.QLabel("Mandatory and optional attributes"))
    w_t = make_qtablewidget_for_item(obj, label=w_output)
