...
from rulemanager import PACKAGE, __version__
...
# url formatting
url_sc = c.URL + 'https://github.com/fstab50/rulemanager' + c.RESET
...
copyright = c.LT2GRAY + """
    ...
    GPLv3 LICENSE. Copyright notice must remain with derivative work.""" + c.RESET + """
    __________________________________________________________________
        """ + c.RESET
