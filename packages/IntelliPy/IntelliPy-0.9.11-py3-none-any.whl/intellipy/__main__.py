...
def main():
    ...
    if sucrose_label:
        ...
        #tk.Checkbutton(master, text="'Correct' but not '" + sucrose_label + "' treated as success for learning rate", variable=water_y_suc_n).grid(row=3, column=2,
        #                                                                                               sticky=tk.W)
        #water_y_suc_y = tk.IntVar(value=0)
        #tk.Checkbutton(master, text="'Correct' and '" + sucrose_label + "' treated as success for learning rate", variable=water_y_suc_y).grid(row=4, column=2,
        #                                                                                             sticky=tk.W)
    #    water_n_suc_y = tk.IntVar()
    #    tk.Checkbutton(master, text="Water: Incorrect, " + sucrose_label + ": Correct", variable=water_n_suc_y).grid(row=5, column=2,
    #                                                                                               sticky=tk.W)
