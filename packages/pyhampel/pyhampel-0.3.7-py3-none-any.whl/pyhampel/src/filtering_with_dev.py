"""
This module contains filtering functions with deviation from median
"""
...
def hampel_filter_dev_list_of_ts(ts_list: list, vals_col: str, time_col=None,
    ...
    for ts in ts_list:
        filtered_ts.append(hampel_filter_with_dev_df(ts, vals_col, time_col, win_size, num_dev, center_win))
    return filtered_ts
