...
class ExportersCoreExportsApi(object):
    ...
    def create(self, pulp_exporter_href, pulp_export, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(pulp_exporter_href, pulp_export, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_with_http_info(pulp_exporter_href, pulp_export, **kwargs)  # noqa: E501

    def create_with_http_info(self, pulp_exporter_href, pulp_export, **kwargs):  # noqa: E501
        """Create a pulp export  # noqa: E501

        Trigger an asynchronous task to export a set of repositories  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(pulp_exporter_href, pulp_export, async_req=True)
        >>> result = thread.get()
    ...
    def delete(self, pulp_pulp_export_href, **kwargs):  # noqa: E501
        """Delete a pulp export  # noqa: E501

        ViewSet for viewing exports from a PulpExporter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(pulp_pulp_export_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str pulp_pulp_export_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(pulp_pulp_export_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, pulp_pulp_export_href, **kwargs):  # noqa: E501
        """Delete a pulp export  # noqa: E501

        ViewSet for viewing exports from a PulpExporter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(pulp_pulp_export_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_pulp_export_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_pulp_export_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_pulp_export_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'pulp_pulp_export_href' in local_var_params:
            path_params['pulp_pulp_export_href'] = local_var_params['pulp_pulp_export_href']  # noqa: E501
    ...
    def read(self, pulp_pulp_export_href, **kwargs):  # noqa: E501
        """Inspect a pulp export  # noqa: E501

        ViewSet for viewing exports from a PulpExporter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(pulp_pulp_export_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(pulp_pulp_export_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, pulp_pulp_export_href, **kwargs):  # noqa: E501
        """Inspect a pulp export  # noqa: E501

        ViewSet for viewing exports from a PulpExporter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(pulp_pulp_export_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_pulp_export_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_pulp_export_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_pulp_export_href` when calling `read`")  # noqa: E501
