...
from flask_response_builder.config import DEFAULT_BUILDERS
...
class FlaskResponseBuilder:
    ...
    def on_format(self, default=None, acceptable=None):
        ...
        def response(fun):
            ...
            def wrapper(*args, **kwargs):
                ...
                if fmt not in (acceptable or DEFAULT_BUILDERS.keys()):
                    fmt = default or 'json'
        ...
        def response(fun):
            ...
            def wrapper(*args, **kwargs):
                ...
                if request.accept_mimetypes is None or str(request.accept_mimetypes) == '*/*':
                    ...
                    mimetypes_list = acceptable or [v for _, v in DEFAULT_BUILDERS.items()]
                    accept = request.accept_mimetypes.best_match(mimetypes_list)

                for k, v in DEFAULT_BUILDERS.items():
                    if accept == v:
    ...
    def response(self, fmt: str, **kwargs):
        ...
        :return:
        """
        if fmt not in DEFAULT_BUILDERS.keys():
            raise NameError("Builder not found: using one of: {}".format(DEFAULT_BUILDERS.keys()))
    ...
    def base64(self, data, headers=None, status=None, enc=None, ct=None):
        ...
        return Response(
            ...
            mimetype="{};{}".format(DEFAULT_BUILDERS['base64'], encoding),
            status=status or 200,
            headers={
                'Content-Type': ct or DEFAULT_BUILDERS['base64'],
                **(headers or {})
            }
        )
    ...
    def csv(self, data, headers=None, status=None, filename=None):
        ...
        return Response(
            ...
            mimetype=DEFAULT_BUILDERS['csv'],
            status=status or 200,
            headers={
                'Content-Type': DEFAULT_BUILDERS['csv'],
                'Total-Rows': len(data),
    ...
    def xml(self, data, headers=None, status=None, root=None, **kwargs):
        ...
        return Response(
            ...
            mimetype=DEFAULT_BUILDERS['xml'],
            status=status or 200,
            headers={
                'Content-Type': DEFAULT_BUILDERS['xml'],
                **(headers or {})
            }
        )
    ...
    def json(self, data, headers=None, status=None, **kwargs):
        ...
        return Response(
            ...
            mimetype=DEFAULT_BUILDERS['json'],
            status=status or 200,
            headers={
                'Content-Type': DEFAULT_BUILDERS['json'],
                **(headers or {})
            }
        )
    ...
    def yaml(self, data, headers=None, status=None, unicode=None):
        ...
        return Response(
            ...
            mimetype=DEFAULT_BUILDERS['yaml'],
            headers={
                'Content-Type': DEFAULT_BUILDERS['yaml'],
                **(headers or {})
            },
            status=status or 200
        )
