...
class Transformer:
    ...
    def json_to_yaml(data: str, json_args=None, yaml_args=None):
        ...
        :return:
        """
        return Transformer.transform(JsonBuilder, YamlBuilder, data, json_args, yaml_args)
    ...
    def yaml_to_json(data: str, yaml_args=None, json_args=None):
        ...
        :return:
        """
        return Transformer.transform(YamlBuilder, JsonBuilder, data, yaml_args, json_args)
