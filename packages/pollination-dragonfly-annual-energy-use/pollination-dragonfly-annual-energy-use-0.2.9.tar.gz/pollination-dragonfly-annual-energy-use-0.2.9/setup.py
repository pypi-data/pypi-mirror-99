...
setuptools.setup(
    name='pollination-dragonfly-annual-energy-use',                                     # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    project_urls={
        'icon': 'https://raw.githubusercontent.com/ladybug-tools/artwork/master/icons_components/dragonfly/png/dfeui.png',
    ...
    keywords='dragonfly, energy, ladybug-tools, energyplus, openstudio, energy, dragonfly-annual-energy-use',  # will be used as keywords
