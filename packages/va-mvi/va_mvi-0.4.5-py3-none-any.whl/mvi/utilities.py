...
def get_db_table_limit() -> int:
    ...
    Reads from the environment variable MVI_SERVICE_DB_TABLE_LIMIT.
    ...
    table_limit = os.environ.get("MVI_SERVICE_DB_TABLE_LIMIT", "365days")
    ...
    LOGGER.error(
        "Wrong format of environment variable MVI_SERVICE_DB_TABLE_LIMIT."
