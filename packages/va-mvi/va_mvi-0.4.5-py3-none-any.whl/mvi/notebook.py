...
def service_cell(project_dir, cell):
    """Create the necessary boilerplate for an MVI service and write the
    ...
    # Create requirements.txt file with va-mvi
    requirements_path = project_dir / "requirements.txt"
    if not requirements_path.is_file():
        with open(requirements_path, "w") as file_handle:
            file_handle.write("va-mvi")
