...
```shell
pip install antipetros_discordbot==1.1.10
```
...
- **POST_FAQ_BY_NUMBER**
    ...
    - **aliases:** *faq*, *post+faq+by+number*, *post-faq-by-number*, *post.faq.by.number*, *postfaqbynumber*
...
- **FLIP_COIN**
    ...
    - **aliases:** *flip*, *flip.coin*, *coinflip*, *flip+coin*, *flipcoin*, *flip-coin*
