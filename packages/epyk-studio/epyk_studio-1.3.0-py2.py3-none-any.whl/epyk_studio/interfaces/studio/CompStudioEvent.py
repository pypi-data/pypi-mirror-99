...
class Event:
  ...
  def certificate(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def progress(self, percentage, icon="fas fa-plane", width=(100, '%'), height=("auto", ''), options=None,
               profile=None):
    """
    Description:
    ------------
    ...
    """
    options = options or {}
    icon = self.page.ui.icons.awesome(icon, height=("auto", ''), profile=profile)
    icon.icon.style.css.color = self.page.theme.colors[-1]
    progress = self.page.ui.div()
    progress.style.css.border = "1px solid %s" % self.page.theme.colors[-1]
    progress.style.css.display = "inline-block"
    progress.style.css.width = "calc(100% - 50px)"
    inner = self.page.ui.div("%s%%" % percentage, width=(percentage, '%'), options=options, profile=profile)
    inner.style.css.background = self.page.theme.colors[4]
    inner.style.css.color = self.page.theme.greys[0]
    inner.style.css.text_align = "center"
    progress.add(inner)
    container = self.page.ui.div([progress, icon], width=width, height=height, options=options, profile=profile)
  ...
  def search(self, text="", placeholder=None, icon="fas fa-search", width=(100, "%"), height=(None, "px"),
    ...
    container.input = self.page.ui.inputs.d_search(
      text, placeholder, width, height, html_code, options, attrs, profile)
    container.input.style.css.border = "1px solid %s" % self.page.theme.greys[3]
    container.input.style.css.padding = "0 30px"
    container.input.style.css.text_align = "left"
    container.add(container.input)
    container.icon = self.page.ui.icons.awesome(icon, profile=profile)
  ...
  def delimiter(self, size=1):
    ...
    Attributes:
    ----------
    :param size: Integer. Optional. The delimiter size.
    """
  ...
  def avatar(self, image=None, size=80, text=None, html_code=None, profile=None, options=None):
    """
    Description:
    ------------
    ...
    img = self.page.ui.images.avatar(
      image=image, text=text, width=(size, 'px'), height=(size, 'px'), html_code=html_code, options=dfl_options,
      profile=profile)
    return img
  ...
  def comment(self, avatar, placeholder=None, width=(100, '%'), height=(None, 'px'), options=None, profile=None):
    ...
    container.text = self.page.ui.textarea(placeholder=placeholder)
    container.text.style.css.display = "inline-block"
    container.text.style.css.float = "right"
    container.text.style.css.color = self.page.theme.greys[4]
  ...
  def dated(self, date, name=None, width=(None, '%'), height=(None, 'px'), align="left", format=None, options=None,
    ...
    container = self.page.ui.div(width=width, height=height, options=options, profile=profile)
    container.text = self.page.ui.text(
      "Last updated %s, by" % py_date.strftime("%d %B %Y"), width=(None, ""), profile=profile)
    container.text.style.css.display = 'inline-block'
    container.text.style.css.color = self.page.theme.greys[5]
    container.add(container.text)
    container.name = self.page.ui.link(name, profile=profile)
    container.name.style.css.display = 'inline-block'
    container.name.style.css.color = self.page.theme.colors[-1]
    container.name.style.css.margin_left = 5
    container.add(container.name)
    container.style.css.text_align = align
    return container

  def flip(self, heads, tails, orientation='v', width=(300, 'px'), height=(200, 'px'), options=None, profile=None):
    """
    Description:
    ------------
    ...
    :param profile: Boolean | Dictionary. Optional. A flag to set the component performance storage.
    """
    flip_box = self.page.ui.div(width=width, height=height, options=options, profile=profile)
    ...
    flip_box.style.css.border = "1px solid %s" % self.page.theme.colors[3]
    flip_box.style.css.perspective = 1000

    flip_box_inner = self.page.ui.div(height=(100, '%'), profile=profile)
    ...
    flip_box_front = self.page.ui.div(height=(100, '%'), profile=profile)
    flip_box_front.style.css.position = "absolute"
    flip_box_front.style.css.backface_visibility = "hidden"

    flip_box_back = self.page.ui.div(height=(100, '%'), profile=profile)
    ...
    if not hasattr(heads, 'options'):
      flip_box.heads = self.page.ui.text(heads, height=(100, '%'), profile=profile)
    ...
    if not hasattr(tails, 'options'):
      flip_box.tails = self.page.ui.text(tails, height=(100, '%'), profile=profile)
      ...
      flip_box_back.style.css.background = self.page.theme.colors[3]
  ...
  def phone(self, number, icon="fas fa-phone-alt", width=('auto', ''), height=(None, 'px'), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def button(self, text, icon=None, border=True, background=True, width=(100, '%'), align="center", height=(None, 'px'),
  ...
  def sand_clock(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=False):
    """
    Description:
    ------------
  ...
  def flag(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=False):
    """
    Description:
    ------------
  ...
  def animator(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=False):
    """
    Description:
    ------------
...
class Wedding(Event):
  ...
  def theme(self):
    ...
    """
    self.page.theme = ThemeRed.Pink()

  def banner(self, data, size_notch=0, background=None, width=(100, '%'), align="center", height=(None, 'px'),
             options=None, profile=False):
    """
    Description:
    ------------
  ...
  def title(self, text=None, options=None, tooltip="", width=(None, "px"), height=('auto', ""), html_code=None,
            profile=False):
    """
    Description:
    ------------
  ...
  def picture(self, image=None, label=None, path=None, width=(100, "%"), height=(None, "px"), align="center",
    ...
    if height[0] is not None and width[1] == '%':
      width = ("auto", '')
    component = self.page.ui.div(align=align, width=width, height=height, options=options, profile=profile)
    component.image = html.HtmlImage.Image(
      self.page, image, path, align, html_code, (100, '%'), (100, '%'), profile, options or {})
  ...
  def address(self, street, postcode, city, icon="fas fa-map-marker-alt", align="left", width=("auto", ''),
  ...
  def block(self, text, align="left", width=("80", '%'), height=(None, "px"), options=None, profile=None):
    ...
    component.style.css.border_left = "3px solid %s" % self.page.theme.colors[-1]
    if not hasattr(text, 'options'):
      content = self.page.py.encode_html(text.strip())
      if options.get("initial-letter", False):
        content = '<span style="line-height:%spx;font-size:%spx;vertical-align:bottom">%s</span>%s' % (
          options.get("initial-letter"), options.get("initial-letter"), content[0], content[1:])
      component.text = self.page.ui.text(content, profile=profile)
  ...
  def paragraph(self, text, align="left", width=("80", '%'), height=(None, "px"), options=None, profile=None):
    ...
    :param profile: Boolean | Dictionary. Optional. A flag to set the component performance storage.
    """
    text = self.page.ui.text.paragraph(
      text, align=align, width=width, height=height, options=options, profile=profile)
    return text

  def ring(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def dress(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def cake(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def cocktail(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class Birthday(Event):
  ...
  def present(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def balloon(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def hat(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class Baptism(Event):
  ...
  def angel(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def church(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class Birth(Event):
  ...
  def day(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def baby(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def boy(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def girl(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class EVG(Event):
  ...
  def champagne(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def dice(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def purse(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class Seminar(Event):
  ...
  def conference(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
  ...
  def partner(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def team(self, fill=None, border=None, width=(50, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
    ...
    """
    svg = self.page.ui.pictos.path(
      fill=fill, stroke=border, width=width, height=height, viewbox=(150, 80), options=options, profile=profile,
  ...
  def direction(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def coffee(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class Show(Event):
  ...
  def button(self, text="", icon=None, width=(None, "%"), height=(None, "px"), align="left", html_code=None,
    ...
    """
    button = self.page.ui.button(
      text, icon, width=width, height=height, options=options, tooltip=tooltip, profile=profile, align=align)
    button.style.clear()
    button.style.css.padding = "0 10px"
    button.style.css.background = self.page.theme.greys[0]
  ...
  def music(self,  fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def movie(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def sing(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
...
class Dating(Event):
  ...
  def drinks(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def dinner(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    svg = self.page.ui.pictos.path(
      fill=fill, stroke=border, width=width, height=height, options=options, profile=profile,
  ...
  def love(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def like(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def broken(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def bed(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
  ...
  def heartbeat(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, profile=None):
    """
    Description:
    ------------
