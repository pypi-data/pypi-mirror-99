...
from ndu_gateway.tb_utility.tb_utility import TBUtility
from ndu_gateway.gateway.tb_client import TBClient
from ndu_gateway.gateway.tb_updater import TBUpdater
from ndu_gateway.gateway.tb_logger import TBLoggerHandler
from ndu_gateway.storage.memory_event_storage import MemoryEventStorage
from ndu_gateway.storage.file_event_storage import FileEventStorage
from ndu_gateway.gateway.tb_gateway_remote_configurator import RemoteConfigurator
from ndu_gateway.gateway.tb_remote_shell import RemoteShell
...
class TBGatewayService(Thread):
    def __init__(self, config_file=None, is_main_thread=True):
        ...
        from ndu_gateway.gateway.ndu_camera_embedded_connector import NDUGateCameraEmbeddedConnector
