...
def fix_files(
    ...
    *,
    transformer=tradeflowsCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the tradeflows client library.
