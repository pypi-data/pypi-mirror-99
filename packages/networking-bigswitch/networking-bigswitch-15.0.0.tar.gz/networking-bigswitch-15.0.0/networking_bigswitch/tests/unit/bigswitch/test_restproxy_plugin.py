...
# TODO(weifan): This blocks gating, skip for now, needs to be fixed
# functionally, port creation works and tempest tests pass
...
#             if ten_id != 'SHARED':
#                 raise Exception('expecting tenant_id SHARED. got %s'
#                                 % ten_id)
