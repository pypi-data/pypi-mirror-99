...
class ListEnvironmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEnvironments.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.35/reference/services/mwaa.html#MWAA.Paginator.ListEnvironments.paginate)
        """
