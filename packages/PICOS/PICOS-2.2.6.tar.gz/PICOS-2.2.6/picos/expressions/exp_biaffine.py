...
class BiaffineExpression(Expression, ABC):
    ...
    def _sparse_coefs(self):
        """Coefficients (re-)cast to sparse matrices."""
        return {mtbs: cvxopt.sparse(coef) for mtbs, coef in self._coefs.items()}
    ...
    def reshaped(self, shape):
        ...
        return self._basetype(string, shape, self._coefs)
