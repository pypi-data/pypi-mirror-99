...
from ...apps.api_gateway.functions import get_apigateway_profile_groups_from_header
...
class DjangoSsoAppAppBaseAuthenticationBackend(ModelBackend):
    ...
    def try_update_user(self, sso_id, user, user_profile, encoded_jwt, decoded_jwt):
        ...
        if rev_changed:
            ...
            user = update_local_user_from_remote_backend(remote_user_object=remote_user,
