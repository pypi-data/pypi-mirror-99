...
class DetailsReader:
    ...
    @staticmethod
    def load_local_master_details() -> dict:
        with open(file=f"{Paths.ABS_MARO_LOCAL}/cluster/master_details.yml", mode="r") as fr:
            master_details = yaml.safe_load(stream=fr)
