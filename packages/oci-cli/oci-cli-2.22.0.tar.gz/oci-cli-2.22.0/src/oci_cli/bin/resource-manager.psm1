...
function GetOciSubcommands_resource_manager() {
    $ociSubcommands = @{
        ...
        'resource-manager stack' = 'change-compartment copy create create-from-compartment create-from-git-provider create-from-template delete detect-drift get get-stack-tf-config get-stack-tf-state list list-resource-discovery-services list-resource-drift-details list-terraform-versions update update-from-git-provider'
