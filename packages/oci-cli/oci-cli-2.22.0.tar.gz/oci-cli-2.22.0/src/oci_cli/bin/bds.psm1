...
function GetOciSubcommands_bds() {
    $ociSubcommands = @{
        'bds' = 'auto-scale-config block-storage cloudsql instance work-request work-request-error work-request-log-entry'
...
function GetOciCommandsToLongParams_bds() {
    $ociCommandsToLongParams = @{
        'bds auto-scale-config create' = 'bds-instance-id cluster-admin-password display-name from-json help if-match is-enabled max-wait-seconds node-type policy wait-for-state wait-interval-seconds'
        ...
        'bds auto-scale-config edit' = 'auto-scaling-configuration-id bds-instance-id cluster-admin-password display-name force from-json help if-match is-enabled max-wait-seconds policy wait-for-state wait-interval-seconds'
