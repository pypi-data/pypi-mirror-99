...
function GetOciSubcommands_network() {
    $ociSubcommands = @{
        ...
        'network vcn' = 'add-vcn-cidr change-compartment create delete get list modify-vcn-cidr remove-vcn-cidr update'
...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        ...
        'network subnet update' = 'cidr-block defined-tags dhcp-options-id display-name force freeform-tags from-json help if-match max-wait-seconds route-table-id security-list-ids subnet-id wait-for-state wait-interval-seconds'
        ...
        'network vcn create' = 'cidr-block cidr-blocks compartment-id defined-tags display-name dns-label freeform-tags from-json help ipv6-cidr-block is-ipv6-enabled max-wait-seconds wait-for-state wait-interval-seconds'
