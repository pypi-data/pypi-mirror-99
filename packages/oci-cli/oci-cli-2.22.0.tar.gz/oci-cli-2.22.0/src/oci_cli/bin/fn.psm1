...
function GetOciCommandsToLongParams_fn() {
    $ociCommandsToLongParams = @{
        ...
        'fn application create' = 'compartment-id config defined-tags display-name freeform-tags from-json help max-wait-seconds subnet-ids syslog-url wait-for-state wait-interval-seconds'
        ...
        'fn application update' = 'application-id config defined-tags force freeform-tags from-json help if-match max-wait-seconds syslog-url wait-for-state wait-interval-seconds'
