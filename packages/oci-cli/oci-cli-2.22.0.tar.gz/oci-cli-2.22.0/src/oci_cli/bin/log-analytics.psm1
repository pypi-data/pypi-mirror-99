...
function GetOciSubcommands_log_analytics() {
    $ociSubcommands = @{
        'log-analytics' = 'assoc char-encoding-collection config-work-request content-export content-import entity entity-type field label log-group lookup namespace object-collection-rule parser query query-work-request scheduled-task source storage timezone-collection upload warning work-request work-request-error work-request-log'
        ...
        'log-analytics lookup' = 'append-data delete get list register-lookup update update-data'
        ...
        'log-analytics source' = 'delete-source get-column-names get-source get-source-summary list-meta-source-types list-source-extfield-defs list-source-functions list-source-label-operators list-source-patterns list-sources upsert-source validate-source validate-source-extfield-details'
        'log-analytics storage' = 'disable-archiving enable-archiving estimate-purge-data-size estimate-recall-data-size estimate-release-data-size get get-storage-usage get-storage-work-request list-recalled-data list-storage-work-request-errors list-storage-work-requests purge-storage-data recall-archived-data release-recalled-data update'
        'log-analytics timezone-collection' = 'list-supported-timezones'
        'log-analytics upload' = 'delete delete-upload-file delete-upload-warning get list list-upload-files list-upload-warnings upload-log-file validate-file validate-source-mapping'
...
function GetOciCommandsToLongParams_log_analytics() {
    $ociCommandsToLongParams = @{
        ...
        'log-analytics entity list' = 'all cloud-resource-id compartment-id entity-type-name from-json help hostname hostname-contains is-agent-id-null lifecycle-details-contains lifecycle-state limit name name-contains namespace namespace-name page page-size sort-by sort-order source-id'
        ...
        'log-analytics scheduled-task list' = 'all compartment-id display-name from-json help limit namespace namespace-name page page-size sort-by sort-order task-type'
        ...
        'log-analytics upload list' = 'all from-json help limit name name-contains namespace namespace-name page page-size sort-by sort-order'
        ...
        'log-analytics upload upload-log-file' = 'char-encoding content-md5 content-type date-format date-year entity-id file filename from-json help invalidate-cache log-source-name namespace namespace-name opc-meta-loggrpid timezone upload-name'
