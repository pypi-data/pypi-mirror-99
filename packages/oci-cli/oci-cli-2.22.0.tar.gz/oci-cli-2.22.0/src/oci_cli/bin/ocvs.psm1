...
function GetOciCommandsToLongParams_ocvs() {
    $ociCommandsToLongParams = @{
        ...
        'ocvs sddc create' = 'ad compartment-id compute-availability-domain defined-tags display-name esxi-count freeform-tags from-json hcx-vlan-id help instance-prefix is-hcx-enabled max-wait-seconds name nsx-edge-up1-id nsx-edge-up2-id nsx-edge-vtep-id nsx-vtep-id prov-subnet-id ssh-authorized-keys vmotion-id vmware-version vsan-id vsphere-id wait-for-state wait-interval-seconds workload-cidr'
        ...
        'ocvs sddc update' = 'defined-tags display-name force freeform-tags from-json hcx-vlan-id help if-match max-wait-seconds name nsx-edge-up1-id nsx-edge-up2-id nsx-edge-vtep-id nsx-vtep-id sddc-id ssh-authorized-keys vmotion-id vmware-version vsan-id vsphere-id wait-for-state wait-interval-seconds'
