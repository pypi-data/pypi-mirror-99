...
function GetOciSubcommands_data_safe() {
    $ociSubcommands = @{
        'data-safe' = 'on-prem-connector private-endpoint service work-request work-request-error work-request-log-entry'
...
function GetOciCommandsToLongParams_data_safe() {
    $ociCommandsToLongParams = @{
        ...
        'data-safe on-prem-connector list' = 'all compartment-id display-name from-json help limit on-prem-connector-id on-prem-connector-lifecycle-state page page-size sort-by sort-order'
