...
function GetOciCommandsToLongParams_usage_api() {
    $ociCommandsToLongParams = @{
        ...
        'usage-api usage-summary request-summarized-usages' = 'compartment-depth filter from-json granularity group-by group-by-tag help is-aggregate-by-time limit page query-type tenant-id time-usage-ended time-usage-started'
    }
