...
function GetOciSubcommands_dns() {
    $ociSubcommands = @{
        'dns' = 'record resolver resolver-endpoint steering-policy steering-policy-attachment tsig-key view zone'
        ...
        'dns resolver-endpoint' = 'create create-resolver-endpoint-create-resolver-vnic-endpoint-details delete get list update update-resolver-endpoint-update-resolver-vnic-endpoint-details'
...
function GetOciCommandsToLongParams_dns() {
    $ociCommandsToLongParams = @{
        ...
        'dns resolver-endpoint create' = 'endpoint-type forwarding-address from-json help is-forwarding is-listening listening-address max-wait-seconds name resolver-id scope wait-for-state wait-interval-seconds'
        'dns resolver-endpoint create-resolver-endpoint-create-resolver-vnic-endpoint-details' = 'forwarding-address from-json help is-forwarding is-listening listening-address max-wait-seconds name nsg-ids resolver-id scope subnet-id wait-for-state wait-interval-seconds'
        ...
        'dns resolver-endpoint update' = 'endpoint-type from-json help if-match if-unmodified-since max-wait-seconds resolver-endpoint-name resolver-id scope wait-for-state wait-interval-seconds'
        'dns resolver-endpoint update-resolver-endpoint-update-resolver-vnic-endpoint-details' = 'force from-json help if-match if-unmodified-since max-wait-seconds nsg-ids resolver-endpoint-name resolver-id scope wait-for-state wait-interval-seconds'
        ...
        'dns zone create' = 'compartment-id defined-tags external-masters freeform-tags from-json help max-wait-seconds name scope view-id wait-for-state wait-interval-seconds zone-type'
        ...
        'dns zone list' = 'all compartment-id from-json help lifecycle-state limit name name-contains page page-size scope sort-by sort-order time-created-greater-than-or-equal-to time-created-less-than view-id zone-type'
        ...
        'dns zone update' = 'compartment-id defined-tags external-masters force freeform-tags from-json help if-match if-unmodified-since max-wait-seconds scope view-id wait-for-state wait-interval-seconds zone-name-or-id'
    }
...
function GetOciCommandsToShortParams_dns() {
    $ociCommandsToShortParams = @{
        ...
        'dns resolver-endpoint create-resolver-endpoint-create-resolver-vnic-endpoint-details' = '? h'
        'dns resolver-endpoint delete' = '? h'
        'dns resolver-endpoint get' = '? h'
        'dns resolver-endpoint list' = '? h'
        'dns resolver-endpoint update' = '? h'
        'dns resolver-endpoint update-resolver-endpoint-update-resolver-vnic-endpoint-details' = '? h'
