...
function GetOciCommandsToLongParams_oce() {
    $ociCommandsToLongParams = @{
        ...
        'oce oce-instance update' = 'defined-tags description force freeform-tags from-json help if-match instance-license-type instance-usage-type max-wait-seconds oce-instance-id waf-primary-domain wait-for-state wait-interval-seconds'
