...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        ...
        'db external-non-cdb' = 'change-compartment create delete disable-db-management enable-db-management get list update'
        'db external-pdb' = 'change-compartment create delete disable-db-management enable-db-management get update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-id' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id autonomous-database-backup-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-timestamp' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id autonomous-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label standby-whitelisted-ips subnet-id timestamp wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-clone' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label source-id standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-refreshable-clone' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label refreshable-mode source-id standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db autonomous-database update' = 'admin-password are-primary-whitelisted-ips-used autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name force freeform-tags from-json help if-match is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-free-tier is-refreshable-clone license-model max-wait-seconds nsg-ids open-mode permission-level private-endpoint-label refreshable-mode standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
