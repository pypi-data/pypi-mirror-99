...
def загрузить_базу(база = '', справка = False):
  ...
  if база == 'MNIST':
    ...
    if справка:
      ...
      print('Количество изображений в базе: 10000') 
    return x, y
...
def загрузить_базу_ПИСАТЕЛИ():
  global url
  url = 'https://storage.googleapis.com/aiu_bucket/writers.zip'
...
def загрузить_базу_ДОГОВОРА():
  ...
  url = 'https://storage.googleapis.com/aiu_bucket/test_doc.txt'
...
def загрузить_базу_САМОЛЕТЫ_макс():
  global url
  url = 'https://storage.googleapis.com/aiu_bucket/airplane_max.zip' # Указываем URL-файла
  ...
  url = 'https://storage.googleapis.com/aiu_bucket/segment_max.zip' # Указываем URL-файла
...
def загрузить_базу_Люди():
  global url
  url = 'https://storage.googleapis.com/aiu_bucket/original_people.zip' # Указываем URL-файла
  ...
  url = 'https://storage.googleapis.com/aiu_bucket/segment_people.zip' # Указываем URL-файла
...
def загрузить_базу_ГУБЫ():
  global url
  url = 'https://storage.googleapis.com/aiu_bucket/lips.zip' # Указываем URL-файла
