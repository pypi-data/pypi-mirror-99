...
def создать_выборки(длинна, шаг):
  ...
  feature_dim_2 = int(длинна * sample_rate) # установленная длина фреймов (в секундах 0.5 = 500 мс)
...
def параметризация_аудио(файл):
  ...
  print()
  print()
  print('Мел-частотные кепстральные коэффициенты:')
