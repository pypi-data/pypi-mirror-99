...
from tree_config.doc_gen import \
    create_doc_listener as orig_create_doc_listener, \
    write_config_props_rst as orig_write_config_props_rst
...
write_config_props_rst = partial(
    orig_write_config_props_rst, yaml_dump_str=yaml_dumps)
