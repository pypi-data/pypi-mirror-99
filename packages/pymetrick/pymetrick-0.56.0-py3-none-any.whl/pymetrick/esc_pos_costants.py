...
# Currency with CODEPAGE CP1252 p.e.: CODEPAGE_CHANGE + b'\x10'    default CODEPAGE CP437  CODEPAGE_CHANGE + b'\x00'   
CURRENCY = { 'euro'   : b'\x80',
             'dollar' : b'\x24',
             'yen'    : b'\xa5',
             'yuan'   : b'\xa5',
...
# the codepage to use. Transform DEC number to HEX number.
...
# Prefix to change the international character set. You need to attach a
# byte to indicate the international character set to use.
INTERNATIONAL_CHARACTER_SET = ESC + b'\x52'
'''
n          Country          0x20 x20 x40 x50 x50 x50 x50 x60 x70 x70 x70 x7E
0          America           #    $   @   [   \   ]   ^   `   {   |   }   ~
