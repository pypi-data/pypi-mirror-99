...
module_info = {
    ...
    36: ("ocr_document_standard", "通用文字识别标准版"),
    37: ("ocr_document_standard_gpu", "通用文字识别标准版(GPU)"),
    51: ("ocr_document_gpu", "通用文字识别高精板"),
    52: ("ocr_document", "通用文字识别经济版"),
    53: ("ocr_table_gpu", "通用表格识别高精板"),
    54: ("ocr_table", "通用表格识别经济版"),
    55: ("ocr_receipt_gpu", "通用票据识别(GPU)"),
    56: ("ocr_receipt", "通用票据识别"),
    57: ("ocr_idcard_gpu", "通用卡证识别-身份证(GPU)"),
    58: ("ocr_idcard", "通用卡证识别-身份证"),
    59: ("ocr_bankcard_gpu", "通用卡证识别-银行卡(GPU)"),
    60: ("ocr_bankcard", "通用卡证识别-银行卡"),
    61: ("ocr_vehicle_gpu", "通用卡证识别-机动车登记证(GPU)"),
    62: ("ocr_vehicle", "通用卡证识别-机动车登记证"),
    63: ("ocr_vehiclelicense_gpu", "通用卡证识别-机动车行驶证(GPU)"),
    64: ("ocr_vehiclelicense", "通用卡证识别-机动车行驶证"),
    65: ("ocr_biz_gpu", "通用卡证识别-营业执照(GPU)"),
    66: ("ocr_biz", "通用卡证识别-营业执照")
}
