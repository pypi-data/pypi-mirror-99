...
setup(
    ...
    description='Integrated Framework for Configuration',  # Optional
    ...
    url='https://github.com/iflb/ifconf',  # Optional
    ...
    keywords='configuration argparse configparser logging',  # Optional
