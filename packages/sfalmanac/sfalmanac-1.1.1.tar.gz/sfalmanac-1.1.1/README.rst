...
This is the **PyPI edition** of `SFalmanac-Py3 <https://github.com/aendie/SFalmanac-Py3>`_. Version numbering started from 1.0 as the previous well-tested versions that are on github since 2015 were never published in PyPI.
...
SFalmanac is a **Python 3** script that creates the daily pages of the Nautical Almanac. 
...
Ephem is only used for calculating planet magnitudes (as these are not available yet in Skyfield).
