...
from sfalmanac.lib import alma_ephem as alma_ephem
...
'''
        ...
        twi = alma_skyfield.twilight(date+datetime.timedelta(days=1), i, hemisph)
...
'''
        lasthemisph = hemisph
        moon, moon2 = alma_skyfield.moonrise_set(date,i,hemisph)
