...
class ExportBills(Model):
    ...
    def __init__(self, edit=None, delete=None, run=None, permission_id=None, permission_code=None, permission_name=None, description=None, permission_category_name=None, is_licensed=None):
        super(ExportBills, self).__init__()
        self.edit = edit
        self.delete = delete
        self.run = run
