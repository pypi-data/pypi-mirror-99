...
class MeterChildIncludeMeterImportIdAndRoute(Model):
    ...
    def __init__(self, meter_import_id=None, route=None, meter_id=None, meter_code=None, meter_info=None, meter_type=None, commodity=None, active=None, is_calculated_meter=None, is_split_parent_meter=None, is_split_child_meter=None):
        super(MeterChildIncludeMeterImportIdAndRoute, self).__init__()
