...
class PlaceDigestActualAndCalendarizedYearlyResponseCommodityResults(Model):
    ...
    def __init__(self, year=None, total_cost=None, common_use=None, common_use_unit_cost=None, global_use=None, global_use_unit_cost=None, common_demand=None, common_demand_unit_cost=None):
        super(PlaceDigestActualAndCalendarizedYearlyResponseCommodityResults, self).__init__()
        self.year = year
