...
class UnitSystemSettings(Model):
    ...
    def __init__(self, view=None, create=None, edit=None, delete=None, manage=None, permission_id=None, permission_code=None, permission_name=None, description=None, permission_category_name=None, is_licensed=None):
        super(UnitSystemSettings, self).__init__()
        self.view = view
        self.create = create
        self.edit = edit
        self.delete = delete
