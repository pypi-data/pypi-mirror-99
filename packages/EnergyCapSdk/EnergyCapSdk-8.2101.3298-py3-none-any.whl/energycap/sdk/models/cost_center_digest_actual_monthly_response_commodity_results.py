...
class CostCenterDigestActualMonthlyResponseCommodityResults(Model):
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, total_cost=None, common_use=None, common_use_unit_cost=None, global_use=None, global_use_unit_cost=None):
        super(CostCenterDigestActualMonthlyResponseCommodityResults, self).__init__()
