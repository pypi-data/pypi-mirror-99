...
class MeterGroupDigestDemandRankingChild(Model):
    ...
    def __init__(self, cost=None, value=None, meter_id=None, meter_code=None, meter_info=None, meter_display=None, commodity=None, include_in_charts=None, active=None, is_calculated_meter=None, is_split_parent_meter=None, is_split_child_meter=None):
        super(MeterGroupDigestDemandRankingChild, self).__init__()
        self.cost = cost
        self.value = value
