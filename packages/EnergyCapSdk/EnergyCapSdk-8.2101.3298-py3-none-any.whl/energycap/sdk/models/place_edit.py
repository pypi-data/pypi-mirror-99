...
class PlaceEdit(Model):
    ...
    :param primary_use_id: The identifier for the place's primary use <span
    ...
    def __init__(self, place_code, place_info, parent_place_id, place_type_id, primary_use_id=None, build_date=None, address=None, weather_station_code=None, place_description="Æ"):
        super(PlaceEdit, self).__init__()
