...
class AccrualSettings(Model):
    ...
    def __init__(self, view=None, run=None, manage=None, permission_id=None, permission_code=None, permission_name=None, description=None, permission_category_name=None, is_licensed=None):
        super(AccrualSettings, self).__init__()
        self.view = view
        self.run = run
        self.manage = manage
