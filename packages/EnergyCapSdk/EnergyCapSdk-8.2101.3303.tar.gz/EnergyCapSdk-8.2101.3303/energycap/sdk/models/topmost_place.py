...
class TopmostPlace(Model):
    ...
    def __init__(self, is_multi_topmost_place=None, multi_topmost_places=None, place_id=None, place_code=None, place_info=None, place_type=None):
        super(TopmostPlace, self).__init__()
