...
class PlaceDigestTargetComparisonMonthlyResults(Model):
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, total_cost=None):
        super(PlaceDigestTargetComparisonMonthlyResults, self).__init__()
