...
class UpdateApprovedBills(Model):
    ...
    def __init__(self, edit=None, delete=None, permission_id=None, permission_code=None, permission_name=None, description=None, permission_category_name=None, is_licensed=None):
        super(UpdateApprovedBills, self).__init__()
        self.edit = edit
        self.delete = delete
