...
class PlaceGroupDigestWeatherRankingChild(Model):
    ...
    def __init__(self, base_value=None, slope_value=None, place_id=None, place_code=None, place_info=None, place_display=None, include_in_charts=None):
        super(PlaceGroupDigestWeatherRankingChild, self).__init__()
