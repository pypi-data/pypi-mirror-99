...
class MeterGroupDigestDemandRankingResponse(Model):
    ...
    def __init__(self, high_cost=None, low_cost=None, average_cost=None, median_cost=None, high_value=None, low_value=None, average_value=None, median_value=None, cost_unit=None, benchmark_unit=None, benchmark_value_unit=None, benchmark_factor_unit=None, results=None, meter_group_id=None, meter_group_code=None, meter_group_info=None, meter_group_display=None, updated=None):
        super(MeterGroupDigestDemandRankingResponse, self).__init__()
