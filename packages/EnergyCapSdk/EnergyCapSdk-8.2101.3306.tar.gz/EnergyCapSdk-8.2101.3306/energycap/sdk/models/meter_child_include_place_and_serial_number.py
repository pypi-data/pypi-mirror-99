...
class MeterChildIncludePlaceAndSerialNumber(Model):
    ...
    def __init__(self, serial_number=None, parent_place=None, meter_id=None, meter_code=None, meter_info=None, meter_type=None, commodity=None, active=None, is_calculated_meter=None, is_split_parent_meter=None, is_split_child_meter=None):
        super(MeterChildIncludePlaceAndSerialNumber, self).__init__()
