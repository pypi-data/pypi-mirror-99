...
class AccountChildWithType(Model):
    ...
    def __init__(self, account_type=None, account_id=None, account_code=None, account_info=None, vendor=None, active=None, has_calculated_meter=None, has_split_parent_meter=None, has_split_child_meter=None):
        super(AccountChildWithType, self).__init__()
