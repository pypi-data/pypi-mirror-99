...
class GlobalCostAvoidanceSettings(Model):
    ...
    def __init__(self, view=None, manage=None, permission_id=None, permission_code=None, permission_name=None, description=None, permission_category_name=None, is_licensed=None):
        super(GlobalCostAvoidanceSettings, self).__init__()
        self.view = view
        self.manage = manage
