...
class CfnTable(
    ...
    def key_schema(
        ...
        '''
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnTable.KeySchemaProperty", aws_cdk.core.IResolvable]]], jsii.get(self, "keySchema"))
    ...
    class GlobalSecondaryIndexProperty:
        ...
        def key_schema(
            ...
            return typing.cast(typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnTable.KeySchemaProperty", aws_cdk.core.IResolvable]]], result)
...
class IScalableTableAttribute(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_IScalableTableAttributeProxy"]:
