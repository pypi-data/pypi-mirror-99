...
class Configuration(Generic):
    ...
    def __init__(
        ...
        if export_dir:  # exporting snowmobile_template.toml only
            ...
            try:
                ...
                # set 'provided-creds' value if provided
                ...
                # merge snowmobile.toml and snowmobile-ext.toml
                merged = rmerge_dicts(
                    d1=cfg_raw,
                    d2=snowmobile_ext
                )  # dict order matters; d1 supersedes d2 if a value is shared
