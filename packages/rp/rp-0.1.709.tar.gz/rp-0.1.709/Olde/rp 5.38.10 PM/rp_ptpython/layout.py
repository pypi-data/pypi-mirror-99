...
from prompt_toolkit.layout.controls import BufferControl, TokenListControl, FillControl, UIContent
...
def create_layout(python_input,
    ...
    input_buffer_height = input_buffer_height or D(min=3)
                              ...
                              VSplit([
                                  ConditionalContainer(
                                      ...
                                      HSplit([
                                          ...
                                          Window(BufferControl(buffer_name='realtime_display',lexer=SimpleLexer(default_token=Token.Docstring),),wrap_lines=True,height=D(weight=2))
                                      ]),
