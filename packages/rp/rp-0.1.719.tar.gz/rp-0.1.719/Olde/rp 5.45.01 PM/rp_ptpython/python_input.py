            ...
            OptionCategory('rp Pseudo-Terminal',[
                Option(title='Sand Creature',
                       ...
                       get_values=lambda:{
                           ...
                           "Option Camel":lambda:setattr(self,'sand_creature',"Option Camel"),# print("Selected Camel"),
                       }),
                simple_option(title='Realtime Input',
                              description='bla',
    ...
    def _on_input_timeout(self,cli):
        ...
        def run():
            ...
            if self.show_realtime_input:
                cli.buffers['realtime_display'].reset(initial_document=Document(str(r_iterm_comm.rp_evaluator(document.text)),cursor_position=0))
