...
class CpioFile(StructBase):
    ...
    def _open(self, name=None, fileobj=None, mymap=None, block=None):
        ...
        :param :py:class:`bytes` block: file contents in a block of memory,
                                        (if given, this overrides *mymap*)
...
class CpioMember(StructBase):
    ...
    def __eq__(self, other):
        return (isinstance(other, self.__class__) and
                ...
                self.devmajor == other.devmajor and
                self.devminor == other.devminor and
                self.ino == other.ino and
                self.mode == other.mode and
                self.uid == other.uid and
                self.gid == other.gid and
                self.nlink == other.nlink and
                self.rdevmajor == other.rdevmajor and
                self.rdevminor == other.rdevminor and
