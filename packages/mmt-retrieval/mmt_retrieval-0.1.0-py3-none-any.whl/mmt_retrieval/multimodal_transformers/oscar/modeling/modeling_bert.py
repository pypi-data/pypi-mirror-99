...
from mmt_retrieval.multimodal_transformers.oscar.modeling.modeling_utils import CaptionPreTrainedModel
from mmt_retrieval.multimodal_transformers.oscar.utils.cbs import ConstrainedBeamSearch, select_best_beam_with_constraints
...
class CaptionBertLayer(BertLayer):
    ...
    def forward(self, hidden_states, attention_mask, head_mask=None,
        ...
        layer_output = self.output(hidden_states, intermediate_output, attention_mask)
...
class BertImgModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        #self.token_dropout = nn.Dropout2d(getattr(config, "token_dropout_prob", 0.0))
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
        ...
        #embedding_output = self.token_dropout(embedding_output)
