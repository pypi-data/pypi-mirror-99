...
#from apex.normalization.fused_layer_norm import LayerNorm
...
class UniterTextEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, position_ids, adv_training, 
        adv_modality, adv_delta, token_type_ids=None):
...
class UniterImageEmbeddings(nn.Module):
    ...
    def forward(self, img_feat, img_pos_feat, type_embeddings, 
        adv_training, adv_modality, adv_delta, img_masks=None):
...
class UniterModel(UniterPreTrainedModel):
    ...
    def _compute_img_embeddings(self, img_feat, img_pos_feat, 
        ...
        output = self.img_embeddings(img_feat, img_pos_feat,
                                     img_type_embeddings, adv_training, 
                                     adv_modality, adv_delta, img_masks)
        return output
    ...
    def _compute_img_txt_embeddings(self, input_ids, position_ids,
        ...
        txt_emb = self._compute_txt_embeddings(
            input_ids, position_ids, adv_training, adv_modality, 
    ...
    def forward(self, input_ids, position_ids, attention_mask,
                img_feat=None, img_pos_feat=None, adv_training=False, adv_modality="",
                adv_delta_txt=0, adv_delta_img=0, gather_index=None, img_masks=None,
                output_all_encoded_layers=True,
                txt_type_ids=None, img_type_ids=None):
