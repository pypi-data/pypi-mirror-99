...
class smib_milano_ex8p1_4ord_avr_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 1 
        self.N_store = 10000 
        self.params_list = ['X_d', 'X1d', 'T1d0', 'X_q', 'X1q', 'T1q0', 'R_a', 'X_l', 'H', 'D', 'Omega_b', 'omega_s', 'v_0', 'theta_0', 'K_a', 'T_r', 'v_pss', 'Droop', 'T_m', 'K_sec'] 
        self.params_values_list  = [1.81, 0.3, 8.0, 1.76, 0.65, 1.0, 0.003, 0.05, 3.5, 1.0, 314.1592653589793, 1.0, 1.0, 0.0, 100, 0.1, 0.0, 0.05, 5.0, 0.001] 
        self.inputs_ini_list = ['P_l', 'Q_l', 'v_ref'] 
        self.inputs_ini_values_list  = [0.8, 0.2, 1.0] 
        self.inputs_run_list = ['P_l', 'Q_l', 'v_ref'] 
        self.inputs_run_values_list = [0.8, 0.2, 1.0] 
        self.outputs_list = ['p_m'] 
        self.x_list = ['delta', 'omega', 'e1q', 'e1d', 'v_c', 'p_m', 'xi_m'] 
        self.y_run_list = ['i_d', 'i_q', 'v_1', 'theta_1', 'P_t', 'Q_t', 'v_f', 'p_m_ref'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['i_d', 'i_q', 'v_1', 'theta_1', 'P_t', 'Q_t', 'v_f', 'p_m_ref'] 
