...
# -*- coding: utf-8 -*-
#
# pydae documentation build configuration file, created by
...
project = 'pydae'
copyright = u'2013-2019, Juan Manuel Mauricio and the pydae development team'
...
latex_documents = [
  ('index', 'pydae.tex', 'pydae Documentation',
   'Juan Manuel Mauricio', 'manual'),
]
...
man_pages = [
    ('index', 'pydae', 'pydae Documentation',
...
texinfo_documents = [
  ('index', 'pydae', 'pydae Documentation',
   'Juan Luis Cano Rodríguez', 'pydae', 'One line description of project.',
   'Miscellaneous'),
]
