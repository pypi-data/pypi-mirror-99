...
class vsc_lcl_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 12 
        self.N_store = 10000 
        self.params_list = ['L_t_g01', 'R_t_g01', 'C_m_g01', 'L_s_g01', 'R_s_g01', 'omega_g01', 'G_d_g01'] 
        self.params_values_list  = [0.00125, 0.039269908169872414, 4e-06, 0.00125, 0.039269908169872414, 314.1592653589793, 1.0] 
        self.inputs_ini_list = ['v_dc_g01', 'v_1_D', 'v_1_Q', 'phi_g01', 'eta_d_g01', 'eta_q_g01'] 
        self.inputs_ini_values_list  = [750, 0.0, 326, 0.0, 0.0, 0.8] 
        self.inputs_run_list = ['v_dc_g01', 'v_1_D', 'v_1_Q', 'phi_g01', 'eta_d_g01', 'eta_q_g01'] 
        self.inputs_run_values_list = [750, 0.0, 326, 0.0, 0.0, 0.8] 
        self.outputs_list = ['v_t_D', 'v_t_Q', 'damp_D', 'damp_Q', 'i_sd_g01', 'i_sq_g01', 'v_md_g01', 'v_mq_g01', 'i_td_g01', 'i_tq_g01', 'v_sd_g01', 'v_sq_g01'] 
        self.x_list = ['i_tD_g01', 'i_tQ_g01', 'v_mD_g01', 'v_mQ_g01', 'i_sD_g01', 'i_sQ_g01'] 
        self.y_run_list = ['i_1_D', 'i_1_Q', 'v_sD_g01', 'v_sQ_g01', 'v_md_g01', 'v_mq_g01', 'v_sd_g01', 'v_sq_g01', 'i_td_g01', 'i_tq_g01', 'i_sd_g01', 'i_sq_g01', 'eta_D_g01', 'eta_Q_g01'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['i_1_D', 'i_1_Q', 'v_sD_g01', 'v_sQ_g01', 'v_md_g01', 'v_mq_g01', 'v_sd_g01', 'v_sq_g01', 'i_td_g01', 'i_tq_g01', 'i_sd_g01', 'i_sq_g01', 'eta_D_g01', 'eta_Q_g01'] 
...
def ini(struct,mode):
    ...
    if mode == 11:
        ...
        struct[0].Gx_ini[0,4] = 1
        struct[0].Gx_ini[1,5] = 1
        struct[0].Gx_ini[4,2] = cos(phi_g01)
        struct[0].Gx_ini[4,3] = sin(phi_g01)
        struct[0].Gx_ini[5,2] = -sin(phi_g01)
        struct[0].Gx_ini[5,3] = cos(phi_g01)
        struct[0].Gx_ini[8,0] = cos(phi_g01)
        struct[0].Gx_ini[8,1] = sin(phi_g01)
        struct[0].Gx_ini[9,0] = -sin(phi_g01)
        struct[0].Gx_ini[9,1] = cos(phi_g01)
        struct[0].Gx_ini[10,4] = cos(phi_g01)
        struct[0].Gx_ini[10,5] = sin(phi_g01)
