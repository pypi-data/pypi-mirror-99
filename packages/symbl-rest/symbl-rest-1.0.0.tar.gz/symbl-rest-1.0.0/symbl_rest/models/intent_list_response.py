...
class IntentListResponse(object):
    ...
    def __init__(self, intents=None):  # noqa: E501
        """IntentListResponse - a model defined in Swagger"""  # noqa: E501
        self._intents = None
    ...
    @property
    def intents(self):
        """Gets the intents of this IntentListResponse.  # noqa: E501


        :return: The intents of this IntentListResponse.  # noqa: E501
        :rtype: list[ConversationIntent]
        """
        return self._intents

    @intents.setter
    def intents(self, intents):
        """Sets the intents of this IntentListResponse.


        :param intents: The intents of this IntentListResponse.  # noqa: E501
        :type: list[ConversationIntent]
        """
        if intents is None:
            raise ValueError("Invalid value for `intents`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IntentListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntentListResponse):
            return False
