...
class ExternalEvent(object):
    ...
    def __init__(self, topic=None, type=None, user=None, timestamp=None):  # noqa: E501
        """ExternalEvent - a model defined in Swagger"""  # noqa: E501
        self._topic = None
        self._type = None
        self._user = None
    ...
    @property
    def topic(self):
        """Gets the topic of this ExternalEvent.  # noqa: E501

        The topics for which events will occur  # noqa: E501

        :return: The topic of this ExternalEvent.  # noqa: E501
        :rtype: str
        """
        return self._topic
    ...
    def topic(self, topic):
        """Sets the topic of this ExternalEvent.

        The topics for which events will occur  # noqa: E501

        :param topic: The topic of this ExternalEvent.  # noqa: E501
        :type: str
        """
        allowed_values = ["speaker"]  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this ExternalEvent.  # noqa: E501

        The type of supported events  # noqa: E501

        :return: The type of this ExternalEvent.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ExternalEvent.

        The type of supported events  # noqa: E501

        :param type: The type of this ExternalEvent.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def user(self):
        """Gets the user of this ExternalEvent.  # noqa: E501


        :return: The user of this ExternalEvent.  # noqa: E501
        :rtype: UserTrunc
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this ExternalEvent.


        :param user: The user of this ExternalEvent.  # noqa: E501
        :type: UserTrunc
        """
        if user is None:
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this ExternalEvent.  # noqa: E501
        ...
        :return: The timestamp of this ExternalEvent.  # noqa: E501
        :rtype: date
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this ExternalEvent.

        Timestamp in ISO 8601 format when the event was generated. If this is omitted, automatic calculation of timestamp will be done.  # noqa: E501

        :param timestamp: The timestamp of this ExternalEvent.  # noqa: E501
        :type: date
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExternalEvent, dict):
