...
import symbl_rest
from symbl_rest.api.external_event_web_hook_api import ExternalEventWebHookApi  # noqa: E501
from symbl_rest.rest import ApiException


class TestExternalEventWebHookApi(unittest.TestCase):
    """ExternalEventWebHookApi unit test stubs"""

    def setUp(self):
        self.api = ExternalEventWebHookApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_external_event_web_hook(self):
        """Test case for external_event_web_hook
