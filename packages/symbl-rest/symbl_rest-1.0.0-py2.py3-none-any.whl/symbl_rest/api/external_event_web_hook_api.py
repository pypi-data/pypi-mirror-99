...
class ExternalEventWebHookApi(object):
    ...
    def external_event_web_hook(self, connection_id, **kwargs):  # noqa: E501
        """WebHook for external events  # noqa: E501

        Symbl exposes WebHook that can be used to send events from the external system, these events will be used to enhance the insight generation process.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.external_event_web_hook(connection_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str connection_id: ID of the connection (required)
        :param ExternalEvent body:
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.external_event_web_hook_with_http_info(connection_id, **kwargs)  # noqa: E501
        else:
            (data) = self.external_event_web_hook_with_http_info(connection_id, **kwargs)  # noqa: E501
            return data

    def external_event_web_hook_with_http_info(self, connection_id, **kwargs):  # noqa: E501
        """WebHook for external events  # noqa: E501

        Symbl exposes WebHook that can be used to send events from the external system, these events will be used to enhance the insight generation process.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.external_event_web_hook_with_http_info(connection_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method external_event_web_hook" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('connection_id' not in params or
            ...
            raise ValueError("Missing the required parameter `connection_id` when calling `external_event_web_hook`")  # noqa: E501
