...
class MetricEntryResponse(object):
    ...
    def __init__(self, metric_entry=None, errors=None):  # noqa: E501
        """MetricEntryResponse - a model defined in Swagger"""  # noqa: E501
        self._metric_entry = None
        self._errors = None
    ...
    @property
    def metric_entry(self):
        """Gets the metric_entry of this MetricEntryResponse.  # noqa: E501


        :return: The metric_entry of this MetricEntryResponse.  # noqa: E501
        :rtype: MetricEntry
        """
        return self._metric_entry

    @metric_entry.setter
    def metric_entry(self, metric_entry):
        """Sets the metric_entry of this MetricEntryResponse.


        :param metric_entry: The metric_entry of this MetricEntryResponse.  # noqa: E501
        :type: MetricEntry
        """
        if metric_entry is None:
            raise ValueError("Invalid value for `metric_entry`, must not be `None`")  # noqa: E501

        self._metric_entry = metric_entry

    @property
    def errors(self):
        """Gets the errors of this MetricEntryResponse.  # noqa: E501


        :return: The errors of this MetricEntryResponse.  # noqa: E501
        :rtype: list[Error]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this MetricEntryResponse.


        :param errors: The errors of this MetricEntryResponse.  # noqa: E501
        :type: list[Error]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricEntryResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricEntryResponse):
            return False
