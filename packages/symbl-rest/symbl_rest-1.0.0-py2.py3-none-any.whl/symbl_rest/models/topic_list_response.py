...
class TopicListResponse(object):
    ...
    def __init__(self, topics=None):  # noqa: E501
        """TopicListResponse - a model defined in Swagger"""  # noqa: E501
        self._topics = None
    ...
    @property
    def topics(self):
        """Gets the topics of this TopicListResponse.  # noqa: E501


        :return: The topics of this TopicListResponse.  # noqa: E501
        :rtype: list[ConversationTopic]
        """
        return self._topics

    @topics.setter
    def topics(self, topics):
        """Sets the topics of this TopicListResponse.


        :param topics: The topics of this TopicListResponse.  # noqa: E501
        :type: list[ConversationTopic]
        """
        if topics is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TopicListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TopicListResponse):
            return False
