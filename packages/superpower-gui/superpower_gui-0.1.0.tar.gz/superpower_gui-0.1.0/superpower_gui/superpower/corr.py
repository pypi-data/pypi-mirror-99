# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/superpower.corr.ipynb (unless otherwise specified).
...
from ..rpy import RFunction, converter

# Cell
class CorrPearson(RFunction): # one
    argNames = ['N', 'r', 'alternative', 'pVal']
...
class CorrCramerV(RFunction): # one
    argNames=['n_row', 'n_col', 'alternative', 'ns_cells', 'N', 'pVal']
    def __init__(self, argNames=argNames, **kwargs):
        super().__init__(name='corrCramerV', argNames=argNames, **kwargs)

class CorrTetra(RFunction): # two
    argNames=['n_row', 'n_col', 'tail', 'ns_cells', 'N', 'pVal']
    def __init__(self, argNames=argNames, **kwargs):
