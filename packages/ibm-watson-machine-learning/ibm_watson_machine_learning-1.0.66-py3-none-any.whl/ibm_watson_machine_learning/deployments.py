...
class Deployments(WMLResource):
    ...
    def _score_async(self,deployment_uid, scoring_payload,
        ...
        if platform_job_immediate is not None:
            if not isinstance(platform_job_immediate, bool):
                raise TypeError("`platform_job_immediate` only takes boolean values.")
            params.update({'platform_job_immediate': platform_job_immediate})
    ...
    def create_job(self, deployment_id, meta_props, retention=None, platform_job_immediate=None):
        """
            ...
            **Parameters**
            ...
            .. important::
                ...
                #. **platform_job_immediate**: Set the platform job task to syns or async mode (optinal).\n
                   **type**: bool\n
        ...
        return self._score_async(deployment_id, payload,
                                 transaction_id=None,
                                 retention=retention,
                                 platform_job_immediate=platform_job_immediate)
