...
@unittest.skip('Text transformer not supported yet')
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_03_initialize_optimizer(self):
        TestAutoAIRemote.remote_auto_pipelines = self.experiment.optimizer(
            ...
            include_only_estimators=[self.experiment.ClassificationAlgorithms.XGB],
            holdout_size=0.1,
            train_sample_columns_index_list=[4.0, 5.0, 9.0],
            text_processing=True,
            word2vec_feature_number=20,
