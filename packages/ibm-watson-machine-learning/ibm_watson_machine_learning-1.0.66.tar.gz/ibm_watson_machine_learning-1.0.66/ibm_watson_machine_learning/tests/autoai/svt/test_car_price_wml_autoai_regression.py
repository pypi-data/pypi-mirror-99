...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_08_get_summary(self):
        ...
        status_msg = training_details['entity']['status']
        self.assertNotEqual(self.remote_auto_pipelines.get_run_status(), RunStateTypes.FAILED,
                            msg="AutoAI run failed. Status message: {}".format(status_msg))
