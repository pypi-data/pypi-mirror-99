...
AquaConfigurationTypeDef = TypedDict(
    "AquaConfigurationTypeDef",
    {
        "AquaStatus": Literal["enabled", "disabled", "applying"],
        "AquaConfigurationStatus": Literal["enabled", "disabled", "auto"],
    },
    total=False,
)
...
NetworkInterfaceTypeDef = TypedDict(
    "NetworkInterfaceTypeDef",
    {"NetworkInterfaceId": str, "SubnetId": str, "PrivateIpAddress": str, "AvailabilityZone": str},
    total=False,
)
...
VpcEndpointTypeDef = TypedDict(
    "VpcEndpointTypeDef",
    {"VpcEndpointId": str, "VpcId": str, "NetworkInterfaces": List["NetworkInterfaceTypeDef"]},
    total=False,
)
...
ModifyAquaOutputMessageTypeDef = TypedDict(
    "ModifyAquaOutputMessageTypeDef", {"AquaConfiguration": "AquaConfigurationTypeDef"}, total=False
)
