...
# window = sg.Window('Swapping the contents of a window', layout, size=(500, 300), grab_anywhere=True)
window = sg.Window('Swapping the contents of a window', layout, grab_anywhere=True)
