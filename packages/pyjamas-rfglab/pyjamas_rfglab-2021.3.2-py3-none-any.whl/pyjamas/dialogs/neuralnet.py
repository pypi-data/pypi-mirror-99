...
class NeuralNetDialog(ClassifierDialogABC):
    ...
    def setupUi(self, NNet, parameters: dict = None):
    ...
    def parameters(self) -> dict:
        NeuralNetDialog.positive_training_folder = self.positive_training_folder_edit.text()
        NeuralNetDialog.train_image_size = int(self.lnHeight.text()), int(self.lnWidth.text())
