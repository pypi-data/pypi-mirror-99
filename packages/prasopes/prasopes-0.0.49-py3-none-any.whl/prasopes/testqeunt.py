...
#mySett = datasets.BrukerTimsDataset('/home/yan/sw_modd/msresearch/opentims/210211_PEG600_TIMS_Detect_Calibrated.d')
mySett = datasets.BrukerTimsDataset('/home/yan/sw_modd/msresearch/opentims/210216_CageAzo_NHCOCH3_BlueLight.d')
...
[mobs, ints] = mySett.get_mobilogram(1636.2, 1636.75, 0, 3)
...
print("plotting")
#plt.plot(tofs, ints)
plt.plot(mobs, ints, marker='o', markersize=2, linestyle='None')
