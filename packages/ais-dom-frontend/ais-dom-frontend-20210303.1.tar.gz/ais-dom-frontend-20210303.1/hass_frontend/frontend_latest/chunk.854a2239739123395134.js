      ...
      >
        <ha-config-section .isWide=${this.isWide}>
            ...
            ${this.hass.localize("ui.panel.config.customize.picker.introduction")}
              <br />
              <a
              href=${(0,n.R)(this.hass,"/docs/configuration/customizing-devices/#customization-using-the-ui")}
                target="_blank"
                rel="noreferrer"
              >
