...
def __(key):
    return i18n.t('text.guardian.' + key)
...
class TheGuardianAPI:
    ...
    metas = [
        (data.StringVariable(__('headline')), lambda doc: doc['fields']['headline']),
        (data.StringVariable(__('content')), lambda doc: doc['fields']['bodyText']),
        (data.StringVariable(__('trail_text')), lambda doc: doc['fields']['trailText']),
        (data.StringVariable(__('html')), lambda doc: doc['fields']['body']),
        (tv, lambda doc: TheGuardianAPI.tv.parse(doc['webPublicationDate'])),
        (data.DiscreteVariable(__('type')), lambda doc: doc['type']),
        (data.DiscreteVariable(__('language')), lambda doc: doc['fields']['lang']),
        (data.StringVariable(__('tags')),
            lambda doc: ', '.join(tag['webTitle'] for tag in doc['tags'])),
        (data.StringVariable('URL'), lambda doc: doc['webUrl']),
        (data.ContinuousVariable(__('word_count'), number_of_decimals=0),
