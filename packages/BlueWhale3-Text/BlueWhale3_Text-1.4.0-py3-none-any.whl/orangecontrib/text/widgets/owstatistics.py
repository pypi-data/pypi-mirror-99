...
def __(key):
    return i18n.t('text.owstatistics.' + key)
...
STATISTICS = [
    ...
    (__("gbox.word_count"), words_count, None),
    (__("gbox.character_count"), characters_count, None),
    (__("gbox.n_gram_count"), n_gram_count, None),
    (__("gbox.average_word_length"), average_word_len, None),
    (__("gbox.punctuation_count"), punctuation_count, None),
    (__("gbox.capital_count"), capital_count, None),
    (__("gbox.vowel_count"), vowel_count, "a,e,i,o,u"),
    (
        __("gbox.consonant_count"),
        consonant_count,
        "b,c,d,f,g,h,j,k,l,m,n,p,q,r,s,t,v,w,x,y,z",
    ),
    (__("gbox.per_cent_unique_word"), per_cent_unique_words, None),
    (__("gbox.start_with"), starts_with, ""),
    (__("gbox.end_with"), ends_with, ""),
    (__("gbox.contain"), contains, ""),
    (__("gbox.regex"), regex, ""),
    (__("gbox.pos_tag"), pos_tags, "NN,VV,JJ"),
]
...
class OWStatistics(OWWidget, ConcurrentWidgetMixin):
    ...
    def _init_statistics_box(self) -> None:
        ...
        rules_box.addWidget(QLabel(__("row_feature")), 0, 1)
        rules_box.addWidget(QLabel(__("row_pattern")), 0, 2)
