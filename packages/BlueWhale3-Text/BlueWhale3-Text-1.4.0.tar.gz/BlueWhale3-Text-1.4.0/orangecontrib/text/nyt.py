...
class NYT:
    ...
    metas = [
        (data.StringVariable(__('headline')), lambda doc: doc.get('headline', {}).get('main') or ''),
        (data.StringVariable(__('abstract')), lambda doc: doc.get('abstract') or ''),
        (data.StringVariable(__('snippet')), lambda doc: doc.get('snippet') or ''),
        (data.StringVariable(__('lead_paragraph')), lambda doc: doc.get('lead_paragraph') or ''),
        (data.StringVariable(__('subject_keywords')), lambda doc: NYT.keywords(doc, 'subject')),
        (data.StringVariable('URL'), lambda doc: doc.get('web_url') or ''),
        (data.StringVariable(__('locations')), lambda doc: NYT.keywords(doc, 'glocations')),
        (data.StringVariable(__('persons')), lambda doc: NYT.keywords(doc, 'persons')),
        (data.StringVariable(__('organizations')), lambda doc: NYT.keywords(doc, 'organizations')),
        (data.StringVariable(__('creative_works')), lambda doc: NYT.keywords(doc, 'creative_works')),
        (tv, lambda doc: NYT.tv.parse(doc.get('pub_date'))),
        (data.DiscreteVariable(__('article_type')), lambda doc: doc.get('type_of_material', None)),
        (data.ContinuousVariable(__('word_count'), number_of_decimals=0), lambda doc: doc.get('word_count', None)),
    ]
