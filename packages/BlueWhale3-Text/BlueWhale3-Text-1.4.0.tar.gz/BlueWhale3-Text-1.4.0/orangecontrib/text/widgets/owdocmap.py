...
def __(key):
    return i18n.t('text.owdocmap.' + key)
...
class Map:
    ...
    USA = 'us_aea_en'
    all = ((__("gbox_m_world"), WORLD),
           (__("gbox_m_europe"), EUROPE),
           (__("gbox_m_usa"), USA))
...
def main():
    ...
    metas = [
        StringVariable(__("gbox_world")),
        StringVariable(__("gbox_europe")),
        StringVariable(__("gbox_usa")),
    ]
