...
def __(key):
    return i18n.t('text.owbasevectorizer.' + key)
...
class OWBaseVectorizer(OWWidget):
    ...
    # Input/output
    class Inputs:
        corpus = Input("Corpus", Corpus, label=i18n.t("text.common.data"))

    class Outputs:
        corpus = Output("Corpus", Corpus, label=i18n.t("text.common.data"))
