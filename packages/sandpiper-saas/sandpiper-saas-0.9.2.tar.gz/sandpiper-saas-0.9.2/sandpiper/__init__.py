...
def run():
    ...
    parser = argparse.ArgumentParser(description="Sandpiper SaaS",
                                     epilog="SandPiper SaaS Edition runs as a microservice in the cloud to support "
                                            "easy open-source development. "
                                            "To display the Sanpiper help, use --sphelp.")
    ...
    parser.add_argument('sandpiper_args', type=str, nargs='*', help='Arguments to be passed to Sanpiper.')
