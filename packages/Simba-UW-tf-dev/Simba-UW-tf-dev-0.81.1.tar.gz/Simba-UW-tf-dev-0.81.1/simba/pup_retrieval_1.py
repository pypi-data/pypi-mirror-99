...
def pup_retrieval_1(cofigini, prob_pup, prob_mother, dist_start_crit, carry_frames_seconds, smooth_factor, \
    ...
    for counter, video_file in enumerate(features_files):
        ...
        for classifier in classifier_list: curr_df.loc[curr_df['mean_p_mother'] < prob_mother, classifier] = 0
    ...
    log_name = 'Log_pup_retrieval_' + '_' + str(date_time_string) + '.csv'
    ...
    swarm_plot.clear()
    print('All videos analysed, summary file saved @ ' + str(log_save_path))
