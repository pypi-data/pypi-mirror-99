...
def compute(cool, out, norm, chrom, canny, minL, maxW, maxpixel, numcores, pvalue, mask):
    ...
    MP = getStripe.getStripe.getQuantile(obj,Lib,chromnames,maxpixel)
    ...
    for i in range(len(maxpixel)):
        perc = maxpixel[i]
        result = obj.extract(MP, i, perc, bgleft, bgright)
