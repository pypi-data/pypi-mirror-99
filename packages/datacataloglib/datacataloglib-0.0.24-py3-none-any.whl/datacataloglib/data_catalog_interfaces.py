...
class DatasetVersion(object):
   __slots__ = ['org', 'project', 'repository', 'dataset', 'description', 'author', 'source', 'tags', 'url']
   def __init__(self, org, project, repository, dataset, description, author, source, tags, url=""):
            self.org = org
            self.project = project
            self.repository = repository
            self.dataset = dataset
