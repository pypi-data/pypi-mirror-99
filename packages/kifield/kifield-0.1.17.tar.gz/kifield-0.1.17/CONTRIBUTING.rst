...
kifield could always use more documentation, whether as part of the
official kifield docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `kifield` repo on GitHub.
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_kifield
