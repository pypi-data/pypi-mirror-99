...
_DOMAINOWNERINFO.fields_by_name['last_accessed_at'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_DOMAINOWNERINFO.fields_by_name['created_at'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
