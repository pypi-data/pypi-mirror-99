...
class BatchSubmitJobProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    ...
    def job_definition(self) -> aws_cdk.aws_batch.IJobDefinition:
        ...
        return typing.cast(aws_cdk.aws_batch.IJobDefinition, result)
    ...
    def job_queue(self) -> aws_cdk.aws_batch.IJobQueue:
        ...
        return typing.cast(aws_cdk.aws_batch.IJobQueue, result)
...
class CallApiGatewayHttpApiEndpoint(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        api: aws_cdk.aws_apigatewayv2.IHttpApi,
...
class CallApiGatewayHttpApiEndpointProps(CallApiGatewayEndpointBaseProps):
    ...
    @builtins.property
    def api(self) -> aws_cdk.aws_apigatewayv2.IHttpApi:
        '''API to call.'''
        result = self._values.get("api")
        assert result is not None, "Required property 'api' is missing"
        return typing.cast(aws_cdk.aws_apigatewayv2.IHttpApi, result)
...
class DockerImage(
    ...
    def __jsii_proxy_class__() -> typing.Type["_DockerImageProxy"]:
...
class EksCall(
    ...
    def __init__(
        ...
        *,
        ...
        query_parameters: typing.Optional[typing.Mapping[builtins.str, typing.List[builtins.str]]] = None,
        request_body: typing.Optional[aws_cdk.aws_stepfunctions.TaskInput] = None,
        comment: typing.Optional[builtins.str] = None,
        heartbeat: typing.Optional[aws_cdk.core.Duration] = None,
        input_path: typing.Optional[builtins.str] = None,
...
class IContainerDefinition(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IContainerDefinitionProxy"]:
...
class IEcsLaunchTarget(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IEcsLaunchTargetProxy"]:
...
class ISageMakerTask(aws_cdk.aws_iam.IGrantable, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_ISageMakerTaskProxy"]:
...
class S3Location(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_S3LocationProxy"]:
