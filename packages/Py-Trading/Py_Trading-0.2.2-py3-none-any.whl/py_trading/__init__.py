...
class Stock:
	...
	def price_target(self.ticker, exchange='NASDAQ'): # Automatically find correct stock exchange
	...
	def social_media_sentiment(self.ticker, num_of_tweets=50): # Also reddit sentiment, and twitter
		# Twitter
		load_dotenv()
