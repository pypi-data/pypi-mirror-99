...
class FileResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'content_uploaded': (bool, none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, content_uploaded, checksum, user_id, group_id, expires, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            filesize (int, none_type): [optional]  # noqa: E501
        """
        ...
        self.id = id
        self.name = name
        self.content_uploaded = content_uploaded
