...
class SubmissionRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, metadataset_ids, file_ids, *args, **kwargs):  # noqa: E501
        """SubmissionRequest - a model defined in OpenAPI
