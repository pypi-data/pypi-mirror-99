...
class SubmissionResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'metadataset_ids': ([Identifier],),  # noqa: E501
            'file_ids': ([Identifier],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, metadataset_ids, file_ids, *args, **kwargs):  # noqa: E501
        """SubmissionResponse - a model defined in OpenAPI

        Args:
            id (Identifier):
            metadataset_ids ([Identifier]):
            file_ids ([Identifier]):
