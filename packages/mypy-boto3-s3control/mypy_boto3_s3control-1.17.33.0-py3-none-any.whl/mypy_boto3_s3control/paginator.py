...
class ListAccessPointsForObjectLambdaPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAccessPointsForObjectLambda.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.33/reference/services/s3control.html#S3Control.Paginator.ListAccessPointsForObjectLambda.paginate)
        """
