...
class Service:
    ...
    def invoke(self):
        ...
        try:
            ...
            logger.debug("response status code: {}".format(str(requests_response.status_code)))
            logger.debug("response headers: {}".format(str(requests_response.headers)))
            logger.debug("response cookies: {}".format(str(requests_response.cookies)))
            logger.debug("response data: {}".format(requests_response.text))
