"""
Global hamichlol exception and warning classes.
"""

import sys


ODD_ERROR_MESSAGE = "This shouldn't happen. Please report on GitHub: github.com/goldsmith/hamichlol"


class hamichlolException(Exception):
  """Base hamichlol exception class."""
...
class PageError(hamichlolException):
  """Exception raised when no hamichlol matched a query."""
...
class DisambiguationError(hamichlolException):
  """
  Exception raised when a page resolves to a Disambiguation page.

  The `options` property contains a list of titles
  of hamichlol pages that the query may refer to.

  .. note:: `options` does not include titles that do not link to a valid hamichlol page.
  """
...
class RedirectError(hamichlolException):
...
class HTTPTimeoutError(hamichlolException):
