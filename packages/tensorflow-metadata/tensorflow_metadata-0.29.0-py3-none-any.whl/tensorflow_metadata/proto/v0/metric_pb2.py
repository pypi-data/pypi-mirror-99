...
_MAXIMUMMEANDISCREPANCY = _descriptor.Descriptor(
  name='MaximumMeanDiscrepancy',
  full_name='tensorflow.metadata.v0.MaximumMeanDiscrepancy',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kernel', full_name='tensorflow.metadata.v0.MaximumMeanDiscrepancy.kernel', index=0,
...
DESCRIPTOR.message_types_by_name['MaximumMeanDiscrepancy'] = _MAXIMUMMEANDISCREPANCY
...
MaximumMeanDiscrepancy = _reflection.GeneratedProtocolMessageType('MaximumMeanDiscrepancy', (_message.Message,), {
  'DESCRIPTOR' : _MAXIMUMMEANDISCREPANCY,
  '__module__' : 'tensorflow_metadata.proto.v0.metric_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.metadata.v0.MaximumMeanDiscrepancy)
  })
_sym_db.RegisterMessage(MaximumMeanDiscrepancy)
