...
import { filterPlugins } from './extensions/pluginInterface';
import { parseWorkspaceUri } from './extensions/pluginInterface/misc';
import workspaceReducer from './extensions/pluginInterface/workspaceReducer';
import { locationFromRoute, routeFromLocation, workspaceRouteReducer } from './extensions/pluginInterface/WorkspaceRoute';
import theme from './extensions/theme';
import WorkspaceView from './extensions/workspaceview/WorkspaceView';
export const useWorkspaceRoute = (location, history, workspaceUri) => {
    const workspaceRouteDispatch = useMemo(() => ((a) => {
        const route = routeFromLocation(history.location, {});
        let newRoute = workspaceRouteReducer(route, a);
...
const WorkspaceViewWrapper = ({ workspaceUri }) => {
    ...
    return (React.createElement(MuiThemeProvider, { theme: theme },
        React.createElement("div", { ref: divRef, className: "WorkspaceViewWrapper", style: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0 } },
            React.createElement(WorkspaceView, Object.assign({}, {
                defaultFeedId: '',
                workspace,
                workspaceDispatch,
...
//# sourceMappingURL=WorkspaceViewWrapper.js.map