...
import { CanvasWidgetLayer, ClickEventType, MousePresenceEventType } from "../../common/CanvasWidget/CanvasWidgetLayer";
import { getInverseTransformationMatrix, transformPoint } from "../../common/CanvasWidget/Geometry";
...
const onPaint = (painter, layerProps, state) => __awaiter(void 0, void 0, void 0, function* () {
...
const onPropsChange = (layer, layerProps) => {
    ...
    layer.setState(Object.assign(Object.assign({}, layer.getState()), { timeRange,
        transformations,
        yAxisTransformations,
        yAxisWidths,
        yAxisHeights,
...
export const handleClick = (e, layer) => {
    if (e.type === ClickEventType.Move)
        return;
    ...
    for (let i = 0; i < inverseTransformations.length; i++) {
        ...
        if ((0 <= p[1]) && (p[1] <= 1)) {
            if (e.type === ClickEventType.Press) {
                layer.setState(Object.assign(Object.assign({}, state), { captureWheel: true, anchorTimepoint: p[0], dragging: false }));
            }
...
export const handleMouseOut = (e, layer) => {
    if (e.type !== MousePresenceEventType.Leave)
        return;
    layer.setState(Object.assign(Object.assign({}, layer.getState()), { captureWheel: false }));
};
...
export const handleDrag = (layer, drag) => {
    const props = layer.getProps();
    if (!props)
        return;
    const state = layer.getState();
    ...
    if (!pos)
        return;
    if (inverseTransformations.length === 0)
        return;
    layer.setState(Object.assign(Object.assign({}, state), { dragging: true }));
    ...
    if (anchorTimepoint !== null) {
        ...
        layer.setState(Object.assign(Object.assign({}, state), { anchorTimepoint: t }));
    }
};
export const handleWheel = (e, layer) => {
    const props = layer.getProps();
    if (!props)
        return;
...
export const handleKeyboardEvent = (e, layer) => {
    ...
    switch (e.keyCode) {
        case 37:
            props.onTimeShiftFrac && props.onTimeShiftFrac(-0.2);
            return false;
        case 39:
            props.onTimeShiftFrac && props.onTimeShiftFrac(+0.2);
            return false;
        ...
        case 189:
            ...
            return false;
        case 35:
            props.onGotoEnd && props.onGotoEnd();
            return false;
        case 36:
            props.onGotoHome && props.onGotoHome();
            return false;
