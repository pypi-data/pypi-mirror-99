...
def clc_samples():
  ...
  """
  if not os.path.exists('sample_csv_1.csv'):
    print('Downloading sample_csv_1.csv ......')
    df1_request = requests.get("https://github.com/vkreat-tech/ctrl4bi/raw/master/ctrl4bi/sample_datasets/sample_csv_1.csv", allow_redirects=True)
    open('sample_csv_1.csv', 'wb').write(df1_request.content)
  df1=pd.read_csv('sample_csv_1.csv')
  if not os.path.exists('sample_csv_2.csv'):
    print('Downloading sample_csv_2.csv ......')
    df2_request = requests.get("https://github.com/vkreat-tech/ctrl4bi/raw/master/ctrl4bi/sample_datasets/sample_csv_2.csv", allow_redirects=True)
