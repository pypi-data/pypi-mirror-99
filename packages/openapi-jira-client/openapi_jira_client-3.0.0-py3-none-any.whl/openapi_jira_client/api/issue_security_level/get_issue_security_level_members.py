...
def _get_kwargs(
    *,
    ...
    issue_security_level_id: Union[Unset, List[int]] = UNSET,
    expand: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/rest/api/3/issuesecurityschemes/{issueSecuritySchemeId}/members".format(
        client.base_url, issueSecuritySchemeId=issue_security_scheme_id
    )

    headers: Dict[str, Any] = client.get_headers()
    cookies: Dict[str, Any] = client.get_cookies()

    json_issue_security_level_id: Union[Unset, List[Any]] = UNSET
    ...
    params: Dict[str, Any] = {
        ...
        "issueSecurityLevelId": json_issue_security_level_id,
        "expand": expand,
    }
...
) -> Optional[Union[PageBeanIssueSecurityLevelMember, None, None, None, None]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[PageBeanIssueSecurityLevelMember, None, None, None, None]]:
    return Response(
