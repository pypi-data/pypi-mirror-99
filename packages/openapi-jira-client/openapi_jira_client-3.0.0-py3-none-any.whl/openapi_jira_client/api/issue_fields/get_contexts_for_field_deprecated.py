...
def _parse_response(*, response: httpx.Response) -> Optional[Union[PageBeanContext, None, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[PageBeanContext, None, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    start_at: Union[Unset, int] = 0,
    max_results: Union[Unset, int] = 20,
) -> Response[Union[PageBeanContext, None, None]]:
    kwargs = _get_kwargs(
        client=client,
        field_id=field_id,
        start_at=start_at,
...
def sync(
    *,
    ...
    start_at: Union[Unset, int] = 0,
    max_results: Union[Unset, int] = 20,
) -> Optional[Union[PageBeanContext, None, None]]:
