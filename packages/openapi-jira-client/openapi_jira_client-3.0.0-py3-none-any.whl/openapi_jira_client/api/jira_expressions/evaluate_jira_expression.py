...
def _get_kwargs(
    *,
    ...
    json_body: JiraExpressionEvalRequestBean,
    expand: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/rest/api/3/expression/eval".format(client.base_url)
...
) -> Optional[Union[JiraExpressionResult, ErrorCollection, None, ErrorCollection]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[JiraExpressionResult, ErrorCollection, None, ErrorCollection]]:
    return Response(
