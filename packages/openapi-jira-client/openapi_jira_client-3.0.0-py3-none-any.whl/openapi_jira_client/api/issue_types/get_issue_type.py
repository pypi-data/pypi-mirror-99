...
def _parse_response(*, response: httpx.Response) -> Optional[Union[IssueTypeDetails, None, None, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[IssueTypeDetails, None, None, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    id: str,
) -> Response[Union[IssueTypeDetails, None, None, None]]:
    kwargs = _get_kwargs(
        client=client,
        id=id,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    id: str,
) -> Optional[Union[IssueTypeDetails, None, None, None]]:
