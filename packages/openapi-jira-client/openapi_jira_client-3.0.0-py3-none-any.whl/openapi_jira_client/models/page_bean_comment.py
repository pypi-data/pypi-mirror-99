...
T = TypeVar("T", bound="PageBeanComment")
...
class PageBeanComment:
    ...
    values: Union[Unset, List[Comment]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Comment.from_dict(values_item_data)

            values.append(values_item)

        page_bean_comment = cls(
            self_=self_,
            next_page=next_page,
