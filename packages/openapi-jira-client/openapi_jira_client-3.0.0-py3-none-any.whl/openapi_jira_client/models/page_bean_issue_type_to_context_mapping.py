...
from ..models.issue_type_to_context_mapping import IssueTypeToContextMapping
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanIssueTypeToContextMapping")
...
class PageBeanIssueTypeToContextMapping:
    ...
    values: Union[Unset, List[IssueTypeToContextMapping]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueTypeToContextMapping.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_type_to_context_mapping = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_type_to_context_mapping
