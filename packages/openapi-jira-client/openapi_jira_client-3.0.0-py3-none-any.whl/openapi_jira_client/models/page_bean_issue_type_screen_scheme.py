...
T = TypeVar("T", bound="PageBeanIssueTypeScreenScheme")
...
class PageBeanIssueTypeScreenScheme:
    ...
    values: Union[Unset, List[IssueTypeScreenScheme]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueTypeScreenScheme.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_type_screen_scheme = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_type_screen_scheme
