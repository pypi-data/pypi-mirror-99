...
from ..models.issue_type_screen_schemes_projects import IssueTypeScreenSchemesProjects
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanIssueTypeScreenSchemesProjects")
...
class PageBeanIssueTypeScreenSchemesProjects:
    ...
    values: Union[Unset, List[IssueTypeScreenSchemesProjects]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueTypeScreenSchemesProjects.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_type_screen_schemes_projects = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_type_screen_schemes_projects
