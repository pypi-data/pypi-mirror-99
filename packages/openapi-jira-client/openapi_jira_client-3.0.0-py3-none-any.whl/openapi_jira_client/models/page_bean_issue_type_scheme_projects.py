...
from ..models.issue_type_scheme_projects import IssueTypeSchemeProjects
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanIssueTypeSchemeProjects")
...
class PageBeanIssueTypeSchemeProjects:
    ...
    values: Union[Unset, List[IssueTypeSchemeProjects]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueTypeSchemeProjects.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_type_scheme_projects = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_type_scheme_projects
