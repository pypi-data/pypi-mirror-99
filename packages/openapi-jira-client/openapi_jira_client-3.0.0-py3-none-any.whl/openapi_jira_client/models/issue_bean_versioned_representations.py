...
from ..models.issue_bean_versioned_representations_additional_property import (
...
class IssueBeanVersionedRepresentations:
    ...
    additional_properties: Dict[str, IssueBeanVersionedRepresentationsAdditionalProperty] = attr.ib(
