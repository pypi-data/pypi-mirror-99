...
T = TypeVar("T", bound="PageBeanIssueFieldOption")
...
class PageBeanIssueFieldOption:
    ...
    values: Union[Unset, List[IssueFieldOption]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueFieldOption.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_field_option = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_field_option
