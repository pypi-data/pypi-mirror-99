...
T = TypeVar("T", bound="PageBeanScreen")
...
class PageBeanScreen:
    ...
    values: Union[Unset, List[Screen]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Screen.from_dict(values_item_data)

            values.append(values_item)

        page_bean_screen = cls(
            self_=self_,
            next_page=next_page,
