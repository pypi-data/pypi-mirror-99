...
T = TypeVar("T", bound="PageBeanDashboard")
...
class PageBeanDashboard:
    ...
    values: Union[Unset, List[Dashboard]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Dashboard.from_dict(values_item_data)

            values.append(values_item)

        page_bean_dashboard = cls(
            self_=self_,
            next_page=next_page,
