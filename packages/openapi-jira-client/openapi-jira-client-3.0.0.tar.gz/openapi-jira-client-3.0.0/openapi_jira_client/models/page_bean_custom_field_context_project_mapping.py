...
from ..models.custom_field_context_project_mapping import CustomFieldContextProjectMapping
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanCustomFieldContextProjectMapping")
...
class PageBeanCustomFieldContextProjectMapping:
    ...
    values: Union[Unset, List[CustomFieldContextProjectMapping]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = CustomFieldContextProjectMapping.from_dict(values_item_data)

            values.append(values_item)

        page_bean_custom_field_context_project_mapping = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_custom_field_context_project_mapping
