...
T = TypeVar("T", bound="PageBeanWorkflow")
...
class PageBeanWorkflow:
    ...
    values: Union[Unset, List[Workflow]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Workflow.from_dict(values_item_data)

            values.append(values_item)

        page_bean_workflow = cls(
            self_=self_,
            next_page=next_page,
