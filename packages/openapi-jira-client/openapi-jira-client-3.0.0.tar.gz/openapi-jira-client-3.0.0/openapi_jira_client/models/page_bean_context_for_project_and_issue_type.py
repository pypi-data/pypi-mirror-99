...
from ..models.context_for_project_and_issue_type import ContextForProjectAndIssueType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanContextForProjectAndIssueType")
...
class PageBeanContextForProjectAndIssueType:
    ...
    values: Union[Unset, List[ContextForProjectAndIssueType]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = ContextForProjectAndIssueType.from_dict(values_item_data)

            values.append(values_item)

        page_bean_context_for_project_and_issue_type = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_context_for_project_and_issue_type
