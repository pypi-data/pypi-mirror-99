...
T = TypeVar("T", bound="PageBeanNotificationScheme")
...
class PageBeanNotificationScheme:
    ...
    values: Union[Unset, List[NotificationScheme]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = NotificationScheme.from_dict(values_item_data)

            values.append(values_item)

        page_bean_notification_scheme = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_notification_scheme
