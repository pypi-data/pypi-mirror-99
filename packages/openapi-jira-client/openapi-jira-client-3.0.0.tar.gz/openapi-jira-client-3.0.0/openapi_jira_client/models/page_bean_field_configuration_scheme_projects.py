...
from ..models.field_configuration_scheme_projects import FieldConfigurationSchemeProjects
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanFieldConfigurationSchemeProjects")
...
class PageBeanFieldConfigurationSchemeProjects:
    ...
    values: Union[Unset, List[FieldConfigurationSchemeProjects]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = FieldConfigurationSchemeProjects.from_dict(values_item_data)

            values.append(values_item)

        page_bean_field_configuration_scheme_projects = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_field_configuration_scheme_projects
