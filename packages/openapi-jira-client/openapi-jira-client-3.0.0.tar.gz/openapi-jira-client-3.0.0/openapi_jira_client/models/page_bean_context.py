...
T = TypeVar("T", bound="PageBeanContext")
...
class PageBeanContext:
    ...
    values: Union[Unset, List[Context]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Context.from_dict(values_item_data)

            values.append(values_item)

        page_bean_context = cls(
            self_=self_,
            next_page=next_page,
