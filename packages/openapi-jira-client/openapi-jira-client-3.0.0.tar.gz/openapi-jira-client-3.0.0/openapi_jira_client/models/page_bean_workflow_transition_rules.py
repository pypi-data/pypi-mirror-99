...
T = TypeVar("T", bound="PageBeanWorkflowTransitionRules")
...
class PageBeanWorkflowTransitionRules:
    ...
    values: Union[Unset, List[WorkflowTransitionRules]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = WorkflowTransitionRules.from_dict(values_item_data)

            values.append(values_item)

        page_bean_workflow_transition_rules = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_workflow_transition_rules
