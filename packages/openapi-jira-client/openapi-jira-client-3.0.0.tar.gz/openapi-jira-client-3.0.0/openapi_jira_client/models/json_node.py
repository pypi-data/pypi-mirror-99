...
class JsonNode:
    ...
    field_names: Union[JsonNodeFieldNames, Unset] = UNSET
    array: Union[Unset, bool] = UNSET
    fields: Union[JsonNodeFields, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        binary_value: Union[Unset, List[Any]] = UNSET
