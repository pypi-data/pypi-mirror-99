...
T = TypeVar("T", bound="PageBeanWorkflowScheme")
...
class PageBeanWorkflowScheme:
    ...
    values: Union[Unset, List[WorkflowScheme]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = WorkflowScheme.from_dict(values_item_data)

            values.append(values_item)

        page_bean_workflow_scheme = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_workflow_scheme
