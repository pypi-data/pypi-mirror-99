...
T = TypeVar("T", bound="PageBeanGroupDetails")
...
class PageBeanGroupDetails:
    ...
    values: Union[Unset, List[GroupDetails]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = GroupDetails.from_dict(values_item_data)

            values.append(values_item)

        page_bean_group_details = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_group_details
