...
T = TypeVar("T", bound="PageBeanWebhook")
...
class PageBeanWebhook:
    ...
    values: Union[Unset, List[Webhook]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Webhook.from_dict(values_item_data)

            values.append(values_item)

        page_bean_webhook = cls(
            self_=self_,
            next_page=next_page,
