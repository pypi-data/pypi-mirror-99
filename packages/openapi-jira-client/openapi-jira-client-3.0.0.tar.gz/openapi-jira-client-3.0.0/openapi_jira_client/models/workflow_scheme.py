...
class WorkflowScheme:
    ...
    issue_type_mappings: Union[WorkflowSchemeIssueTypeMappings, Unset] = UNSET
    original_default_workflow: Union[Unset, str] = UNSET
    original_issue_type_mappings: Union[WorkflowSchemeOriginalIssueTypeMappings, Unset] = UNSET
    ...
    issue_types: Union[WorkflowSchemeIssueTypes, Unset] = UNSET
