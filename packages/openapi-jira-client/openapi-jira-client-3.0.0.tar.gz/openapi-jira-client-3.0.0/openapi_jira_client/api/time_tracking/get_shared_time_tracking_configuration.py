...
def _parse_response(*, response: httpx.Response) -> Optional[Union[TimeTrackingConfiguration, None, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[TimeTrackingConfiguration, None, None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
) -> Response[Union[TimeTrackingConfiguration, None, None]]:
    kwargs = _get_kwargs(
        client=client,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
) -> Optional[Union[TimeTrackingConfiguration, None, None]]:
