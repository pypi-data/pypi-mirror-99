...
def _get_kwargs(
    *,
    ...
    json_validate_query: Union[Unset, SearchForIssuesUsingJqlValidateQuery] = UNSET
    if not isinstance(validate_query, Unset):
        json_validate_query = validate_query

    json_fields: Union[Unset, List[Any]] = UNSET
    if not isinstance(fields, Unset):
        json_fields = fields

    json_properties: Union[Unset, List[Any]] = UNSET
