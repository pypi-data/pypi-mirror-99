...
def _parse_response(*, response: httpx.Response) -> Optional[Union[EntityProperty, None, None, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[EntityProperty, None, None, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    worklog_id: str,
    property_key: str,
) -> Response[Union[EntityProperty, None, None, None]]:
    kwargs = _get_kwargs(
        client=client,
...
def sync(
    *,
    ...
    worklog_id: str,
    property_key: str,
) -> Optional[Union[EntityProperty, None, None, None]]:
