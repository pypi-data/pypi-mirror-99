...
) -> Optional[Union[EntityProperty, OperationMessage, OperationMessage, OperationMessage]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[EntityProperty, OperationMessage, OperationMessage, OperationMessage]]:
    return Response(
