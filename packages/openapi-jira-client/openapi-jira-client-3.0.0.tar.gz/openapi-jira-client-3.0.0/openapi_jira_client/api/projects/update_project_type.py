...
def _get_kwargs(
    *,
    ...
    url = "{}/rest/api/3/project/{projectIdOrKey}/type/{newProjectTypeKey}".format(
        client.base_url, projectIdOrKey=project_id_or_key, newProjectTypeKey=new_project_type_key
    )
