...
from ...models.update_custom_field_details import UpdateCustomFieldDetails
...
def _get_kwargs(
    *,
    ...
    field_id: str,
    json_body: UpdateCustomFieldDetails,
) -> Dict[str, Any]:
    url = "{}/rest/api/3/field/{fieldId}".format(client.base_url, fieldId=field_id)
