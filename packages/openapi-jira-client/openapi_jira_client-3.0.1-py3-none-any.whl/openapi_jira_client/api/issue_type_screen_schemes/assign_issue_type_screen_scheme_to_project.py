...
from ...models.issue_type_screen_scheme_project_association import IssueTypeScreenSchemeProjectAssociation
...
def _get_kwargs(
    *,
    ...
    json_body: IssueTypeScreenSchemeProjectAssociation,
) -> Dict[str, Any]:
    url = "{}/rest/api/3/issuetypescreenscheme/project".format(client.base_url)
