...
def _get_kwargs(
    *,
    ...
    issue_type_screen_scheme_id: Union[Unset, List[int]] = UNSET,
) -> Dict[str, Any]:
    url = "{}/rest/api/3/issuetypescreenscheme/mapping".format(client.base_url)

    headers: Dict[str, Any] = client.get_headers()
    cookies: Dict[str, Any] = client.get_cookies()

    json_issue_type_screen_scheme_id: Union[Unset, List[int]] = UNSET
    ...
    params: Dict[str, Any] = {
        ...
        "issueTypeScreenSchemeId": json_issue_type_screen_scheme_id,
    }
...
) -> Optional[Union[PageBeanIssueTypeScreenSchemeItem, None, None, None]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[PageBeanIssueTypeScreenSchemeItem, None, None, None]]:
    return Response(
