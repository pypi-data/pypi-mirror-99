...
T = TypeVar("T", bound="PageBeanChangelog")
...
class PageBeanChangelog:
    ...
    values: Union[Unset, List[Changelog]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Changelog.from_dict(values_item_data)

            values.append(values_item)

        page_bean_changelog = cls(
            self_=self_,
            next_page=next_page,
