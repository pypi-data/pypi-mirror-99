...
T = TypeVar("T", bound="PageBeanFieldConfigurationItem")
...
class PageBeanFieldConfigurationItem:
    ...
    values: Union[Unset, List[FieldConfigurationItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = FieldConfigurationItem.from_dict(values_item_data)

            values.append(values_item)

        page_bean_field_configuration_item = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_field_configuration_item
