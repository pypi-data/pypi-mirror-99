...
from ..models.component_with_issue_count import ComponentWithIssueCount
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanComponentWithIssueCount")
...
class PageBeanComponentWithIssueCount:
    ...
    values: Union[Unset, List[ComponentWithIssueCount]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = ComponentWithIssueCount.from_dict(values_item_data)

            values.append(values_item)

        page_bean_component_with_issue_count = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_component_with_issue_count
