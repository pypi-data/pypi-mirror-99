...
from ..models.custom_field_option_details import CustomFieldOptionDetails
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanCustomFieldOptionDetails")
...
class PageBeanCustomFieldOptionDetails:
    ...
    values: Union[Unset, List[CustomFieldOptionDetails]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = CustomFieldOptionDetails.from_dict(values_item_data)

            values.append(values_item)

        page_bean_custom_field_option_details = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_custom_field_option_details
