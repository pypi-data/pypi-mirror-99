...
T = TypeVar("T", bound="PageBeanFieldConfiguration")
...
class PageBeanFieldConfiguration:
    ...
    values: Union[Unset, List[FieldConfiguration]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = FieldConfiguration.from_dict(values_item_data)

            values.append(values_item)

        page_bean_field_configuration = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_field_configuration
