...
from ..models.issue_type_scheme_mapping import IssueTypeSchemeMapping
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanIssueTypeSchemeMapping")
...
class PageBeanIssueTypeSchemeMapping:
    ...
    values: Union[Unset, List[IssueTypeSchemeMapping]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueTypeSchemeMapping.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_type_scheme_mapping = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_type_scheme_mapping
