...
T = TypeVar("T", bound="PageBeanUserKey")
...
class PageBeanUserKey:
    ...
    values: Union[Unset, List[UserKey]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = UserKey.from_dict(values_item_data)

            values.append(values_item)

        page_bean_user_key = cls(
            self_=self_,
            next_page=next_page,
