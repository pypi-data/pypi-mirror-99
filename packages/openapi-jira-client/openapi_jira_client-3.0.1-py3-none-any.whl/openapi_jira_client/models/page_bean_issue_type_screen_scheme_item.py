...
from ..models.issue_type_screen_scheme_item import IssueTypeScreenSchemeItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanIssueTypeScreenSchemeItem")
...
class PageBeanIssueTypeScreenSchemeItem:
    ...
    values: Union[Unset, List[IssueTypeScreenSchemeItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueTypeScreenSchemeItem.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_type_screen_scheme_item = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_type_screen_scheme_item
