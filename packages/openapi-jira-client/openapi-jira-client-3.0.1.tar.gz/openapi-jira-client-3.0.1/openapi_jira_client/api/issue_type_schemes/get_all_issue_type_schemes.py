...
def _parse_response(*, response: httpx.Response) -> Optional[Union[PageBeanIssueTypeScheme, None, None, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[PageBeanIssueTypeScheme, None, None, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    id_: Union[Unset, List[int]] = UNSET,
) -> Response[Union[PageBeanIssueTypeScheme, None, None, None]]:
    kwargs = _get_kwargs(
        client=client,
        start_at=start_at,
...
def sync(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    id_: Union[Unset, List[int]] = UNSET,
) -> Optional[Union[PageBeanIssueTypeScheme, None, None, None]]:
