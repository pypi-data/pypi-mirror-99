...
def _get_kwargs(
    *,
    ...
    url = "{}/rest/api/3/attachment/{id}/expand/human".format(client.base_url, id=id_)
...
) -> Optional[Union[AttachmentArchiveMetadataReadable, None, None, None, None]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[AttachmentArchiveMetadataReadable, None, None, None, None]]:
    return Response(
