...
from ..models.issue_security_level_member import IssueSecurityLevelMember
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanIssueSecurityLevelMember")
...
class PageBeanIssueSecurityLevelMember:
    ...
    values: Union[Unset, List[IssueSecurityLevelMember]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueSecurityLevelMember.from_dict(values_item_data)

            values.append(values_item)

        page_bean_issue_security_level_member = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_issue_security_level_member
