...
T = TypeVar("T", bound="PageBeanProject")
...
class PageBeanProject:
    ...
    values: Union[Unset, List[Project]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Project.from_dict(values_item_data)

            values.append(values_item)

        page_bean_project = cls(
            self_=self_,
            next_page=next_page,
