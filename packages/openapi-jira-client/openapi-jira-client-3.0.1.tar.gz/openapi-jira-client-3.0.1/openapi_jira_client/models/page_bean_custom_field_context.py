...
from ..models.custom_field_context import CustomFieldContext
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanCustomFieldContext")
...
class PageBeanCustomFieldContext:
    ...
    values: Union[Unset, List[CustomFieldContext]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = CustomFieldContext.from_dict(values_item_data)

            values.append(values_item)

        page_bean_custom_field_context = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_custom_field_context
