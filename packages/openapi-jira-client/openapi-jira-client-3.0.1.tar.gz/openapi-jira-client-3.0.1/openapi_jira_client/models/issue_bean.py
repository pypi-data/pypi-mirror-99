...
class IssueBean:
    ...
    rendered_fields: Union[Unset, IssueBeanRenderedFields] = UNSET
    properties: Union[Unset, IssueBeanProperties] = UNSET
    names: Union[Unset, IssueBeanNames] = UNSET
    schema: Union[Unset, IssueBeanSchema] = UNSET
    ...
    versioned_representations: Union[Unset, IssueBeanVersionedRepresentations] = UNSET
    fields_to_include: Union[Unset, IncludedFields] = UNSET
    fields: Union[Unset, IssueBeanFields] = UNSET
