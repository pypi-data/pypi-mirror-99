...
T = TypeVar("T", bound="PageBeanFieldConfigurationScheme")
...
class PageBeanFieldConfigurationScheme:
    ...
    values: Union[Unset, List[FieldConfigurationScheme]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = FieldConfigurationScheme.from_dict(values_item_data)

            values.append(values_item)

        page_bean_field_configuration_scheme = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_field_configuration_scheme
