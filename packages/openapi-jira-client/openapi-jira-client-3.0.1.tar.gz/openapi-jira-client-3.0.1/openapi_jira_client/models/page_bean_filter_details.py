...
from ..models.filter_details import FilterDetails
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanFilterDetails")
...
class PageBeanFilterDetails:
    ...
    values: Union[Unset, List[FilterDetails]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = FilterDetails.from_dict(values_item_data)

            values.append(values_item)

        page_bean_filter_details = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_filter_details
