...
from ..models.screen_with_tab import ScreenWithTab
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanScreenWithTab")
...
class PageBeanScreenWithTab:
    ...
    values: Union[Unset, List[ScreenWithTab]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = ScreenWithTab.from_dict(values_item_data)

            values.append(values_item)

        page_bean_screen_with_tab = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_screen_with_tab
