...
from ..models.screen_scheme import ScreenScheme
from ..types import UNSET, Unset

T = TypeVar("T", bound="PageBeanScreenScheme")
...
class PageBeanScreenScheme:
    ...
    values: Union[Unset, List[ScreenScheme]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = ScreenScheme.from_dict(values_item_data)

            values.append(values_item)

        page_bean_screen_scheme = cls(
            self_=self_,
            next_page=next_page,
        ...
        return page_bean_screen_scheme
