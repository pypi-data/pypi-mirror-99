...
setup(
    ...
    description='Setup & analyze data from ALS BL 4.0.2 diffractometer',  # Required
    ...
    url='https://bitbucket.org/berkeleylab/als.milo/src/master/',  # Optional
    ...
    keywords='CCD RSXD XRMS XRMR x-ray ALS BL4.0.2 diffraction',  # Optional
