...
from ibvpy.time_functions import \
    LoadingScenario
from ibvpy.api import BCDof, BCSlice, IMATSEval
...
class PullOut2LayerSim(Simulator):
    ...
    dots_grid1 = Property(Instance(XDomainFEInterface1D),
    ...
    dots_grid2 = Property(Instance(XDomainFEInterface1D),
                          depends_on=itags_str)
    '''Discretization object.
    '''
    @cached_property
    ...
    def _get_domains(self):
        return [(self.dots_grid1, self.mats_eval1),
