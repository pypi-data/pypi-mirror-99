...
from pietoolbelt.metrics.cpu.segmentation import jaccard


class Bagging:
    def __init__(self, predicts_path: str, main_metric: {"jaccard": jaccard}, workers_num: int, predicts_dir: str):
        self._path = predicts_path
        self._workers_num = workers_num
        self._predicts_dir = predicts_dir
