...
class TripleMulNet(nn.Module):
    def __init__(self, input_size_a, input_size_b, hidden_size, output_size, qnet_type):
        ...
        self.linear_h2w = nn.Linear(hidden_size, output_size)
    ...
    def forward(self, x_a, x_b):
        ...
        y = F.relu(self.linear_i2h(torch.cat([y_a, y_b], dim=-1)))
        y = self.linear_h2w(y)
