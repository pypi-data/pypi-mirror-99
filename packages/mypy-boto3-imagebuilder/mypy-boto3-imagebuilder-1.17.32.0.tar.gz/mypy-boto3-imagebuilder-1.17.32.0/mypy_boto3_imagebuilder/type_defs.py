...
EbsInstanceBlockDeviceSpecificationTypeDef = TypedDict(
    "EbsInstanceBlockDeviceSpecificationTypeDef",
    {
        ...
        "snapshotId": str,
        "volumeSize": int,
        "volumeType": Literal["standard", "io1", "io2", "gp2", "gp3", "sc1", "st1"],
    },
    total=False,
)

ImagePackageTypeDef = TypedDict(
    "ImagePackageTypeDef", {"packageName": str, "packageVersion": str}, total=False
)
...
ListImagePackagesResponseTypeDef = TypedDict(
    "ListImagePackagesResponseTypeDef",
    {"requestId": str, "imagePackageList": List["ImagePackageTypeDef"], "nextToken": str},
    total=False,
)
