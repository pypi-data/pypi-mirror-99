...
def operate(grd_ob, grd_fo, smooth, threshold,minsize,match_method = centmatch,summary =True,
            save_dir = None,show = False):
    look_ff = feature_finder(grd_ob,grd_fo,smooth=smooth,threshold=threshold,minsize=minsize)
    ...
    if save_dir is not None:
        ...
        plot_value_and_label(look_merge,save_path=png_save_path,show=show)
