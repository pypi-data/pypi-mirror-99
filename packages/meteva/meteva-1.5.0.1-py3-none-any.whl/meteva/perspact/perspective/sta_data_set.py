...
class sta_data_set:
    ...
    def set_time_unfold(self,time_list_list = None,time_range_list = None):
        ...
        if time_list_list is not None:
            ...
            for time_range in time_range_list:
                time_start = meteva.base.method.time_tools.all_type_time_to_time64(time_range[0])
                time_end = meteva.base.method.time_tools.all_type_time_to_time64(time_range[1])
                dtime = time_range[2]
    ...
    def set_dtime_unfold(self,dtime_list_list = None,dtime_range_list = None):
        ...
        if dtime_list_list is not None:
            ...
            for dtime_range in dtime_range_list:
                sdtime = meteva.base.method.time_tools.all_type_timedelta_to_timedelta64(dtime_range_list[0])
                edtime = meteva.base.method.time_tools.all_type_timedelta_to_timedelta64(dtime_range_list[1])
                ddtime = meteva.base.method.time_tools.all_type_timedelta_to_timedelta64(dtime_range_list[2])
    ...
    def set_para_dict_list_list(self):
        ...
        if self.dhour == 'fold':
            ...
            dtime_list2 = []
            for dtime in dtime_list:
                dtime = meteva.base.tool.time_tools.all_type_timedelta_to_timedelta64(dtime)
                seconds = dtime/np.timedelta64(1, 's')
