...
class SessionInterface:
    ...
    If :meth:`open_session` returns ``None`` Rakish will call into
    ...
    is to assign :attr:`rakish.Rakish.session_interface`::
    ...
    #: This can be used by Rakish extensions to make a decision in regards
