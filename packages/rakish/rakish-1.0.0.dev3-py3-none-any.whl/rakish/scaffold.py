...
class Scaffold:
    """Common behavior shared between :class:`~rakish.Rakish` and
    :class:`~rakish.blueprints.Blueprint`.
    ...
    #: JSON encoder class used by :func:`rakish.json.dumps`. If a
    #: blueprint sets this, it will be used instead of the app's value.
    json_encoder = None

    #: JSON decoder class used by :func:`rakish.json.loads`. If a
    #: blueprint sets this, it will be used instead of the app's value.
    json_decoder = None
    ...
    def __init__(
        ...
        #: object. The commands are available from the ``rakish`` command
    ...
    def get_send_file_max_age(self, filename):
        ...
        the configuration of :data:`~rakish.current_app`. This defaults
    ...
    def open_resource(self, resource, mode="rb"):
        ...
        ``app.py`` where the ``Rakish`` app is defined, it can be opened
        with:
    ...
    def teardown_request(self, f):
        ...
        .. admonition:: Debug Note
           ...
           In debug mode Rakish will not tear down a request on an exception
