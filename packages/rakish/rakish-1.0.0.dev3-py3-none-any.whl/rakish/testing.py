...
class EnvironBuilder(werkzeug.test.EnvironBuilder):
    ...
    :param app: The Rakish application to configure the environment from.
...
class RakishClient(Client):
    """Works like a regular Werkzeug test client but has some knowledge about
    how Rakish works to defer the cleanup of the request context stack to the
    ...
    def session_transaction(self, *args, **kwargs):
        ...
        :meth:`~rakish.Rakish.test_request_context` which are directly
        passed through.
        """
    ...
    def open(
        ...
        def copy_environ(other):
            return {
                **self.environ_base,
                **other,
                "rakish._preserve_context": self.preserve_context,
            }
...
class RakishCliRunner(CliRunner):
    """A :class:`~click.testing.CliRunner` for testing a Rakish app's
    CLI commands. Typically created using
    :meth:`~rakish.Rakish.test_cli_runner`. See :ref:`testing-cli`.
    """
    ...
    def invoke(self, cli=None, args=None, **kwargs):
        ...
        :class:`~rakish.cli.ScriptInfo` that knows how to load the Rakish
        app being tested.

        :param cli: Command object to invoke. Default is the app's
            :attr:`~rakish.app.Rakish.cli` group.
