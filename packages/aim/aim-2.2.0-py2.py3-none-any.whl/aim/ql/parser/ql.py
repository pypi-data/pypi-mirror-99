...
from aim.ql.parser import tokens as T
from aim.ql.parser.utils import imt, remove_quotes
...
class TokenList(Token):
    ...
    def pprint_tree(self, max_depth=None, depth=0, f=None, _pre=''):
        ...
        for idx, token in enumerate(self.tokens):
            ...
            if token.is_group and (max_depth is None or depth < max_depth):
                ...
                token.pprint_tree(max_depth, depth + 1, f, _pre + parent_pre)
...
class IdentifierList(TokenList):
    """A list of :class:`~ql.Identifier`\'s."""
