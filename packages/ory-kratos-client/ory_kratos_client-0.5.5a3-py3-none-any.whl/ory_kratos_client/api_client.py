...
from ory_kratos_client import rest
from ory_kratos_client.configuration import Configuration
from ory_kratos_client.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v0.5.5-alpha.3/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_identity  # this is an instance of the class Endpoint
        api_instance.create_identity()  # this invokes api_instance.create_identity.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_identity.callable or self.callable in this class
