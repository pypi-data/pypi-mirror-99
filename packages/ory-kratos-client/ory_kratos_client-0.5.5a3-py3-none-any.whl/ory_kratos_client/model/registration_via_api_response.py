...
class RegistrationViaApiResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, identity, session_token, *args, **kwargs):  # noqa: E501
        """RegistrationViaApiResponse - a model defined in OpenAPI
