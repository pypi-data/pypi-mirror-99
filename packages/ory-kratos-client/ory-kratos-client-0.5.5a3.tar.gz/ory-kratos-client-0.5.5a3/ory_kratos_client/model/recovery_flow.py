...
def lazy_import():
    ...
    globals()['RecoveryFlowMethod'] = RecoveryFlowMethod


class RecoveryFlow(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'methods': ({str: (RecoveryFlowMethod,)},),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expires_at, id, issued_at, methods, request_url, state, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            methods ({str: (RecoveryFlowMethod,)}): Methods contains context for all account recovery methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages.
