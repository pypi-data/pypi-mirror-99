...
class FormField(ModelNormal):
    ...
    def __init__(self, name, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            disabled (bool): Disabled is the equivalent of `<input {{if .Disabled}}disabled{{end}}\">`. [optional]  # noqa: E501
            messages (Messages): [optional]  # noqa: E501
            pattern (str): Pattern is the equivalent of `<input pattern=\"{{.Pattern}}\">`. [optional]  # noqa: E501
            required (bool): Required is the equivalent of `<input required=\"{{.Required}}\">`. [optional]  # noqa: E501
            value ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Value is the equivalent of `<input value=\"{{.Value}}\">`. [optional]  # noqa: E501
        """
