...
class CfnDeliveryStream(
    ...
    def delivery_stream_encryption_configuration_input(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnDeliveryStream.DeliveryStreamEncryptionConfigurationInputProperty", aws_cdk.core.IResolvable]], jsii.get(self, "deliveryStreamEncryptionConfigurationInput"))
    ...
    def extended_s3_destination_configuration(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnDeliveryStream.ExtendedS3DestinationConfigurationProperty"]], jsii.get(self, "extendedS3DestinationConfiguration"))
...
class CfnDeliveryStreamProps:
    ...
    def delivery_stream_encryption_configuration_input(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnDeliveryStream.DeliveryStreamEncryptionConfigurationInputProperty, aws_cdk.core.IResolvable]], result)
    ...
    def extended_s3_destination_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, CfnDeliveryStream.ExtendedS3DestinationConfigurationProperty]], result)
