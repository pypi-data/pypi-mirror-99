...
timesteps = 250
if usethread:
    dbfilename = "timing-emt2011-thread.dat"
    logfilename = "timing-emt2011-thread.log"
else:
    dbfilename = "timing-emt2011.dat"
    logfilename = "timing-emt2011.log"
selfcheckfilename = "timing-emt2011-selfcheck.dat"
...
#PrintVersion(1)
print("Running ASAP timing-emt2011 on "+host+".")
...
if os.access(dbfilename, os.F_OK):
    database = pickle.load(open(dbfilename, "rb"))
    founddb = 1
else:
...
if isbetter != (0,0):
    ...
    pickle.dump(database, open(newfilename, "wb"), 1)
    if founddb:
