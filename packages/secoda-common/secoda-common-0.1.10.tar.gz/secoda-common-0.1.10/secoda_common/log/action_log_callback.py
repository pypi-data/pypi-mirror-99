...
from secoda_common.log.action_log_model import ActionLogParams
...
def register_pre_exec_callback(action_log_callback: Callable[..., Any]) -> None:
    ...
    application.log.action_log_model.ActionLogParams
...
def on_post_execution(action_log_params: ActionLogParams) -> None:
    ...
    application.log.action_log_model.ActionLogParams. Note that any exception from callback will be logged
