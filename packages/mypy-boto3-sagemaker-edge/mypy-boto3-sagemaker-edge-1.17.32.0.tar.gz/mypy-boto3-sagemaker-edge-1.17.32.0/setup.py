...
setup(
    ...
    description="Type annotations for boto3.SagemakerEdgeManager 1.17.32 service, generated by mypy-boto3-buider 4.4.0",
    classifiers=[
    ...
    keywords="boto3 sagemaker-edge type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
