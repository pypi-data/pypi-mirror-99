...
class CfnCustomDataIdentifier(
    ...
    def attr_deleted(self) -> _IResolvable_a771d0ef:
        ...
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrDeleted"))
...
class CfnFindingsFilter(
    ...
    class FindingCriteriaProperty:
        ...
        def criterion(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_a771d0ef]], result)
