...
class CfnTopic(
    ...
    def __init__(
        ...
        *,
        ...
        subscription: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnTopic.SubscriptionProperty", _IResolvable_a771d0ef]]]] = None,
...
class ITopic(_IResource_8c1dbbbd, typing_extensions.Protocol):
...
class NumericConditions:
    def __init__(
        ...
        *,
        ...
        :param whitelist: (experimental) Match one or more values. Default: - None
...
class StringConditions:
    def __init__(
        ...
        *,
        ...
        :param blacklist: (experimental) Match any value that doesn't include any of the specified values. Default: - None
