...
class CfnEventSourceMapping(
    ...
    def partial_batch_response(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]], jsii.get(self, "partialBatchResponse"))
...
class CodeSigningConfigProps:
    def __init__(
        self,
        *,
        signing_profiles: typing.List[_ISigningProfile_e1c38440],
        description: typing.Optional[builtins.str] = None,
...
class _FunctionBaseProxy(
    FunctionBase, jsii.proxy_for(_Resource_abff4495) # type: ignore[misc]
):
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="canCreatePermissions")
    def _can_create_permissions(self) -> builtins.bool:
