...
class AddBehaviorOptions:
    def __init__(
        ...
        *,
        ...
        trusted_key_groups: typing.Optional[typing.List["IKeyGroup"]] = None,
...
class CfnDistribution(
    ...
    class DistributionConfigProperty:
        ...
        def default_cache_behavior(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDistribution.DefaultCacheBehaviorProperty", _IResolvable_a771d0ef]], result)
...
class DistributionProps:
    def __init__(
        ...
        *,
        ...
        :param minimum_protocol_version: (experimental) The minimum version of the SSL protocol that you want CloudFront to use for HTTPS connections. CloudFront serves your objects only to browsers or devices that support at least the SSL version that you specify. Default: SecurityPolicyProtocol.TLS_V1_2_2019
...
class ICachePolicy(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_ICachePolicyProxy"]:
...
class IDistribution(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IDistributionProxy"]:
...
class IKeyGroup(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IKeyGroupProxy"]:
        return _IKeyGroupProxy
...
class IOrigin(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IOriginProxy"]:
...
class IOriginAccessIdentity(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IOriginAccessIdentityProxy"]:
...
class IOriginRequestPolicy(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IOriginRequestPolicyProxy"]:
...
class IPublicKey(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IPublicKeyProxy"]:
        return _IPublicKeyProxy
...
class KeyGroup(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(KeyGroup, self, [scope, id, props])
...
class OriginBase(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_OriginBaseProxy"]:
...
class PublicKey(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(PublicKey, self, [scope, id, props])
