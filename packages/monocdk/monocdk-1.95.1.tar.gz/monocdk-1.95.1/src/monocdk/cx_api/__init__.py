...
class CloudArtifact(metaclass=jsii.JSIIMeta, jsii_type="monocdk.cx_api.CloudArtifact"):
    ...
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Mapping[builtins.str, typing.List[_MetadataEntry_b98ee123]]] = None,
        properties: typing.Optional[typing.Union[_AwsCloudFormationStackProperties_6a08f279, _AssetManifestProperties_5eac543c, _TreeArtifactProperties_44f77b3d, _NestedCloudAssemblyProperties_40af483d]] = None,
    ) -> None:
        '''
        :param assembly: -
        :param id: -
...
class CloudAssemblyBuilder(
    ...
    def add_missing(
        ...
        *,
        key: builtins.str,
        props: typing.Union[_AmiContextQuery_a528fa4a, _AvailabilityZonesContextQuery_a84904c8, _HostedZoneContextQuery_3a794037, _SSMParameterContextQuery_6f44d3dd, _VpcContextQuery_12233b2e, _EndpointServiceAvailabilityZonesContextQuery_9b9d87e5, _LoadBalancerContextQuery_631e1faf, _LoadBalancerListenerContextQuery_d16fd2ba, _SecurityGroupContextQuery_6ba2a6f0],
...
class IEnvironmentPlaceholderProvider(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_IEnvironmentPlaceholderProviderProxy"]:
...
class MetadataEntry(_MetadataEntry_b98ee123):
    def __init__(
        ...
        *,
        type: builtins.str,
        data: typing.Optional[typing.Union[builtins.str, _FileAssetMetadataEntry_3cdad4c1, _ContainerImageAssetMetadataEntry_c1b055f1, typing.List[_Tag_34494fd5]]] = None,
