...
class CfnWorkGroup(
    ...
    def work_group_configuration_updates(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnWorkGroup.WorkGroupConfigurationUpdatesProperty", _IResolvable_a771d0ef]], jsii.get(self, "workGroupConfigurationUpdates"))
    ...
    class WorkGroupConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            engine_version: typing.Optional[typing.Union["CfnWorkGroup.EngineVersionProperty", _IResolvable_a771d0ef]] = None,
    ...
    class WorkGroupConfigurationUpdatesProperty:
        ...
        def result_configuration_updates(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnWorkGroup.ResultConfigurationUpdatesProperty", _IResolvable_a771d0ef]], result)
...
class CfnWorkGroupProps:
    ...
    def work_group_configuration_updates(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnWorkGroup.WorkGroupConfigurationUpdatesProperty, _IResolvable_a771d0ef]], result)
