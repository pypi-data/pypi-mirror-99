...
class ClientAttributes(
    ...
    def __init__(self) -> None:
        ...
        :stability: experimental
        '''
        jsii.create(ClientAttributes, self, [])
...
class ICustomAttribute(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_ICustomAttributeProxy"]:
...
class IUserPool(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IUserPoolProxy"]:
...
class IUserPoolClient(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IUserPoolClientProxy"]:
...
class IUserPoolDomain(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IUserPoolDomainProxy"]:
...
class IUserPoolIdentityProvider(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IUserPoolIdentityProviderProxy"]:
...
class IUserPoolResourceServer(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IUserPoolResourceServerProxy"]:
...
class StandardAttributes:
    def __init__(
        ...
        *,
        ...
        :param email_verified: (experimental) Whether the email address has been verified. Default: - see the defaults under ``StandardAttribute``
        ...
        :param phone_number_verified: (experimental) Whether the phone number has been verified. Default: - see the defaults under ``StandardAttribute``
...
class StandardAttributesMask:
    def __init__(
        ...
        *,
        ...
        '''(experimental) This interface contains all standard attributes recognized by Cognito from https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html including ``email_verified`` and ``phone_number_verified``.
...
class UserPoolIdentityProviderApple(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(UserPoolIdentityProviderApple, self, [scope, id, props])
