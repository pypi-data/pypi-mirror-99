...
class CfnInstanceAccessControlAttributeConfiguration(
    ...
    class AccessControlAttributeValueProperty:
        ...
        def source(
            ...
            return typing.cast(typing.Union["CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeValueSourceListProperty", _IResolvable_a771d0ef], result)
