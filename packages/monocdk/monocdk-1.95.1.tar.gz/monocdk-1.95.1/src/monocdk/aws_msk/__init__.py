...
class CfnCluster(
    ...
    class SaslProperty:
        def __init__(
            self,
            *,
            scram: typing.Union["CfnCluster.ScramProperty", _IResolvable_a771d0ef],
        ) -> None:
            '''
        ...
        def scram(
            self,
        ) -> typing.Union["CfnCluster.ScramProperty", _IResolvable_a771d0ef]:
            ...
            return typing.cast(typing.Union["CfnCluster.ScramProperty", _IResolvable_a771d0ef], result)
...
class Cluster(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_msk.Cluster"):
