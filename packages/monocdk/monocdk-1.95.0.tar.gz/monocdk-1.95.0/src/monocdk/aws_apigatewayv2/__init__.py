...
class CfnIntegration(
    ...
    class ResponseParameterListProperty:
        def __init__(
            self,
            *,
            response_parameters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnIntegration.ResponseParameterProperty", _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            '''
...
@jsii.interface(jsii_type="monocdk.aws_apigatewayv2.IWebSocketRouteIntegration")
...
class _IWebSocketRouteIntegrationProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk.aws_apigatewayv2.IWebSocketRouteIntegration"
