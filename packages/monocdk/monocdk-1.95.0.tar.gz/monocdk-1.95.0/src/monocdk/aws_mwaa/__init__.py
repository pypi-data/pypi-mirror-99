...
class CfnEnvironment(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        airflow_configuration_options: typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_a771d0ef]] = None,
        ...
        logging_configuration: typing.Optional[typing.Union["CfnEnvironment.LoggingConfigurationProperty", _IResolvable_a771d0ef]] = None,
        max_workers: typing.Optional[jsii.Number] = None,
        network_configuration: typing.Optional[typing.Union["CfnEnvironment.NetworkConfigurationProperty", _IResolvable_a771d0ef]] = None,
    ...
    def airflow_configuration_options(
        self,
    ) -> typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_a771d0ef]], jsii.get(self, "airflowConfigurationOptions"))

    @airflow_configuration_options.setter
    def airflow_configuration_options(
        self,
        value: typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_a771d0ef]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_mwaa.CfnEnvironment.AirflowConfigurationOptionsProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    ...
    class LoggingConfigurationProperty:
        def __init__(
            self,
            *,
            dag_processing_logs: typing.Optional[typing.Union["CfnEnvironment.ModuleLoggingConfigurationProperty", _IResolvable_a771d0ef]] = None,
            scheduler_logs: typing.Optional[typing.Union["CfnEnvironment.ModuleLoggingConfigurationProperty", _IResolvable_a771d0ef]] = None,
            task_logs: typing.Optional[typing.Union["CfnEnvironment.ModuleLoggingConfigurationProperty", _IResolvable_a771d0ef]] = None,
            webserver_logs: typing.Optional[typing.Union["CfnEnvironment.ModuleLoggingConfigurationProperty", _IResolvable_a771d0ef]] = None,
            worker_logs: typing.Optional[typing.Union["CfnEnvironment.ModuleLoggingConfigurationProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_mwaa.CfnEnvironment.TagMapProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
...
class CfnEnvironmentProps:
    ...
    def airflow_configuration_options(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnEnvironment.AirflowConfigurationOptionsProperty, _IResolvable_a771d0ef]], result)
