...
class CfnAssessmentTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        user_attributes_for_findings: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union[_IResolvable_a771d0ef, _CfnTag_95fbdc29]]]] = None,
    ) -> None:
...
class CfnResourceGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        resource_group_tags: typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union[_IResolvable_a771d0ef, _CfnTag_95fbdc29]]],
    ) -> None:
