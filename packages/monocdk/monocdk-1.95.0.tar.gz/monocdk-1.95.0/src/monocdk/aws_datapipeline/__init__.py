...
class CfnPipeline(
    ...
    def parameter_objects(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnPipeline.ParameterObjectProperty", _IResolvable_a771d0ef]]], jsii.get(self, "parameterObjects"))
...
class CfnPipelineProps:
    ...
    def parameter_objects(
        ...
        return typing.cast(typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union[CfnPipeline.ParameterObjectProperty, _IResolvable_a771d0ef]]], result)
