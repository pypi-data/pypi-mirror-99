...
class BaseDataSource(
    ...
    def __jsii_proxy_class__() -> typing.Type["_BaseDataSourceProxy"]:
...
class CfnGraphQLApi(
    ...
    def __init__(
        ...
        *,
        ...
        lambda_authorizer_config: typing.Optional[typing.Union["CfnGraphQLApi.LambdaAuthorizerConfigProperty", _IResolvable_a771d0ef]] = None,
...
class IAppsyncFunction(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IAppsyncFunctionProxy"]:
...
class IField(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IFieldProxy"]:
        return _IFieldProxy
...
class IGraphqlApi(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IGraphqlApiProxy"]:
...
class IIntermediateType(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IIntermediateTypeProxy"]:
...
class MappingTemplate(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_MappingTemplateProxy"]:
    ...
    def lambda_request(
        ...
        :stability: experimental
        '''
        return typing.cast("MappingTemplate", jsii.sinvoke(cls, "lambdaRequest", [payload]))
...
class BackedDataSource(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_BackedDataSourceProxy"]:
...
class GraphqlApiBase(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_GraphqlApiBaseProxy"]:
...
class _GraphqlApiBaseProxy(
    GraphqlApiBase, jsii.proxy_for(_Resource_abff4495) # type: ignore[misc]
):
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="apiId")
    def api_id(self) -> builtins.str:
