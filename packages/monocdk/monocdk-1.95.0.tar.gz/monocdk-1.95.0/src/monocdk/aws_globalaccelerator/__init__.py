...
from ..aws_ec2 import (
    ISecurityGroup as _ISecurityGroup_cdbba9d3, IVpc as _IVpc_6d1f76c4
)
...
class AcceleratorSecurityGroup(
    ...
    jsii_type="monocdk.aws_globalaccelerator.AcceleratorSecurityGroup",
):
    ...
    def from_vpc(
        ...
        :stability: experimental
        '''
        return typing.cast(_ISecurityGroup_cdbba9d3, jsii.sinvoke(cls, "fromVpc", [scope, id, vpc, endpoint_group]))
...
class CfnEndpointGroup(
    ...
    def __init__(
        ...
        *,
        ...
        endpoint_configurations: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnEndpointGroup.EndpointConfigurationProperty", _IResolvable_a771d0ef]]]] = None,
        ...
        port_overrides: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnEndpointGroup.PortOverrideProperty", _IResolvable_a771d0ef]]]] = None,
...
class CfnListener(
    ...
    def __init__(
        ...
        *,
        accelerator_arn: builtins.str,
        port_ranges: typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnListener.PortRangeProperty", _IResolvable_a771d0ef]]],
...
@jsii.data_type(
    jsii_type="monocdk.aws_globalaccelerator.Ec2Instance",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk.aws_globalaccelerator.ElasticIpAddress",
    jsii_struct_bases=[],
...
class EndpointConfiguration(
    _Construct_e78e779f,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_globalaccelerator.EndpointConfiguration",
):
...
@jsii.data_type(
    jsii_type="monocdk.aws_globalaccelerator.EndpointConfigurationOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk.aws_globalaccelerator.EndpointConfigurationProps",
...
@jsii.data_type(
    jsii_type="monocdk.aws_globalaccelerator.LoadBalancer",
    jsii_struct_bases=[],
