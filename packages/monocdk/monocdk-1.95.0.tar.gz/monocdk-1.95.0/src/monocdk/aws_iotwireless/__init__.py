...
class CfnDeviceProfile(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        lo_ra_wan: typing.Optional[typing.Union["CfnDeviceProfile.LoRaWANDeviceProfileProperty", _IResolvable_a771d0ef]] = None,
...
class CfnServiceProfile(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        lo_ra_wan: typing.Optional[typing.Union["CfnServiceProfile.LoRaWANServiceProfileProperty", _IResolvable_a771d0ef]] = None,
        name: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.List[_CfnTag_95fbdc29]] = None,
    ) -> None:
    ...
    def attr_hr_allowed(self) -> _IResolvable_a771d0ef:
        '''
        :cloudformationAttribute: HrAllowed
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrHrAllowed"))
    ...
    def attr_nwk_geo_loc(self) -> _IResolvable_a771d0ef:
        '''
        :cloudformationAttribute: NwkGeoLoc
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrNwkGeoLoc"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrPrAllowed")
    def attr_pr_allowed(self) -> _IResolvable_a771d0ef:
        '''
        :cloudformationAttribute: PrAllowed
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrPrAllowed"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrRaAllowed")
    def attr_ra_allowed(self) -> _IResolvable_a771d0ef:
        '''
        :cloudformationAttribute: RaAllowed
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrRaAllowed"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrReportDevStatusBattery")
    def attr_report_dev_status_battery(self) -> _IResolvable_a771d0ef:
        '''
        :cloudformationAttribute: ReportDevStatusBattery
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrReportDevStatusBattery"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrReportDevStatusMargin")
    def attr_report_dev_status_margin(self) -> _IResolvable_a771d0ef:
        '''
        :cloudformationAttribute: ReportDevStatusMargin
        '''
        return typing.cast(_IResolvable_a771d0ef, jsii.get(self, "attrReportDevStatusMargin"))
...
class CfnWirelessDevice(
    ...
    def __init__(
        ...
        *,
        ...
        lo_ra_wan: typing.Optional[typing.Union["CfnWirelessDevice.LoRaWANDeviceProperty", _IResolvable_a771d0ef]] = None,
        name: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.List[_CfnTag_95fbdc29]] = None,
    ...
    class AbpV10xProperty:
        def __init__(
            ...
            *,
            ...
            session_keys: typing.Union["CfnWirelessDevice.SessionKeysAbpV10xProperty", _IResolvable_a771d0ef],
        ) -> None:
            '''
    ...
    class AbpV11Property:
        def __init__(
            ...
            *,
            dev_addr: builtins.str,
            session_keys: typing.Union["CfnWirelessDevice.SessionKeysAbpV11Property", _IResolvable_a771d0ef],
        ) -> None:
            '''
...
class CfnWirelessGateway(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        lo_ra_wan: typing.Union["CfnWirelessGateway.LoRaWANGatewayProperty", _IResolvable_a771d0ef],
        description: typing.Optional[builtins.str] = None,
        last_uplink_received_at: typing.Optional[builtins.str] = None,
        name: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.List[_CfnTag_95fbdc29]] = None,
