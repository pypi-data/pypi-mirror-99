...
from ..aws_apigatewayv2 import IHttpApi as _IHttpApi_0223d52c
...
class BatchSubmitJobProps(_TaskStateBaseProps_b13f6332):
    ...
    def job_definition(self) -> _IJobDefinition_62e31f75:
        ...
        return typing.cast(_IJobDefinition_62e31f75, result)
    ...
    def job_queue(self) -> _IJobQueue_1a4ac619:
        ...
        return typing.cast(_IJobQueue_1a4ac619, result)
...
class CallApiGatewayHttpApiEndpointProps(CallApiGatewayEndpointBaseProps):
    ...
    @builtins.property
    def api(self) -> _IHttpApi_0223d52c:
        ...
        return typing.cast(_IHttpApi_0223d52c, result)
