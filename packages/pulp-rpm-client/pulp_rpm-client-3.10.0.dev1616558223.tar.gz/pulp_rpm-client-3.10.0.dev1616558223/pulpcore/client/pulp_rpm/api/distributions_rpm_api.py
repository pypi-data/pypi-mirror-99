...
class DistributionsRpmApi(object):
    ...
    def delete(self, rpm_rpm_distribution_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str rpm_rpm_distribution_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def delete_with_http_info(self, rpm_rpm_distribution_href, **kwargs):  # noqa: E501
        ...
        path_params = {}
        if 'rpm_rpm_distribution_href' in local_var_params:
            path_params['rpm_rpm_distribution_href'] = local_var_params['rpm_rpm_distribution_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{rpm_rpm_distribution_href}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedrpmRpmDistributionResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedrpmRpmDistributionResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def partial_update_with_http_info(self, rpm_rpm_distribution_href, patchedrpm_rpm_distribution, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '{rpm_rpm_distribution_href}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
