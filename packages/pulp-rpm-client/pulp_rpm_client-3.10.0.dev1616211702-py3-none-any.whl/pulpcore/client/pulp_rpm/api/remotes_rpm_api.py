...
class RemotesRpmApi(object):
    ...
    def delete(self, rpm_rpm_remote_href, **kwargs):  # noqa: E501
        """Delete a rpm remote  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(rpm_rpm_remote_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str rpm_rpm_remote_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(rpm_rpm_remote_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, rpm_rpm_remote_href, **kwargs):  # noqa: E501
        """Delete a rpm remote  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(rpm_rpm_remote_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rpm_rpm_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['rpm_rpm_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rpm_rpm_remote_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'rpm_rpm_remote_href' in local_var_params:
            path_params['rpm_rpm_remote_href'] = local_var_params['rpm_rpm_remote_href']  # noqa: E501
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedrpmRpmRemoteResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedrpmRpmRemoteResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def partial_update(self, rpm_rpm_remote_href, patchedrpm_rpm_remote, **kwargs):  # noqa: E501
        """Update a rpm remote  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(rpm_rpm_remote_href, patchedrpm_rpm_remote, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(rpm_rpm_remote_href, patchedrpm_rpm_remote, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, rpm_rpm_remote_href, patchedrpm_rpm_remote, **kwargs):  # noqa: E501
        """Update a rpm remote  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(rpm_rpm_remote_href, patchedrpm_rpm_remote, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rpm_rpm_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['rpm_rpm_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rpm_rpm_remote_href` when calling `partial_update`")  # noqa: E501
    ...
    def read(self, rpm_rpm_remote_href, **kwargs):  # noqa: E501
        """Inspect a rpm remote  # noqa: E501

        A ViewSet for RpmRemote.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(rpm_rpm_remote_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(rpm_rpm_remote_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, rpm_rpm_remote_href, **kwargs):  # noqa: E501
        """Inspect a rpm remote  # noqa: E501

        A ViewSet for RpmRemote.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(rpm_rpm_remote_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rpm_rpm_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['rpm_rpm_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rpm_rpm_remote_href` when calling `read`")  # noqa: E501
    ...
    def update(self, rpm_rpm_remote_href, rpm_rpm_remote, **kwargs):  # noqa: E501
        """Update a rpm remote  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(rpm_rpm_remote_href, rpm_rpm_remote, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(rpm_rpm_remote_href, rpm_rpm_remote, **kwargs)  # noqa: E501

    def update_with_http_info(self, rpm_rpm_remote_href, rpm_rpm_remote, **kwargs):  # noqa: E501
        """Update a rpm remote  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(rpm_rpm_remote_href, rpm_rpm_remote, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rpm_rpm_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['rpm_rpm_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rpm_rpm_remote_href` when calling `update`")  # noqa: E501
        # verify the required parameter 'rpm_rpm_remote' is set
        if self.api_client.client_side_validation and ('rpm_rpm_remote' not in local_var_params or  # noqa: E501
                                                        local_var_params['rpm_rpm_remote'] is None):  # noqa: E501
