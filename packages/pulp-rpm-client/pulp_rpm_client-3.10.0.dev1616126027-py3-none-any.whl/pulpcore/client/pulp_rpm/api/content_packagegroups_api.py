...
class ContentPackagegroupsApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedrpmPackageGroupResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedrpmPackageGroupResponseList',  # noqa: E501
    ...
    def read(self, rpm_package_group_href, **kwargs):  # noqa: E501
        """Inspect a package group  # noqa: E501

        PackageGroup ViewSet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(rpm_package_group_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str rpm_package_group_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(rpm_package_group_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, rpm_package_group_href, **kwargs):  # noqa: E501
        """Inspect a package group  # noqa: E501

        PackageGroup ViewSet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(rpm_package_group_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('rpm_package_group_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['rpm_package_group_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rpm_package_group_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'rpm_package_group_href' in local_var_params:
            path_params['rpm_package_group_href'] = local_var_params['rpm_package_group_href']  # noqa: E501
