from aurore.config import config_options
...
DEFAULT_SCHEMA = (
    ...
    ('base_uri', config_options.URL(default="")),
    ...
    # The aurore theme for the documentation.
    ...
    # enabling strict mode causes aurore to stop the build when a problem is
    ...
    # aurore itself. A good example here would be including the current
    # project version.
