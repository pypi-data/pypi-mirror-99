# Generated from /Users/ozgelule/thundra-agent-java/thundra-agent-broker-tracepoint/src/main/antlr4/io/thundra/agent/broker/tracepoint/condition/parser/Condition.g4 by ANTLR 4.7.2
# encoding: utf-8
import sys
...
class ConditionParser(Parser):
    ...
    def expression(self, _p: int = 0):
        ...
        try:
            ...
            if token in [ConditionParser.LPAREN]:
                ...
                pass
            elif token in [ConditionParser.BOOLEAN, ConditionParser.NULL, ConditionParser.CHARACTER,
                           ConditionParser.NUMBER, ConditionParser.STRING, ConditionParser.VARIABLE,
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    _prevctx = localctx
                    localctx = ConditionParser.BinaryExpressionContext(self, ConditionParser.ExpressionContext(self,
                                                                                                               _parentctx,
                                                                                                               _parentState))
    ...
    def comparator(self):
        ...
        try:
            ...
            if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ConditionParser.GT) | (1 << ConditionParser.GE) | (1 << ConditionParser.LT) | (
                    1 << ConditionParser.LE) | (1 << ConditionParser.EQ) | (1 << ConditionParser.NE))) != 0)):
    ...
    def operand(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ConditionParser.BOOLEAN) | (1 << ConditionParser.NULL) | (1 << ConditionParser.CHARACTER) | (
                    1 << ConditionParser.NUMBER) | (1 << ConditionParser.STRING) | (1 << ConditionParser.VARIABLE) | (
                            1 << ConditionParser.PLACEHOLDER))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
