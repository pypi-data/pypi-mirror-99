...
from tracepointdebug.tracepoint import errors
from tracepointdebug.tracepoint.coded_exception import CodedException
from tracepointdebug.tracepoint.trace_point import TracePoint
from tracepointdebug.tracepoint.trace_point_config import TracePointConfig
...
class TracePointManager(object):
    ...
    def update_trace_point(self, trace_point_id, client, expire_duration, expire_count, enable_tracing,
        ...
        with self._lock:
            ...
            trace_point_config = TracePointConfig(trace_point_id, trace_point.config.file, trace_point.config.line,
    ...
    def put_trace_point(self, trace_point_id, file, file_hash, line, client, expire_duration, expire_count,
        ...
        with self._lock:
            ...
            trace_point_config = TracePointConfig(trace_point_id, file, line, client, condition, expire_duration,
                                                  expire_count,
                                                  file_hash=file_hash,
