...
from tracepointdebug.tracepoint.request.update_trace_point_request import UpdateTracePointRequest
from tracepointdebug.tracepoint.response.update_trace_point_response import UpdateTracePointResponse
