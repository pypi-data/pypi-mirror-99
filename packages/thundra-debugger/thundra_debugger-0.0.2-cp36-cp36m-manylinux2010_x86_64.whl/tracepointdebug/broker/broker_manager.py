...
API_KEY = os.environ.get("thundra_apiKey")
BROKER_HOST = os.environ.get("thundra_agent_broker_host", "wss://broker.thundra.io")
BROKER_PORT = os.environ.get("thundra_agent_broker_port", 443)
