...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.22.1-alpha.1616094643+a59403bc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.22.1-alpha.1616094643+a59403bc`
                """)
            else:
                raise
