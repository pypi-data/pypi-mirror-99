...
class RequestorApi(object):
    ...
    def accept_debit_note(self, debit_note_id, acceptance, **kwargs):  # noqa: E501
        """Accept received Debit Note.  # noqa: E501

        Send Debit Note Accepted message to Debit Note Issuer. If Debit Note is binding (i.e. has non-null payment due date) trigger payment orchestration for this Debit Note using specified Allocation.  This is a blocking operation. It will not return until the Requestor has acknowledged accepting the Invoice or timeout has passed.  **NOTE:** An Accepted Debit Note cannot be Rejected later.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accept_debit_note(debit_note_id, acceptance, async_req=True)
        >>> result = thread.get()
        ...
        return self.accept_debit_note_with_http_info(debit_note_id, acceptance, **kwargs)  # noqa: E501

    def accept_debit_note_with_http_info(self, debit_note_id, acceptance, **kwargs):  # noqa: E501
        """Accept received Debit Note.  # noqa: E501

        Send Debit Note Accepted message to Debit Note Issuer. If Debit Note is binding (i.e. has non-null payment due date) trigger payment orchestration for this Debit Note using specified Allocation.  This is a blocking operation. It will not return until the Requestor has acknowledged accepting the Invoice or timeout has passed.  **NOTE:** An Accepted Debit Note cannot be Rejected later.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accept_debit_note_with_http_info(debit_note_id, acceptance, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('debit_note_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `debit_note_id` when calling `accept_debit_note`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'timeout' in local_var_params and local_var_params['timeout'] < 0.0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `timeout` when calling `accept_debit_note`, must be a value greater than or equal to `0.0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/debitNotes/{debitNoteId}/accept', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def accept_invoice_with_http_info(
        ...
        if self.api_client.client_side_validation and 'timeout' in local_var_params and local_var_params['timeout'] < 0.0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `timeout` when calling `accept_invoice`, must be a value greater than or equal to `0.0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/invoices/{invoiceId}/accept', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_allocation_with_http_info(self, allocation, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `create_allocation`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `create_allocation`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_demand_decorations(self, allocation_ids, **kwargs):  # noqa: E501
        """Obtain Demand elements specific to the given allocations, to be appended to a market Demand.  # noqa: E501

        Generate payment-related properties and constraints to be added to a demand published on the marketplace. As a parameter it accepts a list of IDs of allocations to be used to pay for invoices resulting from the decorated demand.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_demand_decorations(allocation_ids, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[str] allocation_ids: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_demand_decorations_with_http_info(allocation_ids, **kwargs)  # noqa: E501

    def get_demand_decorations_with_http_info(self, allocation_ids, **kwargs):  # noqa: E501
        """Obtain Demand elements specific to the given allocations, to be appended to a market Demand.  # noqa: E501

        Generate payment-related properties and constraints to be added to a demand published on the marketplace. As a parameter it accepts a list of IDs of allocations to be used to pay for invoices resulting from the decorated demand.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_demand_decorations_with_http_info(allocation_ids, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(MarketDecoration, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in local_var_params['kwargs'].items():
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_demand_decorations" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'allocation_ids' is set
        if self.api_client.client_side_validation and ('allocation_ids' not in local_var_params or  # noqa: E501
                                                        local_var_params['allocation_ids'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `allocation_ids` when calling `get_demand_decorations`")  # noqa: E501
        ...
        query_params = []
        if 'allocation_ids' in local_var_params and local_var_params['allocation_ids'] is not None:  # noqa: E501
            query_params.append(('allocationIds', local_var_params['allocation_ids']))  # noqa: E501
            collection_formats['allocationIds'] = 'csv'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MarketDecoration',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_requestor_accounts(self, **kwargs):  # noqa: E501
        """Get available accounts for sending payments.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_requestor_accounts(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_requestor_accounts_with_http_info(**kwargs)  # noqa: E501

    def get_requestor_accounts_with_http_info(self, **kwargs):  # noqa: E501
        """Get available accounts for sending payments.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_requestor_accounts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in local_var_params['kwargs'].items():
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_requestor_accounts" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def reject_debit_note(self, debit_note_id, rejection, **kwargs):  # noqa: E501
        ...
        **WARNING:** Operation not implemented.  Send Debit Note Rejected message to Invoice Issuer. Notification of rejection is signalling that Requestor does not accept the Debit Note (for some reason).  This is a blocking operation. It will not return until the Requestor has acknowledged rejecting the Invoice or timeout has passed.  **NOTE:** A Rejected Debit Note can be Accepted subsequently (e.g. as a result of some arbitrage).   # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.reject_debit_note_with_http_info(debit_note_id, rejection, **kwargs)  # noqa: E501

    def reject_debit_note_with_http_info(self, debit_note_id, rejection, **kwargs):  # noqa: E501
        """Reject received Debit Note.  # noqa: E501

        **WARNING:** Operation not implemented.  Send Debit Note Rejected message to Invoice Issuer. Notification of rejection is signalling that Requestor does not accept the Debit Note (for some reason).  This is a blocking operation. It will not return until the Requestor has acknowledged rejecting the Invoice or timeout has passed.  **NOTE:** A Rejected Debit Note can be Accepted subsequently (e.g. as a result of some arbitrage).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reject_debit_note_with_http_info(debit_note_id, rejection, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('debit_note_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['debit_note_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `debit_note_id` when calling `reject_debit_note`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'timeout' in local_var_params and local_var_params['timeout'] < 0.0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `timeout` when calling `reject_debit_note`, must be a value greater than or equal to `0.0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/debitNotes/{debitNoteId}/reject', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def reject_invoice_with_http_info(
        ...
        **WARNING:** Operation not implemented.  Send Invoice Rejected message to Invoice Issuer. Notification of rejection is signalling that Requestor does not accept Invoice (for some reason).  This is a blocking operation. It will not return until the Requestor has acknowledged rejecting the Invoice or timeout has passed.  **NOTE:** A Rejected Invoice can be Accepted subsequently (e.g. as a result of some arbitrage).   # noqa: E501
        ...
        if self.api_client.client_side_validation and 'timeout' in local_var_params and local_var_params['timeout'] < 0.0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `timeout` when calling `reject_invoice`, must be a value greater than or equal to `0.0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/invoices/{invoiceId}/reject', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def release_allocation_with_http_info(self, allocation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/allocations/{allocationId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
