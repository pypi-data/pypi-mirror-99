...
import ardicsrtcollector.helper.helper as package_version
...
setup(
    ...
    py_modules=["ardicsrtcollector", "ardicsrtcollector/crop_mp3_srt/crop_mp3_srt", "ardicsrtcollector/youtube_srt_mp3","ardicsrtcollector/helper/helper" ],
