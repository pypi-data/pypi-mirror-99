...
class __FlagUpdateSerDer__:
    ...
    def parseInternal(self, value, instance):
        itemsIdValue = value['itemsId']
        instance.itemsId = serder.ListSerDer(serder.LONG).parse(itemsIdValue)
    ...
    def encodeInternal(self, value, instance):
        ...
        itemsIdValue = value.itemsId
        instance["itemsId"] = serder.ListSerDer(serder.LONG).encode(itemsIdValue)
        from netbluemind.backend.mail.api.flags.MailboxItemFlag import MailboxItemFlag
        from netbluemind.backend.mail.api.flags.MailboxItemFlag import __MailboxItemFlagSerDer__
        mailboxItemFlagValue = value.mailboxItemFlag
        instance["mailboxItemFlag"] = __MailboxItemFlagSerDer__().encode(mailboxItemFlagValue)
        return instance
