...
class ErrorCode(Enum):
    ...
    EMPTY_EVENT_ATTACHMENT_VALUE = 'EMPTY_EVENT_ATTACHMENT_VALUE';
    TIMEOUT = 'TIMEOUT';
    VERSION_HAS_CHANGED = 'VERSION_HAS_CHANGED';
    MULTIPLE_EVENT_COUNTERS = 'MULTIPLE_EVENT_COUNTERS';
    EVENT_ACCEPTS_NO_COUNTERS = 'EVENT_ACCEPTS_NO_COUNTERS';
