...
class ItemIdentifier (ItemVersion):
    def __init__( self):
        ItemVersion.__init__(self)
        self.uid = None
        pass

class __ItemIdentifierSerDer__:
    def __init__( self ):
        pass
    ...
    def parse(self, value):
        if(value == None):
            return None
        instance = ItemIdentifier()
        __ItemVersionSerDer__().parseInternal(value,instance)
    ...
    def encodeInternal(self, value, instance):
        __ItemVersionSerDer__().encodeInternal(value,instance)
