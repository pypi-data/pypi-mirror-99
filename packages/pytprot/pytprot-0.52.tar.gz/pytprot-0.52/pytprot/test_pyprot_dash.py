...
inputfiles_basic = [file for file in os.listdir('/home/oth/BHS/PYT/1.project/pytprot/tests/examples/1gzx')]
path_basic = '/home/oth/BHS/PYT/1.project/pytprot/tests/examples/1gzx/'
...
def superimpose(chain1, chain2, apply=False):
    """
    ...
    # If they are the same size
        ...
        if apply == True:
            imposer.apply(moving_m.get_atoms())
        print(imposer.rms)
