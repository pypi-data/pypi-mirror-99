...
def unbalance_condition_longwas_trans(data_file, id, tpoint, trait, bed_file, agmat_file, var_com, condition_snp,
    ...
    :param condition_snp: conditional SNP added to fixed effects
