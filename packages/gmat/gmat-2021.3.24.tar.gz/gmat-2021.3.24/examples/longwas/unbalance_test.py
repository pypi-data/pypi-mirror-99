...
kin_lst = agmat(bed_file, out_file='../data/mouse_long/test', inv=True, small_val=0.001, out_fmt='id_id_val')
data_file = '../data/mouse_long/phe.unbalance.txt'
id = 'ID'
tpoint = 'weak'
trait = 'trait'
kin_inv_file = '../data/mouse_long/test.agiv.id_fmt'
tfix = 'Sex'
...
res_fixed_perm = unbalance_longwas_fixed_permutation(data_file, id, tpoint, trait, bed_file, kin_file, var_com, permutation_lst=[0],
...
res_trans_perm = unbalance_longwas_trans_permutation(data_file, id, tpoint, trait, bed_file, kin_file, var_com, permutation_lst=[0],
                                    tfix=None, prefix_outfile=prefix_outfile)
