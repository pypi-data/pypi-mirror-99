...
def _remma_epiAD_eff(y, xmat, zmat, gmat_lst, var_com, bed_file, snp_lst_0=None, var_app=1.0, p_cut=1.0e-5, out_file='epiAD_eff'):
    """
    ...
    :param out_file: output file. default value is 'remma_epiAA_eff'.
    :return: 0
    """
...
def remma_epiAD_eff(pheno_file, bed_file, gmat_lst, var_com, snp_lst_0=None, var_app=1.0, p_cut=1.0e-5, out_file='epiAD_eff'):
    """
    ...
    :param var_app: the approximate variances for estimated SNP effects.
    :param p_cut: put cut value. default value is 1.0e-5.
    :param out_file: output file. default value is 'epiAD_eff'.
    :return: 0
    """
    y, xmat, zmat = design_matrix_wemai_multi_gmat(pheno_file, bed_file)
    res = _remma_epiAD_eff(y, xmat, zmat, gmat_lst, var_com, bed_file,
                           snp_lst_0=snp_lst_0, var_app=var_app, p_cut=p_cut, out_file=out_file)
    return res


def _remma_epiAD_eff_parallel(y, xmat, zmat, gmat_lst, var_com, bed_file, parallel,
    ...
    :param var_app: the approximate variances for estimated SNP effects.
    :param p_cut: put cut value. default value is 1.0e-5.
    :param out_file: output file. default value is 'remma_epiAD_eff_parallel'.
    :return: 0
    """
    ...
    res = _remma_epiAD_eff(y, xmat, zmat, gmat_lst, var_com, bed_file, snp_lst_0=snp_list_0, var_app=var_app,
                                p_cut=p_cut, out_file=out_file + '.' + str(parallel[1]))
    return res


def remma_epiAD_eff_parallel(pheno_file, bed_file, gmat_lst, var_com, parallel,
                                   var_app=1.0, p_cut=1.0e-5, out_file='epiAD_eff_parallel'):
    """
    Parallel version. Additive by dominance epistasis test by random SNP-BLUP model.
    :param pheno_file: phenotypic file. The fist two columns are family id, individual id which are same as plink *.fam
    ...
    :param var_app: the approximate variances for estimated SNP effects.
    :param p_cut: put cut value. default value is 1.0e-5.
    :param out_file: output file. default value is 'epiAD_eff_parallel'.
    :return: 0
    """
    y, xmat, zmat = design_matrix_wemai_multi_gmat(pheno_file, bed_file)
    res = _remma_epiAD_eff_parallel(y, xmat, zmat, gmat_lst, var_com, bed_file, parallel,
