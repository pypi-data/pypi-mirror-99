...
from azureml._base_sdk_common._docstring_wrapper import (
    module_logger,
    _experimental_link_msg,
)
...
class ParallelRunConfig(_ParallelRunConfigBase):
    ...
    :param partition_keys: The keys used to partition dataset into mini-batches. If specified, the data with
        ...
        NOTE: This is an experimental parameter, please refer to https://aka.ms/azuremlexperimental
    ...
    def __init__(
        ...
        :type partition_keys: List[str]
        """
        # This is a work-around to notify user of experimental parameter until it's supported by
        # @experimental decorator
        # TASK 877245: https://msdata.visualstudio.com/Vienna/_workitems/edit/877245
        if partition_keys is not None:
            _parameter_msg = "This is an experimental parameter,"
            module_logger.warning(
                "Parameter {0}: {1} {2}".format("partition_keys", _parameter_msg, _experimental_link_msg)
            )
