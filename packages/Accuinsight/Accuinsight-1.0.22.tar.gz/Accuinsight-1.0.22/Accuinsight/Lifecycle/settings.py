...
def setAPI(api_url, api_port):
    ...
    LcConst_path = '/opt/conda/lib/python3.7/site-packages/Accuinsight/modeler/core/LcConst/LcConst.py'
    if os.path.isfile(LcConst_path) == False:
            LcConst_path = '/opt/conda/lib/python3.6/site-packages/Accuinsight/modeler/core/LcConst/LcConst.py'
    else:
        pass
