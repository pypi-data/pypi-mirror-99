...
def to_string(obj):
    return _ModelerObjectPrinter().to_string(obj)
...
class _ModelerObjectPrinter(object):

    def __init__(self):
        super(_ModelerObjectPrinter, self).__init__()
        self.printer = pprint.PrettyPrinter()

    def to_string(self, obj):
        if isinstance(obj, _ModelerObject):
