...
class RelationsModel(Model):
    ...
    def __init__(self,
        ...
        if use_spert:
            self.rel_classifier = nn.Linear(embedder.token_embedder_tokens.config.hidden_size * 3, self.relations_size)
    ...
    def forward(  # type: ignore
        ...
        if self._use_spert:
            ...
            logits = self._forward_relations_classifier(embedded_context=embedded_text_input,
