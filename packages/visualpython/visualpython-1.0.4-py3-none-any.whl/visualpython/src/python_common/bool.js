define([
    ...
    PythonCommon.prototype.initHtml = function() {
        ...
        sbTagString.clear();
        sbTagString.appendFormat('<input type="text" id="{0}" class="{1}" />', 'vp_pyExpr', 'vp-input')
        tblLayoutRequire.addRow("Input Expression", sbTagString.toString());
    ...
    PythonCommon.prototype.generateCode = function(addCell = false, exec = false) {
        ...
        code.appendFormat('bool({0})', $(this.wrapSelector('#vp_pyExpr')).val());
