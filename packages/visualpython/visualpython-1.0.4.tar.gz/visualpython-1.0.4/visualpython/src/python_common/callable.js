define([
    ...
    PythonCommon.prototype.initHtml = function() {
        ...
        tblLayoutRequire.addReqRow("Input Object", sbTagString.toString());
    ...
    PythonCommon.prototype.generateCode = function(addCell = false, exec = false) {
        ...
        code.appendFormat('callable({0})', $(this.wrapSelector('#vp_pyObj')).val());
