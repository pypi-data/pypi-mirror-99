define([
    ...
    PythonCommon.prototype.initHtml = function() {
        ...
        sbTagString.clear();
        sbTagString.appendFormat('<input type="text" id="{0}" class="{1}" />', 'vp_pyBytes', 'vp-input');
        ...
        pdGen.vp_searchVarList(['bytes', 'bytearray'], function(result) {
            ...
            suggestInput.setComponentID('vp_pyBytes');
            suggestInput.addClass('vp-input');
            suggestInput.setSuggestList(function() { return varList; });
            suggestInput.setNormalFilter(false);
            suggestInput.setValue($(that.wrapSelector('#vp_pyBytes')).val());
            $(that.wrapSelector('#vp_pyBytes')).replaceWith(function() {
    ...
    PythonCommon.prototype.generateCode = function(addCell = false, exec = false) {
        ...
        code.appendFormat('memoryview({0})', $(this.wrapSelector('#vp_pyBytes')).val());
