define([
    ...
    // 옵션 속성
    const funcOptProp = {
        funcName : "staticmethod()"
        , funcID : "pyBuilt_staticmethod"
    }
    ...
    PythonCommon.prototype.initHtml = function() {
        ...
        pdGen.vp_searchVarList(['function'], function(result) {
            ...
            suggestInput.setComponentID('vp_pyFunction');
            suggestInput.addClass('vp-input');
            suggestInput.setSuggestList(function() { return varList; });
            suggestInput.setNormalFilter(false);
            suggestInput.setValue($(that.wrapSelector('#vp_pyFunction')).val());
            $(that.wrapSelector('#vp_pyFunction')).replaceWith(function() {
    ...
    PythonCommon.prototype.generateCode = function(addCell = false, exec = false) {
        ...
        code.appendFormat('staticmethod({0})', $(this.wrapSelector('#vp_pyFunction')).val());
