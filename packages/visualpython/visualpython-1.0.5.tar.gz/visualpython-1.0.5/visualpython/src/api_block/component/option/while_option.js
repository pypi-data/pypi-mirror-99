        ...
        ifConditionListState.forEach( ( condition, index ) => {
            ...
            $(document).on(STR_CHANGE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid, function(event) {
                ...
                /**
                  ...
                  * iF arg4 선택 변경 
                 */
                $(document).off(STR_CHANGE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid);
                $(document).on(STR_CHANGE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid, function(event) {
                                ...
                                /** If arg input 입력 변경 이벤트 함수 바인딩 */
                                    ...
                                    $(document).on(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG +i+ index + uuid, function(event) {
                                        ...
                                        if (i == 1) {
                                            ...
                                            if (inputValue == '') {
                                                $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                                                $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                                                $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).attr("disabled", true);
                                            } else {
                                                $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).removeClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                                                $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).removeClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                                                $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).attr("disabled", false);
                                            }
                                        } else if (i == 5) {
                                            updatedValue = {
                                                ...ifConditionState
                ...
                var bindSelectValueEventFunc_while = function(selectedValue, index, type) {
                    ...
                    if (type == WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG1) {
                    ...
                    } else if (type == WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG4) {
                        ...
                        if (selectedValue == STR_EMPTY) {
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).attr(STR_DISABLED, true);
                        } else {
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).removeClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).removeClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).attr(STR_DISABLED, false);
                        }
        
                    } else if (type == WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG5) {
                        updatedValue = {
                            ...ifConditionState
                            , arg5: selectedValue 
                        }
                ...
                var renderThisComponent = function() {
                    ...
                    ifConditionListState.forEach( (condition, index) => {
                        ...
                        var sbIfArg4;
                            ...
                            sbIfArg4 =  MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid
                                , arg4
                                , COMPARISON_OPERATOR_IF_ARG4
                                , VP_CLASS_STYLE_WIDTH_15PERCENT
                                , STR_OPERATOR
                        ...
                        var suggestInputArg5 =  MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid
                                                                                , arg5
                                                                                ...
                                                                                , function(selectedValue) {
                                                                                    bindSelectValueEventFunc_while(selectedValue, 
                                                                                                                index,
                                                                                                                WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG5);
                                                                                    });    
    
                        var suggestInputArg6 =  MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid
                                                                                    , arg6
                                                                                    , COMPARISON_OPERATOR_IF_ARG6
                                                                                    , VP_CLASS_STYLE_WIDTH_10PERCENT
                                                                                    , STR_OPERATOR
                                                                                    , function(selectedValue) {
                                                                                        bindSelectValueEventFunc_while(selectedValue, 
                                                                                            index,
                                                                                            WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG6);
                                                                                });      
                        ...
                        sbConditionLeft.appendLine(sbIfArg4);
                    ...
                    ifConditionListState.forEach( (condition,index) => {
                        ...
                        $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).val(arg5);

                        $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid).val(arg2);
                        if (arg4 == '') {
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).val(STR_EMPTY);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).attr(STR_DISABLED, true);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                        } else {
                        ...
                        if ( ifConditionListState.length -1 == index ) {
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid).addClass(VP_CLASS_STYLE_OPACITY_0);
                        } else {
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid).val(arg6);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid).addClass(VP_CLASS_STYLE_OPACITY_1);
                        }
