define([
    ...
    PythonCommon.prototype.initHtml = function() {
        ...
        sbTagString.clear();
        sbTagString.appendFormat('<input type="text" id="{0}" class="{1}" />', 'vp_pyOrd', 'vp-input');
        tblLayoutRequire.addReqRow("Enter Character", sbTagString.toString());
    ...
    PythonCommon.prototype.generateCode = function(addCell = false, exec = false) {
        ...
        code.appendFormat("ord('{0}')", $(this.wrapSelector('#vp_pyOrd')).val());
