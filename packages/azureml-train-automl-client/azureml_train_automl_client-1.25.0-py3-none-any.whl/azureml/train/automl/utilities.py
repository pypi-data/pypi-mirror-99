...
def _combine_start_params(
    updated_params: Optional[Dict[str, Any]],
    **kwargs: Any
) -> Dict[str, Any]:
    """Add the provided variables to updated_params if updated_params does not already contain the element."""
    if isinstance(updated_params, dict):
        return {**kwargs, **updated_params}
    return kwargs
