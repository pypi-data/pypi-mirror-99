...
import elements_sdk
from elements_sdk.models.asset_project_link import AssetProjectLink  # noqa: E501
from elements_sdk.rest import ApiException

class TestAssetProjectLink(unittest.TestCase):
    """AssetProjectLink unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AssetProjectLink
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = elements_sdk.models.asset_project_link.AssetProjectLink()  # noqa: E501
        if include_optional :
            return AssetProjectLink(
                id = 56, 
                project = elements_sdk.models.asset.Asset(
                    id = 56, 
