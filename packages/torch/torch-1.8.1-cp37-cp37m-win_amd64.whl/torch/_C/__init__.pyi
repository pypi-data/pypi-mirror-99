...
class _TensorBase(object):
    ...
    def __get__(self, instance, owner=None) -> Tensor: ...
    ...
    def div(self, other: Union[Tensor, Number], *, rounding_mode: Optional[str]=None, out: Optional[Tensor]=None) -> Tensor: ...
    def div_(self, other: Union[Tensor, Number], *, rounding_mode: Optional[str]=None) -> Tensor: ...
    @overload
    def divide(self, other: Tensor) -> Tensor: ...
    @overload
    def divide(self, other: Tensor, *, rounding_mode: str) -> Tensor: ...
    @overload
    def divide(self, other: Number, *, rounding_mode: str) -> Tensor: ...
    @overload
    def divide(self, other: Number) -> Tensor: ...
    @overload
    def divide_(self, other: Tensor) -> Tensor: ...
    @overload
    def divide_(self, other: Tensor, *, rounding_mode: str) -> Tensor: ...
    @overload
    def divide_(self, other: Number, *, rounding_mode: str) -> Tensor: ...
    @overload
