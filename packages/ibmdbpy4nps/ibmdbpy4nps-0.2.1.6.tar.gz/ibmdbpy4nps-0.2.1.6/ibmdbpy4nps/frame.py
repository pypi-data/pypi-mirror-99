...
import ibmdbpy4nps
import ibmdbpy4nps.statistics
import ibmdbpy4nps.indexing
import ibmdbpy4nps.aggregation
import ibmdbpy4nps.filtering
import ibmdbpy4nps.utils

from ibmdbpy4nps.utils import timed, chunklist
from ibmdbpy4nps.internals import InternalState
from ibmdbpy4nps.exceptions import IdaDataFrameError
...
class IdaDataFrame(object):
    ...
    def __init__(self, idadb, tablename, indexer = None):
        ...
        self.loc = ibmdbpy4nps.indexing.Loc(self)
...
###############################################################################
    ...
    def __getitem__(self, item):
        ...
        if isinstance(item, ibmdbpy4nps.filtering.FilterQuery):
    ...
    def __lt__(self, value):
        ...
        """
        return ibmdbpy4nps.filtering.FilterQuery(self.columns, self._name, "lt", value)

    def __le__(self, value):
        """
        ibmdbpy.filtering.FilterQuery object when comparing self using "<=".
        """
        return ibmdbpy4nps.filtering.FilterQuery(self.columns, self._name, "le", value)

    def __eq__(self, value):
        """
        ibmdbpy.filtering.FilterQuery object when comparing self using "==".
        """
        return ibmdbpy4nps.filtering.FilterQuery(self.columns, self._name, "eq", value)

    def __ne__(self, value):
        """
        ibmdbpy.filtering.FilterQuery object when comparing self using "!=".
        """
        return ibmdbpy4nps.filtering.FilterQuery(self.columns, self._name, "ne", value)

    def __ge__(self, value):
        """
        ibmdbpy.filtering.FilterQuery object when comparing self using ">=".
        """
        return ibmdbpy4nps.filtering.FilterQuery(self.columns, self._name, "ge", value)

    def __gt__(self, value):
        """
        ibmdbpy.filtering.FilterQuery object when comparing self using ">".
        """
        return ibmdbpy4nps.filtering.FilterQuery(self.columns, self._name, "gt", value)
    ...
    def __add__(self, other):
        ...
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "add", other)
    ...
    def __radd__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "add", self, swap = True)
    ...
    def __div__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "div", other)
    ...
    def __rdiv__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "div", self, swap = True)
    ...
    def __floordiv__(self,other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "floordiv", other)
    ...
    def __rfloordiv__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "floordiv", self, swap = True)
    ...
    def __mod__(self,other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "mod", other)
    ...
    def __rmod__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "mod", self, swap = True)
    ...
    def __mul__(self,other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "mul", other)
    ...
    def __rmul__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "mul", self, swap = True)
    ...
    def __neg__(self):
        ...
        """
        other = None
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "neg", other)
    ...
    def __pow__(self,other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "pow", other)
    ...
    def __rpow__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "pow", self, swap = True)
    ...
    def __sub__(self,other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(self, "sub", other)
    ...
    def __rsub__(self, other):
        ...
        """
        self._combine_check(other)
        return ibmdbpy4nps.aggregation.aggregate_idadf(other, "sub", self, swap = True)
...
#                data = ibmdbpy.utils._convert_dtypes(self, data)
                if isinstance(self, ibmdbpy4nps.IdaSeries):
                    data = pd.Series(data)
            return data
    ...
    def pivot_table(self, values=None, columns=None, max_entries=1000,
        ...
        """
        # TODO : Support index
        from ibmdbpy4nps.statistics import pivot_table
...
###############################################################################
    ...
    def describe(self, percentiles=[0.25, 0.50, 0.75]):
        ...
        """
        from ibmdbpy4nps.statistics import describe
    ...
    def summary(self):
        ...
        """
        from ibmdbpy4nps.statistics import summary
    ...
    def cov(self):
        ...
        covariance matrix: DataFrame
            ...
            coefficients.
        """
        from ibmdbpy4nps.statistics import cov
    ...
    def corr(self, method="pearson", features=None, ignore_indexer=True):
        ...
        """
        from ibmdbpy4nps.statistics import corr
    ...
    def quantile(self, q=0.5):
        ...
        """
        from ibmdbpy4nps.statistics import quantile
    ...
    def mad(self):
        ...
        """
        from ibmdbpy4nps.statistics import mad
    ...
    def min(self):
        ...
        """
        from ibmdbpy4nps.statistics import ida_min
    ...
    def max(self):
        ...
        """
        from ibmdbpy4nps.statistics import ida_max
    ...
    def count(self):
        ...
        """
        from ibmdbpy4nps.statistics import count
    ...
    def count_distinct(self):
        ...
        """
        from ibmdbpy4nps.statistics import count_distinct
    ...
    def std(self):
        ...
        """
        from ibmdbpy4nps.statistics import std
    ...
    def var(self):
        ...
        """
        from ibmdbpy4nps.statistics import var
    ...
    def mean(self):
        ...
        """
        from ibmdbpy4nps.statistics import mean
    ...
    def sum(self):
        ...
        from ibmdbpy4nps.statistics import ida_sum
    ...
    def median(self):
        ...
        # Behave like having the option "numeric only" to true
        # TODO: Implement the option
        from ibmdbpy4nps.statistics import median
...
###############################################################################
    ...
    def save_as(self, tablename, clear_existing = False):
        ...
        if tablename == self.tablename:
            ...
            display_yes = ibmdbpy4nps.utils.query_yes_no(question)
            if not display_yes:
                return
...
###############################################################################
    ...
    def _clone_as_serie(self, column):
        ...
        """
        newida = ibmdbpy4nps.IdaSeries(idadb = self._idadb, tablename = self._name,
...
###############################################################################
    ...
    def _table_def(self, factor_threshold=None):
        ...
        data['FACTORS'] = ibmdbpy4nps.statistics._count_level(self, data.index.values)
    ...
    def _combine_check(self, other):
        ...
        if isinstance(other, IdaDataFrame) | isinstance(other, ibmdbpy4nps.IdaSeries):
            if self._name != other._name:
                raise IdaDataFrameError("It is not possible to aggregate columns using columns of a different table.")

        if not(isinstance(other, IdaDataFrame) | isinstance(other, ibmdbpy4nps.IdaSeries) | isinstance(other, Number)):
        ...
        if isinstance(other, ibmdbpy4nps.IdaSeries)|isinstance(other, IdaDataFrame):
