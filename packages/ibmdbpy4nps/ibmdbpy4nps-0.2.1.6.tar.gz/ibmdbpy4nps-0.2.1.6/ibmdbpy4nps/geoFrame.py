...
import ibmdbpy4nps
from ibmdbpy4nps.frame import IdaDataFrame
from ibmdbpy4nps.geoSeries import IdaGeoSeries
...
class IdaGeoDataFrame(IdaDataFrame):
    ...
    def __getitem__(self, item):
        ...
        if isinstance(ida, ibmdbpy4nps.IdaSeries):
            if ida.dtypes['TYPENAME'][ida.column].find('ST_') == 0:
                ...
                # Return IdaSeries
                return ida
        elif isinstance(ida, ibmdbpy4nps.IdaDataFrame):
    ...
    def _binary_operation_handler(self, ida2, db2gse_function,
        ...
        idageodf=ibmdbpy4nps.IdaGeoDataFrame(self._idadb, viewname, indexer='INDEXERIDA1')
        return idageodf