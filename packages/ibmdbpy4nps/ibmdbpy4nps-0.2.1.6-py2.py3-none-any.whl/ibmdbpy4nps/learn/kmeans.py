...
import ibmdbpy4nps
from ibmdbpy4nps import IdaDataFrame
from ibmdbpy4nps.exceptions import IdaKMeansError
import six
...
class KMeans(object):
    ...
    def predict(self, idadf, column_id=None, outtable=None):
        ...
        self.labels_ = ibmdbpy4nps.IdaDataFrame(idadf._idadb, outtable, indexer=column_id)
        return self.labels_
