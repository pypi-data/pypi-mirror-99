...
import ibmdbpy4nps
from ibmdbpy4nps.exceptions import IdaAssociationRulesError
import six
...
class AssociationRules(object):
    ...
    def fit(self, idadf, transaction_id, item_id,  nametable=None, namecol=None, verbose=False):
        ...
        if not (nametable is None or isinstance(nametable, ibmdbpy4nps.frame.IdaDataFrame)):
            nametable = ibmdbpy4nps.utils.check_tablename(nametable)
        ...
        if self.modelname is None:
            ...
            self.modelname = ibmdbpy4nps.utils.check_tablename(self.modelname)
    ...
    def predict(self, idadf, outtable=None, transaction_id=None, item_id=None,
        ...
        if self.outtable is None:
            ...
            self.outtable = ibmdbpy4nps.utils.check_tablename(self.outtable)
        ...
        self.labels_ = ibmdbpy4nps.IdaDataFrame(idadf._idadb, outtable)
        return self.labels_
