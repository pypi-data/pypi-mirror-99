...
def confusion_matrix_(rater_a, rater_b, min_rating=None, max_rating=None, *args, **kwargs):
    """
...
def histogram(ratings, min_rating=None, max_rating=None):
    ...
    num_ratings = int(max_rating - min_rating + 1)
    hist_ratings = np.array([0 for x in range(num_ratings)])
    for r in ratings:
        hist_ratings[r - min_rating] += 1
    return hist_ratings


def quadratic_weighted_kappa(rater_a, rater_b, min_rating=None, max_rating=None, *args, **kwargs):
    """
...
def linear_weighted_kappa(rater_a, rater_b, min_rating=None, max_rating=None, *args, **kwargs):
    """
    ...
    conf_mat = confusion_matrix(list(rater_a), list(rater_b))
        
        
    # conf_mat = confusion_matrix_(rater_a, rater_b,
...
def kappa(rater_a, rater_b, min_rating=None, max_rating=None, *args, **kwargs):
    """
...
def mean_quadratic_weighted_kappa(kappas, weights=None, *args, **kwargs):
    """
...
def weighted_mean_quadratic_weighted_kappa(solution, submission, *args, **kwargs):
