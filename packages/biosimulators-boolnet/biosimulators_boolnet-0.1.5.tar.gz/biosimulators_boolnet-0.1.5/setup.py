...
setuptools.setup(
    ...
    description=("BioSimulators-compliant command-line interface to "
                 "the BoolNet simulation program."),
    long_description=md.long_description,
    url="https://github.com/biosimulators/Biosimulators_BoolNet",
    download_url="https://github.com/biosimulators/Biosimulators_BoolNet",
