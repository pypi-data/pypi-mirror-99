...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.52.0-alpha.1616406175+2022f08f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.52.0-alpha.1616406175+2022f08f`
                """)
            else:
                raise
