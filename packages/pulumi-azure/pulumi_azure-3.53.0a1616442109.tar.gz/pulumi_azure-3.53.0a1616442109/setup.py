...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.53.0-alpha.1616442109+5884b62a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.53.0-alpha.1616442109+5884b62a`
                """)
            else:
                raise
