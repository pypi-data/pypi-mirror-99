...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.0.0-alpha.1616680006+2bcdb442'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.0.0-alpha.1616680006+2bcdb442`
                """)
            else:
                raise
