...
cdaemon = dae.Main_Daemon(rmdir, attempt_healing=opts.attempt_healing, el=opts.event_list, verbose=True, debug=True, sender_email=opts.sender_email,receiver=opts.receiver,password=password)
cdaemon.summon()
