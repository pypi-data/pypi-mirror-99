...
from mitosheet3.steps.filter import execute_filter_column
from mitosheet3.steps import EVENT_TYPE_TO_STEP, STEP_TYPE_TO_STEP
from mitosheet3.updates import UPDATES
from mitosheet3.steps.initial_steps.initalize import execute_initialize_step
from mitosheet3.steps.initial_steps.initial_rename import execute_initial_rename_step
from mitosheet3.utils import dfs_to_json
from mitosheet3.transpiler.transpile import transpile
from mitosheet3.user.user_utils import get_user_field
...
class WidgetStateContainer():
    ...
    def handle_edit_event(self, edit_event):
        ...
        try:
            ...
            if self.curr_step['step_id'] == edit_event['step_id']:
            ...
            # NOTE: no new errors occur below these lines, which is why we don't have to 
            # roll the back 
