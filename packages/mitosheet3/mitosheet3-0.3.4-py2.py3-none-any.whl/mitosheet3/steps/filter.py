...
"""
import functools
from mitosheet3.utils import create_new_step, does_sheet_index_exist_within_step
...
def _reset_filter(wsc, sheet_index, column_header, ignore_last_step=False):
    ...
    from mitosheet3.updates.replay_analysis import execute_replay_analysis_update
    from mitosheet3.save_utils import write_analysis
