...
from mitosheet3.utils import get_new_step_id
from mitosheet3.errors import EditError
from mitosheet3.widget_state_container import WidgetStateContainer
from mitosheet3.steps.column_steps.add_column import execute_add_column_step
from mitosheet3.tests.test_utils import create_mito_wrapper, create_mito_wrapper_dfs
...
def test_column_exists_error():
    ...
    mito.add_column(0, 'B')
    with pytest.raises(EditError) as e_info:
        execute_add_column_step(mito.mito_widget.widget_state_container.curr_step, 0, 'B')
