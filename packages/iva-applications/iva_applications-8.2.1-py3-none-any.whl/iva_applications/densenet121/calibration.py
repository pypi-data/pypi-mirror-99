"""Utils for densenet121 preprocessing. It equals to the 'torch' preprocessing from keras-applications."""
import os
import glob
import numpy as np
...
def save_calibration_tensor(path_to_dataset: str, save_dir: str):
    ...
    np.save(os.path.join(save_dir, 'calibration_tensors_densenet'), tensors)
