...
from iva_applications.inception_resnet_v2.preprocess import image_to_tensor
...
def save_calibration_tensor(path_to_dataset: str, save_dir: str):
    ...
    np.save(os.path.join(save_dir, 'calibration_tensors_inception_resnet_v2'), tensors)
