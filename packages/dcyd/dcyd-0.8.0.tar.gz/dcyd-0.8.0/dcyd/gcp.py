...
def get_fallback_logger() -> logging.Logger:
    ...
    '''
    logger = logging.getLogger('dcyd-client-fallback-log')
    logger.setLevel(logging.INFO)
    handler = logging.StreamHandler(sys.stderr) if not os.getenv('DCYD_CLIENT_FILE_LOGGER') else logging.NullHandler()
...
def get_file_logger(*, log_file_path: str = os.getenv('DCYD_CLIENT_FILE_LOGGER')) -> logging.Logger:
    ...
    logger = logging.getLogger('dcyd-client-file-log')
    logger.setLevel(logging.INFO)
