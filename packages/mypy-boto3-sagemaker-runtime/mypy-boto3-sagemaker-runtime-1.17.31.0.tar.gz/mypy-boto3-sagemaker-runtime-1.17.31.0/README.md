...
[boto3.SageMakerRuntime 1.17.31](https://boto3.amazonaws.com/v1/documentation/api/1.17.31/reference/services/sagemaker-runtime.html#SageMakerRuntime) service
compatible with
