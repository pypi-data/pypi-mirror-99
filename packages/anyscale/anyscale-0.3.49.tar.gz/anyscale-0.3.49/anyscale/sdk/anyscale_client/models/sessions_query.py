...
class SessionsQuery(object):
    ...
    def __init__(self, name=None, paging=None, state_filter=[], local_vars_configuration=None):  # noqa: E501
    ...
    def name(self):
        ...
        Filters Sessions by name. If this field is absent, no filtering is done.  # noqa: E501
