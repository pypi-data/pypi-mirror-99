...
class AppConfig(object):
    ...
    def __init__(self, id=None, name=None, project_id=None, creator_id=None, created_at=None, last_modified_at=None, deleted_at=None, local_vars_configuration=None):  # noqa: E501
