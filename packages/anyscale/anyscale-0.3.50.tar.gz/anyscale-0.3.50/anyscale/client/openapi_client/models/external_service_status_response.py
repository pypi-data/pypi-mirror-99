...
class ExternalServiceStatusResponse(object):
    ...
    def __init__(self, metrics_dashboard_status=None, jupyter_noteboook_status=None, service_proxy_status=None, ray_dashboard_status=None, webterminal_status=None, local_vars_configuration=None):  # noqa: E501
