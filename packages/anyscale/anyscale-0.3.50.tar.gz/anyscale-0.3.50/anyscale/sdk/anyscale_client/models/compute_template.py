...
class ComputeTemplate(object):
    ...
    def __init__(self, id=None, name=None, creator_id=None, organization_id=None, project_id=None, created_at=None, last_modified_at=None, deleted_at=None, config=None, local_vars_configuration=None):  # noqa: E501
