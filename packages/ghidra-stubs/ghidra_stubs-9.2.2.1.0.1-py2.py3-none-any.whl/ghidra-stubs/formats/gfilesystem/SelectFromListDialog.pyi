...
class SelectFromListDialog(docking.DialogComponentProvider):
    """
    ...
    def __init__(self, title: unicode, prompt: unicode, list: List[object], toStringFunc: java.util.function.Function): ...
    ...
    @staticmethod
    def selectFromList(list: List[object], title: unicode, prompt: unicode, toStringFunc: java.util.function.Function) -> object:
        """
