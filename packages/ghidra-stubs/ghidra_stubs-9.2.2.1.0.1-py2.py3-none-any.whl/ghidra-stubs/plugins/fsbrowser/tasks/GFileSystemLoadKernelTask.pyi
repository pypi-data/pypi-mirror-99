...
class GFileSystemLoadKernelTask(ghidra.util.task.Task):




    def __init__(self, __a0: ghidra.framework.plugintool.Plugin, __a1: ghidra.app.services.ProgramManager, __a2: List[object]): ...
