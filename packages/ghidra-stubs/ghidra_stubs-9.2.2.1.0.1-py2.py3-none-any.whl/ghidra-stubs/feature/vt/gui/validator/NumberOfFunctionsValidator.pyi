...
class NumberOfFunctionsValidator(ghidra.feature.vt.gui.validator.VTPreconditionValidator):
    DIFFERENCE_THRESHOLD: unicode = u'Maximum percentage difference between number of functions in each program'
    DIFFERENCE_THRESHOLD_DEFAULT: float = 0.25
