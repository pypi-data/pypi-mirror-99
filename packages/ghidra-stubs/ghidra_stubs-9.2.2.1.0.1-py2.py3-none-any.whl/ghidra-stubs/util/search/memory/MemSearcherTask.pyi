...
class MemSearcherTask(ghidra.util.task.Task):




    def __init__(self, searchInfo: ghidra.util.search.memory.SearchInfo, algorithm: ghidra.util.search.memory.MemorySearchAlgorithm): ...
    ...
    def getMatchingAddresses(self) -> List[ghidra.util.search.memory.MemSearchResult]: ...
    ...
    @property
    def matchingAddresses(self) -> List[object]: ...