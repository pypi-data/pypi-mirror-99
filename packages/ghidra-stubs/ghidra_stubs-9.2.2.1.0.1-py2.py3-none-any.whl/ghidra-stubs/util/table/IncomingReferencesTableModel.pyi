...
class IncomingReferencesTableModel(ghidra.util.table.AddressBasedTableModel):




    def __init__(self, __a0: unicode, __a1: ghidra.framework.plugintool.ServiceProvider, __a2: ghidra.program.model.listing.Program, __a3: List[object], __a4: ghidra.util.task.TaskMonitor): ...
