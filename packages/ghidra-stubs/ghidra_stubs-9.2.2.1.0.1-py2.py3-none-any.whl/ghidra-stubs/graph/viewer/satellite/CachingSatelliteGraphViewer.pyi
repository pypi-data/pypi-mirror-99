...
class CachingSatelliteGraphViewer(ghidra.graph.viewer.SatelliteGraphViewer):




    def __init__(self, masterViewer: ghidra.graph.viewer.GraphViewer, preferredSize: java.awt.Dimension): ...
