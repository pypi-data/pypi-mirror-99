...
class VisualGraphPickingGraphMousePlugin(ghidra.graph.viewer.event.mouse.JungPickingGraphMousePlugin, ghidra.graph.viewer.event.mouse.VisualGraphMousePlugin):
