...
class VisualGraphMouseTrackingGraphMousePlugin(edu.uci.ics.jung.visualization.control.AbstractGraphMousePlugin, java.awt.event.MouseListener, java.awt.event.MouseMotionListener, ghidra.graph.viewer.event.mouse.VisualGraphMousePlugin):
    """
    ...
    def __init__(self, viewer: ghidra.graph.viewer.GraphViewer): ...
