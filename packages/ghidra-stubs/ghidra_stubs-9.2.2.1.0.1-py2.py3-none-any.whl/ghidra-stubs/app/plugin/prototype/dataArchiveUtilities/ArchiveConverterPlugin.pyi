...
class ArchiveConverterPlugin(ghidra.app.plugin.ProgramPlugin):





    class NameComplex(object):




        def __init__(self, __a0: ghidra.app.plugin.prototype.dataArchiveUtilities.ArchiveConverterPlugin, __a1: ghidra.program.model.data.DataType): ...
    ...
    def genUIData(self, __a0: ghidra.program.model.data.FileDataTypeManager, __a1: ghidra.app.plugin.prototype.dataArchiveUtilities.ComplexName, __a2: int) -> ghidra.program.model.data.DataType: ...
