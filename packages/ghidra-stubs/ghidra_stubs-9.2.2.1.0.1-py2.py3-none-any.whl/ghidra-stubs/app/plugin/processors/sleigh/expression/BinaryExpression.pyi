...
class BinaryExpression(ghidra.app.plugin.processors.sleigh.expression.PatternExpression):
    """
    ...
    @property
    def left(self) -> ghidra.app.plugin.processors.sleigh.expression.PatternExpression: ...

    @property
    def right(self) -> ghidra.app.plugin.processors.sleigh.expression.PatternExpression: ...