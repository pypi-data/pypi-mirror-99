...
class SelectionScopeWidget(ghidra.app.plugin.core.instructionsearch.ui.ControlPanelWidget):




    def __init__(self, __a0: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin, __a1: unicode, __a2: ghidra.app.plugin.core.instructionsearch.ui.InstructionSearchDialog): ...
    ...
    def getSearchRange(self) -> List[object]: ...
    ...
    def updateSearchRangeAll(self) -> None: ...

    def updateSearchRangeBySelection(self) -> None: ...
    ...
    @property
    def searchRange(self) -> List[object]: ...