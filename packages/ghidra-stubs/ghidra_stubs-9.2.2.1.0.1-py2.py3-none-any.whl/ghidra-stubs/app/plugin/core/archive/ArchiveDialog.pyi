...
class ArchiveDialog(docking.DialogComponentProvider):
    ...
    def getArchivePathName(self) -> unicode: ...
    ...
    def isValidName(self, __a0: unicode) -> bool: ...
    ...
    def showDialog(self, __a0: ghidra.framework.model.ProjectLocator, __a1: unicode, __a2: ghidra.framework.plugintool.PluginTool) -> bool: ...
    ...
    @property
    def archivePathName(self) -> unicode: ...