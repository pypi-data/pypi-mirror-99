...
class NavigationHistoryPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.NavigationHistoryService, ghidra.app.nav.NavigatableRemovalListener, ghidra.framework.options.OptionsChangeListener):
    ...
    def addNewLocation(self, __a0: ghidra.app.nav.Navigatable) -> None: ...

    def clear(self, __a0: ghidra.app.nav.Navigatable) -> None: ...
    ...
    def getNextLocations(self, __a0: ghidra.app.nav.Navigatable) -> List[object]: ...
    ...
    def getPreviousLocations(self, __a0: ghidra.app.nav.Navigatable) -> List[object]: ...
    ...
    def hasNext(self, __a0: ghidra.app.nav.Navigatable) -> bool: ...

    def hasNextFunction(self, __a0: ghidra.app.nav.Navigatable) -> bool: ...

    def hasPrevious(self, __a0: ghidra.app.nav.Navigatable) -> bool: ...

    def hasPreviousFunction(self, __a0: ghidra.app.nav.Navigatable) -> bool: ...
    ...
    @overload
    def next(self, __a0: ghidra.app.nav.Navigatable) -> None: ...

    @overload
    def next(self, __a0: ghidra.app.nav.Navigatable, __a1: ghidra.app.nav.LocationMemento) -> None: ...

    def nextFunction(self, __a0: ghidra.app.nav.Navigatable) -> None: ...
    ...
    @overload
    def previous(self, __a0: ghidra.app.nav.Navigatable) -> None: ...

    @overload
    def previous(self, __a0: ghidra.app.nav.Navigatable, __a1: ghidra.app.nav.LocationMemento) -> None: ...

    def previousFunction(self, __a0: ghidra.app.nav.Navigatable) -> None: ...
    ...
    @overload
    def writeDataState(self, __a0: ghidra.framework.options.SaveState, __a1: ghidra.app.nav.Navigatable, __a2: ghidra.app.plugin.core.navigation.NavigationHistoryPlugin.HistoryList) -> None: ...
