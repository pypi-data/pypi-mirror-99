...
class OperandLabelDialog(docking.DialogComponentProvider):
    ...
    def setOperandLabel(self, __a0: ghidra.app.context.ListingActionContext) -> None: ...
    ...
    @property
    def operandLabel(self) -> None: ...  # No getter available.

    @operandLabel.setter
    def operandLabel(self, value: ghidra.app.context.ListingActionContext) -> None: ...