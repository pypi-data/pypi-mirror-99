...
class StringAddedEvent(ghidra.app.plugin.core.string.StringEvent):




    def __init__(self, __a0: ghidra.program.model.data.DataType, __a1: ghidra.program.model.address.Address, __a2: int): ...
