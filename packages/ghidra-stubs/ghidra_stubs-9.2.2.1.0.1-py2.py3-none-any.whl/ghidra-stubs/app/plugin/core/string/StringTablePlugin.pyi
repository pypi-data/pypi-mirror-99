...
class StringTablePlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    def createStringsProvider(self, __a0: ghidra.app.plugin.core.string.StringTableOptions) -> None: ...
    ...
    def removeTransientProvider(self, __a0: ghidra.app.plugin.core.string.StringTableProvider) -> None: ...
