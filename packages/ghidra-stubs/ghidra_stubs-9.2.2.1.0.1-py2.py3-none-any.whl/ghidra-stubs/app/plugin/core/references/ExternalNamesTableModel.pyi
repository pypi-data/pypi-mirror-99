...
class ExternalNamesTableModel(docking.widgets.table.AbstractSortedTableModel):
    ...
    @overload
    def getColumnValueForRow(self, __a0: ghidra.app.plugin.core.references.ExternalPath, __a1: int) -> object: ...
