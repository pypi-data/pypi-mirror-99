...
class FindReferencesTableModel(ghidra.app.util.query.AlignedObjectBasedPreviewTableModel):




    @overload
    def __init__(self, __a0: ghidra.program.model.address.AddressSetView, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.program.model.listing.Program): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.framework.plugintool.ServiceProvider, __a2: ghidra.program.model.listing.Program): ...



    def addAlignmentListener(self, __a0: ghidra.app.util.query.AddressAlignmentListener) -> None: ...
    ...
    def getAlignmentAddress(self, __a0: List[object], __a1: int) -> ghidra.program.model.address.Address: ...
    ...
    def removeAlignmentListener(self, __a0: ghidra.app.util.query.AddressAlignmentListener) -> None: ...
