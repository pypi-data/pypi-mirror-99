...
class SelectComplementAction(ghidra.app.plugin.core.codebrowser.actions.CodeViewerContextAction):
    ...
    @overload
    def isEnabledForContext(self, __a0: ghidra.app.plugin.core.codebrowser.CodeViewerActionContext) -> bool: ...
