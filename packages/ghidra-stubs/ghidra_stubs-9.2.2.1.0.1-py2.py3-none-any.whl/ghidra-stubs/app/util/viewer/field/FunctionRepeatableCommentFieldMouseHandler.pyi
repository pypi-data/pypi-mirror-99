...
class FunctionRepeatableCommentFieldMouseHandler(ghidra.app.util.viewer.field.CommentFieldMouseHandler):
    """
    A handler to process FunctionRepeatableCommentFieldLocation.
    """
