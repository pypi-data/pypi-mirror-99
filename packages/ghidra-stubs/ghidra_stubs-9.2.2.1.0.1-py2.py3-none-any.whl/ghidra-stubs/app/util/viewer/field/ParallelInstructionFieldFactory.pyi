...
class ParallelInstructionFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    DEFAULT_COLOR: java.awt.Color = java.awt.Color[r=0,g=0,b=128]
    ...
    def fieldOptionsChanged(self, options: ghidra.framework.options.Options, name: unicode, oldValue: object, newValue: object) -> None: ...
    ...
    def newInstance(self, model: ghidra.app.util.viewer.format.FieldFormatModel, hsProvider: ghidra.app.util.HighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
