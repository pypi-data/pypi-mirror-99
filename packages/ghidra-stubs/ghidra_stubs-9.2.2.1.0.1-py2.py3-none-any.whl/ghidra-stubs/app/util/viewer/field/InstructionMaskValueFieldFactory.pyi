...
class InstructionMaskValueFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    FIELD_NAME: unicode = u'Instr Mask/Value'
    LABEL_COLOR: java.awt.Color = java.awt.Color[r=0,g=0,b=0]
    MASK_COLOR: java.awt.Color = java.awt.Color[r=0,g=0,b=128]
    VALUE_COLOR: java.awt.Color = java.awt.Color[r=0,g=128,b=0]
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, hsProvider: ghidra.app.util.HighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
