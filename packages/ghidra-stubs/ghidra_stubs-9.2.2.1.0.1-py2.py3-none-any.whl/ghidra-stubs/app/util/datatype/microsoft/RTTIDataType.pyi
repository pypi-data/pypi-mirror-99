...
class RTTIDataType(ghidra.program.model.data.DynamicDataType):
    ...
    @overload
    def isValid(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, validationOptions: ghidra.app.util.datatype.microsoft.DataValidationOptions) -> bool:
        """
