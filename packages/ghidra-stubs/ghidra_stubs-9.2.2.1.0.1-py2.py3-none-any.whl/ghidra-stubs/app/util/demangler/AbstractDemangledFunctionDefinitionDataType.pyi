...
class AbstractDemangledFunctionDefinitionDataType(ghidra.app.util.demangler.DemangledDataType):
    ...
    @property
    def displayFunctionPointerParens(self) -> None: ...  # No getter available.

    @displayFunctionPointerParens.setter
    def displayFunctionPointerParens(self, value: bool) -> None: ...
