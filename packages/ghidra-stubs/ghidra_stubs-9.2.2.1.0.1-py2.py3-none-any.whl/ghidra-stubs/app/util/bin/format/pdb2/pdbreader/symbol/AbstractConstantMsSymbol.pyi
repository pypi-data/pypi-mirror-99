...
class AbstractConstantMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractMsSymbol, ghidra.app.util.bin.format.pdb2.pdbreader.symbol.NameMsSymbol):
    ...
    @property
    def value(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.Numeric: ...