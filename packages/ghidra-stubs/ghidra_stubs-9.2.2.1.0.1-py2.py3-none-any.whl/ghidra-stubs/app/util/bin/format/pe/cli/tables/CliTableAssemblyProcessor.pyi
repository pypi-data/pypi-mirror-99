...
class CliTableAssemblyProcessor(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliAssemblyProcessorRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        processor: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableAssemblyProcessor, __a1: int): ...
