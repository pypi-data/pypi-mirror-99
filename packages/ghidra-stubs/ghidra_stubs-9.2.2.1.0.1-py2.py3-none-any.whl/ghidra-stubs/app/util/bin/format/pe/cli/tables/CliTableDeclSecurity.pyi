...
class CliTableDeclSecurity(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliDeclSecurityRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        action: int
        parentIndex: int
        permissionSetIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableDeclSecurity, __a1: int, __a2: int, __a3: int): ...
