...
class RelocByIndexGroup(ghidra.app.util.bin.format.pef.Relocation):
    """
    See Apple's -- PEFBinaryFormat.h
    """

    kPEFRelocSmByImport: int = 0
    kPEFRelocSmBySection: int = 3
    kPEFRelocSmSetSectC: int = 1
    kPEFRelocSmSetSectD: int = 2
