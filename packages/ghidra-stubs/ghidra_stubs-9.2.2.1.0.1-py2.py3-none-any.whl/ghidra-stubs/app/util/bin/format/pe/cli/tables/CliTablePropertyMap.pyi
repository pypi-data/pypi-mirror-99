...
class CliTablePropertyMap(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliPropertyMapRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        parentIndex: int
        propertyListIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTablePropertyMap, __a1: int, __a2: int): ...
