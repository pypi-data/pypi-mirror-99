...
class MatrixMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    PDB_ID: int = 5404
    ...
    def getMajorStride(self) -> long: ...

    def getName(self) -> unicode: ...

    def getNumColumns(self) -> long: ...

    def getNumRows(self) -> long: ...
    ...
    @property
    def majorStride(self) -> long: ...

    @property
    def numColumns(self) -> long: ...

    @property
    def numRows(self) -> long: ...
