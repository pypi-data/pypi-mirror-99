...
class CliTableGenericParam(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliGenericParamRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        flags: int
        nameIndex: int
        number: int
        ownerIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableGenericParam, __a1: int, __a2: int, __a3: int, __a4: int): ...
