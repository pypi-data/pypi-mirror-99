...
class LocalProcedureReferenceMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractLocalProcedureReferenceMsSymbol, ghidra.app.util.bin.format.pdb2.pdbreader.symbol.NameMsSymbol):
    PDB_ID: int = 4391
