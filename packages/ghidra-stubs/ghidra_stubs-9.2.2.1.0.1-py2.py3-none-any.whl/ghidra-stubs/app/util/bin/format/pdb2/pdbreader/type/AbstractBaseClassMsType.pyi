...
class AbstractBaseClassMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType, ghidra.app.util.bin.format.pdb2.pdbreader.type.MsTypeField):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.util.bin.format.pdb2.pdbreader.AbstractPdb, __a1: ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber, __a2: long, __a3: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes): ...
