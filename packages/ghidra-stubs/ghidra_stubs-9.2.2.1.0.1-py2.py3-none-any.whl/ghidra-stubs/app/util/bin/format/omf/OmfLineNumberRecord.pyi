...
class OmfLineNumberRecord(ghidra.app.util.bin.format.omf.OmfRecord):





    class LineSubrecord(object):
        ...
        @staticmethod
        def read(__a0: ghidra.app.util.bin.BinaryReader, __a1: bool) -> ghidra.app.util.bin.format.omf.OmfLineNumberRecord.LineSubrecord: ...
