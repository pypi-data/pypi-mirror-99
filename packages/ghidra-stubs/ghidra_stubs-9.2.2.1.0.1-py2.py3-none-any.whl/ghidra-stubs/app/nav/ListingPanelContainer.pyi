...
class ListingPanelContainer(javax.swing.JPanel):
    ...
    @overload
    def __init__(self, leftListingPanel: javax.swing.JComponent, isConnected: bool): ...

    @overload
    def __init__(self, leftListingPanel: javax.swing.JComponent, rightListingPanel: javax.swing.JComponent, leftTitle: unicode, rightTitle: unicode): ...
    ...
    def setConnnected(self, isConnected: bool) -> None: ...
    ...
    def setNorthPanel(self, comp: javax.swing.JComponent) -> None: ...

    def setOpaque(self, __a0: bool) -> None: ...

    def setOrientation(self, isSideBySide: bool) -> None: ...

    def setOtherPanel(self, rightListingPanel: javax.swing.JComponent, leftTitle: unicode, rightTitle: unicode) -> None: ...
    ...
    def updateTitle(self, newTitle: unicode) -> None: ...
    ...
    @property
    def connnected(self) -> None: ...  # No getter available.

    @connnected.setter
    def connnected(self, value: bool) -> None: ...

    @property
    def northPanel(self) -> None: ...  # No getter available.

    @northPanel.setter
    def northPanel(self, value: javax.swing.JComponent) -> None: ...

    @property
    def orientation(self) -> None: ...  # No getter available.
