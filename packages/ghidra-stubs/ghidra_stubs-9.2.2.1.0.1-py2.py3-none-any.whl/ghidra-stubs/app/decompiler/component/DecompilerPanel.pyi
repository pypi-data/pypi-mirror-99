...
class DecompilerPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldMouseListener, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, ghidra.app.decompiler.component.ClangHighlightListener):
    """
    ...
    def addPcodeOpHighlights(self, ops: java.util.Set, hlColor: java.awt.Color) -> None: ...
    ...
    def addVarnodeHighlights(self, varnodes: java.util.Set, colorProvider: ghidra.app.plugin.core.decompile.actions.TokenHighlightColorProvider) -> None: ...
    ...
    def applySecondaryHighlights(self, highlightsByName: java.util.Map) -> None: ...
    ...
    def removeSecondaryHighlights(self) -> None: ...
    ...
    @property
    def layoutModel(self) -> docking.widgets.fieldpanel.LayoutModel: ...
    ...
    @property
    def searchResults(self) -> None: ...  # No getter available.

    @searchResults.setter
    def searchResults(self, value: docking.widgets.SearchLocation) -> None: ...
