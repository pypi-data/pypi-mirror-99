...
class ScheduledTaskPanel(javax.swing.JPanel):
    ...
    def __init__(self, labelText: unicode, indention: int): ...
    ...
    def setHiddenViewAmount(self, fraction: float) -> None:
        """
    ...
    @property
    def hiddenViewAmount(self) -> None: ...  # No getter available.

    @hiddenViewAmount.setter
    def hiddenViewAmount(self, value: float) -> None: ...
