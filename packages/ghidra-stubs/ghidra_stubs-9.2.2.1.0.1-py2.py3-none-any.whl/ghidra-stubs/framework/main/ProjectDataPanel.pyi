...
class ProjectDataPanel(javax.swing.JSplitPane):
    """
    ...
    @overload
    def __init__(self, __a0: int, __a1: bool): ...

    @overload
    def __init__(self, __a0: int, __a1: java.awt.Component, __a2: java.awt.Component): ...

    @overload
    def __init__(self, __a0: int, __a1: bool, __a2: java.awt.Component, __a3: java.awt.Component): ...
    ...
    def getBottomComponent(self) -> java.awt.Component: ...
    ...
    def getLastDividerLocation(self) -> int: ...

    def getLayout(self) -> java.awt.LayoutManager: ...

    def getLeftComponent(self) -> java.awt.Component: ...
    ...
    def getMaximumDividerLocation(self) -> int: ...

    def getMaximumSize(self) -> java.awt.Dimension: ...

    def getMinimumDividerLocation(self) -> int: ...
    ...
    def getResizeWeight(self) -> float: ...

    def getRightComponent(self) -> java.awt.Component: ...
    ...
    def getTopComponent(self) -> java.awt.Component: ...
    ...
    def getUI(self) -> javax.swing.plaf.SplitPaneUI: ...
    ...
    def isContinuousLayout(self) -> bool: ...
    ...
    def isOneTouchExpandable(self) -> bool: ...
    ...
    def resetToPreferredSizes(self) -> None: ...
    ...
    def setBottomComponent(self, __a0: java.awt.Component) -> None: ...
    ...
    def setContinuousLayout(self, __a0: bool) -> None: ...
    ...
    @overload
    def setDividerLocation(self, __a0: float) -> None: ...

    def setDividerSize(self, __a0: int) -> None: ...
    ...
    def setLastDividerLocation(self, __a0: int) -> None: ...

    def setLayout(self, __a0: java.awt.LayoutManager) -> None: ...

    def setLeftComponent(self, __a0: java.awt.Component) -> None: ...
    ...
    def setOneTouchExpandable(self, __a0: bool) -> None: ...
    ...
    def setResizeWeight(self, __a0: float) -> None: ...

    def setRightComponent(self, __a0: java.awt.Component) -> None: ...
    ...
    def setTopComponent(self, __a0: java.awt.Component) -> None: ...

    def setTransferHandler(self, __a0: javax.swing.TransferHandler) -> None: ...

    def setUI(self, __a0: javax.swing.plaf.SplitPaneUI) -> None: ...
