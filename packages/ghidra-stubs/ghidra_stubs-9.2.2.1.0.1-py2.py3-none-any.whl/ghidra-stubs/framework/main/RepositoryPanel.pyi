...
class RepositoryPanel(docking.wizard.AbstractWizardJPanel):
    """
    ...
    def __init__(self, panelManager: docking.wizard.PanelManager, serverName: unicode, repositoryNames: List[unicode], readOnlyServerAccess: bool): ...
