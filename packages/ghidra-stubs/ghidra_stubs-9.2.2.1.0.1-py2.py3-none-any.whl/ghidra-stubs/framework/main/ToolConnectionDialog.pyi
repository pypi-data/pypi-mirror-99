...
class ToolConnectionDialog(docking.DialogComponentProvider, ghidra.framework.model.WorkspaceChangeListener):
    """
    ...
    def propertyChange(self, event: java.beans.PropertyChangeEvent) -> None: ...
