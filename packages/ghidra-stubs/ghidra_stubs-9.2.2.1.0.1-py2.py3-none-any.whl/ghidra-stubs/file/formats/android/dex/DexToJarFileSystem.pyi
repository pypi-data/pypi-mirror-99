...
class DexToJarFileSystem(ghidra.formats.gfilesystem.GFileSystemBase):
    ...
    def getJarFile(self) -> ghidra.formats.gfilesystem.GFile: ...
    ...
    @property
    def jarFile(self) -> ghidra.formats.gfilesystem.GFile: ...