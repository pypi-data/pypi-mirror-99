...
class TokenField(ghidra.pcodeCPort.slghpatexpress.PatternValue):
    ...
    @overload
    def __init__(self, __a0: ghidra.sleigh.grammar.Location, __a1: ghidra.pcodeCPort.context.Token, __a2: bool, __a3: int, __a4: int): ...
