...
class BinaryExpression(ghidra.pcodeCPort.slghpatexpress.PatternExpression):
    ...
    @property
    def left(self) -> ghidra.pcodeCPort.slghpatexpress.PatternExpression: ...

    @property
    def right(self) -> ghidra.pcodeCPort.slghpatexpress.PatternExpression: ...