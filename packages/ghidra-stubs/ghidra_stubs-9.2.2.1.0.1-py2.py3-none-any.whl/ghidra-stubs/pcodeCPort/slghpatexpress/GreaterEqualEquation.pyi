...
class GreaterEqualEquation(ghidra.pcodeCPort.slghpatexpress.ValExpressEquation):
    location: ghidra.sleigh.grammar.Location



    def __init__(self, __a0: ghidra.sleigh.grammar.Location, __a1: ghidra.pcodeCPort.slghpatexpress.PatternValue, __a2: ghidra.pcodeCPort.slghpatexpress.PatternExpression): ...
