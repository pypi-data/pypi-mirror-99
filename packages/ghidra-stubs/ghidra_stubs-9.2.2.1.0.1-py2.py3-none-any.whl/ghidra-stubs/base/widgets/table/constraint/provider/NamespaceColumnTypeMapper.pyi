...
class NamespaceColumnTypeMapper(docking.widgets.table.constraint.ColumnTypeMapper):
    """
    ...
    @overload
    def convert(self, namespace: ghidra.program.model.symbol.Namespace) -> unicode: ...
