...
class ContextRegisterFilterInputDialog(ghidra.bitpatterns.gui.InputDialogComponentProvider):




    def __init__(self, __a0: unicode, __a1: ghidra.bitpatterns.info.ContextRegisterExtent, __a2: java.awt.Component): ...
    ...
    def getFilter(self) -> ghidra.bitpatterns.info.ContextRegisterFilter: ...
    ...
    @property
    def filter(self) -> ghidra.bitpatterns.info.ContextRegisterFilter: ...