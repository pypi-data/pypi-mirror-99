...
class UnsignedShortDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Basic implementation for a Short Integer dataType
    """

    dataType: ghidra.program.model.data.UnsignedShortDataType = ushort
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedShortDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.ShortDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.ShortDataType: ...