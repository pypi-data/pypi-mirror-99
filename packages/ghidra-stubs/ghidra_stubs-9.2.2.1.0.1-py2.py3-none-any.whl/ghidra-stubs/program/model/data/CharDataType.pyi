...
class CharDataType(ghidra.program.model.data.AbstractIntegerDataType, ghidra.program.model.data.DataTypeWithCharset):
    """
    ...
    dataType: ghidra.program.model.data.CharDataType = char
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.CharDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.CharDataType: ...