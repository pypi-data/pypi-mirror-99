...
class AbstractStringDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic, ghidra.program.model.data.DataTypeWithCharset):
    ...
    Common base class for all Ghidra string DataTypes.
     ...
     #AbstractStringDataType(String, String, String, String, String, String, String, DataType, StringLayoutEnum, DataTypeManager)
     and the DataType#clone(DataTypeManager) method.
 
    """

    COMMON_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@7ccf896b, ghidra.program.model.data.RenderUnicodeSettingsDefinition@c6eb9f])
    COMMON_WITH_CHARSET_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@7ccf896b, ghidra.program.model.data.RenderUnicodeSettingsDefinition@c6eb9f, ghidra.program.model.data.CharsetSettingsDefinition@52cf9723])
