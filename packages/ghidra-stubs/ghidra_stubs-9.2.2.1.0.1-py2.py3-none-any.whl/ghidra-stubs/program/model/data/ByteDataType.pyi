...
class ByteDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Provides a definition of a Byte within a program.
    """

    dataType: ghidra.program.model.data.ByteDataType = byte
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.ByteDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.SignedByteDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.SignedByteDataType: ...