...
class Integer7DataType(ghidra.program.model.data.AbstractIntegerDataType):
    dataType: ghidra.program.model.data.Integer7DataType = int7
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.Integer7DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger7DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger7DataType: ...