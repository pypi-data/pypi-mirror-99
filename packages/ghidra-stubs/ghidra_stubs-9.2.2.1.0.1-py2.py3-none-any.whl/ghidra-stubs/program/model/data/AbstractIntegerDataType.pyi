...
class AbstractIntegerDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.ArrayStringable):
    """
    Base type for integer data types such as CharDataType, IntegerDataType,
     and LongDataType.
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.AbstractIntegerDataType: ...
