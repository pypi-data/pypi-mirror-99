...
class SignedCharDataType(ghidra.program.model.data.CharDataType):
    """
    ...
    dataType: ghidra.program.model.data.SignedCharDataType = schar
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.SignedCharDataType: ...
