...
class DefaultObjectPropertyMap(ghidra.program.model.util.DefaultPropertyMap, ghidra.program.model.util.ObjectPropertyMap):
    """
    ...
    def __init__(self, name: unicode, objectClass: java.lang.Class):
        """
