...
class AddressSetTableModel(ghidra.util.table.AddressPreviewTableModel):




    def __init__(self, title: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor): ...
