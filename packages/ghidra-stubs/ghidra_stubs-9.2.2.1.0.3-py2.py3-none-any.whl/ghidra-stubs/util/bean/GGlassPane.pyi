...
class GGlassPane(javax.swing.JComponent):
    ...
    def addPainter(self, painter: ghidra.util.bean.GGlassPanePainter) -> None:
        """
    ...
    @staticmethod
    def getGlassPane(component: java.awt.Component) -> ghidra.util.bean.GGlassPane: ...
    ...
    def removePainter(self, painter: ghidra.util.bean.GGlassPanePainter) -> None: ...
    ...
    @staticmethod
    def setAllGlassPanesBusy(isBusy: bool) -> None:
        """
    ...
    def showBusyCursor(self, showBusyCursor: bool) -> None: ...
