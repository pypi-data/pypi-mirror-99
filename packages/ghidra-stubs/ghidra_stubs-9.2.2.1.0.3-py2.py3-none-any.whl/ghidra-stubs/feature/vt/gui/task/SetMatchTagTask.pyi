...
class SetMatchTagTask(ghidra.util.task.Task):




    def __init__(self, __a0: ghidra.feature.vt.api.main.VTSession, __a1: List[object], __a2: ghidra.feature.vt.api.main.VTMatchTag): ...
