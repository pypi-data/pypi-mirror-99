...
class UnapplyMarkupItemTask(ghidra.feature.vt.gui.task.VtTask):




    def __init__(self, __a0: ghidra.feature.vt.api.main.VTSession, __a1: ghidra.program.util.AddressCorrelation, __a2: List[object]): ...
