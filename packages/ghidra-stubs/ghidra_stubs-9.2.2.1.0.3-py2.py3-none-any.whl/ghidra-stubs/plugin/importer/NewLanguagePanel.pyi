...
class NewLanguagePanel(javax.swing.JPanel):
    ...
    def addSelectionListener(self, listener: ghidra.plugin.importer.LcsSelectionListener) -> None: ...
    ...
    def removeSelectionListener(self, listener: ghidra.plugin.importer.LcsSelectionListener) -> None: ...
    ...
    def setAllLcsPairsList(self, __a0: List[object]) -> None: ...
    ...
    def setFormatText(self, text: unicode) -> None: ...
    ...
    def setRecommendedLcsPair(self, lcsPair: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None: ...

    def setRecommendedLcsPairsList(self, __a0: List[object]) -> None: ...
    ...
    def setShowAllLcsPairs(self, show: bool) -> None: ...

    def setShowRecommendedCheckbox(self, show: bool) -> None: ...
    ...
    @property
    def allLcsPairsList(self) -> None: ...  # No getter available.

    @allLcsPairsList.setter
    def allLcsPairsList(self, value: List[object]) -> None: ...

    @property
    def formatText(self) -> None: ...  # No getter available.

    @formatText.setter
    def formatText(self, value: unicode) -> None: ...

    @property
    def recommendedLcsPair(self) -> None: ...  # No getter available.

    @recommendedLcsPair.setter
    def recommendedLcsPair(self, value: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None: ...

    @property
    def recommendedLcsPairsList(self) -> None: ...  # No getter available.

    @recommendedLcsPairsList.setter
    def recommendedLcsPairsList(self, value: List[object]) -> None: ...

    @property
    def selectedLcsPair(self) -> ghidra.program.model.lang.LanguageCompilerSpecPair: ...

    @selectedLcsPair.setter
    def selectedLcsPair(self, value: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None: ...

    @property
    def showAllLcsPairs(self) -> None: ...  # No getter available.

    @showAllLcsPairs.setter
    def showAllLcsPairs(self, value: bool) -> None: ...

    @property
    def showRecommendedCheckbox(self) -> None: ...  # No getter available.

    @showRecommendedCheckbox.setter
    def showRecommendedCheckbox(self, value: bool) -> None: ...