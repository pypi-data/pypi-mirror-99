...
class ImporterLanguageDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, loadSpecs: java.util.Collection, tool: ghidra.framework.plugintool.PluginTool, defaultSelectedLanguage: ghidra.program.model.lang.LanguageCompilerSpecPair): ...
    ...
    def show(self, parent: java.awt.Component) -> None: ...
