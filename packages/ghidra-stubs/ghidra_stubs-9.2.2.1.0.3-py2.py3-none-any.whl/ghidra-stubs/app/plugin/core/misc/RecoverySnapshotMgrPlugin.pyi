...
class RecoverySnapshotMgrPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.FrontEndOnly, ghidra.framework.options.OptionsChangeListener, ghidra.framework.model.ProjectListener):
