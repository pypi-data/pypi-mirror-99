...
class EclipseIntegrationOptionsPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.FrontEndOnly):
    AUTO_GHIDRADEV_INSTALL_OPTION: unicode = u'Automatically install GhidraDev'
    ECLIPSE_INSTALL_DIR_OPTION: unicode = u'Eclipse Installation Directory'
    ECLIPSE_WORKSPACE_DIR_OPTION: unicode = u'Eclipse Workspace Directory (optional)'
    PLUGIN_OPTIONS_NAME: unicode = u'Eclipse Integration'
    SCRIPT_EDITOR_PORT_OPTION: unicode = u'Script Editor Port'
    SYMBOL_LOOKUP_PORT_OPTION: unicode = u'Symbol Lookup Port'
