...
class UninitializedBlockCmd(ghidra.framework.cmd.BackgroundCommand):




    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.mem.MemoryBlock): ...
