...
class CategoryNode(ghidra.app.plugin.core.datamgr.tree.DataTypeTreeNode):




    def __init__(self, __a0: ghidra.program.model.data.Category, __a1: ghidra.app.plugin.core.datamgr.tree.ArrayPointerFilterState): ...
