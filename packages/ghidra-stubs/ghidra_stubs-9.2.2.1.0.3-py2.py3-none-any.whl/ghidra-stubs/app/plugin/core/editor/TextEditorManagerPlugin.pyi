...
import ghidra.app.plugin.core.editor
...
class TextEditorManagerPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.app.services.TextEditorService):
    ...
    def edit(self, __a0: unicode, __a1: java.io.InputStream) -> None: ...
    ...
    def getEditors(self) -> List[object]: ...
    ...
    def removeTextFile(self, __a0: ghidra.app.plugin.core.editor.TextEditorComponentProvider, __a1: unicode) -> bool: ...
