...
class StructureEditorModelListener(ghidra.app.plugin.core.compositeeditor.CompositeEditorModelListener, object):
    ...
    def internalAlignmentStateChanged(self, __a0: bool) -> None: ...

    def notify(self) -> None: ...

    def notifyAll(self) -> None: ...

    def packStateChanged(self, __a0: long) -> None: ...
