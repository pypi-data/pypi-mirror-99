...
class CompositeEditorPanel(javax.swing.JPanel, ghidra.app.plugin.core.compositeeditor.CompositeEditorModelListener, ghidra.app.plugin.core.compositeeditor.ComponentCellEditorListener, docking.dnd.Draggable, docking.dnd.Droppable):




    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.CompositeEditorModel, __a1: ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider): ...
    ...
    @property
    def status(self) -> None: ...  # No getter available.
