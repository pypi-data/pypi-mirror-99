...
class ExecuteDiffDialog(docking.DialogComponentProvider):
    DIFF_ACTION: unicode = u'Diff'
    ...
    def configure(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.address.AddressSetView, __a3: ghidra.program.util.ProgramDiffFilter) -> None: ...
