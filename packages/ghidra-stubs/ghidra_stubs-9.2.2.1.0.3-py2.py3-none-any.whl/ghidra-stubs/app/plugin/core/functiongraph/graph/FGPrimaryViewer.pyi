...
class FGPrimaryViewer(ghidra.graph.viewer.GraphViewer):
    ...
    def createVertexMouseInfo(self, __a0: java.awt.event.MouseEvent, __a1: ghidra.graph.viewer.VisualVertex, __a2: java.awt.geom.Point2D) -> ghidra.graph.viewer.event.mouse.VertexMouseInfo: ...
    ...
    def getGPickedVertexState(self) -> ghidra.graph.viewer.event.picking.GPickedState: ...

    def getGraphLayout(self) -> edu.uci.ics.jung.algorithms.layout.Layout: ...

    def getGraphMouse(self) -> edu.uci.ics.jung.visualization.VisualizationViewer.GraphMouse: ...
    ...
    def getVisualGraphLayout(self) -> ghidra.graph.viewer.layout.VisualGraphLayout: ...
    ...
    def setGraphMouse(self, __a0: edu.uci.ics.jung.visualization.VisualizationViewer.GraphMouse) -> None: ...
    ...
    def setVertexTooltipProvider(self, __a0: ghidra.graph.viewer.event.mouse.VertexTooltipProvider) -> None: ...

    def setViewerInitializedListener(self, __a0: java.util.function.Consumer) -> None: ...
