...
class FGVertexListingPanel(ghidra.app.util.viewer.listingpanel.ListingPanel):
    ...
    def addHighlightProvider(self, __a0: ghidra.app.util.HighlightProvider) -> None: ...

    def addHoverService(self, __a0: ghidra.app.plugin.core.codebrowser.hover.ListingHoverService) -> None: ...

    def addIndexMapChangeListener(self, __a0: javax.swing.event.ChangeListener) -> None: ...
    ...
    def center(self, __a0: ghidra.program.util.ProgramLocation) -> None: ...
    ...
    def enablePropertyBasedColorModel(self, __a0: bool) -> None: ...
    ...
    def getHeaderActions(self, __a0: unicode) -> List[object]: ...
    ...
    @overload
    def getLayout(self, __a0: ghidra.program.model.address.Address) -> docking.widgets.fieldpanel.Layout: ...
    ...
    def getMarginProviders(self) -> List[object]: ...
    ...
    def getOverviewProviders(self) -> List[object]: ...
    ...
    @overload
    def getProgramLocation(self, __a0: java.awt.Point) -> ghidra.program.util.ProgramLocation: ...

    @overload
    def getProgramSelection(self) -> ghidra.program.util.ProgramSelection: ...

    @overload
    def getProgramSelection(self, __a0: docking.widgets.fieldpanel.support.FieldSelection) -> ghidra.program.util.ProgramSelection: ...
    ...
    def removeHighlightProvider(self, __a0: ghidra.app.util.HighlightProvider) -> None: ...

    def removeHoverService(self, __a0: ghidra.app.plugin.core.codebrowser.hover.ListingHoverService) -> None: ...

    def removeIndexMapChangeListener(self, __a0: javax.swing.event.ChangeListener) -> None: ...
    ...
    def scrollTo(self, __a0: ghidra.program.util.ProgramLocation) -> None: ...
    ...
    def setBackgroundColorModel(self, __a0: ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel) -> None: ...
    ...
    @overload
    def setCursorPosition(self, __a0: ghidra.program.util.ProgramLocation) -> None: ...

    @overload
    def setCursorPosition(self, __a0: ghidra.program.util.ProgramLocation, __a1: docking.widgets.EventTrigger) -> None: ...
    ...
    def setDividerLocation(self, __a0: int) -> None: ...
    ...
    def setFormatManager(self, __a0: ghidra.app.util.viewer.format.FormatManager) -> None: ...

    def setHighlight(self, __a0: ghidra.program.util.ProgramSelection) -> None: ...

    def setHoverMode(self, __a0: bool) -> None: ...
    ...
    def setListingHoverHandler(self, __a0: ghidra.app.util.viewer.listingpanel.ListingHoverProvider) -> None: ...

    def setListingModel(self, __a0: ghidra.app.util.viewer.listingpanel.ListingModel) -> None: ...
    ...
    def setProgramLocationListener(self, __a0: ghidra.app.util.viewer.listingpanel.ProgramLocationListener) -> None: ...

    def setProgramSelectionListener(self, __a0: ghidra.app.util.viewer.listingpanel.ProgramSelectionListener) -> None: ...
    ...
    def setStringSelectionListener(self, __a0: ghidra.app.util.viewer.listingpanel.StringSelectionListener) -> None: ...

    def setTextBackgroundColor(self, __a0: java.awt.Color) -> None: ...
    ...
    def showHeader(self, __a0: bool) -> None: ...
    ...
    def updateDisplay(self, __a0: bool) -> None: ...
