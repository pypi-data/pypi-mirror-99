...
class PcodeFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    @overload
    def __init__(self, __a0: unicode, __a1: ghidra.app.util.viewer.format.FieldFormatModel, __a2: ghidra.app.util.HighlightProvider, __a3: ghidra.framework.options.Options, __a4: ghidra.framework.options.Options): ...
