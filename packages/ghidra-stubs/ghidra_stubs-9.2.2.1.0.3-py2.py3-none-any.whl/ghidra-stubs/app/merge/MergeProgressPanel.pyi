...
class MergeProgressPanel(javax.swing.JPanel):
    ...
    COMPLETED_ICON: javax.swing.ImageIcon
    DEFINED_ICON: javax.swing.ImageIcon
    IN_PROGRESS_ICON: javax.swing.ImageIcon
    ...
    def addInfo(self, phase: List[unicode]) -> javax.swing.JPanel:
        """
    ...
    def setCompleted(self, phase: List[unicode]) -> None:
        """
    ...
    def setInProgress(self, phase: List[unicode]) -> None:
        """
        Indicates a particular phase or sub-phase whose status icon is to be changed to 
