...
class RemoveReferenceCmd(object, ghidra.framework.cmd.Command):
    """
    ...
    @overload
    def __init__(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, opIndex: int):
        """
        Constructs a new command for removing a memory reference.
