...
class FunctionPurgeFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    FIELD_NAME: unicode = u'Function Purge'
    ...
    def newInstance(self, newModel: ghidra.app.util.viewer.format.FieldFormatModel, newHlProvider: ghidra.app.util.HighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
