...
class CliTableModule(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliModuleRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        encBaseIdIndex: int
        encIdIndex: int
        generation: int
        mvIdIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableModule, __a1: int, __a2: int, __a3: int, __a4: int, __a5: int): ...
