...
class CliTableFile(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliFileRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        flags: int
        hashIndex: int
        nameIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableFile, __a1: int, __a2: int, __a3: int): ...
