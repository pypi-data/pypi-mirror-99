...
class CliTableTypeRef(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliTypeRefRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableTypeRef, __a1: int, __a2: int, __a3: int): ...
