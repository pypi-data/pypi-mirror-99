...
class CliTableConstant(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliConstantRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        parentIndex: int
        reserved: int
        type: int
        valueIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableConstant, __a1: int, __a2: int, __a3: int, __a4: int): ...
