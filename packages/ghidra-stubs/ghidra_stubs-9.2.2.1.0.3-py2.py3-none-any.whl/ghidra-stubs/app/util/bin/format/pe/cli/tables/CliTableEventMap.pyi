...
class CliTableEventMap(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliEventMapRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        eventIndex: int
        parentIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableEventMap, __a1: int, __a2: int): ...
