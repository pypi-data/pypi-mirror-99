...
class DynamicLinkerCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    ...
    @staticmethod
    def createDynamicLinkerCommand(reader: ghidra.app.util.bin.format.FactoryBundledWithBinaryReader) -> ghidra.app.util.bin.format.macho.commands.DynamicLinkerCommand: ...
