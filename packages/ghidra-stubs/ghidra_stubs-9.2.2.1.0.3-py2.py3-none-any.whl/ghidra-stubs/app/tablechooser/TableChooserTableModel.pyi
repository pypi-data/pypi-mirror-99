...
class TableChooserTableModel(ghidra.util.table.AddressBasedTableModel):
    ...
    @overload
    def addObject(self, rowObject: ghidra.app.tablechooser.AddressableRowObject) -> None: ...
    ...
    def containsObject(self, obj: ghidra.app.tablechooser.AddressableRowObject) -> bool: ...
    ...
    @overload
    def removeObject(self, obj: ghidra.app.tablechooser.AddressableRowObject) -> None: ...
