...
import ghidra.file.formats.coff
...
class CoffArchiveFileSystemFactory(object, ghidra.formats.gfilesystem.factory.GFileSystemFactoryFull, ghidra.formats.gfilesystem.factory.GFileSystemProbeBytesOnly):
    ...
    def create(self, __a0: ghidra.formats.gfilesystem.FSRL, __a1: ghidra.formats.gfilesystem.FSRLRoot, __a2: ghidra.app.util.bin.ByteProvider, __a3: java.io.File, __a4: ghidra.formats.gfilesystem.FileSystemService, __a5: ghidra.util.task.TaskMonitor) -> ghidra.file.formats.coff.CoffArchiveFileSystem: ...
