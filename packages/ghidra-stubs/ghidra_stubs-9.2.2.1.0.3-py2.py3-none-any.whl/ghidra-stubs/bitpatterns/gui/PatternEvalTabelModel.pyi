...
class PatternEvalTabelModel(ghidra.util.table.AddressBasedTableModel):




    def __init__(self, __a0: ghidra.bitpatterns.gui.FunctionBitPatternsExplorerPlugin, __a1: ghidra.program.model.listing.Program, __a2: List[object]): ...
