...
class ClipboardPanel(javax.swing.JPanel):
    ...
    def evaluatePatterns(self, __a0: List[object]) -> ghidra.bitpatterns.info.PatternEvaluationStats: ...
    ...
    @property
    def lastSelectedObjects(self) -> List[object]: ...