...
class SpacebaseSpace(ghidra.pcodeCPort.space.AddrSpace):
    ...
    @overload
    def __init__(self, __a0: unicode, __a1: int, __a2: int, __a3: ghidra.pcodeCPort.space.AddrSpace, __a4: int): ...
