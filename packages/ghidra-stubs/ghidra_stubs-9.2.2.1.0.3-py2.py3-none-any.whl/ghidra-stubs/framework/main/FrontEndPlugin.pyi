...
class FrontEndPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.FrontEndService, ghidra.framework.client.RemoteAdapterListener, ghidra.framework.main.ProgramaticUseOnly):
    """
