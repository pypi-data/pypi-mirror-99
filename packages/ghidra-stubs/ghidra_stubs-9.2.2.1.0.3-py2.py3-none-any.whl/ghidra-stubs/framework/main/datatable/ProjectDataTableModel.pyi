...
class ProjectDataTableModel(docking.widgets.table.threaded.ThreadedTableModel):
    ...
    def getDataSource(self) -> ghidra.framework.model.ProjectData: ...
    ...
    def setProjectData(self, projectData: ghidra.framework.model.ProjectData) -> None: ...
    ...
    @property
    def dataSource(self) -> ghidra.framework.model.ProjectData: ...

    @property
    def editing(self) -> None: ...  # No getter available.

    @editing.setter
    def editing(self, value: bool) -> None: ...

    @property
    def projectData(self) -> None: ...  # No getter available.

    @projectData.setter
    def projectData(self, value: ghidra.framework.model.ProjectData) -> None: ...