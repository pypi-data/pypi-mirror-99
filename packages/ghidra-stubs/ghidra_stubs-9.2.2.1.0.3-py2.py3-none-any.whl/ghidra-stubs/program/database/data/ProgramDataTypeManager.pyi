...
class ProgramDataTypeManager(ghidra.program.database.data.DataTypeManagerDB, ghidra.program.database.ManagerDB, ghidra.program.model.data.ProgramBasedDataTypeManager):
    """
