...
class SignedByteDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Provides a definition of a Signed Byte within a program.
    """

    dataType: ghidra.program.model.data.SignedByteDataType = sbyte
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.SignedByteDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.ByteDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.ByteDataType: ...