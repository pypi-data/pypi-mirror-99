...
class Complex32DataType(ghidra.program.model.data.AbstractComplexDataType):
    """
    Provides a definition of a  built-in data type consisting of two 16 byte floating point
     numbers in the IEEE 754 double precision format.
    """

    dataType: ghidra.program.model.data.Complex32DataType = complex32
