...
class MoveViewToViewSpacePointAnimatorFunctionGraphJob(ghidra.graph.job.MoveViewAnimatorFunctionGraphJob):




    def __init__(self, viewer: edu.uci.ics.jung.visualization.VisualizationServer, viewSpacePoint: java.awt.geom.Point2D, useAnimation: bool): ...
