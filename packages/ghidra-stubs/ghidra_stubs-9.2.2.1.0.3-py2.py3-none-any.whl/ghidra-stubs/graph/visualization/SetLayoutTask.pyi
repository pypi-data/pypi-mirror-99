...
class SetLayoutTask(ghidra.util.task.Task):




    def __init__(self, __a0: org.jungrapht.visualization.VisualizationViewer, __a1: ghidra.graph.visualization.LayoutTransitionManager, __a2: unicode): ...
