...
class CombinePattern(ghidra.pcodeCPort.slghpattern.DisjointPattern):
    ...
    @overload
    def __init__(self, __a0: ghidra.pcodeCPort.slghpattern.ContextPattern, __a1: ghidra.pcodeCPort.slghpattern.InstructionPattern): ...
