...
class GhidraApplicationConfiguration(ghidra.framework.HeadlessGhidraApplicationConfiguration):
    ...
    def setShowSplashScreen(self, b: bool) -> None: ...
    ...
    @property
    def showSplashScreen(self) -> None: ...  # No getter available.

    @showSplashScreen.setter
    def showSplashScreen(self, value: bool) -> None: ...