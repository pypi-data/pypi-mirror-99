...
class FieldHeader(javax.swing.JTabbedPane, javax.swing.event.ChangeListener):
    ...
    def __init__(self, formatMgr: ghidra.app.util.viewer.format.FormatManager, scroller: docking.widgets.indexedscrollpane.IndexedScrollPane, panel: docking.widgets.fieldpanel.FieldPanel):
        """
    ...
    @overload
    def addTab(self, __a0: unicode, __a1: java.awt.Component) -> None: ...

    @overload
    def addTab(self, __a0: unicode, __a1: javax.swing.Icon, __a2: java.awt.Component) -> None: ...

    @overload
    def addTab(self, __a0: unicode, __a1: javax.swing.Icon, __a2: java.awt.Component, __a3: unicode) -> None: ...
    ...
    def getActions(self, ownerName: unicode) -> List[docking.action.DockingActionIf]: ...
    ...
    def getBackgroundAt(self, __a0: int) -> java.awt.Color: ...
    ...
    def getBoundsAt(self, __a0: int) -> java.awt.Rectangle: ...
    ...
    @overload
    def getComponentAt(self, __a0: int) -> java.awt.Component: ...
    ...
    def getCurrentModel(self) -> ghidra.app.util.viewer.format.FieldFormatModel:
        """
    ...
    def getDisabledIconAt(self, __a0: int) -> javax.swing.Icon: ...

    def getDisplayedMnemonicIndexAt(self, __a0: int) -> int: ...

    def getDropTarget(self) -> java.awt.dnd.DropTarget: ...

    def getFieldHeaderLocation(self, p: java.awt.Point) -> ghidra.app.util.viewer.format.FieldHeaderLocation:
        """
    ...
    def getForegroundAt(self, __a0: int) -> java.awt.Color: ...
    ...
    def getHeaderTab(self) -> ghidra.app.util.viewer.format.FieldHeaderComp:
        """
    ...
    def getIconAt(self, __a0: int) -> javax.swing.Icon: ...
    ...
    def getMnemonicAt(self, __a0: int) -> int: ...

    def getModel(self) -> javax.swing.SingleSelectionModel: ...
    ...
    def getSelectedComponent(self) -> java.awt.Component: ...
    ...
    def getTabComponentAt(self, __a0: int) -> java.awt.Component: ...

    def getTabCount(self) -> int: ...

    def getTabLayoutPolicy(self) -> int: ...

    def getTabPlacement(self) -> int: ...

    def getTabRunCount(self) -> int: ...

    def getTitleAt(self, __a0: int) -> unicode: ...
    ...
    def getToolTipTextAt(self, __a0: int) -> unicode: ...
    ...
    def indexAtLocation(self, __a0: int, __a1: int) -> int: ...

    def indexOfComponent(self, __a0: java.awt.Component) -> int: ...

    @overload
    def indexOfTab(self, __a0: unicode) -> int: ...

    @overload
    def indexOfTab(self, __a0: javax.swing.Icon) -> int: ...

    def indexOfTabComponent(self, __a0: java.awt.Component) -> int: ...

    def insertTab(self, __a0: unicode, __a1: javax.swing.Icon, __a2: java.awt.Component, __a3: unicode, __a4: int) -> None: ...
    ...
    def isEnabledAt(self, __a0: int) -> bool: ...
    ...
    def removeTabAt(self, __a0: int) -> None: ...
    ...
    def setBackgroundAt(self, __a0: int, __a1: java.awt.Color) -> None: ...
    ...
    def setComponentAt(self, __a0: int, __a1: java.awt.Component) -> None: ...
    ...
    def setDisabledIconAt(self, __a0: int, __a1: javax.swing.Icon) -> None: ...

    def setDisplayedMnemonicIndexAt(self, __a0: int, __a1: int) -> None: ...
    ...
    def setEnabledAt(self, __a0: int, __a1: bool) -> None: ...
    ...
    def setForegroundAt(self, __a0: int, __a1: java.awt.Color) -> None: ...

    def setIconAt(self, __a0: int, __a1: javax.swing.Icon) -> None: ...
    ...
    def setMnemonicAt(self, __a0: int, __a1: int) -> None: ...

    def setModel(self, __a0: javax.swing.SingleSelectionModel) -> None: ...
    ...
    def setSelectedComponent(self, __a0: java.awt.Component) -> None: ...

    def setSelectedFieldFactory(self, factory: ghidra.app.util.viewer.field.FieldFactory) -> None:
        """
    ...
    def setTabComponentAt(self, __a0: int, __a1: java.awt.Component) -> None: ...

    def setTabLayoutPolicy(self, __a0: int) -> None: ...

    def setTabLock(self, b: bool) -> None:
        """
    ...
    def setTabPlacement(self, __a0: int) -> None: ...

    def setTitleAt(self, __a0: int, __a1: unicode) -> None: ...

    def setToolTipText(self, __a0: unicode) -> None: ...

    def setToolTipTextAt(self, __a0: int, __a1: unicode) -> None: ...

    def setTransferHandler(self, __a0: javax.swing.TransferHandler) -> None: ...

    def setUI(self, __a0: javax.swing.plaf.TabbedPaneUI) -> None: ...

    def setVerifyInputWhenFocusTarget(self, __a0: bool) -> None: ...

    def setViewComponent(self, centerComponent: javax.swing.JComponent) -> None: ...
    ...
    def stateChanged(self, ev: javax.swing.event.ChangeEvent) -> None: ...
    ...
    @property
    def currentModel(self) -> ghidra.app.util.viewer.format.FieldFormatModel: ...

    @property
    def formatManager(self) -> ghidra.app.util.viewer.format.FormatManager: ...

    @property
    def headerTab(self) -> ghidra.app.util.viewer.format.FieldHeaderComp: ...

    @property
    def selectedFieldFactory(self) -> ghidra.app.util.viewer.field.FieldFactory: ...

    @selectedFieldFactory.setter
    def selectedFieldFactory(self, value: ghidra.app.util.viewer.field.FieldFactory) -> None: ...

    @property
    def tabLock(self) -> None: ...  # No getter available.

    @tabLock.setter
    def tabLock(self, value: bool) -> None: ...

    @property
    def viewComponent(self) -> None: ...  # No getter available.

    @viewComponent.setter
    def viewComponent(self, value: javax.swing.JComponent) -> None: ...