...
class AnnotatedStringFieldMouseHandler(object, ghidra.app.util.viewer.field.FieldMouseHandlerExtension):
    """
    A handler to process ghidra.util.bean.field.AnnotatedTextFieldElement clicks.
    """
