...
class GoToAddressLabelDialog(docking.DialogComponentProvider, ghidra.app.services.GoToServiceListener):
    ...
    def getHistory(self) -> List[unicode]: ...
    ...
    def maxEntrysChanged(self) -> None: ...
    ...
    def setCStyleInput(self, cStyleInput: bool) -> None: ...

    def setCaseSensitive(self, b: bool) -> None: ...
    ...
    def setMemory(self, goToMemory: bool) -> None: ...
    ...
    def show(self, nav: ghidra.app.nav.Navigatable, addr: ghidra.program.model.address.Address, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
    ...
    @property
    def CStyleInput(self) -> None: ...  # No getter available.

    @CStyleInput.setter
    def CStyleInput(self, value: bool) -> None: ...

    @property
    def caseSensitive(self) -> None: ...  # No getter available.
    ...
    @property
    def memory(self) -> None: ...  # No getter available.

    @memory.setter
    def memory(self, value: bool) -> None: ...

    @property
    def text(self) -> None: ...  # No getter available.
