...
class CliTableMethodImpl(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliMethodImplRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        classIndex: int
        methodBodyIndex: int
        methodDeclarationIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableMethodImpl, __a1: int, __a2: int, __a3: int): ...
