...
class ARM_ElfExtension(ghidra.app.util.bin.format.elf.extend.ElfExtension):
    PT_ARM_EXIDX: ghidra.app.util.bin.format.elf.ElfProgramHeaderType = PT_ARM_EXIDX(0x70000000)
    SHT_ARM_ATTRIBUTES: ghidra.app.util.bin.format.elf.ElfSectionHeaderType = SHT_ARM_ATTRIBUTES(0x70000003)
    SHT_ARM_DEBUGOVERLAY: ghidra.app.util.bin.format.elf.ElfSectionHeaderType = SHT_ARM_DEBUGOVERLAY(0x70000004)
    SHT_ARM_EXIDX: ghidra.app.util.bin.format.elf.ElfSectionHeaderType = SHT_ARM_EXIDX(0x70000001)
    SHT_ARM_OVERLAYSECTION: ghidra.app.util.bin.format.elf.ElfSectionHeaderType = SHT_ARM_OVERLAYSECTION(0x70000005)
    SHT_ARM_PREEMPTMAP: ghidra.app.util.bin.format.elf.ElfSectionHeaderType = SHT_ARM_PREEMPTMAP(0x70000002)
