...
class CliTableAssemblyRefProcessor(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliAssemblyRefProcessorRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        assemblyRefIndex: int
        processor: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableAssemblyRefProcessor, __a1: int, __a2: int): ...
