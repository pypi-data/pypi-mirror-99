...
class CliTableInterfaceImpl(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliInterfaceImplRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        classIndex: int
        interfaceIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableInterfaceImpl, __a1: int, __a2: int): ...
