...
class VtShapeMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    PDB_ID: int = 10
    ...
    def getDescriptorList(self) -> List[object]: ...
    ...
    def hasDescriptor(self, __a0: ghidra.app.util.bin.format.pdb2.pdbreader.type.VtShapeDescriptorMsProperty) -> bool: ...
    ...
    @property
    def descriptorList(self) -> List[object]: ...
