...
class AbstractArgumentsListMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    ...
    def getArgRecordNumbers(self) -> List[object]: ...
    ...
    @property
    def argRecordNumbers(self) -> List[object]: ...