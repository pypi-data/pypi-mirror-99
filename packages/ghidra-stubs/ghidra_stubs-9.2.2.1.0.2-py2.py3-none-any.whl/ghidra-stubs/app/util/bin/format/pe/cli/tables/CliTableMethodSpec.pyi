...
class CliTableMethodSpec(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliMethodSpecRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        instantiationIndex: int
        methodIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableMethodSpec, __a1: int, __a2: int): ...
