...
class AbstractNestedTypeExtMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    ...
    def getClassFieldAttributes(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes: ...

    def getLength(self) -> long: ...

    def getName(self) -> unicode: ...

    def getNestedTypeDefinitionRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...
    ...
    @property
    def classFieldAttributes(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes: ...

    @property
    def name(self) -> unicode: ...

    @property
    def nestedTypeDefinitionRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...