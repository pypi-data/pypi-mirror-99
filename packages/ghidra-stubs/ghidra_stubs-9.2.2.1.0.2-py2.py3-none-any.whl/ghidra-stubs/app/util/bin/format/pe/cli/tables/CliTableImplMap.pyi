...
class CliTableImplMap(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliImplMapRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        importNameIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableImplMap, __a1: int, __a2: int, __a3: int, __a4: int): ...
