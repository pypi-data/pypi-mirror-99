...
class CliTableGenericParamConstraint(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliGenericParamConstraintRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        constraintIndex: int
        ownerIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableGenericParamConstraint, __a1: int, __a2: int): ...
