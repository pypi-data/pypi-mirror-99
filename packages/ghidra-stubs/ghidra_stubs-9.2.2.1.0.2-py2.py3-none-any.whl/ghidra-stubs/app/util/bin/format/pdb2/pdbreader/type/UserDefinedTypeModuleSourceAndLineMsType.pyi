...
class UserDefinedTypeModuleSourceAndLineMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    PDB_ID: int = 5639
    ...
    def getSourceFileNameOffset(self) -> int: ...
    ...
    @property
    def sourceFileNameOffset(self) -> int: ...
