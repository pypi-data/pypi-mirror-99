...
class AnnotationReferenceMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractReferenceMsSymbol, ghidra.app.util.bin.format.pdb2.pdbreader.symbol.NameMsSymbol):
    PDB_ID: int = 4392
