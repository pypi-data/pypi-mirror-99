...
class DataReferenceMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractDataReferenceMsSymbol, ghidra.app.util.bin.format.pdb2.pdbreader.symbol.NameMsSymbol):
    PDB_ID: int = 4390
