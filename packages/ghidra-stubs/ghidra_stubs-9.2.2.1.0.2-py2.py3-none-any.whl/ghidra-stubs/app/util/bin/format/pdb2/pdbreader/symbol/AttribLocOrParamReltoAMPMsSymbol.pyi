...
class AttribLocOrParamReltoAMPMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractManagedLocalOrParameterRelativeToAlternateFramePointerMsSymbol):
    PDB_ID: int = 4400
