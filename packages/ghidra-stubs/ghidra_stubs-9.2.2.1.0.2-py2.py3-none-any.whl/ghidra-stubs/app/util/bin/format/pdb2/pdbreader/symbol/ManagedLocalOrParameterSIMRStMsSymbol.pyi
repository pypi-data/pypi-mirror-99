...
class ManagedLocalOrParameterSIMRStMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractManagedLocalOrParameterStoredInManyRegisterMsSymbol):
    PDB_ID: int = 4133
