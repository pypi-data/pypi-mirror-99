...
class AbstractCobol0MsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    ...
    def getParentRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...

    def getParentType(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType: ...
    ...
    @property
    def parentRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...

    @property
    def parentType(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType: ...