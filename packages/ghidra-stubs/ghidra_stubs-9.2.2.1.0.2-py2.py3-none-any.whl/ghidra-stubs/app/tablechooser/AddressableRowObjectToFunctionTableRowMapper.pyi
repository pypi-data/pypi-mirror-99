...
class AddressableRowObjectToFunctionTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    ...
    @overload
    def map(self, rowObject: ghidra.app.tablechooser.AddressableRowObject, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.listing.Function: ...
