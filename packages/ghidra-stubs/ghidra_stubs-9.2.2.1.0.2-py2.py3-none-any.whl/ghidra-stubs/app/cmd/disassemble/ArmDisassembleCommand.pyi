...
class ArmDisassembleCommand(ghidra.app.cmd.disassemble.DisassembleCommand):
    """
    ...
    @overload
    def __init__(self, start: ghidra.program.model.address.Address, restrictedSet: ghidra.program.model.address.AddressSetView, thumbMode: bool):
        """
    ...
    @overload
    def __init__(self, startSet: ghidra.program.model.address.AddressSetView, restrictedSet: ghidra.program.model.address.AddressSetView, thumbMode: bool):
        """
        Constructor for ArmDisassembleCommand.
