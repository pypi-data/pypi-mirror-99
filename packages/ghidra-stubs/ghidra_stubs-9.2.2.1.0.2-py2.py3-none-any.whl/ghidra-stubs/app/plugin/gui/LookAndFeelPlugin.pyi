...
class LookAndFeelPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.FrontEndOnly, ghidra.framework.options.OptionsChangeListener):
    LOOK_AND_FEEL_NAME: unicode = u'Swing Look And Feel'
