...
class AbstractLeb128DataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic):
    MAX_LEB128_ENCODED_VALUE_LEN: int = 8



    def __init__(self, __a0: unicode, __a1: bool, __a2: ghidra.program.model.data.DataTypeManager): ...
