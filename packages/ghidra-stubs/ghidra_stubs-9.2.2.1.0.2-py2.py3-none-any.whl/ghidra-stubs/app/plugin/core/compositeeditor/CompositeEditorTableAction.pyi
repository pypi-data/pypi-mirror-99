...
class CompositeEditorTableAction(docking.action.DockingAction, ghidra.app.plugin.core.compositeeditor.EditorAction):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider, __a1: unicode, __a2: unicode, __a3: List[unicode], __a4: List[unicode], __a5: javax.swing.ImageIcon): ...
