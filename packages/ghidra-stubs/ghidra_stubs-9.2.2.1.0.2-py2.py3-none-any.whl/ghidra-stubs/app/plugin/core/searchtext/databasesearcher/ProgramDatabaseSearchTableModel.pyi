...
class ProgramDatabaseSearchTableModel(ghidra.app.plugin.core.searchtext.AbstractSearchTableModel):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.address.AddressSetView, __a3: ghidra.app.plugin.core.searchtext.SearchOptions): ...
    ...
    def getSearcher(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.searchtext.Searcher: ...
