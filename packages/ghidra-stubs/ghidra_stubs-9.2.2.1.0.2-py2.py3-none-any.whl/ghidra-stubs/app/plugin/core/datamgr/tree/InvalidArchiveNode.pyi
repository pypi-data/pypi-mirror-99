...
class InvalidArchiveNode(ghidra.app.plugin.core.datamgr.tree.ArchiveNode):




    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.archive.InvalidFileArchive): ...
