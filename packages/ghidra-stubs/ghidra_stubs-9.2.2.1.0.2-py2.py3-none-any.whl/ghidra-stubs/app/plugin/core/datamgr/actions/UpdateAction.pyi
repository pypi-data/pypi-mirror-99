...
class UpdateAction(ghidra.app.plugin.core.datamgr.actions.SyncAction):
    MENU_NAME: unicode = u'Update Datatypes From'
    ...
    @overload
    def compareTo(self, __a0: ghidra.app.plugin.core.datamgr.actions.SyncAction) -> int: ...
