...
class FunctionEditorDialog(docking.DialogComponentProvider, ghidra.app.plugin.core.function.editor.ModelChangeListener):




    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.function.editor.FunctionEditorModel): ...
