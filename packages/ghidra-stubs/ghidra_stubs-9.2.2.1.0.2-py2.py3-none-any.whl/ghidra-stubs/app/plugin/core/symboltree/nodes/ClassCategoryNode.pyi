...
class ClassCategoryNode(ghidra.app.plugin.core.symboltree.nodes.SymbolCategoryNode):
    CLOSED_FOLDER_CLASSES_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/9.2.2/x64/Ghidra/Features/Base/lib/Base.jar!/images/closedFolderClasses.png
    OPEN_FOLDER_CLASSES_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/9.2.2/x64/Ghidra/Features/Base/lib/Base.jar!/images/openFolderClasses.png
