...
class StringDataInstanceColumnConstraint(object, docking.widgets.table.constraint.ColumnConstraint):
    ...
    @property
    def columnType(self) -> java.lang.Class: ...

    @property
    def constraintValueString(self) -> unicode: ...

    @property
    def constraintValueTooltip(self) -> unicode: ...
