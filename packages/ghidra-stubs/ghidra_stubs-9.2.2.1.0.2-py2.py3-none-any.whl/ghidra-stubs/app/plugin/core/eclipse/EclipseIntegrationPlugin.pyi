...
class EclipseIntegrationPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.app.services.EclipseIntegrationService):
    ...
    def connectToEclipse(self, __a0: int) -> ghidra.app.plugin.core.eclipse.EclipseConnection: ...
    ...
    def handleEclipseError(self, __a0: unicode, __a1: bool, __a2: java.lang.Throwable) -> None: ...
    ...
    def isEclipseFeatureInstalled(self, __a0: java.io.FilenameFilter) -> bool: ...

    def notify(self) -> None: ...

    def notifyAll(self) -> None: ...

    def offerGhidraDevInstallation(self, __a0: ghidra.util.task.TaskMonitor) -> None: ...
