...
class SpacecurveRasterPanel(javax.swing.JPanel):




    def __init__(self, __a0: java.awt.image.IndexColorModel): ...
    ...
    def setColorModel(self, __a0: java.awt.image.IndexColorModel) -> None: ...
    ...
    def setRaster(self, __a0: List[int], __a1: int, __a2: int) -> None: ...
    ...
    @property
    def colorModel(self) -> None: ...  # No getter available.

    @colorModel.setter
    def colorModel(self, value: java.awt.image.IndexColorModel) -> None: ...