...
class PowerPCAddressAnalyzer(ghidra.app.plugin.core.analysis.ConstantPropagationAnalyzer):
    ...
    def flowConstants(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.address.AddressSetView, __a3: ghidra.program.util.SymbolicPropogator, __a4: ghidra.util.task.TaskMonitor) -> ghidra.program.model.address.AddressSet: ...
