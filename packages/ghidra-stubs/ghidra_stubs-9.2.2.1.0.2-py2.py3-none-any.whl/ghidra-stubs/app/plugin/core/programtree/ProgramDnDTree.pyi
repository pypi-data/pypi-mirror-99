...
class ProgramDnDTree(ghidra.app.plugin.core.programtree.DragNDropTree):




    def __init__(self, __a0: unicode, __a1: javax.swing.tree.DefaultTreeModel, __a2: ghidra.app.plugin.core.programtree.ProgramTreePlugin): ...
    ...
    @property
    def mouseListeners(self) -> List[java.awt.event.MouseListener]: ...
