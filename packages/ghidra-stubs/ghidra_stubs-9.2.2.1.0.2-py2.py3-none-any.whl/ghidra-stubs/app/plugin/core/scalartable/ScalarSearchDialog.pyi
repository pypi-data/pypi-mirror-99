...
class ScalarSearchDialog(docking.DialogComponentProvider):
    ...
    def setFilterValues(self, __a0: long, __a1: long) -> None: ...
    ...
    def setSearchAScalar(self) -> None: ...

    def setSpecificScalarValue(self, __a0: int) -> None: ...
    ...
    @property
    def specificScalarValue(self) -> None: ...  # No getter available.

    @specificScalarValue.setter
    def specificScalarValue(self, value: int) -> None: ...