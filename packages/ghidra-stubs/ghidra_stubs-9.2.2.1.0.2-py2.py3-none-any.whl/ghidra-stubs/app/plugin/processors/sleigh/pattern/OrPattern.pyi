...
class OrPattern(ghidra.app.plugin.processors.sleigh.pattern.Pattern):
    """
    ...
    @overload
    def __init__(self, a: ghidra.app.plugin.processors.sleigh.pattern.DisjointPattern, b: ghidra.app.plugin.processors.sleigh.pattern.DisjointPattern): ...
