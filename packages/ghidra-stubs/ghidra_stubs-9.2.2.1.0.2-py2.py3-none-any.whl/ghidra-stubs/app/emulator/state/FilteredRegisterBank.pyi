...
class FilteredRegisterBank(ghidra.pcode.memstate.MemoryPageBank):
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, ps: int, initState: ghidra.app.emulator.state.RegisterState, lang: ghidra.program.model.lang.Language, writeBack: bool, faultHandler: ghidra.pcode.memstate.MemoryFaultHandler): ...
