...
class ProgramLocationColumnTypeMapper(docking.widgets.table.constraint.ColumnTypeMapper):
    """
    ...
    @overload
    def convert(self, location: ghidra.program.util.ProgramLocation) -> ghidra.program.model.address.Address: ...
