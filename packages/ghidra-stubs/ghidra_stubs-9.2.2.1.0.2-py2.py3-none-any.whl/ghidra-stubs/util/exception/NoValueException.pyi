...
class NoValueException(ghidra.util.exception.UsrException):
    """
    Exception thrown if there is no value at a
     requested index.
    """

    noValueException: ghidra.util.exception.NoValueException = ghidra.util.exception.NoValueException: There is no value for the given index.
