...
class ReferenceTypeTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    """
    ...
    @overload
    def getProgramLocation(self, rowObject: ghidra.program.model.symbol.Reference, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.util.ProgramLocation: ...
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.model.symbol.Reference, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.symbol.RefType: ...
