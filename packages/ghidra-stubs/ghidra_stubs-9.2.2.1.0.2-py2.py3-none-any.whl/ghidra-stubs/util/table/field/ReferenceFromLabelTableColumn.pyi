...
class ReferenceFromLabelTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    """
    ...
    @overload
    def getValue(self, rowObject: ghidra.app.plugin.core.analysis.ReferenceAddressPair, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> unicode: ...
