...
class ObjectPropertyMapDB(ghidra.program.database.properties.PropertyMapDB, ghidra.program.model.util.ObjectPropertyMap):
    """
    ...
    def __init__(self, dbHandle: db.DBHandle, openMode: int, errHandler: db.util.ErrorHandler, changeMgr: ghidra.program.util.ChangeManager, addrMap: ghidra.program.database.map.AddressMap, name: unicode, saveableObjectClass: java.lang.Class, monitor: ghidra.util.task.TaskMonitor, supportsPrivate: bool):
        """
    ...
    def add(self, addr: ghidra.program.model.address.Address, value: ghidra.util.Saveable) -> None: ...
    ...
    @staticmethod
    def getSaveableClassForName(classPath: unicode) -> java.lang.Class:
        """
    ...
    @property
    def objectClass(self) -> java.lang.Class: ...