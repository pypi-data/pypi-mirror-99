...
class ProjectDataTypeManager(ghidra.program.database.data.DataTypeManagerDB, ghidra.program.model.data.ProjectArchiveBasedDataTypeManager):
    """
    ...
    def __init__(self, handle: db.DBHandle, openMode: int, errHandler: db.util.ErrorHandler, lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor):
        """
        Constructor
    ...
    def setDataTypeArchive(self, dtArchive: ghidra.program.database.DataTypeArchiveDB) -> None:
        """
    ...
    @property
    def dataTypeArchive(self) -> None: ...  # No getter available.

    @dataTypeArchive.setter
    def dataTypeArchive(self, value: ghidra.program.database.DataTypeArchiveDB) -> None: ...
