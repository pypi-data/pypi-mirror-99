...
class AutoParameterImpl(ghidra.program.model.listing.ParameterImpl):




    def __init__(self, dataType: ghidra.program.model.data.DataType, ordinal: int, storage: ghidra.program.model.listing.VariableStorage, function: ghidra.program.model.listing.Function): ...
