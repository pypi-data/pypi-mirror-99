...
class LongDoubleComplexDataType(ghidra.program.model.data.AbstractComplexDataType):
    """
    Provides a definition of a  built-in data type consisting of two LongDouble
    ...
    dataType: ghidra.program.model.data.LongDoubleComplexDataType = longdoublecomplex
