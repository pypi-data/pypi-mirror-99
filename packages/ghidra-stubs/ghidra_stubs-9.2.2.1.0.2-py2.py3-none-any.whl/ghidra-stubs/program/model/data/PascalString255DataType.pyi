...
class PascalString255DataType(ghidra.program.model.data.AbstractStringDataType):
    """
    A length-prefixed string DataType (max 255 bytes) with char size of 1 byte,
     user setable CharsetSettingsDefinition (default ASCII),
     unbounded (ignores containing field size, relies on embedded length value).
 
    """

    dataType: ghidra.program.model.data.PascalString255DataType = PascalString255
    ...
    @overload
    def copy(self, retainIdentity: bool) -> ghidra.program.model.data.DataType: ...
