...
class AlignmentDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic):
    ...
    @overload
    def getLength(self, buf: ghidra.program.model.mem.MemBuffer, length: int) -> int: ...
