...
class TerminatedStringDataType(ghidra.program.model.data.AbstractStringDataType):
    """
    ...
    dataType: ghidra.program.model.data.TerminatedStringDataType = TerminatedCString
