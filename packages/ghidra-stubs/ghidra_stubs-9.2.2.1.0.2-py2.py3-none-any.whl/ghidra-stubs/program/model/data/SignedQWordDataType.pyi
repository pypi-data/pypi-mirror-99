...
class SignedQWordDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Provides a definition of a Signed Quad Word within a program.
    """

    dataType: ghidra.program.model.data.SignedQWordDataType = sqword
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.SignedQWordDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.QWordDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.QWordDataType: ...