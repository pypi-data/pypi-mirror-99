...
class UnsignedIntegerDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Basic implementation for an unsigned Integer dataType
    """

    dataType: ghidra.program.model.data.UnsignedIntegerDataType = uint
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedIntegerDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.IntegerDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.IntegerDataType: ...