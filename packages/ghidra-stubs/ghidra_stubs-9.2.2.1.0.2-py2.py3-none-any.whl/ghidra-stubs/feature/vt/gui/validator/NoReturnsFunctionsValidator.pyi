...
class NoReturnsFunctionsValidator(ghidra.feature.vt.gui.validator.VTPreconditionValidator):
    DIFFERENCE_THRESHOLD: unicode = u'Maximum percentage difference between number of no-return functions in each program'
    DIFFERENCE_THRESHOLD_DEFAULT: float = 0.0
