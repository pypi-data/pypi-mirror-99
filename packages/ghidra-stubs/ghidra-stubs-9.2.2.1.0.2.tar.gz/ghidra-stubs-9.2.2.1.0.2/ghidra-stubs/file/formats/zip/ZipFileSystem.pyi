...
class ZipFileSystem(object, ghidra.formats.gfilesystem.GFileSystem):




    def __init__(self, __a0: ghidra.formats.gfilesystem.FSRLRoot): ...
    ...
    def getInfoMap(self, __a0: java.util.zip.ZipEntry) -> java.util.Map: ...
    ...
    def mount(self, __a0: java.io.File, __a1: ghidra.util.task.TaskMonitor) -> None: ...
