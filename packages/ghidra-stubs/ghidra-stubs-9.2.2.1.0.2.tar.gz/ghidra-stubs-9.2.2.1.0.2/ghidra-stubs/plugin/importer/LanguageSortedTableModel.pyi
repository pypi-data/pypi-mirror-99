...
class LanguageSortedTableModel(docking.widgets.table.AbstractSortedTableModel):
    ...
    @overload
    def getColumnValueForRow(self, pair: ghidra.program.model.lang.LanguageCompilerSpecPair, column: int) -> object: ...
    ...
    def getLcsPairAtRow(self, selectedRow: int) -> ghidra.program.model.lang.LanguageCompilerSpecPair: ...

    def getListeners(self, __a0: java.lang.Class) -> List[java.util.EventListener]: ...

    def getModelData(self) -> List[ghidra.program.model.lang.LanguageCompilerSpecPair]: ...
