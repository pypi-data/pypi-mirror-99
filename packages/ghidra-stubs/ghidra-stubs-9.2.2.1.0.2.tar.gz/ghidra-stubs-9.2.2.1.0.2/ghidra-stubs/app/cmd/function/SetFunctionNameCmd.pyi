...
class SetFunctionNameCmd(object, ghidra.framework.cmd.Command):
    """
    ...
    def __init__(self, entry: ghidra.program.model.address.Address, newName: unicode, source: ghidra.program.model.symbol.SourceType):
        """
