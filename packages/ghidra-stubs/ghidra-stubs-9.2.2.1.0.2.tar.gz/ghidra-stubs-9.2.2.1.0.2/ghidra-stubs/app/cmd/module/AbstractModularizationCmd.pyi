...
class AbstractModularizationCmd(ghidra.framework.cmd.BackgroundCommand):




    def __init__(self, name: unicode, path: ghidra.program.util.GroupPath, treeName: unicode, selection: ghidra.program.util.ProgramSelection, blockModel: ghidra.program.model.block.CodeBlockModel): ...
