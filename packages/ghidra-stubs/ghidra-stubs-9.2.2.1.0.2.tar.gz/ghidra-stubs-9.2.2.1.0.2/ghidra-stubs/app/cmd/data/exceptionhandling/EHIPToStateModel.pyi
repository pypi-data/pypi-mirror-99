...
class EHIPToStateModel(ghidra.app.cmd.data.AbstractCreateDataTypeModel):
    DATA_TYPE_NAME: unicode = u'IPToStateMapEntry'
    ...
    def getComponentAddressOfIPAddress(self, __a0: int) -> ghidra.program.model.address.Address: ...
    ...
    def getIP(self, __a0: int) -> object: ...

    def getName(self) -> unicode: ...

    def getProgram(self) -> ghidra.program.model.listing.Program: ...

    def getState(self, __a0: int) -> int: ...
