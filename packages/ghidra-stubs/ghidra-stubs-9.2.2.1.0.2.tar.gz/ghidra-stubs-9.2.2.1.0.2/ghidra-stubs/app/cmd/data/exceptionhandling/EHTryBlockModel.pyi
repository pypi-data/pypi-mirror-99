...
class EHTryBlockModel(ghidra.app.cmd.data.AbstractCreateDataTypeModel):
    DATA_TYPE_NAME: unicode
    ...
    def getCatchHandlerCount(self, __a0: int) -> int: ...

    def getCatchHandlerMapAddress(self, __a0: int) -> ghidra.program.model.address.Address: ...

    def getCatchHandlerModel(self, __a0: int) -> ghidra.app.cmd.data.exceptionhandling.EHCatchHandlerModel: ...

    def getCatchHigh(self, __a0: int) -> int: ...

    def getClass(self) -> java.lang.Class: ...

    def getComponentAddressOfCatchHandlerMapAddress(self, __a0: int) -> ghidra.program.model.address.Address: ...
    ...
    def getTryHigh(self, __a0: int) -> int: ...

    def getTryLow(self, __a0: int) -> int: ...
