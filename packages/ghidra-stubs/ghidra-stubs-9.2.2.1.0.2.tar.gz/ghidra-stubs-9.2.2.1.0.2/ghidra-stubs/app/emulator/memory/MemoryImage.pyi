...
class MemoryImage(ghidra.pcode.memstate.MemoryBank):
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, isBigEndian: bool, ps: int, ld: ghidra.app.emulator.memory.MemoryLoadImage, faultHandler: ghidra.pcode.memstate.MemoryFaultHandler): ...
    ...
    def getPage(self, addr: long) -> ghidra.pcode.memstate.MemoryPage: ...
