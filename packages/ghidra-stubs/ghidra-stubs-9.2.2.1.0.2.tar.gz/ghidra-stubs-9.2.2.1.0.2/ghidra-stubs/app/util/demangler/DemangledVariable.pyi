...
class DemangledVariable(ghidra.app.util.demangler.DemangledObject):
    """
    ...
    def getDataType(self) -> ghidra.app.util.demangler.DemangledDataType:
        """
    ...
    def setDatatype(self, datatype: ghidra.app.util.demangler.DemangledDataType) -> None: ...
    ...
    @property
    def dataType(self) -> ghidra.app.util.demangler.DemangledDataType: ...

    @property
    def datatype(self) -> None: ...  # No getter available.

    @datatype.setter
    def datatype(self, value: ghidra.app.util.demangler.DemangledDataType) -> None: ...
