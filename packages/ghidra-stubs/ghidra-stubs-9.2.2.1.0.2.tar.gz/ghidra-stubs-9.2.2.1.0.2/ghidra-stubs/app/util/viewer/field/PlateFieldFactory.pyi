...
class PlateFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, hsProvider: ghidra.app.util.HighlightProvider, toolOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
