...
class ArrayValuesFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    FIELD_NAME: unicode = u'Array Values'
    ...
    def getFieldLocation(self, lf: ghidra.app.util.viewer.field.ListingField, index: long, fieldNum: int, location: ghidra.program.util.ProgramLocation) -> docking.widgets.fieldpanel.support.FieldLocation: ...
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, highlightProvider: ghidra.app.util.HighlightProvider, toolOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
