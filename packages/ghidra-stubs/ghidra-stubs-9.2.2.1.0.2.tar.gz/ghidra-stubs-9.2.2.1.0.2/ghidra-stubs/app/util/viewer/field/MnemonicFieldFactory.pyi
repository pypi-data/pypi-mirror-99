...
class MnemonicFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates Mnemonic Fields.
    """

    FIELD_NAME: unicode = u'Mnemonic'
    OVERRIDE_COLOR: java.awt.Color = java.awt.Color[r=180,g=0,b=108]
