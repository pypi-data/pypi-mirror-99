...
class DimensionedArrayConstBoundsLowerUpper16MsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractDimensionedArrayConstBoundsLowerUpperMsType):
    PDB_ID: int = 521
