...
class CliTableFieldRVA(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliFieldRVARow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        fieldIndex: int
        rva: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableFieldRVA, __a1: int, __a2: int): ...
