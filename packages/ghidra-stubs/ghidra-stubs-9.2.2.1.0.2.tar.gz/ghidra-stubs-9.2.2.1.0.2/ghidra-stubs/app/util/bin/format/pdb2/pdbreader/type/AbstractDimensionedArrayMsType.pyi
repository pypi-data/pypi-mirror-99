...
class AbstractDimensionedArrayMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    ...
    def getDimensionInformation(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType: ...

    def getDimensionInformationRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...
    ...
    @property
    def dimensionInformation(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType: ...

    @property
    def dimensionInformationRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...
