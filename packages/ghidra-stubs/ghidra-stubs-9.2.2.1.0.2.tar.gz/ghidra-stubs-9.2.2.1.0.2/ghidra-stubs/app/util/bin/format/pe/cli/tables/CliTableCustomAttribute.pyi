...
class CliTableCustomAttribute(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliCustomAttributeRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        parentIndex: int
        typeIndex: int
        valueIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableCustomAttribute, __a1: int, __a2: int, __a3: int): ...
