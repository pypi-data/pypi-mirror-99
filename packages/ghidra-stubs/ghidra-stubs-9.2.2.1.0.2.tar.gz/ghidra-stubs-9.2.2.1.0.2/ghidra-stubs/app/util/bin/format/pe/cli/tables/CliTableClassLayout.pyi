...
class CliTableClassLayout(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliClassLayoutRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        classSize: int
        packingSize: int
        parentIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableClassLayout, __a1: int, __a2: int, __a3: int): ...
