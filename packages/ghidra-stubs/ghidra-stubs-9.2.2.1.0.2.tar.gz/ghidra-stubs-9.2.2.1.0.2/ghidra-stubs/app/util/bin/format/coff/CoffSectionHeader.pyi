...
class CoffSectionHeader(object, ghidra.app.util.bin.StructConverter):
    """
    ...
    @property
    def explicitlyByteAligned(self) -> bool: ...
    ...
    @property
    def initializedData(self) -> bool: ...

    @property
    def lineNumberCount(self) -> int: ...

    @property
    def lineNumbers(self) -> List[object]: ...
    ...
    @property
    def uninitializedData(self) -> bool: ...
