...
class CliTableFieldLayout(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliFieldLayoutRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        fieldIndex: int
        offset: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableFieldLayout, __a1: int, __a2: int): ...
