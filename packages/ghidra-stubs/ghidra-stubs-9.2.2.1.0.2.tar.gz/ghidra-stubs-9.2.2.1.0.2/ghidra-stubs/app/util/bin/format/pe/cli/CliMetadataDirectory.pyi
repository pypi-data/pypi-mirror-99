...
class CliMetadataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    """
    ...
    @staticmethod
    def createCliMetadataDirectory(ntHeader: ghidra.app.util.bin.format.pe.NTHeader, reader: ghidra.app.util.bin.format.FactoryBundledWithBinaryReader) -> ghidra.app.util.bin.format.pe.cli.CliMetadataDirectory: ...
