...
class CliTableAssemblyRef(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliAssemblyRefRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        buildNumber: int
        cultureIndex: int
        flags: int
        hashValueIndex: int
        ...
        minorVersion: int
        nameIndex: int
        publicKeyOrTokenIndex: int
        revisionNumber: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableAssemblyRef, __a1: int, __a2: int, __a3: int, __a4: int, __a5: int, __a6: int, __a7: int, __a8: int, __a9: int): ...
