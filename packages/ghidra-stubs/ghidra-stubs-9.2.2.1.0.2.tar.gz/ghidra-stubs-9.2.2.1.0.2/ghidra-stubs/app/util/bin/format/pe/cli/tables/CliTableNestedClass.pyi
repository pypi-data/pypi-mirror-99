...
class CliTableNestedClass(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliNestedClassRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        enclosingClassIndex: int
        nestedClassIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableNestedClass, __a1: int, __a2: int): ...
