...
class CliTableEvent(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliEventRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        eventFlags: int
        eventTypeIndex: int
        nameIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableEvent, __a1: int, __a2: int, __a3: int): ...
