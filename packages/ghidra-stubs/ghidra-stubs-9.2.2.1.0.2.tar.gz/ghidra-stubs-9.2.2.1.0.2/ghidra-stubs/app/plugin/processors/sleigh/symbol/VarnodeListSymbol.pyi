...
class VarnodeListSymbol(ghidra.app.plugin.processors.sleigh.symbol.ValueSymbol):
    """
    ...
    def getVarnodeTable(self) -> java.util.Collection: ...
    ...
    @property
    def varnodeTable(self) -> java.util.Collection: ...