...
import docking.widgets.textarea
import java.awt
import java.awt.dnd
...
class HintTextAreaIS(docking.widgets.textarea.HintTextArea):
    ...
    def getLineEndOffset(self, __a0: int) -> int: ...

    def getLineOfOffset(self, __a0: int) -> int: ...

    def getLineStartOffset(self, __a0: int) -> int: ...

    def getLineWrap(self) -> bool: ...
    ...
    def getWrapStyleWord(self) -> bool: ...
    ...
    def insert(self, __a0: unicode, __a1: int) -> None: ...
    ...
    def replaceRange(self, __a0: unicode, __a1: int, __a2: int) -> None: ...
    ...
    def setLineWrap(self, __a0: bool) -> None: ...
    ...
    def setRows(self, __a0: int) -> None: ...
    ...
    def setTabSize(self, __a0: int) -> None: ...
    ...
    def setWrapStyleWord(self, __a0: bool) -> None: ...
