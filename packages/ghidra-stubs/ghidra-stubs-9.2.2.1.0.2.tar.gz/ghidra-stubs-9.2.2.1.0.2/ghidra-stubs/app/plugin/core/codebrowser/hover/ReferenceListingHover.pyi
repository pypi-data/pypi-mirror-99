...
class ReferenceListingHover(ghidra.app.plugin.core.hover.AbstractReferenceHover, ghidra.app.plugin.core.codebrowser.hover.ListingHoverService):
    ...
    @overload
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.services.CodeFormatService): ...
