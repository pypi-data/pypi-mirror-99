...
class FunctionComparisonPanel(javax.swing.JPanel, javax.swing.event.ChangeListener):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.ComponentProviderAdapter, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.program.model.listing.Function, __a3: ghidra.program.model.listing.Function): ...
    ...
    def getActionContext(self, __a0: java.awt.event.MouseEvent, __a1: docking.ComponentProvider) -> docking.ActionContext: ...
    ...
    def getComparisonPanels(self) -> List[object]: ...
    ...
    def getDisplayedPanel(self) -> ghidra.app.util.viewer.util.CodeComparisonPanel: ...

    def getDropTarget(self) -> java.awt.dnd.DropTarget: ...

    def getDualListingPanel(self) -> ghidra.app.util.viewer.listingpanel.ListingCodeComparisonPanel: ...
    ...
    def getLeftComparisonData(self) -> ghidra.app.plugin.core.functioncompare.FunctionComparisonData: ...
    ...
    def getRightComparisonData(self) -> ghidra.app.plugin.core.functioncompare.FunctionComparisonData: ...
    ...
    def readConfigState(self, __a0: unicode, __a1: ghidra.framework.options.SaveState) -> None: ...
    ...
    def setCurrentTabbedComponent(self, __a0: unicode) -> bool: ...
    ...
    def writeConfigState(self, __a0: unicode, __a1: ghidra.framework.options.SaveState) -> None: ...
    ...
    @property
    def displayedPanel(self) -> ghidra.app.util.viewer.util.CodeComparisonPanel: ...

    @property
    def dualListingPanel(self) -> ghidra.app.util.viewer.listingpanel.ListingCodeComparisonPanel: ...

    @property
    def empty(self) -> bool: ...

    @property
    def leftComparisonData(self) -> ghidra.app.plugin.core.functioncompare.FunctionComparisonData: ...
    ...
    @property
    def rightComparisonData(self) -> ghidra.app.plugin.core.functioncompare.FunctionComparisonData: ...
