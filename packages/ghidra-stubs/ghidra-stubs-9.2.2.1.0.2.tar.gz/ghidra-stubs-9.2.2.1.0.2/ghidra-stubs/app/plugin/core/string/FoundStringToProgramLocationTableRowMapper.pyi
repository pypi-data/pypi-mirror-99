...
class FoundStringToProgramLocationTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    ...
    @overload
    def map(self, __a0: ghidra.program.util.string.FoundString, __a1: ghidra.program.model.listing.Program, __a2: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.util.ProgramLocation: ...
