...
class ThunkReferenceAddressDialog(docking.DialogComponentProvider):
    ...
    @overload
    def showDialog(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.address.Address) -> None: ...

    @overload
    def showDialog(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.symbol.Symbol) -> None: ...
