...
class FGEdgeImpl(object, ghidra.app.plugin.core.functiongraph.graph.FGEdge):
    ...
    @overload
    def cloneEdge(self, __a0: ghidra.app.plugin.core.functiongraph.graph.vertex.FGVertex, __a1: ghidra.app.plugin.core.functiongraph.graph.vertex.FGVertex) -> ghidra.app.plugin.core.functiongraph.graph.FGEdgeImpl: ...
