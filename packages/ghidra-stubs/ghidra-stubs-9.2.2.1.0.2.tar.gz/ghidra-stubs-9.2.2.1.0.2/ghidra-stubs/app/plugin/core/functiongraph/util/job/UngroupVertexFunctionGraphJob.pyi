...
class UngroupVertexFunctionGraphJob(ghidra.app.plugin.core.functiongraph.util.job.AbstractGroupingFunctionGraphJob):




    def __init__(self, __a0: ghidra.app.plugin.core.functiongraph.mvc.FGController, __a1: ghidra.app.plugin.core.functiongraph.graph.vertex.GroupedFunctionGraphVertex, __a2: bool, __a3: bool): ...
