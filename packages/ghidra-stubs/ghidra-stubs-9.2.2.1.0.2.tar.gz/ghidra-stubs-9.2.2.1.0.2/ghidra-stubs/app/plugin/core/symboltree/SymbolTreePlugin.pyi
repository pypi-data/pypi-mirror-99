...
class SymbolTreePlugin(ghidra.framework.plugintool.Plugin):
    PLUGIN_NAME: unicode = u'SymbolTreePlugin'
    ...
    @overload
    def goTo(self, __a0: ghidra.program.model.symbol.ExternalLocation) -> None: ...

    @overload
    def goTo(self, __a0: ghidra.program.model.symbol.Symbol) -> None: ...
