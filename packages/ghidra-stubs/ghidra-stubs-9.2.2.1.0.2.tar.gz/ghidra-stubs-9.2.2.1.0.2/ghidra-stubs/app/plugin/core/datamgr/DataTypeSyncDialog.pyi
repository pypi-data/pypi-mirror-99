...
class DataTypeSyncDialog(docking.DialogComponentProvider, ghidra.app.plugin.core.datamgr.DataTypeSyncListener):




    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, __a1: unicode, __a2: unicode, __a3: List[object], __a4: java.util.Set, __a5: unicode, __a6: unicode): ...
    ...
    def dataTypeSelected(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeSyncInfo) -> None: ...
    ...
    def getSelectedInfos(self) -> List[object]: ...
    ...
    @property
    def selectedInfos(self) -> List[object]: ...