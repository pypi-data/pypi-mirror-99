...
class SymbolRowObjectToAddressTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    ...
    @overload
    def map(self, __a0: ghidra.program.model.symbol.Symbol, __a1: ghidra.program.model.listing.Program, __a2: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.address.Address: ...
