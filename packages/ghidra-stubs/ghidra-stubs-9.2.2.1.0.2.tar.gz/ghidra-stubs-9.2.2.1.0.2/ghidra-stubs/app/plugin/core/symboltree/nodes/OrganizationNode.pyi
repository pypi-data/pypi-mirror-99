...
class OrganizationNode(ghidra.app.plugin.core.symboltree.nodes.SymbolTreeNode):
    ...
    def insertNode(self, __a0: docking.widgets.tree.GTreeNode) -> None: ...
    ...
    @staticmethod
    def organize(__a0: List[object], __a1: int, __a2: ghidra.util.task.TaskMonitor) -> List[object]: ...
