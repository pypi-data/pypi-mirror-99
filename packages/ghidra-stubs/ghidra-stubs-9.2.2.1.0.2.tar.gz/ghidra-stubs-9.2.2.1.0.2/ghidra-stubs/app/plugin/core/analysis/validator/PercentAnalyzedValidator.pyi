...
class PercentAnalyzedValidator(ghidra.app.plugin.core.analysis.validator.PostAnalysisValidator):
    COVERAGE_THRESHOLD: unicode = u'Minimum analysis coverage threshold'
    COVERAGE_THRESHOLD_DEFAULT: float = 0.75
