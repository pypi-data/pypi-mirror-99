...
class ConvertCommand(ghidra.framework.cmd.BackgroundCommand):




    def __init__(self, __a0: ghidra.app.plugin.core.equate.AbstractConvertAction, __a1: ghidra.app.context.ListingActionContext): ...
