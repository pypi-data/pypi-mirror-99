...
class LocalVariableStringable(ghidra.feature.vt.api.util.Stringable):
    SHORT_NAME: unicode = u'LOCAL'
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Variable): ...
    ...
    def getLocalVariable(self, __a0: ghidra.program.model.listing.Function, __a1: ghidra.program.model.address.Address) -> ghidra.program.model.listing.Variable: ...
