...
class AddressEditorPanel(javax.swing.JPanel):
    ...
    def setAddressPanelListener(self, __a0: ghidra.feature.vt.gui.editors.AddressEditorPanelListener) -> None: ...
    ...
    @property
    def addressPanelListener(self) -> None: ...  # No getter available.

    @addressPanelListener.setter
    def addressPanelListener(self, value: ghidra.feature.vt.gui.editors.AddressEditorPanelListener) -> None: ...