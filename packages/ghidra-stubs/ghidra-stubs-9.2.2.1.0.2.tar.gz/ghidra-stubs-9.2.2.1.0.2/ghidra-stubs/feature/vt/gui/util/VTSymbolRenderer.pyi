...
class VTSymbolRenderer(ghidra.util.table.GhidraTableCellRenderer):




    def __init__(self, __a0: ghidra.framework.plugintool.ServiceProvider, __a1: javax.swing.JComponent): ...
