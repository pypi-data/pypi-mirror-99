...
class VisualGraphSatelliteScalingGraphMousePlugin(edu.uci.ics.jung.visualization.control.SatelliteScalingGraphMousePlugin, ghidra.graph.viewer.event.mouse.VisualGraphMousePlugin):
