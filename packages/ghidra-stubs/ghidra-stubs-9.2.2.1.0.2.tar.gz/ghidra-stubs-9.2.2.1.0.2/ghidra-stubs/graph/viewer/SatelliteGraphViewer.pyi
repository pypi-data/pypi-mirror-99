...
class SatelliteGraphViewer(edu.uci.ics.jung.visualization.control.SatelliteVisualizationViewer):
    """
    ...
    def __init__(self, master: ghidra.graph.viewer.GraphViewer, preferredSize: java.awt.Dimension): ...
    ...
    def addGraphMouseListener(self, __a0: edu.uci.ics.jung.visualization.control.GraphMouseListener) -> None: ...
    ...
    def addPostRenderPaintable(self, __a0: edu.uci.ics.jung.visualization.VisualizationServer.Paintable) -> None: ...

    def addPreRenderPaintable(self, __a0: edu.uci.ics.jung.visualization.VisualizationServer.Paintable) -> None: ...
    ...
    def fireStateChanged(self) -> None: ...
    ...
    def getCenter(self) -> java.awt.geom.Point2D: ...
    ...
    def getGraphLayout(self) -> edu.uci.ics.jung.algorithms.layout.Layout: ...

    def getGraphMouse(self) -> ghidra.graph.viewer.event.mouse.VisualGraphPluggableGraphMouse: ...
    ...
    def getMaster(self) -> edu.uci.ics.jung.visualization.VisualizationViewer: ...

    def getMaximumSize(self) -> java.awt.Dimension: ...

    def getMinimumSize(self) -> java.awt.Dimension: ...

    def getModel(self) -> edu.uci.ics.jung.visualization.VisualizationModel: ...
    ...
    def getPickSupport(self) -> edu.uci.ics.jung.algorithms.layout.GraphElementAccessor: ...

    def getPickedEdgeState(self) -> edu.uci.ics.jung.visualization.picking.PickedState: ...

    def getPickedVertexState(self) -> edu.uci.ics.jung.visualization.picking.PickedState: ...

    def getPopupLocation(self, __a0: java.awt.event.MouseEvent) -> java.awt.Point: ...

    def getPreferredSize(self) -> java.awt.Dimension: ...

    def getPreferredVertexRenderer(self) -> edu.uci.ics.jung.visualization.renderers.Renderer.Vertex:
        """
    ...
    def getRenderer(self) -> edu.uci.ics.jung.visualization.renderers.Renderer: ...

    def getRenderingHints(self) -> java.util.Map: ...
    ...
    def prependPostRenderPaintable(self, __a0: edu.uci.ics.jung.visualization.VisualizationServer.Paintable) -> None: ...

    def prependPreRenderPaintable(self, __a0: edu.uci.ics.jung.visualization.VisualizationServer.Paintable) -> None: ...
    ...
    def removePostRenderPaintable(self, __a0: edu.uci.ics.jung.visualization.VisualizationServer.Paintable) -> None: ...

    def removePreRenderPaintable(self, __a0: edu.uci.ics.jung.visualization.VisualizationServer.Paintable) -> None: ...
    ...
    def scaleToLayout(self, __a0: edu.uci.ics.jung.visualization.control.ScalingControl) -> None: ...
    ...
    def setDocked(self, docked: bool) -> None:
        """
    ...
    def setEdgeToolTipTransformer(self, __a0: com.google.common.base.Function) -> None: ...
    ...
    def setGraphLayout(self, __a0: edu.uci.ics.jung.algorithms.layout.Layout) -> None: ...

    def setGraphMouse(self, graphMouse: edu.uci.ics.jung.visualization.VisualizationViewer.GraphMouse) -> None: ...
    ...
    def setModel(self, __a0: edu.uci.ics.jung.visualization.VisualizationModel) -> None: ...

    def setMouseEventToolTipTransformer(self, __a0: com.google.common.base.Function) -> None: ...
    ...
    def setPickSupport(self, __a0: edu.uci.ics.jung.algorithms.layout.GraphElementAccessor) -> None: ...

    def setPickedEdgeState(self, __a0: edu.uci.ics.jung.visualization.picking.PickedState) -> None: ...

    def setPickedVertexState(self, __a0: edu.uci.ics.jung.visualization.picking.PickedState) -> None: ...

    def setPreferredSize(self, __a0: java.awt.Dimension) -> None: ...

    def setRenderContext(self, __a0: edu.uci.ics.jung.visualization.RenderContext) -> None: ...

    def setRenderer(self, __a0: edu.uci.ics.jung.visualization.renderers.Renderer) -> None: ...

    def setRenderingHints(self, __a0: java.util.Map) -> None: ...
    ...
    def setVertexToolTipTransformer(self, __a0: com.google.common.base.Function) -> None: ...
    ...
    @docked.setter
    def docked(self, value: bool) -> None: ...

    @property
    def graphMouse(self) -> ghidra.graph.viewer.event.mouse.VisualGraphPluggableGraphMouse: ...

    @property
    def preferredVertexRenderer(self) -> edu.uci.ics.jung.visualization.renderers.Renderer.Vertex: ...