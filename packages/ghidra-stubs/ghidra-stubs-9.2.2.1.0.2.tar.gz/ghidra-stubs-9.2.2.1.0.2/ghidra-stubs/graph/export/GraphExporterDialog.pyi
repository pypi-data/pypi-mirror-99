...
class GraphExporterDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, __a0: org.jgrapht.Graph): ...
    ...
    def setExportFormat(self, __a0: ghidra.graph.export.GraphExportFormat) -> None: ...
    ...
    @property
    def exportFormat(self) -> None: ...  # No getter available.

    @exportFormat.setter
    def exportFormat(self, value: ghidra.graph.export.GraphExportFormat) -> None: ...
