...
class QWordDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Provides a definition of a Quad Word within a program.
    """

    dataType: ghidra.program.model.data.QWordDataType = qword
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.QWordDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.SignedQWordDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.SignedQWordDataType: ...