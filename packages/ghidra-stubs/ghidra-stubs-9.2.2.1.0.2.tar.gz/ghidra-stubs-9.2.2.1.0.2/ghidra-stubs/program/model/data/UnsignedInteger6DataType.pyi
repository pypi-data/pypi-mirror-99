...
class UnsignedInteger6DataType(ghidra.program.model.data.AbstractIntegerDataType):
    dataType: ghidra.program.model.data.UnsignedInteger6DataType = uint6
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedInteger6DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.Integer6DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.Integer6DataType: ...