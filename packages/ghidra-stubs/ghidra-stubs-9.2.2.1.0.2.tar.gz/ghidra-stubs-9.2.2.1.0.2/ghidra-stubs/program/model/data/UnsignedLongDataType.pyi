...
class UnsignedLongDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Basic implementation for a Signed Long Integer dataType
    """

    dataType: ghidra.program.model.data.UnsignedLongDataType = ulong
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedLongDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.LongDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.LongDataType: ...