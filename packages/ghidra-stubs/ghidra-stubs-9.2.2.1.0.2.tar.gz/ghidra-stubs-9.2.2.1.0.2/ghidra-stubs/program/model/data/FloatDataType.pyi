...
class FloatDataType(ghidra.program.model.data.AbstractFloatDataType):
    """
    Provides a definition of a Float within a program.
    """

    dataType: ghidra.program.model.data.FloatDataType = float
    ...
    @staticmethod
    def getFloatDataType(size: int, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.DataType:
        """
