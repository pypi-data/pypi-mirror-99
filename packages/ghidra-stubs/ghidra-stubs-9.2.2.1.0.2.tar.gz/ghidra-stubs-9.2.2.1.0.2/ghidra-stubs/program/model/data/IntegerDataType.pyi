...
class IntegerDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Basic implementation for an signed Integer dataType
    """

    dataType: ghidra.program.model.data.IntegerDataType = int
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.IntegerDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedIntegerDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedIntegerDataType: ...