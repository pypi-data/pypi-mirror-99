...
class HighFunctionSymbol(ghidra.program.model.pcode.HighSymbol):
    """
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, size: int, function: ghidra.program.model.pcode.HighFunction):
        """
