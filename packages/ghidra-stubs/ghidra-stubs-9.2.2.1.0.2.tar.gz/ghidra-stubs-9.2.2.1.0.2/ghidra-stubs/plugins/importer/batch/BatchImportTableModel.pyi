...
class BatchImportTableModel(docking.widgets.table.AbstractSortedTableModel):
    """
    An adapter between BatchInfo and a TableModel.
    """
    ...
    class COLS(java.lang.Enum):
        FILES: ghidra.plugins.importer.batch.BatchImportTableModel.COLS = FILES
        FILETYPE: ghidra.plugins.importer.batch.BatchImportTableModel.COLS = FILETYPE
        LANG: ghidra.plugins.importer.batch.BatchImportTableModel.COLS = LANG
        LOADER: ghidra.plugins.importer.batch.BatchImportTableModel.COLS = LOADER
        SELECTED: ghidra.plugins.importer.batch.BatchImportTableModel.COLS = SELECTED
        UNKNOWN_COLUMN_LABEL: unicode = u'<unknown>'
        columnLabel: unicode
        count: int = 5
        editable: bool
        ...
        @staticmethod
        def getCol(__a0: int) -> ghidra.plugins.importer.batch.BatchImportTableModel.COLS: ...

        @staticmethod
        def getColumnLabel(__a0: int) -> unicode: ...
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.plugins.importer.batch.BatchImportTableModel.COLS: ...
        ...
        @staticmethod
        def values() -> List[ghidra.plugins.importer.batch.BatchImportTableModel.COLS]: ...
    ...
    def getModelData(self) -> List[ghidra.plugins.importer.batch.BatchGroup]: ...
