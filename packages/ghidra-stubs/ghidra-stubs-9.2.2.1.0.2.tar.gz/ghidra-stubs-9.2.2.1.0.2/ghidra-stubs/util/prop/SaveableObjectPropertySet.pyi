...
class SaveableObjectPropertySet(ghidra.util.prop.PropertySet):
    """
    ...
    def getObject(self, index: long) -> ghidra.util.Saveable:
        """
    ...
    def putObject(self, index: long, value: ghidra.util.Saveable) -> None:
        """
