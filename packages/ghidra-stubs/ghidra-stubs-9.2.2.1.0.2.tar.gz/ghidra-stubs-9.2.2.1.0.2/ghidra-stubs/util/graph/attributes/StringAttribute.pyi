...
class StringAttribute(ghidra.util.graph.attributes.Attribute):
    """
    ...
    def getValue(self, o: ghidra.util.graph.KeyedObject) -> unicode:
        """
    ...
    def setValue(self, __a0: ghidra.util.graph.KeyedObject, __a1: unicode) -> bool: ...
