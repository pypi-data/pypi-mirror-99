...
class ObjectValueRange(object, java.lang.Comparable):
    """
    ...
    def __init__(self, start: long, end: long, value: object):
        """
    ...
    @overload
    def compareTo(self, otherRange: ghidra.util.datastruct.ObjectValueRange) -> int:
        """
