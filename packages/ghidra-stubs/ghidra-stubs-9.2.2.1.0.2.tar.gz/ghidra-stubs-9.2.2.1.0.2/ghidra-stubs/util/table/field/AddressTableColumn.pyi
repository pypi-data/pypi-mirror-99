...
class AddressTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    """
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.model.address.Address, settings: ghidra.docking.settings.Settings, pgm: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.util.table.field.AddressBasedLocation: ...
