...
class OutgoingReferenceEndpoint(ghidra.util.table.field.ReferenceEndpoint):
    """
    ...
    @overload
    def __init__(self, r: ghidra.program.model.symbol.Reference, toAddress: ghidra.program.model.address.Address, isOffcut: bool):
        """
