...
class ReferenceEndpointToReferenceTableRowMapper(docking.widgets.table.TableRowMapper):
    ...
    @overload
    def map(self, rowObject: ghidra.util.table.field.ReferenceEndpoint, data: ghidra.program.model.listing.Program, sp: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.symbol.Reference: ...
