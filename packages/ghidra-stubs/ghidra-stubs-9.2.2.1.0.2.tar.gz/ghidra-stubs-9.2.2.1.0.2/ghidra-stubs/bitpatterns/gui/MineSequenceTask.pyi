...
class MineSequenceTask(ghidra.util.task.Task):




    def __init__(self, __a0: ghidra.closedpatternmining.ClosedSequenceMiner): ...
    ...
    def getClosedSeqs(self) -> java.util.Set: ...
    ...
    @property
    def closedSeqs(self) -> java.util.Set: ...