...
class DisplayLexer_BaseLexer(ghidra.sleigh.grammar.AbstractSleighLexer):
    ALPHA: int = 4
    ALPHAUP: int = 5
    AMPERSAND: int = 6
    ASSIGN: int = 7
    ...
    UNKNOWN: int = 237
    WS: int = 238
    gDisplayLexer: ghidra.sleigh.grammar.DisplayLexer
    gParent: ghidra.sleigh.grammar.DisplayLexer
    ...
    @overload
    def __init__(self, input: org.antlr.runtime.CharStream, gDisplayLexer: ghidra.sleigh.grammar.DisplayLexer): ...

    @overload
    def __init__(self, input: org.antlr.runtime.CharStream, state: org.antlr.runtime.RecognizerSharedState, gDisplayLexer: ghidra.sleigh.grammar.DisplayLexer): ...
