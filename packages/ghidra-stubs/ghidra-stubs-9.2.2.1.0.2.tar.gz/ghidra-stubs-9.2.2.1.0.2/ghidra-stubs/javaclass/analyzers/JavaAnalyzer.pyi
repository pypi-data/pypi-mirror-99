...
import ghidra.javaclass.analyzers
...
class JavaAnalyzer(ghidra.javaclass.analyzers.AbstractJavaAnalyzer, ghidra.app.plugin.core.analysis.AnalysisWorker):
    ...
    def restoreDefaultOptions(self, __a0: ghidra.framework.options.Options, __a1: ghidra.program.model.listing.Program) -> None: ...
