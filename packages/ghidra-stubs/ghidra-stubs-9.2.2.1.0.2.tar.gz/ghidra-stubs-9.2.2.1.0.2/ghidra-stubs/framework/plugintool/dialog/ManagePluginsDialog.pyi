...
class ManagePluginsDialog(docking.DialogComponentProvider, javax.swing.event.ChangeListener):




    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, addSaveActions: bool, isNewTool: bool): ...
