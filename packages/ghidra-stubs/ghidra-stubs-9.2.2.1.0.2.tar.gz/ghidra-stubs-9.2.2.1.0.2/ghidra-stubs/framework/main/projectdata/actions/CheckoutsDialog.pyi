...
class CheckoutsDialog(docking.DialogComponentProvider, ghidra.framework.model.ProjectListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, user: ghidra.framework.remote.User, domainFile: ghidra.framework.model.DomainFile, checkouts: List[ghidra.framework.store.ItemCheckoutStatus]): ...
