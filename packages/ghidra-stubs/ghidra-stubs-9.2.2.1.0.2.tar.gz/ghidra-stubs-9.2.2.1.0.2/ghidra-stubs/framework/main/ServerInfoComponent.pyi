...
class ServerInfoComponent(javax.swing.JPanel):
    ...
    def setChangeListener(self, listener: javax.swing.event.ChangeListener) -> None:
        """
    ...
    def setServerInfo(self, info: ghidra.framework.model.ServerInfo) -> None:
        """
    ...
    def setStatusListener(self, statusListener: ghidra.util.StatusListener) -> None:
        """
    ...
    @property
    def serverInfo(self) -> None: ...  # No getter available.

    @serverInfo.setter
    def serverInfo(self, value: ghidra.framework.model.ServerInfo) -> None: ...
    ...
    def statusListener(self, value: ghidra.util.StatusListener) -> None: ...
