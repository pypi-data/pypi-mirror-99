...
class ConsoleTextPane(javax.swing.JTextPane, ghidra.framework.options.OptionsChangeListener):
    ...
    def addErrorMessage(self, message: unicode) -> None: ...
    ...
    def addHyperlinkListener(self, __a0: javax.swing.event.HyperlinkListener) -> None: ...
    ...
    def addMessage(self, message: unicode) -> None: ...
    ...
    def addPartialMessage(self, message: unicode) -> None: ...
    ...
    def addStyle(self, __a0: unicode, __a1: javax.swing.text.Style) -> javax.swing.text.Style: ...
    ...
    @staticmethod
    def createEditorKitForContentType(__a0: unicode) -> javax.swing.text.EditorKit: ...
    ...
    def fireHyperlinkUpdate(self, __a0: javax.swing.event.HyperlinkEvent) -> None: ...
    ...
    def getCharacterAttributes(self) -> javax.swing.text.AttributeSet: ...
    ...
    def getEditorKit(self) -> javax.swing.text.EditorKit: ...

    @staticmethod
    def getEditorKitClassNameForContentType(__a0: unicode) -> unicode: ...

    def getEditorKitForContentType(self, __a0: unicode) -> javax.swing.text.EditorKit: ...
    ...
    def getHyperlinkListeners(self) -> List[javax.swing.event.HyperlinkListener]: ...

    def getIgnoreRepaint(self) -> bool: ...

    def getInheritsPopupMenu(self) -> bool: ...

    def getInputAttributes(self) -> javax.swing.text.MutableAttributeSet: ...
    ...
    def getLogicalStyle(self) -> javax.swing.text.Style: ...
    ...
    def getPage(self) -> java.net.URL: ...

    def getParagraphAttributes(self) -> javax.swing.text.AttributeSet: ...
    ...
    def getStyle(self, __a0: unicode) -> javax.swing.text.Style: ...

    def getStyledDocument(self) -> javax.swing.text.StyledDocument: ...
    ...
    def insertComponent(self, __a0: java.awt.Component) -> None: ...

    def insertIcon(self, __a0: javax.swing.Icon) -> None: ...
    ...
    @overload
    def read(self, __a0: java.io.InputStream, __a1: object) -> None: ...
    ...
    @overload
    @staticmethod
    def registerEditorKitForContentType(__a0: unicode, __a1: unicode) -> None: ...

    @overload
    @staticmethod
    def registerEditorKitForContentType(__a0: unicode, __a1: unicode, __a2: java.lang.ClassLoader) -> None: ...
    ...
    def removeHyperlinkListener(self, __a0: javax.swing.event.HyperlinkListener) -> None: ...
    ...
    def removeStyle(self, __a0: unicode) -> None: ...
    ...
    def scrollToReference(self, __a0: unicode) -> None: ...
    ...
    def setCharacterAttributes(self, __a0: javax.swing.text.AttributeSet, __a1: bool) -> None: ...
    ...
    def setConsoleListener(self, listener: ghidra.framework.main.ConsoleListener) -> None: ...

    def setContentType(self, __a0: unicode) -> None: ...
    ...
    def setEditorKit(self, __a0: javax.swing.text.EditorKit) -> None: ...

    def setEditorKitForContentType(self, __a0: unicode, __a1: javax.swing.text.EditorKit) -> None: ...
    ...
    def setLogicalStyle(self, __a0: javax.swing.text.Style) -> None: ...
    ...
    @overload
    def setPage(self, __a0: unicode) -> None: ...

    @overload
    def setPage(self, __a0: java.net.URL) -> None: ...

    def setParagraphAttributes(self, __a0: javax.swing.text.AttributeSet, __a1: bool) -> None: ...

    def setPreferredSize(self, __a0: java.awt.Dimension) -> None: ...

    def setRequestFocusEnabled(self, __a0: bool) -> None: ...

    def setScrollLock(self, lock: bool) -> None: ...
    ...
    def setStyledDocument(self, __a0: javax.swing.text.StyledDocument) -> None: ...
    ...
    @property
    def consoleListener(self) -> None: ...  # No getter available.

    @consoleListener.setter
    def consoleListener(self, value: ghidra.framework.main.ConsoleListener) -> None: ...
    ...
    @property
    def scrollLock(self) -> None: ...  # No getter available.

    @scrollLock.setter
    def scrollLock(self, value: bool) -> None: ...