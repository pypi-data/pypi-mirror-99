...
class UndoActionDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, __a0: unicode, __a1: javax.swing.ImageIcon, __a2: unicode, __a3: unicode, __a4: List[object]): ...
    ...
    def getSelectedDomainFiles(self) -> List[ghidra.framework.model.DomainFile]: ...
    ...
    @property
    def selectedDomainFiles(self) -> List[ghidra.framework.model.DomainFile]: ...