...
class VersionControlDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, addToVersionControl: bool):
        """
        Constructor
    ...
    def setCurrentFileName(self, filename: unicode) -> None:
        """
    ...
    def setKeepCheckboxEnabled(self, enabled: bool) -> None:
        """
    ...
    @property
    def currentFileName(self) -> None: ...  # No getter available.

    @currentFileName.setter
    def currentFileName(self, value: unicode) -> None: ...

    @property
    def keepCheckboxEnabled(self) -> None: ...  # No getter available.

    @keepCheckboxEnabled.setter
    def keepCheckboxEnabled(self, value: bool) -> None: ...