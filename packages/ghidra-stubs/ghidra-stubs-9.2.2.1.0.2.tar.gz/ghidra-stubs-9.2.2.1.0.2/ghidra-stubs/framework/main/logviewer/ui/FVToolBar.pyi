...
class FVToolBar(javax.swing.JToolBar):
    """
    Toolbar that contains widgets for controlling the FileViewer.  Currently there is one
     widget:
    ...
    def getScrollLockBtn(self) -> docking.EmptyBorderToggleButton: ...
    ...
    @property
    def scrollLockBtn(self) -> docking.EmptyBorderToggleButton: ...