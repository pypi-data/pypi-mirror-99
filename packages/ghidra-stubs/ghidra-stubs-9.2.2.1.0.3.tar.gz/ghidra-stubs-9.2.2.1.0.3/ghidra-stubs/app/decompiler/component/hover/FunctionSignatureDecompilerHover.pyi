...
class FunctionSignatureDecompilerHover(ghidra.app.plugin.core.hover.AbstractConfigurableHover, ghidra.app.decompiler.component.hover.DecompilerHoverService):
    """
