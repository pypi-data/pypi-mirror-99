...
class ComplexityDepthModularizationCmd(ghidra.app.cmd.module.AbstractModularizationCmd):
    """
    ...
    def __init__(self, path: ghidra.program.util.GroupPath, treeName: unicode, selection: ghidra.program.util.ProgramSelection, blockModel: ghidra.program.model.block.CodeBlockModel): ...
    ...
    @overload
    def applyTo(self, obj: ghidra.framework.model.DomainObject, taskMonitor: ghidra.util.task.TaskMonitor) -> bool: ...
