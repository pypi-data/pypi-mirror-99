...
class ElfBinaryAnalysisCommand(ghidra.program.flatapi.FlatProgramAPI, ghidra.framework.cmd.BinaryAnalysisCommand, ghidra.app.plugin.core.analysis.AnalysisWorker):
    ...
    def analysisWorkerCallback(self, program: ghidra.program.model.listing.Program, workerContext: object, analysisMonitor: ghidra.util.task.TaskMonitor) -> bool: ...
    ...
    def applyTo(self, program: ghidra.program.model.listing.Program, analysisMonitor: ghidra.util.task.TaskMonitor) -> bool: ...
