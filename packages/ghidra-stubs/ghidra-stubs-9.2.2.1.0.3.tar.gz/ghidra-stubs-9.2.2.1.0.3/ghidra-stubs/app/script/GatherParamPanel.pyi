...
class GatherParamPanel(javax.swing.JPanel):
    ADDRESS: int = 3
    DIRECTORY: int = 2
    FILE: int = 1
    INTEGER: int = 4
    ...
    class ParamComponent(object):
        ...
        def __init__(self, __a0: ghidra.app.script.GatherParamPanel, __a1: java.awt.Component, __a2: int): ...
        ...
        def getDisplayComponent(self) -> java.awt.Component: ...
        ...
        @property
        def displayComponent(self) -> java.awt.Component: ...
    ...
    def addParameterRegardless(self, key: unicode, label: unicode, type: int, defaultValue: object) -> None: ...
    ...
    def currentProgramChanged(self) -> None: ...
    ...
    def getParameter(self, key: unicode) -> ghidra.app.script.GatherParamPanel.ParamComponent: ...
    ...
    def setParamsInState(self) -> None: ...
    ...
    @property
    def shown(self) -> None: ...  # No getter available.
