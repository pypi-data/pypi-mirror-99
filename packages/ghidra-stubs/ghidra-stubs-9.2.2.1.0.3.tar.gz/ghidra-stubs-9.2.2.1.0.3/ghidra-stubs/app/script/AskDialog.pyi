...
class AskDialog(docking.DialogComponentProvider):
    BYTES: int = 4
    DOUBLE: int = 3
    INT: int = 1
    LONG: int = 2
    ...
    @overload
    def __init__(self, parent: java.awt.Component, title: unicode, message: unicode, type: int): ...

    @overload
    def __init__(self, dialogTitle: unicode, message: unicode, type: int, defaultValue: object): ...

    @overload
    def __init__(self, parent: java.awt.Component, title: unicode, message: unicode, type: int, choices: List[object], defaultValue: object): ...
    ...
    def getChoiceValue(self) -> object: ...
    ...
    def getTextFieldValue(self) -> unicode: ...
    ...
    @property
    def choiceValue(self) -> object: ...

    @property
    def textFieldValue(self) -> unicode: ...
