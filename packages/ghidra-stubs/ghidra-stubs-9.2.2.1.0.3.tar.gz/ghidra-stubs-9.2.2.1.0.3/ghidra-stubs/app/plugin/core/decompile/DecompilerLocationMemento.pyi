...
class DecompilerLocationMemento(ghidra.app.nav.LocationMemento):
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.util.ProgramLocation, __a2: docking.widgets.fieldpanel.support.ViewerPosition): ...
