...
class DataOrganizationPanel(javax.swing.JPanel):
    ...
    def setOrganization(self, __a0: ghidra.program.model.data.DataOrganizationImpl) -> None: ...
    ...
    @property
    def organization(self) -> None: ...  # No getter available.

    @organization.setter
    def organization(self, value: ghidra.program.model.data.DataOrganizationImpl) -> None: ...