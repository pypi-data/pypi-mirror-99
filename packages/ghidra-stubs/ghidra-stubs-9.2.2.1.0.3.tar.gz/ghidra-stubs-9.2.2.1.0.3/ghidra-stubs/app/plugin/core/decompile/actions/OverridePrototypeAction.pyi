...
class OverridePrototypeAction(ghidra.app.plugin.core.decompile.actions.AbstractDecompilerAction):
    ...
    class ProtoOverrideDialog(ghidra.app.plugin.core.function.EditFunctionSignatureDialog):
        ...
        def __init__(self, __a0: ghidra.app.plugin.core.decompile.actions.OverridePrototypeAction, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.program.model.listing.Function, __a3: unicode, __a4: unicode): ...
