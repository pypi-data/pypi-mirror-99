...
class NamespaceCategoryNode(ghidra.app.plugin.core.symboltree.nodes.SymbolCategoryNode):
    CLOSED_FOLDER_NAMESPACES_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/9.2.2/x64/Ghidra/Features/Base/lib/Base.jar!/images/closedFolderNamespaces.png
    OPEN_FOLDER_NAMESPACES_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/9.2.2/x64/Ghidra/Features/Base/lib/Base.jar!/images/openFolderNamespaces.png
