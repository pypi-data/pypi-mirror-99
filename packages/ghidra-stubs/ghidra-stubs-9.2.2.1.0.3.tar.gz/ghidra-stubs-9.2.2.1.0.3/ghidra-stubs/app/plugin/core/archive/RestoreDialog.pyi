...
class RestoreDialog(docking.DialogComponentProvider):




    def __init__(self, __a0: ghidra.app.plugin.core.archive.ArchivePlugin): ...
    ...
    def showDialog(self, __a0: unicode, __a1: ghidra.framework.model.ProjectLocator) -> bool: ...
