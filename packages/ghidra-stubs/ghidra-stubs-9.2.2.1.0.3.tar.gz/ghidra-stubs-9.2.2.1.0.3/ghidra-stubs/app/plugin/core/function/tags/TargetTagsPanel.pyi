...
class TargetTagsPanel(ghidra.app.plugin.core.function.tags.TagListPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.function.tags.FunctionTagsComponentProvider, __a1: ghidra.framework.plugintool.PluginTool, __a2: unicode): ...
