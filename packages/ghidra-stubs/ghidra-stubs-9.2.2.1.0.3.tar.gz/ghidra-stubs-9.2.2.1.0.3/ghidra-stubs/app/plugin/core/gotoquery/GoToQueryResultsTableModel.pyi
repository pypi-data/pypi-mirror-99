...
class GoToQueryResultsTableModel(ghidra.app.util.query.ProgramLocationPreviewTableModel):
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.framework.plugintool.ServiceProvider, __a2: List[object], __a3: ghidra.util.task.TaskMonitor): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.app.services.QueryData, __a2: ghidra.framework.plugintool.ServiceProvider, __a3: int, __a4: ghidra.util.task.TaskMonitor): ...
