...
class CompositeViewerDataTypeManager(ghidra.program.model.data.StandAloneDataTypeManager):
    ...
    def __init__(self, __a0: unicode, __a1: ghidra.program.model.data.Composite, __a2: ghidra.program.model.data.Category): ...
    ...
    def clearAllSettings(self, __a0: ghidra.program.model.address.Address) -> None: ...

    def clearSetting(self, __a0: ghidra.program.model.address.Address, __a1: unicode) -> bool: ...

    def clearSettings(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    def getByteSettingsValue(self, __a0: ghidra.program.model.address.Address, __a1: unicode) -> List[int]: ...
    ...
    def getLongSettingsValue(self, __a0: ghidra.program.model.address.Address, __a1: unicode) -> long: ...

    def getName(self) -> unicode: ...

    def getNames(self, __a0: ghidra.program.model.address.Address) -> List[unicode]: ...
    ...
    def getSettings(self, __a0: ghidra.program.model.address.Address, __a1: unicode) -> object: ...
    ...
    def getStringSettingsValue(self, __a0: ghidra.program.model.address.Address, __a1: unicode) -> unicode: ...
    ...
    @overload
    def getUniqueName(self, __a0: ghidra.program.model.data.CategoryPath, __a1: ghidra.program.model.data.CategoryPath, __a2: unicode) -> unicode: ...

    def getUniversalID(self) -> ghidra.util.UniversalID: ...

    def getUnusedConflictName(self, __a0: ghidra.program.model.data.CategoryPath, __a1: unicode) -> unicode: ...
    ...
    def isEmptySetting(self, __a0: ghidra.program.model.address.Address) -> bool: ...
    ...
    def setByteSettingsValue(self, __a0: ghidra.program.model.address.Address, __a1: unicode, __a2: List[int]) -> bool: ...

    def setFavorite(self, __a0: ghidra.program.model.data.DataType, __a1: bool) -> None: ...

    def setLongSettingsValue(self, __a0: ghidra.program.model.address.Address, __a1: unicode, __a2: long) -> bool: ...

    def setName(self, __a0: unicode) -> None: ...

    def setSettings(self, __a0: ghidra.program.model.address.Address, __a1: unicode, __a2: object) -> bool: ...

    def setStringSettingsValue(self, __a0: ghidra.program.model.address.Address, __a1: unicode, __a2: unicode) -> bool: ...
