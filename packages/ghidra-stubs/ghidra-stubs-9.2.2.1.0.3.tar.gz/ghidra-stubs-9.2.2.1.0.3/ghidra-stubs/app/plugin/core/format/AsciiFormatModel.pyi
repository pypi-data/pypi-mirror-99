...
class AsciiFormatModel(object, ghidra.app.plugin.core.format.UniversalDataFormatModel):
    NEXT_UNIT: int = -1
    PREVIOUS_UNIT: int = -1
    ...
    def supportsProvider(self, __a0: ghidra.app.plugin.core.byteviewer.ByteViewerComponentProvider) -> bool: ...
