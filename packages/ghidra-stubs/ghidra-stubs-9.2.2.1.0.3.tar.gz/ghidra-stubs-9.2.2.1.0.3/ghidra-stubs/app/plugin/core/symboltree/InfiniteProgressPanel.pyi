...
class InfiniteProgressPanel(javax.swing.JComponent, java.awt.event.MouseListener):
    ...
    @overload
    def __init__(self, __a0: unicode, __a1: int, __a2: float): ...

    @overload
    def __init__(self, __a0: unicode, __a1: int, __a2: float, __a3: int): ...

    @overload
    def __init__(self, __a0: unicode, __a1: int, __a2: float, __a3: int, __a4: int): ...
