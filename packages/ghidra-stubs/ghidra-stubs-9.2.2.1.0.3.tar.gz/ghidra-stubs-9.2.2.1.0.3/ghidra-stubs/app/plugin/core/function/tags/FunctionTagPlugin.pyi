...
class FunctionTagPlugin(ghidra.app.plugin.ProgramPlugin):
    FUNCTION_TAG_MENU_SUBGROUP: unicode = u'TagFunction'
    ...
    def getProvider(self) -> ghidra.app.plugin.core.function.tags.FunctionTagsComponentProvider: ...
    ...
    @property
    def provider(self) -> ghidra.app.plugin.core.function.tags.FunctionTagsComponentProvider: ...