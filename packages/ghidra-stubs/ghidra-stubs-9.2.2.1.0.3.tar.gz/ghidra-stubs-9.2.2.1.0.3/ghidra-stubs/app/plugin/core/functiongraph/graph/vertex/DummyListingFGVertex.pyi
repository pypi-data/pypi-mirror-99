...
class DummyListingFGVertex(ghidra.app.plugin.core.functiongraph.graph.vertex.ListingFunctionGraphVertex):
    ...
    def cloneVertex(self, __a0: ghidra.app.plugin.core.functiongraph.mvc.FGController) -> ghidra.app.plugin.core.functiongraph.graph.vertex.ListingFunctionGraphVertex: ...
