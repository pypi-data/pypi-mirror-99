...
class StackEditorManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.options.OptionsChangeListener, ghidra.app.plugin.core.stackeditor.StackEditorOptionManager):
