...
class EndInstructionValueSolver(ghidra.app.plugin.assembler.sleigh.expr.AbstractExpressionSolver):
    ...
    @overload
    def getInstructionLength(self, iv: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, res: java.util.Map) -> int: ...
    ...
    @overload
    def getValue(self, iv: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, vals: java.util.Map, res: java.util.Map, cur: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedConstructor) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
    ...
    @overload
    def solve(self, iv: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, goal: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong, vals: java.util.Map, res: java.util.Map, cur: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedConstructor, hints: java.util.Set, description: unicode) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution: ...
    ...
    @overload
    def valueForResolution(self, exp: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, rc: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedConstructor) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
