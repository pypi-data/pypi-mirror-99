...
class InstructionPattern(ghidra.app.plugin.processors.sleigh.pattern.DisjointPattern):
    """
    ...
    @overload
    def __init__(self, mv: ghidra.app.plugin.processors.sleigh.pattern.PatternBlock): ...
    ...
    @overload
    def getBlock(self) -> ghidra.app.plugin.processors.sleigh.pattern.PatternBlock: ...
    ...
    @property
    def block(self) -> ghidra.app.plugin.processors.sleigh.pattern.PatternBlock: ...