...
class CliTableManifestResource(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliManifestResourceRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        flags: int
        implIndex: int
        nameIndex: int
        offset: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableManifestResource, __a1: int, __a2: int, __a3: int, __a4: int): ...
