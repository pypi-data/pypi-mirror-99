...
class AbstractEnumMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractComplexMsType):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.util.bin.format.pdb2.pdbreader.AbstractPdb, __a1: unicode, __a2: ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber, __a3: ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber, __a4: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty, __a5: int): ...
