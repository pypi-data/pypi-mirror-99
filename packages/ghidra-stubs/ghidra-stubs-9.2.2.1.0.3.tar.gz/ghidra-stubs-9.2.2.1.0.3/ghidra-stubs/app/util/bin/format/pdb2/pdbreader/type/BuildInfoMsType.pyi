...
class BuildInfoMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    BUILDINFO_BUILD_TOOL: int = 1
    BUILDINFO_COMMAND_ARGUMENTS: int = 4
    BUILDINFO_CURRENT_DIRECTORY: int = 0
    BUILDINFO_PROGRAM_DATABASE_FILE: int = 3
    BUILDINFO_SOURCE_FILE: int = 2
    PDB_ID: int = 5635
