...
class CliSigField(ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig):
    identifier: int = 6
    type: ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig.CliParam
    ...
    @staticmethod
    def isFieldSig(blob: ghidra.app.util.bin.format.pe.cli.blobs.CliBlob) -> bool:
        """
