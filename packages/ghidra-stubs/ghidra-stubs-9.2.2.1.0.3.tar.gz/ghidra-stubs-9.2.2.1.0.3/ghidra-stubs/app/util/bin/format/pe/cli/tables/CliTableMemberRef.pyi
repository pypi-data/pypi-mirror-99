...
class CliTableMemberRef(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliMemberRefRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        classIndex: int
        nameIndex: int
        signatureIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableMemberRef, __a1: int, __a2: int, __a3: int): ...
