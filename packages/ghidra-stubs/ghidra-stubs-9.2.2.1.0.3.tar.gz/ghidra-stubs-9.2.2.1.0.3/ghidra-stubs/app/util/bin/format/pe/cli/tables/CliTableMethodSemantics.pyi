...
class CliTableMethodSemantics(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliMethodSemanticsRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableMethodSemantics, __a1: int, __a2: int, __a3: int): ...
