...
class CliTableField(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliFieldRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        TYPEDEF_OWNER_INIT_VALUE: int = -1
        flags: int
        nameIndex: int
        sigIndex: int
        typeDefOwnerIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableField, __a1: int, __a2: int, __a3: int): ...
