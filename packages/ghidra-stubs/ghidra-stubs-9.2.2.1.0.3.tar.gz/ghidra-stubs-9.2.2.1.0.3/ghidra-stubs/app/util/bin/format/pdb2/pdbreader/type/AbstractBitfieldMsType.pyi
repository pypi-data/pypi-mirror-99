...
class AbstractBitfieldMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType):
    ...
    def getElementRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...
    ...
    @property
    def elementRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...