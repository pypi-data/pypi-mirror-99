...
class CliTableExportedType(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliExportedTypeRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        flags: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableExportedType, __a1: int, __a2: int, __a3: int, __a4: int, __a5: int): ...
