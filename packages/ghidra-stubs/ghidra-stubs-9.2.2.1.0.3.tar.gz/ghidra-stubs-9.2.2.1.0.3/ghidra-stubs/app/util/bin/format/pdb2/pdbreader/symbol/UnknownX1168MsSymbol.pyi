...
class UnknownX1168MsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractUnknownMsSymbol):
    PDB_ID: int = 4456
    ...
    def getTypeRecordNumbers(self) -> List[object]: ...
    ...
    @property
    def typeRecordNumbers(self) -> List[object]: ...