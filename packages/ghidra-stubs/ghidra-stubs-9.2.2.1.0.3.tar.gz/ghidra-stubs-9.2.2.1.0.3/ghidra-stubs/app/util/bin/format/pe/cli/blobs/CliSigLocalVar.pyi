...
class CliSigLocalVar(ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig):
    identifier: int = 7
    ...
    @staticmethod
    def isLocalVarSig(blob: ghidra.app.util.bin.format.pe.cli.blobs.CliBlob) -> bool:
        """
