...
class ImportAddressTableDataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    ...
    def getThunkDataSet(self, index: int) -> List[ghidra.app.util.bin.format.pe.ThunkData]:
        """
