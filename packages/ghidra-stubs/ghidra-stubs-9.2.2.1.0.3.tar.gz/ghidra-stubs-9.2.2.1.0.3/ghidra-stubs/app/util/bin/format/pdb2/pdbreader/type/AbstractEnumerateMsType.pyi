...
class AbstractEnumerateMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType, ghidra.app.util.bin.format.pdb2.pdbreader.type.MsTypeField):
    ...
    def getNumeric(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.Numeric: ...
    ...
    @property
    def numeric(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.Numeric: ...