...
class CliTableStandAloneSig(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliStandAloneSigRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        signatureIndex: int



        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableStandAloneSig, __a1: int): ...
