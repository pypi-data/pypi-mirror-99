...
class CliTableAssemblyOS(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliAssemblyOSRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        osMajorVersion: int
        osMinorVersion: int
        osPlatformID: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableAssemblyOS, __a1: int, __a2: int, __a3: int): ...
