...
class FixedBitSizeValueField(javax.swing.JPanel):
    ...
    def __init__(self, bitSize: int, includeFormatButton: bool, leftJustify: bool): ...
    ...
    def setBitSize(self, bitSize: int) -> None: ...
    ...
    def setFormat(self, radix: int, signed: bool) -> None: ...
    ...
    def setMinMax(self, min: long, max: long) -> None: ...
    ...
    @overload
    def setValue(self, value: long) -> bool: ...

    @overload
    def setValue(self, value: long, pad: bool) -> bool: ...
    ...
    @property
    def bitSize(self) -> None: ...  # No getter available.
