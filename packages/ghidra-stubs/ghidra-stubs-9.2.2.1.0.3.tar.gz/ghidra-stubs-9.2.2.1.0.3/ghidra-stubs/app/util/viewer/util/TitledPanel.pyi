...
class TitledPanel(javax.swing.JPanel):
    ...
    @overload
    def __init__(self, name: unicode, panel: javax.swing.JComponent, margin: int):
        """
    ...
    @overload
    def __init__(self, titleLabel: javax.swing.JLabel, panel: javax.swing.JComponent, margin: int):
        """
        Creates a new TitlePanel
    ...
    def addTitleComponent(self, comp: javax.swing.JComponent) -> None:
        """
    ...
    def setTitleName(self, name: unicode) -> None: ...
    ...
    @property
    def titleName(self) -> None: ...  # No getter available.

    @titleName.setter
    def titleName(self, value: unicode) -> None: ...