...
class RegisterTransitionFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    def newInstance(self, fieldFormatModel: ghidra.app.util.viewer.format.FieldFormatModel, hsProvider: ghidra.app.util.HighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
