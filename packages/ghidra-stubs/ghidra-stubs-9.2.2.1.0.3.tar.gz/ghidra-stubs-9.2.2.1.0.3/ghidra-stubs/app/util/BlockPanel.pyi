...
class BlockPanel(javax.swing.JPanel, java.awt.event.ComponentListener):
    ...
    def componentHidden(self, e: java.awt.event.ComponentEvent) -> None: ...

    def componentMoved(self, e: java.awt.event.ComponentEvent) -> None: ...

    def componentResized(self, e: java.awt.event.ComponentEvent) -> None: ...

    def componentShown(self, e: java.awt.event.ComponentEvent) -> None: ...
    ...
    def setMemoryBlockMap(self, map: ghidra.app.util.viewer.util.AddressPixelMap) -> None: ...
    ...
    @property
    def memoryBlockMap(self) -> None: ...  # No getter available.

    @memoryBlockMap.setter
    def memoryBlockMap(self, value: ghidra.app.util.viewer.util.AddressPixelMap) -> None: ...