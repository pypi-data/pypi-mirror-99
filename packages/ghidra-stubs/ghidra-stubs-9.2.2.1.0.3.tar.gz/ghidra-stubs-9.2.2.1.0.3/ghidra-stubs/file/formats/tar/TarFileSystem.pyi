...
class TarFileSystem(object, ghidra.formats.gfilesystem.GFileSystem):
    ...
    def __init__(self, __a0: java.io.File, __a1: ghidra.formats.gfilesystem.FSRLRoot, __a2: ghidra.formats.gfilesystem.FileSystemService): ...
    ...
    def getInfoMap(self, __a0: org.apache.commons.compress.archivers.tar.TarArchiveEntry) -> java.util.Map: ...
    ...
    def getRawContainerFile(self) -> java.io.File: ...
    ...
    @property
    def rawContainerFile(self) -> java.io.File: ...
