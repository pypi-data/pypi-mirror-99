...
class SparseImageFileSystem(object, ghidra.formats.gfilesystem.GFileSystem):




    def __init__(self, __a0: ghidra.formats.gfilesystem.FSRLRoot, __a1: ghidra.formats.gfilesystem.FSRL, __a2: ghidra.formats.gfilesystem.FileSystemService, __a3: ghidra.util.task.TaskMonitor): ...
    ...
    def lookup(self, __a0: unicode) -> ghidra.formats.gfilesystem.GFileImpl: ...
