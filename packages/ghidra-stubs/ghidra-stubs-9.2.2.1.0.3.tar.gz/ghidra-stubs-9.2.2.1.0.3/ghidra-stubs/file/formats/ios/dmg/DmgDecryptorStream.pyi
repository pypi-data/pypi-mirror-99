...
class DmgDecryptorStream(java.io.InputStream):
    DMG_VERSION_2: int = 2



    @overload
    def __init__(self, __a0: unicode, __a1: unicode, __a2: ghidra.app.util.bin.ByteProvider): ...

    @overload
    def __init__(self, __a0: unicode, __a1: unicode, __a2: java.io.File): ...
