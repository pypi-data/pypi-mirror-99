...
class Img3FileSystem(ghidra.formats.gfilesystem.GFileSystemBase):
    ...
    def getData(self, __a0: ghidra.formats.gfilesystem.GFile, __a1: ghidra.util.task.TaskMonitor) -> java.io.InputStream: ...
