...
class JavaClassDecompilerFileSystem(object, ghidra.formats.gfilesystem.GFileSystem):




    def __init__(self, __a0: ghidra.formats.gfilesystem.FSRLRoot, __a1: ghidra.formats.gfilesystem.FileSystemService, __a2: ghidra.util.task.TaskMonitor): ...
