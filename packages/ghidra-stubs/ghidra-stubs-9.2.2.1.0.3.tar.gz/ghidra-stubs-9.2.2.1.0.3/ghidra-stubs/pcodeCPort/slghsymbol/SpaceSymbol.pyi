...
class SpaceSymbol(ghidra.pcodeCPort.slghsymbol.SleighSymbol):
    location: ghidra.sleigh.grammar.Location



    def __init__(self, __a0: ghidra.sleigh.grammar.Location, __a1: ghidra.pcodeCPort.space.AddrSpace): ...
