...
class VisualGraphEdgeLabelRenderer(edu.uci.ics.jung.visualization.renderers.DefaultEdgeLabelRenderer):
    ...
    Overrides the DefaultEdgeLabelRenderer so that the client can set the non-picked
     foreground color.  See #setNonPickedForegroundColor(Color).
    """
    ...
    def getEdgeLabelRendererComponent(self, __a0: javax.swing.JComponent, __a1: object, __a2: java.awt.Font, __a3: bool, __a4: object) -> java.awt.Component: ...
    ...
    def isRotateEdgeLabels(self) -> bool: ...
    ...
    def setNonPickedForegroundColor(self, color: java.awt.Color) -> None:
        """
    ...
    def setRotateEdgeLabels(self, __a0: bool) -> None: ...
    ...
    @property
    def nonPickedForegroundColor(self) -> None: ...  # No getter available.

    @nonPickedForegroundColor.setter
    def nonPickedForegroundColor(self, value: java.awt.Color) -> None: ...