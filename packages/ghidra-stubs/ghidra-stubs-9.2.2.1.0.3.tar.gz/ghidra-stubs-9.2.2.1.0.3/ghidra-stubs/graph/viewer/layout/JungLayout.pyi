...
class JungLayout(ghidra.graph.viewer.layout.JungWrappingVisualGraphLayoutAdapter):
    """
    A class that defines a simple Jung Layout interface for 
     VisualVertex and VisualEdges
    """
    ...
    def __init__(self, jungLayout: edu.uci.ics.jung.algorithms.layout.Layout): ...
    ...
    @overload
    def apply(self, __a0: ghidra.graph.viewer.VisualVertex) -> java.awt.geom.Point2D: ...
    ...
    def cloneLayout(self, newGraph: ghidra.graph.VisualGraph) -> ghidra.graph.viewer.layout.JungWrappingVisualGraphLayoutAdapter: ...
    ...
    @overload
    def isLocked(self, __a0: ghidra.graph.viewer.VisualVertex) -> bool: ...

    @overload
    def isLocked(self, __a0: object) -> bool: ...

    @overload
    def lock(self, __a0: ghidra.graph.viewer.VisualVertex, __a1: bool) -> None: ...
    ...
    def setGraph(self, graph: edu.uci.ics.jung.graph.Graph) -> None: ...

    def setInitializer(self, t: com.google.common.base.Function) -> None: ...
    ...
    def setSize(self, d: java.awt.Dimension) -> None: ...
