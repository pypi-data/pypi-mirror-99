...
class MultipleLabelsRenderer(ghidra.util.table.column.AbstractGhidraColumnRenderer):





    class MultipleLabelsRendererType(java.lang.Enum):
        DESTINATION: ghidra.feature.vt.gui.provider.matchtable.MultipleLabelsRenderer.MultipleLabelsRendererType = DESTINATION
        SOURCE: ghidra.feature.vt.gui.provider.matchtable.MultipleLabelsRenderer.MultipleLabelsRendererType = SOURCE
        displayString: unicode
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.feature.vt.gui.provider.matchtable.MultipleLabelsRenderer.MultipleLabelsRendererType: ...
        ...
        @staticmethod
        def values() -> List[ghidra.feature.vt.gui.provider.matchtable.MultipleLabelsRenderer.MultipleLabelsRendererType]: ...
    ...
    def __init__(self, __a0: ghidra.feature.vt.gui.provider.matchtable.MultipleLabelsRenderer.MultipleLabelsRendererType): ...
    ...
    @overload
    def getFilterString(self, __a0: List[ghidra.program.model.symbol.Symbol], __a1: ghidra.docking.settings.Settings) -> unicode: ...
    ...
    def getHTMLRenderingEnabled(self) -> bool: ...
