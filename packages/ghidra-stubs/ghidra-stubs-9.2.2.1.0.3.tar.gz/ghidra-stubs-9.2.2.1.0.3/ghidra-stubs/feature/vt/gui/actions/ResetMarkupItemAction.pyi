...
class ResetMarkupItemAction(docking.action.DockingAction):
    RESET_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/9.2.2/x64/Ghidra/Features/VersionTracking/lib/VersionTracking.jar!/images/undo-apply.png
