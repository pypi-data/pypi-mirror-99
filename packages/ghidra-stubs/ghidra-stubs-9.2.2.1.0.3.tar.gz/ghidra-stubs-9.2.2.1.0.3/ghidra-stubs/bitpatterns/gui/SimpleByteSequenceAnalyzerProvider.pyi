...
class SimpleByteSequenceAnalyzerProvider(ghidra.bitpatterns.gui.ByteSequenceAnalyzerProvider):
    TITLE_INITIAL: unicode = u'Byte Sequences for '



    def __init__(self, __a0: ghidra.bitpatterns.gui.FunctionBitPatternsExplorerPlugin, __a1: unicode, __a2: ghidra.bitpatterns.info.ContextRegisterFilter, __a3: List[object], __a4: java.awt.Component, __a5: ghidra.bitpatterns.info.PatternType): ...
