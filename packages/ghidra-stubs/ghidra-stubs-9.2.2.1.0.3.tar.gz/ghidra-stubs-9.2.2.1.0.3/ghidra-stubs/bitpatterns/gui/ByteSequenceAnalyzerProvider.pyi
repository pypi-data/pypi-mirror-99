...
class ByteSequenceAnalyzerProvider(docking.DialogComponentProvider):




    def __init__(self, __a0: unicode, __a1: ghidra.bitpatterns.gui.FunctionBitPatternsExplorerPlugin, __a2: List[object], __a3: java.awt.Component, __a4: ghidra.bitpatterns.info.PatternType, __a5: ghidra.bitpatterns.info.ContextRegisterFilter, __a6: unicode): ...
