...
class GlobalVariableSymbolDB(ghidra.program.database.symbol.VariableSymbolDB):
    ...
    def __init__(self, symbolMgr: ghidra.program.database.symbol.SymbolManager, cache: ghidra.program.database.DBObjectCache, variableMgr: ghidra.program.database.symbol.VariableStorageManagerDB, address: ghidra.program.model.address.Address, record: db.Record):
        """
