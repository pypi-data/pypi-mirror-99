...
class CodeSymbol(ghidra.program.database.symbol.SymbolDB):
    """
    ...
    @overload
    def __init__(self, mgr: ghidra.program.database.symbol.SymbolManager, cache: ghidra.program.database.DBObjectCache, addr: ghidra.program.model.address.Address, key: long):
        """
    ...
    @overload
    def __init__(self, mgr: ghidra.program.database.symbol.SymbolManager, cache: ghidra.program.database.DBObjectCache, addr: ghidra.program.model.address.Address, record: db.Record):
        """
    ...
    @overload
    def delete(self, keepReferences: bool) -> bool: ...
