...
class BlockIfGoto(ghidra.program.model.pcode.BlockGraph):
    """
    ...
    def getGotoTarget(self) -> ghidra.program.model.pcode.PcodeBlock: ...
    ...
    def setGotoTarget(self, bl: ghidra.program.model.pcode.PcodeBlock) -> None: ...
    ...
    @property
    def gotoTarget(self) -> ghidra.program.model.pcode.PcodeBlock: ...

    @gotoTarget.setter
    def gotoTarget(self, value: ghidra.program.model.pcode.PcodeBlock) -> None: ...

    @property
    def gotoType(self) -> int: ...