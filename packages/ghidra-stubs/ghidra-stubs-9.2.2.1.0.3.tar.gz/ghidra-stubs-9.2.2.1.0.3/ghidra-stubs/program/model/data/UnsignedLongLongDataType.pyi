...
class UnsignedLongLongDataType(ghidra.program.model.data.AbstractIntegerDataType):
    """
    Basic implementation for an Signed LongLong Integer dataType
    """

    dataType: ghidra.program.model.data.UnsignedLongLongDataType = ulonglong
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedLongLongDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.LongLongDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.LongLongDataType: ...