...
class WideChar32DataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.ArrayStringable, ghidra.program.model.data.DataTypeWithCharset):
    dataType: ghidra.program.model.data.WideChar32DataType = wchar32
