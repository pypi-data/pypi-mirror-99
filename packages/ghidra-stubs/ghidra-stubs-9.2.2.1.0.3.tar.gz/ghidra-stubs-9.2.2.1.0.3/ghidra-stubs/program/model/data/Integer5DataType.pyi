...
class Integer5DataType(ghidra.program.model.data.AbstractIntegerDataType):
    dataType: ghidra.program.model.data.Integer5DataType = int5
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.Integer5DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger5DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger5DataType: ...