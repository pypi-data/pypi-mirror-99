...
class ShiftedAddressDataType(ghidra.program.model.data.BuiltIn):
    """
    Provides a definition of a Double Word within a program.
    """

    dataType: ghidra.program.model.data.ShiftedAddressDataType = ShiftedAddress
    ...
    @staticmethod
    def getAddressValue(buf: ghidra.program.model.mem.MemBuffer, size: int, shift: int, targetSpace: ghidra.program.model.address.AddressSpace) -> ghidra.program.model.address.Address:
        """
