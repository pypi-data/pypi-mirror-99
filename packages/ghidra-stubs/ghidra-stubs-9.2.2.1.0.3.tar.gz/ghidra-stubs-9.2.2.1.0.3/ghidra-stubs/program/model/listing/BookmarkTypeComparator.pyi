...
class BookmarkTypeComparator(object, java.util.Comparator):
    """
    ...
    @overload
    def compare(self, bt1: ghidra.program.model.listing.BookmarkType, bt2: ghidra.program.model.listing.BookmarkType) -> int:
        """
