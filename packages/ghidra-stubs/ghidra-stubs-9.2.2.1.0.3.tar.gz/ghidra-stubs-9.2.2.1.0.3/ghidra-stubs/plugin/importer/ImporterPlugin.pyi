...
class ImporterPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.FileImporterService, ghidra.framework.main.FrontEndable, ghidra.framework.model.ProjectListener):
    """
