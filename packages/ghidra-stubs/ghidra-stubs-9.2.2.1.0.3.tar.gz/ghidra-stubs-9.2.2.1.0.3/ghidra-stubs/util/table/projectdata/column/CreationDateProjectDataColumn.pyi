...
class CreationDateProjectDataColumn(ghidra.framework.main.datatable.ProjectDataColumn):
    ...
    @overload
    def getValue(self, info: ghidra.framework.main.datatable.DomainFileInfo, settings: ghidra.docking.settings.Settings, data: ghidra.framework.model.ProjectData, services: ghidra.framework.plugintool.ServiceProvider) -> java.util.Date: ...
