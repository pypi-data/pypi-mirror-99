...
class OffcutReferenceCountToAddressTableColumn(ghidra.util.table.field.ProgramBasedDynamicTableColumnExtensionPoint):
    """
    ...
    @overload
    def getValue(self, address: ghidra.program.model.address.Address, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> int: ...
