...
class FunctionCallingConventionTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.model.listing.Function, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> unicode: ...
