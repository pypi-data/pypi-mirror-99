...
class GhidraThreadedTablePanel(docking.widgets.table.threaded.GThreadedTablePanel):




    @overload
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel): ...

    @overload
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel, minUpdateDelay: int): ...

    @overload
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel, minUpdateDelay: int, maxUpdateDelay: int): ...
    ...
    def setModel(self, model: docking.widgets.table.threaded.ThreadedTableModel) -> None: ...
