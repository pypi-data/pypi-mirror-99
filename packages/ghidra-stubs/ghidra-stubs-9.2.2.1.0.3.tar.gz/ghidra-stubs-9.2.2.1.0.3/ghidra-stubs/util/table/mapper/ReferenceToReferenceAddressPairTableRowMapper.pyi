...
class ReferenceToReferenceAddressPairTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    ...
    @overload
    def map(self, rowObject: ghidra.program.model.symbol.Reference, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.app.plugin.core.analysis.ReferenceAddressPair: ...
