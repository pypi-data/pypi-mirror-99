...
class AddressToSymbolTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    ...
    @overload
    def map(self, rowObject: ghidra.program.model.address.Address, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.symbol.Symbol: ...
