...
class ExtensionTablePanel(javax.swing.JPanel):
    ...
    def getSelectedItem(self) -> ghidra.framework.plugintool.dialog.ExtensionDetails: ...
    ...
    def getTableModel(self) -> ghidra.framework.plugintool.dialog.ExtensionTableModel: ...
    ...
    @property
    def selectedItem(self) -> ghidra.framework.plugintool.dialog.ExtensionDetails: ...

    @property
    def table(self) -> docking.widgets.table.GTable: ...

    @property
    def tableModel(self) -> ghidra.framework.plugintool.dialog.ExtensionTableModel: ...