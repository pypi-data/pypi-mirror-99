...
class CheckoutsPanel(javax.swing.JPanel):
    ...
    def __init__(self, parent: java.awt.Component, tool: ghidra.framework.plugintool.PluginTool, user: ghidra.framework.remote.User, domainFile: ghidra.framework.model.DomainFile, checkouts: List[ghidra.framework.store.ItemCheckoutStatus]):
        """
        Constructor
    ...
    def createActions(self, provider: docking.DialogComponentProvider) -> None: ...
