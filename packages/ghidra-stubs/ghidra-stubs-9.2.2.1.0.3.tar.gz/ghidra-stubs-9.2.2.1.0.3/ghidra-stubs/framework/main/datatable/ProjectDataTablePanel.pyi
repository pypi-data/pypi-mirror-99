...
class ProjectDataTablePanel(javax.swing.JPanel):
    filesPendingSelection: java.util.Set
    ...
    def setProjectData(self, name: unicode, projectData: ghidra.framework.model.ProjectData) -> None: ...

    def setRequestFocusEnabled(self, __a0: bool) -> None: ...

    def setSelectedDomainFiles(self, files: java.util.Set) -> None: ...
    ...
    @property
    def selectedDomainFiles(self) -> None: ...  # No getter available.

    @selectedDomainFiles.setter
    def selectedDomainFiles(self, value: java.util.Set) -> None: ...