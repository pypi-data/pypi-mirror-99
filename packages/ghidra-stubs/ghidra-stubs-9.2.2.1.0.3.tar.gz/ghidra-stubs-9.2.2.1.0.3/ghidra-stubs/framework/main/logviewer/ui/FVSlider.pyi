...
class FVSlider(javax.swing.JSlider, javax.swing.event.ChangeListener, java.awt.event.MouseMotionListener, java.awt.event.MouseListener):
    ...
    def __init__(self, scrollPane: javax.swing.JScrollPane, table: ghidra.framework.main.logviewer.ui.FVTable, viewportUtility: ghidra.framework.main.logviewer.ui.ViewportUtility, model: ghidra.framework.main.logviewer.model.ChunkModel, reader: ghidra.framework.main.logviewer.model.ChunkReader, eventListener: ghidra.framework.main.logviewer.event.FVEventListener):
        """
    ...
    @overload
    def createStandardLabels(self, __a0: int) -> java.util.Hashtable: ...

    @overload
    def createStandardLabels(self, __a0: int, __a1: int) -> java.util.Hashtable: ...
    ...
    def getFilePosition(self, sliderPos: int) -> long:
        """
    ...
    def getLabelTable(self) -> java.util.Dictionary: ...
    ...
    def getMajorTickSpacing(self) -> int: ...
    ...
    def getMinorTickSpacing(self) -> int: ...

    def getModel(self) -> javax.swing.BoundedRangeModel: ...
    ...
    def getPaintLabels(self) -> bool: ...

    def getPaintTicks(self) -> bool: ...

    def getPaintTrack(self) -> bool: ...
    ...
    def setExtent(self, __a0: int) -> None: ...
    ...
    def setLabelTable(self, __a0: java.util.Dictionary) -> None: ...
    ...
    def setMajorTickSpacing(self, __a0: int) -> None: ...

    @overload
    def setMaximum(self, fileSize: long) -> None:
        """
    ...
    @overload
    def setMaximum(self, __a0: int) -> None: ...

    def setMaximumSize(self, __a0: java.awt.Dimension) -> None: ...

    def setMinimum(self, __a0: int) -> None: ...

    def setMinimumSize(self, __a0: java.awt.Dimension) -> None: ...

    def setMinorTickSpacing(self, __a0: int) -> None: ...

    def setMixingCutoutShape(self, __a0: java.awt.Shape) -> None: ...

    def setModel(self, __a0: javax.swing.BoundedRangeModel) -> None: ...
    ...
    def setPaintLabels(self, __a0: bool) -> None: ...

    def setPaintTicks(self, __a0: bool) -> None: ...

    def setPaintTrack(self, __a0: bool) -> None: ...
    ...
    def setSnapToTicks(self, __a0: bool) -> None: ...

    def setToolTipText(self, __a0: unicode) -> None: ...

    def setTransferHandler(self, __a0: javax.swing.TransferHandler) -> None: ...

    def setUI(self, __a0: javax.swing.plaf.SliderUI) -> None: ...

    @overload
    def setValue(self, filePos: long) -> None:
        """
    ...
    def setValueIsAdjusting(self, __a0: bool) -> None: ...
    ...
    def syncWithViewport(self) -> None:
        """
