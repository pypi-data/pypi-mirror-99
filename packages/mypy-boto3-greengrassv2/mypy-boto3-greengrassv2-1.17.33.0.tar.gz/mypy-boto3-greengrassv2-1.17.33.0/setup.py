...
setup(
    ...
    description="Type annotations for boto3.GreengrassV2 1.17.33 service, generated by mypy-boto3-buider 4.4.0",
    classifiers=[
    ...
    keywords="boto3 greengrassv2 type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
