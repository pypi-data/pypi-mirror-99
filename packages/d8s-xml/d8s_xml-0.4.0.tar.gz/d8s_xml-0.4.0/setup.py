...
setup(
    name='d8s_xml',
    description="Democritus functions for working with XML.",
    long_description=readme,
    long_description_content_type="text/markdown",
    author="Floyd Hightower",
    author_email='floyd.hightower27@gmail.com',
    url='https://github.com/democritus-project/d8s-xml',
    ...
    license="MIT license",
    zip_safe=True,
    keywords="democritus,utility,python,xml,xml-utility",
    classifiers=[
