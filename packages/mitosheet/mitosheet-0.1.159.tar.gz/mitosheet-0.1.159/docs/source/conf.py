...
# -*- coding: utf-8 -*-
#
# mito documentation build configuration file
#
...
_version_py = os.path.join(repo, 'mito', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'mito.tex', 'mito Documentation',
     'Mito', 'manual'),
]
