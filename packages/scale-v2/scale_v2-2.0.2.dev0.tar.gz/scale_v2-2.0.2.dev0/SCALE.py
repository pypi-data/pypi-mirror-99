...
if __name__ == '__main__':
    ...
    parser.add_argument('--min_peaks', type=int, default=100)
    parser.add_argument('--min_cell_ratio', type=int, default=0.01)
