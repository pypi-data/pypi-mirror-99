...
def test_corn():
    ...
    tea = module.corn_tea
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.049338614545349116, rtol=1e-2)
    ...
    assert np.allclose(tea.installed_equipment_cost, 68091346.5729724, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 7540028.394826127, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 95.48918772049558, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 109.60334960044514, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 2.3398776669855312, rtol=1e-2)
...
def test_lipidcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.2021098002427277, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 108167304.97974095, rtol=1e-2)
    assert np.allclose(tea.material_cost, 61706431.98458194, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 208598245.91475707, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -24788905.439613696, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 222.90841003992878, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 222.15284042377215, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 9.209898026644808, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 88.66151802540669, rtol=1e-2)
    bst.process_tools.default()
...
def test_cornstover():
    ...
    assert np.allclose(product.price, 0.6916309409818583, rtol=1e-2)
    assert np.allclose(tea.sales, 127259957.33862731, rtol=1e-2)
    assert np.allclose(tea.material_cost, 76896133.26708354, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 216247603.78969324, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -11349642.249453217, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 308.8762900461569, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 345.8392329622445, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 22.866816847247968, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 46.46131825592197, rtol=1e-2)
    bst.process_tools.default()
...
def test_sugarcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.11621544819924606, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 86988832.46567929, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59809132.4945109, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 177116093.27791548, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -12076096.527550228, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 252.51987885480244, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 237.36317613337715, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 9.513194044503818, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 48.21863163280581, rtol=1e-2)
    bst.process_tools.default()
...
def test_LAOs():
    ...
    assert np.allclose(product.price, 1.3096597648870891, rtol=1e-2)
    assert np.allclose(tea.sales, 159158849.70467967, rtol=1e-2)
    assert np.allclose(tea.material_cost, 135661164.7725663, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 53861470.00082424, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 777422.2349223903, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 39.58733139285662, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 125.08498522827803, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 3.489755615051576, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 3.635648072402511, rtol=1e-2)
    bst.process_tools.default()
