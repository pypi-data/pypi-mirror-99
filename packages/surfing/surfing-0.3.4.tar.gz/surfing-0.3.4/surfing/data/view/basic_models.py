...
class AssetInfo(Base):
    ...
    asset_id = Column(CHAR(40), primary_key=True) # 代码
    real_id = Column(CHAR(20), primary_key=True) # 真实代码
    asset_name = Column(CHAR(15)) # 资产名
    real_name = Column(CHAR(40)) # 真实名字
    asset_type = Column(CHAR(10)) # 资产名
