...
class EmRawDataDownloader:
    ...
    def em_bond_clean_price(self, start_date: str, end_date: str, bond_list: Tuple[str] = ()):
        BLACK_SHEET = ['175449.SH', '175471.SH', 'n16042138.SH', 'n20110693.SZ', 'n20102723.SH',
...
if __name__ == '__main__':
    ...
    # em.em_bond_clean_price('20210319', '20210319')
    # em.em_bond_dirty_price('20210319', '20210319')
