...
class FOFBase:
    create_time = Column(DATETIME, nullable=False, default=datetime.datetime.now)  # 创建时间
    update_time = Column(DATETIME, nullable=False, default=datetime.datetime.now, onupdate=datetime.datetime.now)  # 更新时间
