...
class BasicDataPart1:
    ...
    def fund_benchmark_parser(self, file_path: str):
        ...
        df = pd.read_csv(file_path, header=0, index_col=1)
    ...
    def recalc_all_funds_benchmark(self, path: str):
        ...
        whole_funds_benchmark = all_funds_benchmark.join(now_fund_benchmark.set_index('em_id')[['assets', 'industry']], how='outer')
        ...
        BasicDataHelper()._upload_basic(whole_funds_benchmark.rename_axis(index='em_id').reset_index(), FundBenchmarkNew.__table__.name)
