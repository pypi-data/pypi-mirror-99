...
def helicsFederateEnterExecutingModeIterativeComplete(fed                ,)                         :
    """
...
def helicsEndpointSendEventRaw(
    endpoint                , destination     , data       , time            ,
):
    """
    Send a message at a specific time to the specified destination.
...
def helicsEndpointSubscribe(endpoint                , key     ):
    """
...
def helicsFederatePendingMessagesCount(fed                )       :
    """
...
def helicsEndpointPendingMessagesCount(endpoint                )       :
    """
    Returns the number of pending receives for all endpoints of a particular federate.
...
def helicsFederateRegisterSubscription(fed                , key     , units      = "")               :
    """
...
def helicsFederateRegisterInput(fed                , key     , type                , units     )               :
    """
...
def helicsFederateRegisterTypeInput(fed                , key     , type     , units     )               :
    """
...
def helicsFederateRegisterGlobalInput(fed                , key     , type                , units     )                     :
    """
...
def helicsFederateRegisterGlobalTypeInput(fed                , key     , type     , units     )               :
    """
...
def helicsFederateGetPublication(fed                , key     )                     :
    """
...
def helicsFederateGetInput(fed                , key     )               :
    """
...
def helicsFederateGetSubscription(fed                , key     )               :
    """
