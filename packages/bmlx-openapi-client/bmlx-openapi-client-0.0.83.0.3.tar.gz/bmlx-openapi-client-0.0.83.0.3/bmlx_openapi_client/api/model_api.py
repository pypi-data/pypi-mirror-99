...
class ModelApi(object):
    ...
    def get_model_by_id(self, id, **kwargs):  # noqa: E501
        """GetModel by id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_model_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_model_by_id_with_http_info(id, **kwargs)  # noqa: E501

    def get_model_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """GetModel by id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_model_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `get_model_by_id`")  # noqa: E501
