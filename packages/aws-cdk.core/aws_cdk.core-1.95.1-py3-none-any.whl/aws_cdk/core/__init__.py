...
class BundlingOptions:
    ...
    def image(self) -> BundlingDockerImage:
        ...
        return typing.cast(BundlingDockerImage, result)
...
class DependableTrait(
    ...
    def __jsii_proxy_class__() -> typing.Type["_DependableTraitProxy"]:
...
class DockerImage(
    ...
    def from_build(
        ...
        *,
        ...
        return typing.cast(BundlingDockerImage, jsii.sinvoke(cls, "fromBuild", [path, options]))
...
class FileAssetSource:
    def __init__(
        ...
        *,
        ...
        :param file_name: The path, relative to the root of the cloud assembly, in which this asset source resides. This can be a path to a file or a directory, dependning on the packaging type. Default: - Exactly one of ``directory`` and ``executable`` is required
...
class IDependable(typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_IDependableProxy"]:
