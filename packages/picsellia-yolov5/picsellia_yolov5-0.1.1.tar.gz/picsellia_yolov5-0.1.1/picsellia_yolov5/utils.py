...
def setup_hyp(exp_name, cfg, checkpoint_dir, config_dir, params={}, label_map=[]):
    ...
    for ff in os.listdir(config_dir):
        if ff.endswith('{}.yaml'.format(exp_name)):
            hyp_path = os.path.join(config_dir, ff)
