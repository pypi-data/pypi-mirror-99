...
setuptools.setup(
    name='pollination-annual-radiation',                                     # will be used for package name
    ...
    url='https://github.com/pollination/annual-radiation',                   # will be translated to home
    project_urls={
    ...
    description='Annual radiation recipe for Pollination.',                  # will be used as package description
    ...
    keywords='honeybee, radiance, ladybug-tools, daylight, annual-radiation',# will be used as keywords
