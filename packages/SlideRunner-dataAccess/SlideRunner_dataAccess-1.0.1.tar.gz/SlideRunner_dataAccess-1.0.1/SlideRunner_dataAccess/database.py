"""
   ...
   This file: Support for (SQLITE) databases 
...
#        query = 'INSERT INTO Annotations (coordinateX1, coordinateY1, coordinateX2, coordinateY2, slide, class1, person1) VALUES (%d,%d,%d,%d,%d,%d, %d)' % (x1,y1,x2,y2,slideUID,classID,annotator)
    ...
    def setAnnotationClickable(self, annoId:int, clickable:int):

        self.execute(f'UPDATE ANNOTATIONS SET clickable={clickable} where uid=={annoId}')
