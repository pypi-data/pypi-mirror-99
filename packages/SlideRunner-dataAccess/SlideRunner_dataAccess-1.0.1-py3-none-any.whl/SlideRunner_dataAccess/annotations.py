"""
   ...
   This file: Annotations (definition, visualization, interaction)
...
"""
  Annotation label class for plugins
"""
...
class annotation():
      ...
      def __init__(self, uid=0, text='',pluginAnnotationLabel=None):
          ...
          if (pluginAnnotationLabel is not None):
              if (isinstance(pluginAnnotationLabel, PluginAnnotationLabel)):
                  self.pluginAnnotationLabel = pluginAnnotationLabel
              else:
                  raise ValueError('pluginAnnotationLabel needs to be of class PluginAnnotationLabel')
