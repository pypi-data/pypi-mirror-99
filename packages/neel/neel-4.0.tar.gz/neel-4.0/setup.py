...
setup(
  name = 'neel',         # How you named your package folder (MyLib)
  packages = ['neel'],   # Chose the same as "name"
  version = '4.0',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'sum of two numbers',   # Give a short description about your library
