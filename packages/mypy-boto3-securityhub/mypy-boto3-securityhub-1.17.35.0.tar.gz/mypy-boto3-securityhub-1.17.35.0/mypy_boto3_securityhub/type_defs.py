...
CellTypeDef = TypedDict(
    "CellTypeDef", {"Column": int, "Row": int, "ColumnName": str, "CellReference": str}, total=False
)
...
ClassificationStatusTypeDef = TypedDict(
    "ClassificationStatusTypeDef", {"Code": str, "Reason": str}, total=False
)
...
CustomDataIdentifiersDetectionsTypeDef = TypedDict(
    "CustomDataIdentifiersDetectionsTypeDef",
    {"Count": int, "Arn": str, "Name": str, "Occurrences": "OccurrencesTypeDef"},
    total=False,
)

CustomDataIdentifiersResultTypeDef = TypedDict(
    "CustomDataIdentifiersResultTypeDef",
    {"Detections": List["CustomDataIdentifiersDetectionsTypeDef"], "TotalCount": int},
    total=False,
)
...
DataClassificationDetailsTypeDef = TypedDict(
    "DataClassificationDetailsTypeDef",
    {"DetailedResultsLocation": str, "Result": "ClassificationResultTypeDef"},
    total=False,
)
...
FindingProviderSeverityTypeDef = TypedDict(
    "FindingProviderSeverityTypeDef",
    {"Label": Literal["INFORMATIONAL", "LOW", "MEDIUM", "HIGH", "CRITICAL"], "Original": str},
    total=False,
)
...
PageTypeDef = TypedDict(
    "PageTypeDef",
    {"PageNumber": int, "LineRange": "RangeTypeDef", "OffsetRange": "RangeTypeDef"},
    total=False,
)
...
RangeTypeDef = TypedDict(
    "RangeTypeDef", {"Start": int, "End": int, "StartColumn": int}, total=False
)
...
SensitiveDataResultTypeDef = TypedDict(
    "SensitiveDataResultTypeDef",
    {"Category": str, "Detections": List["SensitiveDataDetectionsTypeDef"], "TotalCount": int},
    total=False,
)
