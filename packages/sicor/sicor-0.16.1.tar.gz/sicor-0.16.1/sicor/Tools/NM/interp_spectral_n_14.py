...
@jit(nopython=True, locals={'vi': float32,
                            ...
                            'b7': int8, 'b8': int8, 'b9': int8, 'b10': int8, 'b11': int8, 'b12': int8, 'b13': int8,
                            'v0': float32, 'v1': float32, 'v2': float32, 'v3': float32, 'v4': float32, 'v5': float32,
                            'v6': float32, 'v7': float32, 'v8': float32, 'v9': float32, 'v10': float32, 'v11': float32,
                            'v12': float32, 'v13': float32, })
                                                    ...
                                                    for i12 in d12:
                                                        for i13 in d13:
                                                            ...
                                                            v0 = sign(p0 - i0) * np.abs(
                                                                1.0 * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v1 = sign(p1 - i1) * np.abs(
                                                                (p0 - i0) * 1.0 * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v2 = sign(p2 - i2) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * 1.0 * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v3 = sign(p3 - i3) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * 1.0 *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v4 = sign(p4 - i4) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (1.0) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v5 = sign(p5 - i5) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * 1.0 * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v6 = sign(p6 - i6) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * 1.0 * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v7 = sign(p7 - i7) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * 1.0 * (p8 - i8) *
                                                                (p9 - i9) * (p10 - i10) * (p11 - i11) * (p12 - i12) *
                                                                (p13 - i13))
                                                            v8 = sign(p8 - i8) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) * (1.0) *
                                                                (p9 - i9) * (p10 - i10) * (p11 - i11) * (p12 - i12) *
                                                                (p13 - i13))
                                                            v9 = sign(p9 - i9) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * 1.0 * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v10 = sign(p10 - i10) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * 1.0 * (p11 - i11) *
                                                                (p12 - i12) * (p13 - i13))
                                                            v11 = sign(p11 - i11) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * 1.0 *
                                                                (p12 - i12) * (p13 - i13))
                                                            v12 = sign(p12 - i12) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (1.0) * (p13 - i13))
                                                            v13 = sign(p13 - i13) * np.abs(
                                                                (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) *
                                                                (p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) *
                                                                (p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11) *
                                                                (p12 - i12) * 1.0)
                                                            # works only in numba since the integer conversion of
                                                            # the b is handled trough the interface block,
                                                            # without numba add int()'s here
                                                            ...
                                                            b12 = np.int(i12 + sign(p12 - i12))
                                                            b13 = np.int(i13 + sign(p13 - i13))
                                                            # when writing, numba didn't support array striding,
                                                            # meant is: res[:] += vi*data[:,b0,b1,b2]
                                                            for ii in range(ndim):
                                                                # <- here decide weather spectral dimension
                                                                # is first or last
                                                                dat = data[b0, b1, b2, b3, b4, b5, b6, b7, b8, b9,
                                                                           b10, b11, b12, b13, ii]
                                                                res[ii] += vi * dat
                                                ...
                                                for i11 in d11:
                                                    for i12 in d12:
                                                        for i13 in d13:
                                                            ...
                                                            # works only in numba since the integer conversion
                                                            # of the b is handled trough the interface block,
                                                            # without numba add np.int()'s here
                                                            b0 = np.int(i0 + sign(p0 - i0))
                                                            ...
                                                            # meant is: res[:] += vi*data[:,b0,b1,b2]
                                                            for ii in range(ndim):
                                                                # <- here decide weather spectral dimension is
                                                                # first or last
                                                                dat = data[b0, b1, b2, b3, b4, b5, b6, b7, b8, b9,
                                                                           b10, b11, b12, b13, ii]
                                                                res[ii] += vi * dat
...
def __intp__(data, pt, dv, jacobean):
    ...
    d12 = np.zeros(2, dtype=int)
    d13 = np.zeros(2, dtype=int)
...
class intp(object):
    ...
    def __init__(self, data, axes=None, jacobean=True, caching=False, maxsize=2000,
                 hash_pattern="%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,"):
        """
        data : data: numpy array, last dimension is spectral one, over which interpolation is beeing carried over
        axes : list of 1D numpy arrays of shape data.shape(i), contaoning the scales for
        each dimension, not including values for the spectral dimension
        maxsize: max number of cached results, both for Jacobean and non Jacobean cac
        hes
    ...
    def interpolate(self, pt):
        ...
        p12, d12, r12 = int1d(self.data.shape[12], self.axes_x[12], self.axes_y[12], pt[12])
        p13, d13, r13 = int1d(self.data.shape[13], self.axes_x[13], self.axes_y[13], pt[13])
        # all ri must be one for pt to to be in the table
        rr = r0 * r1 * r2 * r3 * r4 * r5 * r6 * r7 * r8 * r9 * r10 * r11 * r12 * r13
        if rr != 1:
            raise ValueError("At least one dimension is out of bounds.")
        else:
            return __intp__(self.data, [p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13],
                            [d0, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13], jacobean=self.__jacobean__)
