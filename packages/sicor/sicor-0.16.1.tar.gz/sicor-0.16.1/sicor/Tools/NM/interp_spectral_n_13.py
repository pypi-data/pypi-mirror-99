...
@jit(nopython=True, locals={'vi': float32,
                            ...
                            'b7': int8, 'b8': int8, 'b9': int8, 'b10': int8, 'b11': int8, 'b12': int8,
                                            ...
                                            for i10 in d10:
                                                for i11 in d11:
                                                    for i12 in d12:
                                                        ...
                                                        vi = np.abs((p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                            p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) * (p8 - i8) * (
                                                                p9 - i9) * (p10 - i10) * (p11 - i11) * (
                                                                    p12 - i12))
                                                        ...
                                                        v5 = sign(p5 - i5) * np.abs(
                                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                                p4 - i4) * 1.0 * (p6 - i6) * (p7 - i7) * (p8 - i8) * (
                                                                    p9 - i9) * (p10 - i10) * (p11 - i11) * (p12 - i12))
                                                        v6 = sign(p6 - i6) * np.abs(
                                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                                p4 - i4) * (p5 - i5) * 1.0 * (p7 - i7) * (p8 - i8) * (
                                                                    p9 - i9) * (p10 - i10) * (p11 - i11) * (p12 - i12))
                                                        ...
                                                        v9 = sign(p9 - i9) * np.abs(
                                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                                p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) * (
                                                                    p8 - i8) * (p10 - i10) * (p11 - i11) * (p12 - i12))
                                                        v10 = sign(p10 - i10) * np.abs(
                                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                                p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) * (
                                                                    p8 - i8) * (p9 - i9) * (p11 - i11) * (p12 - i12))
                                                        v11 = sign(p11 - i11) * np.abs(
                                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                                p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) * (
                                                                    p8 - i8) * (p9 - i9) * (p10 - i10) * (p12 - i12))
                                                        v12 = sign(p12 - i12) * np.abs(
                                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (
                                                                p4 - i4) * (p5 - i5) * (p6 - i6) * (p7 - i7) * (
                                                                    p8 - i8) * (p9 - i9) * (p10 - i10) * (p11 - i11))
                                                        # works only in numba since the integer conversion of the
                                                        # b is handled trough the interface block, without numba
                                                        #  add int()'s here
                                                        ...
                                                        for ii in range(ndim):
                                                            ...
                                                            dat = data[b0, b1, b2, b3, b4, b5, b6, b7, b8,
                                                                       b9, b10, b11, b12, ii]
                                                            res[ii] += vi * dat
...
class intp(object):
    ...
    def __init__(self, data, axes=None, jacobean=True, caching=False, maxsize=2000,
                 hash_pattern="%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,"):
        """
        data : data: numpy array, last dimension is spectral one, over which interpolation is beeing carried over
        axes : list of 1D numpy arrays of shape data.shape(i), contaoning the scales for each
    ...
    def interpolate(self, pt):
        ...
        rr = r0 * r1 * r2 * r3 * r4 * r5 * r6 * r7 * r8 * r9 * r10 * r11 * r12
        if rr != 1:
            raise ValueError("At least one dimension is out of bounds.")
        else:
            return __intp__(self.data, [p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12],
                            [d0, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12], jacobean=self.__jacobean__)
