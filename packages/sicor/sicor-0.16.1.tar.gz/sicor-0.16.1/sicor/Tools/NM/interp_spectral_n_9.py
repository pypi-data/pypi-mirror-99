...
@jit(nopython=True, locals={'vi': float32,
                            ...
                            'v6': float32, 'v7': float32, 'v8': float32, })
                                ...
                                for i7 in d7:
                                    for i8 in d8:
                                        ...
                                        v0 = sign(p0 - i0) * np.abs(
                                            1.0 * (p1 - i1) * (p2 - i2) * (p3 - i3) * (p4 - i4) * (p5 - i5) * (
                                                p6 - i6) * (p7 - i7) * (p8 - i8))
                                        v1 = sign(p1 - i1) * np.abs(
                                            (p0 - i0) * 1.0 * (p2 - i2) * (p3 - i3) * (p4 - i4) * (p5 - i5) * (
                                                p6 - i6) * (p7 - i7) * (p8 - i8))
                                        v2 = sign(p2 - i2) * np.abs(
                                            (p0 - i0) * (p1 - i1) * 1.0 * (p3 - i3) * (p4 - i4) * (p5 - i5) * (
                                                p6 - i6) * (p7 - i7) * (p8 - i8))
                                        v3 = sign(p3 - i3) * np.abs(
                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * 1.0 * (p4 - i4) * (p5 - i5) * (
                                                p6 - i6) * (p7 - i7) * (p8 - i8))
                                        v4 = sign(p4 - i4) * np.abs(
                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * 1.0 * (p5 - i5) * (
                                                p6 - i6) * (p7 - i7) * (p8 - i8))
                                        v5 = sign(p5 - i5) * np.abs(
                                            (p0 - i0) * (p1 - i1) * (p2 - i2) * (p3 - i3) * (p4 - i4) * 1.0 * (
                                                p6 - i6) * (p7 - i7) * (p8 - i8))
                                        ...
                                        # handled trough the interface block, without numba add int()'s here
                                        ...
                                        for ii in range(ndim):
                                            ...
                                            dat = data[b0, b1, b2, b3, b4, b5, b6, b7, b8, ii]
                                            res[ii] += vi * dat
                                            grad[0, ii] += v0 * dat
                                            grad[1, ii] += v1 * dat
                                            grad[2, ii] += v2 * dat
                            ...
                            for i6 in d6:
                                for i7 in d7:
                                    for i8 in d8:
                                        ...
                                        # works only in numba since the integer conversion of the b is
                                        # handled trough the interface block, without numba add np.int()'s here
...
class intp(object):
    ...
    def __init__(self, data, axes=None, jacobean=True, caching=False, maxsize=2000,
                 hash_pattern="%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,"):
        """
    ...
    def interpolate(self, pt):
        ...
        rr = r0 * r1 * r2 * r3 * r4 * r5 * r6 * r7 * r8
        if rr != 1:
            raise ValueError("At least one dimension is out of bounds.")
        else:
            return __intp__(self.data, [p0, p1, p2, p3, p4, p5, p6, p7, p8], [d0, d1, d2, d3, d4, d5, d6, d7, d8],
