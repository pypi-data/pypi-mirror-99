                        ...
                        for i5 in d5:
                            for i6 in d6:
                                for i7 in d7:
                                    ...
                                    # the interface block, without numba add int()'s here
                                    ...
                                    for ii in range(ndim):
                                        ...
                                        dat = data[b0, b1, b2, b3, b4, b5, b6, b7, ii]
                                        res[ii] += vi * dat
                                        grad[0, ii] += v0 * dat
                                        grad[1, ii] += v1 * dat
                                        grad[2, ii] += v2 * dat
...
def __intp__(data, pt, dv, jacobean):
    ...
    if jacobean:
        grad = np.zeros((8, ndim_spectral))
        __intp_spectral__(data, res, grad, ndim_spectral,
                          pt[0], pt[1], pt[2], pt[3], pt[4], pt[5], pt[6], pt[7],
                          d0, d1, d2, d3, d4, d5, d6, d7)  # <- here decide weather spectral dimension is first or last
        ...
        __intp_spectral_no_jac__(data, res, ndim_spectral,
                                 ...
                                 d7)  # <- here decide weather spectral dimension is first or last
        return res


# class intp8_dx(object):
class intp(object):
    """
    ...
    def __init__(self, data, axes=None, jacobean=True, caching=False, maxsize=2000,
                 hash_pattern="%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,"):
        """
    ...
    def interpolate(self, pt):
        ...
        if rr != 1:
            ...
            return __intp__(self.data, [p0, p1, p2, p3, p4, p5, p6, p7], [d0, d1, d2, d3, d4, d5, d6, d7],
