...
@jit(nopython=True, locals={'vi': float32,
                            ...
                            'b7': int8, 'b8': int8, 'b9': int8, 'b10': int8,
                                        ...
                                        for i9 in d9:
                                            for i10 in d10:
                                                ...
                                                for ii in range(ndim):
                                                    ...
                                                    dat = data[b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, ii]
                                                    res[ii] += vi * dat
...
class intp(object):
    ...
    def __init__(self, data, axes=None, jacobean=True, caching=False, maxsize=2000,
                 hash_pattern="%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,"):
        """
    ...
    def interpolate(self, pt):
        ...
        rr = r0 * r1 * r2 * r3 * r4 * r5 * r6 * r7 * r8 * r9 * r10
        if rr != 1:
            raise ValueError("At least one dimension is out of bounds.")
        else:
            return __intp__(self.data, [p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10],
                            [d0, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10], jacobean=self.__jacobean__)
