 ...
 *     else:
 */
  __pyx_t_1 = __Pyx_HasAttr(__pyx_v_first, __pyx_n_u_start); if (unlikely(__pyx_t_1 == ((int)-1))) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 *     else:
 */
  __pyx_t_2 = __Pyx_HasAttr(__pyx_v_second, __pyx_n_u_start); if (unlikely(__pyx_t_2 == ((int)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
 ...
 */
  /*else*/ {
    __pyx_t_3 = __Pyx_PyObject_GetSlice(__pyx_v_second, 0, 2, NULL, NULL, &__pyx_slice_, 0, 1, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if ((likely(PyTuple_CheckExact(__pyx_t_3))) || (PyList_CheckExact(__pyx_t_3))) {
      PyObject* sequence = __pyx_t_3;
      Py_ssize_t size = __Pyx_PySequence_SIZE(sequence);
...
static PyMethodDef __pyx_methods[] = {
  {"overlap", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6Mikado_9utilities_7overlap_1overlap, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6Mikado_9utilities_7overlap_overlap},
  {0, 0, 0, 0}
};
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_overlap(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'overlap' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
