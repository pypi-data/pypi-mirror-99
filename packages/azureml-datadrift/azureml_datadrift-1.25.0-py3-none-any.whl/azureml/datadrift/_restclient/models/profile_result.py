...
class ProfileResult(Model):
    ...
    def __init__(self, column_name=None, type=None, min=None, max=None, count=None, missing_count=None, not_missing_count=None, percent_missing=None, error_count=None, empty_count=None, quantiles=None, moments=None, type_counts=None, value_counts=None, unique_values=None, histogram=None, s_type_counts=None):
