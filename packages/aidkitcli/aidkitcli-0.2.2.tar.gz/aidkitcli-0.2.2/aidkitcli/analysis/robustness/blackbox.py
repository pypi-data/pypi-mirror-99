"""Create a RequestModel to execute a Black-Box attack."""
from typing import Dict, List

from aidkitcli.core.analyses.blackbox import blackbox as request_factory
...
def blackbox(data: str,
             ...
             title: str = "Config Black-Box Attack"
             ) -> Dict[str, int]:
    """
    Execute a Black-Box Attack that creates one perturbation per file in the
    data set. The perturbation is then added to every eligible data point in
    the corresponding data file. Finally, the performance of the model on the
    clean and the perturbed data is displayed on a plot.
