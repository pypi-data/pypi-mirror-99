...
cascade_detail_title: "Detailed Description of the Cascade, Part 2 of 3" _NL
cascade_detail_header: "File   Atom    KARMA      Final Time       Final Energy            ...Final Direction Cosines...." _NL
    cascade_detail_data: pint _S ELEM _S pint _S pfloat _S pfloat (_S pfloat)~3 _NL
'''
...
class Transformer(lark.Transformer):
    ...
    def cascade_detail_data(self, args):
        # cascade_detail2_data: pint _S ELEM _S pint _S pfloat _S pfloat (_S pfloat)~3 _NL
        #   'File':args[0],
        #   'Atom':args[1],
        #   'Karma':args[2],
        #   'Final Time':args[3],
        #   'Final Energy':args[4],
        #   'Final Location X':args[5],
        #   'Final Location Y':args[6],
        #   'Final Location Z':args[7]
        args[1] = args[1].value
