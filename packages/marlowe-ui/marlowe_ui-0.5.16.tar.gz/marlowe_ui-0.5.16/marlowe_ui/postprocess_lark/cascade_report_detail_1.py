...
cascade_detail_title: "Detailed Description of the Cascade, Part 1 of 3" _NL
cascade_detail_header: "File   Atom   KARMA   Initial Time   Initial Energy           ......Initial Location......          Site   TRAK   NSEQ" _NL
    cascade_detail_data: pint _S ELEM _S pint _S pfloat _S pfloat (_S pfloat)~3 _S pint _S pint _S pint _NL
'''
...
class Transformer(lark.Transformer):
    ...
    def cascade_detail_data(self, args):
        ...
        #   'Karma':args[2],
        #   'Initial Time':args[3],
        #   'Initial Energy':args[4],
        #   'Initial Location X':args[5],
        #   'Initial Location Y':args[6],
        #   'Initial Location Z':args[7],
        #   'Initial Location Site':args[8],
        #   'Trak':args[9],
        #   'Nseq':args[10]
        args[1] = args[1].value
