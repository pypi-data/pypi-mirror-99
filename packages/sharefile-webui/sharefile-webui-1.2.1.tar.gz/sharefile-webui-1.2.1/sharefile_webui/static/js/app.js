class App {
	...
	_renderControls(){
		...
		let html = `<button id="controls-button-add-dir" data-param="New directory">Add new dir</button>`;
		container.empty();
		container.append(html);
						...
						html =
							...
							`<div class="file-container">` +
								...
								`<div class="file-buttons">` +
									...
									`<button class="file-button-rename-file" data-param-path="${filepath}" data-param-name="${filename}"">Rename file</button>` +
									`<button class="file-button-delete-file" data-param="${filepath}">Delete file</button>` +
								`</div>` +
							`</div>`
						}
						...
						if(filename == "/" || filename == ".."){
							...
							html =
								`<div class="dir-container">` +
									`<div class="dir"><a href="?context=${filepath}">${filename}</a></div>` +
									`<div class="image-buttons">` +
										`<button class="dir-button-rename-dir" data-param-path="${filepath}" data-param-name="${filename}">Rename dir</button>` +
