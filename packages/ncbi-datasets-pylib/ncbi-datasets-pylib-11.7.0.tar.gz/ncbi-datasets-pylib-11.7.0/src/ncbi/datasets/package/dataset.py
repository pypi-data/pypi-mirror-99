...
import ncbi.datasets.v1alpha1.reports.assembly_sequence_info_pb2 as sequence_report_pb2
...
import ncbi.datasets.v1alpha1.reports.microbigge_pb2 as microbigge_report_pb2
    ...
    def get_file_handle(self, file_name: str) -> TextIO:
        ...
        Parameters:
            file_name: Name of file within the data directory, e.g. if the full
                       datasets path is ncbi_dataset/data/GCF_000001405.39/chrX.fna,
                       file_name should be GCF_000001405.39/chrX.fna
        Returns:
        ...
        if self.dataset_zip:
            try:
                ...
                with io.TextIOWrapper(self.dataset_zip.open(zinfo), encoding='utf-8') as fh:
                    yield fh
