...
class WarningGeneWarningCode(object):
    ...
    allowable_values = [UNKNOWN_GENE_WARNING_CODE, ACCESSION_VERSION_MISMATCH, REPLACED_GENE_ID, DISCONTINUED_GENE_ID, UNRECOGNIZED_GENE_ID, UNRECOGNIZED_GENE_SYMBOL, UNRECOGNIZED_ACCESSION, UNRECOGNIZED_TAX_TOKEN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """WarningGeneWarningCode - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WarningGeneWarningCode):
            return False
