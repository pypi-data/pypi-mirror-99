...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='ncbi/datasets/v1alpha1/mongo_options.proto',
  package='ncbi.datasets.v1alpha1',
  syntax='proto3',
  serialized_options=b'Z\026ncbi/datasets/v1alpha1\370\001\001',
  serialized_pb=b'\n*ncbi/datasets/v1alpha1/mongo_options.proto\x12\x16ncbi.datasets.v1alpha1\x1a google/protobuf/descriptor.proto\"G\n\x13MongoMessageOptions\x12\x1e\n\ncollection\x18\x01 \x01(\tR\ncollection\x12\x10\n\x03key\x18\x02 \x01(\tR\x03key\"\xc8\x03\n\x11MongoFieldOptions\x12\x1a\n\x08required\x18\x01 \x01(\x08R\x08required\x12\x45\n\x04spec\x18\x02 \x01(\x0b\x32\x31.ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpecR\x04spec\x1a\xcf\x02\n\x07ObjSpec\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n\tbson_type\x18\x02 \x01(\tR\x08\x62sonType\x12S\n\nproperties\x18\x03 \x01(\x0b\x32\x31.ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpecH\x00R\nproperties\x12I\n\x05items\x18\x04 \x01(\x0b\x32\x31.ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpecH\x00R\x05items\x12h\n\x15\x61\x64\x64itional_properties\x18\x05 \x01(\x0b\x32\x31.ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpecH\x00R\x14\x61\x64\x64itionalPropertiesB\t\n\x07\x63ontent:k\n\x0bmongo_field\x12\x1d.google.protobuf.FieldOptions\x18\xa1\x96\x03 \x01(\x0b\x32).ncbi.datasets.v1alpha1.MongoFieldOptionsR\nmongoField:y\n\x10mongo_collection\x12\x1f.google.protobuf.MessageOptions\x18\xb8\x8e\x03 \x01(\x0b\x32+.ncbi.datasets.v1alpha1.MongoMessageOptionsR\x0fmongoCollectionB\x1bZ\x16ncbi/datasets/v1alpha1\xf8\x01\x01\x62\x06proto3'
  ,
...
mongo_field = _descriptor.FieldDescriptor(
  name='mongo_field', full_name='ncbi.datasets.v1alpha1.mongo_field', index=0,
  number=52001, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='mongoField', file=DESCRIPTOR)
MONGO_COLLECTION_FIELD_NUMBER = 51000
mongo_collection = _descriptor.FieldDescriptor(
  name='mongo_collection', full_name='ncbi.datasets.v1alpha1.mongo_collection', index=1,
  number=51000, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='mongoCollection', file=DESCRIPTOR)


_MONGOMESSAGEOPTIONS = _descriptor.Descriptor(
  name='MongoMessageOptions',
  full_name='ncbi.datasets.v1alpha1.MongoMessageOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='collection', full_name='ncbi.datasets.v1alpha1.MongoMessageOptions.collection', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='key', full_name='ncbi.datasets.v1alpha1.MongoMessageOptions.key', index=1,
...
_MONGOFIELDOPTIONS_OBJSPEC = _descriptor.Descriptor(
  name='ObjSpec',
  full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='bson_type', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec.bson_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='bsonType', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='properties', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec.properties', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='properties', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='items', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec.items', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='additional_properties', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec.additional_properties', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='additionalProperties', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='content', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec.content',
...
_MONGOFIELDOPTIONS = _descriptor.Descriptor(
  ...
  full_name='ncbi.datasets.v1alpha1.MongoFieldOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='required', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.required', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='required', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spec', full_name='ncbi.datasets.v1alpha1.MongoFieldOptions.spec', index=1,
...
MongoMessageOptions = _reflection.GeneratedProtocolMessageType('MongoMessageOptions', (_message.Message,), {
  ...
  '__module__' : 'ncbi.datasets.v1alpha1.mongo_options_pb2'
  # @@protoc_insertion_point(class_scope:ncbi.datasets.v1alpha1.MongoMessageOptions)
  })
...
MongoFieldOptions = _reflection.GeneratedProtocolMessageType('MongoFieldOptions', (_message.Message,), {
  ...
  'ObjSpec' : _reflection.GeneratedProtocolMessageType('ObjSpec', (_message.Message,), {
    ...
    '__module__' : 'ncbi.datasets.v1alpha1.mongo_options_pb2'
    # @@protoc_insertion_point(class_scope:ncbi.datasets.v1alpha1.MongoFieldOptions.ObjSpec)
    })
  ,
  'DESCRIPTOR' : _MONGOFIELDOPTIONS,
  '__module__' : 'ncbi.datasets.v1alpha1.mongo_options_pb2'
  # @@protoc_insertion_point(class_scope:ncbi.datasets.v1alpha1.MongoFieldOptions)
  })
