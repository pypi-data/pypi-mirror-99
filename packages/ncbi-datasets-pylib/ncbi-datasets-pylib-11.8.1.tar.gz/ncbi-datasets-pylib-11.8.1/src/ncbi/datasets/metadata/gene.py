...
from ncbi.datasets.openapi.models import V1alpha1GeneMatch
from ncbi.datasets.openapi.models import V1alpha1GeneDescriptor


def print_gene_warning_or_error(gene: V1alpha1GeneMatch):
...
def gene_values_by_fields(gene_descriptor: V1alpha1GeneDescriptor, fields=List[str]):
...
def print_gene_metadata_by_fields(gene: V1alpha1GeneMatch, fields=List[str]):
    """Reports selected fields for a V1alpha1GeneMatch object to stdout
