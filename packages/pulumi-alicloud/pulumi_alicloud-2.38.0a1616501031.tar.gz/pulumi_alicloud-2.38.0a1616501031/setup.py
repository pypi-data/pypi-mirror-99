...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.38.0-alpha.1616501031+0847e4c5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.38.0-alpha.1616501031+0847e4c5`
                """)
            else:
                raise
