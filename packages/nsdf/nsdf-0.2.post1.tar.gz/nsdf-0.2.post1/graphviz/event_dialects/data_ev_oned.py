...
def add_leaf(G, parent, leaf_name, leaf_html):
    G.add_node(leaf_name, label=leaf_html, shape='box', style='filled', concentrate=True, width=width_box,
               fontname=font_name, fontsize=font_size, fillcolor=NODE_5)
...
neuronA = '<<TABLE ALIGN="CENTER" BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="2" FIXEDSIZE="TRUE"> <TR><TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">sp[1]</TD> <TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">...</TD> <TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">sp[11]</TD> </TR> </TABLE>>'

neuronB = '<<TABLE ALIGN="CENTER" BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="2" FIXEDSIZE="TRUE"> <TR><TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">sp[1]</TD> <TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">...</TD> <TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">sp[13]</TD> </TR> </TABLE>>'


dir_list = ['/cells/spikes/neuronA',
            '/cells/spikes/neuronB']

G = gen_figure(dir_list)
add_leaf(G, dir_list[0], 'neuronA', neuronA)
add_leaf(G, dir_list[1], 'neuronB', neuronB)

G.layout('dot')
G.draw('data_ev_oned.svg')
