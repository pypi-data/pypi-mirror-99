...
def gen_figure(dir_list):
    ...
    G.add_node('/', label='map', shape=subgrp_shape, style='filled', concentrate=True, width=width_box,
    ...
    for path in dir_list:
        ...
        for ii,sub_folder in enumerate(sub_dirs):
            try: 
                ...
                if ii==0:
                    add_child(G, '/', sub_folder, NODE_COLOR[ii+2], False)
                elif ii==1:
...
neuronA = '<<TABLE ALIGN="CENTER" BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="2" FIXEDSIZE="TRUE"> <TR> <TD WIDTH="150" HEIGHT="40" FIXEDSIZE="TRUE" ALIGN="CENTER">/model/filecontents/...<BR/>Cell.xml/neuronA/soma</TD></TR> <TR> <TD ALIGN="CENTER" WIDTH="150" HEIGHT="40" FIXEDSIZE="TRUE">/model/filecontents/...<BR/>Cell.xml/neuronA/axon</TD></TR></TABLE>>'

dir_list = ['/uniform/neuronA']
