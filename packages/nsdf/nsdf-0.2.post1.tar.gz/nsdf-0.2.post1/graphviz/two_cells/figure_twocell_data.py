...
Im1 = '<<TABLE ALIGN="CENTER" BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="2" FIXEDSIZE="TRUE"> <TR><TD WIDTH="50" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">soma[1]</TD> <TD WIDTH="50" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">...</TD> <TD WIDTH="50" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">soma[M]</TD> </TR> <TR> <TD ALIGN="CENTER" WIDTH="50" HEIGHT="30" FIXEDSIZE="TRUE">dend[1]</TD> <TD ALIGN="CENTER" WIDTH="50" HEIGHT="30" FIXEDSIZE="TRUE">...</TD> <TD ALIGN="CENTER" WIDTH="50" HEIGHT="30" FIXEDSIZE="TRUE">dend[M]</TD> </TR></TABLE>>'
...
dir_list = ['/data/static/cells/synapses',
            '/data/uniform/neuronA/Vm',
            '/data/uniform/neuronA/Im',
            '/data/nonuniform/neuronB/Im',
            '/data/event/cells/spikes']
