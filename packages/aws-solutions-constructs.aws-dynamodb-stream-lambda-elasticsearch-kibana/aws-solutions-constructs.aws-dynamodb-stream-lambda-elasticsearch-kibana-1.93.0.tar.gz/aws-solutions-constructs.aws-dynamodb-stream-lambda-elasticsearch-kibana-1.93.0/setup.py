    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodb-stream-lambda-elasticsearch-kibana@1.93.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.core==1.93.0",
        "aws-solutions-constructs.aws-dynamodb-stream-lambda==1.93.0",
        "aws-solutions-constructs.aws-lambda-elasticsearch-kibana==1.93.0",
