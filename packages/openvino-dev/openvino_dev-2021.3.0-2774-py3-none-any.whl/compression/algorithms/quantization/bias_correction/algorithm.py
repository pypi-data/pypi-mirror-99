...
from ....graph.special_operations import OPERATIONS_WITH_BIAS, SPLIT_OPERATIONS
...
class BiasCorrection(Algorithm):
    ...
    def _compute_bias_shift(self, model_copy, **params):
        ...
        if model_copy.is_cascade:
            ref_stats_layout = {add_name: {'mean_per_channel': asf.mean_per_channel}}
            ...
            for feed_dict in params['feed_dicts']:
                ...
                q_outputs.append(asf.mean_per_channel(q_output[add_name]))
    ...
    def register_statistics(self, model, stats_collector):
        ...
        for node in topological_biased_ops:
            ...
            statistics_layout[add_node.name] = {'mean_per_channel': asf.mean_per_channel}
