...
class PatternBuilder:
    ...
    def insert_swish(self, input_node=None, output_node=None, remove_orig_edge=True):
        ...
        self.insert_single_op(input_node, output_node, 'Sigmoid', 'act', remove_orig_edge)
        return self.insert_single_op([input_node, self._tail()], output_node, 'Multiply', 'multiply')
