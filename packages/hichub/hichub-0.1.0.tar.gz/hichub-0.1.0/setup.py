...
setup(
    ...
    description="Comprehensive Network Analysis for HiC",  # Optional
    ...
    # project.
    author='Xiang Li',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='lux@gwu.edu',  # Optional
    ...
    # larger catalog.
    keywords='HiC, graph, Hub',  # Optional
    ...
    data_files=[('test_data', ['tests/chr10_test.bed'])],  # Optional
