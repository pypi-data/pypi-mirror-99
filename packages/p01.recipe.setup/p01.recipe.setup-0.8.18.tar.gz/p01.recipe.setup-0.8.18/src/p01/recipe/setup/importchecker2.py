...
$Id: importchecker2.py 5080 2021-01-21 14:44:34Z roger.ineichen $
"""
import compiler
import os
import os.path
...
class Module:
    ...
    def getImportNames(self):
        ...
        result = []
        map = self._map
        for module_name in list(map.keys()):
            for usedname, originalname in list(map[module_name]['names'].items()):
    ...
    def getUnusedImports(self):
        ...
        """
        result = []
        for value in list(self._map.values()):
            for usedname, originalname in list(value['names'].items()):
...
class ImportDatabase:
    ...
    def getModulesImportingNameFrom(self, name, module):
        ...
        """
        result = []
        for path in list(self._names.get((module.getPath(), name), {}).keys()):
