...
# the main functions
def copyone(dc, src, dst, overwrite=False):
...
def copytree(dc, src, dst, overwrite=False):
...
def moveone(dc, src, dst, overwrite=False):
...
def movetree(dc, src, dst, overwrite=False):
    """ move a collection
