...
class Interaction:
    ...
    @property
    def expired(self):
        if self.__expired: return True
        self.__expired = datetime.datetime.utcnow() - self.created_at > datetime.timedelta(minutes=15)
    ...
    async def reply(self, content=None, *,  embed=None, embeds=None,
        ...
        '''
        # If expired, use TextChannel.send instead
        if self.expired:
        ...
        if ephemeral or is_empty_message:
            return None
        self.editable = True
