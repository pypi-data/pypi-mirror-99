...
class EdgeFunction(
    ...
    def add_alias(
        ...
        *,
        ...
        return typing.cast(aws_cdk.aws_lambda.Alias, jsii.invoke(self, "addAlias", [alias_name, options]))
    ...
    def add_event_source_mapping(
        ...
        *,
        ...
        retry_attempts: typing.Optional[jsii.Number] = None,
        source_access_configurations: typing.Optional[typing.List[aws_cdk.aws_lambda.SourceAccessConfiguration]] = None,
        ...
        return typing.cast(aws_cdk.aws_lambda.EventSourceMapping, jsii.invoke(self, "addEventSourceMapping", [id, options]))
    ...
    def grant_invoke(
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grantInvoke", [identity]))
    ...
    def metric_errors(
        ...
        *,
        ...
        return typing.cast(aws_cdk.aws_cloudwatch.Metric, jsii.invoke(self, "metricErrors", [props]))
    ...
    def metric_throttles(
        ...
        *,
        ...
        return typing.cast(aws_cdk.aws_cloudwatch.Metric, jsii.invoke(self, "metricThrottles", [props]))
    ...
    def current_version(self) -> aws_cdk.aws_lambda.IVersion:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_lambda.IVersion, jsii.get(self, "currentVersion"))
    ...
    def latest_version(self) -> aws_cdk.aws_lambda.IVersion:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_lambda.IVersion, jsii.get(self, "latestVersion"))
    ...
    def permissions_node(self) -> aws_cdk.core.ConstructNode:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.core.ConstructNode, jsii.get(self, "permissionsNode"))
