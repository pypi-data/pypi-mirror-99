...
from jdcloud_cli.controllers.services.resourcetag import ResourcetagController
...
from jdcloud_cli.controllers.services.lb import LbController
...
def main():
    ...
    with JDC() as app:
        ...
        app.handler.register(LbController)
