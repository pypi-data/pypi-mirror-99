...
class JdccsController(BaseController):
    ...
    @expose(
        arguments=[
            (['--api'], dict(help="""(string) api name """, choices=['describe-alarms','create-alarm','describe-alarm','delete-alarm','describe-alarm-history','switch-alarm','describe-metrics','describe-metric-data','last-downsample','describe-bandwidth-traffics','describe-bandwidth-traffic','describe-traffic-sampling','describe-idcs','describe-rooms','describe-cabinets','describe-cabinet','describe-devices','describe-device','describe-ips','describe-bandwidths','describe-bandwidth','describe-idc-overview','describe-tickets','describe-ticket','create-general-services-ticket',], required=True)),
        ],
        formatter_class=RawTextHelpFormatter,
