...
class IotcoreController(BaseController):
    ...
    @expose(
        ...
        description='''
            ...
            示例: jdc iotcore create-admin-product  --instance-id xxx --product-name xxx --product-type 0 --coll-device-type xxx
        ''',
    )
    ...
    @expose(
        arguments=[
            (['--api'], dict(help="""(string) api name """, choices=['register-device','download-device-certificate','delete-device','describe-device','describe-thing-type-list','describe-thing-type','describe-thing-model','set-device-property','invoke-function','describe-event-list','describe-function-list','describe-property','describe-property-snapshot','create-device-topo','describe-device-topo','update-device-topo','delete-device-topo','invoke-thing-topic','describe-thing-shadow','update-thing-shadow','invoke-thing-service','add-device-links','query-device-page','update-device','add-device','query-device-detail','remove-device','get-device-group','get-device-group-list','find-device-group-link-page','elevator-operating-status','collector-read-message','read-holding-registers','collector-write-message','update-loo-device','add-loo-device','loongray-query-page','query-admin-statistics','remove-loongray-device','describe-product-with-admin','update-product-with-admin','delete-product-with-admin','list-products-with-admin','create-admin-product','list-products','create-product','describe-product','update-product','delete-product','list-product-abilities','import-thing-model','export-thing-model','describe-product-topics','create-product-topic','describe-product-topic',], required=True)),
        ],
        formatter_class=RawTextHelpFormatter,
