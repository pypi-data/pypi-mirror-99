...
class VodController(BaseController):
    ...
    @expose(
        ...
        formatter_class=RawTextHelpFormatter,
        help=''' 查询截图模板列表。; 允许通过条件过滤查询，支持的过滤字段如下：;   - templateType[eq] 按模板类型精确查询;  ''',
        description='''
            查询截图模板列表。; 允许通过条件过滤查询，支持的过滤字段如下：;   - templateType[eq] 按模板类型精确查询; 。
    ...
    @expose(
        arguments=[
            (['--template-name'], dict(help="""(string) 模板名称 """, dest='templateName',  required=True)),
            (['--template-type'], dict(help="""(string) 模板类型。取值范围：;   sample - 采样截图模板;   sprite - 雪碧图模板;  """, dest='templateType',  required=True)),
            (['--template-config'], dict(help="""(string) 模板配置，JSON格式的字符串; 若 templateType 取值 sample，则JSON字符串须符合 SnapshotTemplateSampleConfigInfo 格式; 若 templateType 取值 sprite，则JSON字符串须符合 SnapshotTemplateSpriteConfigInfo 格式;  """, dest='templateConfig',  required=True)),
            (['--input-json'], dict(help='(json) 以json字符串或文件绝对路径形式作为输入参数。\n字符串方式举例：--input-json \'{"field":"value"}\';\n文件格式举例：--input-json file:///xxxx.json', dest='input_json', required=False)),
            (['--headers'], dict(help="""(json) 用户自定义Header，举例：'{"x-jdcloud-security-token":"abc","test":"123"}'""", dest='headers', required=False)),
        ],
        formatter_class=RawTextHelpFormatter,
        ...
        description='''
            ...
            示例: jdc vod create-snapshot-template  --template-name xxx --template-type xxx --template-config xxx
        ''',
    )
    ...
    @expose(
        ...
        description='''
            ...
            示例: jdc vod get-snapshot-template  --template-id 5
        ''',
    )
    ...
    @expose(
        arguments=[
            (['--template-id'], dict(help="""(int) 模板ID """, dest='templateId', type=int, required=True)),
            (['--template-name'], dict(help="""(string) 模板名称 """, dest='templateName',  required=False)),
            (['--template-config'], dict(help="""(string) 模板配置，JSON格式的字符串 """, dest='templateConfig',  required=False)),
            (['--input-json'], dict(help='(json) 以json字符串或文件绝对路径形式作为输入参数。\n字符串方式举例：--input-json \'{"field":"value"}\';\n文件格式举例：--input-json file:///xxxx.json', dest='input_json', required=False)),
            (['--headers'], dict(help="""(json) 用户自定义Header，举例：'{"x-jdcloud-security-token":"abc","test":"123"}'""", dest='headers', required=False)),
        ],
        formatter_class=RawTextHelpFormatter,
        ...
        description='''
            ...
            示例: jdc vod update-snapshot-template  --template-id 5
        ''',
    )
    ...
    @expose(
        ...
        description='''
            ...
            示例: jdc vod delete-snapshot-template  --template-id 5
        ''',
    )
