...
class EliteController(BaseController):
    ...
    @expose(
        ...
        description='''
            ...
            示例: jdc elite jdx-query-delivery-info  --order-number xxx
        ''',
    )
    ...
    def jdx_query_product(self):
        ...
        try:
            from jdcloud_sdk.services.elite.apis.JdxQueryProductRequest import JdxQueryProductRequest
            params_dict = collect_user_args(self.app)
            headers = collect_user_headers(self.app)
            req = JdxQueryProductRequest(params_dict, headers)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print('{"error":"This api is not supported, please use the newer version"}')
