...
from tensorflow_probability.substrates.jax.distributions import inverse_gaussian
...
#   `tensorflow_probability/substrates/jax/distributions/normal_inverse_gaussian.py`
