...
from tensorflow_probability.substrates.jax.distributions import log_prob_ratio
...
#   `tensorflow_probability/substrates/jax/experimental/distribute/sharded.py`
