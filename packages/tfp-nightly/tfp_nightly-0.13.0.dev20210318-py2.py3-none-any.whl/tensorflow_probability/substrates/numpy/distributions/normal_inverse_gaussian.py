...
from tensorflow_probability.substrates.numpy.distributions import inverse_gaussian
...
#   `tensorflow_probability/substrates/numpy/distributions/normal_inverse_gaussian.py`
