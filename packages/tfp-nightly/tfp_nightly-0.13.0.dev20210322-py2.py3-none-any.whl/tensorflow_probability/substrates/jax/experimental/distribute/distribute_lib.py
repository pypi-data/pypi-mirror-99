...
from tensorflow_probability.substrates.jax.math import gradient as math_gradient
...
#   `tensorflow_probability/substrates/jax/experimental/distribute/distribute_lib.py`
