...
from tensorflow_probability.substrates.jax.math import value_and_gradient
...
#   `tensorflow_probability/substrates/jax/experimental/mcmc/weighted_resampling.py`
