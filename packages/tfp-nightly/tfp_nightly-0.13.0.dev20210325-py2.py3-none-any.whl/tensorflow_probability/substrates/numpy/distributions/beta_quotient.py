...
from tensorflow_probability.substrates.numpy.math import hypergeometric as hypgeo
...
#   `tensorflow_probability/substrates/numpy/distributions/beta_quotient.py`
