...
from mastapy.detailed_rigid_connectors.splines import (
    _1162, _1179, _1154, _1157,
    _1161, _1164, _1165, _1172,
    _1184
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1185
from mastapy.detailed_rigid_connectors import _1152
...
class SplineHalfDesign(_1152.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1162.HeatTreatmentTypes':
        ...
        return constructor.new(_1162.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1162.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1185.FitAndTolerance':
        ...
        return constructor.new(_1185.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
