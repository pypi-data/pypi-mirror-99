...
from mastapy.detailed_rigid_connectors.splines import _1166, _1175, _1183
...
class DIN5480SplineHalfDesign(_1183.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1166.ManufacturingTypes':
        ...
        return constructor.new(_1166.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1166.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1175.FinishingMethods':
        ...
        return constructor.new(_1175.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1175.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
