...
from mastapy.detailed_rigid_connectors.splines.ratings import _1195
...
class SplineJointRating(_1200.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1195.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1195.SplineHalfRating))
        return value
