...
from mastapy.bearings.tolerances import _1626, _1612, _1618
...
class InterferenceFitHalfDesign(_1152.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1211.StressRegions':
        ...
        return constructor.new(_1211.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1626.SupportTolerance':
        ...
        if _1626.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1612.InnerSupportTolerance':
        ...
        if _1612.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1618.OuterSupportTolerance':
        ...
        if _1618.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
