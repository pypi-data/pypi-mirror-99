...
from mastapy.detailed_rigid_connectors.interference_fits import _1208, _1207, _1212
...
class InterferenceFitDesign(_1151.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1208.CalculationMethods':
        ...
        return constructor.new(_1208.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1208.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1207.AssemblyMethods':
        ...
        return constructor.new(_1207.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1207.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
