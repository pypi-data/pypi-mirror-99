...
class KeywayRating(_1213.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1201.KeyedJointDesign':
        ...
        return constructor.new(_1201.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign else None

    @property
    def keyway_half_ratings(self) -> 'List[_1205.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1205.KeywayHalfRating))
        return value
