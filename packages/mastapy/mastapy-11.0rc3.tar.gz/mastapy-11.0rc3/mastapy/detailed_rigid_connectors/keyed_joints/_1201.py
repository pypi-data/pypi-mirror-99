...
from mastapy.detailed_rigid_connectors.keyed_joints import _1204, _1202
...
class KeyedJointDesign(_1209.InterferenceFitDesign):
    '''KeyedJointDesign
