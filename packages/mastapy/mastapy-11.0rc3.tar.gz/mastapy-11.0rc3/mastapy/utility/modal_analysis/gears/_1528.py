...
from mastapy.utility.modal_analysis.gears import _1529, _1533
...
class GearMeshForTE(_1533.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1529.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1529.GearOrderForTE))
        return value
