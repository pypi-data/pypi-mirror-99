...
from mastapy.html import _267
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.report import _1494
...
class CustomReportText(_1494.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_267.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_267.HeadingType)(value) if value else None

    @heading_type.setter
    def heading_type(self, value: '_267.HeadingType'):
