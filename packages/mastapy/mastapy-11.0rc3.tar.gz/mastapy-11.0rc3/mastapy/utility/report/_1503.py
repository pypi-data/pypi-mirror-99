...
from mastapy.utility.report import _1504, _1507
...
TItem = TypeVar('TItem', bound='_1507.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1504.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
