...
from mastapy.utility.databases import _1556, _1558, _1557
...
TValue = TypeVar('TValue', bound='_1556.NamedDatabaseItem')


class NamedDatabase(_1558.SQLDatabase['_1557.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1556.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1556.NamedDatabaseItem') -> '_1556.NamedDatabaseItem':
        ...
        new_name = str(new_name)
        method_result = self.wrapped.Duplicate(new_name if new_name else None, item.wrapped if item else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None
