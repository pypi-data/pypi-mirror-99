...
from mastapy.utility.units_and_measurements.measurements import _1391
...
class DutyCyclePropertySummaryForce(_1563.DutyCyclePropertySummary['_1391.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
