...
from mastapy.utility.units_and_measurements.measurements import _1370
...
class DutyCyclePropertySummarySmallAngle(_1563.DutyCyclePropertySummary['_1370.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
