...
class ParetoOptimistaionVariable(_1315.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1317.PropertyTargetForDominantCandidateSearch':
    ...
    def property_target_for_dominant_candidate_search(self, value: '_1317.PropertyTargetForDominantCandidateSearch'):
