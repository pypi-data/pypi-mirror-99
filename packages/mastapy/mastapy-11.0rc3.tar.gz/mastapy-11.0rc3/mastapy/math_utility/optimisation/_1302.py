...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1309.ParetoOptimisationInput':
        ...
        return constructor.new(_1309.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
