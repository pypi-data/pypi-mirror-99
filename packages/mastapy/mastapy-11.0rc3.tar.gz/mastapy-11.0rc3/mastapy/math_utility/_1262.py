...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    def coordinate_system_for_rotation_origin(self) -> '_1264.CoordinateSystemForRotationOrigin':
        ...
        return constructor.new(_1264.CoordinateSystemForRotationOrigin)(value) if value else None

    @coordinate_system_for_rotation_origin.setter
    def coordinate_system_for_rotation_origin(self, value: '_1264.CoordinateSystemForRotationOrigin'):
    ...
    @property
    def rotation_axis(self) -> '_1290.RotationAxis':
        '''RotationAxis: 'RotationAxis' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RotationAxis)
        return constructor.new(_1290.RotationAxis)(value) if value else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1290.RotationAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RotationAxis = value

    @property
    def coordinate_system_for_rotation_axes(self) -> '_1263.CoordinateSystemForRotation':
        ...
        return constructor.new(_1263.CoordinateSystemForRotation)(value) if value else None

    @coordinate_system_for_rotation_axes.setter
    def coordinate_system_for_rotation_axes(self, value: '_1263.CoordinateSystemForRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def modified_coordinate_system_for_rotation(self) -> '_1261.CoordinateSystem3D':
        ...
        return constructor.new(_1261.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForRotation) if self.wrapped.ModifiedCoordinateSystemForRotation else None

    @property
    def modified_coordinate_system_for_translation(self) -> '_1261.CoordinateSystem3D':
        ...
        return constructor.new(_1261.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForTranslation) if self.wrapped.ModifiedCoordinateSystemForTranslation else None
