...
from mastapy.materials import _238, _224
...
class Material(_1556.NamedDatabaseItem):
    '''Material
    ...
    @property
    def standard(self) -> '_238.MaterialStandards':
        '''MaterialStandards: 'Standard' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Standard)
        return constructor.new(_238.MaterialStandards)(value) if value else None

    @standard.setter
    def standard(self, value: '_238.MaterialStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Standard = value

    @property
    def hardness_type(self) -> '_224.HardnessType':
        '''HardnessType: 'HardnessType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HardnessType)
        return constructor.new(_224.HardnessType)(value) if value else None

    @hardness_type.setter
    def hardness_type(self, value: '_224.HardnessType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
