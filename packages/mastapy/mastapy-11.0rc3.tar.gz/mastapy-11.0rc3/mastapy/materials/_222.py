...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_251.TransmissionApplications':
        ...
        return constructor.new(_251.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_251.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_225.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_225.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_225.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def include_ansiabma_ratings(self) -> 'bool':
        ...
        return self.wrapped.IncludeANSIABMARatings

    @include_ansiabma_ratings.setter
    def include_ansiabma_ratings(self, value: 'bool'):
        self.wrapped.IncludeANSIABMARatings = bool(value) if value else False
    ...
    @property
    def wind_turbine_standard(self) -> '_254.WindTurbineStandards':
        ...
        return constructor.new(_254.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_254.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_255.WorkingCharacteristics':
        ...
        return constructor.new(_255.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_255.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_255.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_255.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def gearing_type(self) -> '_221.GearingTypes':
        '''GearingTypes: 'GearingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GearingType)
        return constructor.new(_221.GearingTypes)(value) if value else None

    @gearing_type.setter
    def gearing_type(self, value: '_221.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_253.VehicleDynamicsProperties':
        ...
        return constructor.new(_253.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_211.AirProperties':
        ...
        return constructor.new(_211.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
