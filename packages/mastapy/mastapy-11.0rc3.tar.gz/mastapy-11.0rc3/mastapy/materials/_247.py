...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_248.SoundPressureEnclosureType':
        ...
        return constructor.new(_248.SoundPressureEnclosureType)(value) if value else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_248.SoundPressureEnclosureType'):
