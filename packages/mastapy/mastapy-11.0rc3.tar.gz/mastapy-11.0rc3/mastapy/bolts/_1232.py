...
from mastapy.bolts import _1247, _1228
...
class BoltMaterial(_1228.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1247.StrengthGrades':
        ...
        return constructor.new(_1247.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1247.StrengthGrades'):
