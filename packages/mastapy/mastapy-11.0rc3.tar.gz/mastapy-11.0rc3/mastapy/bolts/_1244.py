...
class LoadedBolt(_0.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1227.AxialLoadType':
        ...
        return constructor.new(_1227.AxialLoadType)(value) if value else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1227.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1243.JointTypes':
        '''JointTypes: 'JointType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.JointType)
        return constructor.new(_1243.JointTypes)(value) if value else None

    @joint_type.setter
    def joint_type(self, value: '_1243.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tightening_technique(self) -> '_1249.TighteningTechniques':
        ...
        return constructor.new(_1249.TighteningTechniques)(value) if value else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1249.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TighteningTechnique = value

    @property
    def bolt(self) -> '_1239.DetailedBoltDesign':
        ...
        return constructor.new(_1239.DetailedBoltDesign)(self.wrapped.Bolt) if self.wrapped.Bolt else None
