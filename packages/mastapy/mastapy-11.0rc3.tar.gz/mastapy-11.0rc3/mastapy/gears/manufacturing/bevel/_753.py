...
from mastapy.gears.gear_designs.conical import _1082
...
class PinionFinishMachineSettings(_281.ConicalGearToothSurface):
    '''PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self) -> '_1082.TopremLetter':
