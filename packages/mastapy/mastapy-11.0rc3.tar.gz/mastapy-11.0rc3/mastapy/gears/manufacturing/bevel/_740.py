...
class ConicalSetMicroGeometryConfigBase(_1139.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_286.DeflectionFromBendingOption':
        ...
        return constructor.new(_286.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_286.DeflectionFromBendingOption'):
