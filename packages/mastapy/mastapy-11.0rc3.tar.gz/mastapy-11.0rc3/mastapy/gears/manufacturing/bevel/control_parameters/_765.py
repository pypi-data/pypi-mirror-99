...
from mastapy.gears.manufacturing.bevel.control_parameters import _764
...
class ConicalManufacturingSGMControlParameters(_764.ConicalGearManufacturingControlParameters):
    '''ConicalManufacturingSGMControlParameters
