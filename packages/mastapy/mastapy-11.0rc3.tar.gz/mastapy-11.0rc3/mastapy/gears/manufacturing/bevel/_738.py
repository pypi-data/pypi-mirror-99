...
from mastapy.gears.gear_designs.conical import _1069, _1068
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _723, _732, _740
...
class ConicalSetManufacturingConfig(_740.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_723.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_723.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_732.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_732.ConicalMeshManufacturingConfig))
        return value
