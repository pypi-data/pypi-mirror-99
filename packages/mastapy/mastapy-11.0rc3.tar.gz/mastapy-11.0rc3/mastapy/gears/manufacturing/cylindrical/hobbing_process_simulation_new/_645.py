...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _609, _641
...
class WormGrindingProcessProfileCalculation(_641.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
