...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_610.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_610.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_610.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_606.AnalysisMethod':
        ...
        return constructor.new(_606.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_606.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_637.RackMountingError':
        ...
        return constructor.new(_637.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_612.GearMountingError':
        ...
        return constructor.new(_612.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_611.CutterHeadSlideError':
        ...
        return constructor.new(_611.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
