...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _632, _619, _646
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_632.ProcessSimulationInput':
        ...
        if _632.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_619.HobbingProcessSimulationInput':
        ...
        if _619.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_646.WormGrindingProcessSimulationInput':
        ...
        if _646.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
