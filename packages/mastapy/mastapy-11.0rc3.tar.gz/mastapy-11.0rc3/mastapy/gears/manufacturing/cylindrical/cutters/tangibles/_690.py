...
class CylindricalGearHobShape(_695.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_674.CylindricalGearHobDesign':
        ...
        return constructor.new(_674.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design else None
