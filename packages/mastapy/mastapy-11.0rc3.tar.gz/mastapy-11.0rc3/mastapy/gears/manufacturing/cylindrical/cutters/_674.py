...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _690, _695, _693
from mastapy._internal.cast_exception import CastException
from mastapy.gears.manufacturing.cylindrical.cutters import _677
...
class CylindricalGearHobDesign(_677.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_578.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_578.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_578.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_690.CylindricalGearHobShape':
        ...
        return constructor.new(_690.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None

    @property
    def nominal_rack_shape(self) -> '_695.RackShape':
        ...
        if _695.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_690.CylindricalGearHobShape':
        ...
        if _690.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_693.CylindricalGearWormGrinderShape':
        ...
        if _693.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_690.CylindricalGearHobShape':
        ...
        return constructor.new(_690.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_690.CylindricalGearHobShape':
        ...
        return constructor.new(_690.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
