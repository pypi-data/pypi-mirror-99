...
class CylindricalGearShaperTangible(_688.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_679.CylindricalGearShaper':
        ...
        return constructor.new(_679.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None
