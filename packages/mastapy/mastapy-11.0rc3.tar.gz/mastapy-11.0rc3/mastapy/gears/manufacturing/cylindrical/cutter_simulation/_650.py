...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _651, _656
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self) -> '_651.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_651.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_656.FinishStockPoint':
        ...
        return constructor.new(_656.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter else None

    @property
    def stock_removed_at_designed_sap(self) -> '_656.FinishStockPoint':
        ...
        return constructor.new(_656.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_656.FinishStockPoint':
        ...
        return constructor.new(_656.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm else None

    @property
    def gear_fillet_points(self) -> 'List[_694.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_694.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_656.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_656.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_656.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_656.FinishStockPoint))
        return value
