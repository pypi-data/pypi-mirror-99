...
class CylindricalGearShaper(_683.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1000.ShaperEdgeTypes':
        ...
        return constructor.new(_1000.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1000.ShaperEdgeTypes'):
