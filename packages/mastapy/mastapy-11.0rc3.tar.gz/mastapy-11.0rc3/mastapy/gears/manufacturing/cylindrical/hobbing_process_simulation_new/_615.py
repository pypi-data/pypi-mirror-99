...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _607, _613
...
class HobbingProcessLeadCalculation(_613.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
