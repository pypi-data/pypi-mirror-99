...
from mastapy.gears.manufacturing.cylindrical.cutters import _677, _673, _674
...
class RackShape(_688.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_677.CylindricalGearRackDesign':
