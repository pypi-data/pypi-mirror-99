...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _712
...
class RedressingSettings(_0.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_680.CylindricalGearShaver':
        ...
        if _680.CylindricalGearShaver.TYPE not in self.wrapped.RedressedShaver.__class__.__mro__:
