...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _638, _632
...
class WormGrindingProcessSimulationInput(_632.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_638.WormGrinderManufactureError':
        ...
        return constructor.new(_638.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
