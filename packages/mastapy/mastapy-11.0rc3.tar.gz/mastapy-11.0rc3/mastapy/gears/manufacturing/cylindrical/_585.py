...
class SuitableCutterSetup(_0.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_660.ManufacturingOperationConstraints':
        ...
        return constructor.new(_660.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
