...
class HobbingProcessSimulationInput(_632.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    @property
    def hob_manufacture_error(self) -> '_623.HobManufactureError':
        ...
        return constructor.new(_623.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError else None

    @property
    def hob_resharpening_error(self) -> '_624.HobResharpeningError':
        ...
        return constructor.new(_624.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError else None
