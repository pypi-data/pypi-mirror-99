...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _709, _708, _712
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _651
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_709.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_709.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_709.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_709.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_651.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_651.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_680.CylindricalGearShaver':
        ...
        if _680.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_953.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_953.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_953.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_953.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
