...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _608, _613
...
class HobbingProcessPitchCalculation(_613.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
