...
class PlanetaryDetail(_0.APIBase):
    ...
    @property
    def planet_delta_angles(self) -> 'List[_300.NamedPlanetAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetDeltaAngles, constructor.new(_300.NamedPlanetAngle))
        return value
