...
from mastapy.gears.gear_designs.hypoid import _915, _916
...
class HypoidGearSetDesign(_1106.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_915.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_915.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_915.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_915.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_916.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_916.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_916.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_916.HypoidGearMeshDesign))
        return value
