...
class WormDesign(_887.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_311.WormAddendumFactor':
        ...
        return constructor.new(_311.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_311.WormAddendumFactor'):
