...
from mastapy.gears.materials import _548
...
class KlingelnbergConicalGearDesign(_1065.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_548.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_548.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
