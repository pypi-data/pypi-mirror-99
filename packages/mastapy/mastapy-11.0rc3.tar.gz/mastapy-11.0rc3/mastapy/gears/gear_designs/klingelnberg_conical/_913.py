...
from mastapy.gears.gear_designs.conical import _1079, _1067
...
class KlingelnbergConicalGearSetDesign(_1067.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1079.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1079.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1079.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_912.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_912.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_912.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_912.KlingelnbergConicalGearMeshDesign))
        return value
