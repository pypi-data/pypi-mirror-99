...
from mastapy.gears.gear_designs.face import _920, _919
...
class FaceGearWheelDesign(_919.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_920.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_920.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_920.FaceGearDiameterFaceWidthSpecificationMethod'):
