...
class SelectedDesignConstraintsCollection(_1349.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_876.DesignConstraintsCollection':
        ...
        return constructor.new(_876.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
