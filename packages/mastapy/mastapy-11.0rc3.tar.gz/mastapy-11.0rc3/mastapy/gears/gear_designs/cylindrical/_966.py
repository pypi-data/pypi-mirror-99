...
from mastapy.gears.gear_designs.cylindrical import _1009, _929
...
class CylindricalMeshLinearBacklashSpecification(_1009.TolerancedValueSpecification['_929.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
