...
class GearSetFCAImportSetup(_0.APIBase):
    ...
    @property
    def meshes(self) -> 'List[_949.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_949.CylindricalGearMeshDesign))
        return value
