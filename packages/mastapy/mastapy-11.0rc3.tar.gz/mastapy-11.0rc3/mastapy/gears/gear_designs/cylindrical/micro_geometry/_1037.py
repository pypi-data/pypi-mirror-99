...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1045, _1040
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1040.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormReliefPoints, constructor.new(_1040.ProfileFormReliefWithDeviation))
        return value

    @property
    def involute_inspection_points(self) -> 'List[_1045.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InvoluteInspectionPoints, constructor.new(_1045.TotalProfileReliefWithDeviation))
        return value
