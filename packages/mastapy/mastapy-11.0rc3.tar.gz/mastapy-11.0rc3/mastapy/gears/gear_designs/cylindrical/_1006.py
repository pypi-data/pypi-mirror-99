...
class TiffAnalysisSettings(_1344.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def surface_material_properties(self) -> '_978.HardenedMaterialProperties':
        ...
        return constructor.new(_978.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_978.HardenedMaterialProperties':
        ...
        return constructor.new(_978.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
