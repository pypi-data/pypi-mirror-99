...
class ProfileReliefWithDeviation(_1043.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_953.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_953.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile else None
