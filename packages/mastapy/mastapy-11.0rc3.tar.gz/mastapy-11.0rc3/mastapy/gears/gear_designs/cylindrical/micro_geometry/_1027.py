...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1026
...
class CylindricalGearProfileModificationAtFaceWidthPosition(_1026.CylindricalGearProfileModification):
    '''CylindricalGearProfileModificationAtFaceWidthPosition
