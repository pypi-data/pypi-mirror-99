...
from mastapy.utility.report import _1514
...
class CylindricalGearTableWithMGCharts(_1514.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_960.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_960.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_960.CylindricalGearTableMGItemDetail'):
