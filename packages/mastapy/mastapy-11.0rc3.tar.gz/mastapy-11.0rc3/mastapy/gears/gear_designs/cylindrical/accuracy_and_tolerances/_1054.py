...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1051
...
class ISO13282013AccuracyGrader(_1051.CylindricalAccuracyGraderWithProfileFormAndSlope):
    '''ISO13282013AccuracyGrader
