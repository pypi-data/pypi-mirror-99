...
from mastapy.gears.gear_designs.spiral_bevel import _901, _899, _902
...
class SpiralBevelGearMeshDesign(_1092.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_902.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_902.SpiralBevelMeshedGearDesign))
        return value
