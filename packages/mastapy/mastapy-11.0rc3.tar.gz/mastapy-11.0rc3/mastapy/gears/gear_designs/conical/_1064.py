...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1073.CutterGaugeLengths':
        ...
        return constructor.new(_1073.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1073.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1072.CutterBladeType':
        ...
        return constructor.new(_1072.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1072.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_1081.TopremEntryType':
        ...
        return constructor.new(_1081.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1081.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_1082.TopremLetter':
        ...
        return constructor.new(_1082.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_1082.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_1082.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1082.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
