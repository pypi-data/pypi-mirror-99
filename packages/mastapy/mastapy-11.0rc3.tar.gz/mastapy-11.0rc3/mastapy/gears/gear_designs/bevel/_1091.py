...
from mastapy.gears.gear_designs.bevel import _1097
...
class BevelGearDesign(_1104.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1097.FinishingMethods':
        ...
        return constructor.new(_1097.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1097.FinishingMethods'):
