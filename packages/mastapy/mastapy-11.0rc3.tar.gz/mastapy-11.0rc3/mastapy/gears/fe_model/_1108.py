...
class GearFEModel(_1129.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1110.GearMeshingElementOptions':
        ...
        return constructor.new(_1110.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None
    ...
    def get_stress_influence_coefficients_from_fe(self, flank: '_287.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_287.GearFlanks', progress: '_7196.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
