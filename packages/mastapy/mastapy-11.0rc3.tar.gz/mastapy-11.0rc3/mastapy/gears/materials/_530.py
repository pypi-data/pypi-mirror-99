...
from mastapy.materials import _208, _209, _210
...
class AGMACylindricalGearMaterial(_538.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_208.AGMAMaterialApplications':
        ...
        return constructor.new(_208.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_208.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_209.AGMAMaterialClasses':
        ...
        return constructor.new(_209.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_209.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_210.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_210.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_210.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
