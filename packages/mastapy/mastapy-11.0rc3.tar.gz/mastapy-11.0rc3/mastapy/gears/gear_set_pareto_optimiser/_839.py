...
from mastapy.math_utility.optimisation import _1311, _1302, _1308
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_848.LargerOrSmaller':
        ...
        return constructor.new(_848.LargerOrSmaller)(value) if value else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_848.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1311.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1311.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None

    @property
    def optimisation_targets(self) -> 'List[_855.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_855.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1302.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1302.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_873.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_873.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_837.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_837.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_870.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_870.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1308.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1308.ParetoOptimisationFilter))
        return value
