...
from mastapy.gears.gear_set_pareto_optimiser import _839, _850
...
class MicroGeometryDesignSpaceSearch(_839.DesignSpaceSearchBase['_796.CylindricalGearSetLoadDistributionAnalysis', '_850.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_796.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _796.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.LoadCaseDutyCycle.__class__.__mro__:
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_1028.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1028.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_1028.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1028.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1028.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1028.CylindricalGearSetMicroGeometry))
        return value
