...
from mastapy.gears.rating.bevel.standards import _505, _510
...
class AGMASpiralBevelMeshSingleFlankRating(_510.SpiralBevelMeshSingleFlankRating):
    '''AGMASpiralBevelMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_505.AGMASpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_505.AGMASpiralBevelGearSingleFlankRating))
        return value

    @property
    def agma_bevel_gear_single_flank_ratings(self) -> 'List[_505.AGMASpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMABevelGearSingleFlankRatings, constructor.new(_505.AGMASpiralBevelGearSingleFlankRating))
        return value
