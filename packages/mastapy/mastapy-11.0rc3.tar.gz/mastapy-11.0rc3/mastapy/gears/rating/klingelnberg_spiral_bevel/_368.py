...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _366, _367
...
class KlingelnbergCycloPalloidSpiralBevelGearSetRating(_374.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_mesh_ratings(self) -> 'List[_366.KlingelnbergCycloPalloidSpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshRatings, constructor.new(_366.KlingelnbergCycloPalloidSpiralBevelGearMeshRating))
        return value
