...
class StraightBevelDiffGearRating(_488.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_891.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_891.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
