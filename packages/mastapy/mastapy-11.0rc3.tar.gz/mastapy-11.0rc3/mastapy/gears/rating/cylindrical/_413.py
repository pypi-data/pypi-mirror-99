...
class CylindricalGearDutyCycleRating(_319.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_422.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_422.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_422.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_422.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_432.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_432.MeshRatingForReports))
        return value
