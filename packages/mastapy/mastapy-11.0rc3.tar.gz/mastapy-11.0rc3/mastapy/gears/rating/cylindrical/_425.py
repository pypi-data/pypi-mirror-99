...
class CylindricalMeshDutyCycleRating(_326.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_416.CylindricalGearMeshRating':
        ...
        return constructor.new(_416.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
