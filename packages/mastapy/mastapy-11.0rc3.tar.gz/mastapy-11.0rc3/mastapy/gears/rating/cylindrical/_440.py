...
from mastapy.gears.rating.cylindrical import _441
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self) -> '_441.ScuffingResultsRowGear':
        ...
        return constructor.new(_441.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
