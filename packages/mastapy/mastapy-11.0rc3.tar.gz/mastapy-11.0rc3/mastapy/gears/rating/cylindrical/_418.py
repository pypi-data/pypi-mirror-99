...
from mastapy.gears.rating.cylindrical import _414, _415, _444
...
class CylindricalGearRating(_322.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_444.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_444.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
