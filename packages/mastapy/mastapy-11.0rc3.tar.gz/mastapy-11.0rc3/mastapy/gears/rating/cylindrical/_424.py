...
class CylindricalGearSingleFlankRating(_325.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_239.MetalPlasticType':
        ...
        return constructor.new(_239.MetalPlasticType)(value) if value else None
    ...
    def combined_tip_relief(self) -> 'float':
        ...
        return self.wrapped.CombinedTipRelief
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_419.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_419.CylindricalGearRatingGeometryDataSource)(value) if value else None
