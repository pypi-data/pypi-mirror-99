...
from mastapy.gears.rating.cylindrical.iso6336 import _464, _474
...
class ISO63362006GearSingleFlankRating(_474.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_464.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_464.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults else None
