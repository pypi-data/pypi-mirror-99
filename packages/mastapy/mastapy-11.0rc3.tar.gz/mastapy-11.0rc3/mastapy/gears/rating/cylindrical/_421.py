...
from mastapy.gears.rating.cylindrical import _440
...
class CylindricalGearScuffingResults(_0.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_440.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_440.ScuffingResultsRow))
        return value
