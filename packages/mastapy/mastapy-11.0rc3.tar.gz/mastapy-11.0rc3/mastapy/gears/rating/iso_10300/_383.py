...
from mastapy.gears.rating.virtual_cylindrical_gears import _350
...
T = TypeVar('T', bound='_350.VirtualCylindricalGearBasic')


class ISO10300MeshSingleFlankRating(_494.ConicalMeshSingleFlankRating, Generic[T]):
    '''ISO10300MeshSingleFlankRating
