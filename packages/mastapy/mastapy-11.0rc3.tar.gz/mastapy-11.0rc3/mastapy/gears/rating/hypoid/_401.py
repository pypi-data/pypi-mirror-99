...
from mastapy.gears.rating.hypoid import _399, _400
...
class HypoidGearSetRating(_515.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_399.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_399.HypoidGearMeshRating))
        return value
