...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _377, _375
...
class KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating(_375.KlingelnbergConicalMeshSingleFlankRating):
    '''KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_377.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_377.KlingelnbergCycloPalloidConicalGearSingleFlankRating))
        return value

    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_377.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KN3030KlingelnbergGearSingleFlankRatings, constructor.new(_377.KlingelnbergCycloPalloidConicalGearSingleFlankRating))
        return value
