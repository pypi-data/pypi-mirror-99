...
from mastapy.gears.rating.virtual_cylindrical_gears import _348
...
class KlingelnbergConicalMeshSingleFlankRating(_327.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_348.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_348.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
