...
class ZerolBevelGearRating(_503.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_882.ZerolBevelGearDesign':
        ...
        return constructor.new(_882.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
