...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_shape(self) -> '_84.VolumeElementShape':
        ...
        return constructor.new(_84.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_84.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_diameter_for_gear(self) -> '_70.MeshingDiameterForGear':
        ...
        return constructor.new(_70.MeshingDiameterForGear)(value) if value else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_70.MeshingDiameterForGear'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MeshingDiameterForGear = value

    @property
    def meshing_problems(self) -> 'List[_56.FEMeshingProblem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshingProblems, constructor.new(_56.FEMeshingProblem))
        return value
