...
from mastapy.math_utility.stiffness_calculators import _1299
...
class SurfaceToSurfaceContactStiffnessEntity(_122.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1299.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1299.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
