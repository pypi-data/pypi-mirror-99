...
class Bar(_138.NodalComponent):
    ...
    @property
    def bar_geometry(self) -> '_46.BarGeometry':
        ...
        return constructor.new(_46.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
