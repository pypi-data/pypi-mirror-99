...
from mastapy.math_utility import _1265
from mastapy.nodal_analysis.dev_tools_analyses import _151
from mastapy.fe_tools.vfx_tools import _1146
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1265.DataPrecision':
        ...
        return constructor.new(_1265.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1265.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_151.EigenvalueOptions':
        ...
        return constructor.new(_151.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None

    @property
    def solver_options(self) -> '_1146.ProSolveOptions':
        ...
        return constructor.new(_1146.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions else None
