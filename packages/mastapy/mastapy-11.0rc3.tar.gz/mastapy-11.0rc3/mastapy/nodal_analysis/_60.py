...
class FEStiffness(_0.APIBase):
    ...
    @property
    def stiffness_in_fe_coordinate_system_mn_rad(self) -> '_72.NodalMatrix':
        ...
        return constructor.new(_72.NodalMatrix)(self.wrapped.StiffnessInFECoordinateSystemMNRad) if self.wrapped.StiffnessInFECoordinateSystemMNRad else None

    @property
    def mass_matrix_mn_rad_s_kg(self) -> '_72.NodalMatrix':
        ...
        return constructor.new(_72.NodalMatrix)(self.wrapped.MassMatrixMNRadSKg) if self.wrapped.MassMatrixMNRadSKg else None
    ...
    @property
    def stiffness_matrix(self) -> '_72.NodalMatrix':
        '''NodalMatrix: 'StiffnessMatrix' is the original name of this property.'''

        return constructor.new(_72.NodalMatrix)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix else None

    @stiffness_matrix.setter
    def stiffness_matrix(self, value: '_72.NodalMatrix'):
