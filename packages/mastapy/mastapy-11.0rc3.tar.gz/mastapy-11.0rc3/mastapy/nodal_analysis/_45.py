...
from mastapy.nodal_analysis import _74, _75
...
class AnalysisSettings(_1349.PerMachineSettings):
    '''AnalysisSettings
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_74.RatingTypeForBearingReliability':
        ...
        return constructor.new(_74.RatingTypeForBearingReliability)(value) if value else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_74.RatingTypeForBearingReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RatingTypeForBearingReliability = value

    @property
    def rating_type_for_shaft_reliability(self) -> '_75.RatingTypeForShaftReliability':
        ...
        return constructor.new(_75.RatingTypeForShaftReliability)(value) if value else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_75.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
