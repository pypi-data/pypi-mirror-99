...
class SingularValuesAnalysis(_0.APIBase):
    ...
    @property
    def smallest_singular_vectors(self) -> 'List[_106.SingularVectorAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SmallestSingularVectors, constructor.new(_106.SingularVectorAnalysis))
        return value

    @property
    def largest_singular_vectors(self) -> 'List[_106.SingularVectorAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectors, constructor.new(_106.SingularVectorAnalysis))
        return value
