...
class SingularVectorAnalysis(_0.APIBase):
    ...
    @property
    def largest_singular_vector_components(self) -> 'List[_104.SingularDegreeOfFreedomAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectorComponents, constructor.new(_104.SingularDegreeOfFreedomAnalysis))
        return value
