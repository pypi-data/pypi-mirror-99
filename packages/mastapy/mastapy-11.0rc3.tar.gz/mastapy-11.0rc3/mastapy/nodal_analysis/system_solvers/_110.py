...
from mastapy.nodal_analysis.system_solvers import _95
...
class TransientSolver(_95.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_81.TransientSolverStatus':
        ...
        return constructor.new(_81.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_81.TransientSolverStatus'):
