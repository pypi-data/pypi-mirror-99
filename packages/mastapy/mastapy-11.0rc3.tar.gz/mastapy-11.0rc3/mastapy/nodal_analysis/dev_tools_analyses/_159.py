...
from mastapy.nodal_analysis.dev_tools_analyses import _150
...
class FEModelInstanceDrawStyle(_0.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_150.DrawStyleForFE':
        ...
        return constructor.new(_150.DrawStyleForFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
