...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _190, _178
...
class ElementPropertiesRigid(_178.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_190.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_190.RigidElementNodeDegreesOfFreedom))
        return value
