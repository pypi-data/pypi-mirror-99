...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1140
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1140.CoordinateSystemType':
        ...
        return constructor.new(_1140.CoordinateSystemType)(value) if value else None
