...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1142
...
class ElementPropertiesBeam(_186.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_1142.BeamSectionType':
        ...
        return constructor.new(_1142.BeamSectionType)(value) if value else None
