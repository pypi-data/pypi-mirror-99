...
from mastapy.bearings.roller_bearing_profiles import (
    _1640, _1634, _1635, _1636,
    _1637, _1638, _1639, _1641
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1598.RollerBearingProfileTypes':
        ...
        return constructor.new(_1598.RollerBearingProfileTypes)(value) if value else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1598.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1640.RollerBearingProfile':
        ...
        if _1640.RollerBearingProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1634.RollerBearingConicalProfile':
        ...
        if _1634.RollerBearingConicalProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1635.RollerBearingCrownedProfile':
        ...
        if _1635.RollerBearingCrownedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1636.RollerBearingDinLundbergProfile':
        ...
        if _1636.RollerBearingDinLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1637.RollerBearingFlatProfile':
        ...
        if _1637.RollerBearingFlatProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1638.RollerBearingJohnsGoharProfile':
        ...
        if _1638.RollerBearingJohnsGoharProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1639.RollerBearingLundbergProfile':
        ...
        if _1639.RollerBearingLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1641.RollerBearingUserSpecifiedProfile':
        ...
        if _1641.RollerBearingUserSpecifiedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
