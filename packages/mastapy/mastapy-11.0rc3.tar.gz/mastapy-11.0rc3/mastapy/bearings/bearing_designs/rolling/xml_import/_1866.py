...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1864, _1863
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1864.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1864.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1863.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1863.AbstractXmlVariableAssignment))
        return value
