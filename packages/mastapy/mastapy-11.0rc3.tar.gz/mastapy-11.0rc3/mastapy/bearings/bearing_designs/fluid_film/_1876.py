...
class PlainGreaseFilledJournalBearing(_1878.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1877.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1877.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1877.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1879.PlainJournalHousing':
        ...
        if _1879.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1872.CylindricalHousingJournalBearing':
        ...
        if _1872.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1873.MachineryEncasedJournalBearing':
        ...
        if _1873.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1875.PedestalJournalBearing':
        ...
        if _1875.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
