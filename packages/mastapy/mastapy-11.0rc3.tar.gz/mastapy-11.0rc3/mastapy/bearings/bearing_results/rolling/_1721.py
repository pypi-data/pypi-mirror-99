...
class LoadedNonBarrelRollerBearingRow(_1726.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1720.LoadedNonBarrelRollerBearingResults':
