...
from mastapy.bearings.bearing_results.rolling import _1682, _1680
...
class LoadedAngularContactThrustBallBearingRow(_1680.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1682.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1682.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
