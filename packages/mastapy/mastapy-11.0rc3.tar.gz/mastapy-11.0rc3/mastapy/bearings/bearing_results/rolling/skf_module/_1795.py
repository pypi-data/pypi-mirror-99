...
from mastapy.bearings.bearing_results.rolling.skf_module import _1788, _1791
...
class Viscosities(_1791.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1788.OperatingViscosity':
        ...
        return constructor.new(_1788.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
