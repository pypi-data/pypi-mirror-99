...
from mastapy.bearings.bearing_results.rolling.skf_module import _1786, _1791
...
class BearingRatingLife(_1791.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1786.LifeModel':
        ...
        return constructor.new(_1786.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
