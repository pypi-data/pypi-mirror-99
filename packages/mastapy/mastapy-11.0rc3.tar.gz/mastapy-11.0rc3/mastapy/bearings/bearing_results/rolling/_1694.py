...
from mastapy.bearings.bearing_results.rolling import _1693, _1691
...
class LoadedAxialThrustNeedleRollerBearingRow(_1691.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1693.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1693.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
