...
from mastapy.bearings.bearing_results.rolling.skf_module import _1773, _1791
...
class AdjustedSpeed(_1791.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1773.AdjustmentFactors':
        ...
        return constructor.new(_1773.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
