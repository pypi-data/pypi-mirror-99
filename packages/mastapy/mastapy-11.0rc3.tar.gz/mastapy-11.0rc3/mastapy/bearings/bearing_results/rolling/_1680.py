...
from mastapy.bearings.bearing_results.rolling import _1679, _1682, _1699
...
class LoadedAngularContactBallBearingRow(_1699.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1679.LoadedAngularContactBallBearingResults':
