...
class LoadedDetailedBearingResults(_1659.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_233.LubricationDetail':
        ...
        return constructor.new(_233.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
