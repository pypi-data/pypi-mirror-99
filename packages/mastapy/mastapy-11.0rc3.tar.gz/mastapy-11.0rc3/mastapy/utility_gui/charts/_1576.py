...
class CustomTableAndChart(_1514.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1251.Range':
        ...
        if _1251.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
