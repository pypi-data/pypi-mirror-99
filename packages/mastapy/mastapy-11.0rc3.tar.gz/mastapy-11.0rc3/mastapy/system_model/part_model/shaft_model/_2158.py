...
class Shaft(_2114.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2133.GuideImage':
        ...
        return constructor.new(_2133.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2141.MountableComponent', offset: 'float'):
