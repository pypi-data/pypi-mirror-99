...
from mastapy.gears import _289, _290
...
class GearSetConfiguration(_0.APIBase):
    ...
    def implementation_detail_results_for(self, analysis_case: '_6598.StaticLoadCase', gear_set_mode: '_290.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1135.GearSetGroupDutyCycle':
    ...
    def implementation_detail_results_for_group(self, analysis_case: '_5316.AbstractStaticLoadCaseGroup', gear_set_mode: '_290.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1135.GearSetGroupDutyCycle':
        ''' 'ImplementationDetailResultsFor' is the original name of this method.
    ...
    def perform_implementation_detail_analysis(self, static_load: '_6598.StaticLoadCase', gear_set_mode: '_290.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis_group(self, static_load_case_group: '_5316.AbstractStaticLoadCaseGroup', gear_set_mode: '_290.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
