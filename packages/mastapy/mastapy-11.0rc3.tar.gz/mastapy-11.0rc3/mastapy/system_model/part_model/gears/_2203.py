...
class FaceGear(_2205.Gear):
    ...
    @property
    def active_gear_design(self) -> '_919.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_919.FaceGearDesign':
        ...
        if _919.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
