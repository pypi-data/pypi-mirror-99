...
class SuperchargerRotorSet(_1556.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2240.YVariableForImportedData':
        ...
        return constructor.new(_2240.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2240.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2233.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2233.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2235.RotorSpeedInputOptions':
        ...
        return constructor.new(_2235.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2230.BoostPressureInputOptions':
        ...
        return constructor.new(_2230.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2232.PressureRatioInputOptions':
        ...
        return constructor.new(_2232.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2231.InputPowerInputOptions':
        ...
        return constructor.new(_2231.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2234.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2234.RotorSetMeasuredPoint))
        return value
