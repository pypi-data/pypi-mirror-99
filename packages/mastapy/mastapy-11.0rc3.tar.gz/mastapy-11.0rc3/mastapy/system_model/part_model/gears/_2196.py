...
class ConceptGear(_2205.Gear):
    ...
    @property
    def active_gear_design(self) -> '_1087.ConceptGearDesign':
        ...
        return constructor.new(_1087.ConceptGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def concept_gear_design(self) -> '_1087.ConceptGearDesign':
        ...
        return constructor.new(_1087.ConceptGearDesign)(self.wrapped.ConceptGearDesign) if self.wrapped.ConceptGearDesign else None
