...
from mastapy.cycloidal import _1224, _1225
...
class RingPins(_2141.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1224.RingPinsDesign':
        ...
        return constructor.new(_1224.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign else None

    @property
    def ring_pins_material(self) -> '_1225.RingPinsMaterial':
        ...
        return constructor.new(_1225.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial else None
