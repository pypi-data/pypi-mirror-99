...
from mastapy.system_model.part_model.part_groups import _2163, _2165, _2162
...
class ParallelPartGroup(_2162.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2163.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2163.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2165.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2165.DesignMeasurements))
        return value
