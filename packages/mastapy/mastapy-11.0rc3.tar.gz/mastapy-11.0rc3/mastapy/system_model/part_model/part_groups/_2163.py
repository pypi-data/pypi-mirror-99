...
from mastapy.system_model.part_model.part_groups import _2164, _2162
...
class ConcentricPartGroup(_2162.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2164.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2164.ConcentricPartGroupParallelToThis))
        return value
