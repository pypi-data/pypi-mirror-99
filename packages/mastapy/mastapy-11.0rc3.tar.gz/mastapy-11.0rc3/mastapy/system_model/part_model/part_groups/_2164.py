...
from mastapy.system_model.part_model.part_groups import _2162, _2163, _2166
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2162.ConcentricOrParallelPartGroup':
        ...
        if _2162.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2163.ConcentricPartGroup':
        ...
        if _2163.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2166.ParallelPartGroup':
        ...
        if _2166.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
