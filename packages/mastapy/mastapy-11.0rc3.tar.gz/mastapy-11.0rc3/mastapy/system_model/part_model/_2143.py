...
from mastapy.materials.efficiency import _264
...
class OilSeal(_2125.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_264.OilSealMaterialType':
        ...
        return constructor.new(_264.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_264.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1662.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1662.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
