...
class FlexiblePinAssembly(_2153.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2200.CylindricalGear':
        ...
        if _2200.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
