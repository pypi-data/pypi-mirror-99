...
from mastapy.system_model.part_model.import_from_cad import _2178, _2179
...
class ConnectorFromCAD(_2179.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2178.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2178.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2178.HousedOrMounted'):
