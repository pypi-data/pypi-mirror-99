...
from mastapy.math_utility import _1261, _1262
from mastapy.system_model.connections_and_sockets import (
    _1950, _1971, _1952, _1976
)
from mastapy.system_model.part_model import _2123, _2145
...
class Component(_2145.Part):
    ...
    @property
    def component_connections(self) -> 'List[_1950.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1950.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_1971.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1261.CoordinateSystem3D') -> '_1971.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1971.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1262.CoordinateSystemEditor':
    ...
    def can_delete_connection(self, connection: '_1952.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_1976.Socket':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1952.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1952.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_1976.Socket') -> 'List[_1976.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_1976.Socket))

    def connect_to_socket(self, socket: '_1976.Socket') -> '_2123.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_1976.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_1976.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2123.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2123.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
