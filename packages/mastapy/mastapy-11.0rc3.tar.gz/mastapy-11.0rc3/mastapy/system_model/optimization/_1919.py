...
from mastapy.system_model.optimization import _1920, _1918
...
TStep = TypeVar('TStep', bound='_1918.OptimizationStep')


class OptimizationStrategy(_1920.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
