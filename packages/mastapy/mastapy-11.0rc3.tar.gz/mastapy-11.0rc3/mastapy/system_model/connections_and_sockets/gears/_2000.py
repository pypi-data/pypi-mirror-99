...
class KlingelnbergCycloPalloidSpiralBevelGearMesh(_1998.KlingelnbergCycloPalloidConicalGearMesh):
    '''KlingelnbergCycloPalloidSpiralBevelGearMesh
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_design(self) -> '_904.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
        ...
        return constructor.new(_904.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign else None
