...
class HypoidGearMesh(_1979.AGMAGleasonConicalGearMesh):
    '''HypoidGearMesh
    ...
    @property
    def hypoid_gear_mesh_design(self) -> '_916.HypoidGearMeshDesign':
        ...
        return constructor.new(_916.HypoidGearMeshDesign)(self.wrapped.HypoidGearMeshDesign) if self.wrapped.HypoidGearMeshDesign else None
