...
from mastapy.system_model.analyses_and_results.static_loads import _6453, _6565
from mastapy.system_model import _1895
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4053, _4054
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6565.ParametricStudyType':
        ...
        return constructor.new(_6565.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6565.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1895.ExternalFullFELoader':
        ...
        return constructor.new(_1895.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4053.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4053.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4054.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4054.ParametricStudyVariable))
        return value
