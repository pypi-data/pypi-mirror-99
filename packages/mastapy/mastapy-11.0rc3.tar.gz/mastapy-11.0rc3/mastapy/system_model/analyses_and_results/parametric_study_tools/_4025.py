...
class GearSetParametricStudyTool(_4074.SpecialisedAssemblyParametricStudyTool):
    '''GearSetParametricStudyTool
    ...
    @property
    def gear_set_duty_cycle_results(self) -> 'List[_323.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDutyCycleResults, constructor.new(_323.GearSetDutyCycleRating))
        return value
