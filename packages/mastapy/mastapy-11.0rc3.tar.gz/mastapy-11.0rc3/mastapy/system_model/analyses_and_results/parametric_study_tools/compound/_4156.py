...
class DatumCompoundParametricStudyTool(_4130.ComponentCompoundParametricStudyTool):
    '''DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4009.DatumParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4009.DatumParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4009.DatumParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4009.DatumParametricStudyTool))
        return value
