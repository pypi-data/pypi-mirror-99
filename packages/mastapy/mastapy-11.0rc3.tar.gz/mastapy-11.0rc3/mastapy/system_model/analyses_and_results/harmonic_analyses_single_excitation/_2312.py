...
class ModalAnalysisForHarmonicAnalysis(_2309.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5677.HarmonicAnalysisOptions':
        ...
        if _5677.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
