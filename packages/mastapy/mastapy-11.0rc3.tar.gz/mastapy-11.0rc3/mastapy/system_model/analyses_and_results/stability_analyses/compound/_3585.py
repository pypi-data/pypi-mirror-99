...
class CoaxialConnectionCompoundStabilityAnalysis(_3658.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3453.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3453.CoaxialConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3453.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3453.CoaxialConnectionStabilityAnalysis))
        return value
