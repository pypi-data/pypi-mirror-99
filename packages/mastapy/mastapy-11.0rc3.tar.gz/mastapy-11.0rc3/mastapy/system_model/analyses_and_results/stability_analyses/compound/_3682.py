...
class UnbalancedMassCompoundStabilityAnalysis(_3683.VirtualComponentCompoundStabilityAnalysis):
    '''UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3553.UnbalancedMassStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3553.UnbalancedMassStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3553.UnbalancedMassStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3553.UnbalancedMassStabilityAnalysis))
        return value
