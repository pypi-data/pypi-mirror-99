...
class AGMAGleasonConicalGearSetCompoundStabilityAnalysis(_3595.ConicalGearSetCompoundStabilityAnalysis):
    '''AGMAGleasonConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3434.AGMAGleasonConicalGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3434.AGMAGleasonConicalGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3434.AGMAGleasonConicalGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3434.AGMAGleasonConicalGearSetStabilityAnalysis))
        return value
