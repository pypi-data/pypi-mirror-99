...
class FrequencyOptionsForHarmonicAnalysisResults(_7175.AbstractAnalysisOptions['_6598.StaticLoadCase']):
    '''FrequencyOptionsForHarmonicAnalysisResults
    ...
    def design_defaults(self) -> 'FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.DesignDefaults) if self.wrapped.DesignDefaults else None
