...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2306, _2307
...
class ConnectionHarmonicAnalysis(_7180.ConnectionStaticLoadAnalysisCase):
    '''ConnectionHarmonicAnalysis
    ...
    def harmonic_analysis(self) -> '_2306.HarmonicAnalysis':
        ...
        if _2306.HarmonicAnalysis.TYPE not in self.wrapped.HarmonicAnalysis.__class__.__mro__:
    ...
    @property
    def harmonic_analyses_of_single_excitations(self) -> 'List[_5396.HarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicAnalysesOfSingleExcitations, constructor.new(_5396.HarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def system_deflection_results(self) -> '_2395.ConnectionSystemDeflection':
        ...
        if _2395.ConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_abstract_shaft_to_mountable_component_connection_system_deflection(self) -> '_2361.AbstractShaftToMountableComponentConnectionSystemDeflection':
        ...
        if _2361.AbstractShaftToMountableComponentConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cycloidal_disc_planetary_bearing_connection_system_deflection(self) -> '_2405.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
        ...
        if _2405.CycloidalDiscPlanetaryBearingConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_inter_mountable_component_connection_system_deflection(self) -> '_2433.InterMountableComponentConnectionSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_shaft_to_mountable_component_connection_system_deflection(self) -> '_2471.ShaftToMountableComponentConnectionSystemDeflection':
