...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5773
...
class SingleWhineAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def orders(self) -> 'List[_5773.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5773.ResultsForOrder))
        return value
