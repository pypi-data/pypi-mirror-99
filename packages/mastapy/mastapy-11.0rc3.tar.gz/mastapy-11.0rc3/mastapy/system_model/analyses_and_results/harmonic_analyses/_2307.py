...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2306
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2306.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
