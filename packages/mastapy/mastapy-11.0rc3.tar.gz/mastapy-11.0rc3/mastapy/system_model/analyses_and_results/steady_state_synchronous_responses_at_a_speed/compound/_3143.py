...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed(_3054.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3016.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3016.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3016.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3016.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed))
        return value
