...
class GearLoadCase(_6562.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6527.GearManufactureError':
        ...
        if _6527.GearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6480.ConicalGearManufactureError':
        ...
        if _6480.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6497.CylindricalGearManufactureError':
        ...
        if _6497.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
