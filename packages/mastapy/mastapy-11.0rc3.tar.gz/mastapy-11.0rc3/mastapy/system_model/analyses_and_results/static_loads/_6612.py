...
class TimeSeriesLoadCase(_6441.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5118.MBDAnalysisOptions':
        ...
        return constructor.new(_5118.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
