...
from mastapy.system_model.analyses_and_results.static_loads import _6508, _6516
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6508.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
