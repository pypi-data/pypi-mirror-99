...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6580.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6580.RingPinManufacturingError))
        return value
