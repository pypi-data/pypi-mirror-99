...
from mastapy.system_model.analyses_and_results.static_loads import _6480, _6526
...
class ConicalGearLoadCase(_6526.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6480.ConicalGearManufactureError':
        ...
        return constructor.new(_6480.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
