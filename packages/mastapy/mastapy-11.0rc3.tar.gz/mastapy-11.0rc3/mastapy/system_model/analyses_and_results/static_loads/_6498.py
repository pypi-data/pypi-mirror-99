...
class CylindricalGearMeshLoadCase(_6528.GearMeshLoadCase):
    '''CylindricalGearMeshLoadCase
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_545.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_545.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents else None
