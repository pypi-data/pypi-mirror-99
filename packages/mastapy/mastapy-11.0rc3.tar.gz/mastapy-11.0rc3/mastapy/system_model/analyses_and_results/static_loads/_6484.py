...
from mastapy.system_model.analyses_and_results.static_loads import _6598, _6447, _6612
...
class ConnectionLoadCase(_2323.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6598.StaticLoadCase':
        ...
        if _6598.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
