...
from mastapy.system_model.analyses_and_results.static_loads import _6497, _6526
...
class CylindricalGearLoadCase(_6526.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6497.CylindricalGearManufactureError':
        ...
        return constructor.new(_6497.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def overridden_micro_geometry(self) -> '_1023.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1023.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
