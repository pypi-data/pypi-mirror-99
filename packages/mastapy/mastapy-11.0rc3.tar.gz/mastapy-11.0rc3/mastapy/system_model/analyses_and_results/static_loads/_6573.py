...
from mastapy.system_model.analyses_and_results.static_loads import _6572, _6562
...
class PlanetCarrierLoadCase(_6562.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6572.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6572.PlanetarySocketManufactureError))
        return value
