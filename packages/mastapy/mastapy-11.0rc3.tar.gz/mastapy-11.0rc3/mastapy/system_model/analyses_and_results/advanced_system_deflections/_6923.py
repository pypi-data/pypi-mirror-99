...
class BevelDifferentialGearAdvancedSystemDeflection(_6928.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_503.BevelGearRating':
        ...
        if _503.BevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_zerol_bevel_gear_rating(self) -> '_331.ZerolBevelGearRating':
        ...
        if _331.ZerolBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_rating(self) -> '_361.StraightBevelGearRating':
        ...
        if _361.StraightBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spiral_bevel_gear_rating(self) -> '_364.SpiralBevelGearRating':
        ...
        if _364.SpiralBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2371.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2371.BevelDifferentialGearSystemDeflection))
        return value
