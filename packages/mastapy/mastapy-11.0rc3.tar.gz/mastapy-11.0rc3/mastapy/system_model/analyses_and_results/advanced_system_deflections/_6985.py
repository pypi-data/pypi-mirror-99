...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6983, _6984, _6982
...
class KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection(_6982.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_advanced_system_deflection(self) -> 'List[_6983.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsAdvancedSystemDeflection, constructor.new(_6983.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_advanced_system_deflection(self) -> 'List[_6984.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesAdvancedSystemDeflection, constructor.new(_6984.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection))
        return value
