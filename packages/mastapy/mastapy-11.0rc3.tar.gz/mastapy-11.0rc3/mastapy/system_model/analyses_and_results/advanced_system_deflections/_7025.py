...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7023, _7024, _6930
...
class StraightBevelGearSetAdvancedSystemDeflection(_6930.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_7023.StraightBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsAdvancedSystemDeflection, constructor.new(_7023.StraightBevelGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_7024.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesAdvancedSystemDeflection, constructor.new(_7024.StraightBevelGearMeshAdvancedSystemDeflection))
        return value
