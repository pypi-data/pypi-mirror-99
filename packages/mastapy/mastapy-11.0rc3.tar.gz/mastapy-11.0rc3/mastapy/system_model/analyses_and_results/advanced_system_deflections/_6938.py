...
class ConceptCouplingAdvancedSystemDeflection(_6950.CouplingAdvancedSystemDeflection):
    '''ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2387.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2387.ConceptCouplingSystemDeflection))
        return value
