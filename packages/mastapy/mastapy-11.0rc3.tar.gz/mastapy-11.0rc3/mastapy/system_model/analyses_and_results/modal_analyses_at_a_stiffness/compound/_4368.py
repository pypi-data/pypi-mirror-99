...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4396.ConicalGearCompoundModalAnalysisAtAStiffness):
    '''AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4239.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4239.AGMAGleasonConicalGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4239.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4239.AGMAGleasonConicalGearModalAnalysisAtAStiffness))
        return value
