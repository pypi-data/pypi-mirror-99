...
class ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6709.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_1987.ConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2392.ConicalGearMeshSystemDeflection':
