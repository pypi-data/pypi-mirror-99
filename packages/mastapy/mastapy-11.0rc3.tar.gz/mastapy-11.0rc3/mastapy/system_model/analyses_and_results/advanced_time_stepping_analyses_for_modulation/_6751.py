...
class SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6667.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2473.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2473.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
