...
class PerModeResultsReport(_1490.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1548.TableAndChartOptions':
    ...
    def display_option(self, value: '_1548.TableAndChartOptions'):
