...
class CycloidalAssemblyCompoundModalAnalysis(_5002.SpecialisedAssemblyCompoundModalAnalysis):
    '''CycloidalAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4795.CycloidalAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4795.CycloidalAssemblyModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4795.CycloidalAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4795.CycloidalAssemblyModalAnalysis))
        return value
