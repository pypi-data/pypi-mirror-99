...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5132, _5145
...
class BeltDriveMultibodyDynamicsAnalysis(_5145.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5132.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5132.PulleyMultibodyDynamicsAnalysis))
        return value
