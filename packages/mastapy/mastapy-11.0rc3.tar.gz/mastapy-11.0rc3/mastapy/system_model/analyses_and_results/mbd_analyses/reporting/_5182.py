...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5179
...
class DynamicTorqueResultAtTime(_5179.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
