...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2313
from mastapy.math_utility.convergence import _1334, _1333
from mastapy.utility_gui import _1574
from mastapy.system_model.drawing import _1929
...
class PartMultibodyDynamicsAnalysis(_7188.PartTimeSeriesLoadAnalysisCase):
    '''PartMultibodyDynamicsAnalysis
    ...
    @property
    def data_logger(self) -> '_1334.DataLogger':
        ...
        if _1334.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.DataLogger.__class__)(self.wrapped.DataLogger) if self.wrapped.DataLogger else None

    def create_viewable(self) -> '_1929.MBDAnalysisViewable':
