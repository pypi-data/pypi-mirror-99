...
class AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis(_5217.ConicalGearCompoundMultibodyDynamicsAnalysis):
    '''AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5038.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5038.AGMAGleasonConicalGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5038.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5038.AGMAGleasonConicalGearMultibodyDynamicsAnalysis))
        return value
