...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5056, _5075
...
class ClutchMultibodyDynamicsAnalysis(_5075.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5056.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5056.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
