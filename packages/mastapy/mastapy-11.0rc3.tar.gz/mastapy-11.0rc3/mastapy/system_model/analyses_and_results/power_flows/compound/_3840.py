...
class BevelDifferentialGearCompoundPowerFlow(_3845.BevelGearCompoundPowerFlow):
    '''BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3708.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3708.BevelDifferentialGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3708.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3708.BevelDifferentialGearPowerFlow))
        return value
