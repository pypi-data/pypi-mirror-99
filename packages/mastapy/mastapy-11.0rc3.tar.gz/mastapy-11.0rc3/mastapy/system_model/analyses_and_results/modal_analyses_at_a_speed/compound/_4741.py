...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_4661.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4612.TorqueConverterPumpModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4612.TorqueConverterPumpModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4612.TorqueConverterPumpModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4612.TorqueConverterPumpModalAnalysisAtASpeed))
        return value
