...
class RollingRingConnectionCompoundModalAnalysisAtASpeed(_4687.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''RollingRingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4585.RollingRingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4585.RollingRingConnectionModalAnalysisAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4585.RollingRingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4585.RollingRingConnectionModalAnalysisAtASpeed))
        return value
