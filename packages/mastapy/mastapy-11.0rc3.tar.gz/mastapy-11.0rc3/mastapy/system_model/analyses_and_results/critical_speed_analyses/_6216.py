...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2300
...
class ConnectionCriticalSpeedAnalysis(_7180.ConnectionStaticLoadAnalysisCase):
    '''ConnectionCriticalSpeedAnalysis
