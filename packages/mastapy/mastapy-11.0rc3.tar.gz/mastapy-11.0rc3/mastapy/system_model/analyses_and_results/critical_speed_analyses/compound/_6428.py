...
class SynchroniserSleeveCompoundCriticalSpeedAnalysis(_6427.SynchroniserPartCompoundCriticalSpeedAnalysis):
    '''SynchroniserSleeveCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6299.SynchroniserSleeveCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6299.SynchroniserSleeveCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6299.SynchroniserSleeveCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6299.SynchroniserSleeveCriticalSpeedAnalysis))
        return value
