...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5329, _5330, _5333
from mastapy.system_model.part_model.gears import _2207, _2205
from mastapy.system_model.analyses_and_results.static_loads import _6526, _6528, _6531
...
TGearSet = TypeVar('TGearSet', bound='_2207.GearSet')
TGear = TypeVar('TGear', bound='_2205.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6526.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1993.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6528.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6531.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5333.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5329.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5329.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5330.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5330.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
