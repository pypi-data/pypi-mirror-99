...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2680, _2678, _2708
...
class ConceptGearSetSteadyStateSynchronousResponseOnAShaft(_2708.GearSetSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def concept_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2680.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSteadyStateSynchronousResponseOnAShaft, constructor.new(_2680.ConceptGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def concept_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2678.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSteadyStateSynchronousResponseOnAShaft, constructor.new(_2678.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
