...
class SteadyStateSynchronousResponseOnAShaft(_7189.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3275.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3275.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
