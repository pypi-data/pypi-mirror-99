...
class CouplingConnectionSystemDeflection(_2433.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3733.CouplingConnectionPowerFlow':
