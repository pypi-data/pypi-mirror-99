...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2392.ConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3763.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
