...
class BevelGearMeshSystemDeflection(_2362.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3712.BevelGearMeshPowerFlow':
