...
class MeasurementComponentSystemDeflection(_2501.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3773.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3773.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
