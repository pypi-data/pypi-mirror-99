...
class CVTBeltConnectionSystemDeflection(_2367.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3736.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3736.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
