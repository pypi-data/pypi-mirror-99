...
class HypoidGearSystemDeflection(_2364.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3760.HypoidGearPowerFlow':
        ...
        return constructor.new(_3760.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
