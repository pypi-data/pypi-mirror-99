...
from mastapy.system_model.analyses_and_results.system_deflections import _2507, _2505, _2375
...
class ZerolBevelGearSetSystemDeflection(_2375.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3828.ZerolBevelGearSetPowerFlow':
        ...
        return constructor.new(_3828.ZerolBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2507.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2507.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2505.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2505.ZerolBevelGearMeshSystemDeflection))
        return value
