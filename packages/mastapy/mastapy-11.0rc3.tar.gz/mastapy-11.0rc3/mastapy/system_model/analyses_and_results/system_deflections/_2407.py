...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2511
...
class CylindricalGearMeshSystemDeflection(_2425.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3744.CylindricalGearMeshPowerFlow':
        ...
        return constructor.new(_3744.CylindricalGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def gear_a(self) -> '_2413.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2413.CylindricalGearSystemDeflection':
    ...
    @property
    def misalignment_data(self) -> '_50.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_50.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentData) if self.wrapped.MisalignmentData else None

    @property
    def misalignment_data_left_flank(self) -> '_50.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_50.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataLeftFlank) if self.wrapped.MisalignmentDataLeftFlank else None

    @property
    def misalignment_data_right_flank(self) -> '_50.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_50.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataRightFlank) if self.wrapped.MisalignmentDataRightFlank else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2413.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2413.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2511.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2511.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2511.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2511.MeshDeflectionResults))
        return value
