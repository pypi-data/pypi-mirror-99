...
from mastapy.system_model.analyses_and_results.power_flows import _3746, _3781
from mastapy.gears.rating.cylindrical import _423
from mastapy.gears.manufacturing.cylindrical import _568
from mastapy.system_model.analyses_and_results.system_deflections import _2413, _2407, _2426
...
class CylindricalGearSetSystemDeflection(_2426.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3746.CylindricalGearSetPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_568.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_568.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2413.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2413.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2407.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2407.CylindricalGearMeshSystemDeflection))
        return value
