...
from mastapy.system_model.analyses_and_results.static_loads import _6457, _6490
from mastapy.system_model.analyses_and_results.power_flows import _3706, _3737
from mastapy.system_model.analyses_and_results.system_deflections import _2367, _2472
...
class BeltDriveSystemDeflection(_2472.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6457.BeltDriveLoadCase':
        ...
        if _6457.BeltDriveLoadCase.TYPE not in self.wrapped.AssemblyLoadCase.__class__.__mro__:
    ...
    @property
    def power_flow_results(self) -> '_3706.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2367.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2367.BeltConnectionSystemDeflection))
        return value
