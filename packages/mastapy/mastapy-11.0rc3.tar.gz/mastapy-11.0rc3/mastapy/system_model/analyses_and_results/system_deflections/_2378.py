...
class BoltSystemDeflection(_2383.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3716.BoltPowerFlow':
        ...
        return constructor.new(_3716.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
