...
from mastapy.system_model.drawing import _1924
...
class ConcentricPartGroupCombinationSystemDeflectionResults(_0.APIBase):
    ...
    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_1924.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionsInViewCoordinateSystem, constructor.new(_1924.ConcentricPartGroupCombinationSystemDeflectionShaftResults))
        return value
