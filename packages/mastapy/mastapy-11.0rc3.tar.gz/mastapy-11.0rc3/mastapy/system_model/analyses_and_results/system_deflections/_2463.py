...
class RollingRingAssemblySystemDeflection(_2472.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3790.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3790.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
