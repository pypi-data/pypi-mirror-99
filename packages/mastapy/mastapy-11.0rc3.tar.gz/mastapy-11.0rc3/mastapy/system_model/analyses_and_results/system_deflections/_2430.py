...
from mastapy.system_model.analyses_and_results.system_deflections import _2431, _2429, _2363
...
class HypoidGearSetSystemDeflection(_2363.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3761.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3761.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2431.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2431.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2429.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2429.HypoidGearMeshSystemDeflection))
        return value
