...
class BevelDifferentialSunGearSystemDeflection(_2371.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3711.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3711.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
