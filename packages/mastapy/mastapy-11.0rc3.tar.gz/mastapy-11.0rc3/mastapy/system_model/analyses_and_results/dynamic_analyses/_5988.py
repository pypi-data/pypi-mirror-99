...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5986, _5987, _5985
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_5985.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_5986.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsDynamicAnalysis, constructor.new(_5986.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_5987.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesDynamicAnalysis, constructor.new(_5987.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis))
        return value
