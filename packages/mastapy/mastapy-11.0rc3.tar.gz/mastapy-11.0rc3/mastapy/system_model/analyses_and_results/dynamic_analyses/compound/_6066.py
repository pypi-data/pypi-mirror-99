...
class BoltedJointCompoundDynamicAnalysis(_6144.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''BoltedJointCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5936.BoltedJointDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5936.BoltedJointDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5936.BoltedJointDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5936.BoltedJointDynamicAnalysis))
        return value
