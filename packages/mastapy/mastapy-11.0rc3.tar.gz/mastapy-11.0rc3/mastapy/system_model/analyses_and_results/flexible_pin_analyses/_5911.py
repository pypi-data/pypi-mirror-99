...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2566, _2602, _2525
...
class FlexiblePinAnalysisGearAndBearingRating(_5908.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2566.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2566.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2525.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2525.BearingCompoundSystemDeflection))
        return value
