...
class FlexiblePinAnalysisManufactureLevel(_5908.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4005.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4005.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
