...
from mastapy.nodal_analysis.dev_tools_analyses import _160, _151
from mastapy.nodal_analysis import _58
from mastapy.system_model.fe import _2067
...
class FESubstructureWithSelectionForModalAnalysis(_2067.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_160.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_160.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_58.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_58.FEModalFrequencyComparison))
        return value
