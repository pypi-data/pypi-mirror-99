...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _174
...
class CoordinateSystemWithSelection(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_174.CoordinateSystemReporting':
        ...
        return constructor.new(_174.CoordinateSystemReporting)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None
