...
class FEStiffnessTester(_0.APIBase):
    ...
    @property
    def fe_stiffness(self) -> '_2062.FESubstructure':
        ...
        return constructor.new(_2062.FESubstructure)(self.wrapped.FEStiffness) if self.wrapped.FEStiffness else None

    @property
    def force_and_displacement_results(self) -> 'List[_1322.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAndDisplacementResults, constructor.new(_1322.ForceAndDisplacementResults))
        return value
