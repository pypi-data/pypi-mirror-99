...
from mastapy.system_model.fe import _2054
...
class ElectricMachineStatorFELink(_2102.MultiNodeFELink):
    '''ElectricMachineStatorFELink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_2054.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_2054.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
