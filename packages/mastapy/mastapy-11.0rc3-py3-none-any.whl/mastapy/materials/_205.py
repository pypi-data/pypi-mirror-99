...
from mastapy.materials import _206
...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_206.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_206.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_206.AcousticRadiationEfficiencyInputType'):
