...
from mastapy.materials import _44
...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_44.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_44.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_44.AcousticRadiationEfficiencyInputType'):
