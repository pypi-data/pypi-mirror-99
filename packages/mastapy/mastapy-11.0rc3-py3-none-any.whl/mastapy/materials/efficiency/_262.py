...
class OilPumpDetail(_1344.IndependentReportablePropertiesBase['OilPumpDetail']):
    '''OilPumpDetail
    ...
    @property
    def oil_pump_drive_type(self) -> '_263.OilPumpDriveType':
        ...
        return constructor.new(_263.OilPumpDriveType)(value) if value else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_263.OilPumpDriveType'):
