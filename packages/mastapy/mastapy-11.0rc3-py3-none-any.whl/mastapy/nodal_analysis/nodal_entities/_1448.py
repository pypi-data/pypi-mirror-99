...
class Bar(_1463.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1379.BarGeometry':
        ...
        return constructor.new(_1379.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
