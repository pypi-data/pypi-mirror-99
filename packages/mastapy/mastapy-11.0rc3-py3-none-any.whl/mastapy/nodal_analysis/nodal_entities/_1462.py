...
class LineContactStiffnessEntity(_1447.ArbitraryNodalComponent):
    '''LineContactStiffnessEntity
    ...
    @property
    def stiffness_in_local_coordinate_system(self) -> '_1403.NodalMatrix':
        ...
        return constructor.new(_1403.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem else None
