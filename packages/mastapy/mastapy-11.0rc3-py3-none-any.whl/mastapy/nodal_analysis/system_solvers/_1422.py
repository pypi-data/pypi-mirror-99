...
from mastapy.nodal_analysis.system_solvers import _1432
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_1432.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
