...
from mastapy.nodal_analysis.system_solvers import _1431
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_1431.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
