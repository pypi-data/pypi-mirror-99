...
from mastapy.nodal_analysis import _1386, _1414, _1401
...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_shape(self) -> '_1414.VolumeElementShape':
        ...
        return constructor.new(_1414.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_1414.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_diameter_for_gear(self) -> '_1401.MeshingDiameterForGear':
        ...
        return constructor.new(_1401.MeshingDiameterForGear)(value) if value else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_1401.MeshingDiameterForGear'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
