...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _966
...
class ElementPropertiesBeam(_1490.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self) -> '_966.BeamSectionType':
        ...
        return constructor.new(_966.BeamSectionType)(value) if value else None
