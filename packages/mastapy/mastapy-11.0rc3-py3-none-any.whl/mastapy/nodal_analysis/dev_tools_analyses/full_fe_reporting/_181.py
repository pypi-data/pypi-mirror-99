...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _178
...
class ElementPropertiesMass(_178.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1280.InertiaTensor':
        ...
        return constructor.new(_1280.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
