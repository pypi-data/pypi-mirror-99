...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _175
...
class RigidElementNodeDegreesOfFreedom(_0.APIBase):
    ...
    @property
    def type_(self) -> '_175.DegreeOfFreedomType':
        ...
        return constructor.new(_175.DegreeOfFreedomType)(value) if value else None
