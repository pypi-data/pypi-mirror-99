...
from mastapy.fe_tools.enums import _970
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_970.ElementPropertyClass':
        ...
        return constructor.new(_970.ElementPropertyClass)(value) if value else None
