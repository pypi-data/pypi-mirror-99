...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1144, _1143
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1144.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1144.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_1143.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1143.ContactPairConstrainedSurfaceType)(value) if value else None
