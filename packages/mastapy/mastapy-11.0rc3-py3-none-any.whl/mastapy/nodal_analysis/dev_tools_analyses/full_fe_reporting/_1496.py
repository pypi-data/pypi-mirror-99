...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1483
...
class RigidElementNodeDegreesOfFreedom(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1483.DegreeOfFreedomType':
        ...
        return constructor.new(_1483.DegreeOfFreedomType)(value) if value else None
