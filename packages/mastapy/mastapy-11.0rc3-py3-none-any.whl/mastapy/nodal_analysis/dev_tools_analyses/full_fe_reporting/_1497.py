...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _970, _969
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_970.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_970.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_969.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_969.ContactPairConstrainedSurfaceType)(value) if value else None
