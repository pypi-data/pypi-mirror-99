...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1515, _1503
...
class ElementPropertiesRigid(_1503.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1515.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1515.RigidElementNodeDegreesOfFreedom))
        return value
