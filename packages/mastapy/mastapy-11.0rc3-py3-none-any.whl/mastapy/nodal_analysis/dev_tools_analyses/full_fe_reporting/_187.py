...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def elastic_modulus_components(self) -> '_176.ElasticModulusOrthotropicComponents':
        ...
        return constructor.new(_176.ElasticModulusOrthotropicComponents)(self.wrapped.ElasticModulusComponents) if self.wrapped.ElasticModulusComponents else None

    @property
    def shear_modulus_components(self) -> '_191.ShearModulusOrthotropicComponents':
        ...
        return constructor.new(_191.ShearModulusOrthotropicComponents)(self.wrapped.ShearModulusComponents) if self.wrapped.ShearModulusComponents else None

    @property
    def poissons_ratio_components(self) -> '_189.PoissonRatioOrthotropicComponents':
        ...
        return constructor.new(_189.PoissonRatioOrthotropicComponents)(self.wrapped.PoissonsRatioComponents) if self.wrapped.PoissonsRatioComponents else None

    @property
    def thermal_expansion_coefficient_components(self) -> '_192.ThermalExpansionOrthotropicComponents':
        ...
        return constructor.new(_192.ThermalExpansionOrthotropicComponents)(self.wrapped.ThermalExpansionCoefficientComponents) if self.wrapped.ThermalExpansionCoefficientComponents else None
