...
from mastapy.fe_tools.vis_tools_visualisation.enums import _964
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_964.CoordinateSystemType':
        ...
        return constructor.new(_964.CoordinateSystemType)(value) if value else None
