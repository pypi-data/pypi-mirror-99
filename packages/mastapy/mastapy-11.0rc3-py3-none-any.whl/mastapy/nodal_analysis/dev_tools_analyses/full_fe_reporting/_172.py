...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1143, _1142
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1143.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1143.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_1142.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1142.ContactPairConstrainedSurfaceType)(value) if value else None
