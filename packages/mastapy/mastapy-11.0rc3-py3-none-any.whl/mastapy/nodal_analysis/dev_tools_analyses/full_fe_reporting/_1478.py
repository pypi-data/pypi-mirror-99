...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _968, _967
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_968.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_968.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_967.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_967.ContactPairConstrainedSurfaceType)(value) if value else None
