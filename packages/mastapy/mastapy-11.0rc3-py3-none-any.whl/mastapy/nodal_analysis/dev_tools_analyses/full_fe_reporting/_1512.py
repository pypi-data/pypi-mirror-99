...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def elastic_modulus_components(self) -> '_1501.ElasticModulusOrthotropicComponents':
        ...
        return constructor.new(_1501.ElasticModulusOrthotropicComponents)(self.wrapped.ElasticModulusComponents) if self.wrapped.ElasticModulusComponents else None

    @property
    def shear_modulus_components(self) -> '_1516.ShearModulusOrthotropicComponents':
        ...
        return constructor.new(_1516.ShearModulusOrthotropicComponents)(self.wrapped.ShearModulusComponents) if self.wrapped.ShearModulusComponents else None

    @property
    def poissons_ratio_components(self) -> '_1514.PoissonRatioOrthotropicComponents':
        ...
        return constructor.new(_1514.PoissonRatioOrthotropicComponents)(self.wrapped.PoissonsRatioComponents) if self.wrapped.PoissonsRatioComponents else None

    @property
    def thermal_expansion_coefficient_components(self) -> '_1517.ThermalExpansionOrthotropicComponents':
        ...
        return constructor.new(_1517.ThermalExpansionOrthotropicComponents)(self.wrapped.ThermalExpansionCoefficientComponents) if self.wrapped.ThermalExpansionCoefficientComponents else None
