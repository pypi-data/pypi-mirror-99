...
class FEModelInstanceDrawStyle(_0.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_1455.DrawStyleForImportedFE':
        ...
        return constructor.new(_1455.DrawStyleForImportedFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
