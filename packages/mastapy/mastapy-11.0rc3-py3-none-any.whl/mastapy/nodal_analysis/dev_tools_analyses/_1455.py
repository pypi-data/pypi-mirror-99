...
class DrawStyleForImportedFE(_0.APIBase):
    ...
    @property
    def line_option(self) -> '_1372.FEMeshElementEntityOption':
        ...
        return constructor.new(_1372.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_1372.FEMeshElementEntityOption'):
