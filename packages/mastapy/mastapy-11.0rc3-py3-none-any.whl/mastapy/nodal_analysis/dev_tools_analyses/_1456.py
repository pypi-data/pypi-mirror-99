...
from mastapy.nodal_analysis import _1387
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.nodal_analysis.dev_tools_analyses import _1474
...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_1474.MassMatrixType':
        ...
        return constructor.new(_1474.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_1474.MassMatrixType'):
