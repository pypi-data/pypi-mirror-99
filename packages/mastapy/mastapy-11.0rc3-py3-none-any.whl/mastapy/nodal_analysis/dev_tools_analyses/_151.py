...
from mastapy.nodal_analysis.dev_tools_analyses import _169
...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_169.MassMatrixType':
        ...
        return constructor.new(_169.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_169.MassMatrixType'):
