...
from mastapy.math_utility import _1070
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1070.DataPrecision':
        ...
        return constructor.new(_1070.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1070.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1456.EigenvalueOptions':
        ...
        return constructor.new(_1456.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
