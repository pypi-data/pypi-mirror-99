...
from mastapy.nodal_analysis.component_mode_synthesis import _1500, _1497
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1461.FEModel':
        ...
        return constructor.new(_1461.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1500.CMSOptions':
        ...
        return constructor.new(_1500.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1497.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1497.CMSElementFaceGroup))
        return value
