...
from mastapy.units_and_measurements import _6530
...
class MeasurementTypeExtensions:
    ...
    @staticmethod
    def is_unmeasurable(measurement_type: '_6530.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_valid(measurement_type: '_6530.MeasurementType') -> 'bool':
