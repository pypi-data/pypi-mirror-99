...
from mastapy.math_utility import _1270
...
class Eigenmodes(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1270.Eigenmode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_1270.Eigenmode))
        return value
