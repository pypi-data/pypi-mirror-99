...
from mastapy.math_utility import _1283
...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self) -> '_1283.PIDControlUpdateMethod':
        ...
        return constructor.new(_1283.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1283.PIDControlUpdateMethod'):
