...
from mastapy.math_utility import _1095
...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self) -> '_1095.PIDControlUpdateMethod':
        ...
        return constructor.new(_1095.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1095.PIDControlUpdateMethod'):
