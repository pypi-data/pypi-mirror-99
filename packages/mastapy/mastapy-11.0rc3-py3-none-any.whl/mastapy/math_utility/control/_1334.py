...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self) -> '_1284.PIDControlUpdateMethod':
        ...
        return constructor.new(_1284.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1284.PIDControlUpdateMethod'):
