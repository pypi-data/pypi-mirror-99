...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    def coordinate_system_for_rotation_origin(self) -> '_1501.CoordinateSystemForRotationOrigin':
        ...
        return constructor.new(_1501.CoordinateSystemForRotationOrigin)(value) if value else None

    @coordinate_system_for_rotation_origin.setter
    def coordinate_system_for_rotation_origin(self, value: '_1501.CoordinateSystemForRotationOrigin'):
    ...
    @property
    def rotation_axis(self) -> '_1527.RotationAxis':
        '''RotationAxis: 'RotationAxis' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RotationAxis)
        return constructor.new(_1527.RotationAxis)(value) if value else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1527.RotationAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RotationAxis = value

    @property
    def coordinate_system_for_rotation_axes(self) -> '_1500.CoordinateSystemForRotation':
        ...
        return constructor.new(_1500.CoordinateSystemForRotation)(value) if value else None

    @coordinate_system_for_rotation_axes.setter
    def coordinate_system_for_rotation_axes(self, value: '_1500.CoordinateSystemForRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def containing_assembly_image(self) -> '_7157.SMTBitmap':
        '''SMTBitmap: 'ContainingAssemblyImage' is the original name of this property.'''

        return constructor.new(_7157.SMTBitmap)(self.wrapped.ContainingAssemblyImage) if self.wrapped.ContainingAssemblyImage else None

    @containing_assembly_image.setter
    def containing_assembly_image(self, value: '_7157.SMTBitmap'):
    ...
    @property
    def root_assembly_image(self) -> '_7157.SMTBitmap':
        '''SMTBitmap: 'RootAssemblyImage' is the original name of this property.'''

        return constructor.new(_7157.SMTBitmap)(self.wrapped.RootAssemblyImage) if self.wrapped.RootAssemblyImage else None

    @root_assembly_image.setter
    def root_assembly_image(self, value: '_7157.SMTBitmap'):
        value = value.wrapped if value else None
        self.wrapped.RootAssemblyImage = value

    @property
    def coordinate_system(self) -> '_1498.CoordinateSystem3D':
        ...
        return constructor.new(_1498.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def modified_coordinate_system_for_rotation(self) -> '_1498.CoordinateSystem3D':
        ...
        return constructor.new(_1498.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForRotation) if self.wrapped.ModifiedCoordinateSystemForRotation else None

    @property
    def modified_coordinate_system_for_translation(self) -> '_1498.CoordinateSystem3D':
        ...
        return constructor.new(_1498.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForTranslation) if self.wrapped.ModifiedCoordinateSystemForTranslation else None
