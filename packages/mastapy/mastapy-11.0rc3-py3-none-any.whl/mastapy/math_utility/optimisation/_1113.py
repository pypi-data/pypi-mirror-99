...
from mastapy.math_utility.optimisation import _1120
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1120.ParetoOptimisationInput':
        ...
        return constructor.new(_1120.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
