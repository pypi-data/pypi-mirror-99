...
from mastapy.math_utility.optimisation import _1557, _1556
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def integer_range(self) -> '_1260.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1260.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange else None

    @integer_range.setter
    def integer_range(self, value: '_1260.IntegerRange'):
        value = value.wrapped if value else None
    ...
    @property
    def specification_type(self) -> '_1557.TargetingPropertyTo':
        ...
        return constructor.new(_1557.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1557.TargetingPropertyTo'):
