...
from mastapy.math_utility.optimisation import _1559, _1557
...
class ParetoOptimistaionVariable(_1557.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1559.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1559.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1559.PropertyTargetForDominantCandidateSearch'):
