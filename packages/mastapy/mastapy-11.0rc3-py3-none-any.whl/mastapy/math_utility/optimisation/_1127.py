...
class ParetoOptimistaionVariable(_1126.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1128.PropertyTargetForDominantCandidateSearch':
    ...
    def property_target_for_dominant_candidate_search(self, value: '_1128.PropertyTargetForDominantCandidateSearch'):
