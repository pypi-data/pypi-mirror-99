...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self) -> '_1136.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1136.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
