...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self) -> '_1123.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1123.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
