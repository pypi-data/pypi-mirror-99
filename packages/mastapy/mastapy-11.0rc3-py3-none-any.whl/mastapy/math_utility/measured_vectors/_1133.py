...
from mastapy.math_utility.measured_vectors import _1137, _1132
...
class ForceAndDisplacementResults(_1132.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1137.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1137.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
