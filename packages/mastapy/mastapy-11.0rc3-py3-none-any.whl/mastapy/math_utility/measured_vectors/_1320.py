...
from mastapy.math_utility.measured_vectors import _1324, _1319
...
class ForceAndDisplacementResults(_1319.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1324.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1324.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
