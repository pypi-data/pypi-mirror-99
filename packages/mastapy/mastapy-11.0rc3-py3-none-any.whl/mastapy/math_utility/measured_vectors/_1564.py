...
from mastapy.math_utility.measured_vectors import _1568, _1563
...
class ForceAndDisplacementResults(_1563.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1568.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1568.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
