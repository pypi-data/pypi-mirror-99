...
class OverridableDisplacementBoundaryCondition(_0.APIBase):
    ...
    def theta_x(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ThetaX) if self.wrapped.ThetaX else None
    ...
    def theta_y(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ThetaY) if self.wrapped.ThetaY else None
    ...
    def theta_z(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ThetaZ) if self.wrapped.ThetaZ else None
