...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self) -> '_1324.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1324.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
