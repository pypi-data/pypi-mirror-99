...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def history(self) -> '_1137.FileHistory':
        ...
        return constructor.new(_1137.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def database_key(self) -> '_1350.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1350.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey else None

    @database_key.setter
    def database_key(self, value: '_1350.NamedKey'):
