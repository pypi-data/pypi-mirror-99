...
from mastapy.utility import _1337
from mastapy.utility.databases import _1551
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def history(self) -> '_1337.FileHistory':
        ...
        return constructor.new(_1337.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def database_key(self) -> '_1551.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1551.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey else None

    @database_key.setter
    def database_key(self, value: '_1551.NamedKey'):
