...
from mastapy.utility.databases import _1346, _1343, _1342
...
TKey = TypeVar('TKey', bound='_1343.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1342.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1346.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1343.DatabaseKey'):
