...
from mastapy.utility.databases import _1556, _1553, _1552
...
TKey = TypeVar('TKey', bound='_1553.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1552.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1556.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1553.DatabaseKey'):
