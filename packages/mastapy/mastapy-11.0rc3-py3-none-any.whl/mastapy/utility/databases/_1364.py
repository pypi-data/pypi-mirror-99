...
from mastapy.utility.databases import _1362, _1359, _1358
...
TKey = TypeVar('TKey', bound='_1359.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1358.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1362.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1359.DatabaseKey'):
