...
from mastapy.utility.databases import _1468, _1465, _1464
...
class SQLDatabase(_1464.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1468.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1465.DatabaseKey'):
