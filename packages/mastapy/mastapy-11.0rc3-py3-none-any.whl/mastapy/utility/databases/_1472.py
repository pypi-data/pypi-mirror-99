...
from mastapy.utility.databases import _1470, _1467, _1466
...
TKey = TypeVar('TKey', bound='_1467.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1466.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1470.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1467.DatabaseKey'):
