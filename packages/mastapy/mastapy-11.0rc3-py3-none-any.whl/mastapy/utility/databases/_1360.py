...
from mastapy.utility.databases import _1361, _1363, _1362
...
TValue = TypeVar('TValue', bound='_1361.NamedDatabaseItem')


class NamedDatabase(_1363.SQLDatabase['_1362.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1361.NamedDatabaseItem', new_name: 'str') -> 'bool':
