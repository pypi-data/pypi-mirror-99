...
from mastapy.utility import _1255
from mastapy.utility.databases import _1469
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def history(self) -> '_1255.FileHistory':
        ...
        return constructor.new(_1255.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def database_key(self) -> '_1469.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1469.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey else None

    @database_key.setter
    def database_key(self, value: '_1469.NamedKey'):
