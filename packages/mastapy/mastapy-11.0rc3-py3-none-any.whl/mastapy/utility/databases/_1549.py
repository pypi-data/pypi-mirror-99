...
from mastapy.utility.databases import _1550, _1552, _1551
...
TValue = TypeVar('TValue', bound='_1550.NamedDatabaseItem')


class NamedDatabase(_1552.SQLDatabase['_1551.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1550.NamedDatabaseItem', new_name: 'str') -> 'bool':
