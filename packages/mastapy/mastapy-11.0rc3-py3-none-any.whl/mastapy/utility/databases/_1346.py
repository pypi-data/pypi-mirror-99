...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def history(self) -> '_1135.FileHistory':
        ...
        return constructor.new(_1135.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def database_key(self) -> '_1347.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1347.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey else None

    @database_key.setter
    def database_key(self, value: '_1347.NamedKey'):
