...
from mastapy.utility import _1142, _1131
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self) -> '_1142.NumberFormatInfoSummary':
        ...
        return constructor.new(_1142.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1131.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1131.DispatcherHelper))
        return value
