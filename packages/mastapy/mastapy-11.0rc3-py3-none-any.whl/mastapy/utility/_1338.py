...
from mastapy.utility import _1348, _1337
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self) -> '_1348.NumberFormatInfoSummary':
        ...
        return constructor.new(_1348.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1337.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1337.DispatcherHelper))
        return value
