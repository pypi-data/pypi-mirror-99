...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1161.RoundingMethods':
        ...
        return constructor.new(_1161.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1161.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1173.Unit':
        ...
        if _1173.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
