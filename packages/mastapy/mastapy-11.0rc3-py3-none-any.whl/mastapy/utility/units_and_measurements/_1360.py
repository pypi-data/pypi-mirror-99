...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1353.RoundingMethods':
        ...
        return constructor.new(_1353.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1353.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1365.Unit':
        ...
        if _1365.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
