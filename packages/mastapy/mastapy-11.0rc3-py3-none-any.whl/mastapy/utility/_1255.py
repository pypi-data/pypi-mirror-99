...
from mastapy.utility import _1256
...
class FileHistory(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1256.FileHistoryItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_1256.FileHistoryItem))
        return value
