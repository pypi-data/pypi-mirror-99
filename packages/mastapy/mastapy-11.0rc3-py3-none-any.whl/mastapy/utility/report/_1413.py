...
from mastapy.utility.report import _1414, _1415
...
T = TypeVar('T', bound='_1415.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1414.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
