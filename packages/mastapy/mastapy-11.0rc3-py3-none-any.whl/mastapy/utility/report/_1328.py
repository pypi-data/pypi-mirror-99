...
from mastapy.utility.report import _1327, _1320
...
class UserTextRow(_1320.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1327.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1327.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1327.HeadingSize'):
