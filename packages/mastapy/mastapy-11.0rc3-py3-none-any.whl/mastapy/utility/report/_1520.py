...
from mastapy.utility.report import _1519, _1512
...
class UserTextRow(_1512.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1519.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1519.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1519.HeadingSize'):
