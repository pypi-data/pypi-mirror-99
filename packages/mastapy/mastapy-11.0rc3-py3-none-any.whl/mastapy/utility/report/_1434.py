...
from mastapy.utility.report import _1433, _1426
...
class UserTextRow(_1426.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1433.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1433.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1433.HeadingSize'):
