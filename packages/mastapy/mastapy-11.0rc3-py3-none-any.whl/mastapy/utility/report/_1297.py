...
from mastapy.utility.cad_export import _1365
...
class CustomReportCadDrawing(_1313.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1365.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1365.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1365.StockDrawings'):
