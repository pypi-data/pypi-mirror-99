...
from mastapy.utility.cad_export import _1560
from mastapy.utility.report import _1505
...
class CustomReportCadDrawing(_1505.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1560.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1560.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1560.StockDrawings'):
