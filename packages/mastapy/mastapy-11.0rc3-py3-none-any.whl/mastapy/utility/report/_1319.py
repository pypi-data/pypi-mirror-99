...
class CustomReportText(_1302.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_105.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_105.HeadingType)(value) if value else None

    @heading_type.setter
    def heading_type(self, value: '_105.HeadingType'):
