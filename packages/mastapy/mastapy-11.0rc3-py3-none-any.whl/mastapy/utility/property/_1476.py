...
from mastapy.utility.units_and_measurements.measurements import _1345
...
class DutyCyclePropertySummaryPercentage(_1474.DutyCyclePropertySummary['_1345.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
