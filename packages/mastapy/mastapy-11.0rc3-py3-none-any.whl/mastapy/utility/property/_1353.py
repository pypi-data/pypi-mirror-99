...
from mastapy.utility.units_and_measurements.measurements import _1184
...
class DutyCyclePropertySummaryForce(_1352.DutyCyclePropertySummary['_1184.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
