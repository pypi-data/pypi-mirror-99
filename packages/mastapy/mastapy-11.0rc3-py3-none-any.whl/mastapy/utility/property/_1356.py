...
from mastapy.utility.units_and_measurements.measurements import _1246
...
class DutyCyclePropertySummaryStress(_1352.DutyCyclePropertySummary['_1246.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
