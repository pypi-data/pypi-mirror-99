...
from mastapy.utility.units_and_measurements.measurements import _1431
...
class DutyCyclePropertySummaryPercentage(_1563.DutyCyclePropertySummary['_1431.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
