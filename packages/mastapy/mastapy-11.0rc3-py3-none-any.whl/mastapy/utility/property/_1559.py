...
from mastapy.utility.units_and_measurements.measurements import _1366
...
class DutyCyclePropertySummarySmallAngle(_1556.DutyCyclePropertySummary['_1366.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
