...
from mastapy.utility.units_and_measurements.measurements import _1199
...
class DutyCyclePropertySummaryForce(_1367.DutyCyclePropertySummary['_1199.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
