...
from mastapy.utility.units_and_measurements.measurements import _1284
...
class DutyCyclePropertySummarySmallAngle(_1474.DutyCyclePropertySummary['_1284.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
