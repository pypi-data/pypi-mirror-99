...
from mastapy.utility.units_and_measurements.measurements import _1453
...
class DutyCyclePropertySummaryStress(_1563.DutyCyclePropertySummary['_1453.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
