...
from mastapy.utility.model_validation import _1436
...
class StatusItem(_0.APIBase):
    ...
    def fixes(self) -> 'List[_1436.Fix]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Fixes, constructor.new(_1436.Fix))
        return value
