...
from mastapy.utility.modal_analysis.gears import _1530, _1533, _1535
...
class GearOrderForTE(_1535.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1530.GearPositions':
        ...
        return constructor.new(_1530.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1533.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1533.OrderForTE))
        return value
