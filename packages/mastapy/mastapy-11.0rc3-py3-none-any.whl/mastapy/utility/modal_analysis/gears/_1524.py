...
from mastapy.utility.modal_analysis.gears import _1525, _1529
...
class GearMeshForTE(_1529.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1525.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1525.GearOrderForTE))
        return value
