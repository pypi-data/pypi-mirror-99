...
from mastapy.utility.modal_analysis.gears import _1526, _1529, _1531
...
class GearOrderForTE(_1531.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1526.GearPositions':
        ...
        return constructor.new(_1526.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1529.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1529.OrderForTE))
        return value
