...
from mastapy.utility.modal_analysis.gears import _1337, _1340, _1342
...
class GearOrderForTE(_1342.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1337.GearPositions':
        ...
        return constructor.new(_1337.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1340.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1340.OrderForTE))
        return value
