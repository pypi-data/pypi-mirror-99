...
from mastapy.utility.modal_analysis.gears import _1335, _1339
...
class GearMeshForTE(_1339.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1335.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1335.GearOrderForTE))
        return value
