...
class FileHistory(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1342.FileHistoryItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_1342.FileHistoryItem))
        return value
    ...
    def add_history_item(self, user_name: 'str', comment: 'str'):
        ...
        comment = str(comment)
        self.wrapped.AddHistoryItem(user_name if user_name else None, comment if comment else None)
