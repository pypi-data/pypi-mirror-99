...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def twod_spline_drawing(self) -> '_6532.SMTBitmap':
        ...
        return constructor.new(_6532.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None

    @property
    def halves(self) -> 'List[_975.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_975.DetailedRigidConnectorHalfDesign))
        return value
