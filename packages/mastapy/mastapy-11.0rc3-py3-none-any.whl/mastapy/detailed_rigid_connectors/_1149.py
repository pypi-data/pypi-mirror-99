...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def two_d_spline_drawing(self) -> '_7154.SMTBitmap':
        ...
        return constructor.new(_7154.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None

    @property
    def halves(self) -> 'List[_1150.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_1150.DetailedRigidConnectorHalfDesign))
        return value
