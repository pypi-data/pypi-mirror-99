...
from mastapy.detailed_rigid_connectors.keyed_joints import _1202, _1200
...
class KeyedJointDesign(_1207.InterferenceFitDesign):
    '''KeyedJointDesign
