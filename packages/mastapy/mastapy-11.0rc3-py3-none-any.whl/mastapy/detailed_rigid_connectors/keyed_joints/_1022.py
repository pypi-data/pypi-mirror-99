...
from mastapy.detailed_rigid_connectors.keyed_joints import _1025, _1023
...
class KeyedJointDesign(_1030.InterferenceFitDesign):
    '''KeyedJointDesign
