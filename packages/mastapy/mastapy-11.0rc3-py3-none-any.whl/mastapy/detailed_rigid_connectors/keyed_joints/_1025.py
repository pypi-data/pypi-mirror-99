...
from mastapy.detailed_rigid_connectors.keyed_joints import _1028, _1026
...
class KeyedJointDesign(_1033.InterferenceFitDesign):
    '''KeyedJointDesign
