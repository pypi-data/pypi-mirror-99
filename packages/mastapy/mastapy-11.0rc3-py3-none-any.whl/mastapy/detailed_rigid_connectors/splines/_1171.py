...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1186
from mastapy.detailed_rigid_connectors.splines import _1183
...
class SAESplineHalfDesign(_1183.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1186.SAESplineTolerances':
        ...
        return constructor.new(_1186.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
