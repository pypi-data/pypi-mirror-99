...
from mastapy.detailed_rigid_connectors.splines import _1162
...
class SplineMaterial(_235.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_1162.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1162.HeatTreatmentTypes'):
