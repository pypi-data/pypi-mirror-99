...
from mastapy.detailed_rigid_connectors.interference_fits import _1029, _1028, _1033
...
class InterferenceFitDesign(_972.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1029.CalculationMethods':
        ...
        return constructor.new(_1029.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1029.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1028.AssemblyMethods':
        ...
        return constructor.new(_1028.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1028.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
