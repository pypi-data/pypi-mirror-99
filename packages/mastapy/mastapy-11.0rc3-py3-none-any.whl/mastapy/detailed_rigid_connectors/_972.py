...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def twod_spline_drawing(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None

    @property
    def halves(self) -> 'List[_973.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_973.DetailedRigidConnectorHalfDesign))
        return value
