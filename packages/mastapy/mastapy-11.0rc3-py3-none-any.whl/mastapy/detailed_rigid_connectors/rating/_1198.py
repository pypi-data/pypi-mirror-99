...
from mastapy.detailed_rigid_connectors import _1149
from mastapy.detailed_rigid_connectors.splines import (
    _1152, _1155, _1159, _1162,
    _1163, _1170, _1177, _1182
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints import _1199
from mastapy.detailed_rigid_connectors.interference_fits import _1207
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1149.DetailedRigidConnectorDesign':
        ...
        if _1149.DetailedRigidConnectorDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1152.CustomSplineJointDesign':
        ...
        if _1152.CustomSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1155.DIN5480SplineJointDesign':
        ...
        if _1155.DIN5480SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1159.GBT3478SplineJointDesign':
        ...
        if _1159.GBT3478SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1162.ISO4156SplineJointDesign':
        ...
        if _1162.ISO4156SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1163.JISB1603SplineJointDesign':
        ...
        if _1163.JISB1603SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1170.SAESplineJointDesign':
        ...
        if _1170.SAESplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1177.SplineJointDesign':
        ...
        if _1177.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1182.StandardSplineJointDesign':
        ...
        if _1182.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1199.KeyedJointDesign':
        ...
        if _1199.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1207.InterferenceFitDesign':
        ...
        if _1207.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
