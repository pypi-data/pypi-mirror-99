...
from mastapy.detailed_rigid_connectors import _1150
from mastapy.detailed_rigid_connectors.splines import (
    _1153, _1156, _1160, _1163,
    _1164, _1171, _1178, _1183
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1150.DetailedRigidConnectorDesign':
        ...
        if _1150.DetailedRigidConnectorDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1153.CustomSplineJointDesign':
        ...
        if _1153.CustomSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1156.DIN5480SplineJointDesign':
        ...
        if _1156.DIN5480SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1160.GBT3478SplineJointDesign':
        ...
        if _1160.GBT3478SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1163.ISO4156SplineJointDesign':
        ...
        if _1163.ISO4156SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1164.JISB1603SplineJointDesign':
        ...
        if _1164.JISB1603SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1171.SAESplineJointDesign':
        ...
        if _1171.SAESplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1178.SplineJointDesign':
        ...
        if _1178.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1183.StandardSplineJointDesign':
        ...
        if _1183.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1200.KeyedJointDesign':
        ...
        if _1200.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1208.InterferenceFitDesign':
        ...
        if _1208.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
