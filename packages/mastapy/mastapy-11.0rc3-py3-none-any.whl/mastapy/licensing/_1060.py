...
from mastapy.licensing import _6535, _6536, _6537
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_6535.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_6535.LicenceServerDetails':
        ...
        return constructor.new(_6535.LicenceServerDetails)(method_result) if method_result else None
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_6536.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetLicensedModuleDetails(), constructor.new(_6536.ModuleDetails))

    @staticmethod
    def get_available_module_details() -> 'Iterable[_6536.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetAvailableModuleDetails(), constructor.new(_6536.ModuleDetails))

    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_6537.ModuleLicenceStatus]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetRequestedModuleStatuses(), constructor.new(_6537.ModuleLicenceStatus))
