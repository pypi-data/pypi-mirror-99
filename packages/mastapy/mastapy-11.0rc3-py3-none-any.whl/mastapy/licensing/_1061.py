...
from mastapy.licensing import _6538, _6539, _6540
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_6538.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_6538.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_6539.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetLicensedModuleDetails(), constructor.new(_6539.ModuleDetails))

    @staticmethod
    def get_available_module_details() -> 'Iterable[_6539.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetAvailableModuleDetails(), constructor.new(_6539.ModuleDetails))

    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_6540.ModuleLicenceStatus]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetRequestedModuleStatuses(), constructor.new(_6540.ModuleLicenceStatus))
