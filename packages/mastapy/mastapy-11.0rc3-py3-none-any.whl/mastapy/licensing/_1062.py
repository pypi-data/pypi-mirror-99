...
from mastapy.licensing import _6580, _6581, _6582
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_6580.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_6580.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_6581.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetLicensedModuleDetails(), constructor.new(_6581.ModuleDetails))

    @staticmethod
    def get_available_module_details() -> 'Iterable[_6581.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetAvailableModuleDetails(), constructor.new(_6581.ModuleDetails))

    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_6582.ModuleLicenceStatus]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetRequestedModuleStatuses(), constructor.new(_6582.ModuleLicenceStatus))
