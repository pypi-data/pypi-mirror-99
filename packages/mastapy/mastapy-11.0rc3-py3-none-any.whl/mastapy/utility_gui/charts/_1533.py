...
class CustomTableAndChart(_1322.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1063.Range':
        ...
        if _1063.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
