...
from mastapy.utility.report import _1510
...
class CustomTableAndChart(_1510.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1249.Range':
        ...
        if _1249.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
