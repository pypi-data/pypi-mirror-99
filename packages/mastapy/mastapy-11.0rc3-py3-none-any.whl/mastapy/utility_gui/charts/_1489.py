...
from mastapy.math_utility.measured_ranges import _1569
...
class CustomTableAndChart(_1428.CustomTable):
    ...
    @property
    def primary_axis_range(self) -> '_1492.Range':
        ...
        if _1492.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
