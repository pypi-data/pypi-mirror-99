...
from mastapy.math_utility.measured_ranges import _1139
from mastapy._internal.cast_exception import CastException
from mastapy.utility.report import _1323
...
class CustomTableAndChart(_1323.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1064.Range':
        ...
        if _1064.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
