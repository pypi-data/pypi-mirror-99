...
from mastapy.utility.report import _1513
...
class CustomTableAndChart(_1513.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1250.Range':
        ...
        if _1250.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
