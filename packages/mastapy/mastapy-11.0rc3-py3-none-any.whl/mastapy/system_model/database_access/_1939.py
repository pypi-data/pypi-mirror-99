...
from mastapy.system_model.optimization import _1907, _1916
...
class Databases(_0.APIBase):
    ...
    @property
    def conical_gear_optimization_strategy_database(self) -> '_1907.ConicalGearOptimizationStrategyDatabase':
        ...
        return constructor.new(_1907.ConicalGearOptimizationStrategyDatabase)(self.wrapped.ConicalGearOptimizationStrategyDatabase) if self.wrapped.ConicalGearOptimizationStrategyDatabase else None

    @property
    def optimization_strategy_database(self) -> '_1916.OptimizationStrategyDatabase':
        ...
        return constructor.new(_1916.OptimizationStrategyDatabase)(self.wrapped.OptimizationStrategyDatabase) if self.wrapped.OptimizationStrategyDatabase else None

    @property
    def supercharger_rotor_set_database(self) -> '_2234.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2234.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None
