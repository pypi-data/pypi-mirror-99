...
from mastapy.bearings import _1558
...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2148
...
class Databases(_0.APIBase):
    ...
    @property
    def rolling_bearing_database(self) -> '_1558.RollingBearingDatabase':
        ...
        return constructor.new(_1558.RollingBearingDatabase)(self.wrapped.RollingBearingDatabase) if self.wrapped.RollingBearingDatabase else None
    ...
    @property
    def supercharger_rotor_set_database(self) -> '_2148.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2148.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None
