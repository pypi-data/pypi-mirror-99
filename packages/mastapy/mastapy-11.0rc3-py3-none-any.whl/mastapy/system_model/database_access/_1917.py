...
from mastapy.bearings import _1592
from mastapy._internal import constructor
from mastapy.bolts import _1229, _1231, _1236
...
from mastapy.system_model.optimization import _1899, _1908
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2208
from mastapy.materials import _213, _214, _233
...
class Databases(_0.APIBase):
    ...
    @property
    def rolling_bearing_database(self) -> '_1592.RollingBearingDatabase':
        ...
        return constructor.new(_1592.RollingBearingDatabase)(self.wrapped.RollingBearingDatabase) if self.wrapped.RollingBearingDatabase else None

    @property
    def bolt_geometry_database(self) -> '_1229.BoltGeometryDatabase':
        ...
        return constructor.new(_1229.BoltGeometryDatabase)(self.wrapped.BoltGeometryDatabase) if self.wrapped.BoltGeometryDatabase else None

    @property
    def bolt_material_database(self) -> '_1231.BoltMaterialDatabase':
        ...
        return constructor.new(_1231.BoltMaterialDatabase)(self.wrapped.BoltMaterialDatabase) if self.wrapped.BoltMaterialDatabase else None

    @property
    def clamped_section_material_database(self) -> '_1236.ClampedSectionMaterialDatabase':
        ...
        return constructor.new(_1236.ClampedSectionMaterialDatabase)(self.wrapped.ClampedSectionMaterialDatabase) if self.wrapped.ClampedSectionMaterialDatabase else None
    ...
    @property
    def conical_gear_optimization_strategy_database(self) -> '_1899.ConicalGearOptimizationStrategyDatabase':
        ...
        return constructor.new(_1899.ConicalGearOptimizationStrategyDatabase)(self.wrapped.ConicalGearOptimizationStrategyDatabase) if self.wrapped.ConicalGearOptimizationStrategyDatabase else None

    @property
    def optimization_strategy_database(self) -> '_1908.OptimizationStrategyDatabase':
        ...
        return constructor.new(_1908.OptimizationStrategyDatabase)(self.wrapped.OptimizationStrategyDatabase) if self.wrapped.OptimizationStrategyDatabase else None

    @property
    def supercharger_rotor_set_database(self) -> '_2208.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2208.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None
