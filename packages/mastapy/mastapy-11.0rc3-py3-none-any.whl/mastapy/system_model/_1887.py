...
from mastapy.system_model_gui import _1571
...
from mastapy.system_model import (
    _1907, _1908, _1906, _1888
)
from mastapy.gears import _283, _289
from mastapy.gears.materials import _545
from mastapy.utility import _1342, _1341, _1340
from mastapy.shafts import _34
from mastapy.detailed_rigid_connectors.splines import _1155
from mastapy._math.vector_3d import Vector3D
from mastapy.system_model.part_model.gears import (
    _2187, _2208, _2188, _2189,
    _2190, _2191, _2192, _2193,
    _2194, _2195, _2196, _2197,
    _2198, _2199, _2200, _2201,
    _2202, _2203, _2204, _2205,
    _2207, _2209, _2210, _2211,
...
from mastapy.system_model.fe import _2041
from mastapy.bearings.bearing_results.rolling import _1676
from mastapy.system_model.part_model.configurations import _2289, _2287, _2290
...
from mastapy.utility.model_validation import _1524
from mastapy.system_model.database_access import _1944
...
from mastapy.gears.gear_designs.creation_options import _1057, _1060, _1059
from mastapy import _7196, _0
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2648
...
from mastapy.bearings.bearing_designs.rolling import _1853
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1571.MASTAGUI':
        ...
        return constructor.new(_1571.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def efficiency_rating_method_for_bearings(self) -> '_256.BearingEfficiencyRatingMethod':
        ...
        return constructor.new(_256.BearingEfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method_for_bearings.setter
    def efficiency_rating_method_for_bearings(self, value: '_256.BearingEfficiencyRatingMethod'):
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1907.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1907.ThermalExpansionOptionForGroundedNodes)(value) if value else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1907.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transverse_contact_ratio_requirement(self) -> '_283.ContactRatioRequirements':
        ...
        return constructor.new(_283.ContactRatioRequirements)(value) if value else None

    @transverse_contact_ratio_requirement.setter
    def transverse_contact_ratio_requirement(self, value: '_283.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TransverseContactRatioRequirement = value

    @property
    def axial_contact_ratio_requirement(self) -> '_283.ContactRatioRequirements':
    ...
    def axial_contact_ratio_requirement(self, value: '_283.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_545.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_545.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_545.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_545.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None

    @property
    def file_save_details_most_recent(self) -> '_1342.FileHistoryItem':
        ...
        return constructor.new(_1342.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1908.TransmissionTemperatureSet':
        ...
        return constructor.new(_1908.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_1155.DetailedSplineJointSettings':
        ...
        return constructor.new(_1155.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1341.FileHistory':
        ...
        return constructor.new(_1341.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None

    @property
    def gear_set_design_group(self) -> '_289.GearSetDesignGroup':
        ...
        return constructor.new(_289.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None

    @property
    def selected_gear_set_selection_group(self) -> '_2187.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2187.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1906.SystemReporting':
        ...
        return constructor.new(_1906.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_2041.BatchOperations':
        ...
        return constructor.new(_2041.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1676.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1676.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2187.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2187.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2289.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2289.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2287.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2287.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2290.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2290.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5319.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5319.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5320.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5320.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2151.RootAssembly':
        ...
        return constructor.new(_2151.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2208.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2208.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2208.GearSetConfiguration'):
    ...
    @property
    def databases(self) -> '_1944.Databases':
        ...
        return constructor.new(_1944.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    @property
    def masta_settings(self) -> '_1888.MastaSettings':
        ...
        return constructor.new(_1888.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings else None
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2246.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2249.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2250.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_pair_creation_options(self) -> '_1057.CylindricalGearPairCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2248.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_spiral_bevel_gear_set_creation_options(self) -> '_1060.SpiralBevelGearSetCreationOptions':
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_1059.HypoidGearSetCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2247.CycloidalAssemblyCreationOptions':
    ...
    def design_state_named(self, name: 'str') -> '_5319.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5320.DutyCycle':
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1524.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7196.TaskProgress') -> '_1524.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2648.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2648.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2648.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5319.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5320.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2112.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2112.Assembly.TYPE](), constructor.new(_2112.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1340.ExternalFullFEFileOption'] = _1340.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1853.RollingBearing'):
