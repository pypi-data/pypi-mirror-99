...
from mastapy.utility.model_validation import _1331, _1332
...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_1833.Design':
        ...
        return constructor.new(_1833.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties else None
    ...
    @property
    def all_status_errors(self) -> 'List[_1332.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1332.StatusItem))
        return value
