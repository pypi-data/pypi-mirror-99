...
from mastapy.system_model.analyses_and_results.static_loads import _6232, _6161
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.imported_fes import _1967
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6232.TorqueRippleInputType':
        ...
        return constructor.new(_6232.TorqueRippleInputType)(value) if value else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6232.TorqueRippleInputType'):
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_6161.HarmonicLoadDataType') -> '_1085.MultipleFourierSeriesInterpolator':
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_6161.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6532.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_6161.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6532.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for_with_stiffness_node(self, harmonic_load_data_type: '_6161.HarmonicLoadDataType', node: '_1967.ImportedFEStiffnessNode') -> '_1085.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
        ...
        harmonic_load_data_type = conversion.mp_to_pn_enum(harmonic_load_data_type)
        method_result = self.wrapped.MultipleFourierSeriesInterpolatorFor.Overloads[_HARMONIC_LOAD_DATA_TYPE, _IMPORTED_FE_STIFFNESS_NODE](harmonic_load_data_type, node.wrapped if node else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def add_or_replace_excitation_data_with_stiffness_node(self, harmonic_load_data_type: '_6161.HarmonicLoadDataType', node: '_1967.ImportedFEStiffnessNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6532.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
        ...
        fourier_series_name = str(fourier_series_name)
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type)
        self.wrapped.AddOrReplaceExcitationData.Overloads[_HARMONIC_LOAD_DATA_TYPE, _IMPORTED_FE_STIFFNESS_NODE, _DOUBLE, _LIST[_DOUBLE], _STRING, _MEASUREMENT_TYPE](harmonic_load_data_type, node.wrapped if node else None, speed if speed else 0.0, fourier_series_values, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)

    def add_or_replace_excitation_data_with_amplitudes_phases_and_stiffness_node(self, harmonic_load_data_type: '_6161.HarmonicLoadDataType', node: '_1967.ImportedFEStiffnessNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6532.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
        ...
        fourier_series_name = str(fourier_series_name)
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type)
        self.wrapped.AddOrReplaceExcitationData.Overloads[_HARMONIC_LOAD_DATA_TYPE, _IMPORTED_FE_STIFFNESS_NODE, _DOUBLE, _LIST[_DOUBLE], _LIST[_DOUBLE], _DOUBLE, _STRING, _MEASUREMENT_TYPE](harmonic_load_data_type, node.wrapped if node else None, speed if speed else 0.0, fourier_series_amplitudes, fourier_series_phases, fourier_series_mean_value if fourier_series_mean_value else 0.0, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)
