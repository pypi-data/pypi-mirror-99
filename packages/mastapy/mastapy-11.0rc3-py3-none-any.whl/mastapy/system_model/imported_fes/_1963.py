...
class ImportedFELink(_0.APIBase):
    ...
    @property
    def component(self) -> '_2046.Component':
        ...
        if _2046.Component.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_abstract_shaft_or_housing(self) -> '_2039.AbstractShaftOrHousing':
        ...
        if _2039.AbstractShaftOrHousing.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bearing(self) -> '_2042.Bearing':
    ...
    def component_of_type_bolt(self) -> '_2044.Bolt':
        ...
        if _2044.Bolt.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Bolt. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_connector(self) -> '_2049.Connector':
    ...
    def component_of_type_datum(self) -> '_2050.Datum':
        ...
        if _2050.Datum.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Datum. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_external_cad_model(self) -> '_2053.ExternalCADModel':
        ...
        if _2053.ExternalCADModel.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_guide_dxf_model(self) -> '_2055.GuideDxfModel':
        ...
        if _2055.GuideDxfModel.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_imported_fe_component(self) -> '_2058.ImportedFEComponent':
        ...
        if _2058.ImportedFEComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_mass_disc(self) -> '_2062.MassDisc':
        ...
        if _2062.MassDisc.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to MassDisc. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_measurement_component(self) -> '_2063.MeasurementComponent':
        ...
        if _2063.MeasurementComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_mountable_component(self) -> '_2064.MountableComponent':
        ...
        if _2064.MountableComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_oil_seal(self) -> '_2066.OilSeal':
        ...
        if _2066.OilSeal.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to OilSeal. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_planet_carrier(self) -> '_2069.PlanetCarrier':
        ...
        if _2069.PlanetCarrier.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_point_load(self) -> '_2071.PointLoad':
        ...
        if _2071.PointLoad.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to PointLoad. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_power_load(self) -> '_2072.PowerLoad':
        ...
        if _2072.PowerLoad.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to PowerLoad. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_unbalanced_mass(self) -> '_2077.UnbalancedMass':
        ...
        if _2077.UnbalancedMass.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_virtual_component(self) -> '_2078.VirtualComponent':
        ...
        if _2078.VirtualComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_shaft(self) -> '_2081.Shaft':
        ...
        if _2081.Shaft.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Shaft. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_agma_gleason_conical_gear(self) -> '_2111.AGMAGleasonConicalGear':
        ...
        if _2111.AGMAGleasonConicalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_differential_gear(self) -> '_2113.BevelDifferentialGear':
        ...
        if _2113.BevelDifferentialGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_differential_planet_gear(self) -> '_2115.BevelDifferentialPlanetGear':
        ...
        if _2115.BevelDifferentialPlanetGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_differential_sun_gear(self) -> '_2116.BevelDifferentialSunGear':
        ...
        if _2116.BevelDifferentialSunGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_gear(self) -> '_2117.BevelGear':
        ...
        if _2117.BevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to BevelGear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_concept_gear(self) -> '_2119.ConceptGear':
        ...
        if _2119.ConceptGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_conical_gear(self) -> '_2121.ConicalGear':
        ...
        if _2121.ConicalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cylindrical_gear(self) -> '_2123.CylindricalGear':
        ...
        if _2123.CylindricalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cylindrical_planet_gear(self) -> '_2125.CylindricalPlanetGear':
        ...
        if _2125.CylindricalPlanetGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_face_gear(self) -> '_2126.FaceGear':
    ...
    def component_of_type_gear(self) -> '_2128.Gear':
        ...
        if _2128.Gear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Gear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_hypoid_gear(self) -> '_2132.HypoidGear':
        ...
        if _2132.HypoidGear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to HypoidGear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> '_2134.KlingelnbergCycloPalloidConicalGear':
        ...
        if _2134.KlingelnbergCycloPalloidConicalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_2136.KlingelnbergCycloPalloidHypoidGear':
        ...
        if _2136.KlingelnbergCycloPalloidHypoidGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_2138.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        if _2138.KlingelnbergCycloPalloidSpiralBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_spiral_bevel_gear(self) -> '_2141.SpiralBevelGear':
        ...
        if _2141.SpiralBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_diff_gear(self) -> '_2143.StraightBevelDiffGear':
        ...
        if _2143.StraightBevelDiffGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_gear(self) -> '_2145.StraightBevelGear':
        ...
        if _2145.StraightBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_planet_gear(self) -> '_2147.StraightBevelPlanetGear':
        ...
        if _2147.StraightBevelPlanetGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_sun_gear(self) -> '_2148.StraightBevelSunGear':
        ...
        if _2148.StraightBevelSunGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_worm_gear(self) -> '_2149.WormGear':
        ...
        if _2149.WormGear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to WormGear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_zerol_bevel_gear(self) -> '_2151.ZerolBevelGear':
        ...
        if _2151.ZerolBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_clutch_half(self) -> '_2173.ClutchHalf':
        ...
        if _2173.ClutchHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to ClutchHalf. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_concept_coupling_half(self) -> '_2176.ConceptCouplingHalf':
        ...
        if _2176.ConceptCouplingHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_coupling_half(self) -> '_2178.CouplingHalf':
        ...
        if _2178.CouplingHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cvt_pulley(self) -> '_2181.CVTPulley':
        ...
        if _2181.CVTPulley.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to CVTPulley. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_part_to_part_shear_coupling_half(self) -> '_2183.PartToPartShearCouplingHalf':
        ...
        if _2183.PartToPartShearCouplingHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_pulley(self) -> '_2184.Pulley':
        ...
        if _2184.Pulley.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Pulley. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_rolling_ring(self) -> '_2190.RollingRing':
        ...
        if _2190.RollingRing.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_shaft_hub_connection(self) -> '_2192.ShaftHubConnection':
        ...
        if _2192.ShaftHubConnection.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_spring_damper_half(self) -> '_2195.SpringDamperHalf':
        ...
        if _2195.SpringDamperHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_synchroniser_half(self) -> '_2198.SynchroniserHalf':
        ...
        if _2198.SynchroniserHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_synchroniser_part(self) -> '_2199.SynchroniserPart':
        ...
        if _2199.SynchroniserPart.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_synchroniser_sleeve(self) -> '_2200.SynchroniserSleeve':
        ...
        if _2200.SynchroniserSleeve.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_torque_converter_pump(self) -> '_2202.TorqueConverterPump':
        ...
        if _2202.TorqueConverterPump.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_torque_converter_turbine(self) -> '_2204.TorqueConverterTurbine':
        ...
        if _2204.TorqueConverterTurbine.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    def socket(self) -> '_1913.Socket':
        ...
        if _1913.Socket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cvt_pulley_socket(self) -> '_1894.CVTPulleySocket':
        ...
        if _1894.CVTPulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CVTPulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_socket(self) -> '_1896.CylindricalSocket':
        ...
        if _1896.CylindricalSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_electric_machine_stator_socket(self) -> '_1898.ElectricMachineStatorSocket':
        ...
        if _1898.ElectricMachineStatorSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_inner_shaft_connecting_socket(self) -> '_1899.InnerShaftConnectingSocket':
        ...
        if _1899.InnerShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_inner_shaft_socket(self) -> '_1900.InnerShaftSocket':
        ...
        if _1900.InnerShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to InnerShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_connecting_socket(self) -> '_1902.OuterShaftConnectingSocket':
        ...
        if _1902.OuterShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_outer_shaft_socket(self) -> '_1903.OuterShaftSocket':
        ...
        if _1903.OuterShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to OuterShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_planetary_socket(self) -> '_1905.PlanetarySocket':
        ...
        if _1905.PlanetarySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PlanetarySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_pulley_socket(self) -> '_1906.PulleySocket':
        ...
        if _1906.PulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_rolling_ring_socket(self) -> '_1909.RollingRingSocket':
        ...
        if _1909.RollingRingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_shaft_connecting_socket(self) -> '_1910.ShaftConnectingSocket':
        ...
        if _1910.ShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_shaft_socket(self) -> '_1911.ShaftSocket':
        ...
        if _1911.ShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1917.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1917.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_differential_gear_teeth_socket(self) -> '_1919.BevelDifferentialGearTeethSocket':
        ...
        if _1919.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_gear_teeth_socket(self) -> '_1921.BevelGearTeethSocket':
        ...
        if _1921.BevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_concept_gear_teeth_socket(self) -> '_1923.ConceptGearTeethSocket':
        ...
        if _1923.ConceptGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_conical_gear_teeth_socket(self) -> '_1925.ConicalGearTeethSocket':
        ...
        if _1925.ConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1927.CylindricalGearTeethSocket':
        ...
        if _1927.CylindricalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_face_gear_teeth_socket(self) -> '_1929.FaceGearTeethSocket':
        ...
        if _1929.FaceGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_gear_teeth_socket(self) -> '_1931.GearTeethSocket':
        ...
        if _1931.GearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to GearTeethSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_hypoid_gear_teeth_socket(self) -> '_1933.HypoidGearTeethSocket':
        ...
        if _1933.HypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1934.KlingelnbergConicalGearTeethSocket':
        ...
        if _1934.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_1938.KlingelnbergHypoidGearTeethSocket':
        ...
        if _1938.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_1939.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _1939.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spiral_bevel_gear_teeth_socket(self) -> '_1941.SpiralBevelGearTeethSocket':
        ...
        if _1941.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_1943.StraightBevelDiffGearTeethSocket':
        ...
        if _1943.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_gear_teeth_socket(self) -> '_1945.StraightBevelGearTeethSocket':
        ...
        if _1945.StraightBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_worm_gear_teeth_socket(self) -> '_1947.WormGearTeethSocket':
        ...
        if _1947.WormGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_zerol_bevel_gear_teeth_socket(self) -> '_1949.ZerolBevelGearTeethSocket':
        ...
        if _1949.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_clutch_socket(self) -> '_1951.ClutchSocket':
        ...
        if _1951.ClutchSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ClutchSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_coupling_socket(self) -> '_1953.ConceptCouplingSocket':
        ...
        if _1953.ConceptCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_coupling_socket(self) -> '_1955.CouplingSocket':
        ...
        if _1955.CouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CouplingSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_part_to_part_shear_coupling_socket(self) -> '_1957.PartToPartShearCouplingSocket':
        ...
        if _1957.PartToPartShearCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spring_damper_socket(self) -> '_1959.SpringDamperSocket':
        ...
        if _1959.SpringDamperSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_pump_socket(self) -> '_1961.TorqueConverterPumpSocket':
        ...
        if _1961.TorqueConverterPumpSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_turbine_socket(self) -> '_1962.TorqueConverterTurbineSocket':
        ...
        if _1962.TorqueConverterTurbineSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def alignment_in_world_coordinate_system(self) -> '_2012.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2012.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInWorldCoordinateSystem) if self.wrapped.AlignmentInWorldCoordinateSystem else None

    @property
    def alignment_in_fe_coordinate_system(self) -> '_2012.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2012.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInFECoordinateSystem) if self.wrapped.AlignmentInFECoordinateSystem else None

    @property
    def alignment_in_component_coordinate_system(self) -> '_2012.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2012.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInComponentCoordinateSystem) if self.wrapped.AlignmentInComponentCoordinateSystem else None
    ...
    def nodes_grouped_by_angle(self) -> 'OrderedDict[float, List[_2004.ImportedFEStiffnessNode]]':
        ...
        return conversion.pn_to_mp_objects_in_list_in_ordered_dict(self.wrapped.NodesGroupedByAngle(), constructor.new(_2004.ImportedFEStiffnessNode))
    ...
    def add_or_replace_node(self, node: '_2004.ImportedFEStiffnessNode'):
