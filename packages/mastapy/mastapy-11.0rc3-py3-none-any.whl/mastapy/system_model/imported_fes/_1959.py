...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1497
...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_1497.ContactPairReporting':
        ...
        return constructor.new(_1497.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
