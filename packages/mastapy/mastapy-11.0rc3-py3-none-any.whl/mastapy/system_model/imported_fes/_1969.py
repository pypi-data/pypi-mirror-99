...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def node_selection(self) -> '_1490.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_1490.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection else None

    @property
    def draw_style(self) -> '_1475.DrawStyleForImportedFE':
        ...
        return constructor.new(_1475.DrawStyleForImportedFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle else None

    @property
    def transparency_draw_style(self) -> '_1489.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_1489.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle else None

    @property
    def component_draw_style(self) -> '_1482.FEModelComponentDrawStyle':
        ...
        return constructor.new(_1482.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle else None
