...
from mastapy.system_model.imported_fes import _1937
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.math_utility import _1064, _1063
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def first_component_alignment_axis(self) -> '_1064.Axis':
        ...
        return constructor.new(_1064.Axis)(value) if value else None

    @first_component_alignment_axis.setter
    def first_component_alignment_axis(self, value: '_1064.Axis'):
    ...
    @property
    def first_fe_alignment_axis(self) -> '_1063.AlignmentAxis':
        ...
        return constructor.new(_1063.AlignmentAxis)(value) if value else None

    @first_fe_alignment_axis.setter
    def first_fe_alignment_axis(self, value: '_1063.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1064.Axis':
    ...
    def component_direction_normal_to_surface(self, value: '_1064.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1063.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1063.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
