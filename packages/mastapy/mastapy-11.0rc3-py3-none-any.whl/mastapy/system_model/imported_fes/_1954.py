...
class BatchOperations(_0.APIBase):
    ...
    @property
    def fe_components(self) -> 'List[_1969.FEComponentWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_1969.FEComponentWithBatchOptions))
        return value

    @property
    def fe_components_with_external_files(self) -> 'List[_1969.FEComponentWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponentsWithExternalFiles, constructor.new(_1969.FEComponentWithBatchOptions))
        return value
