...
from mastapy.system_model.imported_fes.version_comparer import _2032
...
class LoadCaseResults(_0.APIBase):
    ...
    @property
    def imported_fe_results(self) -> 'List[_2032.ImportedFEResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEResults, constructor.new(_2032.ImportedFEResults))
        return value
