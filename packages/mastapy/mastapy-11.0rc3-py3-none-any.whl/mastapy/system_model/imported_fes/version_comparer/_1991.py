...
from mastapy.system_model.imported_fes.version_comparer import _1993, _1989
...
class ImportedFEVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_1993.LoadCasesToRun':
        ...
        return constructor.new(_1993.LoadCasesToRun)(value) if value else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_1993.LoadCasesToRun'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LoadCasesToRun = value

    @property
    def design_results(self) -> 'List[_1989.DesignResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignResults, constructor.new(_1989.DesignResults))
        return value
