...
from mastapy.system_model.imported_fes.version_comparer import _1992
...
class DesignResults(_0.APIBase):
    ...
    @property
    def load_cases(self) -> 'List[_1992.LoadCaseResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_1992.LoadCaseResults))
        return value
