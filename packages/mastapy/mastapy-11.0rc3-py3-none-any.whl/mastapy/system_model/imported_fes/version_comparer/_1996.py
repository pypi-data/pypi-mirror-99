...
from mastapy.system_model.imported_fes.version_comparer import _1998, _1994
...
class ImportedFEVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_1998.LoadCasesToRun':
        ...
        return constructor.new(_1998.LoadCasesToRun)(value) if value else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_1998.LoadCasesToRun'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LoadCasesToRun = value

    @property
    def design_results(self) -> 'List[_1994.DesignResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignResults, constructor.new(_1994.DesignResults))
        return value
