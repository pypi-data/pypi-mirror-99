...
from mastapy.system_model.imported_fes.version_comparer import _1995
...
class LoadCaseResults(_0.APIBase):
    ...
    @property
    def imported_fe_results(self) -> 'List[_1995.ImportedFEResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEResults, constructor.new(_1995.ImportedFEResults))
        return value
