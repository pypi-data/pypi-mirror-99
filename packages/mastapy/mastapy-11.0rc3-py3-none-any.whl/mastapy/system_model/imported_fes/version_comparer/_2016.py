...
from mastapy.system_model.imported_fes.version_comparer import _2020
...
class ImportedFEResults(_0.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_2020.NodeComparisonResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_2020.NodeComparisonResult))
        return value
