...
from mastapy.math_utility.measured_vectors import _1135, _1137
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1137.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1137.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
