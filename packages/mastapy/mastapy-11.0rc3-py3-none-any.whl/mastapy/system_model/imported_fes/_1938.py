...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1478
...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_1478.ContactPairReporting':
        ...
        return constructor.new(_1478.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
