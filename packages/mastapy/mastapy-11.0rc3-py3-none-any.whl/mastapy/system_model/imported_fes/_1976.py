...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1499
...
class CoordinateSystemWithSelection(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_1499.CoordinateSystemReporting':
        ...
        return constructor.new(_1499.CoordinateSystemReporting)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None
