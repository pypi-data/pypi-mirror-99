...
from mastapy.system_model.analyses_and_results.static_loads import _6273, _6202
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6273.TorqueRippleInputType':
        ...
        return constructor.new(_6273.TorqueRippleInputType)(value) if value else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6273.TorqueRippleInputType'):
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_6202.HarmonicLoadDataType') -> '_1093.MultipleFourierSeriesInterpolator':
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_6202.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6572.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_6202.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6572.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for_with_stiffness_node(self, harmonic_load_data_type: '_6202.HarmonicLoadDataType', node: '_2004.ImportedFEStiffnessNode') -> '_1093.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_stiffness_node(self, harmonic_load_data_type: '_6202.HarmonicLoadDataType', node: '_2004.ImportedFEStiffnessNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6572.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_stiffness_node(self, harmonic_load_data_type: '_6202.HarmonicLoadDataType', node: '_2004.ImportedFEStiffnessNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6572.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
