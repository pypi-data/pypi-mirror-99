...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def node_selection(self) -> '_165.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_165.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection else None

    @property
    def draw_style(self) -> '_150.DrawStyleForFE':
        ...
        return constructor.new(_150.DrawStyleForFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle else None

    @property
    def transparency_draw_style(self) -> '_164.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_164.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle else None

    @property
    def component_draw_style(self) -> '_157.FEModelComponentDrawStyle':
        ...
        return constructor.new(_157.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle else None
