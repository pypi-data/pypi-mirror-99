...
from mastapy.system_model.fe import _2017
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2017.BearingRacePosition':
        ...
        return constructor.new(_2017.BearingRacePosition)(value) if value else None
