...
from mastapy.system_model.fe import _2024
...
class ElectricMachineStatorFELink(_2072.MultiNodeFELink):
    '''ElectricMachineStatorFELink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_2024.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_2024.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
