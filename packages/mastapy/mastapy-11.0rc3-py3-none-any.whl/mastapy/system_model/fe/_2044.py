...
from mastapy.system_model.fe import _2045
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2045.BearingRacePosition':
        ...
        return constructor.new(_2045.BearingRacePosition)(value) if value else None
