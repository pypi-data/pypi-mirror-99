...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_172.RigidCouplingType':
        ...
        return constructor.new(_172.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_172.RigidCouplingType'):
    ...
    @property
    def fe_substructure_node(self) -> '_2064.FESubstructureNode':
        ...
        return constructor.new(_2064.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode else None
