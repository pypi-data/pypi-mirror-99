...
from mastapy.system_model.optimization import _1915, _1907
...
class ConicalGearOptimisationStrategy(_1915.OptimizationStrategy['_1907.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
