...
from mastapy.system_model.optimization import _1841, _1833
...
class ConicalGearOptimisationStrategy(_1841.OptimizationStrategy['_1833.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
