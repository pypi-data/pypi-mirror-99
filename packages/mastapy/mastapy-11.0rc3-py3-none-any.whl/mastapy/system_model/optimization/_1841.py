...
from mastapy.system_model.optimization import _1842, _1840
...
TStep = TypeVar('TStep', bound='_1840.OptimizationStep')


class OptimizationStrategy(_1842.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
