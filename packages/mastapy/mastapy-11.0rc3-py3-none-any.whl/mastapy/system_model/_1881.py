...
from mastapy.utility.model_validation import _1438, _1439
...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_1878.Design':
        ...
        return constructor.new(_1878.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties else None
    ...
    @property
    def all_status_errors(self) -> 'List[_1439.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1439.StatusItem))
        return value
