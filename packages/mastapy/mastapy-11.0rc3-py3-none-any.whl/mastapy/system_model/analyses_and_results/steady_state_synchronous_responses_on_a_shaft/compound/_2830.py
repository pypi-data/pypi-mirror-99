...
class DatumCompoundSteadyStateSynchronousResponseOnAShaft(_2804.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''DatumCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2700.DatumSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2700.DatumSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2700.DatumSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2700.DatumSteadyStateSynchronousResponseOnAShaft))
        return value
