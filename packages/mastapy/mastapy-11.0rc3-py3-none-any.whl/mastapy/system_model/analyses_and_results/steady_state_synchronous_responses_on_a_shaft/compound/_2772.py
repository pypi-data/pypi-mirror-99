...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft(_2771.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2650.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2650.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2650.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2650.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft))
        return value
