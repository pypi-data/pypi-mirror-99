...
class AbstractAssemblySteadyStateSynchronousResponseOnAShaft(_2576.PartSteadyStateSynchronousResponseOnAShaft):
    '''AbstractAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2001.AbstractAssembly':
    ...
    @property
    def assembly_design(self) -> '_2001.AbstractAssembly':
        ...
        if _2001.AbstractAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_assembly(self) -> '_2000.Assembly':
    ...
    @property
    def assembly_design_of_type_root_assembly(self) -> '_2037.RootAssembly':
        ...
        if _2037.RootAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_specialised_assembly(self) -> '_2039.SpecialisedAssembly':
