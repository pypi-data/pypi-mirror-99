...
class MultibodyDynamicsAnalysis(_7145.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5082.MBDAnalysisOptions':
        ...
        return constructor.new(_5082.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
