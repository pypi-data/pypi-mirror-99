...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5066, _5065, _5097
...
class ConceptGearSetMultibodyDynamicsAnalysis(_5097.GearSetMultibodyDynamicsAnalysis):
    '''ConceptGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5066.ConceptGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5066.ConceptGearMultibodyDynamicsAnalysis))
        return value

    @property
    def concept_gears_multibody_dynamics_analysis(self) -> 'List[_5066.ConceptGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsMultibodyDynamicsAnalysis, constructor.new(_5066.ConceptGearMultibodyDynamicsAnalysis))
        return value

    @property
    def concept_meshes_multibody_dynamics_analysis(self) -> 'List[_5065.ConceptGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesMultibodyDynamicsAnalysis, constructor.new(_5065.ConceptGearMeshMultibodyDynamicsAnalysis))
        return value
