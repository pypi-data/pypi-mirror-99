...
class MultibodyDynamicsAnalysis(_7180.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5113.MBDAnalysisOptions':
        ...
        return constructor.new(_5113.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
