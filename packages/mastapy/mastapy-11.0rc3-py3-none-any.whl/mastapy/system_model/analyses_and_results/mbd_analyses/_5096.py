...
class GearMultibodyDynamicsAnalysis(_5121.MountableComponentMultibodyDynamicsAnalysis):
    '''GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5182.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5182.DynamicTorqueResultAtTime))
        return value
