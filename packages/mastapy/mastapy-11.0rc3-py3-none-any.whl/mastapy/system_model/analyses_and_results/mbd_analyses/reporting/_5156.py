...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5153
...
class DynamicTorqueResultAtTime(_5153.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
