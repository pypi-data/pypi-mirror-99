...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5171
...
class DynamicTorqueResultAtTime(_5171.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
