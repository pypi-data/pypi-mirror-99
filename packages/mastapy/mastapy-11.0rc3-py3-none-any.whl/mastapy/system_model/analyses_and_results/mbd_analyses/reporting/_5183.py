...
class DynamicTorqueVector3DResult(_0.APIBase):
    ...
    @property
    def x(self) -> '_5182.DynamicTorqueResultAtTime':
        ...
        return constructor.new(_5182.DynamicTorqueResultAtTime)(self.wrapped.X) if self.wrapped.X else None

    @property
    def y(self) -> '_5182.DynamicTorqueResultAtTime':
        ...
        return constructor.new(_5182.DynamicTorqueResultAtTime)(self.wrapped.Y) if self.wrapped.Y else None

    @property
    def z(self) -> '_5182.DynamicTorqueResultAtTime':
        ...
        return constructor.new(_5182.DynamicTorqueResultAtTime)(self.wrapped.Z) if self.wrapped.Z else None

    @property
    def magnitude(self) -> '_5182.DynamicTorqueResultAtTime':
        ...
        return constructor.new(_5182.DynamicTorqueResultAtTime)(self.wrapped.Magnitude) if self.wrapped.Magnitude else None

    @property
    def radial_magnitude(self) -> '_5182.DynamicTorqueResultAtTime':
        ...
        return constructor.new(_5182.DynamicTorqueResultAtTime)(self.wrapped.RadialMagnitude) if self.wrapped.RadialMagnitude else None
