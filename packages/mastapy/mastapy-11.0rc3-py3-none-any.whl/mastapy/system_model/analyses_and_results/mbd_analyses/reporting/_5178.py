...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5175
...
class DynamicTorqueResultAtTime(_5175.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
