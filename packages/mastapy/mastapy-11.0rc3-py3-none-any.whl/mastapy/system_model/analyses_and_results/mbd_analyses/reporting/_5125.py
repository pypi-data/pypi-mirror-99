...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5122
...
class DynamicTorqueResultAtTime(_5122.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
