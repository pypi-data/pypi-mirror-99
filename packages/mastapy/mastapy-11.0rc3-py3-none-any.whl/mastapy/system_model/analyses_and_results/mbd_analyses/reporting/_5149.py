...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5146
...
class DynamicTorqueResultAtTime(_5146.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
