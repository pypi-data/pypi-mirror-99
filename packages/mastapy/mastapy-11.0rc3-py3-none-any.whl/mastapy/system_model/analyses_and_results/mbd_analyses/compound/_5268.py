...
class PlanetaryConnectionCompoundMultibodyDynamicsAnalysis(_5282.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''PlanetaryConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5127.PlanetaryConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5127.PlanetaryConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5127.PlanetaryConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5127.PlanetaryConnectionMultibodyDynamicsAnalysis))
        return value
