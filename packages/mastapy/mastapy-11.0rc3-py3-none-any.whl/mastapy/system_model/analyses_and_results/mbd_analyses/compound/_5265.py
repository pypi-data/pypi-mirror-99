...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5222.CouplingCompoundMultibodyDynamicsAnalysis):
    '''PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5126.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5126.PartToPartShearCouplingMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5126.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5126.PartToPartShearCouplingMultibodyDynamicsAnalysis))
        return value
