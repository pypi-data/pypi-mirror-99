...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5096, _5094, _5145
...
class GearSetMultibodyDynamicsAnalysis(_5145.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5096.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5096.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5094.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5094.GearMeshMultibodyDynamicsAnalysis))
        return value
