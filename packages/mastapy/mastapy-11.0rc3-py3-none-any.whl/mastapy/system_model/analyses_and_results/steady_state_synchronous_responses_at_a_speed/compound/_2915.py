...
class BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed(_2997.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2793.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2793.BeltDriveSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2793.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2793.BeltDriveSteadyStateSynchronousResponseAtASpeed))
        return value
