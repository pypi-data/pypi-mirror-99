...
class BevelGearSetSteadyStateSynchronousResponseAtASpeed(_2749.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    '''BevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_design(self) -> '_2081.BevelGearSet':
