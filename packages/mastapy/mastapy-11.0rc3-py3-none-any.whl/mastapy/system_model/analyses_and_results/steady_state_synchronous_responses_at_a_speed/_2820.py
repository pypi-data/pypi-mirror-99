...
class CouplingConnectionSteadyStateSynchronousResponseAtASpeed(_2844.InterMountableComponentConnectionSteadyStateSynchronousResponseAtASpeed):
    '''CouplingConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_design(self) -> '_1954.CouplingConnection':
