...
from mastapy.system_model.analyses_and_results.modal_analyses import _2277
...
class ModalAnalysisForHarmonicAnalysis(_2277.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5639.HarmonicAnalysisOptions':
        ...
        if _5639.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
