...
from mastapy.system_model.analyses_and_results.modal_analyses import _2304
...
class ModalAnalysisForHarmonicAnalysis(_2304.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5672.HarmonicAnalysisOptions':
        ...
        if _5672.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
