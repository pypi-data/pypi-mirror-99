...
from mastapy.system_model.analyses_and_results.modal_analyses import _4763, _4762, _4769
...
class BevelDifferentialGearSetModalAnalysis(_4769.BevelGearSetModalAnalysis):
    '''BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4763.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysis, constructor.new(_4763.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4762.BevelDifferentialGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysis, constructor.new(_4762.BevelDifferentialGearMeshModalAnalysis))
        return value
