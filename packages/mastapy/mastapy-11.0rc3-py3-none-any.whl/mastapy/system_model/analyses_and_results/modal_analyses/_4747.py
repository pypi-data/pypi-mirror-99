...
from mastapy.system_model.analyses_and_results.modal_analyses import _4772, _4807, _4832
...
class AbstractAssemblyModalAnalysis(_4832.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4772.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4772.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4807.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4807.GearMeshModalAnalysis))
        return value
