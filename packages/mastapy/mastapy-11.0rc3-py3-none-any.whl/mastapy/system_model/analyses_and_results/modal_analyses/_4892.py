...
from mastapy.math_utility import (
    _1080, _1105, _1068, _1092,
    _1079, _1064, _1078, _1098
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4800, _4889, _4888, _4844,
    _4890
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import (
    _5467, _5470, _5476, _5477
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5383, _5434
from mastapy.utility.units_and_measurements.measurements import (
    _1225, _1178, _1277, _1184,
    _1175, _1180, _1199, _1272,
    _1193, _1243, _1244, _1247
)
from mastapy.utility.property import _1372
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_4800.CoordinateSystemForWhine':
        ...
        return constructor.new(_4800.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4800.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CoordinateSystem = value

    @property
    def complex_component(self) -> '_1068.ComplexPartDisplayOption':
        ...
        return constructor.new(_1068.ComplexPartDisplayOption)(value) if value else None

    @complex_component.setter
    def complex_component(self, value: '_1068.ComplexPartDisplayOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ComplexComponent = value

    @property
    def magnitude_method_for_complex_vectors(self) -> '_1092.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1092.ComplexMagnitudeMethod)(value) if value else None

    @magnitude_method_for_complex_vectors.setter
    def magnitude_method_for_complex_vectors(self, value: '_1092.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1064.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1064.AcousticWeighting)(value) if value else None

    @weighting.setter
    def weighting(self, value: '_1064.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1078.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1078.DynamicsResponse3DChartType)(value) if value else None

    @chart_type.setter
    def chart_type(self, value: '_1078.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5467.ConnectedComponentType':
        ...
        return constructor.new(_5467.ConnectedComponentType)(value) if value else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5467.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4889.WhineWaterfallExportOption':
        ...
        return constructor.new(_4889.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4889.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5470.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5470.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4888.WaterfallChartSettings':
        ...
        return constructor.new(_4888.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4844.OrderCutsChartSettings':
        ...
        return constructor.new(_4844.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None
    ...
    @property
    def very_short_length_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1225.LengthVeryShort]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1225.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1178.AngleSmall]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1178.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1277.VelocitySmall]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1277.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1184.AngularVelocity]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1184.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1175.Acceleration]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1175.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1180.AngularAcceleration]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1180.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1199.Force]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1199.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1272.Torque]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1272.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1193.Energy]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1193.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1243.PowerSmall]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1243.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1244.PowerSmallPerArea]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1244.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4890.WhineWaterfallReferenceValues[_1247.Pressure]':
        ...
        return constructor.new(_4890.WhineWaterfallReferenceValues)[_1247.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5476.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5476.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5477.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5477.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1372.EnumWithBool[_1098.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1372.EnumWithBool)[_1098.ResultOptionsFor3DVector])
        return value
