...
from mastapy.system_model.analyses_and_results.modal_analyses import _4740, _4775, _4800
...
class AbstractAssemblyModalAnalysis(_4800.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4740.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4740.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4775.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4775.GearMeshModalAnalysis))
        return value
