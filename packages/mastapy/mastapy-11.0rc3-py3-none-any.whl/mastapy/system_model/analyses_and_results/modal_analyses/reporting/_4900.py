...
from mastapy.utility.modal_analysis import _1527
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2326.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1527.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1527.DesignEntityExcitationDescription))
        return value
