...
class ModalCMSResultsForModeAndFE(_0.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_200.ModalCMSResults':
        ...
        return constructor.new(_200.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
