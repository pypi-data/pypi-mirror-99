...
class PerModeResultsReport(_1297.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1354.TableAndChartOptions':
    ...
    def display_option(self, value: '_1354.TableAndChartOptions'):
