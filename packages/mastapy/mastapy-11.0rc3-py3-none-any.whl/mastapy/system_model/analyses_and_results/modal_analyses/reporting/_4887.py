...
from mastapy.utility.modal_analysis import _1333
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2225.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1333.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1333.DesignEntityExcitationDescription))
        return value
