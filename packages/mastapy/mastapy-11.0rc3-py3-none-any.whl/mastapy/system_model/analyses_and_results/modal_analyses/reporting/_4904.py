...
class PerModeResultsReport(_1298.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1355.TableAndChartOptions':
    ...
    def display_option(self, value: '_1355.TableAndChartOptions'):
