...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4892
...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_4892.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_4892.ModalCMSResultsForModeAndFE))
        return value
