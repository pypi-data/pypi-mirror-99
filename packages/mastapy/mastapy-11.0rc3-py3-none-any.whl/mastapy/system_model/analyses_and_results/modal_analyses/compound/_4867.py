...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4889
...
class AbstractShaftOrHousingCompoundModalAnalysis(_4889.ComponentCompoundModalAnalysis):
    '''AbstractShaftOrHousingCompoundModalAnalysis
