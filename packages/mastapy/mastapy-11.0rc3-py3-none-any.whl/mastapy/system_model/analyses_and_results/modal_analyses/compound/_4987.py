...
class PlanetaryConnectionCompoundModalAnalysis(_5001.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''PlanetaryConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4840.PlanetaryConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4840.PlanetaryConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4840.PlanetaryConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4840.PlanetaryConnectionModalAnalysis))
        return value
