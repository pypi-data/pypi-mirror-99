...
class BevelDifferentialGearCompoundModalAnalysis(_4920.BevelGearCompoundModalAnalysis):
    '''BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4763.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4763.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4763.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4763.BevelDifferentialGearModalAnalysis))
        return value
