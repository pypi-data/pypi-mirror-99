...
class AbstractShaftOrHousingModalAnalysis(_4743.ComponentModalAnalysis):
    '''AbstractShaftOrHousingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2326.AbstractShaftOrHousingSystemDeflection':
