...
class AbstractShaftOrHousingModalAnalysis(_4740.ComponentModalAnalysis):
    '''AbstractShaftOrHousingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2324.AbstractShaftOrHousingSystemDeflection':
