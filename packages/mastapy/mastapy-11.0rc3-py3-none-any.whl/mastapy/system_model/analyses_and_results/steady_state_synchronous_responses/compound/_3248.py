...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3123
...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_3189.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    '''SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3123.SpringDamperConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3123.SpringDamperConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_steady_state_synchronous_response_load_cases(self) -> 'List[_3123.SpringDamperConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseLoadCases, constructor.new(_3123.SpringDamperConnectionSteadyStateSynchronousResponse))
        return value
