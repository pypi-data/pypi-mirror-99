...
class BeltDriveCompoundSteadyStateSynchronousResponse(_3204.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    '''BeltDriveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2997.BeltDriveSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2997.BeltDriveSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_steady_state_synchronous_response_load_cases(self) -> 'List[_2997.BeltDriveSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseLoadCases, constructor.new(_2997.BeltDriveSteadyStateSynchronousResponse))
        return value
