...
class CylindricalGearMeshCompoundSteadyStateSynchronousResponse(_3359.GearMeshCompoundSteadyStateSynchronousResponse):
    '''CylindricalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3214.CylindricalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3214.CylindricalGearMeshSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3214.CylindricalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3214.CylindricalGearMeshSteadyStateSynchronousResponse))
        return value
