...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3216, _3214, _3227
...
class CylindricalGearSetSteadyStateSynchronousResponse(_3227.GearSetSteadyStateSynchronousResponse):
    '''CylindricalGearSetSteadyStateSynchronousResponse
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response(self) -> 'List[_3216.CylindricalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSteadyStateSynchronousResponse, constructor.new(_3216.CylindricalGearSteadyStateSynchronousResponse))
        return value

    @property
    def cylindrical_meshes_steady_state_synchronous_response(self) -> 'List[_3214.CylindricalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSteadyStateSynchronousResponse, constructor.new(_3214.CylindricalGearMeshSteadyStateSynchronousResponse))
        return value
