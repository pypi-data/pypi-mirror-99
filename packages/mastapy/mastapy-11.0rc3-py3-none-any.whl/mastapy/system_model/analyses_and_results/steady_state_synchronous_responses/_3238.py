...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3239, _3237, _3235
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_3235.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_3239.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsSteadyStateSynchronousResponse, constructor.new(_3239.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_3237.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesSteadyStateSynchronousResponse, constructor.new(_3237.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse))
        return value
