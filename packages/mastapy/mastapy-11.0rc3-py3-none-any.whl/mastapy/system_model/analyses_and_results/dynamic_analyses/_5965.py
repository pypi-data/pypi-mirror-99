...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5963, _5964, _5977
...
class CylindricalGearSetDynamicAnalysis(_5977.GearSetDynamicAnalysis):
    '''CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_5963.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsDynamicAnalysis, constructor.new(_5963.CylindricalGearDynamicAnalysis))
        return value

    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_5964.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesDynamicAnalysis, constructor.new(_5964.CylindricalGearMeshDynamicAnalysis))
        return value
