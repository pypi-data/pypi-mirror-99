...
class ConnectionDynamicAnalysis(_7179.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    def dynamic_analysis(self) -> '_2301.DynamicAnalysis':
        ...
        if _2301.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.DynamicAnalysis.__class__)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
