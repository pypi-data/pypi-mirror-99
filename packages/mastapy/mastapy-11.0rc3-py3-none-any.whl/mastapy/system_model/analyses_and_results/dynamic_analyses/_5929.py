...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5927, _5928, _5934
...
class BevelDifferentialGearSetDynamicAnalysis(_5934.BevelGearSetDynamicAnalysis):
    '''BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_5927.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsDynamicAnalysis, constructor.new(_5927.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_5928.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesDynamicAnalysis, constructor.new(_5928.BevelDifferentialGearMeshDynamicAnalysis))
        return value
