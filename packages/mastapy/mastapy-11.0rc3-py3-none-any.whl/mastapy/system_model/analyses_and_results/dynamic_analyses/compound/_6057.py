...
class BevelDifferentialGearCompoundDynamicAnalysis(_6062.BevelGearCompoundDynamicAnalysis):
    '''BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5927.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5927.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5927.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5927.BevelDifferentialGearDynamicAnalysis))
        return value
