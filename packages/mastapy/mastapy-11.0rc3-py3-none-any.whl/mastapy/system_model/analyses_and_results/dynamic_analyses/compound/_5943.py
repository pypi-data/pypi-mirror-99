...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5965
...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_5965.ComponentCompoundDynamicAnalysis):
    '''AbstractShaftOrHousingCompoundDynamicAnalysis
