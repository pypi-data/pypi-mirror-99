...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5983
...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_5983.BevelGearMeshCompoundDynamicAnalysis):
    '''BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5855.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5855.BevelDifferentialGearMeshDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_5855.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_5855.BevelDifferentialGearMeshDynamicAnalysis))
        return value
