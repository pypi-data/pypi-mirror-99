...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5992
...
class BevelGearSetCompoundDynamicAnalysis(_5992.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    '''BevelGearSetCompoundDynamicAnalysis
