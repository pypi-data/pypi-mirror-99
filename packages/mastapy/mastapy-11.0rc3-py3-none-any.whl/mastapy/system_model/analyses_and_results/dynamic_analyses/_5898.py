...
from mastapy.system_model.analyses_and_results.analysis_cases import _6556
...
class ConnectionDynamicAnalysis(_6556.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5911.DynamicAnalysis':
        ...
        if _5911.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
