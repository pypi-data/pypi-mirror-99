...
from mastapy.system_model.part_model.couplings import _2181, _2183
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2181.SynchroniserHalf':
        ...
        return constructor.new(_2181.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2183.SynchroniserSleeve':
        ...
        return constructor.new(_2183.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
