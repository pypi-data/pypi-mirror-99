...
from mastapy.system_model.part_model.couplings import _2158, _2160
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2158.SynchroniserHalf':
        ...
        return constructor.new(_2158.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2160.SynchroniserSleeve':
        ...
        return constructor.new(_2160.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
