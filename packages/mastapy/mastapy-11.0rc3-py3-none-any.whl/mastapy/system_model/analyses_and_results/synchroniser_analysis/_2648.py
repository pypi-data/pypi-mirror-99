...
from mastapy.system_model.part_model.couplings import _2279, _2281
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2279.SynchroniserHalf':
        ...
        return constructor.new(_2279.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2281.SynchroniserSleeve':
        ...
        return constructor.new(_2281.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
