...
from mastapy.system_model.part_model.couplings import _2180, _2182
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2180.SynchroniserHalf':
        ...
        return constructor.new(_2180.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2182.SynchroniserSleeve':
        ...
        return constructor.new(_2182.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
