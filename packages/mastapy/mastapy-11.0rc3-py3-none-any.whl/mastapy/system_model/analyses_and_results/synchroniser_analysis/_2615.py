...
from mastapy.system_model.part_model.couplings import _2249, _2251
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2249.SynchroniserHalf':
        ...
        return constructor.new(_2249.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2251.SynchroniserSleeve':
        ...
        return constructor.new(_2251.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
