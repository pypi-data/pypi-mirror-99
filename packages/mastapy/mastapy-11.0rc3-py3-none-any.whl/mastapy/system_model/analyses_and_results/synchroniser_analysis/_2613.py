...
from mastapy.system_model.part_model.couplings import _2247, _2249
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2247.SynchroniserHalf':
        ...
        return constructor.new(_2247.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2249.SynchroniserSleeve':
        ...
        return constructor.new(_2249.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
