...
from mastapy.system_model.part_model.couplings import _2198, _2200
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2198.SynchroniserHalf':
        ...
        return constructor.new(_2198.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2200.SynchroniserSleeve':
        ...
        return constructor.new(_2200.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
