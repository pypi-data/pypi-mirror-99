...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3397
...
class AGMAGleasonConicalGearMeshCompoundPowerFlow(_3397.ConicalGearMeshCompoundPowerFlow):
    '''AGMAGleasonConicalGearMeshCompoundPowerFlow
