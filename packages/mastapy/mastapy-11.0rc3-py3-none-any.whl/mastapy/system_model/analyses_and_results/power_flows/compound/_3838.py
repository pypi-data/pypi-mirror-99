...
from mastapy.system_model.analyses_and_results.power_flows import _3705
...
class BeltConnectionCompoundPowerFlow(_3894.InterMountableComponentConnectionCompoundPowerFlow):
    '''BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3705.BeltConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3705.BeltConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3705.BeltConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3705.BeltConnectionPowerFlow))
        return value
