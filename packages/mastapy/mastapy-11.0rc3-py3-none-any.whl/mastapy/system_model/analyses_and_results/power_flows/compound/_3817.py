...
class ClutchCompoundPowerFlow(_3833.CouplingCompoundPowerFlow):
    '''ClutchCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3686.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3686.ClutchPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3686.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3686.ClutchPowerFlow))
        return value
