...
from mastapy.system_model.analyses_and_results.power_flows import _3691
...
class ConceptCouplingCompoundPowerFlow(_3833.CouplingCompoundPowerFlow):
    '''ConceptCouplingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3691.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3691.ConceptCouplingPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3691.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3691.ConceptCouplingPowerFlow))
        return value
