...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3398
...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_3398.ConicalGearSetCompoundPowerFlow):
    '''AGMAGleasonConicalGearSetCompoundPowerFlow
