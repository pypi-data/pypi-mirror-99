...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3860
...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_3860.ConnectionCompoundPowerFlow):
    '''AbstractShaftToMountableComponentConnectionCompoundPowerFlow
