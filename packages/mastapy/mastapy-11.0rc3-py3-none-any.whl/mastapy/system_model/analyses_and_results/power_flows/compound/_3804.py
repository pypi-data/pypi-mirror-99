...
class BearingCompoundPowerFlow(_3832.ConnectorCompoundPowerFlow):
    '''BearingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3671.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3671.BearingPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3671.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3671.BearingPowerFlow))
        return value
