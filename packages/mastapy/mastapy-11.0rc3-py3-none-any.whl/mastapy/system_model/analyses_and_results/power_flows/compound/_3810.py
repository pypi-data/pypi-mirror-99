...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3807
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3807.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
