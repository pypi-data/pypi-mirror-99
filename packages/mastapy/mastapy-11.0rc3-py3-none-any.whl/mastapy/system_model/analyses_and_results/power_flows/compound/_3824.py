...
class ConceptCouplingHalfCompoundPowerFlow(_3835.CouplingHalfCompoundPowerFlow):
    '''ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3690.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3690.ConceptCouplingHalfPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3690.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3690.ConceptCouplingHalfPowerFlow))
        return value
