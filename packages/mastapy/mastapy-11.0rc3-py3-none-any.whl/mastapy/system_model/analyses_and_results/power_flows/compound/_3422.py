...
class BoltCompoundPowerFlow(_3428.ComponentCompoundPowerFlow):
    '''BoltCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3298.BoltPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3298.BoltPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3298.BoltPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3298.BoltPowerFlow))
        return value
