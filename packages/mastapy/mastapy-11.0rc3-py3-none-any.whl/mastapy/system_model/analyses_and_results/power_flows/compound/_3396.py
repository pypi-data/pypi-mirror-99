...
class BevelDifferentialGearCompoundPowerFlow(_3401.BevelGearCompoundPowerFlow):
    '''BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3272.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3272.BevelDifferentialGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3272.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3272.BevelDifferentialGearPowerFlow))
        return value
