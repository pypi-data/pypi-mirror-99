...
from mastapy.system_model.analyses_and_results.power_flows import _3683
from mastapy.system_model.analyses_and_results.power_flows.compound import _3821
...
class BoltCompoundPowerFlow(_3821.ComponentCompoundPowerFlow):
    '''BoltCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3683.BoltPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3683.BoltPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3683.BoltPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3683.BoltPowerFlow))
        return value
