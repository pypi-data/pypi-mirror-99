...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow(_3466.KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3344.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3344.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3344.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3344.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow))
        return value
