...
class SynchroniserHalfCompoundPowerFlow(_3944.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3812.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3812.SynchroniserHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3812.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3812.SynchroniserHalfPowerFlow))
        return value
