...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3796
...
class AbstractShaftCompoundPowerFlow(_3796.AbstractShaftOrHousingCompoundPowerFlow):
    '''AbstractShaftCompoundPowerFlow
