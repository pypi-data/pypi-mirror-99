...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3386
...
class AbstractShaftOrHousingCompoundPowerFlow(_3386.ComponentCompoundPowerFlow):
    '''AbstractShaftOrHousingCompoundPowerFlow
