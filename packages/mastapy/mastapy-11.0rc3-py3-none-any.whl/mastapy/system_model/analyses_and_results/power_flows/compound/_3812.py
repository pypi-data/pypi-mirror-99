...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3800
...
class BevelGearCompoundPowerFlow(_3800.AGMAGleasonConicalGearCompoundPowerFlow):
    '''BevelGearCompoundPowerFlow
