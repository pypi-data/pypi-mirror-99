...
class CycloidalDiscCompoundPowerFlow(_3830.AbstractShaftCompoundPowerFlow):
    '''CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3742.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3742.CycloidalDiscPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3742.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3742.CycloidalDiscPowerFlow))
        return value
