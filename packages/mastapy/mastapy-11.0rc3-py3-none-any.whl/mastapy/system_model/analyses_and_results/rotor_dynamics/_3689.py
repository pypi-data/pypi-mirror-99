...
from mastapy.utility.units_and_measurements.measurements import _1429
...
class ShaftModalComplexShape(_3687.ShaftComplexShape['_1429.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
