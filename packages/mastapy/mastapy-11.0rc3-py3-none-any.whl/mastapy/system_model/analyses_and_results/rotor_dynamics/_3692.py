...
from mastapy.utility.units_and_measurements.measurements import _1417, _1370
...
class ShaftForcedComplexShape(_3691.ShaftComplexShape['_1417.LengthVeryShort', '_1370.AngleSmall']):
    '''ShaftForcedComplexShape
