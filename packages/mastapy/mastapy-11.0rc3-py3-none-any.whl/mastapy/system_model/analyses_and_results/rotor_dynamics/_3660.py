...
from mastapy.utility.units_and_measurements.measurements import _1344
...
class ShaftModalComplexShape(_3658.ShaftComplexShape['_1344.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
