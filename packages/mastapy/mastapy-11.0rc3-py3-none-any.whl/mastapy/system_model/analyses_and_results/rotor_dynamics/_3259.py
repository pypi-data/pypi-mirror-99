...
from mastapy.utility.units_and_measurements.measurements import _1237
...
class ShaftModalComplexShape(_3257.ShaftComplexShape['_1237.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
