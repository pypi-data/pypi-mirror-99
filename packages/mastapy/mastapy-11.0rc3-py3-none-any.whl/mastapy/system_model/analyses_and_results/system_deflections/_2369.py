...
from mastapy.system_model.analyses_and_results.power_flows import _3707
...
class BevelDifferentialGearMeshSystemDeflection(_2374.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3707.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3707.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_502.BevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_502.BevelGearMeshRating':
        ...
        if _502.BevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_zerol_bevel_gear_mesh_rating(self) -> '_330.ZerolBevelGearMeshRating':
        ...
        if _330.ZerolBevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_mesh_rating(self) -> '_360.StraightBevelGearMeshRating':
        ...
        if _360.StraightBevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spiral_bevel_gear_mesh_rating(self) -> '_363.SpiralBevelGearMeshRating':
        ...
        if _363.SpiralBevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
