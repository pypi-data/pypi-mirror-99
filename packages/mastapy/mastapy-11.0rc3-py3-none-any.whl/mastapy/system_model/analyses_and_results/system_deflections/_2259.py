...
from mastapy.system_model.analyses_and_results.power_flows import _3270, _3301
from mastapy.system_model.analyses_and_results.system_deflections import _2258, _2355
...
class BeltDriveSystemDeflection(_2355.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3270.BeltDrivePowerFlow':
        ...
        if _3270.BeltDrivePowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def belts(self) -> 'List[_2258.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2258.BeltConnectionSystemDeflection))
        return value
