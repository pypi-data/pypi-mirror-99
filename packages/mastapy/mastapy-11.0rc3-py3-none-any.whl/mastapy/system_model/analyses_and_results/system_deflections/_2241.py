...
from mastapy.system_model.analyses_and_results.power_flows import _3251, _3253, _3254
...
class BevelDifferentialGearSystemDeflection(_2246.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3251.BevelDifferentialGearPowerFlow':
