...
from mastapy.system_model.analyses_and_results.power_flows import _3248, _3279
...
class BeltConnectionSystemDeflection(_2298.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3248.BeltConnectionPowerFlow':
