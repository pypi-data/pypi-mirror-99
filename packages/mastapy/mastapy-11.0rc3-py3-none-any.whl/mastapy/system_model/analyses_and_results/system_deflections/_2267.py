...
from mastapy.system_model.part_model.gears import (
    _2101, _2097, _2099, _2100,
    _2125, _2127, _2129, _2131,
    _2132, _2135
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows import (
    _3277, _3272, _3274, _3275,
    _3357, _3363, _3366, _3368,
    _3369, _3385
)
...
class BevelGearSystemDeflection(_2255.AGMAGleasonConicalGearSystemDeflection):
    '''BevelGearSystemDeflection
    ...
    @property
    def component_design(self) -> '_2101.BevelGear':
    ...
    @property
    def power_flow_results(self) -> '_3277.BevelGearPowerFlow':
        ...
        if _3277.BevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_gear_power_flow(self) -> '_3272.BevelDifferentialGearPowerFlow':
        ...
        if _3272.BevelDifferentialGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_planet_gear_power_flow(self) -> '_3274.BevelDifferentialPlanetGearPowerFlow':
        ...
        if _3274.BevelDifferentialPlanetGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_sun_gear_power_flow(self) -> '_3275.BevelDifferentialSunGearPowerFlow':
        ...
        if _3275.BevelDifferentialSunGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spiral_bevel_gear_power_flow(self) -> '_3357.SpiralBevelGearPowerFlow':
        ...
        if _3357.SpiralBevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_diff_gear_power_flow(self) -> '_3363.StraightBevelDiffGearPowerFlow':
        ...
        if _3363.StraightBevelDiffGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_gear_power_flow(self) -> '_3366.StraightBevelGearPowerFlow':
        ...
        if _3366.StraightBevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_planet_gear_power_flow(self) -> '_3368.StraightBevelPlanetGearPowerFlow':
        ...
        if _3368.StraightBevelPlanetGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_sun_gear_power_flow(self) -> '_3369.StraightBevelSunGearPowerFlow':
        ...
        if _3369.StraightBevelSunGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_zerol_bevel_gear_power_flow(self) -> '_3385.ZerolBevelGearPowerFlow':
        ...
        if _3385.ZerolBevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
