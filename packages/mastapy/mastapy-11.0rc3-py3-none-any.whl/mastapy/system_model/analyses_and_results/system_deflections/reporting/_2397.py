...
from mastapy.system_model.analyses_and_results import _2225
...
class RigidlyConnectedComponentGroupSystemDeflection(_2225.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1091.MassProperties':
        ...
        return constructor.new(_1091.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties else None

    @property
    def components(self) -> 'List[_2274.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2274.ComponentSystemDeflection))
        return value
