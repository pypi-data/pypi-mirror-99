...
from mastapy.system_model.analyses_and_results import _2243
...
class RigidlyConnectedComponentGroupSystemDeflection(_2243.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1090.MassProperties':
        ...
        return constructor.new(_1090.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties else None

    @property
    def components(self) -> 'List[_2292.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2292.ComponentSystemDeflection))
        return value
