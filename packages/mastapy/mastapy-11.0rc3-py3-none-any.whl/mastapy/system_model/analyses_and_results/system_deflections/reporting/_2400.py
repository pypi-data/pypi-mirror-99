...
class ShaftSystemDeflectionSectionsReport(_1299.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1356.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1356.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1356.TableAndChartOptions'):
