...
class PlanetCarrierWindup(_0.APIBase):
    ...
    @property
    def pin_wind_ups(self) -> 'List[_2396.PlanetPinWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinWindUps, constructor.new(_2396.PlanetPinWindup))
        return value
