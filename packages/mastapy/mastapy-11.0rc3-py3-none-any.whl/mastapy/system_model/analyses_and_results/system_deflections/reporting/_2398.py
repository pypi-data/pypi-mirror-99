...
from mastapy.utility.enums import _1354
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.report import _1297
...
class ShaftSystemDeflectionSectionsReport(_1297.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1354.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1354.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1354.TableAndChartOptions'):
