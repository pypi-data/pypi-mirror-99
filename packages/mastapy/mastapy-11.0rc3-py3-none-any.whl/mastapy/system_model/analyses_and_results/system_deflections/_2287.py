...
class BoltSystemDeflection(_2292.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3298.BoltPowerFlow':
        ...
        return constructor.new(_3298.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
