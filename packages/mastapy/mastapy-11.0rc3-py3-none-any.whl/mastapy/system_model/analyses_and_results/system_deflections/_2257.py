...
from mastapy.system_model.part_model import _2026, _2027
...
from mastapy.math_utility.measured_vectors import _1136, _1133
from mastapy.bearings.bearing_results import (
    _1599, _1604, _1606, _1607,
    _1608, _1609, _1610, _1612
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling import (
    _1631, _1634, _1637, _1642,
    _1645, _1650, _1653, _1657,
    _1660, _1665, _1669, _1672,
    _1677, _1681, _1684, _1688,
    _1691, _1697, _1700, _1703,
    _1706
)
from mastapy.bearings.bearing_results.fluid_film import (
    _1759, _1760, _1761, _1763,
    _1766, _1767
)
...
class BearingSystemDeflection(_2287.ConnectorSystemDeflection):
    '''BearingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3268.BearingPowerFlow':
        ...
        return constructor.new(_3268.BearingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def relative_displacement_in_wcs(self) -> '_1136.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1136.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDisplacementInWCS) if self.wrapped.RelativeDisplacementInWCS else None

    @property
    def relative_displacement_in_lcs(self) -> '_1136.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1136.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDisplacementInLCS) if self.wrapped.RelativeDisplacementInLCS else None

    @property
    def stiffness_between_rings(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessBetweenRings) if self.wrapped.StiffnessBetweenRings else None

    @property
    def stiffness_matrix(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix else None

    @property
    def outer_left_mounting_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.OuterLeftMountingStiffness) if self.wrapped.OuterLeftMountingStiffness else None

    @property
    def outer_right_mounting_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.OuterRightMountingStiffness) if self.wrapped.OuterRightMountingStiffness else None

    @property
    def inner_left_mounting_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.InnerLeftMountingStiffness) if self.wrapped.InnerLeftMountingStiffness else None

    @property
    def inner_right_mounting_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.InnerRightMountingStiffness) if self.wrapped.InnerRightMountingStiffness else None

    @property
    def inner_radial_mounting_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.InnerRadialMountingStiffness) if self.wrapped.InnerRadialMountingStiffness else None

    @property
    def outer_radial_mounting_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.OuterRadialMountingStiffness) if self.wrapped.OuterRadialMountingStiffness else None

    @property
    def preload_spring_stiffness(self) -> '_1599.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1599.BearingStiffnessMatrixReporter)(self.wrapped.PreloadSpringStiffness) if self.wrapped.PreloadSpringStiffness else None

    @property
    def component_detailed_analysis(self) -> '_1604.LoadedBearingResults':
        ...
        if _1604.LoadedBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_concept_axial_clearance_bearing_results(self) -> '_1606.LoadedConceptAxialClearanceBearingResults':
        ...
        if _1606.LoadedConceptAxialClearanceBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_concept_clearance_bearing_results(self) -> '_1607.LoadedConceptClearanceBearingResults':
        ...
        if _1607.LoadedConceptClearanceBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_concept_radial_clearance_bearing_results(self) -> '_1608.LoadedConceptRadialClearanceBearingResults':
        ...
        if _1608.LoadedConceptRadialClearanceBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_detailed_bearing_results(self) -> '_1609.LoadedDetailedBearingResults':
        ...
        if _1609.LoadedDetailedBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_linear_bearing_results(self) -> '_1610.LoadedLinearBearingResults':
        ...
        if _1610.LoadedLinearBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_non_linear_bearing_results(self) -> '_1612.LoadedNonLinearBearingResults':
        ...
        if _1612.LoadedNonLinearBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_angular_contact_ball_bearing_results(self) -> '_1631.LoadedAngularContactBallBearingResults':
        ...
        if _1631.LoadedAngularContactBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_angular_contact_thrust_ball_bearing_results(self) -> '_1634.LoadedAngularContactThrustBallBearingResults':
        ...
        if _1634.LoadedAngularContactThrustBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_asymmetric_spherical_roller_bearing_results(self) -> '_1637.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        if _1637.LoadedAsymmetricSphericalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_axial_thrust_cylindrical_roller_bearing_results(self) -> '_1642.LoadedAxialThrustCylindricalRollerBearingResults':
        ...
        if _1642.LoadedAxialThrustCylindricalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_axial_thrust_needle_roller_bearing_results(self) -> '_1645.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        if _1645.LoadedAxialThrustNeedleRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_ball_bearing_results(self) -> '_1650.LoadedBallBearingResults':
        ...
        if _1650.LoadedBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_crossed_roller_bearing_results(self) -> '_1653.LoadedCrossedRollerBearingResults':
        ...
        if _1653.LoadedCrossedRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_cylindrical_roller_bearing_results(self) -> '_1657.LoadedCylindricalRollerBearingResults':
        ...
        if _1657.LoadedCylindricalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_deep_groove_ball_bearing_results(self) -> '_1660.LoadedDeepGrooveBallBearingResults':
        ...
        if _1660.LoadedDeepGrooveBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_four_point_contact_ball_bearing_results(self) -> '_1665.LoadedFourPointContactBallBearingResults':
        ...
        if _1665.LoadedFourPointContactBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_needle_roller_bearing_results(self) -> '_1669.LoadedNeedleRollerBearingResults':
        ...
        if _1669.LoadedNeedleRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_non_barrel_roller_bearing_results(self) -> '_1672.LoadedNonBarrelRollerBearingResults':
        ...
        if _1672.LoadedNonBarrelRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_roller_bearing_results(self) -> '_1677.LoadedRollerBearingResults':
        ...
        if _1677.LoadedRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_rolling_bearing_results(self) -> '_1681.LoadedRollingBearingResults':
        ...
        if _1681.LoadedRollingBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_self_aligning_ball_bearing_results(self) -> '_1684.LoadedSelfAligningBallBearingResults':
        ...
        if _1684.LoadedSelfAligningBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_spherical_roller_radial_bearing_results(self) -> '_1688.LoadedSphericalRollerRadialBearingResults':
        ...
        if _1688.LoadedSphericalRollerRadialBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_spherical_roller_thrust_bearing_results(self) -> '_1691.LoadedSphericalRollerThrustBearingResults':
        ...
        if _1691.LoadedSphericalRollerThrustBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_taper_roller_bearing_results(self) -> '_1697.LoadedTaperRollerBearingResults':
        ...
        if _1697.LoadedTaperRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_three_point_contact_ball_bearing_results(self) -> '_1700.LoadedThreePointContactBallBearingResults':
        ...
        if _1700.LoadedThreePointContactBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_thrust_ball_bearing_results(self) -> '_1703.LoadedThrustBallBearingResults':
        ...
        if _1703.LoadedThrustBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_toroidal_roller_bearing_results(self) -> '_1706.LoadedToroidalRollerBearingResults':
        ...
        if _1706.LoadedToroidalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_grease_filled_journal_bearing_results(self) -> '_1759.LoadedGreaseFilledJournalBearingResults':
        ...
        if _1759.LoadedGreaseFilledJournalBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_pad_fluid_film_bearing_results(self) -> '_1760.LoadedPadFluidFilmBearingResults':
        ...
        if _1760.LoadedPadFluidFilmBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_plain_journal_bearing_results(self) -> '_1761.LoadedPlainJournalBearingResults':
        ...
        if _1761.LoadedPlainJournalBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_plain_oil_fed_journal_bearing(self) -> '_1763.LoadedPlainOilFedJournalBearing':
        ...
        if _1763.LoadedPlainOilFedJournalBearing.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_tilting_pad_journal_bearing_results(self) -> '_1766.LoadedTiltingPadJournalBearingResults':
        ...
        if _1766.LoadedTiltingPadJournalBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_tilting_pad_thrust_bearing_results(self) -> '_1767.LoadedTiltingPadThrustBearingResults':
        ...
        if _1767.LoadedTiltingPadThrustBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def forces_at_zero_displacement_for_inner_and_outer_nodes(self) -> 'List[_1133.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForcesAtZeroDisplacementForInnerAndOuterNodes, constructor.new(_1133.ForceResults))
        return value

    @property
    def race_mounting_options_for_analysis(self) -> 'List[_2027.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceMountingOptionsForAnalysis, constructor.new(_2027.BearingRaceMountingOptions))
        return value
