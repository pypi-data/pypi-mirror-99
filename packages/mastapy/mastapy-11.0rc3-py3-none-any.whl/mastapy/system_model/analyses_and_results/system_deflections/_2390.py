...
class ConceptGearSystemDeflection(_2427.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3726.ConceptGearPowerFlow':
        ...
        return constructor.new(_3726.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
