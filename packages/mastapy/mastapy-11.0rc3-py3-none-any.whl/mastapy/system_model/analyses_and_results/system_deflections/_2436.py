...
from mastapy.system_model.analyses_and_results.power_flows import _3764, _3767, _3770
...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2394.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3764.KlingelnbergCycloPalloidConicalGearPowerFlow':
