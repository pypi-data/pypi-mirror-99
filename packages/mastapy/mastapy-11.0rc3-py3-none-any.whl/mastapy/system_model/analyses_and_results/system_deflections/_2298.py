...
from mastapy.system_model.analyses_and_results.system_deflections import _2299, _2297, _2330
...
class ConceptGearSetSystemDeflection(_2330.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3309.ConceptGearSetPowerFlow':
        ...
        return constructor.new(_3309.ConceptGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2299.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2299.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2297.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2297.ConceptGearMeshSystemDeflection))
        return value
