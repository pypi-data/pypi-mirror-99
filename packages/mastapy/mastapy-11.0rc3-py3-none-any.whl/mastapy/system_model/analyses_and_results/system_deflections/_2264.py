...
class BevelDifferentialSunGearSystemDeflection(_2262.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3275.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3275.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
