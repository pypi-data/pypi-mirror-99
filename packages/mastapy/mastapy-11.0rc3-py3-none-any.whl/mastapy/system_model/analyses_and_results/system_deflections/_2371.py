...
from mastapy.system_model.analyses_and_results.power_flows import _3708, _3710, _3711
...
class BevelDifferentialGearSystemDeflection(_2376.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3708.BevelDifferentialGearPowerFlow':
