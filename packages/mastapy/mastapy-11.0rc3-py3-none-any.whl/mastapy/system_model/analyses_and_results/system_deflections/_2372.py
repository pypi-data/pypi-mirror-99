...
class BevelDifferentialPlanetGearSystemDeflection(_2371.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3710.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3710.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
