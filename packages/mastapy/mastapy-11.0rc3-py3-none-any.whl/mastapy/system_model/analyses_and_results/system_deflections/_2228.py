...
class AGMAGleasonConicalGearSetSystemDeflection(_2258.ConicalGearSetSystemDeflection):
    '''AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3238.AGMAGleasonConicalGearSetPowerFlow':
