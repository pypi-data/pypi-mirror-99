...
class ConceptCouplingConnectionSystemDeflection(_2306.CouplingConnectionSystemDeflection):
    '''ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3304.ConceptCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3304.ConceptCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
