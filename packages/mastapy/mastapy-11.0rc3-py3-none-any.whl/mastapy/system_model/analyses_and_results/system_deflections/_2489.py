...
class SynchroniserSleeveSystemDeflection(_2488.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3815.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3815.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
