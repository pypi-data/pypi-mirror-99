...
class ExternalCADModelSystemDeflection(_2292.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3327.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3327.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
