...
from mastapy.system_model.analyses_and_results.power_flows import _3694, _3738, _3791
...
class AbstractShaftSystemDeflection(_2355.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3694.AbstractShaftPowerFlow':
