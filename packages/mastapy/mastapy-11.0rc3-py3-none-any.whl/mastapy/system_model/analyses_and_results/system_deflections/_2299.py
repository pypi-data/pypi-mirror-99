...
class ConceptGearSystemDeflection(_2331.GearSystemDeflection):
    ...
    @property
    def power_flow_results(self) -> '_3308.ConceptGearPowerFlow':
        ...
        return constructor.new(_3308.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
