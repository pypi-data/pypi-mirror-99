...
from mastapy.system_model.analyses_and_results.system_deflections import _2280, _2278, _2284
...
class BevelDifferentialGearSetSystemDeflection(_2284.BevelGearSetSystemDeflection):
    '''BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3291.BevelDifferentialGearSetPowerFlow':
        ...
        return constructor.new(_3291.BevelDifferentialGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2280.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSystemDeflection, constructor.new(_2280.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2278.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSystemDeflection, constructor.new(_2278.BevelDifferentialGearMeshSystemDeflection))
        return value
