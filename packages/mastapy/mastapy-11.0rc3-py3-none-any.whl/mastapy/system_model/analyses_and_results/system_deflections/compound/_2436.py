...
class BoltedJointCompoundSystemDeflection(_2510.SpecialisedAssemblyCompoundSystemDeflection):
    '''BoltedJointCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2286.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2286.BoltedJointSystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2286.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2286.BoltedJointSystemDeflection))
        return value
