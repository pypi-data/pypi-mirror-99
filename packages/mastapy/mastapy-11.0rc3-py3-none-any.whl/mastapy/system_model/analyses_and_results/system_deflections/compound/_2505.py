...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2464, _2423
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.power_flows.compound import _3491
from mastapy.system_model.imported_fes import _2023
...
class RootAssemblyCompoundSystemDeflection(_2423.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3491.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3491.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_2023.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_2023.RaceBearingFESystemDeflection))
        return value
