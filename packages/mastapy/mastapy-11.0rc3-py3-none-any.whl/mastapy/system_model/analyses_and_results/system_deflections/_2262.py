...
from mastapy.system_model.analyses_and_results.power_flows import _3272, _3274, _3275
...
class BevelDifferentialGearSystemDeflection(_2267.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3272.BevelDifferentialGearPowerFlow':
