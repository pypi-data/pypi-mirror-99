...
class ShaftToMountableComponentConnectionSystemDeflection(_2361.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3796.ShaftToMountableComponentConnectionPowerFlow':
