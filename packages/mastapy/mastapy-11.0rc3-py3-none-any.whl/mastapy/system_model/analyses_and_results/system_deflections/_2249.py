...
class ClutchConnectionSystemDeflection(_2267.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3260.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3260.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
