...
class BevelDifferentialPlanetGearSystemDeflection(_2280.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3292.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3292.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
