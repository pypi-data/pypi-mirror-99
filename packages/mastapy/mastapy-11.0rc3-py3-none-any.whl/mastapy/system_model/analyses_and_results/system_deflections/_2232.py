...
class AGMAGleasonConicalGearMeshSystemDeflection(_2262.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3243.AGMAGleasonConicalGearMeshPowerFlow':
