...
class AGMAGleasonConicalGearMeshSystemDeflection(_2257.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3236.AGMAGleasonConicalGearMeshPowerFlow':
