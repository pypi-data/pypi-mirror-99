...
class BevelGearSetSystemDeflection(_2272.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3296.BevelGearSetPowerFlow':
