...
class AbstractShaftToMountableComponentConnectionSystemDeflection(_2391.ConnectionSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3695.AbstractShaftToMountableComponentConnectionPowerFlow':
        ...
        if _3695.AbstractShaftToMountableComponentConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_coaxial_connection_power_flow(self) -> '_3716.CoaxialConnectionPowerFlow':
        ...
        if _3716.CoaxialConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_cycloidal_disc_central_bearing_connection_power_flow(self) -> '_3736.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        if _3736.CycloidalDiscCentralBearingConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_cycloidal_disc_planetary_bearing_connection_power_flow(self) -> '_3737.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
        ...
        if _3737.CycloidalDiscPlanetaryBearingConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_planetary_connection_power_flow(self) -> '_3776.PlanetaryConnectionPowerFlow':
        ...
        if _3776.PlanetaryConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_to_mountable_component_connection_power_flow(self) -> '_3792.ShaftToMountableComponentConnectionPowerFlow':
        ...
        if _3792.ShaftToMountableComponentConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
