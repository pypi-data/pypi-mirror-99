...
class BevelDifferentialSunGearSystemDeflection(_2241.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3254.BevelDifferentialSunGearPowerFlow':
