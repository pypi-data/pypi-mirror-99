...
class AGMAGleasonConicalGearSetSystemDeflection(_2393.ConicalGearSetSystemDeflection):
    '''AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3702.AGMAGleasonConicalGearSetPowerFlow':
