...
class BevelGearSetSystemDeflection(_2254.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3278.BevelGearSetPowerFlow':
