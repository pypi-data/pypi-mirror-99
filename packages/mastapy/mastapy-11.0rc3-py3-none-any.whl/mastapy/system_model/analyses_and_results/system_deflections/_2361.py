...
class AbstractShaftToMountableComponentConnectionSystemDeflection(_2395.ConnectionSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3699.AbstractShaftToMountableComponentConnectionPowerFlow':
