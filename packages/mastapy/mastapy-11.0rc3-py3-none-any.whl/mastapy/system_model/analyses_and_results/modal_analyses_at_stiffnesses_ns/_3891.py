...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3890, _3889, _3802
...
class StraightBevelGearSetModalAnalysesAtStiffnesses(_3802.BevelGearSetModalAnalysesAtStiffnesses):
    '''StraightBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def straight_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3890.StraightBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3890.StraightBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def straight_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3889.StraightBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3889.StraightBevelGearMeshModalAnalysesAtStiffnesses))
        return value
