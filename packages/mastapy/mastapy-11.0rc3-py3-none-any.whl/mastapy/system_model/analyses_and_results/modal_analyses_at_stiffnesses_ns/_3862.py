...
from mastapy.system_model.drawing import _1875
...
class PartModalAnalysesAtStiffnesses(_6564.PartStaticLoadAnalysisCase):
    '''PartModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses(self) -> '_3824.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3824.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnesses) if self.wrapped.ModalAnalysesAtStiffnesses else None

    def create_viewable(self) -> '_1875.ModalAnalysesAtStiffnessesViewable':
        ''' 'CreateViewable' is the original name of this method.

        Returns:
            mastapy.system_model.drawing.ModalAnalysesAtStiffnessesViewable
        '''
