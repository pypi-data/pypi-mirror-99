...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4206
...
class BoltedJointCompoundModalAnalysesAtSpeeds(_4206.SpecialisedAssemblyCompoundModalAnalysesAtSpeeds):
    '''BoltedJointCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4008.BoltedJointModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4008.BoltedJointModalAnalysesAtSpeeds))
        return value

    @property
    def assembly_modal_analyses_at_speeds_load_cases(self) -> 'List[_4008.BoltedJointModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtSpeedsLoadCases, constructor.new(_4008.BoltedJointModalAnalysesAtSpeeds))
        return value
