...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4155
...
class ZerolBevelGearCompoundModalAnalysesAtSpeeds(_4171.BevelGearCompoundModalAnalysesAtSpeeds):
    '''ZerolBevelGearCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4155.ZerolBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4155.ZerolBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_4155.ZerolBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_4155.ZerolBevelGearModalAnalysesAtSpeeds))
        return value
