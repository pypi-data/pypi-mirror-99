...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4132
from mastapy.system_model.drawing import _1874
...
class PartModalAnalysesAtSpeeds(_6564.PartStaticLoadAnalysisCase):
    '''PartModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4132.StabilityAnalysis':
        ...
        return constructor.new(_4132.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None

    def create_viewable(self) -> '_1874.ModalAnalysesAtSpeedsViewable':
        ''' 'CreateViewable' is the original name of this method.

        Returns:
            mastapy.system_model.drawing.ModalAnalysesAtSpeedsViewable
        '''
