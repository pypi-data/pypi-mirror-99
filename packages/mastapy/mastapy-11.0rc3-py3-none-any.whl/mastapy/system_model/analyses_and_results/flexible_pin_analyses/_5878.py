...
from mastapy.system_model.analyses_and_results.load_case_groups import _5287
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5870
...
class WindTurbineCertificationReport(_5870.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2122.RootAssembly':
        ...
        return constructor.new(_2122.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2579.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2579.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2433.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2433.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2433.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2433.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
