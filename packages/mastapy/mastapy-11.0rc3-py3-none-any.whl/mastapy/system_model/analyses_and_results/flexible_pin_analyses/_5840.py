...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2443, _2479, _2406
...
class FlexiblePinAnalysisGearAndBearingRating(_5837.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2443.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2443.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2406.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2406.BearingCompoundSystemDeflection))
        return value
