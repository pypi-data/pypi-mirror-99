...
class FlexiblePinAnalysisManufactureLevel(_5837.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3549.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3549.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
