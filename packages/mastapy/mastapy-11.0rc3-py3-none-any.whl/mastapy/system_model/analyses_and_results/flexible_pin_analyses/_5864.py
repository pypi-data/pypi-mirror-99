...
from mastapy.system_model.analyses_and_results.load_case_groups import _5304
from mastapy.system_model.part_model import _2074
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2505
from mastapy.system_model.analyses_and_results.system_deflections import _2367
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5856
...
class WindTurbineCertificationReport(_5856.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2074.RootAssembly':
        ...
        return constructor.new(_2074.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2505.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2505.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2367.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2367.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2367.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2367.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
