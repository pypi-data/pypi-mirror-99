...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5839
...
class FlexiblePinAnalysisStopStartAnalysis(_5839.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2355.ShaftSystemDeflection':
        ...
        return constructor.new(_2355.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase else None

    @property
    def shaft_extreme_load_case(self) -> '_2355.ShaftSystemDeflection':
        ...
        return constructor.new(_2355.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase else None
