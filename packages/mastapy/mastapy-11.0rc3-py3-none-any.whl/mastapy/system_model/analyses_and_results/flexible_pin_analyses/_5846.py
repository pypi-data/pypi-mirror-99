...
from mastapy.system_model.analyses_and_results.load_case_groups import _5286
from mastapy.system_model.part_model import _2060
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2489
from mastapy.system_model.analyses_and_results.system_deflections import _2351
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5838
...
class WindTurbineCertificationReport(_5838.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2060.RootAssembly':
        ...
        return constructor.new(_2060.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2489.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2489.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2351.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2351.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2351.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2351.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
