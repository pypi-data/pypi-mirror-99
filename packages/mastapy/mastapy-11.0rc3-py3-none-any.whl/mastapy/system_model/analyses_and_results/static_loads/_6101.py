...
from mastapy.gears.manufacturing.bevel import _576, _574, _575
...
class AGMAGleasonConicalGearSetLoadCase(_6132.ConicalGearSetLoadCase):
    '''AGMAGleasonConicalGearSetLoadCase
    ...
    @property
    def overridden_manufacturing_config_micro_geometry(self) -> '_576.ConicalSetMicroGeometryConfigBase':
        ...
        if _576.ConicalSetMicroGeometryConfigBase.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_manufacturing_config(self) -> '_574.ConicalSetManufacturingConfig':
        ...
        if _574.ConicalSetManufacturingConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_micro_geometry_config(self) -> '_575.ConicalSetMicroGeometryConfig':
        ...
        if _575.ConicalSetMicroGeometryConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
