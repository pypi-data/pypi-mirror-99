...
from mastapy.system_model.analyses_and_results.static_loads import _6563, _6538, _6514
...
class HarmonicLoadDataExcelImport(_6538.HarmonicLoadDataImportBase['_6514.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6563.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6563.NamedSpeed))
        return value
