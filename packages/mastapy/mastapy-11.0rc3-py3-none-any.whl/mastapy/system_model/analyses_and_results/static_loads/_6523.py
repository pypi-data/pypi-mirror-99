...
from mastapy.system_model.fe import _2039, _2062
...
class FEPartLoadCase(_6444.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2039.AngleSource':
        ...
        return constructor.new(_2039.AngleSource)(value) if value else None
    ...
    def fe_substructure(self) -> 'list_with_selected_item.ListWithSelectedItem_FESubstructure':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure else None
