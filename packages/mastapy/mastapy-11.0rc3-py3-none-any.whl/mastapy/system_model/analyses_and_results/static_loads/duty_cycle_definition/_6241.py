...
from mastapy.system_model.analyses_and_results.load_case_groups import _5258
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model import _1817
...
class DesignStateOptions(_1508.ColumnInputOptions):
    '''DesignStateOptions
    ...
    @property
    def design_state_destinations(self) -> 'List[_1817.DutyCycleImporterDesignEntityMatch[_5258.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1817.DutyCycleImporterDesignEntityMatch)[_5258.DesignState])
        return value
