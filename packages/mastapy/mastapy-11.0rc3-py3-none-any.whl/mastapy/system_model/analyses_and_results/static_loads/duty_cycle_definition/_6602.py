...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6603, _6597
...
class TorqueInputOptions(_6597.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6603.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6603.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6603.TorqueValuesObtainedFrom'):
