...
from mastapy.system_model import _1884
...
class DesignStateOptions(_1483.ColumnInputOptions):
    '''DesignStateOptions
    ...
    @property
    def design_state_destinations(self) -> 'List[_1884.DutyCycleImporterDesignEntityMatch[_5286.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1884.DutyCycleImporterDesignEntityMatch)[_5286.DesignState])
        return value
