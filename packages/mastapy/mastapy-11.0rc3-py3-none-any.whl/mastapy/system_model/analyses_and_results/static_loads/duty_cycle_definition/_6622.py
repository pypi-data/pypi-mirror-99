...
class DesignStateOptions(_1571.ColumnInputOptions):
    '''DesignStateOptions
    ...
    @property
    def design_state_destinations(self) -> 'List[_1890.DutyCycleImporterDesignEntityMatch[_5315.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1890.DutyCycleImporterDesignEntityMatch)[_5315.DesignState])
        return value
