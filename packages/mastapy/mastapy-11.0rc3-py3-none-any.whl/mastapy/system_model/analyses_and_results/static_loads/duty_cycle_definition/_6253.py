...
class PointLoadInputOptions(_1508.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1064.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6244.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6244.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6244.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
