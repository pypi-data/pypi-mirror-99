...
from mastapy.utility_gui import _1509
...
class MultiTimeSeriesDataInputFileOptions(_1509.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1339.TextFileDelimiterOptions':
        ...
        return constructor.new(_1339.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
