...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6268, _6279, _6270, _6267,
    _6271, _6273, _6280, _6277,
    _6269, _6272, _6266
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6187.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6187.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6187.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6279.TimeStepInputOptions':
        ...
        return constructor.new(_6279.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6270.GearRatioInputOptions':
        ...
        return constructor.new(_6270.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6267.DesignStateOptions':
        ...
        return constructor.new(_6267.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6271.LoadCaseNameOptions':
        ...
        return constructor.new(_6271.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6273.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6273.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6280.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6280.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6277.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6277.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6269.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6269.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6272.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6272.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6266.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6266.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1352.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1352.ColumnTitle))
        return value
