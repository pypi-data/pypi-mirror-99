...
from mastapy.utility.file_access_helpers import _1461
from mastapy.utility_gui import _1484
...
class MultiTimeSeriesDataInputFileOptions(_1484.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1461.TextFileDelimiterOptions':
        ...
        return constructor.new(_1461.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
