...
from mastapy.utility.file_access_helpers import _1547
from mastapy.utility_gui import _1573
...
class MultiTimeSeriesDataInputFileOptions(_1573.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1547.TextFileDelimiterOptions':
        ...
        return constructor.new(_1547.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
