...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6288, _6299, _6290, _6287,
    _6291, _6293, _6300, _6297,
    _6289, _6292, _6286
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6207.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6207.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6207.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6299.TimeStepInputOptions':
        ...
        return constructor.new(_6299.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6290.GearRatioInputOptions':
        ...
        return constructor.new(_6290.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6287.DesignStateOptions':
        ...
        return constructor.new(_6287.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6291.LoadCaseNameOptions':
        ...
        return constructor.new(_6291.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6293.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6293.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6300.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6300.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6297.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6297.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6289.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6289.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6292.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6292.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6286.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6286.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1353.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1353.ColumnTitle))
        return value
