...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6632, _6643, _6634, _6631,
    _6635, _6637, _6644, _6641,
    _6633, _6636, _6630
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6546.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6546.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6546.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6643.TimeStepInputOptions':
        ...
        return constructor.new(_6643.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6634.GearRatioInputOptions':
        ...
        return constructor.new(_6634.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6631.DesignStateOptions':
        ...
        return constructor.new(_6631.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6635.LoadCaseNameOptions':
        ...
        return constructor.new(_6635.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6637.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6637.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6644.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6644.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6641.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6641.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6633.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6633.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6636.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6636.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6630.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6630.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1546.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1546.ColumnTitle))
        return value
