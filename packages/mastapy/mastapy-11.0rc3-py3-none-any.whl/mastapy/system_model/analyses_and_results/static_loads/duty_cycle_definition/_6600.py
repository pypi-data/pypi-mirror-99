...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6590, _6601, _6592, _6589,
    _6593, _6595, _6602, _6599,
    _6591, _6594, _6588
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6505.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6505.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6505.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6601.TimeStepInputOptions':
        ...
        return constructor.new(_6601.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6592.GearRatioInputOptions':
        ...
        return constructor.new(_6592.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6589.DesignStateOptions':
        ...
        return constructor.new(_6589.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6593.LoadCaseNameOptions':
        ...
        return constructor.new(_6593.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6595.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6595.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6602.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6602.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6599.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6599.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6591.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6591.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6594.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6594.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6588.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6588.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1460.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1460.ColumnTitle))
        return value
