...
from mastapy.system_model import _1882
from mastapy.utility_gui import _1565
...
class DesignStateOptions(_1565.ColumnInputOptions):
    '''DesignStateOptions
    ...
    @property
    def design_state_destinations(self) -> 'List[_1882.DutyCycleImporterDesignEntityMatch[_5283.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1882.DutyCycleImporterDesignEntityMatch)[_5283.DesignState])
        return value
