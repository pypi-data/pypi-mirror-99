...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6301, _6295
...
class TorqueInputOptions(_6295.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6301.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6301.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6301.TorqueValuesObtainedFrom'):
