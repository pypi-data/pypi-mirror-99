...
class MultiTimeSeriesDataInputFileOptions(_1530.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1353.TextFileDelimiterOptions':
        ...
        return constructor.new(_1353.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
