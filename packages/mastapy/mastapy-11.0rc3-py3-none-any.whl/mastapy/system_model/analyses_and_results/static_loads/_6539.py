...
from mastapy.system_model.analyses_and_results.static_loads import _6542, _6538, _6516
...
class HarmonicLoadDataImportFromMotorPackages(_6538.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
