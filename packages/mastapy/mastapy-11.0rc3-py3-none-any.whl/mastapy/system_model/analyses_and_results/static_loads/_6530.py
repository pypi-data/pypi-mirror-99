...
from mastapy.system_model.analyses_and_results.static_loads import _6529, _6534
...
class GearSetHarmonicLoadData(_6534.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6529.GearMeshTEOrderType':
        ...
        return constructor.new(_6529.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6529.GearMeshTEOrderType'):
