...
from mastapy.gears.gear_designs.conical import _902, _896
...
class ConicalGearMeshLoadCase(_6190.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_902.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_902.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML else None
