...
class CylindricalGearSetLoadCase(_6531.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def coefficient_of_friction_calculation_method(self) -> '_280.CoefficientOfFrictionCalculationMethod':
        ...
        return constructor.new(_280.CoefficientOfFrictionCalculationMethod)(value) if value else None

    @coefficient_of_friction_calculation_method.setter
    def coefficient_of_friction_calculation_method(self, value: '_280.CoefficientOfFrictionCalculationMethod'):
    ...
    @property
    def reset_micro_geometry(self) -> '_6579.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6579.ResetMicroGeometryOptions)(value) if value else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6579.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def overridden_micro_geometry(self) -> '_1028.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1028.CylindricalGearSetMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None

    @property
    def ltca(self) -> '_986.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_986.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA else None

    @property
    def gears(self) -> 'List[_6496.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6496.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_gears_load_case(self) -> 'List[_6496.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_6496.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_6498.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_6498.CylindricalGearMeshLoadCase))
        return value

    def get_harmonic_load_data_for_import(self) -> '_6499.CylindricalGearSetHarmonicLoadData':
