...
from mastapy.system_model.analyses_and_results.static_loads import _6528, _6526, _6590
...
class GearSetLoadCase(_6590.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5095.GearMeshStiffnessModel':
        ...
        return constructor.new(_5095.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5095.GearMeshStiffnessModel'):
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6652.AdvancedTimeSteppingAnalysisForModulationOptions':
        ...
        return constructor.new(_6652.AdvancedTimeSteppingAnalysisForModulationOptions)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions else None

    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6528.GearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesWithoutPlanetaryDuplicates, constructor.new(_6528.GearMeshLoadCase))
        return value

    @property
    def gears(self) -> 'List[_6526.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6526.GearLoadCase))
        return value

    @property
    def gears_without_clones(self) -> 'List[_6526.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsWithoutClones, constructor.new(_6526.GearLoadCase))
        return value
