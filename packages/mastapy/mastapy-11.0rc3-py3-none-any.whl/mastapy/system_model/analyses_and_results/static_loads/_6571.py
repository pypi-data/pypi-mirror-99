...
class PlanetaryGearSetLoadCase(_6500.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1347.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1347.LoadCaseOverrideOption'):
