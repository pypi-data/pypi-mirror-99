...
from mastapy.nodal_analysis.varying_input_components import _87, _86, _91
from mastapy.math_utility.control import _1335
from mastapy.system_model.analyses_and_results.static_loads import (
    _6598, _6447, _6500, _6454
)
...
class RootAssemblyLoadCase(_6454.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_87.ForceInputComponent':
        ...
        return constructor.new(_87.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_86.AngleInputComponent':
        ...
        return constructor.new(_86.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1335.PIDControlSettings':
        ...
        return constructor.new(_1335.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_91.VelocityInputComponent':
        ...
        return constructor.new(_91.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6500.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6500.CylindricalGearSetLoadCase))
        return value
