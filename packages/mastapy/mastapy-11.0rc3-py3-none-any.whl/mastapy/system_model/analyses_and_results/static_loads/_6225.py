...
from mastapy.system_model.analyses_and_results import _2245
...
class PartLoadCase(_2245.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6254.StaticLoadCase':
        ...
        if _6254.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    def get_harmonic_load_data_for_import(self) -> '_6196.HarmonicLoadDataBase':
