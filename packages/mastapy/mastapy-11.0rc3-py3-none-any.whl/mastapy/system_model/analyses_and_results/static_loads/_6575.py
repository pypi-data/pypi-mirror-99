...
from mastapy.math_utility import _1266, _1276
...
class PointLoadHarmonicLoadData(_6591.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1266.DegreesOfFreedom':
        ...
        return constructor.new(_1266.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1266.DegreesOfFreedom'):
