...
from mastapy.utility import _1347
...
from mastapy.bearings.tolerances import _1619, _1625
...
class BearingLoadCase(_6485.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def include_fitting_effects(self) -> '_1347.LoadCaseOverrideOption':
        ...
        return constructor.new(_1347.LoadCaseOverrideOption)(value) if value else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1347.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1347.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1347.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1347.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1347.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearing_stiffness_model(self) -> '_5043.BearingStiffnessModel':
        ...
        return constructor.new(_5043.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5043.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5043.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1619.RaceDetail':
        ...
        return constructor.new(_1619.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1619.RaceDetail':
        ...
        return constructor.new(_1619.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None
    ...
    @property
    def inner_ring_detail(self) -> '_1619.RaceDetail':
        ...
        return constructor.new(_1619.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None
    ...
    @property
    def outer_ring_detail(self) -> '_1619.RaceDetail':
        ...
        return constructor.new(_1619.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None
