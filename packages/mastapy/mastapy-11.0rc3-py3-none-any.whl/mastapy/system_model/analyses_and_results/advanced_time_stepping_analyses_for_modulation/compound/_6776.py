...
class AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_6804.ConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
