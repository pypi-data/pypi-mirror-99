...
class BearingAdvancedTimeSteppingAnalysisForModulation(_6686.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''BearingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2366.BearingSystemDeflection':
        ...
        return constructor.new(_2366.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
