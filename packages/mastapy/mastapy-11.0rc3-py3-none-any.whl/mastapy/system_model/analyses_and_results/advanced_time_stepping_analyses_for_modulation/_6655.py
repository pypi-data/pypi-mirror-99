...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6684.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2363.AGMAGleasonConicalGearSetSystemDeflection':
