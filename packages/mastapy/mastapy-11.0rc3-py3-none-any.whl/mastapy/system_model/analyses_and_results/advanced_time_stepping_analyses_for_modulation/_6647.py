...
from mastapy.system_model.analyses_and_results.system_deflections import _2360, _2406, _2470
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6648.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2360.AbstractShaftSystemDeflection':
