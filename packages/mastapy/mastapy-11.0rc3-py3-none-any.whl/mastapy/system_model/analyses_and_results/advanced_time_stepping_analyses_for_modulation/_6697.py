...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6708.GearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2413.CylindricalGearSystemDeflection':
