...
class GearMeshAdvancedTimeSteppingAnalysisForModulation(_6716.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''GearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2425.GearMeshSystemDeflection':
