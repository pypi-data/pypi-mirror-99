...
class BearingAdvancedSystemDeflection(_6948.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1650.LoadedBearingDutyCycle':
        ...
        if _1650.LoadedBearingDutyCycle.TYPE not in self.wrapped.DutyCycle.__class__.__mro__:
