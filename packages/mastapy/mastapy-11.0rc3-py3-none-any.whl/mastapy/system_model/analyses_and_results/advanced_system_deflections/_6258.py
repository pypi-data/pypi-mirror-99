...
class AdvancedSystemDeflection(_6521.StaticLoadAnalysisCase):
    '''AdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6259.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6259.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None
