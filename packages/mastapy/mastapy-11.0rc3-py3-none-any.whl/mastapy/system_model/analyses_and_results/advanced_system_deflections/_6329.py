...
class ConceptCouplingAdvancedSystemDeflection(_6341.CouplingAdvancedSystemDeflection):
    '''ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2296.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2296.ConceptCouplingSystemDeflection))
        return value
