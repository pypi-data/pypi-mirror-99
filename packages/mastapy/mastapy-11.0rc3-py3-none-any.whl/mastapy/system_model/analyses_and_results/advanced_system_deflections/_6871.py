...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6872
...
class AdvancedSystemDeflection(_7147.StaticLoadAnalysisCase):
    '''AdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6872.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6872.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None
