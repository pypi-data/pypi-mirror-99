...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_785.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_785.UseAdvancedLTCAOptions)(value) if value else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_785.UseAdvancedLTCAOptions'):
