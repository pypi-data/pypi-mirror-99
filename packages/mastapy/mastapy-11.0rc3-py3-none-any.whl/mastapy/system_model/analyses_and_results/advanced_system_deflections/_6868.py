...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6869
...
class AbstractShaftAdvancedSystemDeflection(_6869.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''AbstractShaftAdvancedSystemDeflection
