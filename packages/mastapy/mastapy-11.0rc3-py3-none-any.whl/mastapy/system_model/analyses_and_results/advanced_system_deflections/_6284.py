...
class AdvancedSystemDeflection(_6547.StaticLoadAnalysisCase):
    '''AdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6285.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6285.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None
