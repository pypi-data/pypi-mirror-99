...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6933
...
class ClutchCompoundAdvancedSystemDeflection(_7082.CouplingCompoundAdvancedSystemDeflection):
    '''ClutchCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6933.ClutchAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6933.ClutchAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6933.ClutchAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6933.ClutchAdvancedSystemDeflection))
        return value
