...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6882
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7020
...
class BevelDifferentialGearMeshCompoundAdvancedSystemDeflection(_7020.BevelGearMeshCompoundAdvancedSystemDeflection):
    '''BevelDifferentialGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6882.BevelDifferentialGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6882.BevelDifferentialGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_advanced_system_deflection_load_cases(self) -> 'List[_6882.BevelDifferentialGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedSystemDeflectionLoadCases, constructor.new(_6882.BevelDifferentialGearMeshAdvancedSystemDeflection))
        return value
