...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6425
...
class WormGearMeshCompoundAdvancedSystemDeflection(_6482.GearMeshCompoundAdvancedSystemDeflection):
    '''WormGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6425.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6425.WormGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_advanced_system_deflection_load_cases(self) -> 'List[_6425.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedSystemDeflectionLoadCases, constructor.new(_6425.WormGearMeshAdvancedSystemDeflection))
        return value
