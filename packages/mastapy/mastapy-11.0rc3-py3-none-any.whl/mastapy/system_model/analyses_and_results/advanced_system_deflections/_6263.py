...
class AdvancedSystemDeflection(_6526.StaticLoadAnalysisCase):
    '''AdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6264.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6264.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None
