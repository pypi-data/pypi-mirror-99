...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_variable_bearing_stiffness(self) -> '_6382.UseVariableBearingStiffnessOptions':
        ...
        return constructor.new(_6382.UseVariableBearingStiffnessOptions)(value) if value else None

    @use_variable_bearing_stiffness.setter
    def use_variable_bearing_stiffness(self, value: '_6382.UseVariableBearingStiffnessOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
