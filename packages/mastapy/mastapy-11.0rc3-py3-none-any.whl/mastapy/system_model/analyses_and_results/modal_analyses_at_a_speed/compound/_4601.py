...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4606
...
class BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed(_4606.BevelGearMeshCompoundModalAnalysisAtASpeed):
    '''BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4471.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4471.BevelDifferentialGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4471.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisAtASpeedLoadCases, constructor.new(_4471.BevelDifferentialGearMeshModalAnalysisAtASpeed))
        return value
