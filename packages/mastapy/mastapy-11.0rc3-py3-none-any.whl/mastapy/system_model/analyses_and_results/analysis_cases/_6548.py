...
class TimeSeriesLoadAnalysisCase(_6532.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6248.TimeSeriesLoadCase':
        ...
        return constructor.new(_6248.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
