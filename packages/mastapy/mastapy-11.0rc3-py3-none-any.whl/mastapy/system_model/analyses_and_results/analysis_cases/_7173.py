...
from mastapy.system_model.analyses_and_results import _2323, _2321
...
class DesignEntityCompoundAnalysis(_2321.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2323.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2323.DesignEntitySingleContextAnalysis))
        return value
