...
from mastapy.system_model.analyses_and_results import _2226, _2224
...
class DesignEntityCompoundAnalysis(_2224.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2226.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2226.DesignEntitySingleContextAnalysis))
        return value
