...
class StaticLoadAnalysisCase(_7132.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6556.StaticLoadCase':
        ...
        if _6556.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
