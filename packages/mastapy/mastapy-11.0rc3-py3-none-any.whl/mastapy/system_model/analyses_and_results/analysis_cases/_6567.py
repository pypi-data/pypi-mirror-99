...
class TimeSeriesLoadAnalysisCase(_6551.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6268.TimeSeriesLoadCase':
        ...
        return constructor.new(_6268.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
