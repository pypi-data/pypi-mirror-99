...
from mastapy.system_model.analyses_and_results import _2202, _2201
...
class AnalysisCase(_2201.Context):
    '''AnalysisCase
    ...
    def results_for(self, design_entity: '_1814.DesignEntity') -> '_2202.DesignEntityAnalysis':
        ...
        return constructor.new(_2202.DesignEntityAnalysis)(method_result) if method_result else None
