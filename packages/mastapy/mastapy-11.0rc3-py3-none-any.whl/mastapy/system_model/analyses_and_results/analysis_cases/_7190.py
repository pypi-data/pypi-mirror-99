...
class TimeSeriesLoadAnalysisCase(_7174.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6612.TimeSeriesLoadCase':
        ...
        return constructor.new(_6612.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
