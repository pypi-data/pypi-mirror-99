...
class StaticLoadAnalysisCase(_6534.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6236.StaticLoadCase':
        ...
        if _6236.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
