...
from mastapy.system_model.analyses_and_results.analysis_cases import _6534
...
class TimeSeriesLoadAnalysisCase(_6534.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6250.TimeSeriesLoadCase':
        ...
        return constructor.new(_6250.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
