...
class StaticLoadAnalysisCase(_6511.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6213.StaticLoadCase':
        ...
        if _6213.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
