...
from mastapy.system_model.analyses_and_results import _2205, _2203
...
class DesignEntityCompoundAnalysis(_2203.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2205.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2205.DesignEntitySingleContextAnalysis))
        return value
