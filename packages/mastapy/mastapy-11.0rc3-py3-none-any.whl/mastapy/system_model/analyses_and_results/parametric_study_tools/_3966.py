...
class BearingParametricStudyTool(_3994.ConnectorParametricStudyTool):
    '''BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1650.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1650.LoadedBearingDutyCycle))
        return value
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2366.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2366.BearingSystemDeflection))
        return value
