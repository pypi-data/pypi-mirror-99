...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3926
...
class AbstractShaftParametricStudyTool(_3926.AbstractShaftOrHousingParametricStudyTool):
    '''AbstractShaftParametricStudyTool
