...
class GearParametricStudyTool(_3605.MountableComponentParametricStudyTool):
    '''GearParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> 'List[_157.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleResults, constructor.new(_157.GearDutyCycleRating))
        return value
