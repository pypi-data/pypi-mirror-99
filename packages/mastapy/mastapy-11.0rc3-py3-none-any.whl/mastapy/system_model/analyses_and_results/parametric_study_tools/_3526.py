...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3617
...
class AbstractAssemblyParametricStudyTool(_3617.PartParametricStudyTool):
    '''AbstractAssemblyParametricStudyTool
    ...
    @property
    def component_design(self) -> '_2038.AbstractAssembly':
    ...
    @property
    def assembly_design(self) -> '_2038.AbstractAssembly':
        ...
        if _2038.AbstractAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_assembly(self) -> '_2037.Assembly':
    ...
    @property
    def assembly_design_of_type_root_assembly(self) -> '_2074.RootAssembly':
        ...
        if _2074.RootAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_specialised_assembly(self) -> '_2076.SpecialisedAssembly':
