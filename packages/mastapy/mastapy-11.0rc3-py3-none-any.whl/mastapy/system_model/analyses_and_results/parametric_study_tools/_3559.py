...
from mastapy.system_model.analyses_and_results.analysis_cases import _6554
...
class ConnectionParametricStudyTool(_6554.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3612.ParametricStudyTool':
        ...
        return constructor.new(_3612.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
