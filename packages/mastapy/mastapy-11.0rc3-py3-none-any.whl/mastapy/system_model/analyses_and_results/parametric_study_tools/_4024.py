...
class GearParametricStudyTool(_4043.MountableComponentParametricStudyTool):
    '''GearParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> 'List[_319.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleResults, constructor.new(_319.GearDutyCycleRating))
        return value
