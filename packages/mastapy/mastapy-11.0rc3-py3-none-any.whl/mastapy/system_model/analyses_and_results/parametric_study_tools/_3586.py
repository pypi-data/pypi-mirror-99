...
class GearSetParametricStudyTool(_3634.SpecialisedAssemblyParametricStudyTool):
    '''GearSetParametricStudyTool
    ...
    @property
    def gear_set_duty_cycle_results(self) -> 'List[_161.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDutyCycleResults, constructor.new(_161.GearSetDutyCycleRating))
        return value
