...
class PartParametricStudyTool(_7184.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def data_logger(self) -> '_1574.DataLoggerWithCharts':
        ...
        return constructor.new(_1574.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger else None
