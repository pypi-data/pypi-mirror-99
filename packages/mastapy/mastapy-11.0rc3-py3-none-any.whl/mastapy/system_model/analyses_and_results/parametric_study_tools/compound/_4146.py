...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4115
...
class CVTCompoundParametricStudyTool(_4115.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3999.CVTParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3999.CVTParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3999.CVTParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3999.CVTParametricStudyTool))
        return value
