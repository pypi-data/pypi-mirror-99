...
class ClutchHalfCompoundParametricStudyTool(_3702.CouplingHalfCompoundParametricStudyTool):
    '''ClutchHalfCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3546.ClutchHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3546.ClutchHalfParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3546.ClutchHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3546.ClutchHalfParametricStudyTool))
        return value
