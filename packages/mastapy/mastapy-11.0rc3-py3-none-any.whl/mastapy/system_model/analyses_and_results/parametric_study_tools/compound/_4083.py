...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4088
...
class BevelDifferentialGearCompoundParametricStudyTool(_4088.BevelGearCompoundParametricStudyTool):
    '''BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3937.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3937.BevelDifferentialGearParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3937.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3937.BevelDifferentialGearParametricStudyTool))
        return value
