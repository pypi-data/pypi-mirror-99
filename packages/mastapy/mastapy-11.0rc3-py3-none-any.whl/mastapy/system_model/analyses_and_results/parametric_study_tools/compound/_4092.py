...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3944
...
class BoltedJointCompoundParametricStudyTool(_4170.SpecialisedAssemblyCompoundParametricStudyTool):
    '''BoltedJointCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3944.BoltedJointParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3944.BoltedJointParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3944.BoltedJointParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3944.BoltedJointParametricStudyTool))
        return value
