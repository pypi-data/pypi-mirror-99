...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4083, _4084, _4090
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3938
...
class BevelDifferentialGearSetCompoundParametricStudyTool(_4090.BevelGearSetCompoundParametricStudyTool):
    '''BevelDifferentialGearSetCompoundParametricStudyTool
    ...
    @property
    def bevel_differential_gears_compound_parametric_study_tool(self) -> 'List[_4083.BevelDifferentialGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsCompoundParametricStudyTool, constructor.new(_4083.BevelDifferentialGearCompoundParametricStudyTool))
        return value

    @property
    def bevel_differential_meshes_compound_parametric_study_tool(self) -> 'List[_4084.BevelDifferentialGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesCompoundParametricStudyTool, constructor.new(_4084.BevelDifferentialGearMeshCompoundParametricStudyTool))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3938.BevelDifferentialGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3938.BevelDifferentialGearSetParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3938.BevelDifferentialGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3938.BevelDifferentialGearSetParametricStudyTool))
        return value
