...
class PartToPartShearCouplingCompoundParametricStudyTool(_4142.CouplingCompoundParametricStudyTool):
    '''PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4058.PartToPartShearCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4058.PartToPartShearCouplingParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4058.PartToPartShearCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4058.PartToPartShearCouplingParametricStudyTool))
        return value
