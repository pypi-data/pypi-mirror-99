...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3627
...
class BevelGearCompoundParametricStudyTool(_3627.AGMAGleasonConicalGearCompoundParametricStudyTool):
    '''BevelGearCompoundParametricStudyTool
