...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4148
...
class AbstractAssemblyCompoundParametricStudyTool(_4148.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
