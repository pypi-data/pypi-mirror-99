...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3951
...
class ConceptCouplingConnectionCompoundParametricStudyTool(_4110.CouplingConnectionCompoundParametricStudyTool):
    '''ConceptCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3951.ConceptCouplingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3951.ConceptCouplingConnectionParametricStudyTool))
        return value

    @property
    def connection_parametric_study_tool_load_cases(self) -> 'List[_3951.ConceptCouplingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionParametricStudyToolLoadCases, constructor.new(_3951.ConceptCouplingConnectionParametricStudyTool))
        return value
