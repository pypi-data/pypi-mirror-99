...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3694
...
class AbstractAssemblyCompoundParametricStudyTool(_3694.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
