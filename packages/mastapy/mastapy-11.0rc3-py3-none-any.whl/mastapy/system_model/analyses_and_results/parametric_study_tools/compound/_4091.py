...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3945
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4097
...
class BoltCompoundParametricStudyTool(_4097.ComponentCompoundParametricStudyTool):
    '''BoltCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3945.BoltParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3945.BoltParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3945.BoltParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3945.BoltParametricStudyTool))
        return value
