...
class ConceptCouplingCompoundParametricStudyTool(_3700.CouplingCompoundParametricStudyTool):
    '''ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3552.ConceptCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3552.ConceptCouplingParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3552.ConceptCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3552.ConceptCouplingParametricStudyTool))
        return value
