...
class ConnectionParametricStudyTool(_7177.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4050.ParametricStudyTool':
        ...
        return constructor.new(_4050.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
