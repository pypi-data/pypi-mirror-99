...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4019, _4018, _4025
...
class FaceGearSetParametricStudyTool(_4025.GearSetParametricStudyTool):
    '''FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4019.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsParametricStudyTool, constructor.new(_4019.FaceGearParametricStudyTool))
        return value

    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4018.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesParametricStudyTool, constructor.new(_4018.FaceGearMeshParametricStudyTool))
        return value
