...
from mastapy.system_model.analyses_and_results import _2203
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_6531.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1814.DesignEntity') -> '_2203.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2203.DesignEntityAnalysis') -> '_2203.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
