...
from mastapy.system_model.analyses_and_results.load_case_groups import _5312
...
class AbstractDesignStateLoadCaseGroup(_5312.AbstractStaticLoadCaseGroup):
    '''AbstractDesignStateLoadCaseGroup
    ...
    @property
    def two_d_drawing_showing_power_flow(self) -> '_7192.SMTBitmap':
        ...
        return constructor.new(_7192.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
