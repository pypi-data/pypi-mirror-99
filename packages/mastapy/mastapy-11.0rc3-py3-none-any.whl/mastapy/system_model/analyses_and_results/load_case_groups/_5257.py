...
from mastapy.system_model.analyses_and_results.load_case_groups import _5259
...
class AbstractDesignStateLoadCaseGroup(_5259.AbstractStaticLoadCaseGroup):
    '''AbstractDesignStateLoadCaseGroup
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
