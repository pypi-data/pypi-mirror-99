...
TReal = TypeVar('TReal', bound='_2004.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6091.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5268.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
