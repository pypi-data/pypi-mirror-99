...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5331
...
TConnection = TypeVar('TConnection', bound='_1952.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6484.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5331.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
