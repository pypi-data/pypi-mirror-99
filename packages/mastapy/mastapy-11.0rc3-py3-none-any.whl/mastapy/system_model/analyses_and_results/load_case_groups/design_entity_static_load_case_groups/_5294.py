...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5295
...
TConnection = TypeVar('TConnection', bound='_1876.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6133.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5295.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
