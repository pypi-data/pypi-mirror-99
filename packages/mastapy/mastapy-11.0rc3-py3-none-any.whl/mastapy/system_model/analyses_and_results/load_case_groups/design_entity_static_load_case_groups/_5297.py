...
TConnection = TypeVar('TConnection', bound='_1926.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6447.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5298.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
