...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5268
...
TAssembly = TypeVar('TAssembly', bound='_1996.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6066.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5268.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
