...
TReal = TypeVar('TReal', bound='_2046.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6141.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5317.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
