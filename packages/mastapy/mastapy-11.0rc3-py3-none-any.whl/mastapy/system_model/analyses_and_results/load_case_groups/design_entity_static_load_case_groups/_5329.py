...
TReal = TypeVar('TReal', bound='_2122.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6472.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5333.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
