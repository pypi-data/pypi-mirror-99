...
TReal = TypeVar('TReal', bound='_2009.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6100.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5276.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
