...
from mastapy.system_model.part_model import _2084
...
TAssembly = TypeVar('TAssembly', bound='_2084.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6405.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5300.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
