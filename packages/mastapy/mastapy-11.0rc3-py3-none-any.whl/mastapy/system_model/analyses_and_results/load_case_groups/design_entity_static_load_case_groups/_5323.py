...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5328
...
TAssembly = TypeVar('TAssembly', bound='_2108.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6437.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5328.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
