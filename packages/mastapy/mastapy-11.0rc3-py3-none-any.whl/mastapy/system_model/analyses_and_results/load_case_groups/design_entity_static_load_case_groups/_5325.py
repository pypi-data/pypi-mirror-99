...
TReal = TypeVar('TReal', bound='_2118.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6468.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5329.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
