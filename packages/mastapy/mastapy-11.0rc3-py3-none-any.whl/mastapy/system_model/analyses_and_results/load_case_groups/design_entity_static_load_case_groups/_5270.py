...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5275
...
TAssembly = TypeVar('TAssembly', bound='_2003.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6073.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5275.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
