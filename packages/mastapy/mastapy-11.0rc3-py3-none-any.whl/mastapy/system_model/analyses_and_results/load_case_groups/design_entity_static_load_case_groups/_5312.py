...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5317
...
TAssembly = TypeVar('TAssembly', bound='_2038.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6116.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5317.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
