...
TReal = TypeVar('TReal', bound='_2008.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6095.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5272.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
