...
TConnection = TypeVar('TConnection', bound='_1855.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6112.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5274.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
