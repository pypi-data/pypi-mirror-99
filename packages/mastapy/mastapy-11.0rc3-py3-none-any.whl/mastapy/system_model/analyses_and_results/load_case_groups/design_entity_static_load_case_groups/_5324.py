...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5329
from mastapy.system_model.part_model import _2109
...
TAssembly = TypeVar('TAssembly', bound='_2109.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6438.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5329.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
