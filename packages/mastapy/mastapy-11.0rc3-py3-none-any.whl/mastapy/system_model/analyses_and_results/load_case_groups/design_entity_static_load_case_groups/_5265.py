...
TConnection = TypeVar('TConnection', bound='_1851.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6103.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5266.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
