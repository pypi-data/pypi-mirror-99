...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5276
...
TAssembly = TypeVar('TAssembly', bound='_2001.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6075.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5276.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
