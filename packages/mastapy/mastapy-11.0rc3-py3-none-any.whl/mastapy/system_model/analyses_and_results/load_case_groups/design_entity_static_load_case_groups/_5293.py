...
TReal = TypeVar('TReal', bound='_2030.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6121.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5297.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
