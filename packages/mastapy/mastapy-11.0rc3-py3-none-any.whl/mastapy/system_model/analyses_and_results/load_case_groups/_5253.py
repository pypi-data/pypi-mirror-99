...
class AbstractDesignStateLoadCaseGroup(_5255.AbstractStaticLoadCaseGroup):
    '''AbstractDesignStateLoadCaseGroup
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
