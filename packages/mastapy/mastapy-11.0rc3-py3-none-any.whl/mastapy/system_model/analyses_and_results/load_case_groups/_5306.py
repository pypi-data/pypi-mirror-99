...
from mastapy.system_model.analyses_and_results.static_loads import _6268
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups import _5299
...
class GroupOfTimeSeriesLoadCases(_5299.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_6268.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6268.TimeSeriesLoadCase))
        return value
