...
class GroupOfTimeSeriesLoadCases(_5258.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_6227.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6227.TimeSeriesLoadCase))
        return value
