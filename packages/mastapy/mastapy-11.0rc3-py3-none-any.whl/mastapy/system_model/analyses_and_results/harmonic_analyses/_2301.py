...
from mastapy.system_model.analyses_and_results.analysis_cases import _7166
...
class HarmonicAnalysis(_7166.CompoundAnalysisCase):
    '''HarmonicAnalysis
    ...
    @property
    def harmonic_analyses_of_single_excitations(self) -> 'List[_5391.HarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicAnalysesOfSingleExcitations, constructor.new(_5391.HarmonicAnalysisOfSingleExcitation))
        return value
