...
class ConceptCouplingConnectionHarmonicAnalysis(_5599.CouplingConnectionHarmonicAnalysis):
    '''ConceptCouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2352.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2352.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
