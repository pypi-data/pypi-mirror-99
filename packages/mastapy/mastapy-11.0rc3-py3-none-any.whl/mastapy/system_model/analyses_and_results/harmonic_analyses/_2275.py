...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2274
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2274.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
