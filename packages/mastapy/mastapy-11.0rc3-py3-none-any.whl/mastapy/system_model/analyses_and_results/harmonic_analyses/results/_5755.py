...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5754
...
class ExcitationSourceSelectionGroup(_5754.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5754.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5754.ExcitationSourceSelectionBase))
        return value
