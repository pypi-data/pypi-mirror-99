...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5585
...
class CoaxialConnectionCompoundHarmonicAnalysis(_5838.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5585.CoaxialConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5585.CoaxialConnectionHarmonicAnalysis))
        return value

    @property
    def connection_harmonic_analysis_load_cases(self) -> 'List[_5585.CoaxialConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionHarmonicAnalysisLoadCases, constructor.new(_5585.CoaxialConnectionHarmonicAnalysis))
        return value
