...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5591
...
class ConceptGearCompoundHarmonicAnalysis(_5799.GearCompoundHarmonicAnalysis):
    '''ConceptGearCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5591.ConceptGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5591.ConceptGearHarmonicAnalysis))
        return value

    @property
    def component_harmonic_analysis_load_cases(self) -> 'List[_5591.ConceptGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentHarmonicAnalysisLoadCases, constructor.new(_5591.ConceptGearHarmonicAnalysis))
        return value
