...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5740
...
class AbstractShaftCompoundHarmonicAnalysis(_5740.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    '''AbstractShaftCompoundHarmonicAnalysis
