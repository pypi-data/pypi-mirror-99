...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6495, _6445, _6462, _6471,
    _6472, _6473, _6474, _6491,
    _6533, _6549, _6578
)
...
class AbstractPeriodicExcitationDetail(_0.APIBase):
    ...
    @property
    def harmonic_load_data(self) -> '_6495.HarmonicLoadDataBase':
        ...
        if _6495.HarmonicLoadDataBase.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_conical_gear_set_harmonic_load_data(self) -> '_6445.ConicalGearSetHarmonicLoadData':
        ...
        if _6445.ConicalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_cylindrical_gear_set_harmonic_load_data(self) -> '_6462.CylindricalGearSetHarmonicLoadData':
        ...
        if _6462.CylindricalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data(self) -> '_6471.ElectricMachineHarmonicLoadData':
        ...
        if _6471.ElectricMachineHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_excel(self) -> '_6472.ElectricMachineHarmonicLoadDataFromExcel':
        ...
        if _6472.ElectricMachineHarmonicLoadDataFromExcel.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_jmag(self) -> '_6473.ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        if _6473.ElectricMachineHarmonicLoadDataFromJMAG.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_motor_cad(self) -> '_6474.ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        if _6474.ElectricMachineHarmonicLoadDataFromMotorCAD.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_gear_set_harmonic_load_data(self) -> '_6491.GearSetHarmonicLoadData':
        ...
        if _6491.GearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_point_load_harmonic_load_data(self) -> '_6533.PointLoadHarmonicLoadData':
        ...
        if _6533.PointLoadHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_speed_dependent_harmonic_load_data(self) -> '_6549.SpeedDependentHarmonicLoadData':
        ...
        if _6549.SpeedDependentHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_unbalanced_mass_harmonic_load_data(self) -> '_6578.UnbalancedMassHarmonicLoadData':
        ...
        if _6578.UnbalancedMassHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
