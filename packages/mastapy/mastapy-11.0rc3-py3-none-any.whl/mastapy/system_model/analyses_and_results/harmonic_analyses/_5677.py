...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5755
from mastapy.system_model.analyses_and_results.modal_analyses import _4832
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5719, _5665
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5755.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5755.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4832.ModalAnalysisOptions':
        ...
        return constructor.new(_4832.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
