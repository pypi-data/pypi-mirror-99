...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6143
...
class AbstractShaftCriticalSpeedAnalysis(_6143.AbstractShaftOrHousingCriticalSpeedAnalysis):
    '''AbstractShaftCriticalSpeedAnalysis
