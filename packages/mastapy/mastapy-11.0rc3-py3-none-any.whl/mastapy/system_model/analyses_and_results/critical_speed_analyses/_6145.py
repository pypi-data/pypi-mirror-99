...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6146
...
class AbstractShaftCriticalSpeedAnalysis(_6146.AbstractShaftOrHousingCriticalSpeedAnalysis):
    '''AbstractShaftCriticalSpeedAnalysis
