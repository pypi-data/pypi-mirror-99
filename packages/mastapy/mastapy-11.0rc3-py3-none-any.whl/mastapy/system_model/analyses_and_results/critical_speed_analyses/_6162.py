...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6150
...
class BevelGearSetCriticalSpeedAnalysis(_6150.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    '''BevelGearSetCriticalSpeedAnalysis
