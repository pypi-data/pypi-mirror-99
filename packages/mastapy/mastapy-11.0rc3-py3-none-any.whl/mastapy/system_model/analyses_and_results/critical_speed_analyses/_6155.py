...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6160
...
class BevelDifferentialGearCriticalSpeedAnalysis(_6160.BevelGearCriticalSpeedAnalysis):
    '''BevelDifferentialGearCriticalSpeedAnalysis
