...
class CriticalSpeedAnalysis(_7144.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_options(self) -> '_6182.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6182.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions else None
