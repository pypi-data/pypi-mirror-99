...
class StabilityAnalysis(_7144.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def stability_analysis_options(self) -> '_3501.StabilityAnalysisOptions':
        ...
        return constructor.new(_3501.StabilityAnalysisOptions)(self.wrapped.StabilityAnalysisOptions) if self.wrapped.StabilityAnalysisOptions else None
