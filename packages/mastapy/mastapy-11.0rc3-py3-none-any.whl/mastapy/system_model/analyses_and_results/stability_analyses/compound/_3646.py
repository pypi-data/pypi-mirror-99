...
class PlanetCarrierCompoundStabilityAnalysis(_3638.MountableComponentCompoundStabilityAnalysis):
    '''PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3515.PlanetCarrierStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3515.PlanetCarrierStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3515.PlanetCarrierStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3515.PlanetCarrierStabilityAnalysis))
        return value
