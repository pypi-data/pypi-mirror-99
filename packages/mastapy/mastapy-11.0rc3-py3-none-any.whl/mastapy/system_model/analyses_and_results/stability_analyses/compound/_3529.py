...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3530
...
class AbstractShaftCompoundStabilityAnalysis(_3530.AbstractShaftOrHousingCompoundStabilityAnalysis):
    '''AbstractShaftCompoundStabilityAnalysis
