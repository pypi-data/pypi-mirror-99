...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3528
...
class AbstractShaftCompoundStabilityAnalysis(_3528.AbstractShaftOrHousingCompoundStabilityAnalysis):
    '''AbstractShaftCompoundStabilityAnalysis
