...
class BevelDifferentialGearMeshCompoundSingleMeshWhineAnalysis(_5596.BevelGearMeshCompoundSingleMeshWhineAnalysis):
    '''BevelDifferentialGearMeshCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5467.BevelDifferentialGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5467.BevelDifferentialGearMeshSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5467.BevelDifferentialGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5467.BevelDifferentialGearMeshSingleMeshWhineAnalysis))
        return value
