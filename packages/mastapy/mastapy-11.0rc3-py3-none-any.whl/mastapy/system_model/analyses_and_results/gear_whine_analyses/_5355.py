...
class CouplingConnectionGearWhineAnalysis(_5400.InterMountableComponentConnectionGearWhineAnalysis):
    '''CouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2306.CouplingConnectionSystemDeflection':
