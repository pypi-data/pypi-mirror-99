...
class TorqueConverterConnectionGearWhineAnalysis(_5355.CouplingConnectionGearWhineAnalysis):
    '''TorqueConverterConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2395.TorqueConverterConnectionSystemDeflection':
        ...
        return constructor.new(_2395.TorqueConverterConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
