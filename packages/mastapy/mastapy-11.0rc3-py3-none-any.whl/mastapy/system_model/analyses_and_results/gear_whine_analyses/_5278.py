...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6155, _6110, _6123, _6132,
    _6133, _6134, _6135, _6151,
    _6193, _6206, _6235
)
...
class AbstractPeriodicExcitationDetail(_0.APIBase):
    ...
    @property
    def harmonic_load_data(self) -> '_6155.HarmonicLoadDataBase':
        ...
        if _6155.HarmonicLoadDataBase.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_conical_gear_set_harmonic_load_data(self) -> '_6110.ConicalGearSetHarmonicLoadData':
        ...
        if _6110.ConicalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_cylindrical_gear_set_harmonic_load_data(self) -> '_6123.CylindricalGearSetHarmonicLoadData':
        ...
        if _6123.CylindricalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data(self) -> '_6132.ElectricMachineHarmonicLoadData':
        ...
        if _6132.ElectricMachineHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_excel(self) -> '_6133.ElectricMachineHarmonicLoadDataFromExcel':
        ...
        if _6133.ElectricMachineHarmonicLoadDataFromExcel.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_jmag(self) -> '_6134.ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        if _6134.ElectricMachineHarmonicLoadDataFromJMAG.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_motor_cad(self) -> '_6135.ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        if _6135.ElectricMachineHarmonicLoadDataFromMotorCAD.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_gear_set_harmonic_load_data(self) -> '_6151.GearSetHarmonicLoadData':
        ...
        if _6151.GearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_point_load_harmonic_load_data(self) -> '_6193.PointLoadHarmonicLoadData':
        ...
        if _6193.PointLoadHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_speed_dependent_harmonic_load_data(self) -> '_6206.SpeedDependentHarmonicLoadData':
        ...
        if _6206.SpeedDependentHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_unbalanced_mass_harmonic_load_data(self) -> '_6235.UnbalancedMassHarmonicLoadData':
        ...
        if _6235.UnbalancedMassHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
