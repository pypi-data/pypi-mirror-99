...
class GearWhineAnalysisResultsBrokenDownByComponentWithinAHarmonic(_5706.GearWhineAnalysisResultsBrokenDownByLocationWithinAHarmonic):
    '''GearWhineAnalysisResultsBrokenDownByComponentWithinAHarmonic
    ...
    @property
    def kinetic_energy(self) -> '_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
        ...
        return constructor.new(_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic)(self.wrapped.KineticEnergy) if self.wrapped.KineticEnergy else None

    @property
    def strain_energy(self) -> '_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
        ...
        return constructor.new(_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic)(self.wrapped.StrainEnergy) if self.wrapped.StrainEnergy else None

    @property
    def dynamic_mesh_force(self) -> '_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
        ...
        return constructor.new(_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic)(self.wrapped.DynamicMeshForce) if self.wrapped.DynamicMeshForce else None

    @property
    def dynamic_mesh_moment(self) -> '_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
        ...
        return constructor.new(_5711.ResultsForResponseOfAComponentOrSurfaceInAHarmonic)(self.wrapped.DynamicMeshMoment) if self.wrapped.DynamicMeshMoment else None
