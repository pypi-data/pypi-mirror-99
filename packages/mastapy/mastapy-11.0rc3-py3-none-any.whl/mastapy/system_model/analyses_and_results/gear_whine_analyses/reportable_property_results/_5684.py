...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5685
...
class GearWhineAnalysisResultsBrokenDownByGroupsWithinAHarmonic(_0.APIBase):
    ...
    @property
    def locations_global_coordinate_system(self) -> 'List[_5685.GearWhineAnalysisResultsBrokenDownByLocationWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocationsGlobalCoordinateSystem, constructor.new(_5685.GearWhineAnalysisResultsBrokenDownByLocationWithinAHarmonic))
        return value

    @property
    def locations_local_coordinate_system(self) -> 'List[_5685.GearWhineAnalysisResultsBrokenDownByLocationWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocationsLocalCoordinateSystem, constructor.new(_5685.GearWhineAnalysisResultsBrokenDownByLocationWithinAHarmonic))
        return value
