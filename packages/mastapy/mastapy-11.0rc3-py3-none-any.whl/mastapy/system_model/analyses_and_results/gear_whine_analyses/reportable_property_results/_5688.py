...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5693, _5689
...
class GearWhineAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_5693.SingleWhineAnalysisResultsPropertyAccessor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_5693.SingleWhineAnalysisResultsPropertyAccessor))
        return value

    @property
    def orders_for_combined_excitations(self) -> 'List[_5689.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OrdersForCombinedExcitations, constructor.new(_5689.ResultsForOrder))
        return value
