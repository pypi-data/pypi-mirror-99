...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5710
...
class SingleWhineAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def orders(self) -> 'List[_5710.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5710.ResultsForOrder))
        return value
