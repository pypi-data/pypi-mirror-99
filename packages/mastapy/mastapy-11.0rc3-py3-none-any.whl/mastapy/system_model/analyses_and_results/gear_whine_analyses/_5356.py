...
class CouplingGearWhineAnalysis(_5433.SpecialisedAssemblyGearWhineAnalysis):
    '''CouplingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2308.CouplingSystemDeflection':
