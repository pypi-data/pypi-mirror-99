...
from mastapy.system_model.analyses_and_results.power_flows import _3392
...
class GearMeshGearWhineAnalysis(_5400.InterMountableComponentConnectionGearWhineAnalysis):
    '''GearMeshGearWhineAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3392.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3392.ToothPassingHarmonic))
        return value

    @property
    def system_deflection_results(self) -> '_2329.GearMeshSystemDeflection':
