...
from mastapy.system_model.analyses_and_results.system_deflections import _2238, _2272
...
class BeltDriveGearWhineAnalysis(_5392.SpecialisedAssemblyGearWhineAnalysis):
    '''BeltDriveGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2238.BeltDriveSystemDeflection':
