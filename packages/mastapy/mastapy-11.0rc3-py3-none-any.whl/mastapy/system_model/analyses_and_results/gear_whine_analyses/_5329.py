...
class BevelDifferentialGearMeshGearWhineAnalysis(_5334.BevelGearMeshGearWhineAnalysis):
    '''BevelDifferentialGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2278.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2278.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
