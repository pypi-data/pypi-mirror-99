...
class BevelGearSetGearWhineAnalysis(_5282.AGMAGleasonConicalGearSetGearWhineAnalysis):
    '''BevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2245.BevelGearSetSystemDeflection':
