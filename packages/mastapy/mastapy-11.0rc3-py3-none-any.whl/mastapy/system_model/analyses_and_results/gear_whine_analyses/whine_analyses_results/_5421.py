...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5431
...
class ComponentSelection(_5431.ResultNodeSelection):
    '''ComponentSelection
