...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5455
...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    @property
    def selected_result_location_group(self) -> '_5455.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5455.ResultLocationSelectionGroup)(self.wrapped.SelectedResultLocationGroup) if self.wrapped.SelectedResultLocationGroup else None

    @property
    def result_location_groups(self) -> 'List[_5455.ResultLocationSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultLocationGroups, constructor.new(_5455.ResultLocationSelectionGroup))
        return value
