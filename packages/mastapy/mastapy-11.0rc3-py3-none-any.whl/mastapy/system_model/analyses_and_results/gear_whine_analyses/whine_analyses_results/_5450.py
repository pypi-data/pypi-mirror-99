...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5449
...
class ExcitationSourceSelectionGroup(_5449.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5449.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5449.ExcitationSourceSelectionBase))
        return value
