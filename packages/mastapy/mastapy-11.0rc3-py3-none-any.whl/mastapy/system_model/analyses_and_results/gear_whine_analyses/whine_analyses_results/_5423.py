...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5427, _5424
...
class ExcitationSourceSelection(_5424.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5427.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5427.HarmonicSelection))
        return value
