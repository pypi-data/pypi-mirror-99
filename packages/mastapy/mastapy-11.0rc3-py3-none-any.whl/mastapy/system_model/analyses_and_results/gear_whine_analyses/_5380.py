...
class FaceGearMeshGearWhineAnalysis(_5386.GearMeshGearWhineAnalysis):
    '''FaceGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2325.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2325.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
