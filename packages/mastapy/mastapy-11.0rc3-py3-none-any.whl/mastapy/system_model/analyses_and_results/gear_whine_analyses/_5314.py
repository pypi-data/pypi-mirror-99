...
class BevelGearMeshGearWhineAnalysis(_5302.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''BevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2265.BevelGearMeshSystemDeflection':
