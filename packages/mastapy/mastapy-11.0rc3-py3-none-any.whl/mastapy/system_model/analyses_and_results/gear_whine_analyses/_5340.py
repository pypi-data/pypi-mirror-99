...
class ClutchHalfGearWhineAnalysis(_5357.CouplingHalfGearWhineAnalysis):
    '''ClutchHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2289.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2289.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
