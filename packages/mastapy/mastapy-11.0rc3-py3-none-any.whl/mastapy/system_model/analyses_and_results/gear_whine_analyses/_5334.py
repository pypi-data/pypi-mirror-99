...
class BevelGearMeshGearWhineAnalysis(_5322.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''BevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2283.BevelGearMeshSystemDeflection':
