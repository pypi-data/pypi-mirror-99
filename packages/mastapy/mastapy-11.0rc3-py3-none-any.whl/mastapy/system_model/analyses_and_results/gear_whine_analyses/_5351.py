...
class ConicalGearMeshGearWhineAnalysis(_5386.GearMeshGearWhineAnalysis):
    '''ConicalGearMeshGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1924.ConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2301.ConicalGearMeshSystemDeflection':
