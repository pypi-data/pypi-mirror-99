...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5450
...
class SynchroniserHalfCompoundGearWhineAnalysis(_5842.SynchroniserPartCompoundGearWhineAnalysis):
    '''SynchroniserHalfCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5450.SynchroniserHalfGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5450.SynchroniserHalfGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5450.SynchroniserHalfGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5450.SynchroniserHalfGearWhineAnalysis))
        return value
