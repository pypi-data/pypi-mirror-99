...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5762
...
class AbstractAssemblyCompoundGearWhineAnalysis(_5762.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
