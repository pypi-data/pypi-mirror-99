...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5697
...
class BevelGearMeshCompoundGearWhineAnalysis(_5697.AGMAGleasonConicalGearMeshCompoundGearWhineAnalysis):
    '''BevelGearMeshCompoundGearWhineAnalysis
