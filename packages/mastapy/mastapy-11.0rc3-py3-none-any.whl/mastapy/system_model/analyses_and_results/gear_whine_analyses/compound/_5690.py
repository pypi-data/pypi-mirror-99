...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5712
...
class AbstractShaftOrHousingCompoundGearWhineAnalysis(_5712.ComponentCompoundGearWhineAnalysis):
    '''AbstractShaftOrHousingCompoundGearWhineAnalysis
