...
class BevelDifferentialSunGearGearWhineAnalysis(_5308.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2264.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2264.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
