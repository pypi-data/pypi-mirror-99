...
class VirtualComponentGearWhineAnalysis(_5412.MountableComponentGearWhineAnalysis):
    '''VirtualComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2402.VirtualComponentSystemDeflection':
