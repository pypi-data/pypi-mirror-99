...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6196, _6151, _6164, _6173,
    _6174, _6175, _6176, _6192,
    _6234, _6247, _6276
)
...
class AbstractPeriodicExcitationDetail(_0.APIBase):
    ...
    @property
    def harmonic_load_data(self) -> '_6196.HarmonicLoadDataBase':
        ...
        if _6196.HarmonicLoadDataBase.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_conical_gear_set_harmonic_load_data(self) -> '_6151.ConicalGearSetHarmonicLoadData':
        ...
        if _6151.ConicalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_cylindrical_gear_set_harmonic_load_data(self) -> '_6164.CylindricalGearSetHarmonicLoadData':
        ...
        if _6164.CylindricalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data(self) -> '_6173.ElectricMachineHarmonicLoadData':
        ...
        if _6173.ElectricMachineHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_excel(self) -> '_6174.ElectricMachineHarmonicLoadDataFromExcel':
        ...
        if _6174.ElectricMachineHarmonicLoadDataFromExcel.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_jmag(self) -> '_6175.ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        if _6175.ElectricMachineHarmonicLoadDataFromJMAG.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_motor_cad(self) -> '_6176.ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        if _6176.ElectricMachineHarmonicLoadDataFromMotorCAD.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_gear_set_harmonic_load_data(self) -> '_6192.GearSetHarmonicLoadData':
        ...
        if _6192.GearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_point_load_harmonic_load_data(self) -> '_6234.PointLoadHarmonicLoadData':
        ...
        if _6234.PointLoadHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_speed_dependent_harmonic_load_data(self) -> '_6247.SpeedDependentHarmonicLoadData':
        ...
        if _6247.SpeedDependentHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_unbalanced_mass_harmonic_load_data(self) -> '_6276.UnbalancedMassHarmonicLoadData':
        ...
        if _6276.UnbalancedMassHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
