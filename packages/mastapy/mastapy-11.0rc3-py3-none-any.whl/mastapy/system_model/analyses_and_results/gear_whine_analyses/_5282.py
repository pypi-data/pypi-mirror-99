...
class AGMAGleasonConicalGearSetGearWhineAnalysis(_5311.ConicalGearSetGearWhineAnalysis):
    '''AGMAGleasonConicalGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2233.AGMAGleasonConicalGearSetSystemDeflection':
