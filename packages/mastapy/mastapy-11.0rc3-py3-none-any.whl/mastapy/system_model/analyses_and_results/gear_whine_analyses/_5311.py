...
class BevelDifferentialPlanetGearGearWhineAnalysis(_5308.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2263.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2263.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
