...
class RollingRingConnectionGearWhineAnalysis(_5400.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2365.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2365.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
