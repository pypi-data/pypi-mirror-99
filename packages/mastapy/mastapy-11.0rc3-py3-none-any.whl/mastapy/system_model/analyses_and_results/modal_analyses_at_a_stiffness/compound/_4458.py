...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4371
...
class RootAssemblyCompoundModalAnalysisAtAStiffness(_4371.AssemblyCompoundModalAnalysisAtAStiffness):
    '''RootAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4329.RootAssemblyModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4329.RootAssemblyModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4329.RootAssemblyModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4329.RootAssemblyModalAnalysisAtAStiffness))
        return value
