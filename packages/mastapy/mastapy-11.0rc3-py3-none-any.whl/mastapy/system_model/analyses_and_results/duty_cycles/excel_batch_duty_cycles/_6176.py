...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6180, _6177, _6179
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6180.MASTAFileDetails':
        ...
        return constructor.new(_6180.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6177.ExcelFileDetails':
        ...
        return constructor.new(_6177.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None

    @property
    def working_folder(self) -> '_1354.SelectableFolder':
        ...
        return constructor.new(_1354.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6179.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6179.ExcelSheetDesignStateSelector))
        return value
