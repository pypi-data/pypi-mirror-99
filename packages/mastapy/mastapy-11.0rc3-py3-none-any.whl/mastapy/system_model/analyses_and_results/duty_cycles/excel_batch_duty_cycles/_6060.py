...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6064, _6061, _6063
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6064.MASTAFileDetails':
        ...
        return constructor.new(_6064.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6061.ExcelFileDetails':
        ...
        return constructor.new(_6061.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6063.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6063.ExcelSheetDesignStateSelector))
        return value
