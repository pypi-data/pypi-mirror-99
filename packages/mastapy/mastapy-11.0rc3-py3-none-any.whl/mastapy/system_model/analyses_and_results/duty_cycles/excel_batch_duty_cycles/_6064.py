...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6068, _6065, _6067
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6068.MASTAFileDetails':
        ...
        return constructor.new(_6068.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6065.ExcelFileDetails':
        ...
        return constructor.new(_6065.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None

    @property
    def working_folder(self) -> '_1149.SelectableFolder':
        ...
        return constructor.new(_1149.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6067.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6067.ExcelSheetDesignStateSelector))
        return value
