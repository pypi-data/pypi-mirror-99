...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6110
...
class ExcelBatchDutyCycleCreator(_0.APIBase):
    ...
    @property
    def batch_details(self) -> '_6110.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_6110.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
