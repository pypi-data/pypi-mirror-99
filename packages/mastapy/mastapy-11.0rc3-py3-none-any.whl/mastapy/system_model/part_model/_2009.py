...
from mastapy.math_utility import _1066, _1067
from mastapy.system_model.connections_and_sockets import (
    _1853, _1870, _1855, _1876
)
from mastapy.system_model.part_model import _2010, _2031
...
class Component(_2031.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1066.CoordinateSystem3D':
        ...
        return constructor.new(_1066.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1066.CoordinateSystem3D') -> '_1870.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1067.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1855.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1855.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_1876.Socket') -> 'List[_1876.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_1876.Socket))

    def connect_to_socket(self, socket: '_1876.Socket') -> '_2010.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_1876.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_1876.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2010.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2010.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1855.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_1876.Socket':
