...
class FlexiblePinAssembly(_2076.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2123.CylindricalGear':
        ...
        if _2123.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
