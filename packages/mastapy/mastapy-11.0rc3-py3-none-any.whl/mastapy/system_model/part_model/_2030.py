...
from mastapy.math_utility import _1073, _1074
from mastapy.system_model.connections_and_sockets import (
    _1874, _1891, _1876, _1897
)
from mastapy.system_model.part_model import _2031, _2052
...
class Component(_2052.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1073.CoordinateSystem3D':
        ...
        return constructor.new(_1073.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1874.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1874.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1073.CoordinateSystem3D') -> '_1891.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1891.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1074.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1876.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1876.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_1897.Socket') -> 'List[_1897.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_1897.Socket))

    def connect_to_socket(self, socket: '_1897.Socket') -> '_2031.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_1897.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_1897.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2031.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2031.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1876.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_1897.Socket':
