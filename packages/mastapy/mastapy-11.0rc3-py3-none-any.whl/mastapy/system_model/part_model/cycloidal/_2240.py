...
from mastapy.system_model.part_model import _2134, _2110
...
class CycloidalDisc(_2110.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def load_sharing_settings(self) -> '_2134.LoadSharingSettings':
        ...
        return constructor.new(_2134.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings else None
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2015.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2015.CycloidalDiscPlanetaryBearingSocket))
        return value
