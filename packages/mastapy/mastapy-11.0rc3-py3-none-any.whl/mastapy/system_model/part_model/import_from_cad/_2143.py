...
from mastapy.system_model.part_model.import_from_cad import _2149, _2150
...
class ConnectorFromCAD(_2150.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2149.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2149.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2149.HousedOrMounted'):
