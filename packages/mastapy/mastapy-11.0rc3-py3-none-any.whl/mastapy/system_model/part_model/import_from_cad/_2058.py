...
from mastapy.system_model.part_model.import_from_cad import _2064, _2065
...
class ConnectorFromCAD(_2065.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2064.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2064.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2064.HousedOrMounted'):
