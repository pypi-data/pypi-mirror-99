...
class CylindricalGear(_2205.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_942.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_942.CylindricalGearDesign':
        ...
        if _942.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
