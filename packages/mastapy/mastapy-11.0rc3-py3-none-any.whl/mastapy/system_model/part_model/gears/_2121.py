...
class ConicalGear(_2128.Gear):
    ...
    @property
    def active_gear_design(self) -> '_890.ConicalGearDesign':
        ...
        if _890.ConicalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_bevel_gear_design(self) -> '_916.BevelGearDesign':
        ...
        if _916.BevelGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_929.AGMAGleasonConicalGearDesign':
        ...
        if _929.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design(self) -> '_890.ConicalGearDesign':
        ...
        if _890.ConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_bevel_gear_design(self) -> '_916.BevelGearDesign':
    ...
    @property
    def conical_gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_929.AGMAGleasonConicalGearDesign':
        ...
        if _929.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
