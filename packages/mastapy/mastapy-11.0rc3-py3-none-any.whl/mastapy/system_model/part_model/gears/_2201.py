...
from mastapy.gears import _283
from mastapy.gears.gear_designs.cylindrical import _956, _967
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2238
from mastapy.system_model.part_model.gears import _2200, _2207
...
class CylindricalGearSet(_2207.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_956.CylindricalGearSetDesign':
    ...
    @property
    def supercharger_rotor_set(self) -> '_2238.SuperchargerRotorSet':
        ...
        return constructor.new(_2238.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2200.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2200.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1989.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1989.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_956.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_956.CylindricalGearSetDesign))
        return value
