...
class ConicalGear(_2091.Gear):
    ...
    @property
    def active_gear_design(self) -> '_889.ConicalGearDesign':
    ...
    @property
    def conical_gear_design(self) -> '_889.ConicalGearDesign':
        ...
        if _889.ConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_737.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _737.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_741.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _741.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_745.KlingelnbergConicalGearDesign':
        ...
        if _745.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_hypoid_gear_design(self) -> '_749.HypoidGearDesign':
        ...
        if _749.HypoidGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_bevel_gear_design(self) -> '_915.BevelGearDesign':
    ...
    @property
    def conical_gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_928.AGMAGleasonConicalGearDesign':
        ...
        if _928.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
