...
from mastapy.gears import _288, _289
...
class GearSetConfiguration(_0.APIBase):
    ...
    def implementation_detail_results_for(self, analysis_case: '_6556.StaticLoadCase', gear_set_mode: '_289.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1134.GearSetGroupDutyCycle':
    ...
    def implementation_detail_results_for_group(self, analysis_case: '_5283.AbstractStaticLoadCaseGroup', gear_set_mode: '_289.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1134.GearSetGroupDutyCycle':
        ''' 'ImplementationDetailResultsFor' is the original name of this method.
    ...
    def perform_implementation_detail_analysis(self, static_load: '_6556.StaticLoadCase', gear_set_mode: '_289.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis_group(self, static_load_case_group: '_5283.AbstractStaticLoadCaseGroup', gear_set_mode: '_289.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
