...
class FaceGear(_2091.Gear):
    ...
    @property
    def active_gear_design(self) -> '_753.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_753.FaceGearDesign':
        ...
        if _753.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
