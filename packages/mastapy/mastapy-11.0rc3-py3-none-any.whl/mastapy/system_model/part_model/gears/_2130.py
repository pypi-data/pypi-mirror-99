...
class GearSet(_2076.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_715.GearSetDesign':
        ...
        if _715.GearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_724.WormGearSetDesign':
        ...
        if _724.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_760.FaceGearSetDesign':
        ...
        if _760.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_786.CylindricalGearSetDesign':
        ...
        if _786.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_795.CylindricalPlanetaryGearSetDesign':
        ...
        if _795.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_conical_gear_set_design(self) -> '_892.ConicalGearSetDesign':
        ...
        if _892.ConicalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_concept_gear_set_design(self) -> '_914.ConceptGearSetDesign':
        ...
        if _914.ConceptGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_bevel_gear_set_design(self) -> '_918.BevelGearSetDesign':
        ...
        if _918.BevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_agma_gleason_conical_gear_set_design(self) -> '_931.AGMAGleasonConicalGearSetDesign':
        ...
        if _931.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_designs(self) -> 'List[_715.GearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_715.GearSetDesign))
        return value

    def set_active_gear_set_design(self, gear_set_design: '_715.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_715.GearSetDesign'):
