...
from mastapy.system_model.part_model.gears import _2117, _2118
...
class BevelDifferentialGearSet(_2118.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_918.BevelGearSetDesign':
        ...
        if _918.BevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design(self) -> '_918.BevelGearSetDesign':
        ...
        if _918.BevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gears(self) -> 'List[_2117.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2117.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1920.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1920.BevelGearMesh))
        return value
