...
class CylindricalGear(_2176.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_941.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_941.CylindricalGearDesign':
        ...
        if _941.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
