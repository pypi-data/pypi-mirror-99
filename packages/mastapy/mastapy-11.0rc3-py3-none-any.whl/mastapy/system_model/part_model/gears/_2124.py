...
from mastapy.system_model.part_model.gears import _2123, _2130
...
class CylindricalGearSet(_2130.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2161.SuperchargerRotorSet':
        ...
        return constructor.new(_2161.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2123.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2123.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1926.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1926.CylindricalGearMesh))
        return value
