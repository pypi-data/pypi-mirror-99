...
from mastapy.system_model.part_model.gears import _2171, _2178
...
class CylindricalGearSet(_2178.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_955.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_955.CylindricalGearSetDesign':
        ...
        if _955.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSetDesign.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_set(self) -> '_2209.SuperchargerRotorSet':
        ...
        return constructor.new(_2209.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_1963.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1963.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_955.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_955.CylindricalGearSetDesign))
        return value
