...
class CylindricalGear(_2091.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_774.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_774.CylindricalGearDesign':
        ...
        if _774.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
