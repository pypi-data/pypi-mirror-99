...
class SuperchargerRotorSet(_1346.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2126.YVariableForImportedData':
        ...
        return constructor.new(_2126.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2126.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2119.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2119.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2121.RotorSpeedInputOptions':
        ...
        return constructor.new(_2121.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2116.BoostPressureInputOptions':
        ...
        return constructor.new(_2116.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2118.PressureRatioInputOptions':
        ...
        return constructor.new(_2118.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2117.InputPowerInputOptions':
        ...
        return constructor.new(_2117.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2120.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2120.RotorSetMeasuredPoint))
        return value
