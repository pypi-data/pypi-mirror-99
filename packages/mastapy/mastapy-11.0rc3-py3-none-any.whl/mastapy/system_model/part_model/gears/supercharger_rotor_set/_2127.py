...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2126
...
class SuperchargerRotorSetDatabase(_1348.NamedDatabase['_2126.SuperchargerRotorSet']):
    '''SuperchargerRotorSetDatabase
