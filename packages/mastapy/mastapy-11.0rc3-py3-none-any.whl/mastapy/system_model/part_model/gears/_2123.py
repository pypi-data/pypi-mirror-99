...
class CylindricalGear(_2128.Gear):
    '''CylindricalGear
    ...
    def active_gear_design(self) -> '_775.CylindricalGearDesign':
        ...
        if _775.CylindricalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    def cylindrical_gear_design(self) -> '_775.CylindricalGearDesign':
        ...
        if _775.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
