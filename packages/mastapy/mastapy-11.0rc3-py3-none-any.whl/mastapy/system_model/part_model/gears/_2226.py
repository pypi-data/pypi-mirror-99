...
class WormGear(_2205.Gear):
    ...
    @property
    def active_gear_design(self) -> '_887.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_887.WormGearDesign':
        ...
        if _887.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
