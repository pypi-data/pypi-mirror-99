...
class Shaft(_2004.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2021.GuideImage':
        ...
        return constructor.new(_2021.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2029.MountableComponent', offset: 'float'):
