...
class Shaft(_2109.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2128.GuideImage':
        ...
        return constructor.new(_2128.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2136.MountableComponent', offset: 'float'):
