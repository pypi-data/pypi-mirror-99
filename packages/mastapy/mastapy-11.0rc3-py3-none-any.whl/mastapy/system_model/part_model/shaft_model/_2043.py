...
class Shaft(_2001.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2018.GuideImage':
        ...
        return constructor.new(_2018.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2026.MountableComponent', offset: 'float'):
