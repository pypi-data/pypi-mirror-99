...
class Shaft(_2085.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2104.GuideImage':
        ...
        return constructor.new(_2104.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2112.MountableComponent', offset: 'float'):
