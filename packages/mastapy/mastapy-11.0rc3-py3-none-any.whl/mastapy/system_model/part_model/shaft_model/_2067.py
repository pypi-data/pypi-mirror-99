...
class Shaft(_2025.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2042.GuideImage':
        ...
        return constructor.new(_2042.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2050.MountableComponent', offset: 'float'):
