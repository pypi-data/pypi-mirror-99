...
class Shaft(_2039.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2056.GuideImage':
        ...
        return constructor.new(_2056.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None

    @property
    def active_definition(self) -> '_39.SimpleShaftDefinition':
        ...
        return constructor.new(_39.SimpleShaftDefinition)(self.wrapped.ActiveDefinition) if self.wrapped.ActiveDefinition else None
    ...
    def mount_component(self, component: '_2064.MountableComponent', offset: 'float'):
