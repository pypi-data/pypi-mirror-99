...
class Shaft(_2083.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2102.GuideImage':
        ...
        return constructor.new(_2102.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2110.MountableComponent', offset: 'float'):
