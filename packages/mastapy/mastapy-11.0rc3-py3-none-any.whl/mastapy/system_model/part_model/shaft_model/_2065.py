...
class Shaft(_2023.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2040.GuideImage':
        ...
        return constructor.new(_2040.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2048.MountableComponent', offset: 'float'):
