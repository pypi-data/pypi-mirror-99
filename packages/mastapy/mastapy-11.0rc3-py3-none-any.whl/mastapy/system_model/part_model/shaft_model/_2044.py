...
class Shaft(_2002.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2019.GuideImage':
        ...
        return constructor.new(_2019.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2027.MountableComponent', offset: 'float'):
