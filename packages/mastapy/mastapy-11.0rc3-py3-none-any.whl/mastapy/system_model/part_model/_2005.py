...
from mastapy.bearings.tolerances import (
    _1543, _1544, _1546, _1556,
    _1552, _1559, _1547, _1560,
    _1553, _1562
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_results import _1594, _1595
from mastapy.bearings import (
    _1521, _1528, _1517, _1513
)
...
class Bearing(_2012.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1544.BearingToleranceDefinitionOptions':
    ...
    def bearing_tolerance_definition(self, value: '_1544.BearingToleranceDefinitionOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingToleranceDefinition = value

    @property
    def orientation(self) -> '_1594.Orientations':
        '''Orientations: 'Orientation' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Orientation)
        return constructor.new(_1594.Orientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_1594.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def journal_bearing_type(self) -> '_1528.JournalBearingType':
        ...
        return constructor.new(_1528.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1528.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1517.BearingDampingMatrixOption':
        ...
        return constructor.new(_1517.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1517.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ring_tolerance_inner(self) -> '_1546.InnerRingTolerance':
        ...
        return constructor.new(_1546.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1556.RingTolerance':
        ...
        if _1556.RingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1546.InnerRingTolerance':
        ...
        if _1546.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1552.OuterRingTolerance':
        ...
        if _1552.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1552.OuterRingTolerance':
        ...
        return constructor.new(_1552.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1556.RingTolerance':
        ...
        if _1556.RingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1546.InnerRingTolerance':
        ...
        if _1546.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1552.OuterRingTolerance':
        ...
        if _1552.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_support_detail(self) -> '_1559.SupportDetail':
        ...
        return constructor.new(_1559.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1559.SupportDetail':
        ...
        return constructor.new(_1559.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1559.SupportDetail':
        ...
        return constructor.new(_1559.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1559.SupportDetail':
        ...
        return constructor.new(_1559.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1547.InnerSupportTolerance':
        ...
        return constructor.new(_1547.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1560.SupportTolerance':
        ...
        if _1560.SupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1547.InnerSupportTolerance':
        ...
        if _1547.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1553.OuterSupportTolerance':
        ...
        if _1553.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1553.OuterSupportTolerance':
        ...
        return constructor.new(_1553.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1560.SupportTolerance':
        ...
        if _1560.SupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1547.InnerSupportTolerance':
        ...
        if _1547.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1553.OuterSupportTolerance':
        ...
        if _1553.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1553.OuterSupportTolerance':
        ...
        return constructor.new(_1553.OuterSupportTolerance)(self.wrapped.InnerMountingSleeveBoreTolerance) if self.wrapped.InnerMountingSleeveBoreTolerance else None

    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1547.InnerSupportTolerance':
        ...
        return constructor.new(_1547.InnerSupportTolerance)(self.wrapped.InnerMountingSleeveOuterDiameterTolerance) if self.wrapped.InnerMountingSleeveOuterDiameterTolerance else None

    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1553.OuterSupportTolerance':
        ...
        return constructor.new(_1553.OuterSupportTolerance)(self.wrapped.OuterMountingSleeveBoreTolerance) if self.wrapped.OuterMountingSleeveBoreTolerance else None

    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1547.InnerSupportTolerance':
        ...
        return constructor.new(_1547.InnerSupportTolerance)(self.wrapped.OuterMountingSleeveOuterDiameterTolerance) if self.wrapped.OuterMountingSleeveOuterDiameterTolerance else None

    @property
    def simple_bearing_detail_property(self) -> '_1748.BearingDesign':
        ...
        if _1748.BearingDesign.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1749.DetailedBearing':
        ...
        if _1749.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1750.DummyRollingBearing':
        ...
        if _1750.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1751.LinearBearing':
        ...
        if _1751.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1752.NonLinearBearing':
        ...
        if _1752.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1753.AngularContactBallBearing':
        ...
        if _1753.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1754.AngularContactThrustBallBearing':
        ...
        if _1754.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1755.AsymmetricSphericalRollerBearing':
        ...
        if _1755.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1756.AxialThrustCylindricalRollerBearing':
        ...
        if _1756.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1757.AxialThrustNeedleRollerBearing':
        ...
        if _1757.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1758.BallBearing':
        ...
        if _1758.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1760.BarrelRollerBearing':
        ...
        if _1760.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_1765.CrossedRollerBearing':
        ...
        if _1765.CrossedRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1766.CylindricalRollerBearing':
        ...
        if _1766.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1767.DeepGrooveBallBearing':
        ...
        if _1767.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1769.FourPointContactBallBearing':
        ...
        if _1769.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1771.MultiPointContactBallBearing':
        ...
        if _1771.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1772.NeedleRollerBearing':
        ...
        if _1772.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1773.NonBarrelRollerBearing':
        ...
        if _1773.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1774.RollerBearing':
        ...
        if _1774.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1777.RollingBearing':
        ...
        if _1777.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1778.SelfAligningBallBearing':
        ...
        if _1778.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1780.SphericalRollerBearing':
        ...
        if _1780.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1781.SphericalRollerThrustBearing':
        ...
        if _1781.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1782.TaperRollerBearing':
        ...
        if _1782.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1783.ThreePointContactBallBearing':
        ...
        if _1783.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1784.ThrustBallBearing':
        ...
        if _1784.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1785.ToroidalRollerBearing':
        ...
        if _1785.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1798.PadFluidFilmBearing':
        ...
        if _1798.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1800.PlainGreaseFilledJournalBearing':
        ...
        if _1800.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1802.PlainJournalBearing':
        ...
        if _1802.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1804.PlainOilFedJournalBearing':
        ...
        if _1804.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1805.TiltingPadJournalBearing':
        ...
        if _1805.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1806.TiltingPadThrustBearing':
        ...
        if _1806.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1808.ConceptAxialClearanceBearing':
        ...
        if _1808.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1809.ConceptClearanceBearing':
        ...
        if _1809.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1810.ConceptRadialClearanceBearing':
        ...
        if _1810.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def detail(self) -> '_1748.BearingDesign':
        ...
        if _1748.BearingDesign.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_1749.DetailedBearing':
        ...
        if _1749.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1750.DummyRollingBearing':
        ...
        if _1750.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_1751.LinearBearing':
        ...
        if _1751.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1752.NonLinearBearing':
        ...
        if _1752.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1753.AngularContactBallBearing':
        ...
        if _1753.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1754.AngularContactThrustBallBearing':
        ...
        if _1754.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1755.AsymmetricSphericalRollerBearing':
        ...
        if _1755.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1756.AxialThrustCylindricalRollerBearing':
        ...
        if _1756.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1757.AxialThrustNeedleRollerBearing':
        ...
        if _1757.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_1758.BallBearing':
        ...
        if _1758.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1760.BarrelRollerBearing':
        ...
        if _1760.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_1765.CrossedRollerBearing':
        ...
        if _1765.CrossedRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1766.CylindricalRollerBearing':
        ...
        if _1766.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1767.DeepGrooveBallBearing':
        ...
        if _1767.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1769.FourPointContactBallBearing':
        ...
        if _1769.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1771.MultiPointContactBallBearing':
        ...
        if _1771.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1772.NeedleRollerBearing':
        ...
        if _1772.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1773.NonBarrelRollerBearing':
        ...
        if _1773.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_1774.RollerBearing':
        ...
        if _1774.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1777.RollingBearing':
        ...
        if _1777.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1778.SelfAligningBallBearing':
        ...
        if _1778.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1780.SphericalRollerBearing':
        ...
        if _1780.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1781.SphericalRollerThrustBearing':
        ...
        if _1781.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1782.TaperRollerBearing':
        ...
        if _1782.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1783.ThreePointContactBallBearing':
        ...
        if _1783.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1784.ThrustBallBearing':
        ...
        if _1784.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1785.ToroidalRollerBearing':
        ...
        if _1785.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1798.PadFluidFilmBearing':
        ...
        if _1798.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1800.PlainGreaseFilledJournalBearing':
        ...
        if _1800.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1802.PlainJournalBearing':
        ...
        if _1802.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1804.PlainOilFedJournalBearing':
        ...
        if _1804.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1805.TiltingPadJournalBearing':
        ...
        if _1805.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1806.TiltingPadThrustBearing':
        ...
        if _1806.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1808.ConceptAxialClearanceBearing':
        ...
        if _1808.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1809.ConceptClearanceBearing':
        ...
        if _1809.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1810.ConceptRadialClearanceBearing':
        ...
        if _1810.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2004.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_2004.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_2036.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_2036.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None
    ...
    @property
    def friction_coefficients(self) -> '_1696.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1696.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def force_at_zero_displacement(self) -> '_1123.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1123.VectorWithLinearAndAngularComponents)(self.wrapped.ForceAtZeroDisplacement) if self.wrapped.ForceAtZeroDisplacement else None

    @property
    def tolerance_combinations(self) -> 'List[_1562.ToleranceCombination]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToleranceCombinations, constructor.new(_1562.ToleranceCombination))
        return value

    @property
    def mounting(self) -> 'List[_2006.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_2006.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1513.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2044.Shaft', offset: Optional['float'] = float('nan')) -> '_2010.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2044.Shaft', offset: Optional['float'] = float('nan')) -> '_2010.ComponentsConnectedResult':
