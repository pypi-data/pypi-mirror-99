...
from mastapy.bearings.bearing_results import _1619, _1618
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    @property
    def mounting_sleeve_material(self) -> '_51.BearingMaterial':
        ...
        return constructor.new(_51.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial else None
