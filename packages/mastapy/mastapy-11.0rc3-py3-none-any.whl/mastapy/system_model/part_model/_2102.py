...
class FlexiblePinAssembly(_2124.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2171.CylindricalGear':
        ...
        if _2171.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
