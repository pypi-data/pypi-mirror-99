...
from mastapy.system_model.connections_and_sockets import (
    ...
    _1872, _1873, _1874, _1855,
    _1851, _1852, _1856, _1864,
    _1867, _1871, _1875
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.connections_and_sockets.gears import (
    _1890, _1879, _1881, _1883,
...
from mastapy.system_model.part_model import _2010, _2009, _2027
...
class Connector(_2027.MountableComponent):
    '''Connector
    ...
    @property
    def outer_socket(self) -> '_1859.CylindricalSocket':
        ...
        if _1859.CylindricalSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cvt_pulley_socket(self) -> '_1857.CVTPulleySocket':
        ...
        if _1857.CVTPulleySocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_inner_shaft_connecting_socket(self) -> '_1862.InnerShaftConnectingSocket':
        ...
        if _1862.InnerShaftConnectingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_inner_shaft_socket(self) -> '_1863.InnerShaftSocket':
        ...
        if _1863.InnerShaftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_outer_shaft_connecting_socket(self) -> '_1865.OuterShaftConnectingSocket':
        ...
        if _1865.OuterShaftConnectingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_outer_shaft_socket(self) -> '_1866.OuterShaftSocket':
        ...
        if _1866.OuterShaftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_planetary_socket(self) -> '_1868.PlanetarySocket':
        ...
        if _1868.PlanetarySocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_pulley_socket(self) -> '_1869.PulleySocket':
        ...
        if _1869.PulleySocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_rolling_ring_socket(self) -> '_1872.RollingRingSocket':
        ...
        if _1872.RollingRingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_shaft_connecting_socket(self) -> '_1873.ShaftConnectingSocket':
        ...
        if _1873.ShaftConnectingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_shaft_socket(self) -> '_1874.ShaftSocket':
        ...
        if _1874.ShaftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1890.CylindricalGearTeethSocket':
        ...
        if _1890.CylindricalGearTeethSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_clutch_socket(self) -> '_1914.ClutchSocket':
        ...
        if _1914.ClutchSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_concept_coupling_socket(self) -> '_1916.ConceptCouplingSocket':
        ...
        if _1916.ConceptCouplingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_coupling_socket(self) -> '_1918.CouplingSocket':
        ...
        if _1918.CouplingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_part_to_part_shear_coupling_socket(self) -> '_1920.PartToPartShearCouplingSocket':
        ...
        if _1920.PartToPartShearCouplingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_spring_damper_socket(self) -> '_1922.SpringDamperSocket':
        ...
        if _1922.SpringDamperSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_torque_converter_pump_socket(self) -> '_1924.TorqueConverterPumpSocket':
        ...
        if _1924.TorqueConverterPumpSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_torque_converter_turbine_socket(self) -> '_1925.TorqueConverterTurbineSocket':
        ...
        if _1925.TorqueConverterTurbineSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_connection(self) -> '_1855.Connection':
        ...
        if _1855.Connection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_belt_connection(self) -> '_1851.BeltConnection':
        ...
        if _1851.BeltConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_coaxial_connection(self) -> '_1852.CoaxialConnection':
        ...
        if _1852.CoaxialConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_cvt_belt_connection(self) -> '_1856.CVTBeltConnection':
        ...
        if _1856.CVTBeltConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_inter_mountable_component_connection(self) -> '_1864.InterMountableComponentConnection':
        ...
        if _1864.InterMountableComponentConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_planetary_connection(self) -> '_1867.PlanetaryConnection':
        ...
        if _1867.PlanetaryConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_rolling_ring_connection(self) -> '_1871.RollingRingConnection':
        ...
        if _1871.RollingRingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_shaft_to_mountable_component_connection(self) -> '_1875.ShaftToMountableComponentConnection':
        ...
        if _1875.ShaftToMountableComponentConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_agma_gleason_conical_gear_mesh(self) -> '_1879.AGMAGleasonConicalGearMesh':
        ...
        if _1879.AGMAGleasonConicalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_bevel_differential_gear_mesh(self) -> '_1881.BevelDifferentialGearMesh':
        ...
        if _1881.BevelDifferentialGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_bevel_gear_mesh(self) -> '_1883.BevelGearMesh':
        ...
        if _1883.BevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_concept_gear_mesh(self) -> '_1885.ConceptGearMesh':
        ...
        if _1885.ConceptGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_conical_gear_mesh(self) -> '_1887.ConicalGearMesh':
        ...
        if _1887.ConicalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_cylindrical_gear_mesh(self) -> '_1889.CylindricalGearMesh':
        ...
        if _1889.CylindricalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_face_gear_mesh(self) -> '_1891.FaceGearMesh':
        ...
        if _1891.FaceGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_gear_mesh(self) -> '_1893.GearMesh':
        ...
        if _1893.GearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_hypoid_gear_mesh(self) -> '_1895.HypoidGearMesh':
        ...
        if _1895.HypoidGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh(self) -> '_1898.KlingelnbergCycloPalloidConicalGearMesh':
        ...
        if _1898.KlingelnbergCycloPalloidConicalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_1899.KlingelnbergCycloPalloidHypoidGearMesh':
        ...
        if _1899.KlingelnbergCycloPalloidHypoidGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_1900.KlingelnbergCycloPalloidSpiralBevelGearMesh':
        ...
        if _1900.KlingelnbergCycloPalloidSpiralBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_spiral_bevel_gear_mesh(self) -> '_1903.SpiralBevelGearMesh':
        ...
        if _1903.SpiralBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_straight_bevel_diff_gear_mesh(self) -> '_1905.StraightBevelDiffGearMesh':
        ...
        if _1905.StraightBevelDiffGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_straight_bevel_gear_mesh(self) -> '_1907.StraightBevelGearMesh':
        ...
        if _1907.StraightBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_worm_gear_mesh(self) -> '_1909.WormGearMesh':
        ...
        if _1909.WormGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_zerol_bevel_gear_mesh(self) -> '_1911.ZerolBevelGearMesh':
        ...
        if _1911.ZerolBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_clutch_connection(self) -> '_1913.ClutchConnection':
        ...
        if _1913.ClutchConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_concept_coupling_connection(self) -> '_1915.ConceptCouplingConnection':
        ...
        if _1915.ConceptCouplingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_coupling_connection(self) -> '_1917.CouplingConnection':
        ...
        if _1917.CouplingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_part_to_part_shear_coupling_connection(self) -> '_1919.PartToPartShearCouplingConnection':
        ...
        if _1919.PartToPartShearCouplingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_spring_damper_connection(self) -> '_1921.SpringDamperConnection':
        ...
        if _1921.SpringDamperConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_torque_converter_connection(self) -> '_1923.TorqueConverterConnection':
        ...
        if _1923.TorqueConverterConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_component(self) -> '_2044.Shaft':
        ...
        return constructor.new(_2044.Shaft)(self.wrapped.OuterComponent) if self.wrapped.OuterComponent else None

    def house_in(self, shaft: '_2044.Shaft', offset: Optional['float'] = float('nan')) -> '_1855.Connection':
    ...
    def try_house_in(self, shaft: '_2044.Shaft', offset: Optional['float'] = float('nan')) -> '_2010.ComponentsConnectedResult':
    ...
    def other_component(self, component: '_2009.Component') -> '_2044.Shaft':
