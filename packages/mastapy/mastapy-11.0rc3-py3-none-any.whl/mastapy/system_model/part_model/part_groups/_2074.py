...
from mastapy.system_model.part_model import _2052
...
class PartGroup(_0.APIBase):
    ...
    @property
    def parts(self) -> 'List[_2052.Part]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Parts, constructor.new(_2052.Part))
        return value
