...
from mastapy.system_model.part_model.part_groups import _2045, _2043
...
class ConcentricPartGroup(_2043.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def radial_position(self) -> '_1062.Vector2D':
        '''Vector2D: 'RadialPosition' is the original name of this property.'''

        return constructor.new(_1062.Vector2D)(self.wrapped.RadialPosition) if self.wrapped.RadialPosition else None

    @radial_position.setter
    def radial_position(self, value: '_1062.Vector2D'):
        value = value.wrapped if value else None
        self.wrapped.RadialPosition = value

    @property
    def parallel_groups(self) -> 'List[_2045.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2045.ConcentricPartGroupParallelToThis))
        return value
