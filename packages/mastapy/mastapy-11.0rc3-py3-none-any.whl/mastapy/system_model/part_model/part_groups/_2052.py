...
from mastapy.system_model.part_model.part_groups import _2049, _2051, _2048
...
class ParallelPartGroup(_2048.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2049.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2049.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2051.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2051.DesignMeasurements))
        return value
