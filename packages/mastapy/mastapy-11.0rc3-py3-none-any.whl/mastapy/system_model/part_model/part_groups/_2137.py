...
from mastapy.system_model.part_model.part_groups import _2134, _2136, _2133
...
class ParallelPartGroup(_2133.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2134.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2134.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2136.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2136.DesignMeasurements))
        return value
