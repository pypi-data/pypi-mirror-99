...
from mastapy.system_model.part_model.part_groups import _2133, _2134, _2137
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2133.ConcentricOrParallelPartGroup':
        ...
        if _2133.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2134.ConcentricPartGroup':
        ...
        if _2134.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2137.ParallelPartGroup':
        ...
        if _2137.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
