...
from mastapy.system_model.part_model.part_groups import _2135, _2133
...
class ConcentricPartGroup(_2133.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2135.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2135.ConcentricPartGroupParallelToThis))
        return value
