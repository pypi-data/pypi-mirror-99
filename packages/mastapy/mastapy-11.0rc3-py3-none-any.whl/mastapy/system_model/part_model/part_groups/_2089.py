...
from mastapy.system_model.part_model.part_groups import _2086, _2088, _2085
...
class ParallelPartGroup(_2085.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2086.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2086.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2088.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2088.DesignMeasurements))
        return value
