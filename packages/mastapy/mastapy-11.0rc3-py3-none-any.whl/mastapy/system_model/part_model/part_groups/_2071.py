...
from mastapy.system_model.part_model.part_groups import _2069, _2070, _2073
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2069.ConcentricOrParallelPartGroup':
        ...
        if _2069.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2070.ConcentricPartGroup':
        ...
        if _2070.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2073.ParallelPartGroup':
        ...
        if _2073.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
