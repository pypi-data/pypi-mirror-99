...
from mastapy.system_model.part_model.part_groups import _2085, _2086, _2089
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2085.ConcentricOrParallelPartGroup':
        ...
        if _2085.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2086.ConcentricPartGroup':
        ...
        if _2086.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2089.ParallelPartGroup':
        ...
        if _2089.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
