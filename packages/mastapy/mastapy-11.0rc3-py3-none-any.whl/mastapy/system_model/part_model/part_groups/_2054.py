...
from mastapy.system_model.part_model.part_groups import _2051, _2053, _2050
...
class ParallelPartGroup(_2050.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2051.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2051.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2053.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2053.DesignMeasurements))
        return value
