...
from mastapy.system_model.part_model.part_groups import _2071, _2069
...
class ConcentricPartGroup(_2069.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2071.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2071.ConcentricPartGroupParallelToThis))
        return value
