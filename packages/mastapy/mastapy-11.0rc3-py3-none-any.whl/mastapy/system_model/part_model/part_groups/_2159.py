...
from mastapy.system_model.part_model.part_groups import _2160, _2158
...
class ConcentricPartGroup(_2158.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2160.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2160.ConcentricPartGroupParallelToThis))
        return value
