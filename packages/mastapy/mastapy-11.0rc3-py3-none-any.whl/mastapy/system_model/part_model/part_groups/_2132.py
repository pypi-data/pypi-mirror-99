...
from mastapy.system_model.part_model.part_groups import _2133, _2131
...
class ConcentricPartGroup(_2131.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2133.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2133.ConcentricPartGroupParallelToThis))
        return value
