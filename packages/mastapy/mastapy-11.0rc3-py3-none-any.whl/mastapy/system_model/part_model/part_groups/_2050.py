...
from mastapy.system_model.part_model.part_groups import _2048, _2049, _2052
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2048.ConcentricOrParallelPartGroup':
        ...
        if _2048.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2049.ConcentricPartGroup':
        ...
        if _2049.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2052.ParallelPartGroup':
        ...
        if _2052.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
