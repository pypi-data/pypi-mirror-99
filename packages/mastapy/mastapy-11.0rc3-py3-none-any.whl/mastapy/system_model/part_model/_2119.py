...
from mastapy.bearings.bearing_results import _1666, _1665
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    @property
    def mounting_sleeve_material(self) -> '_213.BearingMaterial':
        ...
        return constructor.new(_213.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial else None
