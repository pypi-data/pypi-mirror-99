...
from mastapy.system_model.part_model import (
    _2065, _2046, _2042, _2045,
    _2058, _2072, _2071, _2066,
    _2068, _2038, _2039, _2044,
    _2049, _2050, _2053, _2054,
    _2055, _2062, _2063, _2064,
    _2069, _2074, _2076, _2077,
    _2078
)
from mastapy.system_model.part_model.gears import (
    _2146, _2133, _2142, _2130,
    _2124, _2122, _2150, _2135,
    _2111, _2112, _2113, _2114,
    _2115, _2116, _2117, _2118,
    _2119, _2120, _2121, _2123,
    _2125, _2126, _2127, _2128,
    _2132, _2134, _2136, _2137,
    _2138, _2139, _2140, _2141,
    _2143, _2144, _2145, _2147,
    _2148, _2149, _2151, _2152
)
from mastapy.system_model.part_model.couplings import (
    _2192, _2170, _2172, _2173,
    _2175, _2176, _2177, _2178,
    _2180, _2181, _2182, _2183,
    _2184, _2190, _2191, _2194,
...
from mastapy.gears.gear_designs.creation_options import _882, _885
...
from mastapy.bearings import _1535, _1560
...
class Assembly(_2038.AbstractAssembly):
    '''Assembly
    ...
    @property
    def oil_level_specification(self) -> '_2065.OilLevelSpecification':
        ...
        return constructor.new(_2065.OilLevelSpecification)(self.wrapped.OilLevelSpecification) if self.wrapped.OilLevelSpecification else None

    @property
    def components_with_unknown_scalar_mass(self) -> 'List[_2046.Component]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownScalarMass, constructor.new(_2046.Component))
        return value

    @property
    def straight_bevel_gear_sets(self) -> 'List[_2146.StraightBevelGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearSets, constructor.new(_2146.StraightBevelGearSet))
        return value

    @property
    def hypoid_gear_sets(self) -> 'List[_2133.HypoidGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearSets, constructor.new(_2133.HypoidGearSet))
        return value

    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2142.SpiralBevelGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearSets, constructor.new(_2142.SpiralBevelGearSet))
        return value

    @property
    def shaft_hub_connections(self) -> 'List[_2192.ShaftHubConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftHubConnections, constructor.new(_2192.ShaftHubConnection))
        return value

    @property
    def gear_sets(self) -> 'List[_2130.GearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSets, constructor.new(_2130.GearSet))
        return value
    ...
    @property
    def shafts(self) -> 'List[_2081.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shafts, constructor.new(_2081.Shaft))
        return value

    @property
    def bearings(self) -> 'List[_2042.Bearing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_2042.Bearing))
        return value

    @property
    def bolted_joints(self) -> 'List[_2045.BoltedJoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltedJoints, constructor.new(_2045.BoltedJoint))
        return value

    @property
    def imported_fes(self) -> 'List[_2058.ImportedFEComponent]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEs, constructor.new(_2058.ImportedFEComponent))
        return value

    @property
    def component_details(self) -> 'List[_2046.Component]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDetails, constructor.new(_2046.Component))
        return value

    @property
    def power_loads(self) -> 'List[_2072.PowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_2072.PowerLoad))
        return value

    @property
    def point_loads(self) -> 'List[_2071.PointLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_2071.PointLoad))
        return value

    @property
    def oil_seals(self) -> 'List[_2066.OilSeal]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OilSeals, constructor.new(_2066.OilSeal))
        return value

    def get_part_named(self, name: 'str') -> '_2068.Part':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2068.Part.TYPE](name if name else None)
    ...
    def get_part_named_of_type_abstract_assembly(self, name: 'str') -> '_2038.AbstractAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2038.AbstractAssembly.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_abstract_shaft_or_housing(self, name: 'str') -> '_2039.AbstractShaftOrHousing':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2039.AbstractShaftOrHousing.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bearing(self, name: 'str') -> '_2042.Bearing':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2042.Bearing.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bolt(self, name: 'str') -> '_2044.Bolt':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2044.Bolt.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bolted_joint(self, name: 'str') -> '_2045.BoltedJoint':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2045.BoltedJoint.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_component(self, name: 'str') -> '_2046.Component':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2046.Component.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_connector(self, name: 'str') -> '_2049.Connector':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2049.Connector.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_datum(self, name: 'str') -> '_2050.Datum':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2050.Datum.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_external_cad_model(self, name: 'str') -> '_2053.ExternalCADModel':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2053.ExternalCADModel.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_flexible_pin_assembly(self, name: 'str') -> '_2054.FlexiblePinAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2054.FlexiblePinAssembly.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_guide_dxf_model(self, name: 'str') -> '_2055.GuideDxfModel':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2055.GuideDxfModel.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_imported_fe_component(self, name: 'str') -> '_2058.ImportedFEComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2058.ImportedFEComponent.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_mass_disc(self, name: 'str') -> '_2062.MassDisc':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2062.MassDisc.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_measurement_component(self, name: 'str') -> '_2063.MeasurementComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2063.MeasurementComponent.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_mountable_component(self, name: 'str') -> '_2064.MountableComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2064.MountableComponent.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_oil_seal(self, name: 'str') -> '_2066.OilSeal':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2066.OilSeal.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_planet_carrier(self, name: 'str') -> '_2069.PlanetCarrier':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2069.PlanetCarrier.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_point_load(self, name: 'str') -> '_2071.PointLoad':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2071.PointLoad.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_power_load(self, name: 'str') -> '_2072.PowerLoad':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2072.PowerLoad.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_root_assembly(self, name: 'str') -> '_2074.RootAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2074.RootAssembly.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_specialised_assembly(self, name: 'str') -> '_2076.SpecialisedAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2076.SpecialisedAssembly.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_unbalanced_mass(self, name: 'str') -> '_2077.UnbalancedMass':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2077.UnbalancedMass.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_virtual_component(self, name: 'str') -> '_2078.VirtualComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2078.VirtualComponent.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_shaft(self, name: 'str') -> '_2081.Shaft':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2081.Shaft.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_agma_gleason_conical_gear(self, name: 'str') -> '_2111.AGMAGleasonConicalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2111.AGMAGleasonConicalGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_agma_gleason_conical_gear_set(self, name: 'str') -> '_2112.AGMAGleasonConicalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2112.AGMAGleasonConicalGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_gear(self, name: 'str') -> '_2113.BevelDifferentialGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2113.BevelDifferentialGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_gear_set(self, name: 'str') -> '_2114.BevelDifferentialGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2114.BevelDifferentialGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_planet_gear(self, name: 'str') -> '_2115.BevelDifferentialPlanetGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2115.BevelDifferentialPlanetGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_sun_gear(self, name: 'str') -> '_2116.BevelDifferentialSunGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2116.BevelDifferentialSunGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bevel_gear(self, name: 'str') -> '_2117.BevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2117.BevelGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_bevel_gear_set(self, name: 'str') -> '_2118.BevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2118.BevelGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_concept_gear(self, name: 'str') -> '_2119.ConceptGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2119.ConceptGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_concept_gear_set(self, name: 'str') -> '_2120.ConceptGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2120.ConceptGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_conical_gear(self, name: 'str') -> '_2121.ConicalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2121.ConicalGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_conical_gear_set(self, name: 'str') -> '_2122.ConicalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2122.ConicalGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_cylindrical_gear(self, name: 'str') -> '_2123.CylindricalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2123.CylindricalGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_cylindrical_gear_set(self, name: 'str') -> '_2124.CylindricalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2124.CylindricalGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_cylindrical_planet_gear(self, name: 'str') -> '_2125.CylindricalPlanetGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2125.CylindricalPlanetGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_face_gear(self, name: 'str') -> '_2126.FaceGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2126.FaceGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_face_gear_set(self, name: 'str') -> '_2127.FaceGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2127.FaceGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_gear(self, name: 'str') -> '_2128.Gear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2128.Gear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_gear_set(self, name: 'str') -> '_2130.GearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2130.GearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_hypoid_gear(self, name: 'str') -> '_2132.HypoidGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2132.HypoidGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_hypoid_gear_set(self, name: 'str') -> '_2133.HypoidGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2133.HypoidGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_conical_gear(self, name: 'str') -> '_2134.KlingelnbergCycloPalloidConicalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2134.KlingelnbergCycloPalloidConicalGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self, name: 'str') -> '_2135.KlingelnbergCycloPalloidConicalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2135.KlingelnbergCycloPalloidConicalGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self, name: 'str') -> '_2136.KlingelnbergCycloPalloidHypoidGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2136.KlingelnbergCycloPalloidHypoidGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self, name: 'str') -> '_2137.KlingelnbergCycloPalloidHypoidGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2137.KlingelnbergCycloPalloidHypoidGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self, name: 'str') -> '_2138.KlingelnbergCycloPalloidSpiralBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2138.KlingelnbergCycloPalloidSpiralBevelGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self, name: 'str') -> '_2139.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2139.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_planetary_gear_set(self, name: 'str') -> '_2140.PlanetaryGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2140.PlanetaryGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_spiral_bevel_gear(self, name: 'str') -> '_2141.SpiralBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2141.SpiralBevelGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_spiral_bevel_gear_set(self, name: 'str') -> '_2142.SpiralBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2142.SpiralBevelGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_diff_gear(self, name: 'str') -> '_2143.StraightBevelDiffGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2143.StraightBevelDiffGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_diff_gear_set(self, name: 'str') -> '_2144.StraightBevelDiffGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2144.StraightBevelDiffGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_gear(self, name: 'str') -> '_2145.StraightBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2145.StraightBevelGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_gear_set(self, name: 'str') -> '_2146.StraightBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2146.StraightBevelGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_planet_gear(self, name: 'str') -> '_2147.StraightBevelPlanetGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2147.StraightBevelPlanetGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_sun_gear(self, name: 'str') -> '_2148.StraightBevelSunGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2148.StraightBevelSunGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_worm_gear(self, name: 'str') -> '_2149.WormGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2149.WormGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_worm_gear_set(self, name: 'str') -> '_2150.WormGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2150.WormGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_zerol_bevel_gear(self, name: 'str') -> '_2151.ZerolBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2151.ZerolBevelGear.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_zerol_bevel_gear_set(self, name: 'str') -> '_2152.ZerolBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2152.ZerolBevelGearSet.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_belt_drive(self, name: 'str') -> '_2170.BeltDrive':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2170.BeltDrive.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_clutch(self, name: 'str') -> '_2172.Clutch':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2172.Clutch.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_clutch_half(self, name: 'str') -> '_2173.ClutchHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2173.ClutchHalf.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_concept_coupling(self, name: 'str') -> '_2175.ConceptCoupling':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2175.ConceptCoupling.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_concept_coupling_half(self, name: 'str') -> '_2176.ConceptCouplingHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2176.ConceptCouplingHalf.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_coupling(self, name: 'str') -> '_2177.Coupling':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2177.Coupling.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_coupling_half(self, name: 'str') -> '_2178.CouplingHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2178.CouplingHalf.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_cvt(self, name: 'str') -> '_2180.CVT':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2180.CVT.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_cvt_pulley(self, name: 'str') -> '_2181.CVTPulley':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2181.CVTPulley.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_part_to_part_shear_coupling(self, name: 'str') -> '_2182.PartToPartShearCoupling':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2182.PartToPartShearCoupling.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_part_to_part_shear_coupling_half(self, name: 'str') -> '_2183.PartToPartShearCouplingHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2183.PartToPartShearCouplingHalf.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_pulley(self, name: 'str') -> '_2184.Pulley':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2184.Pulley.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_rolling_ring(self, name: 'str') -> '_2190.RollingRing':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2190.RollingRing.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_rolling_ring_assembly(self, name: 'str') -> '_2191.RollingRingAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2191.RollingRingAssembly.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_shaft_hub_connection(self, name: 'str') -> '_2192.ShaftHubConnection':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2192.ShaftHubConnection.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_spring_damper(self, name: 'str') -> '_2194.SpringDamper':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2194.SpringDamper.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_spring_damper_half(self, name: 'str') -> '_2195.SpringDamperHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2195.SpringDamperHalf.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser(self, name: 'str') -> '_2196.Synchroniser':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2196.Synchroniser.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser_half(self, name: 'str') -> '_2198.SynchroniserHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2198.SynchroniserHalf.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser_part(self, name: 'str') -> '_2199.SynchroniserPart':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2199.SynchroniserPart.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser_sleeve(self, name: 'str') -> '_2200.SynchroniserSleeve':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2200.SynchroniserSleeve.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_torque_converter(self, name: 'str') -> '_2201.TorqueConverter':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2201.TorqueConverter.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_torque_converter_pump(self, name: 'str') -> '_2202.TorqueConverterPump':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2202.TorqueConverterPump.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def get_part_named_of_type_torque_converter_turbine(self, name: 'str') -> '_2204.TorqueConverterTurbine':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2204.TorqueConverterTurbine.TYPE](name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None

    def add_part(self, part_type: 'Assembly.PartType', name: 'str') -> '_2068.Part':
    ...
    def add_oil_seal(self, name: Optional['str'] = 'Oil Seal') -> '_2066.OilSeal':
    ...
    def add_power_load(self, name: Optional['str'] = 'Power Load') -> '_2072.PowerLoad':
    ...
    def add_point_load(self, name: Optional['str'] = 'Point Load') -> '_2071.PointLoad':
    ...
    def add_datum(self, name: Optional['str'] = 'Datum') -> '_2050.Datum':
    ...
    def add_imported_fe_component(self, name: Optional['str'] = 'Imported FE') -> '_2058.ImportedFEComponent':
    ...
    def add_measurement_component(self, name: Optional['str'] = 'Measurement Component') -> '_2063.MeasurementComponent':
    ...
    def add_mass_disc(self, name: Optional['str'] = 'Mass Disc') -> '_2062.MassDisc':
    ...
    def add_unbalanced_mass(self, name: Optional['str'] = 'Unbalanced Mass') -> '_2077.UnbalancedMass':
    ...
    def add_straight_bevel_differential_gear_set(self, name: Optional['str'] = 'Straight Bevel Differential Gear Set') -> '_2144.StraightBevelDiffGearSet':
    ...
    def add_spiral_bevel_differential_gear_set(self, name: Optional['str'] = 'Spiral Bevel Differential Gear Set') -> '_2114.BevelDifferentialGearSet':
    ...
    def add_zerol_bevel_differential_gear_set(self, name: Optional['str'] = 'Zerol Bevel Differential Gear Set') -> '_2114.BevelDifferentialGearSet':
    ...
    def add_planetary_gear_set(self, name: Optional['str'] = 'Planetary Gear Set') -> '_2140.PlanetaryGearSet':
    ...
    def add_spiral_bevel_gear_set(self, name: Optional['str'] = 'Spiral Bevel Gear Set') -> '_2142.SpiralBevelGearSet':
    ...
    def add_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self, name: Optional['str'] = 'Klingelnberg Cyclo Palloid Spiral Bevel Gear Set') -> '_2139.KlingelnbergCycloPalloidSpiralBevelGearSet':
    ...
    def add_klingelnberg_cyclo_palloid_hypoid_gear_set(self, name: Optional['str'] = 'Klingelnberg Cyclo Palloid Hypoid Gear Set') -> '_2137.KlingelnbergCycloPalloidHypoidGearSet':
    ...
    def add_straight_bevel_gear_set(self, name: Optional['str'] = 'Straight Bevel Gear Set') -> '_2146.StraightBevelGearSet':
    ...
    def add_hypoid_gear_set(self, name: Optional['str'] = 'Hypoid Gear Set') -> '_2133.HypoidGearSet':
    ...
    def add_worm_gear_set(self, name: Optional['str'] = 'Worm Gear Set') -> '_2150.WormGearSet':
    ...
    def add_zerol_bevel_gear_set(self, name: Optional['str'] = 'Zerol Bevel Gear Set') -> '_2152.ZerolBevelGearSet':
    ...
    def add_clutch(self, name: Optional['str'] = 'Clutch') -> '_2172.Clutch':
    ...
    def add_synchroniser(self, name: Optional['str'] = 'Synchroniser') -> '_2196.Synchroniser':
    ...
    def add_rolling_ring(self, name: Optional['str'] = 'Rolling Ring') -> '_2190.RollingRing':
    ...
    def add_concept_coupling(self, name: Optional['str'] = 'Concept Coupling') -> '_2175.ConceptCoupling':
    ...
    def add_cvt(self, name: Optional['str'] = 'CVT') -> '_2180.CVT':
    ...
    def add_spring_damper(self, name: Optional['str'] = 'Spring Damper') -> '_2194.SpringDamper':
    ...
    def add_torque_converter(self, name: Optional['str'] = 'Torque Converter') -> '_2201.TorqueConverter':
    ...
    def add_bolted_joint(self, name: Optional['str'] = 'Bolted Joint') -> '_2045.BoltedJoint':
    ...
    def add_belt_drive_with_options(self, belt_creation_options: Optional['_2166.BeltCreationOptions'] = None) -> '_2170.BeltDrive':
    ...
    def add_belt_drive(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2170.BeltDrive':
        ''' 'AddBeltDrive' is the original name of this method.
    ...
    def add_planet_carrier_with_options(self, planet_carrier_creation_options: Optional['_2168.PlanetCarrierCreationOptions'] = None) -> '_2069.PlanetCarrier':
    ...
    def add_planet_carrier(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2069.PlanetCarrier':
        ''' 'AddPlanetCarrier' is the original name of this method.
    ...
    def add_shaft_with_options(self, shaft_creation_options: '_2169.ShaftCreationOptions') -> '_2081.Shaft':
    ...
    def add_shaft(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2081.Shaft':
        ''' 'AddShaft' is the original name of this method.
    ...
    def add_cylindrical_gear_pair_with_options(self, cylindrical_gear_pair_creation_options: Optional['_882.CylindricalGearPairCreationOptions'] = None) -> '_2124.CylindricalGearSet':
    ...
    def add_cylindrical_gear_pair(self, centre_distance: 'float') -> '_2124.CylindricalGearSet':
        ''' 'AddCylindricalGearPair' is the original name of this method.
    ...
    def add_cylindrical_gear_set_with_options(self, cylindrical_gear_linear_train_creation_options: Optional['_2167.CylindricalGearLinearTrainCreationOptions'] = None) -> '_2124.CylindricalGearSet':
    ...
    def add_cylindrical_gear_set(self, name: 'str', centre_distances: 'List[float]') -> '_2124.CylindricalGearSet':
        ''' 'AddCylindricalGearSet' is the original name of this method.
    ...
    def add_cylindrical_gear_set_extended(self, name: 'str', normal_pressure_angle: 'float', helix_angle: 'float', normal_module: 'float', pinion_hand: '_132.Hand', centre_distances: 'List[float]') -> '_2124.CylindricalGearSet':
        ''' 'AddCylindricalGearSet' is the original name of this method.
    ...
    def add_spiral_bevel_gear_set_with_options(self, spiral_bevel_gear_set_creation_options: Optional['_885.SpiralBevelGearSetCreationOptions'] = None) -> '_2142.SpiralBevelGearSet':
        ''' 'AddSpiralBevelGearSet' is the original name of this method.
    ...
    def add_bearing(self, name: 'str') -> '_2042.Bearing':
    ...
    def import_fe_mesh_from_file(self, file_name: 'str', stiffness_matrix: '_1403.NodalMatrix') -> '_2058.ImportedFEComponent':
    ...
    def add_axial_clearance_bearing(self, name: 'str', contact_diameter: 'float') -> '_2042.Bearing':
    ...
    def add_shaft_hub_connection(self, name: 'str') -> '_2192.ShaftHubConnection':
    ...
    def add_rolling_bearing_from_catalogue(self, catalogue: '_1535.BearingCatalog', designation: 'str', name: 'str') -> '_2042.Bearing':
    ...
    def add_bearing_with_name_and_rolling_bearing_type(self, name: 'str', type_: '_1560.RollingBearingType') -> '_2042.Bearing':
        ''' 'AddBearing' is the original name of this method.
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(self, name: 'str', type_: '_1560.RollingBearingType', designation: 'str') -> '_2042.Bearing':
        ''' 'AddBearing' is the original name of this method.
