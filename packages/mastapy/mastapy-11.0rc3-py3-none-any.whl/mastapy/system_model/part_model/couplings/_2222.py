...
from mastapy.system_model.part_model.couplings import _2223, _2236
from mastapy.system_model.connections_and_sockets import _1922
...
class BeltDrive(_2124.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2223.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2223.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2223.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2236.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2236.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1922.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1922.BeltConnection))
        return value
