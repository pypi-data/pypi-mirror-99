...
from mastapy.system_model.part_model.couplings import _2278, _2280
...
class SynchroniserHalf(_2280.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2278.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2278.SynchroniserCone))
        return value
