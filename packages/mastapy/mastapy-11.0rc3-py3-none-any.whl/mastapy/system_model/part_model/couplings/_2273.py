...
from mastapy.system_model.part_model.couplings import (
    _2267, _2270, _2266, _2269,
    _2274, _2268
)
from mastapy.detailed_rigid_connectors.splines import (
    _1174, _1159, _1179, _1154,
    _1157, _1161, _1164, _1165,
    _1172, _1184
)
from mastapy._internal.python_net import python_net_import
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.interference_fits import _1209
from mastapy.detailed_rigid_connectors.keyed_joints import _1201
...
class ShaftHubConnection(_2125.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2267.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2267.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2267.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1174.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1174.SplineDesignTypes)(value) if value else None

    @spline_type.setter
    def spline_type(self, value: '_1174.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def spline_joint_design(self) -> '_1179.SplineJointDesign':
        ...
        if _1179.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1154.CustomSplineJointDesign':
        ...
        if _1154.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1157.DIN5480SplineJointDesign':
        ...
        if _1157.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1161.GBT3478SplineJointDesign':
        ...
        if _1161.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1164.ISO4156SplineJointDesign':
        ...
        if _1164.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1165.JISB1603SplineJointDesign':
        ...
        if _1165.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1172.SAESplineJointDesign':
        ...
        if _1172.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1184.StandardSplineJointDesign':
        ...
        if _1184.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def interference_fit_design(self) -> '_1209.InterferenceFitDesign':
        ...
        if _1209.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    @property
    def left_flank_lead_relief(self) -> '_2274.SplineLeadRelief':
        ...
        return constructor.new(_2274.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief else None

    @property
    def right_flank_lead_relief(self) -> '_2274.SplineLeadRelief':
        ...
        return constructor.new(_2274.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2268.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2268.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2274.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2274.SplineLeadRelief))
        return value
