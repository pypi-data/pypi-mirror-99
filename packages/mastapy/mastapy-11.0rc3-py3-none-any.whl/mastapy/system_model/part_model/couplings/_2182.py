...
class PartToPartShearCoupling(_2177.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_1956.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_1956.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
