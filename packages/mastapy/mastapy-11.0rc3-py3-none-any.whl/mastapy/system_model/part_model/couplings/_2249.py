...
from mastapy.system_model.part_model.couplings import _2251, _2254
...
class Clutch(_2254.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2251.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2251.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2251.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5055.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5055.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5055.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2018.ClutchConnection':
        ...
        return constructor.new(_2018.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
