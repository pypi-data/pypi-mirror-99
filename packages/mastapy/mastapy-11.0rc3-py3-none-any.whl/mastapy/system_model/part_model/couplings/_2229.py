...
from mastapy.system_model.part_model.couplings import (
    _2230, _2225, _2228, _2233,
    _2235, _2236, _2242, _2246,
...
class Coupling(_2124.SpecialisedAssembly):
    '''Coupling
    ...
    @property
    def halves(self) -> 'List[_2230.CouplingHalf]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_2230.CouplingHalf))
        return value

    @property
    def half_a(self) -> '_2230.CouplingHalf':
        ...
        if _2230.CouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_clutch_half(self) -> '_2225.ClutchHalf':
        ...
        if _2225.ClutchHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_concept_coupling_half(self) -> '_2228.ConceptCouplingHalf':
        ...
        if _2228.ConceptCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_cvt_pulley(self) -> '_2233.CVTPulley':
        ...
        if _2233.CVTPulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to CVTPulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_part_to_part_shear_coupling_half(self) -> '_2235.PartToPartShearCouplingHalf':
        ...
        if _2235.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_pulley(self) -> '_2236.Pulley':
        ...
        if _2236.Pulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to Pulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_rolling_ring(self) -> '_2242.RollingRing':
        ...
        if _2242.RollingRing.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to RollingRing. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_spring_damper_half(self) -> '_2246.SpringDamperHalf':
        ...
        if _2246.SpringDamperHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_half(self) -> '_2249.SynchroniserHalf':
        ...
        if _2249.SynchroniserHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_part(self) -> '_2250.SynchroniserPart':
        ...
        if _2250.SynchroniserPart.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_sleeve(self) -> '_2251.SynchroniserSleeve':
        ...
        if _2251.SynchroniserSleeve.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_pump(self) -> '_2253.TorqueConverterPump':
        ...
        if _2253.TorqueConverterPump.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_turbine(self) -> '_2255.TorqueConverterTurbine':
        ...
        if _2255.TorqueConverterTurbine.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_b(self) -> '_2230.CouplingHalf':
        ...
        if _2230.CouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_clutch_half(self) -> '_2225.ClutchHalf':
        ...
        if _2225.ClutchHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_concept_coupling_half(self) -> '_2228.ConceptCouplingHalf':
        ...
        if _2228.ConceptCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_cvt_pulley(self) -> '_2233.CVTPulley':
        ...
        if _2233.CVTPulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to CVTPulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_part_to_part_shear_coupling_half(self) -> '_2235.PartToPartShearCouplingHalf':
        ...
        if _2235.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_pulley(self) -> '_2236.Pulley':
        ...
        if _2236.Pulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to Pulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_rolling_ring(self) -> '_2242.RollingRing':
        ...
        if _2242.RollingRing.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to RollingRing. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_spring_damper_half(self) -> '_2246.SpringDamperHalf':
        ...
        if _2246.SpringDamperHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_half(self) -> '_2249.SynchroniserHalf':
        ...
        if _2249.SynchroniserHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_part(self) -> '_2250.SynchroniserPart':
        ...
        if _2250.SynchroniserPart.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_sleeve(self) -> '_2251.SynchroniserSleeve':
        ...
        if _2251.SynchroniserSleeve.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_pump(self) -> '_2253.TorqueConverterPump':
        ...
        if _2253.TorqueConverterPump.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_turbine(self) -> '_2255.TorqueConverterTurbine':
        ...
        if _2255.TorqueConverterTurbine.TYPE not in self.wrapped.HalfB.__class__.__mro__:
