...
from mastapy.system_model.part_model.couplings import _2226, _2229
...
class Clutch(_2229.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2226.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2226.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2226.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5026.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5026.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5026.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1994.ClutchConnection':
        ...
        return constructor.new(_1994.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
