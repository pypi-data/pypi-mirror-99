...
from mastapy.math_utility.stiffness_calculators import _1298
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1298.IndividualContactPosition':
        ...
        return constructor.new(_1298.IndividualContactPosition)(value) if value else None
    ...
    @property
    def crowning(self) -> '_2260.CrowningSpecification':
        ...
        return constructor.new(_2260.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
