...
from mastapy.system_model.part_model.couplings import _2129, _2141
...
class BeltDrive(_2034.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2129.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2129.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2129.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2141.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2141.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1847.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1847.BeltConnection))
        return value
