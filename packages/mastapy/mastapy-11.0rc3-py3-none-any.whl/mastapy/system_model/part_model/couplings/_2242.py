...
class RollingRing(_2230.CouplingHalf):
    '''RollingRing
    ...
    @property
    def largest_end(self) -> '_293.Hand':
        '''Hand: 'LargestEnd' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.LargestEnd)
        return constructor.new(_293.Hand)(value) if value else None

    @largest_end.setter
    def largest_end(self, value: '_293.Hand'):
