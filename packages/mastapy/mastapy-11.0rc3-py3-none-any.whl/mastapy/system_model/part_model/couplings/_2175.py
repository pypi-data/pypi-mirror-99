...
class ConceptCoupling(_2177.Coupling):
    '''ConceptCoupling
    ...
    @property
    def coupling_type(self) -> '_1382.CouplingType':
        '''CouplingType: 'CouplingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CouplingType)
        return constructor.new(_1382.CouplingType)(value) if value else None

    @coupling_type.setter
    def coupling_type(self, value: '_1382.CouplingType'):
