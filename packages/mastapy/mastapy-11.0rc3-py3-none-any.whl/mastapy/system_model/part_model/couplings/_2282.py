...
from mastapy.system_model.part_model.couplings import _2283, _2285, _2258
...
class TorqueConverter(_2258.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2283.TorqueConverterPump':
        ...
        return constructor.new(_2283.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2285.TorqueConverterTurbine':
        ...
        return constructor.new(_2285.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
