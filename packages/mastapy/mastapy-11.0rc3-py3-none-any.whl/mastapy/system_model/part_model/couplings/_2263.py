...
class PartToPartShearCoupling(_2258.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2028.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2028.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
