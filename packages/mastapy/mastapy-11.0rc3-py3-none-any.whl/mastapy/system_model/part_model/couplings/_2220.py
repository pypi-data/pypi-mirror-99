...
from mastapy.system_model.part_model.couplings import _2221, _2234
...
class BeltDrive(_2122.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2221.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2221.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2221.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2234.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2234.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1920.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1920.BeltConnection))
        return value
