...
from mastapy.system_model.part_model.couplings import _2137, _2140
...
class Clutch(_2140.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2137.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2137.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2137.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5015.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5015.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5015.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1913.ClutchConnection':
        ...
        return constructor.new(_1913.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
