...
from mastapy.system_model import _1828
...
T = TypeVar('T', bound='_2009.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1063.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1063.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_1828.RelativeOffsetOption':
        ...
        return constructor.new(_1828.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1828.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
