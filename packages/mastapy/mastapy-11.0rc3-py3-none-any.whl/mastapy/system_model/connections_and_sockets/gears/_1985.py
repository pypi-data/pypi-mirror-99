...
class ConceptGearMesh(_1993.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1088.ConceptGearMeshDesign':
        ...
        return constructor.new(_1088.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
