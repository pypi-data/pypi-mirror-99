...
class KlingelnbergCycloPalloidHypoidGearMesh(_1972.KlingelnbergCycloPalloidConicalGearMesh):
    '''KlingelnbergCycloPalloidHypoidGearMesh
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh_design(self) -> '_907.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        return constructor.new(_907.KlingelnbergCycloPalloidHypoidGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign else None
