...
from mastapy.system_model.part_model.gears import _2124, _2140, _2123
...
class CylindricalGearMesh(_1930.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2124.CylindricalGearSet':
        ...
        if _2124.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1138.ShortLengthRange':
        ...
        return constructor.new(_1138.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
