...
class WormGearMesh(_1993.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_888.WormGearMeshDesign':
        ...
        return constructor.new(_888.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
