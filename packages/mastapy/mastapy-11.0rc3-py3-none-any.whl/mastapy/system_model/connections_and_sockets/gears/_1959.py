...
class ConceptGearMesh(_1967.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1087.ConceptGearMeshDesign':
        ...
        return constructor.new(_1087.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
