...
class FaceGearMesh(_1967.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_920.FaceGearMeshDesign':
        ...
        return constructor.new(_920.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
