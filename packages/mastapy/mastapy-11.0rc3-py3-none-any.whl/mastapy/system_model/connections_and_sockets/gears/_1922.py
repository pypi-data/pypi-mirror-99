...
class ConceptGearMesh(_1930.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_913.ConceptGearMeshDesign':
        ...
        return constructor.new(_913.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
