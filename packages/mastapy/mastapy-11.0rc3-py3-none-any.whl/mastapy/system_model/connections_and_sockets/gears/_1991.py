...
class FaceGearMesh(_1993.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_921.FaceGearMeshDesign':
        ...
        return constructor.new(_921.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
