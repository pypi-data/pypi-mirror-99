...
from mastapy.system_model import _1812
...
class SpringDamperConnection(_1917.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1812.ComponentDampingOption':
        ...
        return constructor.new(_1812.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1812.ComponentDampingOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DampingOption = value

    @property
    def damping(self) -> '_1382.LinearDampingConnectionProperties':
        ...
        return constructor.new(_1382.LinearDampingConnectionProperties)(self.wrapped.Damping) if self.wrapped.Damping else None
