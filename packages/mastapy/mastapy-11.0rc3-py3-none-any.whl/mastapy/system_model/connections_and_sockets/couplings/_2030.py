...
class SpringDamperConnection(_2026.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1889.ComponentDampingOption':
        ...
        return constructor.new(_1889.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1889.ComponentDampingOption'):
