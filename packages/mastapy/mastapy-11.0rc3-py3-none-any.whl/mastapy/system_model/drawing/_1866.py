...
from mastapy.system_model.drawing import _1868, _1867
...
class ContourDrawStyle(_110.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1355.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1355.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1355.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1868.ScalingDrawStyle':
        ...
        return constructor.new(_1868.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1867.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1867.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
