...
from mastapy.utility.enums import _1545
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.system_model.drawing import _1912, _1911
from mastapy.geometry import _270
...
class ContourDrawStyle(_270.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1545.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1545.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1545.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1912.ScalingDrawStyle':
        ...
        return constructor.new(_1912.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1911.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1911.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
