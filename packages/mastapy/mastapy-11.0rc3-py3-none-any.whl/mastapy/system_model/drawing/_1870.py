...
from mastapy.system_model.drawing import _1881, _1877
...
class ContourDrawStyle(_109.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1356.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1356.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1356.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1881.ScalingDrawStyle':
        ...
        return constructor.new(_1881.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1877.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1877.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
