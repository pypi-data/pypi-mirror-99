...
from mastapy.math_utility.measured_vectors import _1322
...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self) -> '_1322.ForceAndDisplacementResults':
        ...
        return constructor.new(_1322.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail else None

    @property
    def section_to_the_left_side(self) -> '_2469.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2469.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2469.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2469.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
