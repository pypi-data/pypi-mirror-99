...
from mastapy.system_model.drawing import _1914, _1913
...
class ContourDrawStyle(_270.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1463.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1463.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1463.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1914.ScalingDrawStyle':
        ...
        return constructor.new(_1914.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1913.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1913.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
