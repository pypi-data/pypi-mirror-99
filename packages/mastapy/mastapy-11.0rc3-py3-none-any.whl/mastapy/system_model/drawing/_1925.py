...
from mastapy.system_model.drawing import _1935, _1931
...
class ContourDrawStyle(_271.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1549.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1549.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1549.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1935.ScalingDrawStyle':
        ...
        return constructor.new(_1935.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1931.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1931.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
