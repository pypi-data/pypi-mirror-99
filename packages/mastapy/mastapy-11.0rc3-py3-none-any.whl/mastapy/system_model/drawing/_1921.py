...
from mastapy.system_model.drawing import _1931, _1927
...
class ContourDrawStyle(_270.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1548.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1548.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1548.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1931.ScalingDrawStyle':
        ...
        return constructor.new(_1931.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1927.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1927.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
