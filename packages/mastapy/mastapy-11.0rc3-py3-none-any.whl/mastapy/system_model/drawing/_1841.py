...
from mastapy.system_model.drawing import _1843, _1842
...
class ContourDrawStyle(_112.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1343.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1343.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1343.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1843.ScalingDrawStyle':
        ...
        return constructor.new(_1843.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1842.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1842.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
