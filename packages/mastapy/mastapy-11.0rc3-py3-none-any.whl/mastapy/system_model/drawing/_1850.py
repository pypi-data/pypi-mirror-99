...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self) -> '_1120.ForceAndDisplacementResults':
        ...
        return constructor.new(_1120.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail else None

    @property
    def section_to_the_left_side(self) -> '_2332.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2332.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2332.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2332.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
