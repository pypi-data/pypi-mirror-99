...
class BoltGeometry(_1556.NamedDatabaseItem):
    '''BoltGeometry
    ...
    @property
    def standard_size(self) -> '_1246.StandardSizes':
        '''StandardSizes: 'StandardSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StandardSize)
        return constructor.new(_1246.StandardSizes)(value) if value else None

    @standard_size.setter
    def standard_size(self, value: '_1246.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.StandardSize = value

    @property
    def bolt_sections(self) -> 'List[_1234.BoltSection]':
        '''List[BoltSection]: 'BoltSections' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltSections, constructor.new(_1234.BoltSection))
        return value

    @bolt_sections.setter
    def bolt_sections(self, value: 'List[_1234.BoltSection]'):
        value = value if value else None
    ...
    @property
    def bolt_shank_type(self) -> '_1235.BoltShankType':
        ...
        return constructor.new(_1235.BoltShankType)(value) if value else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1235.BoltShankType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_head_cap(self) -> '_1241.HeadCapTypes':
        ...
        return constructor.new(_1241.HeadCapTypes)(value) if value else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1241.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1248.ThreadTypes':
        '''ThreadTypes: 'TypeOfThread' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfThread)
        return constructor.new(_1248.ThreadTypes)(value) if value else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1248.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_bolted_joint(self) -> '_1236.BoltTypes':
        ...
        return constructor.new(_1236.BoltTypes)(value) if value else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1236.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
