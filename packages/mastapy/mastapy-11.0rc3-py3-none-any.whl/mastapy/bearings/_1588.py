...
from mastapy.bearings import (
    _1598, _1597, _1590, _1591
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1792
...
class BearingSettings(_1349.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1597.RatingLife':
        ...
        return constructor.new(_1597.RatingLife)(value) if value else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1597.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1590.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1590.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1590.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1792.SKFCredentials':
        ...
        return constructor.new(_1792.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
