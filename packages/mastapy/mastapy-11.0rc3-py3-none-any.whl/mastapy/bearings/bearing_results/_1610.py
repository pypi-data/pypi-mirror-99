...
from mastapy.bearings.bearing_results import _1613
...
class LoadedDetailedBearingResults(_1613.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_71.LubricationDetail':
        ...
        return constructor.new(_71.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
