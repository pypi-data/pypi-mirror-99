...
from mastapy.bearings.bearing_results.rolling import _1632, _1635, _1652
...
class LoadedAngularContactBallBearingRow(_1652.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1632.LoadedAngularContactBallBearingResults':
