...
from mastapy.bearings.bearing_results.rolling import _1771, _1729
...
class LoadedBallBearingResults(_1729.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1771.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1771.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
