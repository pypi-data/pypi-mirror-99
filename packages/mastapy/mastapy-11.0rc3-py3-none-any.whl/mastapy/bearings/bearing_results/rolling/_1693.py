...
from mastapy.bearings.bearing_results.rolling import _1690
...
class LoadedAxialThrustNeedleRollerBearingResults(_1690.LoadedAxialThrustCylindricalRollerBearingResults):
    '''LoadedAxialThrustNeedleRollerBearingResults
