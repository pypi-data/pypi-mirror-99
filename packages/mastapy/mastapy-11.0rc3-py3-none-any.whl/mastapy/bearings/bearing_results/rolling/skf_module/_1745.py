...
from mastapy.bearings.bearing_results.rolling.skf_module import _1739, _1741
...
class Viscosities(_1741.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1739.OperatingViscosity':
        ...
        return constructor.new(_1739.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
