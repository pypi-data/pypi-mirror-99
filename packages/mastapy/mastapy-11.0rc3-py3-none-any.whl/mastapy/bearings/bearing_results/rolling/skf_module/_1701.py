...
from mastapy.bearings.bearing_results.rolling.skf_module import _1711, _1715
...
class BearingRatingLife(_1715.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1711.LifeModel':
        ...
        return constructor.new(_1711.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
