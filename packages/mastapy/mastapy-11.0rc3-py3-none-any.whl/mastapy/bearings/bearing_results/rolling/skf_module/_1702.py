...
from mastapy.bearings.bearing_results.rolling.skf_module import _1703, _1719
...
class AdjustedSpeed(_1719.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1703.AdjustmentFactors':
        ...
        return constructor.new(_1703.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
