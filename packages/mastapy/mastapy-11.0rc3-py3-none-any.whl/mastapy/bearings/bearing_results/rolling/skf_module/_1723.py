...
from mastapy.bearings.bearing_results.rolling.skf_module import _1724, _1740
...
class AdjustedSpeed(_1740.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1724.AdjustmentFactors':
        ...
        return constructor.new(_1724.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
