...
from mastapy.bearings.bearing_results.rolling.skf_module import _1725, _1741
...
class AdjustedSpeed(_1741.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1725.AdjustmentFactors':
        ...
        return constructor.new(_1725.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
