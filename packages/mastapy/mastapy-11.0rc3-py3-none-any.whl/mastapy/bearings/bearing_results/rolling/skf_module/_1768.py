...
from mastapy.bearings.bearing_results.rolling.skf_module import _1778, _1782
...
class BearingRatingLife(_1782.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1778.LifeModel':
        ...
        return constructor.new(_1778.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
