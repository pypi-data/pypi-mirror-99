...
from mastapy.bearings.bearing_results.rolling.skf_module import _1764, _1780
...
class AdjustedSpeed(_1780.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1764.AdjustmentFactors':
        ...
        return constructor.new(_1764.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
