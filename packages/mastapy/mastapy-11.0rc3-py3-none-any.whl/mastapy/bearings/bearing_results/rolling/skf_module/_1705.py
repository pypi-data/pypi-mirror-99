...
from mastapy.bearings.bearing_results.rolling.skf_module import _1715, _1719
...
class BearingRatingLife(_1719.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1715.LifeModel':
        ...
        return constructor.new(_1715.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
