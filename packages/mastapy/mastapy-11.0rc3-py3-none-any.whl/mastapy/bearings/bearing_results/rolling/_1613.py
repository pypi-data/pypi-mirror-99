...
from mastapy.bearings.bearing_results.rolling import _1610
...
class LoadedAngularContactThrustBallBearingResults(_1610.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
