...
from mastapy.bearings import _1603
...
class ISO14179SettingsPerBearingType(_1344.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1603.RollingBearingType':
        ...
        return constructor.new(_1603.RollingBearingType)(value) if value else None
