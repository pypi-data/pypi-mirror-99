...
from mastapy.bearings import _1538
...
class ISO14179SettingsPerBearingType(_1138.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1538.RollingBearingType':
        ...
        return constructor.new(_1538.RollingBearingType)(value) if value else None
    ...
    @property
    def iso14179_settings(self) -> '_1605.ISO14179Settings':
        ...
        return constructor.new(_1605.ISO14179Settings)(self.wrapped.ISO14179Settings) if self.wrapped.ISO14179Settings else None
