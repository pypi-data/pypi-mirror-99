...
from mastapy.bearings.bearing_results.rolling import _1669, _1710
...
class LoadedBallBearingElement(_1710.LoadedElement):
    '''LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1669.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceContactGeometries, constructor.new(_1669.BallBearingRaceContactGeometry))
        return value

    @property
    def outer_race_contact_geometries(self) -> 'List[_1669.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceContactGeometries, constructor.new(_1669.BallBearingRaceContactGeometry))
        return value
