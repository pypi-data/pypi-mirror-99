...
from mastapy.bearings.bearing_results.rolling import _1767, _1720
...
class LoadedCylindricalRollerBearingResults(_1720.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1767.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1767.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
