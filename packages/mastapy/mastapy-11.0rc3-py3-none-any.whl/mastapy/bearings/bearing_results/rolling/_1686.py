...
from mastapy.bearings.bearing_results.rolling import _1685, _1726
...
class LoadedAsymmetricSphericalRollerBearingRow(_1726.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1685.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1685.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
