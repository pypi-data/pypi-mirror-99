...
from mastapy.bearings.bearing_results.rolling import _1689
...
class LoadedAxialThrustNeedleRollerBearingElement(_1689.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
