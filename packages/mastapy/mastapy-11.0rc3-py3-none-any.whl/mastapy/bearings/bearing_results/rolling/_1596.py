...
class BallBearingRaceContactGeometry(_0.APIBase):
    ...
    @property
    def race_centre(self) -> '_1062.Vector2D':
        ...
        return constructor.new(_1062.Vector2D)(self.wrapped.RaceCentre) if self.wrapped.RaceCentre else None

    @property
    def ball_centre(self) -> '_1062.Vector2D':
        ...
        return constructor.new(_1062.Vector2D)(self.wrapped.BallCentre) if self.wrapped.BallCentre else None
