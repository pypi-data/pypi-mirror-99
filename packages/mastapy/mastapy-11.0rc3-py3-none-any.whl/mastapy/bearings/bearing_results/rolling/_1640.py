...
from mastapy.bearings.bearing_results.rolling import _1630
...
class LoadedAsymmetricSphericalRollerBearingStripLoadResults(_1630.LoadedAbstractSphericalRollerBearingStripLoadResults):
    '''LoadedAsymmetricSphericalRollerBearingStripLoadResults
