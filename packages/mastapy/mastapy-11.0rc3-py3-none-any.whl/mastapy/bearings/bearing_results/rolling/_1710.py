...
from mastapy.bearings.bearing_results.rolling import _1673, _1770, _1769
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1673.InternalClearance':
        ...
        if _1673.InternalClearance.TYPE not in self.wrapped.OperatingInternalClearance.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.OperatingInternalClearance.__class__)(self.wrapped.OperatingInternalClearance) if self.wrapped.OperatingInternalClearance else None

    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1769.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1769.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1769.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1769.StressAtPosition))
        return value
