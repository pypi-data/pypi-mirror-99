...
from mastapy.utility.property import (
    _1356, _1355, _1353, _1354
)
from mastapy.bearings.bearing_results.rolling import _1660, _1689
...
class LoadedRollingBearingDutyCycle(_1590.LoadedNonLinearBearingDutyCycleResults):
    '''LoadedRollingBearingDutyCycle
    ...
    @property
    def maximum_element_normal_stress_inner_summary(self) -> '_1356.DutyCyclePropertySummaryStress[_1660.LoadedRollingBearingResults]':
        ...
        return constructor.new(_1356.DutyCyclePropertySummaryStress)[_1660.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressInnerSummary) if self.wrapped.MaximumElementNormalStressInnerSummary else None

    @property
    def maximum_element_normal_stress_outer_summary(self) -> '_1356.DutyCyclePropertySummaryStress[_1660.LoadedRollingBearingResults]':
        ...
        return constructor.new(_1356.DutyCyclePropertySummaryStress)[_1660.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressOuterSummary) if self.wrapped.MaximumElementNormalStressOuterSummary else None

    @property
    def maximum_element_normal_stress_summary(self) -> '_1356.DutyCyclePropertySummaryStress[_1519.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1356.DutyCyclePropertySummaryStress)[_1519.BearingLoadCaseResultsLightweight](self.wrapped.MaximumElementNormalStressSummary) if self.wrapped.MaximumElementNormalStressSummary else None

    @property
    def misalignment_summary(self) -> '_1355.DutyCyclePropertySummarySmallAngle[_1519.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1355.DutyCyclePropertySummarySmallAngle)[_1519.BearingLoadCaseResultsLightweight](self.wrapped.MisalignmentSummary) if self.wrapped.MisalignmentSummary else None

    @property
    def iso2812007_dynamic_equivalent_load_summary(self) -> '_1353.DutyCyclePropertySummaryForce[_1519.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1353.DutyCyclePropertySummaryForce)[_1519.BearingLoadCaseResultsLightweight](self.wrapped.ISO2812007DynamicEquivalentLoadSummary) if self.wrapped.ISO2812007DynamicEquivalentLoadSummary else None

    @property
    def isots162812008_dynamic_equivalent_load_summary(self) -> '_1353.DutyCyclePropertySummaryForce[_1519.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1353.DutyCyclePropertySummaryForce)[_1519.BearingLoadCaseResultsLightweight](self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary) if self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary else None

    @property
    def maximum_truncation_summary(self) -> '_1354.DutyCyclePropertySummaryPercentage[_1519.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1354.DutyCyclePropertySummaryPercentage)[_1519.BearingLoadCaseResultsLightweight](self.wrapped.MaximumTruncationSummary) if self.wrapped.MaximumTruncationSummary else None

    @property
    def maximum_static_contact_stress_duty_cycle(self) -> '_1689.MaximumStaticContactStressDutyCycle':
        ...
        return constructor.new(_1689.MaximumStaticContactStressDutyCycle)(self.wrapped.MaximumStaticContactStressDutyCycle) if self.wrapped.MaximumStaticContactStressDutyCycle else None
