...
from mastapy.bearings.bearing_results.fluid_film import _1817, _1813
...
class LoadedPlainJournalBearingResults(_1813.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1817.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1817.LoadedPlainJournalBearingRow))
        return value
