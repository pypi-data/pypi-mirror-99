...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1522.BearingRow':
        ...
        return constructor.new(_1522.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
