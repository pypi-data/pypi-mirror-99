...
from mastapy.bearings.bearing_results.fluid_film import _1808, _1804
...
class LoadedPlainJournalBearingResults(_1804.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1808.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1808.LoadedPlainJournalBearingRow))
        return value
