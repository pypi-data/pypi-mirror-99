...
from mastapy.bearings.bearing_results.fluid_film import _1741
from mastapy.bearings.bearing_results import _1588
...
class LoadedPlainJournalBearingResults(_1588.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1741.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1741.LoadedPlainJournalBearingRow))
        return value
