...
from mastapy.bearings import _1520
...
class LinearBearing(_1744.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1520.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1520.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1520.BearingStiffnessMatrixOption'):
