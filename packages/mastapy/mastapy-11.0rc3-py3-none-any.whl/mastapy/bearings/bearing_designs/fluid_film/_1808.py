...
from mastapy.bearings.bearing_designs.fluid_film import _1800
...
class TiltingPadThrustBearing(_1800.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1542.TiltingPadTypes':
        ...
        return constructor.new(_1542.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1542.TiltingPadTypes'):
