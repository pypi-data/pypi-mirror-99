...
from mastapy.bearings import _1562
...
class TiltingPadThrustBearing(_1820.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1562.TiltingPadTypes':
        ...
        return constructor.new(_1562.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1562.TiltingPadTypes'):
