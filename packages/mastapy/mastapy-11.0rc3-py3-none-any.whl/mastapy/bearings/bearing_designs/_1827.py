...
from mastapy.bearings import _1589
...
class LinearBearing(_1824.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1589.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1589.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1589.BearingStiffnessMatrixOption'):
