...
from mastapy.bearings.bearing_designs.rolling import _1851, _1852, _1850
...
class NonBarrelRollerBearing(_1850.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1851.RollerEndShape':
        ...
        return constructor.new(_1851.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1851.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1852.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1852.RollerRibDetail))
        return value
