...
from mastapy.bearings.bearing_designs.rolling import _1775, _1776, _1774
...
class NonBarrelRollerBearing(_1774.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1775.RollerEndShape':
        ...
        return constructor.new(_1775.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1775.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1776.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1776.RollerRibDetail))
        return value
