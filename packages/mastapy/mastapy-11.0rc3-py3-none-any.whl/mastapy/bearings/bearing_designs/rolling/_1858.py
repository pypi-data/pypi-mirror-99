...
from mastapy.bearings import _1585
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import _1852, _1849
...
class TaperRollerBearing(_1849.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1585.BearingMeasurementType':
        ...
        return constructor.new(_1585.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1585.BearingMeasurementType'):
    ...
    def inner_ring_back_face_corner_radius(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.InnerRingBackFaceCornerRadius) if self.wrapped.InnerRingBackFaceCornerRadius else None
    ...
    def outer_ring_back_face_corner_radius(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.OuterRingBackFaceCornerRadius) if self.wrapped.OuterRingBackFaceCornerRadius else None
    ...
    def inner_ring_front_face_corner_radius(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.InnerRingFrontFaceCornerRadius) if self.wrapped.InnerRingFrontFaceCornerRadius else None
    ...
    def outer_ring_front_face_corner_radius(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.OuterRingFrontFaceCornerRadius) if self.wrapped.OuterRingFrontFaceCornerRadius else None
    ...
    @property
    def major_rib_detail(self) -> '_1852.RollerRibDetail':
        ...
        return constructor.new(_1852.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
