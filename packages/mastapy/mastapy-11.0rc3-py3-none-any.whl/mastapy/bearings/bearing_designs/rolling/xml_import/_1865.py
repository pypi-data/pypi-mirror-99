...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1866
...
class RollingBearingImporter(_0.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1866.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1866.XmlBearingTypeMapping))
        return value
