...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1810, _1809
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1810.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1810.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1809.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1809.AbstractXmlVariableAssignment))
        return value
