...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1860, _1859
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1860.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1860.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1859.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1859.AbstractXmlVariableAssignment))
        return value
