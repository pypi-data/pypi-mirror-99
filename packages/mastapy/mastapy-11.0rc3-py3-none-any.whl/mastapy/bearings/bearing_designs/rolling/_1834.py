...
from mastapy.bearings.bearing_designs.rolling import _1835, _1853
...
class BallBearing(_1853.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1835.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1835.BallBearingShoulderDefinition))
        return value
