...
from mastapy.bearings.bearing_designs.rolling import _1781, _1799
...
class BallBearing(_1799.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1781.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1781.BallBearingShoulderDefinition))
        return value
