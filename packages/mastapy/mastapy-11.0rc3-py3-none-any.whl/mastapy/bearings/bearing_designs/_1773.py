...
from mastapy.bearings import _1546
...
class LinearBearing(_1770.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1546.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1546.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1546.BearingStiffnessMatrixOption'):
