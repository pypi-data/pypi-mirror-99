...
from mastapy.bearings.bearing_designs.concept import _1883, _1885
...
class ConceptAxialClearanceBearing(_1885.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1883.BearingNodePosition':
        ...
        return constructor.new(_1883.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1883.BearingNodePosition'):
