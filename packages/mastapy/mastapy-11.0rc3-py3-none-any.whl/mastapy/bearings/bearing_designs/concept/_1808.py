...
from mastapy.bearings.bearing_designs.concept import _1807, _1809
...
class ConceptAxialClearanceBearing(_1809.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1807.BearingNodePosition':
        ...
        return constructor.new(_1807.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1807.BearingNodePosition'):
