...
from mastapy.bearings.bearing_designs.concept import _1803, _1805
...
class ConceptAxialClearanceBearing(_1805.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1803.BearingNodePosition':
        ...
        return constructor.new(_1803.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1803.BearingNodePosition'):
