...
from mastapy.bearings.bearing_designs.concept import _1872, _1874
...
class ConceptAxialClearanceBearing(_1874.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1872.BearingNodePosition':
        ...
        return constructor.new(_1872.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1872.BearingNodePosition'):
