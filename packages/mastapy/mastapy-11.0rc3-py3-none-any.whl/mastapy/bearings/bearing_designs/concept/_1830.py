...
from mastapy.bearings.bearing_designs.concept import _1829, _1831
...
class ConceptAxialClearanceBearing(_1831.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1829.BearingNodePosition':
        ...
        return constructor.new(_1829.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1829.BearingNodePosition'):
