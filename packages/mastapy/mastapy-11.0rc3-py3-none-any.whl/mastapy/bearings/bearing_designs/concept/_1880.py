...
from mastapy.bearings.bearing_designs.concept import _1879, _1881
...
class ConceptAxialClearanceBearing(_1881.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1879.BearingNodePosition':
        ...
        return constructor.new(_1879.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1879.BearingNodePosition'):
