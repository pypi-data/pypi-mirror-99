...
from mastapy.bearings.tolerances import _1558, _1555
...
class RoundnessSpecification(_1138.IndependentReportablePropertiesBase['RoundnessSpecification']):
    '''RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1558.RoundnessSpecificationType':
        ...
        return constructor.new(_1558.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1558.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def roundness_distribution(self) -> 'List[_1555.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1555.RaceRoundnessAtAngle))
        return value
