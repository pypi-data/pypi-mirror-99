...
from mastapy.bearings.tolerances import _1609, _1606
...
class InterferenceTolerance(_1606.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1609.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1609.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1595.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1595.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1595.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
