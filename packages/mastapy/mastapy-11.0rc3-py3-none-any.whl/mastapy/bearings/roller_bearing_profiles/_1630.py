...
from mastapy.bearings import _1596
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.bearings.roller_bearing_profiles import (
    _1638, _1632, _1633, _1634,
    _1635, _1636, _1637, _1639
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1596.RollerBearingProfileTypes':
        ...
        return constructor.new(_1596.RollerBearingProfileTypes)(value) if value else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1596.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1638.RollerBearingProfile':
        ...
        if _1638.RollerBearingProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1632.RollerBearingConicalProfile':
        ...
        if _1632.RollerBearingConicalProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1633.RollerBearingCrownedProfile':
        ...
        if _1633.RollerBearingCrownedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1634.RollerBearingDinLundbergProfile':
        ...
        if _1634.RollerBearingDinLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1635.RollerBearingFlatProfile':
        ...
        if _1635.RollerBearingFlatProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1636.RollerBearingJohnsGoharProfile':
        ...
        if _1636.RollerBearingJohnsGoharProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1637.RollerBearingLundbergProfile':
        ...
        if _1637.RollerBearingLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1639.RollerBearingUserSpecifiedProfile':
        ...
        if _1639.RollerBearingUserSpecifiedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
