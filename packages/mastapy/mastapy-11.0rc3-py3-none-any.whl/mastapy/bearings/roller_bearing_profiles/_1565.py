...
from mastapy.bearings import _1533
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.bearings.roller_bearing_profiles import (
    _1573, _1567, _1568, _1569,
    _1570, _1571, _1572, _1574
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1533.RollerBearingProfileTypes':
        ...
        return constructor.new(_1533.RollerBearingProfileTypes)(value) if value else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1533.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1573.RollerBearingProfile':
        ...
        if _1573.RollerBearingProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1567.RollerBearingConicalProfile':
        ...
        if _1567.RollerBearingConicalProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1568.RollerBearingCrownedProfile':
        ...
        if _1568.RollerBearingCrownedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1569.RollerBearingDinLundbergProfile':
        ...
        if _1569.RollerBearingDinLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1570.RollerBearingFlatProfile':
        ...
        if _1570.RollerBearingFlatProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1571.RollerBearingJohnsGoharProfile':
        ...
        if _1571.RollerBearingJohnsGoharProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1572.RollerBearingLundbergProfile':
        ...
        if _1572.RollerBearingLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1574.RollerBearingUserSpecifiedProfile':
        ...
        if _1574.RollerBearingUserSpecifiedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
