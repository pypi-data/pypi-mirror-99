...
from mastapy.bearings import (
    _1533, _1532, _1525, _1526
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1720
...
class BearingSettings(_1143.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life(self) -> '_1532.RatingLife':
        ...
        return constructor.new(_1532.RatingLife)(value) if value else None

    @failure_probability_for_rating_life.setter
    def failure_probability_for_rating_life(self, value: '_1532.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1525.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1525.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1525.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1720.SKFCredentials':
        ...
        return constructor.new(_1720.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
