...
class ISOCylindricalGearMaterial(_538.CylindricalGearMaterial):
    '''ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self) -> '_242.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_242.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_242.QualityGrade'):
