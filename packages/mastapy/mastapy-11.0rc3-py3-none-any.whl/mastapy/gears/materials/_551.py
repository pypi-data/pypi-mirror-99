...
from mastapy.materials import _252, _249, _250
from mastapy.gears.materials import _550
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self) -> '_252.VDI2736LubricantType':
        ...
        return constructor.new(_252.VDI2736LubricantType)(value) if value else None

    @lubricant.setter
    def lubricant(self, value: '_252.VDI2736LubricantType'):
    ...
    @property
    def material(self) -> '_550.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_550.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def bending_stress_cycle_data(self) -> 'List[_249.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleData, constructor.new(_249.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data(self) -> 'List[_250.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleData, constructor.new(_250.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value

    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_249.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleDataForDamageTables, constructor.new(_249.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_250.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleDataForDamageTables, constructor.new(_250.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
