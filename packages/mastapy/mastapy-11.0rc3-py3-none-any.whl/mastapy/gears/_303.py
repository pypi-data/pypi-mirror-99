...
from mastapy.math_utility import _1273
...
class PocketingPowerLossCoefficients(_1556.NamedDatabaseItem):
    '''PocketingPowerLossCoefficients
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_307.SpecificationForTheEffectOfOilKinematicViscosity]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecificationsForTheEffectOfOilKinematicViscosity, constructor.new(_307.SpecificationForTheEffectOfOilKinematicViscosity))
        return value
