...
class OptimisationTarget(_0.APIBase, Generic[T]):
    ...
    @property
    def input_setters(self) -> 'List[_1113.InputSetter[T]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1113.InputSetter)[T])
        return value
