...
from mastapy.gears.gear_set_pareto_optimiser import _845
...
class StraightBevelGearSetParetoOptimiser(_845.GearSetParetoOptimiser):
    '''StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_897.StraightBevelGearSetDesign':
        ...
        return constructor.new(_897.StraightBevelGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_897.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_897.StraightBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_897.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_897.StraightBevelGearSetDesign))
        return value
