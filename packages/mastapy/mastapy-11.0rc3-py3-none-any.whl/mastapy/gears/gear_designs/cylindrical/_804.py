...
from mastapy.gears.gear_designs.cylindrical import _767, _802
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_767.CreateNewSuitableCutterOption':
        ...
        return constructor.new(_767.CreateNewSuitableCutterOption)(value) if value else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_767.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CreateNewSuitableCutters = value

    @property
    def use_as_design_mode_geometry(self) -> '_767.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_767.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_802.GearManufacturingConfigSetupViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_802.GearManufacturingConfigSetupViewModel))
        return value
