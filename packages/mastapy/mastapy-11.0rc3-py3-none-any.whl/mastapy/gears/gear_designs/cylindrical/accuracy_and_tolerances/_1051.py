...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1050
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_1050.CylindricalAccuracyGrader):
    '''CylindricalAccuracyGraderWithProfileFormAndSlope
