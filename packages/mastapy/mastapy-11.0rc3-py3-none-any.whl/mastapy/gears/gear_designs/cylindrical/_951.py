...
from mastapy.gears.gear_designs.cylindrical import _952, _936
...
class CylindricalGearPinionTypeCutter(_936.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_952.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_952.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_952.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_952.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
