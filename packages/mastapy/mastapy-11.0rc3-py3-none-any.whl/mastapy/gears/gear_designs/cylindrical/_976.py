...
from mastapy.gears.gear_designs.cylindrical import _932, _974
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_932.CreateNewSuitableCutterOption':
        ...
        return constructor.new(_932.CreateNewSuitableCutterOption)(value) if value else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_932.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CreateNewSuitableCutters = value

    @property
    def use_as_design_mode_geometry(self) -> '_932.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_932.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_974.GearManufacturingConfigSetupViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_974.GearManufacturingConfigSetupViewModel))
        return value
