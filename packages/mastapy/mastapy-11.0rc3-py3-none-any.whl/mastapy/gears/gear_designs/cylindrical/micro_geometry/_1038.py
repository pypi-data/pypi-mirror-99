...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1037
...
class MeshedCylindricalGearMicroGeometry(_0.APIBase):
    ...
    @property
    def flanks(self) -> 'List[_1037.MeshedCylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1037.MeshedCylindricalGearFlankMicroGeometry))
        return value
