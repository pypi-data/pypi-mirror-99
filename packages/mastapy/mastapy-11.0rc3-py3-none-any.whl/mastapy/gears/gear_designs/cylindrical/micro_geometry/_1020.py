...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1019
...
class CylindricalGearLeadModificationAtProfilePosition(_1019.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_953.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_953.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
