...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self) -> '_651.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_651.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver else None
