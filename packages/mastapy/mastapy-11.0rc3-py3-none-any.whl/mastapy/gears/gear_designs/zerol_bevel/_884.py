...
from mastapy.gears.gear_designs.zerol_bevel import _882, _883
...
class ZerolBevelGearSetDesign(_1093.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_313.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_313.ZerolBevelGleasonToothTaperOption)(value) if value else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_313.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_882.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_882.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_882.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_882.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_883.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_883.ZerolBevelGearMeshDesign))
        return value
