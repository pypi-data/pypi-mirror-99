...
from mastapy.gears.gear_designs.worm import _886
...
class WormDesign(_886.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_310.WormAddendumFactor':
        ...
        return constructor.new(_310.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_310.WormAddendumFactor'):
