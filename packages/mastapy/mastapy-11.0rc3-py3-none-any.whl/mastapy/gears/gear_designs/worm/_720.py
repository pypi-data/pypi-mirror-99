...
from mastapy.gears.gear_designs.worm import _721
...
class WormDesign(_721.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_150.WormAddendumFactor':
        ...
        return constructor.new(_150.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_150.WormAddendumFactor'):
