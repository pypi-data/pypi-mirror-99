...
from mastapy.gears.materials import _384
...
class KlingelnbergConicalGearDesign(_889.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_384.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_384.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
