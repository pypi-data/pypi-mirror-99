...
from mastapy.gears.materials import _547
...
class KlingelnbergConicalGearDesign(_1064.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_547.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_547.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
