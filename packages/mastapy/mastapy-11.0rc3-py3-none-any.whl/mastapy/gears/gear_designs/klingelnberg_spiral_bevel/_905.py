...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _903, _904
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(_913.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_903.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_903.KlingelnbergCycloPalloidSpiralBevelGearDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_903.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGears, constructor.new(_903.KlingelnbergCycloPalloidSpiralBevelGearDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_904.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_904.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_904.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_904.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value
