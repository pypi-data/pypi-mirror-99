...
from mastapy.gears.gear_designs.bevel import _1096, _1091
...
class StraightBevelDiffGearDesign(_1091.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1096.EdgeRadiusType':
        ...
        return constructor.new(_1096.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1096.EdgeRadiusType'):
