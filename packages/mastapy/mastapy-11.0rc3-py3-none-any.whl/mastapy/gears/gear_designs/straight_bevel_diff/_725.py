...
from mastapy.gears.gear_designs.bevel import _920, _915
...
class StraightBevelDiffGearDesign(_915.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_920.EdgeRadiusType':
        ...
        return constructor.new(_920.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_920.EdgeRadiusType'):
