...
from mastapy.gears.gear_designs.bevel import _1095, _1090
...
class StraightBevelDiffGearDesign(_1090.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1095.EdgeRadiusType':
        ...
        return constructor.new(_1095.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1095.EdgeRadiusType'):
