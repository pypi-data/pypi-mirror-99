...
from mastapy.gears.gear_designs.concept import _1087, _1088
...
class ConceptGearSetDesign(_880.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_1087.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1087.ConceptGearDesign))
        return value
    ...
    @property
    def concept_meshes(self) -> 'List[_1088.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1088.ConceptGearMeshDesign))
        return value
