...
from mastapy.utility.property import _1562
from mastapy.gears.gear_designs import _874
...
class DesignConstraintsCollection(_1556.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1562.DeletableCollectionMember[_874.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1562.DeletableCollectionMember)[_874.DesignConstraint])
        return value
