...
class GearDesign(_878.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1108.GearFEModel':
        ...
        if _1108.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1112.CylindricalGearFEModel':
        ...
        if _1112.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1115.ConicalGearFEModel':
        ...
        if _1115.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
