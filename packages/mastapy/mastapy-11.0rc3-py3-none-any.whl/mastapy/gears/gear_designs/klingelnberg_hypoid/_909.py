...
from mastapy.gears.gear_designs.klingelnberg_hypoid import _907, _908
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(_913.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidHypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_907.KlingelnbergCycloPalloidHypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_907.KlingelnbergCycloPalloidHypoidGearDesign))
        return value
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_908.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_908.KlingelnbergCycloPalloidHypoidGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_908.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshes, constructor.new(_908.KlingelnbergCycloPalloidHypoidGearMeshDesign))
        return value
