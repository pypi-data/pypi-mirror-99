...
from mastapy.gears.rating.concept import _498, _499
...
class ConceptGearSetRating(_324.GearSetRating):
    '''ConceptGearSetRating
    ...
    @property
    def concept_mesh_ratings(self) -> 'List[_498.ConceptGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshRatings, constructor.new(_498.ConceptGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_499.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_499.ConceptGearRating))
        return value
