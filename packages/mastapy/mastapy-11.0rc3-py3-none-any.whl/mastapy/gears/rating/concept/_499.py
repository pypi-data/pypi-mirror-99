...
from mastapy.gears.rating import _320, _322
...
class ConceptGearRating(_322.GearRating):
    '''ConceptGearRating
    ...
    @property
    def concept_gear(self) -> '_1087.ConceptGearDesign':
        ...
        return constructor.new(_1087.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
