...
from mastapy.gears.rating.conical import _489, _488
from mastapy._internal import constructor, conversion
from mastapy.gears.rating import _320, _319
from mastapy.gears.rating.cylindrical import _414, _415
...
class ConicalGearDutyCycleRating(_319.GearDutyCycleRating):
    '''ConicalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_489.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_489.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_489.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_489.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle else None
    ...
    @property
    def concave_flank_rating(self) -> '_320.GearFlankRating':
        ...
        if _320.GearFlankRating.TYPE not in self.wrapped.ConcaveFlankRating.__class__.__mro__:
    ...
    @property
    def convex_flank_rating(self) -> '_320.GearFlankRating':
        ...
        if _320.GearFlankRating.TYPE not in self.wrapped.ConvexFlankRating.__class__.__mro__:
    ...
    @property
    def gear_ratings(self) -> 'List[_488.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_488.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_488.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_488.ConicalGearRating))
        return value
