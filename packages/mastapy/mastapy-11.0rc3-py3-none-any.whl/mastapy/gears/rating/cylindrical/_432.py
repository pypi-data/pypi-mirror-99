...
class MeshRatingForReports(_0.APIBase):
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_416.CylindricalGearMeshRating':
        ...
        return constructor.new(_416.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating else None
