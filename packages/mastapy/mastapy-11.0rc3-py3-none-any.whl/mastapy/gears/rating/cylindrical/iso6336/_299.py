...
from mastapy.gears.rating.cylindrical.iso6336 import _314
...
class CylindricalGearToothFatigueFractureResults(_0.APIBase):
    ...
    @property
    def critical_section(self) -> '_314.ToothFlankFractureAnalysisContactPoint':
        ...
        return constructor.new(_314.ToothFlankFractureAnalysisContactPoint)(self.wrapped.CriticalSection) if self.wrapped.CriticalSection else None

    @property
    def analysis_rows(self) -> 'List[_314.ToothFlankFractureAnalysisContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AnalysisRows, constructor.new(_314.ToothFlankFractureAnalysisContactPoint))
        return value
