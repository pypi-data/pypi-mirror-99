...
from mastapy.gears.gear_designs.cylindrical import _999
...
class ISO6336AbstractMetalMeshSingleFlankRating(_473.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_437.ScuffingFlashTemperatureRatingMethod':
        ...
        return constructor.new(_437.ScuffingFlashTemperatureRatingMethod)(value) if value else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_438.ScuffingIntegralTemperatureRatingMethod':
        ...
        return constructor.new(_438.ScuffingIntegralTemperatureRatingMethod)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_999.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_999.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_417.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_417.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_469.ISO63362006MeshSingleFlankRating':
        ...
        if _469.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.SingleFlankRatingOfTestGearsForMicropitting.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_474.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_474.ISO6336AbstractMetalGearSingleFlankRating))
        return value
