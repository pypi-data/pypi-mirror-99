...
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _451
from mastapy.materials import _249, _250
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_472.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_318.FlankLoadingState':
        ...
        return constructor.new(_318.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_451.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_451.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
