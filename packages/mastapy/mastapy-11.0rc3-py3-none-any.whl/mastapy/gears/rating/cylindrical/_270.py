...
class MeshRatingForReports(_0.APIBase):
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_254.CylindricalGearMeshRating':
        ...
        return constructor.new(_254.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating else None
