...
from mastapy.gears.gear_designs.cylindrical import _785, _824
from mastapy.materials import _59
from mastapy.gears.rating.cylindrical.agma import _318
...
class AGMA2101MeshSingleFlankRating(_264.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_824.ScuffingTemperatureMethodsAGMA':
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_318.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_318.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_318.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_318.AGMA2101GearSingleFlankRating))
        return value
