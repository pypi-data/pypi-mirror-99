...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_310.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        if _310.ISO6336AbstractMetalGearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_302.ISO63361996GearSingleFlankRating':
        ...
        if _302.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_304.ISO63362006GearSingleFlankRating':
        ...
        if _304.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_306.ISO63362019GearSingleFlankRating':
        ...
        if _306.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_317.DIN3990GearSingleFlankRating':
        ...
        if _317.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
