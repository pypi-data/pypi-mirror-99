...
class CylindricalGearRatingSettings(_1349.PerMachineSettings):
    '''CylindricalGearRatingSettings
    ...
    @property
    def tip_relief_in_scuffing_calculation(self) -> '_442.TipReliefScuffingOptions':
        ...
        return constructor.new(_442.TipReliefScuffingOptions)(value) if value else None

    @tip_relief_in_scuffing_calculation.setter
    def tip_relief_in_scuffing_calculation(self, value: '_442.TipReliefScuffingOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TipReliefInScuffingCalculation = value

    @property
    def dynamic_factor_method(self) -> '_429.DynamicFactorMethods':
        ...
        return constructor.new(_429.DynamicFactorMethods)(value) if value else None

    @dynamic_factor_method.setter
    def dynamic_factor_method(self, value: '_429.DynamicFactorMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_blank_factor_calculation_option(self) -> '_430.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_430.GearBlankFactorCalculationOptions)(value) if value else None

    @gear_blank_factor_calculation_option.setter
    def gear_blank_factor_calculation_option(self, value: '_430.GearBlankFactorCalculationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def film_thickness_equation_for_scuffing(self) -> '_439.ScuffingMethods':
        ...
        return constructor.new(_439.ScuffingMethods)(value) if value else None

    @film_thickness_equation_for_scuffing.setter
    def film_thickness_equation_for_scuffing(self, value: '_439.ScuffingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FilmThicknessEquationForScuffing = value

    @property
    def micropitting_rating_method(self) -> '_433.MicropittingRatingMethod':
        ...
        return constructor.new(_433.MicropittingRatingMethod)(value) if value else None

    @micropitting_rating_method.setter
    def micropitting_rating_method(self, value: '_433.MicropittingRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def scuffing_rating_method_flash_temperature_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ScuffingFlashTemperatureRatingMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ScuffingRatingMethodFlashTemperatureMethod, value) if self.wrapped.ScuffingRatingMethodFlashTemperatureMethod else None
    ...
    def scuffing_rating_method_integral_temperature_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ScuffingIntegralTemperatureRatingMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ScuffingRatingMethodIntegralTemperatureMethod, value) if self.wrapped.ScuffingRatingMethodIntegralTemperatureMethod else None
    ...
    @property
    def permissible_bending_stress_method(self) -> '_436.RatingMethod':
        ...
        return constructor.new(_436.RatingMethod)(value) if value else None

    @permissible_bending_stress_method.setter
    def permissible_bending_stress_method(self, value: '_436.RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chosen_tooth_thickness_for_bending_strength(self) -> '_443.ToothThicknesses':
        ...
        return constructor.new(_443.ToothThicknesses)(value) if value else None

    @chosen_tooth_thickness_for_bending_strength.setter
    def chosen_tooth_thickness_for_bending_strength(self, value: '_443.ToothThicknesses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
