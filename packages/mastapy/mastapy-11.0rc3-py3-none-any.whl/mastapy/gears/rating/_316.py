...
from mastapy.gears.rating import _315, _314
...
class AbstractGearSetRating(_1125.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_315.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_315.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_314.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_314.AbstractGearMeshRating))
        return value
