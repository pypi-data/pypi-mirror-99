...
from mastapy.gears.rating.worm import _174, _173
...
class WormGearDutyCycleRating(_157.GearDutyCycleRating):
    '''WormGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_174.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_174.WormGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def worm_gear_set_design_duty_cycle(self) -> '_174.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_174.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDesignDutyCycle) if self.wrapped.WormGearSetDesignDutyCycle else None
