...
from mastapy.gears.gear_designs.worm import _887, _886, _890
...
class WormGearRating(_322.GearRating):
    '''WormGearRating
    ...
    @property
    def worm_gear(self) -> '_887.WormGearDesign':
        ...
        if _887.WormGearDesign.TYPE not in self.wrapped.WormGear.__class__.__mro__:
