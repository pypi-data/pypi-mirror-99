...
from mastapy.gears.rating.worm import _336, _335
...
class WormGearDutyCycleRating(_319.GearDutyCycleRating):
    '''WormGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_336.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_336.WormGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def worm_gear_set_design_duty_cycle(self) -> '_336.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_336.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDesignDutyCycle) if self.wrapped.WormGearSetDesignDutyCycle else None
