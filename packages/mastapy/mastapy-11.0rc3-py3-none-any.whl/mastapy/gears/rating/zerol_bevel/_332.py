...
from mastapy.gears.rating.zerol_bevel import _330, _331
...
class ZerolBevelGearSetRating(_504.BevelGearSetRating):
    '''ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_mesh_ratings(self) -> 'List[_330.ZerolBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshRatings, constructor.new(_330.ZerolBevelGearMeshRating))
        return value
