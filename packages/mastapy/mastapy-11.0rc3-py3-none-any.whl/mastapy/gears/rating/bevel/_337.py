...
from mastapy.gears.rating.bevel.standards import _343, _341
from mastapy.gears.rating.iso_10300 import _224, _222
...
class BevelGearMeshRating(_348.AGMAGleasonConicalGearMeshRating):
    '''BevelGearMeshRating
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_343.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_343.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_341.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_341.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_224.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_224.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_222.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_222.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 else None
