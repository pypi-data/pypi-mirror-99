...
class KlingelnbergCycloPalloidHypoidGearRating(_373.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_907.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_907.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
