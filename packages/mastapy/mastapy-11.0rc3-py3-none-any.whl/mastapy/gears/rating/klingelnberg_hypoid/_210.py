...
from mastapy.gears.rating.klingelnberg_hypoid import _208, _209
...
class KlingelnbergCycloPalloidHypoidGearSetRating(_213.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidHypoidGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(self) -> 'List[_208.KlingelnbergCycloPalloidHypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshRatings, constructor.new(_208.KlingelnbergCycloPalloidHypoidGearMeshRating))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_ratings(self) -> 'List[_209.KlingelnbergCycloPalloidHypoidGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearRatings, constructor.new(_209.KlingelnbergCycloPalloidHypoidGearRating))
        return value
