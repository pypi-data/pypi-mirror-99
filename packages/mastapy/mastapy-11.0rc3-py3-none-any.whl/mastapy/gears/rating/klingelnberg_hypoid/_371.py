...
from mastapy.gears.rating.klingelnberg_hypoid import _369, _370
...
class KlingelnbergCycloPalloidHypoidGearSetRating(_374.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidHypoidGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(self) -> 'List[_369.KlingelnbergCycloPalloidHypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshRatings, constructor.new(_369.KlingelnbergCycloPalloidHypoidGearMeshRating))
        return value
