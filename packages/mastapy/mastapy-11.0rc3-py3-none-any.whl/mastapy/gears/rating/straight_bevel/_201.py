...
from mastapy.gears.rating.straight_bevel import _199, _200
...
class StraightBevelGearSetRating(_340.BevelGearSetRating):
    '''StraightBevelGearSetRating
    ...
    @property
    def straight_bevel_mesh_ratings(self) -> 'List[_199.StraightBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshRatings, constructor.new(_199.StraightBevelGearMeshRating))
        return value

    @property
    def straight_bevel_gear_ratings(self) -> 'List[_200.StraightBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearRatings, constructor.new(_200.StraightBevelGearRating))
        return value
