...
class StraightBevelGearRating(_503.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_895.StraightBevelGearDesign':
        ...
        return constructor.new(_895.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
