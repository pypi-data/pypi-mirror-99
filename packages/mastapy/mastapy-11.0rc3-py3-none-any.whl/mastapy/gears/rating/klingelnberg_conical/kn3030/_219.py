...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _216, _214
...
class KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating(_214.KlingelnbergConicalMeshSingleFlankRating):
    '''KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_216.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_216.KlingelnbergCycloPalloidConicalGearSingleFlankRating))
        return value

    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_216.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KN3030KlingelnbergGearSingleFlankRatings, constructor.new(_216.KlingelnbergCycloPalloidConicalGearSingleFlankRating))
        return value
