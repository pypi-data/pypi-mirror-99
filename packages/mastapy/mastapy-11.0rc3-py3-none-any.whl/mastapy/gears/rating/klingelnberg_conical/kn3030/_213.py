...
from mastapy.gears.rating.virtual_cylindrical_gears import _186
...
class KlingelnbergConicalMeshSingleFlankRating(_165.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_186.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_186.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
