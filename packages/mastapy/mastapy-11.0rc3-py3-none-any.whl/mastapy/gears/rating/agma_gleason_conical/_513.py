...
from mastapy.gears.gear_designs.conical import _1080
...
class AGMAGleasonConicalGearMeshRating(_487.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1080.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1080.LoadDistributionFactorMethods)(value) if value else None
