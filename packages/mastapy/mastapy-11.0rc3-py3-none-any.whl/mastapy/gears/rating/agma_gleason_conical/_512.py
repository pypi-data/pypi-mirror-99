...
from mastapy.gears.gear_designs.conical import _1079
...
class AGMAGleasonConicalGearMeshRating(_486.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1079.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1079.LoadDistributionFactorMethods)(value) if value else None
