...
from mastapy.gears.rating.straight_bevel_diff import _356, _357
...
class StraightBevelDiffGearSetRating(_490.ConicalGearSetRating):
    '''StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_356.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_356.StraightBevelDiffGearMeshRating))
        return value
