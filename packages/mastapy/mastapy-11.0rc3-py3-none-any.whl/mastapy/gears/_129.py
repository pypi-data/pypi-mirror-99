...
from mastapy.math_utility.optimisation import _1116
...
class GearSetOptimisationResult(_0.APIBase):
    ...
    def gear_set(self) -> '_715.GearSetDesign':
        ...
        if _715.GearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_conical_gear_set_design(self) -> '_892.ConicalGearSetDesign':
    ...
    @property
    def gear_set_of_type_concept_gear_set_design(self) -> '_914.ConceptGearSetDesign':
        ...
        if _914.ConceptGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def rating(self) -> '_154.AbstractGearSetRating':
        ...
        if _154.AbstractGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_gear_set_duty_cycle_rating(self) -> '_161.GearSetDutyCycleRating':
        ...
        if _161.GearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_gear_set_rating(self) -> '_162.GearSetRating':
    ...
    @property
    def rating_of_type_worm_gear_set_duty_cycle_rating(self) -> '_174.WormGearSetDutyCycleRating':
        ...
        if _174.WormGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_face_gear_set_duty_cycle_rating(self) -> '_248.FaceGearSetDutyCycleRating':
        ...
        if _248.FaceGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_cylindrical_gear_set_duty_cycle_rating(self) -> '_260.CylindricalGearSetDutyCycleRating':
        ...
        if _260.CylindricalGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def optimisation_history(self) -> '_1116.OptimisationHistory':
        '''OptimisationHistory: 'OptimisationHistory' is the original name of this property.'''

        return constructor.new(_1116.OptimisationHistory)(self.wrapped.OptimisationHistory) if self.wrapped.OptimisationHistory else None

    @optimisation_history.setter
    def optimisation_history(self, value: '_1116.OptimisationHistory'):
