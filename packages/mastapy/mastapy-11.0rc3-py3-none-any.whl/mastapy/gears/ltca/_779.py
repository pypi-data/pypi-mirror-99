...
from mastapy.gears.ltca import _780, _778
...
class GearMeshLoadDistributionAnalysis(_1131.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1276.FourierSeries':
        ...
        return constructor.new(_1276.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_780.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_780.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_778.GearLoadDistributionAnalysis', flank: '_287.GearFlanks', stress_type: '_79.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_778.GearLoadDistributionAnalysis', stress_type: '_79.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
