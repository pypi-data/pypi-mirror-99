...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_616.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_616.GearMeshLoadedContactLine))
        return value
