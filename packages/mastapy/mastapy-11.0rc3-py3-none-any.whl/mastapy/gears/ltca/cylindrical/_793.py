...
from mastapy.gears.ltca import _773, _779
from mastapy.gears.ltca.cylindrical import _795, _797
...
class CylindricalGearMeshLoadDistributionAnalysis(_779.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_820.CylindricalMeshLoadCase':
        ...
        return constructor.new(_820.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase else None

    @property
    def gear_a_in_mesh(self) -> '_773.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_773.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh else None

    @property
    def gear_b_in_mesh(self) -> '_773.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_773.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_797.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_797.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_773.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_773.CylindricalMeshedGearLoadDistributionAnalysis))
        return value
