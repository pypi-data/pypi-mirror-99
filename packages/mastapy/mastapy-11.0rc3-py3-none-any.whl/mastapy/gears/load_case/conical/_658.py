...
from mastapy.gears.gear_designs.conical import _886, _896
...
class ConicalMeshLoadCase(_646.MeshLoadCase):
    '''ConicalMeshLoadCase
    ...
    @property
    def active_flank(self) -> '_886.ActiveConicalFlank':
        ...
        return constructor.new(_886.ActiveConicalFlank)(value) if value else None
