...
from mastapy.gears import _123, _122
...
class CylindricalMeshLoadCase(_646.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_123.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_123.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_123.CylindricalMisalignmentDataSource'):
