...
from mastapy.gears.fe_model import _934, _933
...
class GearSetFEModel(_964.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_934.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_934.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_933.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_933.GearFEModel))
        return value
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_6571.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
