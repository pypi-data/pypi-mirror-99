...
from mastapy.gears.fe_model import _1109
...
class GearFEModel(_1128.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1109.GearMeshingElementOptions':
        ...
        return constructor.new(_1109.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_286.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_286.GearFlanks', progress: '_7187.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7187.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
