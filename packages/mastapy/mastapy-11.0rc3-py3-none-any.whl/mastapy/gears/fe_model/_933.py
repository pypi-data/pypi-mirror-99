...
class GearFEModel(_954.GearImplementationDetail):
    '''GearFEModel
    ...
    def get_stress_influence_coefficients_from_fe(self, flank: '_125.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_125.GearFlanks', progress: '_6571.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
