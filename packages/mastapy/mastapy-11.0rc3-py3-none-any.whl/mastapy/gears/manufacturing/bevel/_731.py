...
from mastapy.gears.manufacturing.bevel import _742, _726
...
class ConicalMeshManufacturingAnalysis(_1131.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_742.EaseOffBasedTCA':
        ...
        return constructor.new(_742.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_726.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_726.ConicalMeshedGearManufacturingAnalysis))
        return value
