...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _768
...
class BasicConicalGearMachineSettingsGenerated(_768.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
