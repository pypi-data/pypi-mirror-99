...
class PinionConvex(_0.APIBase):
    ...
    @property
    def pinion_convex_ib_configuration(self) -> '_770.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_770.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None
