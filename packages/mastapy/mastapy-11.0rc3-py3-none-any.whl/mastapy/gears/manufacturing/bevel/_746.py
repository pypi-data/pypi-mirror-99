...
from mastapy.gears.manufacturing.bevel import _745, _759
...
class ManufacturingMachine(_1556.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_745.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_745.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_745.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_759.WheelFormatMachineTypes':
        ...
        return constructor.new(_759.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_759.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
