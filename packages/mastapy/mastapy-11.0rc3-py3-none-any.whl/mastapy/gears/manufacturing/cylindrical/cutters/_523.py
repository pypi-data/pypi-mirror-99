...
class RoughCutterCreationSettings(_0.APIBase):
    ...
    @property
    def rough_tool_clearances(self) -> '_496.ManufacturingOperationConstraints':
        ...
        return constructor.new(_496.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances else None

    @property
    def finish_tool_clearances(self) -> '_496.ManufacturingOperationConstraints':
        ...
        return constructor.new(_496.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances else None
