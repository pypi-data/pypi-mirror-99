...
from mastapy.gears.manufacturing.cylindrical.cutters import _512, _508, _509
...
class RackShape(_523.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_512.CylindricalGearRackDesign':
