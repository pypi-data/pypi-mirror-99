...
from mastapy.gears.manufacturing.cylindrical import _580, _584
...
class MicroGeometryInputsProfile(_580.MicroGeometryInputs['_584.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1251.Range':
        ...
        if _1251.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
