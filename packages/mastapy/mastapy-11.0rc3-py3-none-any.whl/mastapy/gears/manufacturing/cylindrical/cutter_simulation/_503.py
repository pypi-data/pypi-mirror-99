...
class WormGrinderSimulationCalculator(_498.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_529.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_529.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
