...
class HobSimulationCalculator(_662.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_690.CylindricalGearHobShape':
        ...
        return constructor.new(_690.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
