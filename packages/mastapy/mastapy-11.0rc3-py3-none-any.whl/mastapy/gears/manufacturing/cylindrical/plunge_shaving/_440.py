...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _434
...
class VirtualPlungeShaverOutputs(_434.PlungeShaverOutputs):
    '''VirtualPlungeShaverOutputs
    ...
    @property
    def lead_modification_on_conjugate_shaver_chart_left_flank(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank) if self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank else None

    @property
    def lead_modification_on_conjugate_shaver_chart_right_flank(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartRightFlank) if self.wrapped.LeadModificationOnConjugateShaverChartRightFlank else None

    @property
    def shaver(self) -> '_516.CylindricalGearShaver':
        ...
        if _516.CylindricalGearShaver.TYPE not in self.wrapped.Shaver.__class__.__mro__:
