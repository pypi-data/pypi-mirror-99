...
class SuitableCutterSetup(_0.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_495.ManufacturingOperationConstraints':
        ...
        return constructor.new(_495.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
