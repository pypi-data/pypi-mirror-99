...
class ShavingDynamics(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_770.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_770.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
