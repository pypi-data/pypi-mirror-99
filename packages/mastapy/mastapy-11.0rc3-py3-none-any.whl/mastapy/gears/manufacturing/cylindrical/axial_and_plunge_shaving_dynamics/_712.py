...
from mastapy.gears.gear_designs.cylindrical import _935
...
class ShavingDynamics(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_935.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_935.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
