...
from mastapy.gears.manufacturing.cylindrical import _580, _579
...
class MicroGeometryInputsLead(_580.MicroGeometryInputs['_579.LeadModificationSegment']):
    '''MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1251.Range':
        ...
        if _1251.Range.TYPE not in self.wrapped.LeadMicroGeometryRange.__class__.__mro__:
