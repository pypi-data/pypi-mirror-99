...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _477
...
class WormGrindingProcessTotalModificationCalculation(_477.WormGrindingProcessCalculation):
    '''WormGrindingProcessTotalModificationCalculation
