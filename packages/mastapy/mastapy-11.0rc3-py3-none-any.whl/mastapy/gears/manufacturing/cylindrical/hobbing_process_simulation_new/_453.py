...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _444, _448
...
class HobbingProcessProfileCalculation(_448.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
