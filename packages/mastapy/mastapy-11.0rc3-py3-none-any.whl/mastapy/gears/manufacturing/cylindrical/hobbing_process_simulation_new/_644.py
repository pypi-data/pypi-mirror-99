...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _608, _641
...
class WormGrindingProcessPitchCalculation(_641.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_608.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_608.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_608.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_608.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
