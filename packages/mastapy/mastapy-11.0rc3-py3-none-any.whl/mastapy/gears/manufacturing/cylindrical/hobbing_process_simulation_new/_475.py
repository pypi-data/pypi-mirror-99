...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _442, _476
...
class WormGrindingLeadCalculation(_476.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
