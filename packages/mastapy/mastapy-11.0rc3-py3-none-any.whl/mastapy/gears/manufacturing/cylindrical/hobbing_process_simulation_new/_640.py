...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _607, _641
...
class WormGrindingLeadCalculation(_641.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
    ...
    @property
    def right_flank(self) -> '_607.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_607.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_607.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_607.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
