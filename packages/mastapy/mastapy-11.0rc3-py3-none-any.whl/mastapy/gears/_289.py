...
from mastapy.gears.rating.cylindrical import _435, _420
from mastapy.gears.gear_designs.cylindrical import _1008, _946
from mastapy.materials import _233, _222
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_435.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_435.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_435.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1008.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1008.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1008.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_222.GeneralTransmissionProperties':
        ...
        return constructor.new(_222.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_420.CylindricalGearRatingSettings':
        ...
        return constructor.new(_420.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
