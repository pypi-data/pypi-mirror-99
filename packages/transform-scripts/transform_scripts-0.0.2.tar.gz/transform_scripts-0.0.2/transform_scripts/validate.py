...
def upload_configs(mode: str, api_key: str, repo: Optional[str]=None, branch: Optional[str]=None, commit: Optional[str]=None, config_dir: Optional[str]=None):
...
if __name__ == "__main__":
    ...
    TRANSFORM_API_KEY = os.environ["TRANSFORM_API_KEY"]  # fail if TRANSFORM_API_KEY not present
