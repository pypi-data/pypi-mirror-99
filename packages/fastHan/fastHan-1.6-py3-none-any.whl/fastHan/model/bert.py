...
from .bert_encoder_theseus import BertModel
...
class BertEmbedding(ContextualEmbedding):
    ...
    def forward(self, words,layers=None):
        """
        ...
        outputs = self.model(words,layers)
