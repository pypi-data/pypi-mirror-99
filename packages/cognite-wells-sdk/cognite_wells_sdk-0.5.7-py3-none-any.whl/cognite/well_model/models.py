...
class MeasurementField(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    type_name: MeasurementType = Field(..., alias="typeName")


class MeasurementIngestion(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    sequence_external_id: str = Field(..., alias="sequenceExternalId")
    measurement_fields: List[MeasurementField] = Field(..., alias="measurementFields")
...
class WellboreIngestion(WellsBaseModel):
    ...
    well_name: str = Field(..., alias="wellName", description="Name of the well parent of this wellbore")
    source: str = Field(..., example="EDM")
    ...
    measurement_ingestions: Optional[List[MeasurementIngestion]] = Field(None, alias="measurementIngestions")
