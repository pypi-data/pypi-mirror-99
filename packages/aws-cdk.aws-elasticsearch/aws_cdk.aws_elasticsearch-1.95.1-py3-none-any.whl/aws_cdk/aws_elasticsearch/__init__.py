...
class CfnDomain(
    ...
    def elasticsearch_cluster_config(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnDomain.ElasticsearchClusterConfigProperty"]], jsii.get(self, "elasticsearchClusterConfig"))
...
class CfnDomainProps:
    ...
    def elasticsearch_cluster_config(
        ...
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, CfnDomain.ElasticsearchClusterConfigProperty]], result)
...
class VpcOptions:
    ...
    def subnets(self) -> typing.List[aws_cdk.aws_ec2.ISubnet]:
        ...
        return typing.cast(typing.List[aws_cdk.aws_ec2.ISubnet], result)
