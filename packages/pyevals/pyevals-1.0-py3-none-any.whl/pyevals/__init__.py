...
class build:
    def __init__(self,x_train,x_test,y_train,y_test,model):
        ...
        :parm method:   Which method you want to pass either Classification or Regression
    ...
    def evaluate(self):
        ...
        SGD Classifier , XgBoost , AdaBoost , Caliberated Classifier , 
        ...
        if(self.model.lower()=='classification'):
            algorithms = ["KNN","LogisticRegression","DecisionTreeClassifier",
                    ...
                    "SGDClassifier","XgBoost","AdaBoost","CalibratedClassifier","MultinomialNB",
            ...
            XgBoost=BuildClassification.XgBoost(self.x_train,self.x_test,self.y_train,self.y_test)
            ...
            functions = [KNearestNeighbor,LogisticReg,DecisionTree,RandomForest,
                            ...
                            XgBoost,AdaBoost,CalibratedClassifier,MultinomialNaiveBayes,
                            BernoulliNaiveBayes,GaussianNaiveBayes]
  
            Accuracy = [functions[algorithm][0] for algorithm in range(13)]
            RecallScore = [functions[algorithm][1] for algorithm in range(13)]
            PresicionScore = [functions[algorithm][2] for algorithm in range(13)]
            RocAucScore = [functions[algorithm][3] for algorithm in range(13)]
            f1Score = [functions[algorithm][4] for algorithm in range(13)]
