...
class ComputeSetting(Model):
    ...
    :type batch_ai_compute_info: ~designer.models.BatchAiComputeInfo
    :param remote_docker_compute_info:
    :type remote_docker_compute_info: ~designer.models.RemoteDockerComputeInfo
    :param hdi_cluster_compute_info:
    :type hdi_cluster_compute_info: ~designer.models.HdiClusterComputeInfo
    :param mlc_compute_info:
    :type mlc_compute_info: ~designer.models.MlcComputeInfo
    :param databricks_compute_info:
    :type databricks_compute_info: ~designer.models.DatabricksComputeInfo
    """
