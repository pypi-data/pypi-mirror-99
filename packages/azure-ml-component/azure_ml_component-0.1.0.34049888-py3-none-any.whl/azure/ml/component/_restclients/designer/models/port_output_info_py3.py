...
class PortOutputInfo(Model):
    ...
    def __init__(self, *, container_uri: str=None, relative_path: str=None, model_output_path: str=None, data_store_name: str=None, supported_actions=None, **kwargs) -> None:
