...
class PipelineEndpointsOperations(object):
    ...
    def list_pipeline_endpoints(
            self, subscription_id, resource_group_name, workspace_name, continuation_token=None, continuation_token1=None, count=500, active_only=False, skip_cache=False, custom_headers=None, raw=False, **operation_config):
        """
        ...
        if skip_cache is not None:
            query_parameters['skipCache'] = self._serialize.query("skip_cache", skip_cache, 'bool')
    ...
    def get_pipeline_endpoint_by_name(
            self, subscription_id, resource_group_name, workspace_name, pipeline_endpoint_name, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_endpoint_by_name.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
            'pipelineEndpointName': self._serialize.url("pipeline_endpoint_name", pipeline_endpoint_name, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    get_pipeline_endpoint_by_name.metadata = {'url': '/studioservice/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineEndpoints/{pipelineEndpointName}/name'}
    ...
    def get_pipeline_endpoint_graph(
            self, subscription_id, resource_group_name, workspace_name, pipeline_endpoint_id, use_cache=False, include_run_setting_params=True, has_namespace_concept=True, skip_dataset_load=False, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_pipeline_endpoint_graph_with_graph_id(
            self, subscription_id, resource_group_name, workspace_name, graph_id, include_run_setting_params=True, has_namespace_concept=True, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_pipeline_endpoint_sdk_code_file_path(
            self, subscription_id, resource_group_name, workspace_name, pipeline_endpoint_id, target_code="1", body=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_endpoint_sdk_code_file_path.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_endpoint_sdk_code_file_path.metadata = {'url': '/studioservice/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineEndpoints/{pipelineEndpointId}/getSdkCodeFilePath'}
    ...
    def get_pipeline_endpoint_by_name_v2(
            self, subscription_id, resource_group_name, workspace_name, pipeline_endpoint_name, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_endpoint_by_name_v2.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_endpoint_by_name_v2.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineEndpoints/{pipelineEndpointName}/name'}
    ...
    def get_pipeline_endpoint_sdk_code_file_path_v2(
            self, subscription_id, resource_group_name, workspace_name, pipeline_endpoint_id, target_code="1", body=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_endpoint_sdk_code_file_path_v2.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_endpoint_sdk_code_file_path_v2.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineEndpoints/{pipelineEndpointId}/getSdkCodeFilePath'}
