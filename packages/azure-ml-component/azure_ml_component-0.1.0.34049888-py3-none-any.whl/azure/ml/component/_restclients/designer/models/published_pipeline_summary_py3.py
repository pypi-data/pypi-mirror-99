...
class PublishedPipelineSummary(Model):
    ...
    def __init__(self, *, name: str=None, description: str=None, graph_id: str=None, published_date=None, last_run_time=None, last_run_status=None, published_by: str=None, tags=None, version: str=None, is_default: bool=None, entity_status=None, id: str=None, etag: str=None, created_date=None, last_modified_date=None, **kwargs) -> None:
