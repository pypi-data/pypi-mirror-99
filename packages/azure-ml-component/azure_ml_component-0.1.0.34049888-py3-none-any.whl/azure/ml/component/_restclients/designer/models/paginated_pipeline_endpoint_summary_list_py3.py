...
class PaginatedPipelineEndpointSummaryList(Model):
    """A paginated list of PipelineEndpointSummarys.

    :param value: An array of objects of type PipelineEndpointSummary.
    :type value: list[~designer.models.PipelineEndpointSummary]
