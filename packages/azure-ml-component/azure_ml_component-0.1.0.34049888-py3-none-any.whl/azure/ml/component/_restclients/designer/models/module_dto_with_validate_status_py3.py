...
class ModuleDtoWithValidateStatus(Model):
    ...
    def __init__(self, *, existing_module_entity=None, status=None, status_details: str=None, namespace: str=None, tags=None, display_name: str=None, dict_tags=None, module_name: str=None, entity_status=None, created_date=None, last_modified_date=None, versions=None, default_version: str=None, module_scope=None, module_version_id: str=None, description: str=None, owner: str=None, job_type: str=None, yaml_link: str=None, yaml_link_with_commit_sha: str=None, family_id: str=None, help_document: str=None, codegen_by: str=None, entry: str=None, os_type: str=None, module_source_type=None, registered_by: str=None, module_version: str=None, is_default_module_version: bool=None, module_entity=None, input_types=None, output_types=None, run_setting_parameters=None, require_gpu: bool=None, module_python_interface=None, snapshot_id: str=None, yaml_str: str=None, **kwargs) -> None:
