...
class PromoteDataSetRequest(Model):
    ...
    def __init__(self, *, name: str=None, description: str=None, pipeline_run_id: str=None, module_node_id: str=None, output_port_name: str=None, model_output_path: str=None, data_type_id: str=None, dataset_type: str=None, data_store_name: str=None, output_relative_path: str=None, **kwargs) -> None:
