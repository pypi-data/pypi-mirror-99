...
class ModuleOperations(object):
    ...
    def list_modules(
            self, subscription_id, resource_group_name, workspace_name, continuation_token=None, continuation_token1=None, count=500, active_only=True, module_scope="2", include_empty_namespace=False, include_run_setting_params=True, order_by="Name", search_string=None, get_yaml=False, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def register_module(
            self, subscription_id, resource_group_name, workspace_name, validate_only=False, anonymous_registration=False, upgrade_if_exists=False, set_as_default_version=True, include_run_setting_params=True, overwrite_module_version=None, get_yaml=False, x_ms_github_token=None, x_ms_github_code=None, remove_client_not_used_fields=True, keep_complete_parameters=False, snapshot_source_zip_file=None, properties=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        :param properties: ModuleSourceType: string, YamlFile: string,
         ...
         IsPrivateRepo: boolean, DataTypeMechanism: string
        :type properties: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def get_module(
            self, subscription_id, resource_group_name, workspace_name, module_namespace, module_name, version=None, include_run_setting_params=True, get_yaml=False, remove_client_not_used_fields=True, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def upgrade_module(
            self, subscription_id, resource_group_name, workspace_name, module_namespace, module_name, validate_only=False, overwrite_module_version=None, x_ms_github_token=None, x_ms_github_code=None, get_yaml=False, snapshot_source_zip_file=None, properties=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def update_module(
            self, subscription_id, resource_group_name, workspace_name, module_namespace, module_name, get_yaml=False, body=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_module_versions(
            self, subscription_id, resource_group_name, workspace_name, module_namespace, module_name, include_run_setting_params=True, get_yaml=False, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def parse_module(
            self, subscription_id, resource_group_name, workspace_name, x_ms_github_token=None, x_ms_github_code=None, get_yaml=False, snapshot_source_zip_file=None, properties=None, custom_headers=None, raw=False, **operation_config):
        """
