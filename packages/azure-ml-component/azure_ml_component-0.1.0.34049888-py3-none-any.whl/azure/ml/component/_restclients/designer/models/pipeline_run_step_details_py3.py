...
class PipelineRunStepDetails(Model):
    ...
    def __init__(self, *, run_id: str=None, target: str=None, status=None, status_detail: str=None, parent_run_id: str=None, start_time=None, end_time=None, is_reused: bool=None, logs=None, outputs=None, snapshot_info=None, input_datasets=None, output_datasets=None, **kwargs) -> None:
