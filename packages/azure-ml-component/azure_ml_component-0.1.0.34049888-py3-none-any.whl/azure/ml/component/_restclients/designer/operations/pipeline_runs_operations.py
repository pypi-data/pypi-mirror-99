...
class PipelineRunsOperations(object):
    ...
    def get_pipeline_run_graph(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, experiment_name=None, experiment_id=None, include_run_setting_params=True, has_namespace_concept=True, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_pipeline_run_graph_no_status(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, include_run_setting_params=True, has_namespace_concept=True, skip_dataset_load=False, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_download_uri_for_path(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, step_run_id, path, custom_headers=None, raw=False, **operation_config):
        """
        ...
        return deserialized
    get_download_uri_for_path.metadata = {'url': '/studioservice/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}/{stepRunId}/downloadUri/{path}'}
    ...
    def get_pipeline_run_sdk_code_file_path(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, experiment_name=None, experiment_id=None, target_code="1", body=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_run_sdk_code_file_path.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_run_sdk_code_file_path.metadata = {'url': '/studioservice/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}/getSdkCodeFilePath'}
    ...
    def get_pipeline_run_profile(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: PipelineRunProfile or ClientRawResponse if raw=true
        ...
        """
        # Construct URL
        url = self.get_pipeline_run_profile.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PipelineRunProfile', response)
        ...
        return deserialized
    get_pipeline_run_profile.metadata = {'url': '/studioservice/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}/profile'}
    ...
    def get_download_uri_for_path_v2(
        ...
        return deserialized
    get_download_uri_for_path_v2.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}/{stepRunId}/downloadUri/{path}'}
    ...
    def get_pipeline_run_sdk_code_file_path_v2(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, experiment_name=None, experiment_id=None, target_code="1", body=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_run_sdk_code_file_path_v2.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_run_sdk_code_file_path_v2.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}/getSdkCodeFilePath'}
    ...
    def get_pipeline_run_profile_v2(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_run_profile_v2.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_run_profile_v2.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}/profile'}
