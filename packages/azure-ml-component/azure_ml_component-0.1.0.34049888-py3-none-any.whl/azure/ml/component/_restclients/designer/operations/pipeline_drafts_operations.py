...
class PipelineDraftsOperations(object):
    ...
    def get_pipeline_draft(
            self, subscription_id, resource_group_name, workspace_name, draft_id, get_status=True, include_run_setting_params=True, has_namespace_concept=True, skip_dataset_load=False, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def get_pipeline_draft_sdk_code_file_path(
            self, subscription_id, resource_group_name, workspace_name, draft_id, target_code="1", body=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_draft_sdk_code_file_path.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_draft_sdk_code_file_path.metadata = {'url': '/studioservice/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineDrafts/{draftId}/getSdkCodeFilePath'}
    ...
    def get_pipeline_draft_sdk_code_file_path_v2(
            self, subscription_id, resource_group_name, workspace_name, draft_id, target_code="1", body=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.get_pipeline_draft_sdk_code_file_path_v2.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    get_pipeline_draft_sdk_code_file_path_v2.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineDrafts/{draftId}/getSdkCodeFilePath'}
