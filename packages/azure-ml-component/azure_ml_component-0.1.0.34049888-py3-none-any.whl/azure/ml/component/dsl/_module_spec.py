...
from azure.ml.component._core._io_definition import InputDefinition, OutputDefinition, ParameterDefinition
...
def _dump_yaml_file(data, file, *, unsafe=False, header=None, default_flow_style=False, **kwargs):
    ...
    with open(file, 'w', encoding='utf-8') as fout:
        ...
        if unsafe:
            yaml.dump(
                data, fout, default_flow_style=default_flow_style, allow_unicode=True, encoding='utf-8', **kwargs
            )
        else:
            yaml.safe_dump(
                data, fout, default_flow_style=default_flow_style, allow_unicode=True, encoding='utf-8', **kwargs
...
class InputPort(InputDefinition, _Port):
    ...
    def __init__(self, name, type, description=None, optional=None, arg_name=None, arg_string=None):
        ...
        InputDefinition.__init__(self, name=name, type=type, description=description, optional=optional)
        _Port.__init__(
...
class OutputPort(OutputDefinition, _Port):
    ...
    def __init__(self, name, type, description=None, arg_name=None, arg_string=None):
        ...
        OutputDefinition.__init__(self, name=name, type=type, description=description)
        _Port.__init__(
            self, name=name, type=type, description=description,
            arg_name=arg_name, arg_string=arg_string,
        )
...
class Param(ParameterDefinition, _BaseParam):
    ...
    def __init__(self, name, type, description=None,
        ...
        ParameterDefinition.__init__(
            self, name=name, type=type, description=description, default=default, enum=enum,
...
class _Dependencies:
    ...
    def _normalize_default_pip_packages(cls, default_pip_packages=None):
        ...
        for i in range(len(default_pkgs)):
            ...
            if name.startswith('azureml-') or name.startswith('azure-ml-'):
...
class _ModuleDefinition:
    ...
    def base_params_to_list(base_params):
        return [
            param.to_dict() if isinstance(param, (InputDefinition, OutputDefinition, ParameterDefinition))
