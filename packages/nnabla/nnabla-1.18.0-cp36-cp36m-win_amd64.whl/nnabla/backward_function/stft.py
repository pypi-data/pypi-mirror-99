...
def stft_backward(inputs, window_size, stride, fft_size, window_type='hanning', center=True, pad_mode='reflect'):
    """
    Args:
    ...
    dy = inputs[0]
    x0 = inputs[1]
    raise NotImplementedError("stft_backward is not implemented.")
