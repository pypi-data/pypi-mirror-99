...
class CommandsConverterTest(unittest.TestCase):
    ...
    def __create_result(self, force_end_file_new_line: bool, black_enabled: bool):
        commands_converter = CommandsConverter(force_end_file_new_line, black_enabled, self.__command_converter)  # type: CommandsConverter

        commands = [
            {"command": 'print("Hello world")', "position": 2, "command_title": ""},
            {"command": "%run /foo/bar", "position": 1, "command_title": ""},
            {"command": "", "position": 1.33, "command_title": ""},
            {"command": "", "position": 1.66, "command_title": ""},
        ]
