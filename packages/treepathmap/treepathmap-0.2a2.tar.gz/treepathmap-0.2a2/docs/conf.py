...
plantuml_filepath = Path(__file__).parent.joinpath("plantuml.jar")
treepathmap_package_path = Path("../.").resolve()
sys.path.insert(0, str(treepathmap_package_path))
print(treepathmap_package_path)
import treepathmap
...
plantuml = 'java -jar {}'.format(plantuml_filepath)
