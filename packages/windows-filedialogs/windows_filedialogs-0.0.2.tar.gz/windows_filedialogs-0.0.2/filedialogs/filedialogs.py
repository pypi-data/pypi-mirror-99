...
def open_file_dialog(title: str = None, directory: str = os.getcwd(),
                     default_name: str = "", default_ext: str = "",
                     ext: str = "All Files\0*.*\0", multiselect: bool = False) -> Union[list[str], str, None]:
...
def save_file_dialog(title: str = None, directory: str = os.getcwd(),
                     default_name: str = "", default_ext: str = "",
                     ext: str = "All Files\0*.*\0") -> Optional[str]:
...
def open_folder_dialog(title: str = "", encoding: str = "ISO8859-1") -> str:
