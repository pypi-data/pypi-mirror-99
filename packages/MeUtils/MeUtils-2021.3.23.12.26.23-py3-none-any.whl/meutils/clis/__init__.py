...
@cli.command()
def hdfs_success_date(cmd="/home/work/tools/infra-client/bin/hdfs dfs -ls /user/s_feeds/dev/user_growth/push/dnn/mitv/impression/*/_SUCCESS"):
    """自定义镜像"""
    l = magic_cmd(cmd, print_output=True)[1].split()
...
def spark_submit(dates='20201228,20201229,20201230'):
    """自定义镜像"""
    dates = dates.split(',')
    cmd = "sh /home/work/yuanjie/zk2file/spark_submit.sh "
