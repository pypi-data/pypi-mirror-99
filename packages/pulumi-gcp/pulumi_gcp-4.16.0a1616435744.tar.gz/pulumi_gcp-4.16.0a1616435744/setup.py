...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.16.0-alpha.1616435744+9cc7f70a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.16.0-alpha.1616435744+9cc7f70a`
                """)
            else:
                raise
