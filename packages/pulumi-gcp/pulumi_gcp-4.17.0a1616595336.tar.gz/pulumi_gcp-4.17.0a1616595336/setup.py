...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.17.0-alpha.1616595336+1aaf6384'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.17.0-alpha.1616595336+1aaf6384`
                """)
            else:
                raise
