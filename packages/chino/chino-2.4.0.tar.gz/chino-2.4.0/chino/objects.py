...
class ChinoBaseObject(object):
    ...
    exclude_repr_field = ['_id', 'class_obj']
    only_key_field = []
    @property
    def _id(self, indent=None):
        return '-'
    ...
    def __repr__(self):
        """
        This returns the class name and parameters
        :return:
        """
        s = "%s(" % ".".join(
        ...
        res = []
        for k, v in vars(self).items():
            if k not in self.exclude_repr_field:
                if k in self.only_key_field:
                    res.append("%s=%s" % (k, "..."))
                else:
                    res.append("%s=%s" % (k, v.__repr__()))
        s += ",".join(res)
        s += ")"
        return s
        # return self.to_dict*
...
class ListResult(ChinoBaseObject):
    ...
    def to_dict(self):
        ...
        res[self.class_obj] = [o.to_dict() for o in
                               self.__getattribute__(self.class_obj)]
        return res

    def __len__(self):
        return self.paging.total_count

    def __getitem__(self, item):
        return self.__getattribute__(self.class_obj)[item]

    def __iter__(self):
        return iter(self.__getattribute__(self.class_obj))
...
class Repository(ChinoBaseObject):
    ...
    def __init__(self, repository_id=None, insert_date=None, last_update=None,
                 description=None, is_active=True, **kwargs):
...
class User(ChinoBaseObject):
    ...
    def __init__(self, user_id=None, username=None, insert_date=None,
                 schema_id=None, last_update=None, is_active=None,
                 attributes=None,
...
class Group(ChinoBaseObject):
    ...
    def __init__(self, group_id=None, group_name=None, insert_date=None,
                 is_active=None, last_update=None,
...
class Document(ChinoBaseObject):
    ...
    def __init__(self, document_id=None, repository_id=None, schema_id=None,
                 insert_date=None, last_update=True,
...
class _Field(ChinoBaseObject):
    ...
    def __init__(self, type, name, indexed=None, **kwargs):
        ...
        # like this we manage boh an unset default and a default set to None
...
class Schema(ChinoBaseObject):
    ...
    def __init__(self, schema_id=None, description=None, repository_id=None,
                 is_active=None, insert_date=None,
...
class UserSchema(ChinoBaseObject):
    ...
    def __init__(self, user_schema_id=None, description=None, is_active=None,
                 insert_date=None,
...
class Collection(ChinoBaseObject):
    ...
    def __init__(self, collection_id=None, name=None, insert_date=None,
                 last_update=True,
                 content=None, is_active=False, **kwargs):
...
class Application(ChinoBaseObject):
    ...
    def __init__(self, app_name=None, app_secret=None, app_id=None,
                 redirect_url=None, grant_type=None, **kwargs):
...
class Permission(ChinoBaseObject):
    ...
    def __init__(self, access=None, permission=None, resource_type=None,
                 resource_id=None, parent_id=None, **kwargs):
        self.access = access
        if permission:
...
class Consent(ChinoBaseObject):
    ...
    def __init__(self, consent_id=None, user_id=None, description=None,
                 data_controller=None, purposes=None,
                 policy_url=None, policy_version=None, collection_mode=None,
                 inserted_date=None, withdrawn_date=None):
        self.user_id = user_id
        self.description = description
        self.data_controller = _DictContent(
            **data_controller) if data_controller else None
        ...
        # should be always 'None' when a new instance is created
...
class Blob(ChinoBaseObject):
    only_key_field = 'content'
    @property
    def _id(self):
        return self.blob_id

    def __init__(self, filename=None, content=None, blob_id=None, **kwargs):
        self.filename = filename
        self.content = content
        self.blob_id = blob_id
        # if 'content' not in self.exclude_repr_field:
        #     self.exclude_repr_field.append('content')
