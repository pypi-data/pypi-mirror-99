...
class Builder:
    ...
    def build(self):
        ...
        self.__build_pipeline.prefect_file_packager = pf.create(key=configuration['prefect_file_packager']['type'],
                                                   configuration=configuration['prefect_file_packager']['conf'])
