...
class Builder:
    ...
    def build(self):
        ...
        self.__build_pipeline.packager = pf.create(key=configuration['orchestration_endpoint_appender']['type'],
                                                   configuration=configuration['orchestration_endpoint_appender']['conf'])

        self.__build_pipeline.packager = pf.create(key=configuration['prefect_file_packager']['type'],
                                                   configuration=configuration['prefect_file_packager']['conf'])

        elf.__build_pipeline.packager = pf.create(key=configuration['package_publisher']['type'],
