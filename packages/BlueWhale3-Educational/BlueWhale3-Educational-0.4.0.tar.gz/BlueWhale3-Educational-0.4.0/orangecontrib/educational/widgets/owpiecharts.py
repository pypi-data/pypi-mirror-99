...
def __(key):
    return i18n.t('educational.owpiecharts.' + key)
...
class OWPieChart(widget.OWWidget):
    ...
    class Inputs:
        data = Input("Data", Orange.data.Table, label=i18n.t("educational.common.data"))
