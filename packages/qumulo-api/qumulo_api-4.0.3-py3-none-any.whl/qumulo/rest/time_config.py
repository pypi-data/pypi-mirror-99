...
@request.request
def set_time(conninfo, credentials, use_ad_for_primary=None, ntp_servers=None):
    method = 'PATCH'
    uri = '/v1/time/settings'
    ...
    return request.rest_request(conninfo, credentials, method, uri, body=time_config)
