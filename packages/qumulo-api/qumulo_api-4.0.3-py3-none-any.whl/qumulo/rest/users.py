...
@request.request
def add_user(
    conninfo, credentials, name, primary_group, password, uid=None, home_directory=None
):
    method = 'POST'
    uri = '/v1/users/'
    ...
    return request.rest_request(conninfo, credentials, method, uri, body=user_info)
