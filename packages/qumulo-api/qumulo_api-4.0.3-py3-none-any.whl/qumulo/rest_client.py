...
class ETagStripperIterator:
    ...
    def __reversed__(self):
        return ETagStripperIterator(reversed(self.iterator), self.etag_strip_function)
...
class RestClient:
    ...
    def __init__(
        self, address, port, credentials=None, timeout=None, reuse_connection=None
    ):
    ...
    def clone(self):
        return RestClient(
            self.conninfo.host, self.conninfo.port, self.credentials, self.timeout
        )
    ...
    def refresh_connection(self):
        ...
        self.conninfo = request.Connection(
            address, port, chunked, chunk_size, timeout=self.timeout
        )
