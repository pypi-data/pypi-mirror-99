...
AggregatedProfileTimeTypeDef = TypedDict(
    "AggregatedProfileTimeTypeDef",
    {"period": Literal["PT5M", "PT1H", "P1D"], "start": datetime},
    total=False,
)
...
ProfilingGroupDescriptionTypeDef = TypedDict(
    "ProfilingGroupDescriptionTypeDef",
    {
        ...
        "arn": str,
        "computePlatform": Literal["Default", "AWSLambda"],
        "createdAt": datetime,
        "name": str,
...
UserFeedbackTypeDef = TypedDict("UserFeedbackTypeDef", {"type": Literal["Positive", "Negative"]})
...
BatchGetFrameMetricDataResponseTypeDef = TypedDict(
    "BatchGetFrameMetricDataResponseTypeDef",
    {
        ...
        "resolution": Literal["PT5M", "PT1H", "P1D"],
        "startTime": datetime,
