from qackorm.models import Model, BufferModel
from qackorm.fields import DateField, StringField
from qackorm.engines import MergeTree
from qackorm.utils import escape, get_subclass_names
...
class AlterTable(ModelOperation):
    ...
    def apply(self, database):
        ...
        # attribute position. Watch https://github.com/Infinidat/qackorm/issues/47
...
class MigrationHistory(Model):
    ...
    @classmethod
    def table_name(cls):
        return 'infi_qackorm_migrations'
