...
from qackorm.models import ModelBase
from qackorm.utils import escape, parse_tsv, import_submodules
...
import traceback
import logging
logger = logging.getLogger('qackorm')
...
class Database(object):
    ...
    def _send(self, data, settings=None, stream=False):
        ...
        print('presend', self.db_url, params, data, stream)
