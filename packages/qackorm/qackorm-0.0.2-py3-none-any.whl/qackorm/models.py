...
from qackorm.fields import Field, StringField
from qackorm.utils import parse_tsv, NO_VALUE, get_subclass_names, arg_to_sql, unescape
from qackorm.query import QuerySet
from qackorm.funcs import F
from qackorm.engines import Merge, Distributed

logger = getLogger('qackorm')
...
class ModelBase(type):
    ...
    def create_ad_hoc_field(cls, db_type):
        import qackorm.fields as orm_fields
        # Enums
