...
class AuthenticateCognitoActionProps:
    ...
    def next(self) -> aws_cdk.aws_elasticloadbalancingv2.ListenerAction:
        ...
        return typing.cast(aws_cdk.aws_elasticloadbalancingv2.ListenerAction, result)
    ...
    def user_pool_domain(self) -> aws_cdk.aws_cognito.IUserPoolDomain:
        ...
        return typing.cast(aws_cdk.aws_cognito.IUserPoolDomain, result)
    ...
    def on_unauthenticated_request(
        ...
        return typing.cast(typing.Optional[aws_cdk.aws_elasticloadbalancingv2.UnauthenticatedAction], result)
