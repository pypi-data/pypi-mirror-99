...
import treform.segmentation.lstmWordSegmentationModel as model
import treform.segmentation.wordSegmentationModelUtil as util

VERBOSE = 0

if __name__ == '__main__':
    VERBOSE = 1
    train_path = "D:\\python_workspace\\treform\\data\\korean_lstm_segmentation_train.txt"
    validation_path = "D:\\python_workspace\\treform\\data\\korean_lstm_segmentation_validation.txt"
    model_dir = "./model"
