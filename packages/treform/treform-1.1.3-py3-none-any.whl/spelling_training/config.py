...
HOME_DIR = 'D:\\python_workspace\\treform'
log.info('HOME_DIR: %s' % HOME_DIR)

PROJECT_DIR = os.path.join(HOME_DIR, '')
...
# ko.wikipedia.org
#################################################
KO_WIKIPEDIA_ORG_DIR = os.path.join(HOME_DIR, 'treform/spelling')

KO_WIKIPEDIA_ORG_INFO_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.info.txt')
KO_WIKIPEDIA_ORG_URLS_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.urls.txt')
KO_WIKIPEDIA_ORG_CHARACTERS_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.characters')

KO_WIKIPEDIA_ORG_SENTENCES_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.sentences.gz')
KO_WIKIPEDIA_ORG_TRAIN_SENTENCES_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.train.sentences.gz')
KO_WIKIPEDIA_ORG_VALID_SENTENCES_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.valid.sentences.gz')
KO_WIKIPEDIA_ORG_TEST_SENTENCES_FILE = os.path.join(KO_WIKIPEDIA_ORG_DIR, 'ko.wikipedia.org.test.sentences.gz')
...
# ko.wikipedia.org
#################################################
WIKIPEDIA_DIR = 'D:\\python_workspace\\treform\\treform\\spelling'

# text (with string)
#WIKIPEDIA_DATA_DIR = os.path.join(WIKIPEDIA_DIR, 'data')
WIKIPEDIA_DATA_DIR = WIKIPEDIA_DIR
