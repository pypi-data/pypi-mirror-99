...
class UnwrapKeyParams(object):
    ...
    def __init__(self, key=None, alg=None, mode=None, iv=None, ad=None, tag_len=None):
        """
        UnwrapKeyParams - a model defined in Swagger
        """
    ...
    def key(self):
        """
        Gets the key of this UnwrapKeyParams.
    ...
    def key(self, key):
        """
        Sets the key of this UnwrapKeyParams.
        """
    ...
    def alg(self):
        """
        Gets the alg of this UnwrapKeyParams.
    ...
    def alg(self, alg):
        """
        Sets the alg of this UnwrapKeyParams.
        """
    ...
    def mode(self):
        """
        Gets the mode of this UnwrapKeyParams.
    ...
    def mode(self, mode):
        """
        Sets the mode of this UnwrapKeyParams.
        """
    ...
    def iv(self):
        """
        Gets the iv of this UnwrapKeyParams.
    ...
    def iv(self, iv):
        """
        Sets the iv of this UnwrapKeyParams.
        For symmetric ciphers, this value will be used for the cipher initialization value. If not provided, SDKMS will generate a random iv and return it in the response. If provided, iv length must match the length required by the cipher and mode. 
        """
    ...
    def ad(self):
        """
        Gets the ad of this UnwrapKeyParams.
    ...
    def ad(self, ad):
        """
        Sets the ad of this UnwrapKeyParams.
        For symmetric ciphers with cipher mode GCM or CCM, this optionally specifies the authenticated data used by the cipher. This field must not be provided with other cipher modes. 
        """
    ...
    def tag_len(self):
        """
        Gets the tag_len of this UnwrapKeyParams.
    ...
    def tag_len(self, tag_len):
        """
        Sets the tag_len of this UnwrapKeyParams.
        For symmetric ciphers with cipher mode GCM or CCM, this field specifies the length of the authentication tag to be produced. This field is specified in bits (not bytes). This field is required for symmetric ciphers with cipher mode GCM or CCM. It must not be specified for asymmetric ciphers and symmetric ciphers with other cipher modes.
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnwrapKeyParams):
            return False
