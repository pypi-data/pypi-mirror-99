...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.20.0-alpha.1616500914+9a1a8010'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.20.0-alpha.1616500914+9a1a8010`
                """)
            else:
                raise
