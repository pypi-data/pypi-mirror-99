...
class PersonIdTypeSub(supermod.PersonIdType):
    def __init__(self, valueOf_=None, **kwargs_):
        super(PersonIdTypeSub, self).__init__(valueOf_,  **kwargs_)
supermod.PersonIdType.subclass = PersonIdTypeSub
# end class PersonIdTypeSub
