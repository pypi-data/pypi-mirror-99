...
class simpleTypeTestsTypeSub(supermod.simpleTypeTestsType):
    def __init__(self, simpleTypeTest=None, simpleContentTest=None, **kwargs_):
        super(simpleTypeTestsTypeSub, self).__init__(simpleTypeTest, simpleContentTest,  **kwargs_)
supermod.simpleTypeTestsType.subclass = simpleTypeTestsTypeSub
# end class simpleTypeTestsTypeSub


class simpleContentTypeSub(supermod.simpleContentType):
    def __init__(self, lang=None, identifier=None, valueOf_=None, **kwargs_):
        super(simpleContentTypeSub, self).__init__(lang, identifier, valueOf_,  **kwargs_)
supermod.simpleContentType.subclass = simpleContentTypeSub
# end class simpleContentTypeSub
