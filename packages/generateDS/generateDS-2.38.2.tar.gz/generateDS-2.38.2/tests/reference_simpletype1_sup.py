...
#
# Command line:
#   generateDS.py --no-dates --no-versions --no-warnings --silence --member-specs="list" -f -o "tests/reference_simpletype2_sup.py" -s "tests/reference_simpletype2_sub.py" --super="reference_simpletype2_sup" tests/reference_simpletype.xsd
#
