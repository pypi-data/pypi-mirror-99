...
#
# Unit tests -- 
# Step 1: Run the unit tests: ``pytest``
...
$commands = [
  ...
  "diff -u enable_slots_nodisablexml1_sub.py enable_slots_nodisablexml2_sub.py",
  "diff -u enable_slots_nodisablexml1_sup.py enable_slots_nodisablexml2_sup.py",
  "diff -u enable_slots1_sub.py enable_slots2_sub.py",
  "diff -u enable_slots1_sup.py enable_slots2_sup.py",
  "diff -u attr_prefix1_sub.py attr_prefix2_sub.py",
  "diff -u attr_prefix1_sup.py attr_prefix2_sup.py",
  "diff -u preserve_cdata_tags1_sub.py preserve_cdata_tags2_sub.py",
  "diff -u preserve_cdata_tags1_sup.py preserve_cdata_tags2_sup.py",
  "diff -u decimal_format1_sub.py decimal_format2_sub.py",
  "diff -u decimal_format1_sup.py decimal_format2_sup.py",
  "diff -u derived_types1_sub.py derived_types2_sub.py",
  "diff -u derived_types1_sup.py derived_types2_sup.py",
]
