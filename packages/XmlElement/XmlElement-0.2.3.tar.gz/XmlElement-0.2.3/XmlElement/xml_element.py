...
class XmlElement():
    def __init__(self, n: str, a: dict = {}, s: List[XmlElement] = [], t: str = None, flag_as_list: bool = False):
        ...
        - `t`: Text content of the XML element (default None)
        - `flag_as_list`: Set this element to produce a List on `to_dict()` even when just one of these elements exits.
        """
        ...
        self.text = t
        self.flag_as_list = flag_as_list
    ...
    def __add_subelement_attribute__(self, subelements:List[XmlElement]) -> None:
        ...
        for subelement in subelements:
            if subelement.name not in ['name', 'attributes', 'subelements', 'text', 'flag_as_list']:
