...
json={"username":username,'password':password})
    ...
    headers={
        ...
        data['summary']['avg']=data['avg_celsius']
        if unit=='fahrenheit':
            data['summary']['avg']=data['avg_fahrenheit']
    ...
    headers={
        ...
        data['summary']['avg']=data['total_water_liters']
        if unit=='gallons':
            data['summary']['avg']=data['total_water_gallons']
