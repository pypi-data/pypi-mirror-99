...
class IssuersApi(object):
    ...
    def get_upstreams(self, issuer_id, org_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_upstreams_with_http_info(issuer_id, org_id, **kwargs)  # noqa: E501

    def get_upstreams_with_http_info(self, issuer_id, org_id, **kwargs):  # noqa: E501
        """Get provisioned upstreams for the issuer  # noqa: E501

        Get provisioned upstreams for the issuer  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_upstreams_with_http_info(issuer_id, org_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(BaseUpstreams, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('issuer_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['issuer_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `issuer_id` when calling `get_upstreams`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_upstreams`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/issuers/issuer_extensions/{issuer_id}/upstreams', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='BaseUpstreams',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
