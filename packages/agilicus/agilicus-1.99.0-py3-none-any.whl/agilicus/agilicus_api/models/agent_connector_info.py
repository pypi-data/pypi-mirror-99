...
class AgentConnectorInfo(object):
    ...
    openapi_types = {
        ...
        'application_forwarders': 'list[ServiceForwarder]'
    }
    ...
    attribute_map = {
        ...
        'application_forwarders': 'application_forwarders'
    }

    def __init__(self, local_authentication_enabled=None, connections_info=None, allow_list=None, authz_public_key=None, application_forwarders=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._application_forwarders = None
        ...
        if application_forwarders is not None:
            self.application_forwarders = application_forwarders
    ...
    @property
    def application_forwarders(self):
        """Gets the application_forwarders of this AgentConnectorInfo.  # noqa: E501

        The list of service forwarders associated with this connector.  # noqa: E501

        :return: The application_forwarders of this AgentConnectorInfo.  # noqa: E501
        :rtype: list[ServiceForwarder]
        """
        return self._application_forwarders

    @application_forwarders.setter
    def application_forwarders(self, application_forwarders):
        """Sets the application_forwarders of this AgentConnectorInfo.

        The list of service forwarders associated with this connector.  # noqa: E501

        :param application_forwarders: The application_forwarders of this AgentConnectorInfo.  # noqa: E501
        :type: list[ServiceForwarder]
        """

        self._application_forwarders = application_forwarders
