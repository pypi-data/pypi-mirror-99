# from: https://raw.githubusercontent.com/pyca/cryptography/master/src/cryptography/fernet.py
# license: BSD/APACHE
# @todo: complement source details
...
class MultiFernet256(object):
    ...
    def rotate(self, msg):
        timestamp, data = Fernet256._get_unverified_token_data(msg)
