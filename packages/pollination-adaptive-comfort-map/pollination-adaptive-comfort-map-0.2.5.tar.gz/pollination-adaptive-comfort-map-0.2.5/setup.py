...
setuptools.setup(
    name='pollination-adaptive-comfort-map',                                     # will be used for package name
    ...
    url='https://github.com/pollination/adaptive-comfort-map',                   # will be translated to home
    project_urls={
        'icon': 'https://raw.githubusercontent.com/ladybug-tools/artwork/master/icons_components/honeybee/png/adaptivemap.png'
    },
    description='Adaptive thermal comfort map for Pollination.',                  # will be used as package description
    ...
    keywords='honeybee, ladybug-tools, thermal, comfort, adaptive',# will be used as keywords
