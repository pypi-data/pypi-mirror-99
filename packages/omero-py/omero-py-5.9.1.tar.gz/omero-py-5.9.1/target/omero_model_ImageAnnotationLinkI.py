...
IceImport.load("omero_model_ImageAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class ImageAnnotationLinkI(_omero_model.ImageAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(ImageAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return ImageAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.ImageAnnotationLinkI = ImageAnnotationLinkI
