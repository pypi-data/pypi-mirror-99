...
class PathI(_omero_model.Path):
      ...
      def warn_of_deprecation(item):
          if item not in PathI.deprecations_warned:
              PathI.deprecations_warned.add(item)
              import warnings
      ...
      ANNOTATIONLINKS =  "ome.model.roi.Path_annotationLinks"
      ...
      def __init__(self, id=None, loaded=None):
          ...
          PathI.warn_of_deprecation("Path")
