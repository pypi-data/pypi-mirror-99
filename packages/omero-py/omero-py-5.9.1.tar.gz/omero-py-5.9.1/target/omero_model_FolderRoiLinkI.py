...
IceImport.load("omero_model_FolderRoiLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class FolderRoiLinkI(_omero_model.FolderRoiLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(FolderRoiLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return FolderRoiLinkI( self._id.getValue(), False )
...
_omero_model.FolderRoiLinkI = FolderRoiLinkI
