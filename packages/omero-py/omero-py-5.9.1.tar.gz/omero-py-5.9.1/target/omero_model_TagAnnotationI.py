...
IceImport.load("omero_model_TagAnnotation_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class TagAnnotationI(_omero_model.TagAnnotation):
      ...
      ANNOTATIONLINKS =  "ome.model.annotations.TagAnnotation_annotationLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(TagAnnotationI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return TagAnnotationI( self._id.getValue(), False )
...
_omero_model.TagAnnotationI = TagAnnotationI
