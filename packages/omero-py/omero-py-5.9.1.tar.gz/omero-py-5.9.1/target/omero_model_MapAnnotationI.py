...
IceImport.load("omero_model_MapAnnotation_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class MapAnnotationI(_omero_model.MapAnnotation):
      ...
      _field_info = _field_info_type(
          mapValue=_field_info_data(wrapper=omero.rtypes.rstring, nullable=True),
      ...
      ANNOTATIONLINKS =  "ome.model.annotations.MapAnnotation_annotationLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(MapAnnotationI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return MapAnnotationI( self._id.getValue(), False )
      ...
      def setMapValue(self, _mapValue, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.mapValue.wrapper is not None:
              if _mapValue is not None:
                  _mapValue = self._field_info.mapValue.wrapper(_mapValue)
...
_omero_model.MapAnnotationI = MapAnnotationI
