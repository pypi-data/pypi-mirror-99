...
if 'ImportJob' not in _M_omero.model.__dict__:
    ...
    ImportJob._op_getImageName.deprecate("ImportJob is deprecated.")
    ...
    ImportJob._op_setImageName.deprecate("ImportJob is deprecated.")
    ...
    ImportJob._op_getImageDescription.deprecate("ImportJob is deprecated.")
    ...
    ImportJob._op_setImageDescription.deprecate("ImportJob is deprecated.")
