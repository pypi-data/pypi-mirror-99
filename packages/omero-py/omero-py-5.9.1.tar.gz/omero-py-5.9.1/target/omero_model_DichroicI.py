...
IceImport.load("omero_model_Dichroic_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class DichroicI(_omero_model.Dichroic):
      ...
      ANNOTATIONLINKS =  "ome.model.acquisition.Dichroic_annotationLinks"
      ...
      def proxy(self, current = None):
          ...
          return DichroicI( self._id.getValue(), False )
      ...
      def removeDichroicAnnotationLink(self, target, current = None):
          self.errorIfUnloaded()
          if not self._annotationLinksLoaded: self.throwNullCollectionException("annotationLinksSeq")
      ...
      def linkAnnotation(self, addition, current = None):
          self.errorIfUnloaded()
          if not self._annotationLinksLoaded: self.throwNullCollectionException("annotationLinksSeq")
          link = _omero_model.DichroicAnnotationLinkI()
          link.link( self, addition );
          self.addDichroicAnnotationLinkToBoth( link, True )
          return link
      ...
      def unlinkAnnotation(self, removal, current = None):
          self.errorIfUnloaded()
          if not self._annotationLinksLoaded: self.throwNullCollectionException("annotationLinksSeq")
          toRemove = self.findDichroicAnnotationLink(removal)
          for next in toRemove:
              self.removeDichroicAnnotationLinkFromBoth( next, True )
...
_omero_model.DichroicI = DichroicI
