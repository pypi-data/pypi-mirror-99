...
IceImport.load("omero_model_ScriptJob_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class ScriptJobI(_omero_model.ScriptJob):
      ...
      ORIGINALFILELINKS =  "ome.model.jobs.ScriptJob_originalFileLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(ScriptJobI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return ScriptJobI( self._id.getValue(), False )
...
_omero_model.ScriptJobI = ScriptJobI
