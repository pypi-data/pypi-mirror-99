...
IceImport.load("omero_model_Polyline_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class PolylineI(_omero_model.Polyline):
      ...
      _field_info = _field_info_type(
          points=_field_info_data(wrapper=omero.rtypes.rstring, nullable=True),
          markerStart=_field_info_data(wrapper=omero.rtypes.rstring, nullable=True),
          markerEnd=_field_info_data(wrapper=omero.rtypes.rstring, nullable=True),
      ...
      MARKERSTART =  "ome.model.roi.Polyline_markerStart"
      MARKEREND =  "ome.model.roi.Polyline_markerEnd"
      ...
      ANNOTATIONLINKS =  "ome.model.roi.Polyline_annotationLinks"
      ...
      def unload(self, current = None):
          self._loaded = False
          self.unloadPoints( )
          self.unloadMarkerStart( )
          self.unloadMarkerEnd( )
      ...
      def proxy(self, current = None):
          ...
          return PolylineI( self._id.getValue(), False )
      ...
      def unloadMarkerStart(self, ):
          self._markerStartLoaded = False
          self._markerStart = None;

      def getMarkerStart(self, current = None):
          self.errorIfUnloaded()
          return self._markerStart

      def setMarkerStart(self, _markerStart, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.markerStart.wrapper is not None:
              if _markerStart is not None:
                  _markerStart = self._field_info.markerStart.wrapper(_markerStart)
          self._markerStart = _markerStart
          pass

      def unloadMarkerEnd(self, ):
          self._markerEndLoaded = False
          self._markerEnd = None;

      def getMarkerEnd(self, current = None):
          self.errorIfUnloaded()
          return self._markerEnd

      def setMarkerEnd(self, _markerEnd, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.markerEnd.wrapper is not None:
              if _markerEnd is not None:
                  _markerEnd = self._field_info.markerEnd.wrapper(_markerEnd)
...
_omero_model.PolylineI = PolylineI
