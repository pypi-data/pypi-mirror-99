...
IceImport.load("omero_model_JobOriginalFileLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class JobOriginalFileLinkI(_omero_model.JobOriginalFileLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(JobOriginalFileLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return JobOriginalFileLinkI( self._id.getValue(), False )
...
_omero_model.JobOriginalFileLinkI = JobOriginalFileLinkI
