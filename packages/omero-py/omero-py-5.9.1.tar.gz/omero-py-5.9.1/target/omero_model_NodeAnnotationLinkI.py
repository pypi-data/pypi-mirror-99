...
IceImport.load("omero_model_NodeAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class NodeAnnotationLinkI(_omero_model.NodeAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(NodeAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return NodeAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.NodeAnnotationLinkI = NodeAnnotationLinkI
