...
IceImport.load("omero_model_FileAnnotation_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class FileAnnotationI(_omero_model.FileAnnotation):
      ...
      _field_info = _field_info_type(
          file=_field_info_data(wrapper=omero.proxy_to_instance, nullable=True),
      ...
      ANNOTATIONLINKS =  "ome.model.annotations.FileAnnotation_annotationLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(FileAnnotationI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return FileAnnotationI( self._id.getValue(), False )
      ...
      def setFile(self, _file, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.file.wrapper is not None:
              if _file is not None:
                  _file = self._field_info.file.wrapper(_file)
          self._file = _file
          pass
...
_omero_model.FileAnnotationI = FileAnnotationI
