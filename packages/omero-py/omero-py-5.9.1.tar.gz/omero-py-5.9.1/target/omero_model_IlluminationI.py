...
IceImport.load("omero_model_Illumination_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class IlluminationI(_omero_model.Illumination):
      ...
      def __init__(self, id=None, loaded=None):
          super(IlluminationI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return IlluminationI( self._id.getValue(), False )
...
_omero_model.IlluminationI = IlluminationI
