...
IceImport.load("omero_model_MicrobeamManipulationType_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class MicrobeamManipulationTypeI(_omero_model.MicrobeamManipulationType):
      ...
      def __init__(self, id=None, loaded=None):
          super(MicrobeamManipulationTypeI, self).__init__()
      ...
      def shallowCopy(self, current = None):
            ...
            copy = MicrobeamManipulationTypeI()
            copy._id = self._id;
            copy._details = None  # Unloading for the moment.
            raise omero.ClientError("NYI")
      def proxy(self, current = None):
          if self._id is None: raise omero.ClientError("Proxies require an id")
          return MicrobeamManipulationTypeI( self._id.getValue(), False )
...
_omero_model.MicrobeamManipulationTypeI = MicrobeamManipulationTypeI
