...
class StatsInfoI(_omero_model.StatsInfo):
      ...
      def unload(self, current = None):
          self._loaded = False
          self.unloadGlobalMin( )
          self.unloadGlobalMax( )
          self.unloadDetails( )
      ...
      def proxy(self, current = None):
          ...
          return StatsInfoI( self._id.getValue(), False )
      ...
      def unloadGlobalMin(self, ):
          self._globalMinLoaded = False
          self._globalMin = None;
...
_omero_model.StatsInfoI = StatsInfoI
