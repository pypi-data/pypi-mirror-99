...
IceImport.load("omero_model_FolderImageLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class FolderImageLinkI(_omero_model.FolderImageLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(FolderImageLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return FolderImageLinkI( self._id.getValue(), False )
...
_omero_model.FolderImageLinkI = FolderImageLinkI
