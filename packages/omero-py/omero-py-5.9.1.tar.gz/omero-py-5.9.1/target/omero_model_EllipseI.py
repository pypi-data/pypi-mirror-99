...
IceImport.load("omero_model_Ellipse_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class EllipseI(_omero_model.Ellipse):
      ...
      _field_info = _field_info_type(
          ...
          radiusX=_field_info_data(wrapper=omero.rtypes.rdouble, nullable=True),
          radiusY=_field_info_data(wrapper=omero.rtypes.rdouble, nullable=True),
      ...
      ANNOTATIONLINKS =  "ome.model.roi.Ellipse_annotationLinks"
      ...
      def proxy(self, current = None):
          ...
          return EllipseI( self._id.getValue(), False )
      ...
      def setRadiusX(self, _radiusX, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.radiusX.wrapper is not None:
              if _radiusX is not None:
                  _radiusX = self._field_info.radiusX.wrapper(_radiusX)
          self._radiusX = _radiusX
          pass

      def unloadRadiusY(self, ):
          self._radiusYLoaded = False
          self._radiusY = None;
      ...
      def setRadiusY(self, _radiusY, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.radiusY.wrapper is not None:
              if _radiusY is not None:
                  _radiusY = self._field_info.radiusY.wrapper(_radiusY)
