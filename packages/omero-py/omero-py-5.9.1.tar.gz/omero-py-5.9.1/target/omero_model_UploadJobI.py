...
IceImport.load("omero_model_UploadJob_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class UploadJobI(_omero_model.UploadJob):
      ...
      ORIGINALFILELINKS =  "ome.model.jobs.UploadJob_originalFileLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(UploadJobI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return UploadJobI( self._id.getValue(), False )
...
_omero_model.UploadJobI = UploadJobI
