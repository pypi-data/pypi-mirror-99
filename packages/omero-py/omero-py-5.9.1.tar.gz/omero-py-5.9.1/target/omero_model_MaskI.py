...
class MaskI(_omero_model.Mask):
      ...
      _field_info = _field_info_type(
          ...
          pixels=_field_info_data(wrapper=omero.proxy_to_instance, nullable=True),
          textValue=_field_info_data(wrapper=omero.rtypes.rstring, nullable=True),
          bytes=_field_info_data(wrapper=None, nullable=True),
      ...
      ANNOTATIONLINKS =  "ome.model.roi.Mask_annotationLinks"
      ...
      def setBytes(self, _bytes, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.bytes.wrapper is not None:
              if _bytes is not None:
                  _bytes = self._field_info.bytes.wrapper(_bytes)
          self._bytes = _bytes
          pass
