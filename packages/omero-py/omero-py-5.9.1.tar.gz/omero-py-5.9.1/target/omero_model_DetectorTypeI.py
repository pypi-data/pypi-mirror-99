...
IceImport.load("omero_model_DetectorType_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class DetectorTypeI(_omero_model.DetectorType):
      ...
      def __init__(self, id=None, loaded=None):
          super(DetectorTypeI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return DetectorTypeI( self._id.getValue(), False )
...
_omero_model.DetectorTypeI = DetectorTypeI
