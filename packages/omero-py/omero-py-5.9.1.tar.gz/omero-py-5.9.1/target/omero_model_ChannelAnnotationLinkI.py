...
IceImport.load("omero_model_ChannelAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class ChannelAnnotationLinkI(_omero_model.ChannelAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(ChannelAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return ChannelAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.ChannelAnnotationLinkI = ChannelAnnotationLinkI
