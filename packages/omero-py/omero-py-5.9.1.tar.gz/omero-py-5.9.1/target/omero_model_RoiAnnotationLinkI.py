...
IceImport.load("omero_model_RoiAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class RoiAnnotationLinkI(_omero_model.RoiAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(RoiAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return RoiAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.RoiAnnotationLinkI = RoiAnnotationLinkI
