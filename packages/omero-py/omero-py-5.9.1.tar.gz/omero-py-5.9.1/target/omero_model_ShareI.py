...
class ShareI(_omero_model.Share):
      ...
      SUDOER =  "ome.model.meta.Share_sudoer"
      ...
      ANNOTATIONLINKS =  "ome.model.meta.Share_annotationLinks"
      ...
      def proxy(self, current = None):
          ...
          return ShareI( self._id.getValue(), False )
