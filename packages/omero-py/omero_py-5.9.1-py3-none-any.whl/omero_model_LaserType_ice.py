...
if 'LaserType' not in _M_omero.model.__dict__:
    ...
    _M_omero.model._t_LaserType = IcePy.defineClass('::omero::model::LaserType', LaserType, -1, (), True, False, _M_omero.model._t_IObject, (), (('_value', (), _M_omero._t_RString, False, 0),))
    LaserType._ice_type = _M_omero.model._t_LaserType

    LaserType._op_getValue = IcePy.Operation('getValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_omero._t_RString, False, 0), ())
    LaserType._op_setValue = IcePy.Operation('setValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_omero._t_RString, False, 0),), (), None, ())
