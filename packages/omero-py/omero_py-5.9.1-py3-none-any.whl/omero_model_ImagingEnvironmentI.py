...
class ImagingEnvironmentI(_omero_model.ImagingEnvironment):
      ...
      _field_info = _field_info_type(
          temperature=_field_info_data(wrapper=omero.proxy_to_instance, nullable=True),
          airPressure=_field_info_data(wrapper=omero.proxy_to_instance, nullable=True),
...
_omero_model.ImagingEnvironmentI = ImagingEnvironmentI
