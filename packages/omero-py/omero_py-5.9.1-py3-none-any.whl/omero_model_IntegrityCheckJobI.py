...
IceImport.load("omero_model_IntegrityCheckJob_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class IntegrityCheckJobI(_omero_model.IntegrityCheckJob):
      ...
      ORIGINALFILELINKS =  "ome.model.jobs.IntegrityCheckJob_originalFileLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(IntegrityCheckJobI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return IntegrityCheckJobI( self._id.getValue(), False )
...
_omero_model.IntegrityCheckJobI = IntegrityCheckJobI
