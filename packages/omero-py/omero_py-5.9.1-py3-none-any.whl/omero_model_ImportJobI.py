...
class ImportJobI(_omero_model.ImportJob):
      ...
      deprecations_warned = set()

      # Deprecation Warning
      @staticmethod
      def warn_of_deprecation(item):
          if item not in ImportJobI.deprecations_warned:
              ImportJobI.deprecations_warned.add(item)
              import warnings
      ...
      ORIGINALFILELINKS =  "ome.model.jobs.ImportJob_originalFileLinks"
      ...
      def __init__(self, id=None, loaded=None):
          ...
          ImportJobI.warn_of_deprecation("ImportJob")
      ...
      def unload(self, current = None):
          self._loaded = False
          self.unloadImageName( )
          self.unloadImageDescription( )
          self.unloadUsername( )
      ...
      def proxy(self, current = None):
          ...
          return ImportJobI( self._id.getValue(), False )
      ...
      def unloadImageDescription(self, ):
          self._imageDescriptionLoaded = False
...
_omero_model.ImportJobI = ImportJobI
