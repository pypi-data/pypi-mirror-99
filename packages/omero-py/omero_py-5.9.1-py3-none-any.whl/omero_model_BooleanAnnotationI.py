...
IceImport.load("omero_model_BooleanAnnotation_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class BooleanAnnotationI(_omero_model.BooleanAnnotation):
      ...
      _field_info = _field_info_type(
          boolValue=_field_info_data(wrapper=omero.rtypes.rbool, nullable=True),
      ...
      ANNOTATIONLINKS =  "ome.model.annotations.BooleanAnnotation_annotationLinks"
      ...
      def __init__(self, id=None, loaded=None):
          super(BooleanAnnotationI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return BooleanAnnotationI( self._id.getValue(), False )
      ...
      def setBoolValue(self, _boolValue, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.boolValue.wrapper is not None:
              if _boolValue is not None:
                  _boolValue = self._field_info.boolValue.wrapper(_boolValue)
...
_omero_model.BooleanAnnotationI = BooleanAnnotationI
