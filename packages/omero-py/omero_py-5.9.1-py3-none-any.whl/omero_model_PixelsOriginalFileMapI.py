...
IceImport.load("omero_model_PixelsOriginalFileMap_ice")
...
class PixelsOriginalFileMapI(_omero_model.PixelsOriginalFileMap):
      ...
      def __init__(self, id=None, loaded=None):
          super(PixelsOriginalFileMapI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return PixelsOriginalFileMapI( self._id.getValue(), False )
...
_omero_model.PixelsOriginalFileMapI = PixelsOriginalFileMapI
