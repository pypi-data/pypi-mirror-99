...
IceImport.load("omero_model_AdminPrivilege_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class AdminPrivilegeI(_omero_model.AdminPrivilege):
      ...
      def __init__(self, id=None, loaded=None):
          super(AdminPrivilegeI, self).__init__()
      ...
      def shallowCopy(self, current = None):
            ...
            copy = AdminPrivilegeI()
            copy._id = self._id;
            copy._details = None  # Unloading for the moment.
            raise omero.ClientError("NYI")
      def proxy(self, current = None):
          if self._id is None: raise omero.ClientError("Proxies require an id")
          return AdminPrivilegeI( self._id.getValue(), False )
...
_omero_model.AdminPrivilegeI = AdminPrivilegeI
