...
IceImport.load("omero_model_ScreenAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class ScreenAnnotationLinkI(_omero_model.ScreenAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(ScreenAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return ScreenAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.ScreenAnnotationLinkI = ScreenAnnotationLinkI
