...
IceImport.load("omero_model_WellAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class WellAnnotationLinkI(_omero_model.WellAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(WellAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return WellAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.WellAnnotationLinkI = WellAnnotationLinkI
