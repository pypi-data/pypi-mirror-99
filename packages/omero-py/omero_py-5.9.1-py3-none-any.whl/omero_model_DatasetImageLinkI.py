...
IceImport.load("omero_model_DatasetImageLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class DatasetImageLinkI(_omero_model.DatasetImageLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(DatasetImageLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return DatasetImageLinkI( self._id.getValue(), False )
...
_omero_model.DatasetImageLinkI = DatasetImageLinkI
