...
IceImport.load("omero_model_FolderAnnotationLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class FolderAnnotationLinkI(_omero_model.FolderAnnotationLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(FolderAnnotationLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return FolderAnnotationLinkI( self._id.getValue(), False )
...
_omero_model.FolderAnnotationLinkI = FolderAnnotationLinkI
