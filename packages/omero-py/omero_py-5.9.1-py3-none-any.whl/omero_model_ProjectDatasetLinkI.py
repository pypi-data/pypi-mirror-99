...
IceImport.load("omero_model_ProjectDatasetLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class ProjectDatasetLinkI(_omero_model.ProjectDatasetLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(ProjectDatasetLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return ProjectDatasetLinkI( self._id.getValue(), False )
...
_omero_model.ProjectDatasetLinkI = ProjectDatasetLinkI
