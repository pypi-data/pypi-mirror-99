...
IceImport.load("omero_model_ScreenPlateLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class ScreenPlateLinkI(_omero_model.ScreenPlateLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(ScreenPlateLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return ScreenPlateLinkI( self._id.getValue(), False )
...
_omero_model.ScreenPlateLinkI = ScreenPlateLinkI
