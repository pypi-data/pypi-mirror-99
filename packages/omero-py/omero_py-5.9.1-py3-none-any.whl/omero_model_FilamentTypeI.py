...
IceImport.load("omero_model_FilamentType_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class FilamentTypeI(_omero_model.FilamentType):
      ...
      def __init__(self, id=None, loaded=None):
          super(FilamentTypeI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return FilamentTypeI( self._id.getValue(), False )
...
_omero_model.FilamentTypeI = FilamentTypeI
