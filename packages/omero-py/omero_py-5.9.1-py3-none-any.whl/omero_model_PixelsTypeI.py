...
IceImport.load("omero_model_PixelsType_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class PixelsTypeI(_omero_model.PixelsType):
      ...
      _field_info = _field_info_type(
          ...
          bitSize=_field_info_data(wrapper=omero.rtypes.rint, nullable=True),
      ...
      def __init__(self, id=None, loaded=None):
          super(PixelsTypeI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return PixelsTypeI( self._id.getValue(), False )
      ...
      def setBitSize(self, _bitSize, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.bitSize.wrapper is not None:
              if _bitSize is not None:
                  _bitSize = self._field_info.bitSize.wrapper(_bitSize)
...
_omero_model.PixelsTypeI = PixelsTypeI
