...
class QuantumDefI(_omero_model.QuantumDef):
      ...
      def proxy(self, current = None):
          ...
          return QuantumDefI( self._id.getValue(), False )
      ...
      def unloadBitResolution(self, ):
          self._bitResolutionLoaded = False
          self._bitResolution = None;
...
_omero_model.QuantumDefI = QuantumDefI
