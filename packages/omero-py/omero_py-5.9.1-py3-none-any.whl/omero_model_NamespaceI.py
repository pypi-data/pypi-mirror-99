...
class NamespaceI(_omero_model.Namespace):
      ...
      _field_info = _field_info_type(
          ...
          displayName=_field_info_data(wrapper=omero.rtypes.rstring, nullable=True),
      ...
      def setDisplayName(self, _displayName, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.displayName.wrapper is not None:
              if _displayName is not None:
                  _displayName = self._field_info.displayName.wrapper(_displayName)
