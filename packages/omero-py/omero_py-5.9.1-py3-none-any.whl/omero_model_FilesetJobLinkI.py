...
IceImport.load("omero_model_FilesetJobLink_ice")
from omero.rtypes import rlong
from collections import namedtuple
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class FilesetJobLinkI(_omero_model.FilesetJobLink):
      ...
      def __init__(self, id=None, loaded=None):
          super(FilesetJobLinkI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return FilesetJobLinkI( self._id.getValue(), False )
...
_omero_model.FilesetJobLinkI = FilesetJobLinkI
