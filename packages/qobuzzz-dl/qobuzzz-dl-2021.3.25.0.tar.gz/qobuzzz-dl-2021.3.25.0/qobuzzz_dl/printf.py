...
import logging
import prettytable
from qobuzzz_dl.lang.language import getLangName, getLang
from qobuzzz_dl.settings import Settings, getSettingsPath
from qobuzzz_dl.model import Album, Track, Playlist, Artist, StreamUrl
