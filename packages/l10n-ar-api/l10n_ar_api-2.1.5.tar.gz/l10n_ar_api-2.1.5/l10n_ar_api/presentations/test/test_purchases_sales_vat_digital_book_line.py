...
class TestPurchaseSalesVatDigitalBookLine(unittest.TestCase):
    ...
    def _get_lines(self):
        ...
        lines = [self.ventas_cbte_line, self.ventas_alicuotas_line,
    ...
    ventas_cbte_line = presentation.PresentationLine.factory("libroIVADigital", "ventasCbte")
    ventas_alicuotas_line = presentation.PresentationLine.factory("libroIVADigital", "ventasAlicuotas")
    compras_cbte_line = presentation.PresentationLine.factory("libroIVADigital", "comprasCbte")
    compras_alicuotas_line = presentation.PresentationLine.factory("libroIVADigital", "comprasAlicuotas")
    compras_importaciones_line = presentation.PresentationLine.factory("libroIVADigital", "comprasImportaciones")
    credito_fiscal_importacion_serv_line = presentation.PresentationLine.factory("libroIVADigital", "creditoFiscalImportacionServ")
        
    def test_create_vat_digital_book_lines(self):
