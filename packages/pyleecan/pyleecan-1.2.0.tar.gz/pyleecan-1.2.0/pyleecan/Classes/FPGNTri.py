# -*- coding: utf-8 -*-
# File generated according to Generator/ClassesRef/Mesh/Interpolation/FPGNTri.csv
# WARNING! All changes made in this file will be lost!
"""Method code available at https://github.com/Eomys/pyleecan/tree/master/pyleecan/Methods/Mesh/FPGNTri
"""
...
try:
    from ..Methods.Mesh.FPGNTri.get_gauss_points import get_gauss_points
...
class FPGNTri(GaussPoint):
    """Store gauss point for triangle elements"""

    VERSION = 1

    # cf Methods.Mesh.FPGNTri.get_gauss_points
    ...
    def __str__(self):
        ...
        FPGNTri_str += super(FPGNTri, self).__str__()
        FPGNTri_str += "nb_gauss_point = " + str(self.nb_gauss_point) + linesep
        return FPGNTri_str
    ...
    def __eq__(self, other):
        ...
        if not super(FPGNTri, self).__eq__(other):
            return False
    ...
    def __sizeof__(self):
        ...
        S += super(FPGNTri, self).__sizeof__()
