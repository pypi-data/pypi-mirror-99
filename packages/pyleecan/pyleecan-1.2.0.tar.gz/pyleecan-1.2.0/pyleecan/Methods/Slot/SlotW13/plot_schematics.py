...
def plot_schematics(
    ...
    if is_default:
        slot = type(self)(
            Zs=8, H0=10e-3, W0=20e-3, H1=10e-3, H2=40e-3, W1=40e-3, W2=10e-3, W3=30e-3
        )
        lam = LamSlot(
        ...
        if is_add_schematics:
            ...
            line.plot(
                ...
                linewidth=ARROW_WIDTH,
                label="W2",
                offset_label=self.H0 * 0.2 + 1j * self.W0 * 0.1,
                is_arrow=True,
                fontsize=SC_FONT_SIZE,
            )
            # W3
            ...
            # H1
            line = Segment(
                point_dict["Z9"], point_dict["Z7"].real + 1j * point_dict["Z9"].imag
            )
            line.plot(
                fig=fig,
                ax=ax,
