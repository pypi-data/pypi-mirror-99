...
class Gen_PWSlot22(Ui_PWSlot22):
    def setupUi(self, PWSlot22):
        ...
        # Setup of in_W0
        txt = self.tr(u"""Slot isthmus orthoradial angular width.""")
        ...
        # Setup of in_W2
        txt = self.tr(u"""Angle between slot edges""")
        ...
        # Setup of in_H0
        txt = self.tr(u"""Slot isthmus radial height.""")
        ...
        # Setup of in_H2
        txt = self.tr(u"""Slot radial height below wedge """)
