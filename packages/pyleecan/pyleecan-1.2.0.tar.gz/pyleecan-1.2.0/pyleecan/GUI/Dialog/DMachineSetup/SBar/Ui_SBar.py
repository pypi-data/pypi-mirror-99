...
class Ui_SBar(object):
    def setupUi(self, SBar):
        ...
        self.widget = QWidget(self.g_ring)
        ...
        self.unit_Hscr = QLabel(self.widget)
        ...
        self.unit_Lscr = QLabel(self.widget)
        ...
        self.lf_Lscr = FloatEdit(self.widget)
        ...
        self.in_Lscr = QLabel(self.widget)
