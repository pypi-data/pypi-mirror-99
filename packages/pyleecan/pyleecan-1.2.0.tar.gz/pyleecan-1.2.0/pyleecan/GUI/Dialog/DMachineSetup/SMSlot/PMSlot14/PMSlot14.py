...
from ......GUI.Dialog.DMachineSetup.SMSlot.PMSlot14.Gen_PMSlot14 import Gen_PMSlot14
from ......Methods.Slot.Slot import SlotCheckError

translate = PySide2.QtCore.QCoreApplication.translate


class PMSlot14(Gen_PMSlot14, QWidget):
    ...
    def check(lam):
        ...
        try:
            ...
            return translate("Unable to compute yoke height:", "PMSlot14") + str(error)

        if yoke_height <= 0:
            return translate(
                "The slot height is greater than the lamination !", "PMSlot14"
            )
