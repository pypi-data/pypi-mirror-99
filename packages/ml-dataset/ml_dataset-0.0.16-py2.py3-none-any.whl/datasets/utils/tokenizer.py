...
class BertTokenizer(Tokenizer):
    ...
    def __init__(
        self, token_dict_path, do_lower_case=False, word_maxlen=200, **kwargs
    ):
        super(BertTokenizer, self).__init__(**kwargs)
        token_dict = self.load_vocab(token_dict_path)
    ...
    def load_vocab(self, dict_path, encoding='utf-8', simplified=False, startswith=None):
    """从bert的词典文件中读取词典
    """
    token_dict = {}
