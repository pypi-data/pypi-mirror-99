...
def unique_project_name(filename):
	...
	if name in project_list or len(name)<4:
			...
			if type(servingproject)==dict and "id" in servingproject:
				...
				if uploadmodel_resp=="Success":
					...
					if type(servingmodel)==dict and "id" in servingmodel:
						...
						lambda_deploy(LOCAL_DIR,"lambda", projectName, projectName+"-stack", projectConfig, notebook_path,infra,pipPackages)
					else:
		...
		if execution_type=="model":
			...
			if type(servingproject)==dict and "id" in servingproject:		
				...
				if uploadmodel_resp=="Success":
					...
					lambda_deploy(LOCAL_DIR,"lambda", projectName, projectName+"-stack", projectConfig, model_path,infra,pipPackages)
				else:
