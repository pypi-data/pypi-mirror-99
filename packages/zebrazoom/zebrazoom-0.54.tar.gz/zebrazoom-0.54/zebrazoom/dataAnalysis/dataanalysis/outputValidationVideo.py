  ...
  while (l < boutEnd):
    ...
    if (analyzeAllWellsAtTheSameTime == 0):
      ...
      # if ( (lengthX > horizontal2) or (lengthY > vertical2) ):
        ...
        # newX = 200 #lengthX * sinkFactor
        # newY = 200 #lengthY * sinkFactor
      ...
      imgResized2 = cv2.resize(img,(length,length))
      
      cv2.putText(imgResized2, str(l), (5,23), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 1)
      
      out.write(imgResized2)
      ...
      cv2.putText(img,str(l), (5,23), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 1)
      out.write(img)
