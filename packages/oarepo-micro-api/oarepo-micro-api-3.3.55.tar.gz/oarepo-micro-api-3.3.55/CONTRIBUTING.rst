...
OARepo Micro API could always use more documentation, whether as part of the
official OARepo Micro API docs, in docstrings, or even on the web in blog posts,
articles, and such.
