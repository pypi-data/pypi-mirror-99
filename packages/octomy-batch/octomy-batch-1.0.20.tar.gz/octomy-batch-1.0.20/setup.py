...
package = {
    ...
    "description": ("OctoMY scheduler"),
    "license": "GPL-3 LGPL-3 MIT",
    "platforms": ["Linux"],
    "keywords": "octomy batch task queue",
    "url": "https://gitlab.com/octomy/batch",
    "packages": find_namespace_packages(include=["fk.*", "fk_batch_filters.*"]),
    "namespace_packages": ["fk", "fk_batch_filters"],
    "scripts": ["bin/octomy-batch"],
    "zip_safe": True,
