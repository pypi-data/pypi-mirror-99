...
class BatchProcessor:
    ...
    def get_status(self):
        status = {"bob": "lol", "type": self.db.get_type_counts(), "status": self.db.get_status_counts(), "last": self.db.get_last_jobs(limit=10), "type_status": self.db.get_type_status_counts(), "counts": self.get_job_counts()}
        return status
