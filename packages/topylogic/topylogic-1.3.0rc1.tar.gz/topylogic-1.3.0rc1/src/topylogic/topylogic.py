...
class graph(object):
    ...
    request_flag = property(_topylogic.graph_request_flag_get, _topylogic.graph_request_flag_set)
    ...
    copy_module = property(_topylogic.graph_copy_module_get, _topylogic.graph_copy_module_set)
    copy_dict = property(_topylogic.graph_copy_dict_get, _topylogic.graph_copy_dict_set)
    copy_obj = property(_topylogic.graph_copy_obj_get, _topylogic.graph_copy_obj_set)
...
class request(object):
    ...
    __repr__ = _swig_repr
    request = property(_topylogic.request_request_get, _topylogic.request_request_set)
    f = property(_topylogic.request_f_get, _topylogic.request_f_set)
    args = property(_topylogic.request_args_get, _topylogic.request_args_set)
...
class glbl_args(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    glbl = property(_topylogic.glbl_args_glbl_get, _topylogic.glbl_args_glbl_set)
    py_callback = property(_topylogic.glbl_args_py_callback_get, _topylogic.glbl_args_py_callback_set)
...
class edge_vars(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    vars = property(_topylogic.edge_vars_vars_get, _topylogic.edge_vars_vars_set)
