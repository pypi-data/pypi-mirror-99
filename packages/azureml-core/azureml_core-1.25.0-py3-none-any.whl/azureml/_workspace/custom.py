...
def ml_workspace_update(
    ...
    if friendly_name is None and description is None and \
       ...
       allow_public_access_when_behind_vnet is None:
        return workspace
    else:
        ...
        if allow_public_access_when_behind_vnet is None:
            allow_public_access_when_behind_vnet = workspace.allow_public_access_when_behind_vnet
    ...
    workspace = WorkspacesOperations.update(
