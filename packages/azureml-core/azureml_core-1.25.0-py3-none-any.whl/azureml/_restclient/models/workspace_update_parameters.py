...
class WorkspaceUpdateParameters(Model):
    ...
    :param allow_public_access_when_behind_vnet: Allow public access for
    ...
    _attribute_map = {
        ...
        'allow_public_access_when_behind_vnet': {'key': 'properties.allowPublicAccessWhenBehindVnet', 'type': 'str'},
        'primary_user_assigned_identity': {'key': 'properties.primaryUserAssignedIdentity', 'type': 'str'},
    }

    def __init__(self, tags=None, sku=None, identity=None, description=None, friendly_name=None, service_managed_resources_settings=None, image_build_compute=None, allow_public_access_when_behind_vnet=None, primary_user_assigned_identity=None):
