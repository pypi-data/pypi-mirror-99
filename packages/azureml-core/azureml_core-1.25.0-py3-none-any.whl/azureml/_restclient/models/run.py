...
class Run(Model):
    ...
    def __init__(self, run_number=None, root_run_id=None, experiment_id=None, created_utc=None, created_by=None, user_id=None, token=None, token_expiry_time_utc=None, error=None, warnings=None, revision=None, status_revision=None, run_uuid=None, parent_run_uuid=None, root_run_uuid=None, run_id=None, parent_run_id=None, status=None, start_time_utc=None, end_time_utc=None, options=None, display_name=None, name=None, data_container_id=None, description=None, hidden=None, run_type=None, run_type_v2=None, properties=None, parameters=None, action_uris=None, script_name=None, target=None, unique_child_run_compute_targets=None, tags=None, settings=None, input_datasets=None, output_datasets=None, run_definition=None, primary_metric_name=None, created_from=None, cancel_uri=None, complete_uri=None, diagnostics_uri=None, compute_request=None, retain_for_lifetime_of_workspace=None, queueing_info=None):
