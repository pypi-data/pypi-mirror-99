...
class AISuperComputerConfiguration(Model):
    ...
    def __init__(self, instance_type=None, image_version=None, location=None, ai_super_computer_storage_data=None, interactive=None, scale_policy=None, virtual_cluster_arm_id=None):
