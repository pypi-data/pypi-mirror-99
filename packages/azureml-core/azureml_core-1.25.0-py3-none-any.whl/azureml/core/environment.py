...
DEFAULT_CPU_IMAGE = _get_tagged_image("mcr.microsoft.com/azureml/intelmpi2018.3-ubuntu16.04")
DEFAULT_GPU_IMAGE = _get_tagged_image("mcr.microsoft.com/azureml/intelmpi2018.3-cuda10.0-cudnn7-ubuntu16.04")
    ...
    def build(self, workspace, image_build_compute=None):
        ...
        try:
            lro = environment_client._start_cloud_image_build(
                name=self.name, version=self.version, image_build_compute=image_build_compute)
