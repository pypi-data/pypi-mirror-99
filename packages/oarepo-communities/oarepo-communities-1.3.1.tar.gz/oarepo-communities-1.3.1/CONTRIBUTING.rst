...
1. Fork the `oarepo/oarepo-communities` repo on GitHub.
...
3. Install your local copy into a virtualenv. Assuming you have
   ...
   .. code-block:: console
      ...
      $ mkvirtualenv oarepo-communities
...
3. The pull request should work for Python 3.6, 3.7, 3.8 and 3.9. Check
   https://github.com/inveniosoftware/oarepo/oarepo-communities/actions?query=event%3Apull_request
