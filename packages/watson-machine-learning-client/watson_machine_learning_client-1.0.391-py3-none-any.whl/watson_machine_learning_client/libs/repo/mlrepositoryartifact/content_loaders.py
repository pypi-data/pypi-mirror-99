...
if lib_checker.installed_libs[SCIKIT]:
    ...
    if lib_checker.installed_libs[XGBOOST]:
        ...
        from watson_machine_learning_client.libs.repo.mlrepositoryartifact.version_helper import XGBoostModelBinary
...
class TensorflowPipelineModelContentLoader(object):
    ...
    def load_content(content_dir,session,tags):
        ...
        from watson_machine_learning_client.libs.repo.mlrepositoryartifact.version_helper import TensorflowModelBinary
