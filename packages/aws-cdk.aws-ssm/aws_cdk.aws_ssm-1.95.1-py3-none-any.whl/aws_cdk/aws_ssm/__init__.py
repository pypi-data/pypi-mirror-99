...
class CfnAssociation(
    ...
    def parameters(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[builtins.str, typing.List[builtins.str]]]], jsii.get(self, "parameters"))
...
class CfnAssociationProps:
    ...
    def parameters(
        ...
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[builtins.str, typing.List[builtins.str]]]], result)
...
class CfnMaintenanceWindowTask(
    ...
    def __init__(
        ...
        *,
        ...
        targets: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.TargetProperty"]]]] = None,
