...
[boto3.QuickSight 1.17.33](https://boto3.amazonaws.com/v1/documentation/api/1.17.33/reference/services/quicksight.html#QuickSight) service
compatible with
...
`mypy_boto3_quicksight.paginator` module contains type annotations for all paginators.
